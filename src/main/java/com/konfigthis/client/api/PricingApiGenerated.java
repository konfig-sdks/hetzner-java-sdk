...
import com.konfigthis.client.model.PricingGetAllPricesResponse;
...
public class PricingApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PricingApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PricingApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getAllPricesCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllPricesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAllPricesCall(_callback);

    }


    private ApiResponse<PricingGetAllPricesResponse> getAllPricesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAllPricesValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<PricingGetAllPricesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAllPricesAsync(final ApiCallback<PricingGetAllPricesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllPricesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<PricingGetAllPricesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetAllPricesRequestBuilder {

        private GetAllPricesRequestBuilder() {
        }

        /**
         * Build call for getAllPrices
        ...
        /**
         * Execute getAllPrices request
         * @return PricingGetAllPricesResponse
         ...
         */
        public PricingGetAllPricesResponse execute() throws ApiException {
            ApiResponse<PricingGetAllPricesResponse> localVarResp = getAllPricesWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getAllPrices request with HTTP info returned
         * @return ApiResponse&lt;PricingGetAllPricesResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<PricingGetAllPricesResponse> executeWithHttpInfo() throws ApiException {
            return getAllPricesWithHttpInfo();
        }

        /**
         * Execute getAllPrices request (asynchronously)
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PricingGetAllPricesResponse> _callback) throws ApiException {
            return getAllPricesAsync(_callback);
        }
    }
     ...
     * @return GetAllPricesRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The &#x60;pricing&#x60; key in the reply contains an pricing object with this structure </td><td>  -  </td></tr>
     ...
     */
    public GetAllPricesRequestBuilder getAllPrices() throws IllegalArgumentException {
        return new GetAllPricesRequestBuilder();
    }
}
