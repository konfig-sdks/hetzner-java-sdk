...
import com.konfigthis.client.model.DatacentersGetAllResponse;
import com.konfigthis.client.model.DatacentersGetByIdResponse;
...
public class DatacentersApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DatacentersApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public DatacentersApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getAllCall(String name, String sort, Long page, Long perPage, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllValidateBeforeCall(String name, String sort, Long page, Long perPage, final ApiCallback _callback) throws ApiException {
        return getAllCall(name, sort, page, perPage, _callback);

    }


    private ApiResponse<DatacentersGetAllResponse> getAllWithHttpInfo(String name, String sort, Long page, Long perPage) throws ApiException {
        okhttp3.Call localVarCall = getAllValidateBeforeCall(name, sort, page, perPage, null);
        Type localVarReturnType = new TypeToken<DatacentersGetAllResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAllAsync(String name, String sort, Long page, Long perPage, final ApiCallback<DatacentersGetAllResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllValidateBeforeCall(name, sort, page, perPage, _callback);
        Type localVarReturnType = new TypeToken<DatacentersGetAllResponse>(){}.getType();
    ...
    public class GetAllRequestBuilder {
         ...
         * @return DatacentersGetAllResponse
         ...
         */
        public DatacentersGetAllResponse execute() throws ApiException {
            ApiResponse<DatacentersGetAllResponse> localVarResp = getAllWithHttpInfo(name, sort, page, perPage);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getAll request with HTTP info returned
         * @return ApiResponse&lt;DatacentersGetAllResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<DatacentersGetAllResponse> executeWithHttpInfo() throws ApiException {
            return getAllWithHttpInfo(name, sort, page, perPage);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<DatacentersGetAllResponse> _callback) throws ApiException {
            return getAllAsync(name, sort, page, perPage, _callback);
        }
    }
    ...
    private ApiResponse<DatacentersGetByIdResponse> getByIdWithHttpInfo(Long id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<DatacentersGetByIdResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(Long id, final ApiCallback<DatacentersGetByIdResponse> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         * @return DatacentersGetByIdResponse
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public DatacentersGetByIdResponse execute() throws ApiException {
            ApiResponse<DatacentersGetByIdResponse> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getById request with HTTP info returned
         * @return ApiResponse&lt;DatacentersGetByIdResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<DatacentersGetByIdResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<DatacentersGetByIdResponse> _callback) throws ApiException {
