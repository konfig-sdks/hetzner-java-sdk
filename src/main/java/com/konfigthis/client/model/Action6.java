...
import com.konfigthis.client.model.Action6Error;
import com.konfigthis.client.model.Action6ResourcesInner;
...
public class Action6 {
  ...
  private List<Action6ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action6 command(String command) {
  ...
  **/
  ...
  public Action6 error(Action6Error error) {
  ...
  **/
  ...
  public Action6Error getError() {
    return error;
  }


  public void setError(Action6Error error) {
  ...
  public Action6 finished(String finished) {
  ...
  **/
  ...
  public Action6 progress(Integer progress) {
  ...
  **/
  ...
  public Action6 resources(List<Action6ResourcesInner> resources) {
  ...
  public Action6 addResourcesItem(Action6ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action6ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action6ResourcesInner> resources) {
  ...
  public Action6 started(String started) {
  ...
  **/
  ...
  public Action6 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action6 instance itself
   */
  public Action6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action6 action6 = (Action6) o;
    return Objects.equals(this.command, action6.command) &&
        Objects.equals(this.error, action6.error) &&
        Objects.equals(this.finished, action6.finished) &&
        Objects.equals(this.id, action6.id) &&
        Objects.equals(this.progress, action6.progress) &&
        Objects.equals(this.resources, action6.resources) &&
        Objects.equals(this.started, action6.started) &&
        Objects.equals(this.status, action6.status)&&
        Objects.equals(this.additionalProperties, action6.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action6 is not found in the empty JSON string", Action6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action6.openapiRequiredFields) {
      ...
      Action6Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action6ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action6.class));

       return (TypeAdapter<T>) new TypeAdapter<Action6>() {
           @Override
           public void write(JsonWriter out, Action6 value) throws IOException {
           ...
           @Override
           public Action6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action6
  * @throws IOException if the JSON string is invalid with respect to Action6
  */
  public static Action6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action6.class);
  }

 /**
  * Convert an instance of Action6 to an JSON string
  *
  * @return JSON string
  */
