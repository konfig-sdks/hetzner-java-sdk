...
import com.konfigthis.client.model.ActionProperty1Error;
import com.konfigthis.client.model.ActionProperty1ResourcesInner;
...
public class ActionProperty1 {
  ...
  private ActionProperty1Error error;
  ...
  private List<ActionProperty1ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty1() {
  }

  public ActionProperty1 command(String command) {
  ...
  **/
  ...
  public ActionProperty1 error(ActionProperty1Error error) {
  ...
  **/
  ...
  public ActionProperty1Error getError() {
    return error;
  }


  public void setError(ActionProperty1Error error) {
  ...
  public ActionProperty1 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty1 id(Long id) {
  ...
  **/
  ...
  public ActionProperty1 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty1 resources(List<ActionProperty1ResourcesInner> resources) {
  ...
  public ActionProperty1 addResourcesItem(ActionProperty1ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty1ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty1ResourcesInner> resources) {
  ...
  public ActionProperty1 started(String started) {
  ...
  **/
  ...
  public ActionProperty1 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty1 instance itself
   */
  public ActionProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty1 actionProperty1 = (ActionProperty1) o;
    return Objects.equals(this.command, actionProperty1.command) &&
        Objects.equals(this.error, actionProperty1.error) &&
        Objects.equals(this.finished, actionProperty1.finished) &&
        Objects.equals(this.id, actionProperty1.id) &&
        Objects.equals(this.progress, actionProperty1.progress) &&
        Objects.equals(this.resources, actionProperty1.resources) &&
        Objects.equals(this.started, actionProperty1.started) &&
        Objects.equals(this.status, actionProperty1.status)&&
        Objects.equals(this.additionalProperties, actionProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty1 is not found in the empty JSON string", ActionProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty1.openapiRequiredFields) {
      ...
      ActionProperty1Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty1ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty1>() {
           @Override
           public void write(JsonWriter out, ActionProperty1 value) throws IOException {
           ...
           @Override
           public ActionProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty1
  * @throws IOException if the JSON string is invalid with respect to ActionProperty1
  */
  public static ActionProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty1.class);
  }

 /**
  * Convert an instance of ActionProperty1 to an JSON string
  *
  * @return JSON string
  */
