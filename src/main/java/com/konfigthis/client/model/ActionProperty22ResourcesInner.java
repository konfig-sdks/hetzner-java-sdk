...
/**
 * ActionProperty22ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty22ResourcesInner {
  ...
  public ActionProperty22ResourcesInner() {
  }

  public ActionProperty22ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty22ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty22ResourcesInner instance itself
   */
  public ActionProperty22ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty22ResourcesInner actionProperty22ResourcesInner = (ActionProperty22ResourcesInner) o;
    return Objects.equals(this.id, actionProperty22ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty22ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty22ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty22ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty22ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty22ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty22ResourcesInner is not found in the empty JSON string", ActionProperty22ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty22ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty22ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty22ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty22ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty22ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty22ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty22ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty22ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty22ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty22ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty22ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty22ResourcesInner
  */
  public static ActionProperty22ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty22ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty22ResourcesInner to an JSON string
  *
  * @return JSON string
  */
