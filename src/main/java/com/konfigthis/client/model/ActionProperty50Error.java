...
public class ActionProperty50Error {
  ...
  public ActionProperty50Error() {
  }

  public ActionProperty50Error code(String code) {
  ...
  **/
  ...
  public ActionProperty50Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty50Error instance itself
   */
  public ActionProperty50Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty50Error actionProperty50Error = (ActionProperty50Error) o;
    return Objects.equals(this.code, actionProperty50Error.code) &&
        Objects.equals(this.message, actionProperty50Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty50Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty50Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty50Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty50Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty50Error is not found in the empty JSON string", ActionProperty50Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty50Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty50Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty50Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty50Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty50Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty50Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty50Error value) throws IOException {
           ...
           @Override
           public ActionProperty50Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty50Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty50Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty50Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty50Error
  */
  public static ActionProperty50Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty50Error.class);
  }

 /**
  * Convert an instance of ActionProperty50Error to an JSON string
  *
  * @return JSON string
  */
