...
/**
 * ActionProperty39ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty39ResourcesInner {
  ...
  public ActionProperty39ResourcesInner() {
  }

  public ActionProperty39ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty39ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty39ResourcesInner instance itself
   */
  public ActionProperty39ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty39ResourcesInner actionProperty39ResourcesInner = (ActionProperty39ResourcesInner) o;
    return Objects.equals(this.id, actionProperty39ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty39ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty39ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty39ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty39ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty39ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty39ResourcesInner is not found in the empty JSON string", ActionProperty39ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty39ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty39ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty39ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty39ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty39ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty39ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty39ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty39ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty39ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty39ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty39ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty39ResourcesInner
  */
  public static ActionProperty39ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty39ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty39ResourcesInner to an JSON string
  *
  * @return JSON string
  */
