...
public class ListMetaProperty19Pagination {
  ...
  public ListMetaProperty19Pagination() {
  }

  public ListMetaProperty19Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty19Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty19Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty19Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty19Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty19Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty19Pagination instance itself
   */
  public ListMetaProperty19Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty19Pagination listMetaProperty19Pagination = (ListMetaProperty19Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty19Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty19Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty19Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty19Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty19Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty19Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty19Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty19Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty19Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty19Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty19Pagination is not found in the empty JSON string", ListMetaProperty19Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty19Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty19Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty19Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty19Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty19Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty19Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty19Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty19Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty19Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty19Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty19Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty19Pagination
  */
  public static ListMetaProperty19Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty19Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty19Pagination to an JSON string
  *
  * @return JSON string
  */
