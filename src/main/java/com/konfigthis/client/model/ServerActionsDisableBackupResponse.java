...
import com.konfigthis.client.model.ActionProperty60;
...
public class ServerActionsDisableBackupResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty60 action;

  public ServerActionsDisableBackupResponse() {
  }

  public ServerActionsDisableBackupResponse action(ActionProperty60 action) {
  ...
  **/
  ...
  public ActionProperty60 getAction() {
    return action;
  }


  public void setAction(ActionProperty60 action) {
   ...
   * @return the ServerActionsDisableBackupResponse instance itself
   */
  public ServerActionsDisableBackupResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsDisableBackupResponse serverActionsDisableBackupResponse = (ServerActionsDisableBackupResponse) o;
    return Objects.equals(this.action, serverActionsDisableBackupResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsDisableBackupResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsDisableBackupResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsDisableBackupResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsDisableBackupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsDisableBackupResponse is not found in the empty JSON string", ServerActionsDisableBackupResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsDisableBackupResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty60.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsDisableBackupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsDisableBackupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsDisableBackupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsDisableBackupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsDisableBackupResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsDisableBackupResponse value) throws IOException {
           ...
           @Override
           public ServerActionsDisableBackupResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsDisableBackupResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsDisableBackupResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsDisableBackupResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsDisableBackupResponse
  */
  public static ServerActionsDisableBackupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsDisableBackupResponse.class);
  }

 /**
  * Convert an instance of ServerActionsDisableBackupResponse to an JSON string
  *
  * @return JSON string
  */
