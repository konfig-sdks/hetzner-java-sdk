...
import com.konfigthis.client.model.ActionProperty9Error;
import com.konfigthis.client.model.ActionProperty9ResourcesInner;
...
public class ActionProperty9 {
  ...
  private ActionProperty9Error error;
  ...
  private List<ActionProperty9ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty9() {
  }

  public ActionProperty9 command(String command) {
  ...
  **/
  ...
  public ActionProperty9 error(ActionProperty9Error error) {
  ...
  **/
  ...
  public ActionProperty9Error getError() {
    return error;
  }


  public void setError(ActionProperty9Error error) {
  ...
  public ActionProperty9 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty9 id(Long id) {
  ...
  **/
  ...
  public ActionProperty9 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty9 resources(List<ActionProperty9ResourcesInner> resources) {
  ...
  public ActionProperty9 addResourcesItem(ActionProperty9ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty9ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty9ResourcesInner> resources) {
  ...
  public ActionProperty9 started(String started) {
  ...
  **/
  ...
  public ActionProperty9 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty9 instance itself
   */
  public ActionProperty9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty9 actionProperty9 = (ActionProperty9) o;
    return Objects.equals(this.command, actionProperty9.command) &&
        Objects.equals(this.error, actionProperty9.error) &&
        Objects.equals(this.finished, actionProperty9.finished) &&
        Objects.equals(this.id, actionProperty9.id) &&
        Objects.equals(this.progress, actionProperty9.progress) &&
        Objects.equals(this.resources, actionProperty9.resources) &&
        Objects.equals(this.started, actionProperty9.started) &&
        Objects.equals(this.status, actionProperty9.status)&&
        Objects.equals(this.additionalProperties, actionProperty9.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty9 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty9 is not found in the empty JSON string", ActionProperty9.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty9.openapiRequiredFields) {
      ...
      ActionProperty9Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty9ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty9.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty9>() {
           @Override
           public void write(JsonWriter out, ActionProperty9 value) throws IOException {
           ...
           @Override
           public ActionProperty9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty9
  * @throws IOException if the JSON string is invalid with respect to ActionProperty9
  */
  public static ActionProperty9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty9.class);
  }

 /**
  * Convert an instance of ActionProperty9 to an JSON string
  *
  * @return JSON string
  */
