...
/**
 * ActionProperty37ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty37ResourcesInner {
  ...
  public ActionProperty37ResourcesInner() {
  }

  public ActionProperty37ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty37ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty37ResourcesInner instance itself
   */
  public ActionProperty37ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty37ResourcesInner actionProperty37ResourcesInner = (ActionProperty37ResourcesInner) o;
    return Objects.equals(this.id, actionProperty37ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty37ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty37ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty37ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty37ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty37ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty37ResourcesInner is not found in the empty JSON string", ActionProperty37ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty37ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty37ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty37ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty37ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty37ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty37ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty37ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty37ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty37ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty37ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty37ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty37ResourcesInner
  */
  public static ActionProperty37ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty37ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty37ResourcesInner to an JSON string
  *
  * @return JSON string
  */
