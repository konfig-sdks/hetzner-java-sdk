...
import com.konfigthis.client.model.ServerActionsCreateImageResponseImageCreatedFrom;
import com.konfigthis.client.model.ServerActionsCreateImageResponseImageProtection;
...
public class ServerActionsCreateImageResponseImage {
 ...
 public enum ArchitectureEnum {
  ...
  private ServerActionsCreateImageResponseImageCreatedFrom createdFrom;
 ...
 public enum OsFlavorEnum {
  ...
  private ServerActionsCreateImageResponseImageProtection protection;
 ...
 public enum TypeEnum {
  ...
  public ServerActionsCreateImageResponseImage() {
  }

  public ServerActionsCreateImageResponseImage description(String description) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage boundTo(Long boundTo) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage created(String created) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage createdFrom(ServerActionsCreateImageResponseImageCreatedFrom createdFrom) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImageCreatedFrom getCreatedFrom() {
    return createdFrom;
  }


  public void setCreatedFrom(ServerActionsCreateImageResponseImageCreatedFrom createdFrom) {
  ...
  public ServerActionsCreateImageResponseImage deleted(String deleted) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage deprecated(String deprecated) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage diskSize(Double diskSize) {
  ...
  public ServerActionsCreateImageResponseImage diskSize(Integer diskSize) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage id(Long id) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage imageSize(Double imageSize) {
  ...
  public ServerActionsCreateImageResponseImage imageSize(Integer imageSize) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage labels(Map<String, String> labels) {
  ...
  public ServerActionsCreateImageResponseImage putLabelsItem(String key, String labelsItem) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage name(String name) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage osFlavor(OsFlavorEnum osFlavor) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage osVersion(String osVersion) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage protection(ServerActionsCreateImageResponseImageProtection protection) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImageProtection getProtection() {
    return protection;
  }


  public void setProtection(ServerActionsCreateImageResponseImageProtection protection) {
  ...
  public ServerActionsCreateImageResponseImage rapidDeploy(Boolean rapidDeploy) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage status(StatusEnum status) {
  ...
  **/
  ...
  public ServerActionsCreateImageResponseImage type(TypeEnum type) {
  ...
  **/
   ...
   * @return the ServerActionsCreateImageResponseImage instance itself
   */
  public ServerActionsCreateImageResponseImage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsCreateImageResponseImage serverActionsCreateImageResponseImage = (ServerActionsCreateImageResponseImage) o;
    return Objects.equals(this.description, serverActionsCreateImageResponseImage.description) &&
        Objects.equals(this.architecture, serverActionsCreateImageResponseImage.architecture) &&
        Objects.equals(this.boundTo, serverActionsCreateImageResponseImage.boundTo) &&
        Objects.equals(this.created, serverActionsCreateImageResponseImage.created) &&
        Objects.equals(this.createdFrom, serverActionsCreateImageResponseImage.createdFrom) &&
        Objects.equals(this.deleted, serverActionsCreateImageResponseImage.deleted) &&
        Objects.equals(this.deprecated, serverActionsCreateImageResponseImage.deprecated) &&
        Objects.equals(this.diskSize, serverActionsCreateImageResponseImage.diskSize) &&
        Objects.equals(this.id, serverActionsCreateImageResponseImage.id) &&
        Objects.equals(this.imageSize, serverActionsCreateImageResponseImage.imageSize) &&
        Objects.equals(this.labels, serverActionsCreateImageResponseImage.labels) &&
        Objects.equals(this.name, serverActionsCreateImageResponseImage.name) &&
        Objects.equals(this.osFlavor, serverActionsCreateImageResponseImage.osFlavor) &&
        Objects.equals(this.osVersion, serverActionsCreateImageResponseImage.osVersion) &&
        Objects.equals(this.protection, serverActionsCreateImageResponseImage.protection) &&
        Objects.equals(this.rapidDeploy, serverActionsCreateImageResponseImage.rapidDeploy) &&
        Objects.equals(this.status, serverActionsCreateImageResponseImage.status) &&
        Objects.equals(this.type, serverActionsCreateImageResponseImage.type)&&
        Objects.equals(this.additionalProperties, serverActionsCreateImageResponseImage.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsCreateImageResponseImage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsCreateImageResponseImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsCreateImageResponseImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsCreateImageResponseImage is not found in the empty JSON string", ServerActionsCreateImageResponseImage.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsCreateImageResponseImage.openapiRequiredFields) {
      ...
      ServerActionsCreateImageResponseImageCreatedFrom.validateJsonObject(jsonObj.getAsJsonObject("created_from"));
      ...
      ServerActionsCreateImageResponseImageProtection.validateJsonObject(jsonObj.getAsJsonObject("protection"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsCreateImageResponseImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsCreateImageResponseImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsCreateImageResponseImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsCreateImageResponseImage.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsCreateImageResponseImage>() {
           @Override
           public void write(JsonWriter out, ServerActionsCreateImageResponseImage value) throws IOException {
           ...
           @Override
           public ServerActionsCreateImageResponseImage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsCreateImageResponseImage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsCreateImageResponseImage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsCreateImageResponseImage
  * @throws IOException if the JSON string is invalid with respect to ServerActionsCreateImageResponseImage
  */
  public static ServerActionsCreateImageResponseImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsCreateImageResponseImage.class);
  }

 /**
  * Convert an instance of ServerActionsCreateImageResponseImage to an JSON string
  *
  * @return JSON string
  */
