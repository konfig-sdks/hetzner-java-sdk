...
import com.konfigthis.client.model.ActionProperty21Error;
import com.konfigthis.client.model.ActionProperty21ResourcesInner;
...
public class ActionProperty21 {
  ...
  private ActionProperty21Error error;
  ...
  private List<ActionProperty21ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty21() {
  }

  public ActionProperty21 command(String command) {
  ...
  **/
  ...
  public ActionProperty21 error(ActionProperty21Error error) {
  ...
  **/
  ...
  public ActionProperty21Error getError() {
    return error;
  }


  public void setError(ActionProperty21Error error) {
  ...
  public ActionProperty21 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty21 id(Long id) {
  ...
  **/
  ...
  public ActionProperty21 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty21 resources(List<ActionProperty21ResourcesInner> resources) {
  ...
  public ActionProperty21 addResourcesItem(ActionProperty21ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty21ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty21ResourcesInner> resources) {
  ...
  public ActionProperty21 started(String started) {
  ...
  **/
  ...
  public ActionProperty21 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty21 instance itself
   */
  public ActionProperty21 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty21 actionProperty21 = (ActionProperty21) o;
    return Objects.equals(this.command, actionProperty21.command) &&
        Objects.equals(this.error, actionProperty21.error) &&
        Objects.equals(this.finished, actionProperty21.finished) &&
        Objects.equals(this.id, actionProperty21.id) &&
        Objects.equals(this.progress, actionProperty21.progress) &&
        Objects.equals(this.resources, actionProperty21.resources) &&
        Objects.equals(this.started, actionProperty21.started) &&
        Objects.equals(this.status, actionProperty21.status)&&
        Objects.equals(this.additionalProperties, actionProperty21.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty21 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty21
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty21.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty21 is not found in the empty JSON string", ActionProperty21.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty21.openapiRequiredFields) {
      ...
      ActionProperty21Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty21ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty21.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty21' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty21> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty21.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty21>() {
           @Override
           public void write(JsonWriter out, ActionProperty21 value) throws IOException {
           ...
           @Override
           public ActionProperty21 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty21 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty21 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty21
  * @throws IOException if the JSON string is invalid with respect to ActionProperty21
  */
  public static ActionProperty21 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty21.class);
  }

 /**
  * Convert an instance of ActionProperty21 to an JSON string
  *
  * @return JSON string
  */
