...
public class FirewallActionsApplyToResourcesRequest {
  public static final String SERIALIZED_NAME_APPLY_TO = "apply_to";
  @SerializedName(SERIALIZED_NAME_APPLY_TO)
  private List<FirewallResource> applyTo = new ArrayList<>();

  public FirewallActionsApplyToResourcesRequest() {
  }

  public FirewallActionsApplyToResourcesRequest applyTo(List<FirewallResource> applyTo) {
  ...
  public FirewallActionsApplyToResourcesRequest addApplyToItem(FirewallResource applyToItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Resources the Firewall should be applied to")

  public List<FirewallResource> getApplyTo() {
    return applyTo;
  }


  public void setApplyTo(List<FirewallResource> applyTo) {
   ...
   * @return the FirewallActionsApplyToResourcesRequest instance itself
   */
  public FirewallActionsApplyToResourcesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallActionsApplyToResourcesRequest firewallActionsApplyToResourcesRequest = (FirewallActionsApplyToResourcesRequest) o;
    return Objects.equals(this.applyTo, firewallActionsApplyToResourcesRequest.applyTo)&&
        Objects.equals(this.additionalProperties, firewallActionsApplyToResourcesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applyTo, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirewallActionsApplyToResourcesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallActionsApplyToResourcesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallActionsApplyToResourcesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallActionsApplyToResourcesRequest is not found in the empty JSON string", FirewallActionsApplyToResourcesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallActionsApplyToResourcesRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayapplyTo.size(); i++) {
        FirewallResource.validateJsonObject(jsonArrayapplyTo.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallActionsApplyToResourcesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallActionsApplyToResourcesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallActionsApplyToResourcesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallActionsApplyToResourcesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallActionsApplyToResourcesRequest>() {
           @Override
           public void write(JsonWriter out, FirewallActionsApplyToResourcesRequest value) throws IOException {
           ...
           @Override
           public FirewallActionsApplyToResourcesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallActionsApplyToResourcesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallActionsApplyToResourcesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallActionsApplyToResourcesRequest
  * @throws IOException if the JSON string is invalid with respect to FirewallActionsApplyToResourcesRequest
  */
  public static FirewallActionsApplyToResourcesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallActionsApplyToResourcesRequest.class);
  }

 /**
  * Convert an instance of FirewallActionsApplyToResourcesRequest to an JSON string
  *
  * @return JSON string
  */
