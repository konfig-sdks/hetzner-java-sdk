...
public class FloatingIPsGetResponseFloatingIpProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public FloatingIPsGetResponseFloatingIpProtection() {
  }

  public FloatingIPsGetResponseFloatingIpProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the FloatingIPsGetResponseFloatingIpProtection instance itself
   */
  public FloatingIPsGetResponseFloatingIpProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIPsGetResponseFloatingIpProtection floatingIPsGetResponseFloatingIpProtection = (FloatingIPsGetResponseFloatingIpProtection) o;
    return Objects.equals(this.delete, floatingIPsGetResponseFloatingIpProtection.delete)&&
        Objects.equals(this.additionalProperties, floatingIPsGetResponseFloatingIpProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIPsGetResponseFloatingIpProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIPsGetResponseFloatingIpProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIPsGetResponseFloatingIpProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIPsGetResponseFloatingIpProtection is not found in the empty JSON string", FloatingIPsGetResponseFloatingIpProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIPsGetResponseFloatingIpProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIPsGetResponseFloatingIpProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIPsGetResponseFloatingIpProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIPsGetResponseFloatingIpProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIPsGetResponseFloatingIpProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIPsGetResponseFloatingIpProtection>() {
           @Override
           public void write(JsonWriter out, FloatingIPsGetResponseFloatingIpProtection value) throws IOException {
           ...
           @Override
           public FloatingIPsGetResponseFloatingIpProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIPsGetResponseFloatingIpProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIPsGetResponseFloatingIpProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIPsGetResponseFloatingIpProtection
  * @throws IOException if the JSON string is invalid with respect to FloatingIPsGetResponseFloatingIpProtection
  */
  public static FloatingIPsGetResponseFloatingIpProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIPsGetResponseFloatingIpProtection.class);
  }

 /**
  * Convert an instance of FloatingIPsGetResponseFloatingIpProtection to an JSON string
  *
  * @return JSON string
  */
