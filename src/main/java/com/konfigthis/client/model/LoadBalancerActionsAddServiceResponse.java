...
import com.konfigthis.client.model.ActionProperty19;
...
public class LoadBalancerActionsAddServiceResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty19 action;

  public LoadBalancerActionsAddServiceResponse() {
  }

  public LoadBalancerActionsAddServiceResponse action(ActionProperty19 action) {
  ...
  **/
  ...
  public ActionProperty19 getAction() {
    return action;
  }


  public void setAction(ActionProperty19 action) {
   ...
   * @return the LoadBalancerActionsAddServiceResponse instance itself
   */
  public LoadBalancerActionsAddServiceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsAddServiceResponse loadBalancerActionsAddServiceResponse = (LoadBalancerActionsAddServiceResponse) o;
    return Objects.equals(this.action, loadBalancerActionsAddServiceResponse.action)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsAddServiceResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsAddServiceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsAddServiceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsAddServiceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsAddServiceResponse is not found in the empty JSON string", LoadBalancerActionsAddServiceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsAddServiceResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty19.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsAddServiceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsAddServiceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsAddServiceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsAddServiceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsAddServiceResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsAddServiceResponse value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsAddServiceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsAddServiceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsAddServiceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsAddServiceResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsAddServiceResponse
  */
  public static LoadBalancerActionsAddServiceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsAddServiceResponse.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsAddServiceResponse to an JSON string
  *
  * @return JSON string
  */
