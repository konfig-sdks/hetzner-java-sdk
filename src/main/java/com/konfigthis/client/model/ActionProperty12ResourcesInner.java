...
/**
 * ActionProperty12ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty12ResourcesInner {
  ...
  public ActionProperty12ResourcesInner() {
  }

  public ActionProperty12ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty12ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty12ResourcesInner instance itself
   */
  public ActionProperty12ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty12ResourcesInner actionProperty12ResourcesInner = (ActionProperty12ResourcesInner) o;
    return Objects.equals(this.id, actionProperty12ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty12ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty12ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty12ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty12ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty12ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty12ResourcesInner is not found in the empty JSON string", ActionProperty12ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty12ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty12ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty12ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty12ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty12ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty12ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty12ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty12ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty12ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty12ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty12ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty12ResourcesInner
  */
  public static ActionProperty12ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty12ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty12ResourcesInner to an JSON string
  *
  * @return JSON string
  */
