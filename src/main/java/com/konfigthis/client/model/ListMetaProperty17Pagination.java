...
public class ListMetaProperty17Pagination {
  ...
  public ListMetaProperty17Pagination() {
  }

  public ListMetaProperty17Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty17Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty17Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty17Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty17Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty17Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty17Pagination instance itself
   */
  public ListMetaProperty17Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty17Pagination listMetaProperty17Pagination = (ListMetaProperty17Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty17Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty17Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty17Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty17Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty17Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty17Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty17Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty17Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty17Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty17Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty17Pagination is not found in the empty JSON string", ListMetaProperty17Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty17Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty17Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty17Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty17Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty17Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty17Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty17Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty17Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty17Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty17Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty17Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty17Pagination
  */
  public static ListMetaProperty17Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty17Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty17Pagination to an JSON string
  *
  * @return JSON string
  */
