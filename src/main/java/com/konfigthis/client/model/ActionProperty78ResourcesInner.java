...
/**
 * ActionProperty78ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty78ResourcesInner {
  ...
  public ActionProperty78ResourcesInner() {
  }

  public ActionProperty78ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty78ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty78ResourcesInner instance itself
   */
  public ActionProperty78ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty78ResourcesInner actionProperty78ResourcesInner = (ActionProperty78ResourcesInner) o;
    return Objects.equals(this.id, actionProperty78ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty78ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty78ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty78ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty78ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty78ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty78ResourcesInner is not found in the empty JSON string", ActionProperty78ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty78ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty78ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty78ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty78ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty78ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty78ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty78ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty78ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty78ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty78ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty78ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty78ResourcesInner
  */
  public static ActionProperty78ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty78ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty78ResourcesInner to an JSON string
  *
  * @return JSON string
  */
