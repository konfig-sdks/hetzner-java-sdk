...
import com.konfigthis.client.model.ActionProperty42;
...
public class PrimaryIpActionsGetActionByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty42 action;

  public PrimaryIpActionsGetActionByIdResponse() {
  }

  public PrimaryIpActionsGetActionByIdResponse action(ActionProperty42 action) {
  ...
  **/
  ...
  public ActionProperty42 getAction() {
    return action;
  }


  public void setAction(ActionProperty42 action) {
   ...
   * @return the PrimaryIpActionsGetActionByIdResponse instance itself
   */
  public PrimaryIpActionsGetActionByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIpActionsGetActionByIdResponse primaryIpActionsGetActionByIdResponse = (PrimaryIpActionsGetActionByIdResponse) o;
    return Objects.equals(this.action, primaryIpActionsGetActionByIdResponse.action)&&
        Objects.equals(this.additionalProperties, primaryIpActionsGetActionByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIpActionsGetActionByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIpActionsGetActionByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIpActionsGetActionByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIpActionsGetActionByIdResponse is not found in the empty JSON string", PrimaryIpActionsGetActionByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIpActionsGetActionByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty42.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIpActionsGetActionByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIpActionsGetActionByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIpActionsGetActionByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIpActionsGetActionByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIpActionsGetActionByIdResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryIpActionsGetActionByIdResponse value) throws IOException {
           ...
           @Override
           public PrimaryIpActionsGetActionByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIpActionsGetActionByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIpActionsGetActionByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIpActionsGetActionByIdResponse
  * @throws IOException if the JSON string is invalid with respect to PrimaryIpActionsGetActionByIdResponse
  */
  public static PrimaryIpActionsGetActionByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIpActionsGetActionByIdResponse.class);
  }

 /**
  * Convert an instance of PrimaryIpActionsGetActionByIdResponse to an JSON string
  *
  * @return JSON string
  */
