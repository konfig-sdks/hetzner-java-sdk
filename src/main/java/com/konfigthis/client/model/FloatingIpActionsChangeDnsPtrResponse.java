...
import com.konfigthis.client.model.ActionProperty10;
...
public class FloatingIpActionsChangeDnsPtrResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty10 action;

  public FloatingIpActionsChangeDnsPtrResponse() {
  }

  public FloatingIpActionsChangeDnsPtrResponse action(ActionProperty10 action) {
  ...
  **/
  ...
  public ActionProperty10 getAction() {
    return action;
  }


  public void setAction(ActionProperty10 action) {
   ...
   * @return the FloatingIpActionsChangeDnsPtrResponse instance itself
   */
  public FloatingIpActionsChangeDnsPtrResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpActionsChangeDnsPtrResponse floatingIpActionsChangeDnsPtrResponse = (FloatingIpActionsChangeDnsPtrResponse) o;
    return Objects.equals(this.action, floatingIpActionsChangeDnsPtrResponse.action)&&
        Objects.equals(this.additionalProperties, floatingIpActionsChangeDnsPtrResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpActionsChangeDnsPtrResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionsChangeDnsPtrResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionsChangeDnsPtrResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionsChangeDnsPtrResponse is not found in the empty JSON string", FloatingIpActionsChangeDnsPtrResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionsChangeDnsPtrResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty10.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionsChangeDnsPtrResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionsChangeDnsPtrResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionsChangeDnsPtrResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionsChangeDnsPtrResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionsChangeDnsPtrResponse>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionsChangeDnsPtrResponse value) throws IOException {
           ...
           @Override
           public FloatingIpActionsChangeDnsPtrResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionsChangeDnsPtrResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionsChangeDnsPtrResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionsChangeDnsPtrResponse
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionsChangeDnsPtrResponse
  */
  public static FloatingIpActionsChangeDnsPtrResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionsChangeDnsPtrResponse.class);
  }

 /**
  * Convert an instance of FloatingIpActionsChangeDnsPtrResponse to an JSON string
  *
  * @return JSON string
  */
