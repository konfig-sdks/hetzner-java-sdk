...
public class LoadBalancerTargetServerProperty {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty() {
  }

  public LoadBalancerTargetServerProperty id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty instance itself
   */
  public LoadBalancerTargetServerProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty loadBalancerTargetServerProperty = (LoadBalancerTargetServerProperty) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty is not found in the empty JSON string", LoadBalancerTargetServerProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty
  */
  public static LoadBalancerTargetServerProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty to an JSON string
  *
  * @return JSON string
  */
