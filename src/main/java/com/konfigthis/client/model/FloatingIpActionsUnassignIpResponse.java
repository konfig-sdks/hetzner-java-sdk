...
import com.konfigthis.client.model.ActionProperty12;
...
public class FloatingIpActionsUnassignIpResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty12 action;

  public FloatingIpActionsUnassignIpResponse() {
  }

  public FloatingIpActionsUnassignIpResponse action(ActionProperty12 action) {
  ...
  **/
  ...
  public ActionProperty12 getAction() {
    return action;
  }


  public void setAction(ActionProperty12 action) {
   ...
   * @return the FloatingIpActionsUnassignIpResponse instance itself
   */
  public FloatingIpActionsUnassignIpResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpActionsUnassignIpResponse floatingIpActionsUnassignIpResponse = (FloatingIpActionsUnassignIpResponse) o;
    return Objects.equals(this.action, floatingIpActionsUnassignIpResponse.action)&&
        Objects.equals(this.additionalProperties, floatingIpActionsUnassignIpResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpActionsUnassignIpResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionsUnassignIpResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionsUnassignIpResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionsUnassignIpResponse is not found in the empty JSON string", FloatingIpActionsUnassignIpResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionsUnassignIpResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty12.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionsUnassignIpResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionsUnassignIpResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionsUnassignIpResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionsUnassignIpResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionsUnassignIpResponse>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionsUnassignIpResponse value) throws IOException {
           ...
           @Override
           public FloatingIpActionsUnassignIpResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionsUnassignIpResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionsUnassignIpResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionsUnassignIpResponse
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionsUnassignIpResponse
  */
  public static FloatingIpActionsUnassignIpResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionsUnassignIpResponse.class);
  }

 /**
  * Convert an instance of FloatingIpActionsUnassignIpResponse to an JSON string
  *
  * @return JSON string
  */
