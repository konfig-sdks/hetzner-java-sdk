...
import com.konfigthis.client.model.Action17Error;
import com.konfigthis.client.model.Action17ResourcesInner;
...
public class Action17 {
  ...
  private List<Action17ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action17 command(String command) {
  ...
  **/
  ...
  public Action17 error(Action17Error error) {
  ...
  **/
  ...
  public Action17Error getError() {
    return error;
  }


  public void setError(Action17Error error) {
  ...
  public Action17 finished(String finished) {
  ...
  **/
  ...
  public Action17 progress(Integer progress) {
  ...
  **/
  ...
  public Action17 resources(List<Action17ResourcesInner> resources) {
  ...
  public Action17 addResourcesItem(Action17ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action17ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action17ResourcesInner> resources) {
  ...
  public Action17 started(String started) {
  ...
  **/
  ...
  public Action17 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action17 instance itself
   */
  public Action17 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action17 action17 = (Action17) o;
    return Objects.equals(this.command, action17.command) &&
        Objects.equals(this.error, action17.error) &&
        Objects.equals(this.finished, action17.finished) &&
        Objects.equals(this.id, action17.id) &&
        Objects.equals(this.progress, action17.progress) &&
        Objects.equals(this.resources, action17.resources) &&
        Objects.equals(this.started, action17.started) &&
        Objects.equals(this.status, action17.status)&&
        Objects.equals(this.additionalProperties, action17.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action17
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action17.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action17 is not found in the empty JSON string", Action17.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action17.openapiRequiredFields) {
      ...
      Action17Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action17ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action17.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action17' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action17> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action17.class));

       return (TypeAdapter<T>) new TypeAdapter<Action17>() {
           @Override
           public void write(JsonWriter out, Action17 value) throws IOException {
           ...
           @Override
           public Action17 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action17 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action17 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action17
  * @throws IOException if the JSON string is invalid with respect to Action17
  */
  public static Action17 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action17.class);
  }

 /**
  * Convert an instance of Action17 to an JSON string
  *
  * @return JSON string
  */
