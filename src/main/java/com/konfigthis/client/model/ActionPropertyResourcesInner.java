...
/**
 * ActionPropertyResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionPropertyResourcesInner {
  ...
  public ActionPropertyResourcesInner() {
  }

  public ActionPropertyResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionPropertyResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionPropertyResourcesInner instance itself
   */
  public ActionPropertyResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionPropertyResourcesInner actionPropertyResourcesInner = (ActionPropertyResourcesInner) o;
    return Objects.equals(this.id, actionPropertyResourcesInner.id) &&
        Objects.equals(this.type, actionPropertyResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionPropertyResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionPropertyResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionPropertyResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionPropertyResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionPropertyResourcesInner is not found in the empty JSON string", ActionPropertyResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionPropertyResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionPropertyResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionPropertyResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionPropertyResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionPropertyResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionPropertyResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionPropertyResourcesInner value) throws IOException {
           ...
           @Override
           public ActionPropertyResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionPropertyResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionPropertyResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionPropertyResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionPropertyResourcesInner
  */
  public static ActionPropertyResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionPropertyResourcesInner.class);
  }

 /**
  * Convert an instance of ActionPropertyResourcesInner to an JSON string
  *
  * @return JSON string
  */
