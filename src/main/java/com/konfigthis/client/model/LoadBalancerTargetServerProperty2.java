...
public class LoadBalancerTargetServerProperty2 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty2() {
  }

  public LoadBalancerTargetServerProperty2 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty2 instance itself
   */
  public LoadBalancerTargetServerProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty2 loadBalancerTargetServerProperty2 = (LoadBalancerTargetServerProperty2) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty2.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty2 is not found in the empty JSON string", LoadBalancerTargetServerProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty2>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty2 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty2
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty2
  */
  public static LoadBalancerTargetServerProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty2.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty2 to an JSON string
  *
  * @return JSON string
  */
