...
import com.konfigthis.client.model.ActionProperty72;
...
public class ServerActionsGracefulShutdownResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty72 action;

  public ServerActionsGracefulShutdownResponse() {
  }

  public ServerActionsGracefulShutdownResponse action(ActionProperty72 action) {
  ...
  **/
  ...
  public ActionProperty72 getAction() {
    return action;
  }


  public void setAction(ActionProperty72 action) {
   ...
   * @return the ServerActionsGracefulShutdownResponse instance itself
   */
  public ServerActionsGracefulShutdownResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsGracefulShutdownResponse serverActionsGracefulShutdownResponse = (ServerActionsGracefulShutdownResponse) o;
    return Objects.equals(this.action, serverActionsGracefulShutdownResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsGracefulShutdownResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsGracefulShutdownResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsGracefulShutdownResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsGracefulShutdownResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsGracefulShutdownResponse is not found in the empty JSON string", ServerActionsGracefulShutdownResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsGracefulShutdownResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty72.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsGracefulShutdownResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsGracefulShutdownResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsGracefulShutdownResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsGracefulShutdownResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsGracefulShutdownResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsGracefulShutdownResponse value) throws IOException {
           ...
           @Override
           public ServerActionsGracefulShutdownResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsGracefulShutdownResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsGracefulShutdownResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsGracefulShutdownResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsGracefulShutdownResponse
  */
  public static ServerActionsGracefulShutdownResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsGracefulShutdownResponse.class);
  }

 /**
  * Convert an instance of ServerActionsGracefulShutdownResponse to an JSON string
  *
  * @return JSON string
  */
