...
import com.konfigthis.client.model.ActionProperty64Error;
import com.konfigthis.client.model.ActionProperty64ResourcesInner;
...
public class ActionProperty64 {
  ...
  private ActionProperty64Error error;
  ...
  private List<ActionProperty64ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty64() {
  }

  public ActionProperty64 command(String command) {
  ...
  **/
  ...
  public ActionProperty64 error(ActionProperty64Error error) {
  ...
  **/
  ...
  public ActionProperty64Error getError() {
    return error;
  }


  public void setError(ActionProperty64Error error) {
  ...
  public ActionProperty64 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty64 id(Long id) {
  ...
  **/
  ...
  public ActionProperty64 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty64 resources(List<ActionProperty64ResourcesInner> resources) {
  ...
  public ActionProperty64 addResourcesItem(ActionProperty64ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty64ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty64ResourcesInner> resources) {
  ...
  public ActionProperty64 started(String started) {
  ...
  **/
  ...
  public ActionProperty64 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty64 instance itself
   */
  public ActionProperty64 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty64 actionProperty64 = (ActionProperty64) o;
    return Objects.equals(this.command, actionProperty64.command) &&
        Objects.equals(this.error, actionProperty64.error) &&
        Objects.equals(this.finished, actionProperty64.finished) &&
        Objects.equals(this.id, actionProperty64.id) &&
        Objects.equals(this.progress, actionProperty64.progress) &&
        Objects.equals(this.resources, actionProperty64.resources) &&
        Objects.equals(this.started, actionProperty64.started) &&
        Objects.equals(this.status, actionProperty64.status)&&
        Objects.equals(this.additionalProperties, actionProperty64.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty64 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty64
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty64.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty64 is not found in the empty JSON string", ActionProperty64.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty64.openapiRequiredFields) {
      ...
      ActionProperty64Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty64ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty64.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty64' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty64> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty64.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty64>() {
           @Override
           public void write(JsonWriter out, ActionProperty64 value) throws IOException {
           ...
           @Override
           public ActionProperty64 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty64 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty64 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty64
  * @throws IOException if the JSON string is invalid with respect to ActionProperty64
  */
  public static ActionProperty64 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty64.class);
  }

 /**
  * Convert an instance of ActionProperty64 to an JSON string
  *
  * @return JSON string
  */
