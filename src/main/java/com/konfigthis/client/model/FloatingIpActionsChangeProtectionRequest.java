...
public class FloatingIpActionsChangeProtectionRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public FloatingIpActionsChangeProtectionRequest() {
  }

  public FloatingIpActionsChangeProtectionRequest delete(Boolean delete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "If true, prevents the Floating IP from being deleted")
   ...
   * @return the FloatingIpActionsChangeProtectionRequest instance itself
   */
  public FloatingIpActionsChangeProtectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpActionsChangeProtectionRequest floatingIpActionsChangeProtectionRequest = (FloatingIpActionsChangeProtectionRequest) o;
    return Objects.equals(this.delete, floatingIpActionsChangeProtectionRequest.delete)&&
        Objects.equals(this.additionalProperties, floatingIpActionsChangeProtectionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpActionsChangeProtectionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionsChangeProtectionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionsChangeProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionsChangeProtectionRequest is not found in the empty JSON string", FloatingIpActionsChangeProtectionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionsChangeProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionsChangeProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionsChangeProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionsChangeProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionsChangeProtectionRequest>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionsChangeProtectionRequest value) throws IOException {
           ...
           @Override
           public FloatingIpActionsChangeProtectionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionsChangeProtectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionsChangeProtectionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionsChangeProtectionRequest
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionsChangeProtectionRequest
  */
  public static FloatingIpActionsChangeProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionsChangeProtectionRequest.class);
  }

 /**
  * Convert an instance of FloatingIpActionsChangeProtectionRequest to an JSON string
  *
  * @return JSON string
  */
