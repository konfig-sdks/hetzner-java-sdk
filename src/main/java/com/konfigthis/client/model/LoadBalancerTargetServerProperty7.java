...
public class LoadBalancerTargetServerProperty7 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty7() {
  }

  public LoadBalancerTargetServerProperty7 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty7 instance itself
   */
  public LoadBalancerTargetServerProperty7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty7 loadBalancerTargetServerProperty7 = (LoadBalancerTargetServerProperty7) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty7.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty7.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty7 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty7 is not found in the empty JSON string", LoadBalancerTargetServerProperty7.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty7.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty7.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty7>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty7 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty7
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty7
  */
  public static LoadBalancerTargetServerProperty7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty7.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty7 to an JSON string
  *
  * @return JSON string
  */
