...
public class ActionProperty31Error {
  ...
  public ActionProperty31Error() {
  }

  public ActionProperty31Error code(String code) {
  ...
  **/
  ...
  public ActionProperty31Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty31Error instance itself
   */
  public ActionProperty31Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty31Error actionProperty31Error = (ActionProperty31Error) o;
    return Objects.equals(this.code, actionProperty31Error.code) &&
        Objects.equals(this.message, actionProperty31Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty31Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty31Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty31Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty31Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty31Error is not found in the empty JSON string", ActionProperty31Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty31Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty31Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty31Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty31Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty31Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty31Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty31Error value) throws IOException {
           ...
           @Override
           public ActionProperty31Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty31Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty31Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty31Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty31Error
  */
  public static ActionProperty31Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty31Error.class);
  }

 /**
  * Convert an instance of ActionProperty31Error to an JSON string
  *
  * @return JSON string
  */
