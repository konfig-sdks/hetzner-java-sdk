...
/**
 * ActionProperty67ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty67ResourcesInner {
  ...
  public ActionProperty67ResourcesInner() {
  }

  public ActionProperty67ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty67ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty67ResourcesInner instance itself
   */
  public ActionProperty67ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty67ResourcesInner actionProperty67ResourcesInner = (ActionProperty67ResourcesInner) o;
    return Objects.equals(this.id, actionProperty67ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty67ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty67ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty67ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty67ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty67ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty67ResourcesInner is not found in the empty JSON string", ActionProperty67ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty67ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty67ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty67ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty67ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty67ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty67ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty67ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty67ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty67ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty67ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty67ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty67ResourcesInner
  */
  public static ActionProperty67ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty67ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty67ResourcesInner to an JSON string
  *
  * @return JSON string
  */
