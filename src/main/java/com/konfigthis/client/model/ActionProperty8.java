...
import com.konfigthis.client.model.ActionProperty8Error;
import com.konfigthis.client.model.ActionProperty8ResourcesInner;
...
public class ActionProperty8 {
  ...
  private ActionProperty8Error error;
  ...
  private List<ActionProperty8ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty8() {
  }

  public ActionProperty8 command(String command) {
  ...
  **/
  ...
  public ActionProperty8 error(ActionProperty8Error error) {
  ...
  **/
  ...
  public ActionProperty8Error getError() {
    return error;
  }


  public void setError(ActionProperty8Error error) {
  ...
  public ActionProperty8 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty8 id(Long id) {
  ...
  **/
  ...
  public ActionProperty8 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty8 resources(List<ActionProperty8ResourcesInner> resources) {
  ...
  public ActionProperty8 addResourcesItem(ActionProperty8ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty8ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty8ResourcesInner> resources) {
  ...
  public ActionProperty8 started(String started) {
  ...
  **/
  ...
  public ActionProperty8 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty8 instance itself
   */
  public ActionProperty8 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty8 actionProperty8 = (ActionProperty8) o;
    return Objects.equals(this.command, actionProperty8.command) &&
        Objects.equals(this.error, actionProperty8.error) &&
        Objects.equals(this.finished, actionProperty8.finished) &&
        Objects.equals(this.id, actionProperty8.id) &&
        Objects.equals(this.progress, actionProperty8.progress) &&
        Objects.equals(this.resources, actionProperty8.resources) &&
        Objects.equals(this.started, actionProperty8.started) &&
        Objects.equals(this.status, actionProperty8.status)&&
        Objects.equals(this.additionalProperties, actionProperty8.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty8 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty8 is not found in the empty JSON string", ActionProperty8.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty8.openapiRequiredFields) {
      ...
      ActionProperty8Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty8ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty8.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty8>() {
           @Override
           public void write(JsonWriter out, ActionProperty8 value) throws IOException {
           ...
           @Override
           public ActionProperty8 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty8 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty8
  * @throws IOException if the JSON string is invalid with respect to ActionProperty8
  */
  public static ActionProperty8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty8.class);
  }

 /**
  * Convert an instance of ActionProperty8 to an JSON string
  *
  * @return JSON string
  */
