...
public class Action14Error {
  ...
  public Action14Error() {
  }

  public Action14Error code(String code) {
  ...
  **/
  ...
  public Action14Error message(String message) {
  ...
  **/
   ...
   * @return the Action14Error instance itself
   */
  public Action14Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action14Error action14Error = (Action14Error) o;
    return Objects.equals(this.code, action14Error.code) &&
        Objects.equals(this.message, action14Error.message)&&
        Objects.equals(this.additionalProperties, action14Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action14Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action14Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action14Error is not found in the empty JSON string", Action14Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action14Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action14Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action14Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action14Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action14Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action14Error>() {
           @Override
           public void write(JsonWriter out, Action14Error value) throws IOException {
           ...
           @Override
           public Action14Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action14Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action14Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action14Error
  * @throws IOException if the JSON string is invalid with respect to Action14Error
  */
  public static Action14Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action14Error.class);
  }

 /**
  * Convert an instance of Action14Error to an JSON string
  *
  * @return JSON string
  */
