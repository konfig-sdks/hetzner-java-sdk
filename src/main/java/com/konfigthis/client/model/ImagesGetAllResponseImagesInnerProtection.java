...
public class ImagesGetAllResponseImagesInnerProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ImagesGetAllResponseImagesInnerProtection() {
  }

  public ImagesGetAllResponseImagesInnerProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the ImagesGetAllResponseImagesInnerProtection instance itself
   */
  public ImagesGetAllResponseImagesInnerProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesGetAllResponseImagesInnerProtection imagesGetAllResponseImagesInnerProtection = (ImagesGetAllResponseImagesInnerProtection) o;
    return Objects.equals(this.delete, imagesGetAllResponseImagesInnerProtection.delete)&&
        Objects.equals(this.additionalProperties, imagesGetAllResponseImagesInnerProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesGetAllResponseImagesInnerProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesGetAllResponseImagesInnerProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesGetAllResponseImagesInnerProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGetAllResponseImagesInnerProtection is not found in the empty JSON string", ImagesGetAllResponseImagesInnerProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesGetAllResponseImagesInnerProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGetAllResponseImagesInnerProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGetAllResponseImagesInnerProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGetAllResponseImagesInnerProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGetAllResponseImagesInnerProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGetAllResponseImagesInnerProtection>() {
           @Override
           public void write(JsonWriter out, ImagesGetAllResponseImagesInnerProtection value) throws IOException {
           ...
           @Override
           public ImagesGetAllResponseImagesInnerProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesGetAllResponseImagesInnerProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesGetAllResponseImagesInnerProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesGetAllResponseImagesInnerProtection
  * @throws IOException if the JSON string is invalid with respect to ImagesGetAllResponseImagesInnerProtection
  */
  public static ImagesGetAllResponseImagesInnerProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGetAllResponseImagesInnerProtection.class);
  }

 /**
  * Convert an instance of ImagesGetAllResponseImagesInnerProtection to an JSON string
  *
  * @return JSON string
  */
