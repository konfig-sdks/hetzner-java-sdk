...
public class Rule1 {
 ...
 public enum ProtocolEnum {
  ...
  public Rule1 description(String description) {
  ...
  **/
  ...
  public Rule1 destinationIps(List<String> destinationIps) {
  ...
  public Rule1 addDestinationIpsItem(String destinationIpsItem) {
  ...
  **/
  ...
  public Rule1 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public Rule1 protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public Rule1 sourceIps(List<String> sourceIps) {
  ...
  public Rule1 addSourceIpsItem(String sourceIpsItem) {
  ...
  **/
   ...
   * @return the Rule1 instance itself
   */
  public Rule1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Rule1 rule1 = (Rule1) o;
    return Objects.equals(this.description, rule1.description) &&
        Objects.equals(this.destinationIps, rule1.destinationIps) &&
        Objects.equals(this.direction, rule1.direction) &&
        Objects.equals(this.port, rule1.port) &&
        Objects.equals(this.protocol, rule1.protocol) &&
        Objects.equals(this.sourceIps, rule1.sourceIps)&&
        Objects.equals(this.additionalProperties, rule1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Rule1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Rule1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rule1 is not found in the empty JSON string", Rule1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rule1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rule1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rule1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rule1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rule1.class));

       return (TypeAdapter<T>) new TypeAdapter<Rule1>() {
           @Override
           public void write(JsonWriter out, Rule1 value) throws IOException {
           ...
           @Override
           public Rule1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Rule1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Rule1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Rule1
  * @throws IOException if the JSON string is invalid with respect to Rule1
  */
  public static Rule1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rule1.class);
  }

 /**
  * Convert an instance of Rule1 to an JSON string
  *
  * @return JSON string
  */
