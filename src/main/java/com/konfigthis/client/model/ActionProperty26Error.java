...
public class ActionProperty26Error {
  ...
  public ActionProperty26Error() {
  }

  public ActionProperty26Error code(String code) {
  ...
  **/
  ...
  public ActionProperty26Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty26Error instance itself
   */
  public ActionProperty26Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty26Error actionProperty26Error = (ActionProperty26Error) o;
    return Objects.equals(this.code, actionProperty26Error.code) &&
        Objects.equals(this.message, actionProperty26Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty26Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty26Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty26Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty26Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty26Error is not found in the empty JSON string", ActionProperty26Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty26Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty26Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty26Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty26Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty26Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty26Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty26Error value) throws IOException {
           ...
           @Override
           public ActionProperty26Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty26Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty26Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty26Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty26Error
  */
  public static ActionProperty26Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty26Error.class);
  }

 /**
  * Convert an instance of ActionProperty26Error to an JSON string
  *
  * @return JSON string
  */
