...
public class ActionProperty49Error {
  ...
  public ActionProperty49Error() {
  }

  public ActionProperty49Error code(String code) {
  ...
  **/
  ...
  public ActionProperty49Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty49Error instance itself
   */
  public ActionProperty49Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty49Error actionProperty49Error = (ActionProperty49Error) o;
    return Objects.equals(this.code, actionProperty49Error.code) &&
        Objects.equals(this.message, actionProperty49Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty49Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty49Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty49Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty49Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty49Error is not found in the empty JSON string", ActionProperty49Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty49Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty49Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty49Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty49Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty49Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty49Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty49Error value) throws IOException {
           ...
           @Override
           public ActionProperty49Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty49Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty49Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty49Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty49Error
  */
  public static ActionProperty49Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty49Error.class);
  }

 /**
  * Convert an instance of ActionProperty49Error to an JSON string
  *
  * @return JSON string
  */
