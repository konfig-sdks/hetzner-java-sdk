...
public class Action12Error {
  ...
  public Action12Error() {
  }

  public Action12Error code(String code) {
  ...
  **/
  ...
  public Action12Error message(String message) {
  ...
  **/
   ...
   * @return the Action12Error instance itself
   */
  public Action12Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action12Error action12Error = (Action12Error) o;
    return Objects.equals(this.code, action12Error.code) &&
        Objects.equals(this.message, action12Error.message)&&
        Objects.equals(this.additionalProperties, action12Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action12Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action12Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action12Error is not found in the empty JSON string", Action12Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action12Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action12Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action12Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action12Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action12Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action12Error>() {
           @Override
           public void write(JsonWriter out, Action12Error value) throws IOException {
           ...
           @Override
           public Action12Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action12Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action12Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action12Error
  * @throws IOException if the JSON string is invalid with respect to Action12Error
  */
  public static Action12Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action12Error.class);
  }

 /**
  * Convert an instance of Action12Error to an JSON string
  *
  * @return JSON string
  */
