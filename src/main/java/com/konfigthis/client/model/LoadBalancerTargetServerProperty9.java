 ...
 */
@ApiModel(description = "Server where the traffic should be routed to. Only present for target type \"server\".")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LoadBalancerTargetServerProperty9 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty9() {
  }

  public LoadBalancerTargetServerProperty9 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty9 instance itself
   */
  public LoadBalancerTargetServerProperty9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty9 loadBalancerTargetServerProperty9 = (LoadBalancerTargetServerProperty9) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty9.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty9.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty9 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty9 is not found in the empty JSON string", LoadBalancerTargetServerProperty9.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty9.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty9.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty9>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty9 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty9
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty9
  */
  public static LoadBalancerTargetServerProperty9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty9.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty9 to an JSON string
  *
  * @return JSON string
  */
