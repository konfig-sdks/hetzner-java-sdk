...
public class ActionProperty33Error {
  ...
  public ActionProperty33Error() {
  }

  public ActionProperty33Error code(String code) {
  ...
  **/
  ...
  public ActionProperty33Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty33Error instance itself
   */
  public ActionProperty33Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty33Error actionProperty33Error = (ActionProperty33Error) o;
    return Objects.equals(this.code, actionProperty33Error.code) &&
        Objects.equals(this.message, actionProperty33Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty33Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty33Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty33Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty33Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty33Error is not found in the empty JSON string", ActionProperty33Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty33Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty33Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty33Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty33Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty33Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty33Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty33Error value) throws IOException {
           ...
           @Override
           public ActionProperty33Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty33Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty33Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty33Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty33Error
  */
  public static ActionProperty33Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty33Error.class);
  }

 /**
  * Convert an instance of ActionProperty33Error to an JSON string
  *
  * @return JSON string
  */
