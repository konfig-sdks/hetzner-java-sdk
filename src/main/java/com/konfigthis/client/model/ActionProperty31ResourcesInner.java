...
/**
 * ActionProperty31ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty31ResourcesInner {
  ...
  public ActionProperty31ResourcesInner() {
  }

  public ActionProperty31ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty31ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty31ResourcesInner instance itself
   */
  public ActionProperty31ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty31ResourcesInner actionProperty31ResourcesInner = (ActionProperty31ResourcesInner) o;
    return Objects.equals(this.id, actionProperty31ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty31ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty31ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty31ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty31ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty31ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty31ResourcesInner is not found in the empty JSON string", ActionProperty31ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty31ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty31ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty31ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty31ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty31ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty31ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty31ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty31ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty31ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty31ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty31ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty31ResourcesInner
  */
  public static ActionProperty31ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty31ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty31ResourcesInner to an JSON string
  *
  * @return JSON string
  */
