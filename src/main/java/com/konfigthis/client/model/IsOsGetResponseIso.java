...
import com.konfigthis.client.model.DeprecationInfoProperty1;
...
public class IsOsGetResponseIso {
 ...
 public enum ArchitectureEnum {
  ...
  private DeprecationInfoProperty1 deprecation;
 ...
 public enum TypeEnum {
  ...
  public IsOsGetResponseIso() {
  }

  public IsOsGetResponseIso description(String description) {
  ...
  **/
  ...
  public IsOsGetResponseIso architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public IsOsGetResponseIso deprecation(DeprecationInfoProperty1 deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty1 getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty1 deprecation) {
  ...
  public IsOsGetResponseIso id(Long id) {
  ...
  **/
  ...
  public IsOsGetResponseIso name(String name) {
  ...
  **/
  ...
  public IsOsGetResponseIso type(TypeEnum type) {
  ...
  **/
   ...
   * @return the IsOsGetResponseIso instance itself
   */
  public IsOsGetResponseIso putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IsOsGetResponseIso isOsGetResponseIso = (IsOsGetResponseIso) o;
    return Objects.equals(this.description, isOsGetResponseIso.description) &&
        Objects.equals(this.architecture, isOsGetResponseIso.architecture) &&
        Objects.equals(this.deprecation, isOsGetResponseIso.deprecation) &&
        Objects.equals(this.id, isOsGetResponseIso.id) &&
        Objects.equals(this.name, isOsGetResponseIso.name) &&
        Objects.equals(this.type, isOsGetResponseIso.type)&&
        Objects.equals(this.additionalProperties, isOsGetResponseIso.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsOsGetResponseIso {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IsOsGetResponseIso
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IsOsGetResponseIso.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsOsGetResponseIso is not found in the empty JSON string", IsOsGetResponseIso.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsOsGetResponseIso.openapiRequiredFields) {
      ...
      DeprecationInfoProperty1.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsOsGetResponseIso.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsOsGetResponseIso' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsOsGetResponseIso> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsOsGetResponseIso.class));

       return (TypeAdapter<T>) new TypeAdapter<IsOsGetResponseIso>() {
           @Override
           public void write(JsonWriter out, IsOsGetResponseIso value) throws IOException {
           ...
           @Override
           public IsOsGetResponseIso read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IsOsGetResponseIso instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IsOsGetResponseIso given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IsOsGetResponseIso
  * @throws IOException if the JSON string is invalid with respect to IsOsGetResponseIso
  */
  public static IsOsGetResponseIso fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsOsGetResponseIso.class);
  }

 /**
  * Convert an instance of IsOsGetResponseIso to an JSON string
  *
  * @return JSON string
  */
