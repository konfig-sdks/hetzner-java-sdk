...
public class ActionPropertyError {
  ...
  public ActionPropertyError() {
  }

  public ActionPropertyError code(String code) {
  ...
  **/
  ...
  public ActionPropertyError message(String message) {
  ...
  **/
   ...
   * @return the ActionPropertyError instance itself
   */
  public ActionPropertyError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionPropertyError actionPropertyError = (ActionPropertyError) o;
    return Objects.equals(this.code, actionPropertyError.code) &&
        Objects.equals(this.message, actionPropertyError.message)&&
        Objects.equals(this.additionalProperties, actionPropertyError.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionPropertyError {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionPropertyError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionPropertyError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionPropertyError is not found in the empty JSON string", ActionPropertyError.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionPropertyError.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionPropertyError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionPropertyError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionPropertyError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionPropertyError.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionPropertyError>() {
           @Override
           public void write(JsonWriter out, ActionPropertyError value) throws IOException {
           ...
           @Override
           public ActionPropertyError read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionPropertyError instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionPropertyError given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionPropertyError
  * @throws IOException if the JSON string is invalid with respect to ActionPropertyError
  */
  public static ActionPropertyError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionPropertyError.class);
  }

 /**
  * Convert an instance of ActionPropertyError to an JSON string
  *
  * @return JSON string
  */
