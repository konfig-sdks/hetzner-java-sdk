...
import com.konfigthis.client.model.ActionProperty70Error;
import com.konfigthis.client.model.ActionProperty70ResourcesInner;
...
public class ActionProperty70 {
  ...
  private ActionProperty70Error error;
  ...
  private List<ActionProperty70ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty70() {
  }

  public ActionProperty70 command(String command) {
  ...
  **/
  ...
  public ActionProperty70 error(ActionProperty70Error error) {
  ...
  **/
  ...
  public ActionProperty70Error getError() {
    return error;
  }


  public void setError(ActionProperty70Error error) {
  ...
  public ActionProperty70 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty70 id(Long id) {
  ...
  **/
  ...
  public ActionProperty70 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty70 resources(List<ActionProperty70ResourcesInner> resources) {
  ...
  public ActionProperty70 addResourcesItem(ActionProperty70ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty70ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty70ResourcesInner> resources) {
  ...
  public ActionProperty70 started(String started) {
  ...
  **/
  ...
  public ActionProperty70 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty70 instance itself
   */
  public ActionProperty70 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty70 actionProperty70 = (ActionProperty70) o;
    return Objects.equals(this.command, actionProperty70.command) &&
        Objects.equals(this.error, actionProperty70.error) &&
        Objects.equals(this.finished, actionProperty70.finished) &&
        Objects.equals(this.id, actionProperty70.id) &&
        Objects.equals(this.progress, actionProperty70.progress) &&
        Objects.equals(this.resources, actionProperty70.resources) &&
        Objects.equals(this.started, actionProperty70.started) &&
        Objects.equals(this.status, actionProperty70.status)&&
        Objects.equals(this.additionalProperties, actionProperty70.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty70 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty70
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty70.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty70 is not found in the empty JSON string", ActionProperty70.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty70.openapiRequiredFields) {
      ...
      ActionProperty70Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty70ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty70.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty70' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty70> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty70.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty70>() {
           @Override
           public void write(JsonWriter out, ActionProperty70 value) throws IOException {
           ...
           @Override
           public ActionProperty70 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty70 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty70 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty70
  * @throws IOException if the JSON string is invalid with respect to ActionProperty70
  */
  public static ActionProperty70 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty70.class);
  }

 /**
  * Convert an instance of ActionProperty70 to an JSON string
  *
  * @return JSON string
  */
