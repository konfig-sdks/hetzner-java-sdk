...
/**
 * PrimaryIPProperty2DnsPtrInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PrimaryIPProperty2DnsPtrInner {
  ...
  public PrimaryIPProperty2DnsPtrInner() {
  }

  public PrimaryIPProperty2DnsPtrInner dnsPtr(String dnsPtr) {
  ...
  **/
  ...
  public PrimaryIPProperty2DnsPtrInner ip(String ip) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "131.232.99.1", required = true, value = "Single IPv4 or IPv6 address")
   ...
   * @return the PrimaryIPProperty2DnsPtrInner instance itself
   */
  public PrimaryIPProperty2DnsPtrInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPProperty2DnsPtrInner primaryIPProperty2DnsPtrInner = (PrimaryIPProperty2DnsPtrInner) o;
    return Objects.equals(this.dnsPtr, primaryIPProperty2DnsPtrInner.dnsPtr) &&
        Objects.equals(this.ip, primaryIPProperty2DnsPtrInner.ip)&&
        Objects.equals(this.additionalProperties, primaryIPProperty2DnsPtrInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPProperty2DnsPtrInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPProperty2DnsPtrInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPProperty2DnsPtrInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPProperty2DnsPtrInner is not found in the empty JSON string", PrimaryIPProperty2DnsPtrInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPProperty2DnsPtrInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPProperty2DnsPtrInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPProperty2DnsPtrInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPProperty2DnsPtrInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPProperty2DnsPtrInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPProperty2DnsPtrInner>() {
           @Override
           public void write(JsonWriter out, PrimaryIPProperty2DnsPtrInner value) throws IOException {
           ...
           @Override
           public PrimaryIPProperty2DnsPtrInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPProperty2DnsPtrInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPProperty2DnsPtrInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPProperty2DnsPtrInner
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPProperty2DnsPtrInner
  */
  public static PrimaryIPProperty2DnsPtrInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPProperty2DnsPtrInner.class);
  }

 /**
  * Convert an instance of PrimaryIPProperty2DnsPtrInner to an JSON string
  *
  * @return JSON string
  */
