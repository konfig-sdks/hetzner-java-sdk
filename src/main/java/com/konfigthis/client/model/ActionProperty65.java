...
import com.konfigthis.client.model.ActionProperty65Error;
import com.konfigthis.client.model.ActionProperty65ResourcesInner;
...
public class ActionProperty65 {
  ...
  private ActionProperty65Error error;
  ...
  private List<ActionProperty65ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty65() {
  }

  public ActionProperty65 command(String command) {
  ...
  **/
  ...
  public ActionProperty65 error(ActionProperty65Error error) {
  ...
  **/
  ...
  public ActionProperty65Error getError() {
    return error;
  }


  public void setError(ActionProperty65Error error) {
  ...
  public ActionProperty65 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty65 id(Long id) {
  ...
  **/
  ...
  public ActionProperty65 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty65 resources(List<ActionProperty65ResourcesInner> resources) {
  ...
  public ActionProperty65 addResourcesItem(ActionProperty65ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty65ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty65ResourcesInner> resources) {
  ...
  public ActionProperty65 started(String started) {
  ...
  **/
  ...
  public ActionProperty65 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty65 instance itself
   */
  public ActionProperty65 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty65 actionProperty65 = (ActionProperty65) o;
    return Objects.equals(this.command, actionProperty65.command) &&
        Objects.equals(this.error, actionProperty65.error) &&
        Objects.equals(this.finished, actionProperty65.finished) &&
        Objects.equals(this.id, actionProperty65.id) &&
        Objects.equals(this.progress, actionProperty65.progress) &&
        Objects.equals(this.resources, actionProperty65.resources) &&
        Objects.equals(this.started, actionProperty65.started) &&
        Objects.equals(this.status, actionProperty65.status)&&
        Objects.equals(this.additionalProperties, actionProperty65.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty65 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty65
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty65.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty65 is not found in the empty JSON string", ActionProperty65.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty65.openapiRequiredFields) {
      ...
      ActionProperty65Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty65ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty65.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty65' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty65> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty65.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty65>() {
           @Override
           public void write(JsonWriter out, ActionProperty65 value) throws IOException {
           ...
           @Override
           public ActionProperty65 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty65 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty65 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty65
  * @throws IOException if the JSON string is invalid with respect to ActionProperty65
  */
  public static ActionProperty65 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty65.class);
  }

 /**
  * Convert an instance of ActionProperty65 to an JSON string
  *
  * @return JSON string
  */
