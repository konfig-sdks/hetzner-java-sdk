...
public class ActionProperty2Error {
  ...
  public ActionProperty2Error() {
  }

  public ActionProperty2Error code(String code) {
  ...
  **/
  ...
  public ActionProperty2Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty2Error instance itself
   */
  public ActionProperty2Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty2Error actionProperty2Error = (ActionProperty2Error) o;
    return Objects.equals(this.code, actionProperty2Error.code) &&
        Objects.equals(this.message, actionProperty2Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty2Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty2Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty2Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty2Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty2Error is not found in the empty JSON string", ActionProperty2Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty2Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty2Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty2Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty2Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty2Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty2Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty2Error value) throws IOException {
           ...
           @Override
           public ActionProperty2Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty2Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty2Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty2Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty2Error
  */
  public static ActionProperty2Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty2Error.class);
  }

 /**
  * Convert an instance of ActionProperty2Error to an JSON string
  *
  * @return JSON string
  */
