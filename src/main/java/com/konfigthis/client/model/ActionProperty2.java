...
import com.konfigthis.client.model.ActionProperty2Error;
import com.konfigthis.client.model.ActionProperty2ResourcesInner;
...
public class ActionProperty2 {
  ...
  private ActionProperty2Error error;
  ...
  private List<ActionProperty2ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty2() {
  }

  public ActionProperty2 command(String command) {
  ...
  **/
  ...
  public ActionProperty2 error(ActionProperty2Error error) {
  ...
  **/
  ...
  public ActionProperty2Error getError() {
    return error;
  }


  public void setError(ActionProperty2Error error) {
  ...
  public ActionProperty2 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty2 id(Long id) {
  ...
  **/
  ...
  public ActionProperty2 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty2 resources(List<ActionProperty2ResourcesInner> resources) {
  ...
  public ActionProperty2 addResourcesItem(ActionProperty2ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty2ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty2ResourcesInner> resources) {
  ...
  public ActionProperty2 started(String started) {
  ...
  **/
  ...
  public ActionProperty2 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty2 instance itself
   */
  public ActionProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty2 actionProperty2 = (ActionProperty2) o;
    return Objects.equals(this.command, actionProperty2.command) &&
        Objects.equals(this.error, actionProperty2.error) &&
        Objects.equals(this.finished, actionProperty2.finished) &&
        Objects.equals(this.id, actionProperty2.id) &&
        Objects.equals(this.progress, actionProperty2.progress) &&
        Objects.equals(this.resources, actionProperty2.resources) &&
        Objects.equals(this.started, actionProperty2.started) &&
        Objects.equals(this.status, actionProperty2.status)&&
        Objects.equals(this.additionalProperties, actionProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty2 is not found in the empty JSON string", ActionProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty2.openapiRequiredFields) {
      ...
      ActionProperty2Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty2ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty2>() {
           @Override
           public void write(JsonWriter out, ActionProperty2 value) throws IOException {
           ...
           @Override
           public ActionProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty2
  * @throws IOException if the JSON string is invalid with respect to ActionProperty2
  */
  public static ActionProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty2.class);
  }

 /**
  * Convert an instance of ActionProperty2 to an JSON string
  *
  * @return JSON string
  */
