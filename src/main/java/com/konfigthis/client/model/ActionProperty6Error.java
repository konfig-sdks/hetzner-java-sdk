...
public class ActionProperty6Error {
  ...
  public ActionProperty6Error() {
  }

  public ActionProperty6Error code(String code) {
  ...
  **/
  ...
  public ActionProperty6Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty6Error instance itself
   */
  public ActionProperty6Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty6Error actionProperty6Error = (ActionProperty6Error) o;
    return Objects.equals(this.code, actionProperty6Error.code) &&
        Objects.equals(this.message, actionProperty6Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty6Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty6Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty6Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty6Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty6Error is not found in the empty JSON string", ActionProperty6Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty6Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty6Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty6Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty6Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty6Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty6Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty6Error value) throws IOException {
           ...
           @Override
           public ActionProperty6Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty6Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty6Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty6Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty6Error
  */
  public static ActionProperty6Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty6Error.class);
  }

 /**
  * Convert an instance of ActionProperty6Error to an JSON string
  *
  * @return JSON string
  */
