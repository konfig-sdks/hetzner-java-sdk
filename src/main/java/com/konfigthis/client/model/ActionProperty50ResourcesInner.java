...
/**
 * ActionProperty50ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty50ResourcesInner {
  ...
  public ActionProperty50ResourcesInner() {
  }

  public ActionProperty50ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty50ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty50ResourcesInner instance itself
   */
  public ActionProperty50ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty50ResourcesInner actionProperty50ResourcesInner = (ActionProperty50ResourcesInner) o;
    return Objects.equals(this.id, actionProperty50ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty50ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty50ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty50ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty50ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty50ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty50ResourcesInner is not found in the empty JSON string", ActionProperty50ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty50ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty50ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty50ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty50ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty50ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty50ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty50ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty50ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty50ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty50ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty50ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty50ResourcesInner
  */
  public static ActionProperty50ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty50ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty50ResourcesInner to an JSON string
  *
  * @return JSON string
  */
