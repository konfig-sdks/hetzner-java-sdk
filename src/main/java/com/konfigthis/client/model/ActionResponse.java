...
import com.konfigthis.client.model.ActionProperty;
...
public class ActionResponse {
  ...
  public ActionResponse action(ActionProperty action) {
  ...
  **/
  ...
  public void setAction(ActionProperty action) {
   ...
   * @return the ActionResponse instance itself
   */
  public ActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, actionResponse.action)&&
        Objects.equals(this.additionalProperties, actionResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      ActionProperty.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ActionResponse>() {
           ...
           public ActionResponse read(JsonReader in) throws IOException {
             ...
             ActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
