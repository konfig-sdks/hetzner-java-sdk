...
/**
 * ActionProperty55ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty55ResourcesInner {
  ...
  public ActionProperty55ResourcesInner() {
  }

  public ActionProperty55ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty55ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty55ResourcesInner instance itself
   */
  public ActionProperty55ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty55ResourcesInner actionProperty55ResourcesInner = (ActionProperty55ResourcesInner) o;
    return Objects.equals(this.id, actionProperty55ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty55ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty55ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty55ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty55ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty55ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty55ResourcesInner is not found in the empty JSON string", ActionProperty55ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty55ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty55ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty55ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty55ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty55ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty55ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty55ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty55ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty55ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty55ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty55ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty55ResourcesInner
  */
  public static ActionProperty55ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty55ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty55ResourcesInner to an JSON string
  *
  * @return JSON string
  */
