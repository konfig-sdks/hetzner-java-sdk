...
public class ServerActionsDetachFromNetworkRequest {
  public static final String SERIALIZED_NAME_NETWORK = "network";
  @SerializedName(SERIALIZED_NAME_NETWORK)
  private Long network;

  public ServerActionsDetachFromNetworkRequest() {
  }

  public ServerActionsDetachFromNetworkRequest network(Long network) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4711", required = true, value = "ID of an existing network to detach the Server from")
   ...
   * @return the ServerActionsDetachFromNetworkRequest instance itself
   */
  public ServerActionsDetachFromNetworkRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsDetachFromNetworkRequest serverActionsDetachFromNetworkRequest = (ServerActionsDetachFromNetworkRequest) o;
    return Objects.equals(this.network, serverActionsDetachFromNetworkRequest.network)&&
        Objects.equals(this.additionalProperties, serverActionsDetachFromNetworkRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsDetachFromNetworkRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsDetachFromNetworkRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsDetachFromNetworkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsDetachFromNetworkRequest is not found in the empty JSON string", ServerActionsDetachFromNetworkRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsDetachFromNetworkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsDetachFromNetworkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsDetachFromNetworkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsDetachFromNetworkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsDetachFromNetworkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsDetachFromNetworkRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsDetachFromNetworkRequest value) throws IOException {
           ...
           @Override
           public ServerActionsDetachFromNetworkRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsDetachFromNetworkRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsDetachFromNetworkRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsDetachFromNetworkRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsDetachFromNetworkRequest
  */
  public static ServerActionsDetachFromNetworkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsDetachFromNetworkRequest.class);
  }

 /**
  * Convert an instance of ServerActionsDetachFromNetworkRequest to an JSON string
  *
  * @return JSON string
  */
