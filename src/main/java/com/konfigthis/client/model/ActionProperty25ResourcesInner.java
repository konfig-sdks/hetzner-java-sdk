...
/**
 * ActionProperty25ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty25ResourcesInner {
  ...
  public ActionProperty25ResourcesInner() {
  }

  public ActionProperty25ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty25ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty25ResourcesInner instance itself
   */
  public ActionProperty25ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty25ResourcesInner actionProperty25ResourcesInner = (ActionProperty25ResourcesInner) o;
    return Objects.equals(this.id, actionProperty25ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty25ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty25ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty25ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty25ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty25ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty25ResourcesInner is not found in the empty JSON string", ActionProperty25ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty25ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty25ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty25ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty25ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty25ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty25ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty25ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty25ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty25ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty25ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty25ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty25ResourcesInner
  */
  public static ActionProperty25ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty25ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty25ResourcesInner to an JSON string
  *
  * @return JSON string
  */
