...
import com.konfigthis.client.model.PlacementGroupProperty1;
...
public class PlacementGroupsGetByIdResponse {
  public static final String SERIALIZED_NAME_PLACEMENT_GROUP = "placement_group";
  @SerializedName(SERIALIZED_NAME_PLACEMENT_GROUP)
  private PlacementGroupProperty1 placementGroup;

  public PlacementGroupsGetByIdResponse() {
  }

  public PlacementGroupsGetByIdResponse placementGroup(PlacementGroupProperty1 placementGroup) {
  ...
  **/
  ...
  public PlacementGroupProperty1 getPlacementGroup() {
    return placementGroup;
  }


  public void setPlacementGroup(PlacementGroupProperty1 placementGroup) {
   ...
   * @return the PlacementGroupsGetByIdResponse instance itself
   */
  public PlacementGroupsGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PlacementGroupsGetByIdResponse placementGroupsGetByIdResponse = (PlacementGroupsGetByIdResponse) o;
    return Objects.equals(this.placementGroup, placementGroupsGetByIdResponse.placementGroup)&&
        Objects.equals(this.additionalProperties, placementGroupsGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlacementGroupsGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PlacementGroupsGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PlacementGroupsGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlacementGroupsGetByIdResponse is not found in the empty JSON string", PlacementGroupsGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PlacementGroupsGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `placement_group`
      PlacementGroupProperty1.validateJsonObject(jsonObj.getAsJsonObject("placement_group"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlacementGroupsGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlacementGroupsGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlacementGroupsGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlacementGroupsGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PlacementGroupsGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, PlacementGroupsGetByIdResponse value) throws IOException {
           ...
           @Override
           public PlacementGroupsGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PlacementGroupsGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PlacementGroupsGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PlacementGroupsGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to PlacementGroupsGetByIdResponse
  */
  public static PlacementGroupsGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlacementGroupsGetByIdResponse.class);
  }

 /**
  * Convert an instance of PlacementGroupsGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
