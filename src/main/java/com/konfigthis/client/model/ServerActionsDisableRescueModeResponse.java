...
import com.konfigthis.client.model.ActionProperty61;
...
public class ServerActionsDisableRescueModeResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty61 action;

  public ServerActionsDisableRescueModeResponse() {
  }

  public ServerActionsDisableRescueModeResponse action(ActionProperty61 action) {
  ...
  **/
  ...
  public ActionProperty61 getAction() {
    return action;
  }


  public void setAction(ActionProperty61 action) {
   ...
   * @return the ServerActionsDisableRescueModeResponse instance itself
   */
  public ServerActionsDisableRescueModeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsDisableRescueModeResponse serverActionsDisableRescueModeResponse = (ServerActionsDisableRescueModeResponse) o;
    return Objects.equals(this.action, serverActionsDisableRescueModeResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsDisableRescueModeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsDisableRescueModeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsDisableRescueModeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsDisableRescueModeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsDisableRescueModeResponse is not found in the empty JSON string", ServerActionsDisableRescueModeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsDisableRescueModeResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty61.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsDisableRescueModeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsDisableRescueModeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsDisableRescueModeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsDisableRescueModeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsDisableRescueModeResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsDisableRescueModeResponse value) throws IOException {
           ...
           @Override
           public ServerActionsDisableRescueModeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsDisableRescueModeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsDisableRescueModeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsDisableRescueModeResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsDisableRescueModeResponse
  */
  public static ServerActionsDisableRescueModeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsDisableRescueModeResponse.class);
  }

 /**
  * Convert an instance of ServerActionsDisableRescueModeResponse to an JSON string
  *
  * @return JSON string
  */
