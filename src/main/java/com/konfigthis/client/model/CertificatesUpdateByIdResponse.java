...
import com.konfigthis.client.model.CertificateProperty2;
...
public class CertificatesUpdateByIdResponse {
  public static final String SERIALIZED_NAME_CERTIFICATE = "certificate";
  @SerializedName(SERIALIZED_NAME_CERTIFICATE)
  private CertificateProperty2 certificate;

  public CertificatesUpdateByIdResponse() {
  }

  public CertificatesUpdateByIdResponse certificate(CertificateProperty2 certificate) {
  ...
  **/
  ...
  public CertificateProperty2 getCertificate() {
    return certificate;
  }


  public void setCertificate(CertificateProperty2 certificate) {
   ...
   * @return the CertificatesUpdateByIdResponse instance itself
   */
  public CertificatesUpdateByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatesUpdateByIdResponse certificatesUpdateByIdResponse = (CertificatesUpdateByIdResponse) o;
    return Objects.equals(this.certificate, certificatesUpdateByIdResponse.certificate)&&
        Objects.equals(this.additionalProperties, certificatesUpdateByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificatesUpdateByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatesUpdateByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatesUpdateByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesUpdateByIdResponse is not found in the empty JSON string", CertificatesUpdateByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificatesUpdateByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `certificate`
      CertificateProperty2.validateJsonObject(jsonObj.getAsJsonObject("certificate"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesUpdateByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesUpdateByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesUpdateByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesUpdateByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesUpdateByIdResponse>() {
           @Override
           public void write(JsonWriter out, CertificatesUpdateByIdResponse value) throws IOException {
           ...
           @Override
           public CertificatesUpdateByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatesUpdateByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatesUpdateByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatesUpdateByIdResponse
  * @throws IOException if the JSON string is invalid with respect to CertificatesUpdateByIdResponse
  */
  public static CertificatesUpdateByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesUpdateByIdResponse.class);
  }

 /**
  * Convert an instance of CertificatesUpdateByIdResponse to an JSON string
  *
  * @return JSON string
  */
