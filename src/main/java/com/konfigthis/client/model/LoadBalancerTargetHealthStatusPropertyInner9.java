...
public class LoadBalancerTargetHealthStatusPropertyInner9 {
 ...
 public enum StatusEnum {
  ...
  public LoadBalancerTargetHealthStatusPropertyInner9() {
  }

  public LoadBalancerTargetHealthStatusPropertyInner9 listenPort(Integer listenPort) {
  ...
  **/
  ...
  public LoadBalancerTargetHealthStatusPropertyInner9 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetHealthStatusPropertyInner9 instance itself
   */
  public LoadBalancerTargetHealthStatusPropertyInner9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetHealthStatusPropertyInner9 loadBalancerTargetHealthStatusPropertyInner9 = (LoadBalancerTargetHealthStatusPropertyInner9) o;
    return Objects.equals(this.listenPort, loadBalancerTargetHealthStatusPropertyInner9.listenPort) &&
        Objects.equals(this.status, loadBalancerTargetHealthStatusPropertyInner9.status)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetHealthStatusPropertyInner9.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetHealthStatusPropertyInner9 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetHealthStatusPropertyInner9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetHealthStatusPropertyInner9 is not found in the empty JSON string", LoadBalancerTargetHealthStatusPropertyInner9.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetHealthStatusPropertyInner9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetHealthStatusPropertyInner9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetHealthStatusPropertyInner9.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner9>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetHealthStatusPropertyInner9 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetHealthStatusPropertyInner9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetHealthStatusPropertyInner9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetHealthStatusPropertyInner9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetHealthStatusPropertyInner9
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner9
  */
  public static LoadBalancerTargetHealthStatusPropertyInner9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetHealthStatusPropertyInner9.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetHealthStatusPropertyInner9 to an JSON string
  *
  * @return JSON string
  */
