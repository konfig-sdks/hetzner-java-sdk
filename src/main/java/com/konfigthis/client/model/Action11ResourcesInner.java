...
/**
 * Action11ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action11ResourcesInner {
  ...
  public Action11ResourcesInner() {
  }

  public Action11ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action11ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action11ResourcesInner instance itself
   */
  public Action11ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action11ResourcesInner action11ResourcesInner = (Action11ResourcesInner) o;
    return Objects.equals(this.id, action11ResourcesInner.id) &&
        Objects.equals(this.type, action11ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action11ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action11ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action11ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action11ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action11ResourcesInner is not found in the empty JSON string", Action11ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action11ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action11ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action11ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action11ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action11ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action11ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action11ResourcesInner value) throws IOException {
           ...
           @Override
           public Action11ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action11ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action11ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action11ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action11ResourcesInner
  */
  public static Action11ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action11ResourcesInner.class);
  }

 /**
  * Convert an instance of Action11ResourcesInner to an JSON string
  *
  * @return JSON string
  */
