...
public class NetworksGetByIdResponseNetworkRoutesInner {
  ...
  public NetworksGetByIdResponseNetworkRoutesInner() {
  }

  public NetworksGetByIdResponseNetworkRoutesInner destination(String destination) {
  ...
  **/
  ...
  public NetworksGetByIdResponseNetworkRoutesInner gateway(String gateway) {
  ...
  **/
   ...
   * @return the NetworksGetByIdResponseNetworkRoutesInner instance itself
   */
  public NetworksGetByIdResponseNetworkRoutesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksGetByIdResponseNetworkRoutesInner networksGetByIdResponseNetworkRoutesInner = (NetworksGetByIdResponseNetworkRoutesInner) o;
    return Objects.equals(this.destination, networksGetByIdResponseNetworkRoutesInner.destination) &&
        Objects.equals(this.gateway, networksGetByIdResponseNetworkRoutesInner.gateway)&&
        Objects.equals(this.additionalProperties, networksGetByIdResponseNetworkRoutesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGetByIdResponseNetworkRoutesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksGetByIdResponseNetworkRoutesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksGetByIdResponseNetworkRoutesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGetByIdResponseNetworkRoutesInner is not found in the empty JSON string", NetworksGetByIdResponseNetworkRoutesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGetByIdResponseNetworkRoutesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGetByIdResponseNetworkRoutesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGetByIdResponseNetworkRoutesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGetByIdResponseNetworkRoutesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGetByIdResponseNetworkRoutesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGetByIdResponseNetworkRoutesInner>() {
           @Override
           public void write(JsonWriter out, NetworksGetByIdResponseNetworkRoutesInner value) throws IOException {
           ...
           @Override
           public NetworksGetByIdResponseNetworkRoutesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksGetByIdResponseNetworkRoutesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksGetByIdResponseNetworkRoutesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksGetByIdResponseNetworkRoutesInner
  * @throws IOException if the JSON string is invalid with respect to NetworksGetByIdResponseNetworkRoutesInner
  */
  public static NetworksGetByIdResponseNetworkRoutesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGetByIdResponseNetworkRoutesInner.class);
  }

 /**
  * Convert an instance of NetworksGetByIdResponseNetworkRoutesInner to an JSON string
  *
  * @return JSON string
  */
