...
import com.konfigthis.client.model.ActionProperty34Error;
import com.konfigthis.client.model.ActionProperty34ResourcesInner;
...
public class ActionProperty34 {
  ...
  private ActionProperty34Error error;
  ...
  private List<ActionProperty34ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty34() {
  }

  public ActionProperty34 command(String command) {
  ...
  **/
  ...
  public ActionProperty34 error(ActionProperty34Error error) {
  ...
  **/
  ...
  public ActionProperty34Error getError() {
    return error;
  }


  public void setError(ActionProperty34Error error) {
  ...
  public ActionProperty34 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty34 id(Long id) {
  ...
  **/
  ...
  public ActionProperty34 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty34 resources(List<ActionProperty34ResourcesInner> resources) {
  ...
  public ActionProperty34 addResourcesItem(ActionProperty34ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty34ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty34ResourcesInner> resources) {
  ...
  public ActionProperty34 started(String started) {
  ...
  **/
  ...
  public ActionProperty34 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty34 instance itself
   */
  public ActionProperty34 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty34 actionProperty34 = (ActionProperty34) o;
    return Objects.equals(this.command, actionProperty34.command) &&
        Objects.equals(this.error, actionProperty34.error) &&
        Objects.equals(this.finished, actionProperty34.finished) &&
        Objects.equals(this.id, actionProperty34.id) &&
        Objects.equals(this.progress, actionProperty34.progress) &&
        Objects.equals(this.resources, actionProperty34.resources) &&
        Objects.equals(this.started, actionProperty34.started) &&
        Objects.equals(this.status, actionProperty34.status)&&
        Objects.equals(this.additionalProperties, actionProperty34.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty34 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty34
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty34.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty34 is not found in the empty JSON string", ActionProperty34.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty34.openapiRequiredFields) {
      ...
      ActionProperty34Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty34ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty34.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty34' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty34> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty34.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty34>() {
           @Override
           public void write(JsonWriter out, ActionProperty34 value) throws IOException {
           ...
           @Override
           public ActionProperty34 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty34 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty34 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty34
  * @throws IOException if the JSON string is invalid with respect to ActionProperty34
  */
  public static ActionProperty34 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty34.class);
  }

 /**
  * Convert an instance of ActionProperty34 to an JSON string
  *
  * @return JSON string
  */
