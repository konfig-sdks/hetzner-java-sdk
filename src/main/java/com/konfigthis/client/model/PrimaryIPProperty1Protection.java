...
public class PrimaryIPProperty1Protection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public PrimaryIPProperty1Protection() {
  }

  public PrimaryIPProperty1Protection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the PrimaryIPProperty1Protection instance itself
   */
  public PrimaryIPProperty1Protection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPProperty1Protection primaryIPProperty1Protection = (PrimaryIPProperty1Protection) o;
    return Objects.equals(this.delete, primaryIPProperty1Protection.delete)&&
        Objects.equals(this.additionalProperties, primaryIPProperty1Protection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPProperty1Protection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPProperty1Protection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPProperty1Protection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPProperty1Protection is not found in the empty JSON string", PrimaryIPProperty1Protection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPProperty1Protection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPProperty1Protection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPProperty1Protection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPProperty1Protection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPProperty1Protection.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPProperty1Protection>() {
           @Override
           public void write(JsonWriter out, PrimaryIPProperty1Protection value) throws IOException {
           ...
           @Override
           public PrimaryIPProperty1Protection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPProperty1Protection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPProperty1Protection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPProperty1Protection
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPProperty1Protection
  */
  public static PrimaryIPProperty1Protection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPProperty1Protection.class);
  }

 /**
  * Convert an instance of PrimaryIPProperty1Protection to an JSON string
  *
  * @return JSON string
  */
