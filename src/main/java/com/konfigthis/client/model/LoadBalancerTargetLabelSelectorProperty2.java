...
public class LoadBalancerTargetLabelSelectorProperty2 {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public LoadBalancerTargetLabelSelectorProperty2() {
  }

  public LoadBalancerTargetLabelSelectorProperty2 selector(String selector) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetLabelSelectorProperty2 instance itself
   */
  public LoadBalancerTargetLabelSelectorProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetLabelSelectorProperty2 loadBalancerTargetLabelSelectorProperty2 = (LoadBalancerTargetLabelSelectorProperty2) o;
    return Objects.equals(this.selector, loadBalancerTargetLabelSelectorProperty2.selector)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetLabelSelectorProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetLabelSelectorProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetLabelSelectorProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetLabelSelectorProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetLabelSelectorProperty2 is not found in the empty JSON string", LoadBalancerTargetLabelSelectorProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetLabelSelectorProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetLabelSelectorProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetLabelSelectorProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetLabelSelectorProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetLabelSelectorProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetLabelSelectorProperty2>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetLabelSelectorProperty2 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetLabelSelectorProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetLabelSelectorProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetLabelSelectorProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetLabelSelectorProperty2
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetLabelSelectorProperty2
  */
  public static LoadBalancerTargetLabelSelectorProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetLabelSelectorProperty2.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetLabelSelectorProperty2 to an JSON string
  *
  * @return JSON string
  */
