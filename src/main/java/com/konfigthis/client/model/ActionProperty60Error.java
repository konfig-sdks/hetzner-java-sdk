...
public class ActionProperty60Error {
  ...
  public ActionProperty60Error() {
  }

  public ActionProperty60Error code(String code) {
  ...
  **/
  ...
  public ActionProperty60Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty60Error instance itself
   */
  public ActionProperty60Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty60Error actionProperty60Error = (ActionProperty60Error) o;
    return Objects.equals(this.code, actionProperty60Error.code) &&
        Objects.equals(this.message, actionProperty60Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty60Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty60Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty60Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty60Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty60Error is not found in the empty JSON string", ActionProperty60Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty60Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty60Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty60Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty60Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty60Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty60Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty60Error value) throws IOException {
           ...
           @Override
           public ActionProperty60Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty60Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty60Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty60Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty60Error
  */
  public static ActionProperty60Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty60Error.class);
  }

 /**
  * Convert an instance of ActionProperty60Error to an JSON string
  *
  * @return JSON string
  */
