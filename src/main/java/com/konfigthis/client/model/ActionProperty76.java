...
import com.konfigthis.client.model.ActionProperty76Error;
import com.konfigthis.client.model.ActionProperty76ResourcesInner;
...
public class ActionProperty76 {
  ...
  private ActionProperty76Error error;
  ...
  private List<ActionProperty76ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty76() {
  }

  public ActionProperty76 command(String command) {
  ...
  **/
  ...
  public ActionProperty76 error(ActionProperty76Error error) {
  ...
  **/
  ...
  public ActionProperty76Error getError() {
    return error;
  }


  public void setError(ActionProperty76Error error) {
  ...
  public ActionProperty76 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty76 id(Long id) {
  ...
  **/
  ...
  public ActionProperty76 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty76 resources(List<ActionProperty76ResourcesInner> resources) {
  ...
  public ActionProperty76 addResourcesItem(ActionProperty76ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty76ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty76ResourcesInner> resources) {
  ...
  public ActionProperty76 started(String started) {
  ...
  **/
  ...
  public ActionProperty76 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty76 instance itself
   */
  public ActionProperty76 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty76 actionProperty76 = (ActionProperty76) o;
    return Objects.equals(this.command, actionProperty76.command) &&
        Objects.equals(this.error, actionProperty76.error) &&
        Objects.equals(this.finished, actionProperty76.finished) &&
        Objects.equals(this.id, actionProperty76.id) &&
        Objects.equals(this.progress, actionProperty76.progress) &&
        Objects.equals(this.resources, actionProperty76.resources) &&
        Objects.equals(this.started, actionProperty76.started) &&
        Objects.equals(this.status, actionProperty76.status)&&
        Objects.equals(this.additionalProperties, actionProperty76.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty76 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty76
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty76.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty76 is not found in the empty JSON string", ActionProperty76.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty76.openapiRequiredFields) {
      ...
      ActionProperty76Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty76ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty76.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty76' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty76> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty76.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty76>() {
           @Override
           public void write(JsonWriter out, ActionProperty76 value) throws IOException {
           ...
           @Override
           public ActionProperty76 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty76 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty76 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty76
  * @throws IOException if the JSON string is invalid with respect to ActionProperty76
  */
  public static ActionProperty76 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty76.class);
  }

 /**
  * Convert an instance of ActionProperty76 to an JSON string
  *
  * @return JSON string
  */
