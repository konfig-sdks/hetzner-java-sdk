 ...
 */
@ApiModel(description = "Configuration for type label_selector, required if type is `label_selector`")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FirewallResource1LabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public FirewallResource1LabelSelector() {
  }

  public FirewallResource1LabelSelector selector(String selector) {
  ...
  **/
   ...
   * @return the FirewallResource1LabelSelector instance itself
   */
  public FirewallResource1LabelSelector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallResource1LabelSelector firewallResource1LabelSelector = (FirewallResource1LabelSelector) o;
    return Objects.equals(this.selector, firewallResource1LabelSelector.selector)&&
        Objects.equals(this.additionalProperties, firewallResource1LabelSelector.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallResource1LabelSelector {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallResource1LabelSelector
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallResource1LabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallResource1LabelSelector is not found in the empty JSON string", FirewallResource1LabelSelector.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallResource1LabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallResource1LabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallResource1LabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallResource1LabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallResource1LabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallResource1LabelSelector>() {
           @Override
           public void write(JsonWriter out, FirewallResource1LabelSelector value) throws IOException {
           ...
           @Override
           public FirewallResource1LabelSelector read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallResource1LabelSelector instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallResource1LabelSelector given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallResource1LabelSelector
  * @throws IOException if the JSON string is invalid with respect to FirewallResource1LabelSelector
  */
  public static FirewallResource1LabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallResource1LabelSelector.class);
  }

 /**
  * Convert an instance of FirewallResource1LabelSelector to an JSON string
  *
  * @return JSON string
  */
