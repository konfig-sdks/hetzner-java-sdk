...
import com.konfigthis.client.model.Action19Error;
import com.konfigthis.client.model.Action19ResourcesInner;
...
public class Action19 {
  ...
  private List<Action19ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action19 command(String command) {
  ...
  **/
  ...
  public Action19 error(Action19Error error) {
  ...
  **/
  ...
  public Action19Error getError() {
    return error;
  }


  public void setError(Action19Error error) {
  ...
  public Action19 finished(String finished) {
  ...
  **/
  ...
  public Action19 progress(Integer progress) {
  ...
  **/
  ...
  public Action19 resources(List<Action19ResourcesInner> resources) {
  ...
  public Action19 addResourcesItem(Action19ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action19ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action19ResourcesInner> resources) {
  ...
  public Action19 started(String started) {
  ...
  **/
  ...
  public Action19 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action19 instance itself
   */
  public Action19 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action19 action19 = (Action19) o;
    return Objects.equals(this.command, action19.command) &&
        Objects.equals(this.error, action19.error) &&
        Objects.equals(this.finished, action19.finished) &&
        Objects.equals(this.id, action19.id) &&
        Objects.equals(this.progress, action19.progress) &&
        Objects.equals(this.resources, action19.resources) &&
        Objects.equals(this.started, action19.started) &&
        Objects.equals(this.status, action19.status)&&
        Objects.equals(this.additionalProperties, action19.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action19
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action19.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action19 is not found in the empty JSON string", Action19.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action19.openapiRequiredFields) {
      ...
      Action19Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action19ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action19.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action19' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action19> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action19.class));

       return (TypeAdapter<T>) new TypeAdapter<Action19>() {
           @Override
           public void write(JsonWriter out, Action19 value) throws IOException {
           ...
           @Override
           public Action19 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action19 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action19 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action19
  * @throws IOException if the JSON string is invalid with respect to Action19
  */
  public static Action19 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action19.class);
  }

 /**
  * Convert an instance of Action19 to an JSON string
  *
  * @return JSON string
  */
