...
import com.konfigthis.client.model.ListMetaProperty31Pagination;
...
public class ListMetaProperty31 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty31Pagination pagination;

  public ListMetaProperty31() {
  }

  public ListMetaProperty31 pagination(ListMetaProperty31Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty31Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty31Pagination pagination) {
   ...
   * @return the ListMetaProperty31 instance itself
   */
  public ListMetaProperty31 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty31 listMetaProperty31 = (ListMetaProperty31) o;
    return Objects.equals(this.pagination, listMetaProperty31.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty31.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty31 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty31
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty31.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty31 is not found in the empty JSON string", ListMetaProperty31.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty31.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty31Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty31.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty31' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty31> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty31.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty31>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty31 value) throws IOException {
           ...
           @Override
           public ListMetaProperty31 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty31 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty31 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty31
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty31
  */
  public static ListMetaProperty31 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty31.class);
  }

 /**
  * Convert an instance of ListMetaProperty31 to an JSON string
  *
  * @return JSON string
  */
