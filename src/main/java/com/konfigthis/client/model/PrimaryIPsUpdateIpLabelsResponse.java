...
import com.konfigthis.client.model.PrimaryIPProperty2;
...
public class PrimaryIPsUpdateIpLabelsResponse {
  public static final String SERIALIZED_NAME_PRIMARY_IP = "primary_ip";
  @SerializedName(SERIALIZED_NAME_PRIMARY_IP)
  private PrimaryIPProperty2 primaryIp;

  public PrimaryIPsUpdateIpLabelsResponse() {
  }

  public PrimaryIPsUpdateIpLabelsResponse primaryIp(PrimaryIPProperty2 primaryIp) {
  ...
  **/
  ...
  public PrimaryIPProperty2 getPrimaryIp() {
    return primaryIp;
  }


  public void setPrimaryIp(PrimaryIPProperty2 primaryIp) {
   ...
   * @return the PrimaryIPsUpdateIpLabelsResponse instance itself
   */
  public PrimaryIPsUpdateIpLabelsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPsUpdateIpLabelsResponse primaryIPsUpdateIpLabelsResponse = (PrimaryIPsUpdateIpLabelsResponse) o;
    return Objects.equals(this.primaryIp, primaryIPsUpdateIpLabelsResponse.primaryIp)&&
        Objects.equals(this.additionalProperties, primaryIPsUpdateIpLabelsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primaryIp, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrimaryIPsUpdateIpLabelsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPsUpdateIpLabelsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPsUpdateIpLabelsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPsUpdateIpLabelsResponse is not found in the empty JSON string", PrimaryIPsUpdateIpLabelsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPsUpdateIpLabelsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `primary_ip`
      PrimaryIPProperty2.validateJsonObject(jsonObj.getAsJsonObject("primary_ip"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPsUpdateIpLabelsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPsUpdateIpLabelsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPsUpdateIpLabelsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPsUpdateIpLabelsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPsUpdateIpLabelsResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryIPsUpdateIpLabelsResponse value) throws IOException {
           ...
           @Override
           public PrimaryIPsUpdateIpLabelsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPsUpdateIpLabelsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPsUpdateIpLabelsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPsUpdateIpLabelsResponse
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPsUpdateIpLabelsResponse
  */
  public static PrimaryIPsUpdateIpLabelsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPsUpdateIpLabelsResponse.class);
  }

 /**
  * Convert an instance of PrimaryIPsUpdateIpLabelsResponse to an JSON string
  *
  * @return JSON string
  */
