...
import com.konfigthis.client.model.ListMetaProperty32Pagination;
...
public class ListMetaProperty32 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty32Pagination pagination;

  public ListMetaProperty32() {
  }

  public ListMetaProperty32 pagination(ListMetaProperty32Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty32Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty32Pagination pagination) {
   ...
   * @return the ListMetaProperty32 instance itself
   */
  public ListMetaProperty32 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty32 listMetaProperty32 = (ListMetaProperty32) o;
    return Objects.equals(this.pagination, listMetaProperty32.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty32.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty32 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty32
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty32.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty32 is not found in the empty JSON string", ListMetaProperty32.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty32.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty32Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty32.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty32' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty32> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty32.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty32>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty32 value) throws IOException {
           ...
           @Override
           public ListMetaProperty32 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty32 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty32 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty32
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty32
  */
  public static ListMetaProperty32 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty32.class);
  }

 /**
  * Convert an instance of ListMetaProperty32 to an JSON string
  *
  * @return JSON string
  */
