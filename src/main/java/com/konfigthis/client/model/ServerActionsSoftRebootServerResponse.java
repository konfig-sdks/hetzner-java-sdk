...
import com.konfigthis.client.model.ActionProperty66;
...
public class ServerActionsSoftRebootServerResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty66 action;

  public ServerActionsSoftRebootServerResponse() {
  }

  public ServerActionsSoftRebootServerResponse action(ActionProperty66 action) {
  ...
  **/
  ...
  public ActionProperty66 getAction() {
    return action;
  }


  public void setAction(ActionProperty66 action) {
   ...
   * @return the ServerActionsSoftRebootServerResponse instance itself
   */
  public ServerActionsSoftRebootServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsSoftRebootServerResponse serverActionsSoftRebootServerResponse = (ServerActionsSoftRebootServerResponse) o;
    return Objects.equals(this.action, serverActionsSoftRebootServerResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsSoftRebootServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsSoftRebootServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsSoftRebootServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsSoftRebootServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsSoftRebootServerResponse is not found in the empty JSON string", ServerActionsSoftRebootServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsSoftRebootServerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty66.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsSoftRebootServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsSoftRebootServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsSoftRebootServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsSoftRebootServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsSoftRebootServerResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsSoftRebootServerResponse value) throws IOException {
           ...
           @Override
           public ServerActionsSoftRebootServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsSoftRebootServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsSoftRebootServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsSoftRebootServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsSoftRebootServerResponse
  */
  public static ServerActionsSoftRebootServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsSoftRebootServerResponse.class);
  }

 /**
  * Convert an instance of ServerActionsSoftRebootServerResponse to an JSON string
  *
  * @return JSON string
  */
