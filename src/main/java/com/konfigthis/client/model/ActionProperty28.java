...
import com.konfigthis.client.model.ActionProperty28Error;
import com.konfigthis.client.model.ActionProperty28ResourcesInner;
...
public class ActionProperty28 {
  ...
  private ActionProperty28Error error;
  ...
  private List<ActionProperty28ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty28() {
  }

  public ActionProperty28 command(String command) {
  ...
  **/
  ...
  public ActionProperty28 error(ActionProperty28Error error) {
  ...
  **/
  ...
  public ActionProperty28Error getError() {
    return error;
  }


  public void setError(ActionProperty28Error error) {
  ...
  public ActionProperty28 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty28 id(Long id) {
  ...
  **/
  ...
  public ActionProperty28 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty28 resources(List<ActionProperty28ResourcesInner> resources) {
  ...
  public ActionProperty28 addResourcesItem(ActionProperty28ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty28ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty28ResourcesInner> resources) {
  ...
  public ActionProperty28 started(String started) {
  ...
  **/
  ...
  public ActionProperty28 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty28 instance itself
   */
  public ActionProperty28 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty28 actionProperty28 = (ActionProperty28) o;
    return Objects.equals(this.command, actionProperty28.command) &&
        Objects.equals(this.error, actionProperty28.error) &&
        Objects.equals(this.finished, actionProperty28.finished) &&
        Objects.equals(this.id, actionProperty28.id) &&
        Objects.equals(this.progress, actionProperty28.progress) &&
        Objects.equals(this.resources, actionProperty28.resources) &&
        Objects.equals(this.started, actionProperty28.started) &&
        Objects.equals(this.status, actionProperty28.status)&&
        Objects.equals(this.additionalProperties, actionProperty28.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty28 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty28
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty28.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty28 is not found in the empty JSON string", ActionProperty28.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty28.openapiRequiredFields) {
      ...
      ActionProperty28Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty28ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty28.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty28' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty28> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty28.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty28>() {
           @Override
           public void write(JsonWriter out, ActionProperty28 value) throws IOException {
           ...
           @Override
           public ActionProperty28 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty28 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty28 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty28
  * @throws IOException if the JSON string is invalid with respect to ActionProperty28
  */
  public static ActionProperty28 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty28.class);
  }

 /**
  * Convert an instance of ActionProperty28 to an JSON string
  *
  * @return JSON string
  */
