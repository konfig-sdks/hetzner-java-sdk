...
public class CertificatesCreateNewCertificateRequest {
 ...
 public enum TypeEnum {
  ...
  private TypeEnum type = TypeEnum.UPLOADED;

  public CertificatesCreateNewCertificateRequest() {
  }

  public CertificatesCreateNewCertificateRequest certificate(String certificate) {
  ...
  **/
  ...
  @ApiModelProperty(example = "-----BEGIN CERTIFICATE----- ...", value = "Certificate and chain in PEM format, in order so that each record directly certifies the one preceding. Required for type `uploaded` Certificates.")
  ...
  public CertificatesCreateNewCertificateRequest domainNames(List<String> domainNames) {
  ...
  public CertificatesCreateNewCertificateRequest addDomainNamesItem(String domainNamesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Domains and subdomains that should be contained in the Certificate issued by *Let's Encrypt*. Required for type `managed` Certificates.")
  ...
  public CertificatesCreateNewCertificateRequest labels(Object labels) {
  ...
  **/
  ...
  public CertificatesCreateNewCertificateRequest name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "my website cert", required = true, value = "Name of the Certificate")
  ...
  public CertificatesCreateNewCertificateRequest privateKey(String privateKey) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "-----BEGIN PRIVATE KEY----- ...", value = "Certificate key in PEM format. Required for type `uploaded` Certificates.")
  ...
  public CertificatesCreateNewCertificateRequest type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "UPLOADED", value = "Choose between uploading a Certificate in PEM format or requesting a managed *Let's Encrypt* Certificate.")
   ...
   * @return the CertificatesCreateNewCertificateRequest instance itself
   */
  public CertificatesCreateNewCertificateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatesCreateNewCertificateRequest certificatesCreateNewCertificateRequest = (CertificatesCreateNewCertificateRequest) o;
    return Objects.equals(this.certificate, certificatesCreateNewCertificateRequest.certificate) &&
        Objects.equals(this.domainNames, certificatesCreateNewCertificateRequest.domainNames) &&
        Objects.equals(this.labels, certificatesCreateNewCertificateRequest.labels) &&
        Objects.equals(this.name, certificatesCreateNewCertificateRequest.name) &&
        Objects.equals(this.privateKey, certificatesCreateNewCertificateRequest.privateKey) &&
        Objects.equals(this.type, certificatesCreateNewCertificateRequest.type)&&
        Objects.equals(this.additionalProperties, certificatesCreateNewCertificateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificate, domainNames, labels, name, privateKey, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CertificatesCreateNewCertificateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatesCreateNewCertificateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatesCreateNewCertificateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesCreateNewCertificateRequest is not found in the empty JSON string", CertificatesCreateNewCertificateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificatesCreateNewCertificateRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("domain_names") != null && !jsonObj.get("domain_names").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesCreateNewCertificateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesCreateNewCertificateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesCreateNewCertificateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesCreateNewCertificateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesCreateNewCertificateRequest>() {
           @Override
           public void write(JsonWriter out, CertificatesCreateNewCertificateRequest value) throws IOException {
           ...
           @Override
           public CertificatesCreateNewCertificateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatesCreateNewCertificateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatesCreateNewCertificateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatesCreateNewCertificateRequest
  * @throws IOException if the JSON string is invalid with respect to CertificatesCreateNewCertificateRequest
  */
  public static CertificatesCreateNewCertificateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesCreateNewCertificateRequest.class);
  }

 /**
  * Convert an instance of CertificatesCreateNewCertificateRequest to an JSON string
  *
  * @return JSON string
  */
