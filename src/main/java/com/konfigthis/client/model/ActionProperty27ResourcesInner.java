...
/**
 * ActionProperty27ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty27ResourcesInner {
  ...
  public ActionProperty27ResourcesInner() {
  }

  public ActionProperty27ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty27ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty27ResourcesInner instance itself
   */
  public ActionProperty27ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty27ResourcesInner actionProperty27ResourcesInner = (ActionProperty27ResourcesInner) o;
    return Objects.equals(this.id, actionProperty27ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty27ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty27ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty27ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty27ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty27ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty27ResourcesInner is not found in the empty JSON string", ActionProperty27ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty27ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty27ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty27ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty27ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty27ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty27ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty27ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty27ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty27ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty27ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty27ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty27ResourcesInner
  */
  public static ActionProperty27ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty27ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty27ResourcesInner to an JSON string
  *
  * @return JSON string
  */
