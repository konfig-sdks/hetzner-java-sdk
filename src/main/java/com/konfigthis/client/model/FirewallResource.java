...
import com.konfigthis.client.model.FirewallResourceLabelSelector;
...
public class FirewallResource {
  ...
  private FirewallResourceLabelSelector labelSelector;
 ...
 public enum TypeEnum {
  ...
  public FirewallResource labelSelector(FirewallResourceLabelSelector labelSelector) {
  ...
  **/
  ...
  public FirewallResourceLabelSelector getLabelSelector() {
    return labelSelector;
  }


  public void setLabelSelector(FirewallResourceLabelSelector labelSelector) {
  ...
  public FirewallResource server(FirewallResourceServer server) {
  ...
  **/
  ...
  public FirewallResource type(TypeEnum type) {
  ...
  **/
   ...
   * @return the FirewallResource instance itself
   */
  public FirewallResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallResource firewallResource = (FirewallResource) o;
    return Objects.equals(this.labelSelector, firewallResource.labelSelector) &&
        Objects.equals(this.server, firewallResource.server) &&
        Objects.equals(this.type, firewallResource.type)&&
        Objects.equals(this.additionalProperties, firewallResource.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallResource is not found in the empty JSON string", FirewallResource.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallResource.openapiRequiredFields) {
      ...
      if (jsonObj.get("label_selector") != null && !jsonObj.get("label_selector").isJsonNull()) {
        FirewallResourceLabelSelector.validateJsonObject(jsonObj.getAsJsonObject("label_selector"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallResource.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallResource>() {
           @Override
           public void write(JsonWriter out, FirewallResource value) throws IOException {
           ...
           @Override
           public FirewallResource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallResource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallResource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallResource
  * @throws IOException if the JSON string is invalid with respect to FirewallResource
  */
  public static FirewallResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallResource.class);
  }

 /**
  * Convert an instance of FirewallResource to an JSON string
  *
  * @return JSON string
  */
