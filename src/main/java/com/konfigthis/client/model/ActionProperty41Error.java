...
public class ActionProperty41Error {
  ...
  public ActionProperty41Error() {
  }

  public ActionProperty41Error code(String code) {
  ...
  **/
  ...
  public ActionProperty41Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty41Error instance itself
   */
  public ActionProperty41Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty41Error actionProperty41Error = (ActionProperty41Error) o;
    return Objects.equals(this.code, actionProperty41Error.code) &&
        Objects.equals(this.message, actionProperty41Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty41Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty41Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty41Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty41Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty41Error is not found in the empty JSON string", ActionProperty41Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty41Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty41Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty41Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty41Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty41Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty41Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty41Error value) throws IOException {
           ...
           @Override
           public ActionProperty41Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty41Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty41Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty41Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty41Error
  */
  public static ActionProperty41Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty41Error.class);
  }

 /**
  * Convert an instance of ActionProperty41Error to an JSON string
  *
  * @return JSON string
  */
