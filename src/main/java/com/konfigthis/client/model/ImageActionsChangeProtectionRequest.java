...
public class ImageActionsChangeProtectionRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ImageActionsChangeProtectionRequest() {
  }

  public ImageActionsChangeProtectionRequest delete(Boolean delete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "If true, prevents the snapshot from being deleted")
   ...
   * @return the ImageActionsChangeProtectionRequest instance itself
   */
  public ImageActionsChangeProtectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImageActionsChangeProtectionRequest imageActionsChangeProtectionRequest = (ImageActionsChangeProtectionRequest) o;
    return Objects.equals(this.delete, imageActionsChangeProtectionRequest.delete)&&
        Objects.equals(this.additionalProperties, imageActionsChangeProtectionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageActionsChangeProtectionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageActionsChangeProtectionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageActionsChangeProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageActionsChangeProtectionRequest is not found in the empty JSON string", ImageActionsChangeProtectionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageActionsChangeProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageActionsChangeProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageActionsChangeProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageActionsChangeProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageActionsChangeProtectionRequest>() {
           @Override
           public void write(JsonWriter out, ImageActionsChangeProtectionRequest value) throws IOException {
           ...
           @Override
           public ImageActionsChangeProtectionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageActionsChangeProtectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageActionsChangeProtectionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageActionsChangeProtectionRequest
  * @throws IOException if the JSON string is invalid with respect to ImageActionsChangeProtectionRequest
  */
  public static ImageActionsChangeProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageActionsChangeProtectionRequest.class);
  }

 /**
  * Convert an instance of ImageActionsChangeProtectionRequest to an JSON string
  *
  * @return JSON string
  */
