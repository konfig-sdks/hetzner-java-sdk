...
import com.konfigthis.client.model.ListMetaProperty26Pagination;
...
public class ListMetaProperty26 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty26Pagination pagination;

  public ListMetaProperty26() {
  }

  public ListMetaProperty26 pagination(ListMetaProperty26Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty26Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty26Pagination pagination) {
   ...
   * @return the ListMetaProperty26 instance itself
   */
  public ListMetaProperty26 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty26 listMetaProperty26 = (ListMetaProperty26) o;
    return Objects.equals(this.pagination, listMetaProperty26.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty26.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty26 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty26
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty26.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty26 is not found in the empty JSON string", ListMetaProperty26.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty26.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty26Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty26.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty26' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty26> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty26.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty26>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty26 value) throws IOException {
           ...
           @Override
           public ListMetaProperty26 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty26 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty26 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty26
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty26
  */
  public static ListMetaProperty26 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty26.class);
  }

 /**
  * Convert an instance of ListMetaProperty26 to an JSON string
  *
  * @return JSON string
  */
