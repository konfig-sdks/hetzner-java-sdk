...
public class ServerActionsChangeProtectionRequest {
  ...
  public ServerActionsChangeProtectionRequest() {
  }

  public ServerActionsChangeProtectionRequest delete(Boolean delete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "If true, prevents the Server from being deleted (currently delete and rebuild attribute needs to have the same value)")
  ...
  public ServerActionsChangeProtectionRequest rebuild(Boolean rebuild) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "If true, prevents the Server from being rebuilt (currently delete and rebuild attribute needs to have the same value)")
   ...
   * @return the ServerActionsChangeProtectionRequest instance itself
   */
  public ServerActionsChangeProtectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsChangeProtectionRequest serverActionsChangeProtectionRequest = (ServerActionsChangeProtectionRequest) o;
    return Objects.equals(this.delete, serverActionsChangeProtectionRequest.delete) &&
        Objects.equals(this.rebuild, serverActionsChangeProtectionRequest.rebuild)&&
        Objects.equals(this.additionalProperties, serverActionsChangeProtectionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsChangeProtectionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsChangeProtectionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsChangeProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsChangeProtectionRequest is not found in the empty JSON string", ServerActionsChangeProtectionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsChangeProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsChangeProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsChangeProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsChangeProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsChangeProtectionRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsChangeProtectionRequest value) throws IOException {
           ...
           @Override
           public ServerActionsChangeProtectionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsChangeProtectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsChangeProtectionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsChangeProtectionRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsChangeProtectionRequest
  */
  public static ServerActionsChangeProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsChangeProtectionRequest.class);
  }

 /**
  * Convert an instance of ServerActionsChangeProtectionRequest to an JSON string
  *
  * @return JSON string
  */
