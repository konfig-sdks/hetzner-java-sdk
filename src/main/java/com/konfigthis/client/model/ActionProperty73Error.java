...
public class ActionProperty73Error {
  ...
  public ActionProperty73Error() {
  }

  public ActionProperty73Error code(String code) {
  ...
  **/
  ...
  public ActionProperty73Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty73Error instance itself
   */
  public ActionProperty73Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty73Error actionProperty73Error = (ActionProperty73Error) o;
    return Objects.equals(this.code, actionProperty73Error.code) &&
        Objects.equals(this.message, actionProperty73Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty73Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty73Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty73Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty73Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty73Error is not found in the empty JSON string", ActionProperty73Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty73Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty73Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty73Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty73Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty73Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty73Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty73Error value) throws IOException {
           ...
           @Override
           public ActionProperty73Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty73Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty73Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty73Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty73Error
  */
  public static ActionProperty73Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty73Error.class);
  }

 /**
  * Convert an instance of ActionProperty73Error to an JSON string
  *
  * @return JSON string
  */
