...
import com.konfigthis.client.model.DatacentersGetAllResponseDatacentersInner;
import com.konfigthis.client.model.ListMetaProperty5;
...
public class DatacentersGetAllResponse {
  public static final String SERIALIZED_NAME_DATACENTERS = "datacenters";
  @SerializedName(SERIALIZED_NAME_DATACENTERS)
  private List<DatacentersGetAllResponseDatacentersInner> datacenters = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty5 meta;
  ...
  public DatacentersGetAllResponse() {
  }

  public DatacentersGetAllResponse datacenters(List<DatacentersGetAllResponseDatacentersInner> datacenters) {
  ...
  public DatacentersGetAllResponse addDatacentersItem(DatacentersGetAllResponseDatacentersInner datacentersItem) {
  ...
  **/
  ...
  public List<DatacentersGetAllResponseDatacentersInner> getDatacenters() {
    return datacenters;
  }


  public void setDatacenters(List<DatacentersGetAllResponseDatacentersInner> datacenters) {
  ...
  public DatacentersGetAllResponse meta(ListMetaProperty5 meta) {
  ...
  **/
  ...
  public ListMetaProperty5 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty5 meta) {
  ...
  public DatacentersGetAllResponse recommendation(Long recommendation) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "The Datacenter which is recommended to be used to create new Servers.")
   ...
   * @return the DatacentersGetAllResponse instance itself
   */
  public DatacentersGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatacentersGetAllResponse datacentersGetAllResponse = (DatacentersGetAllResponse) o;
    return Objects.equals(this.datacenters, datacentersGetAllResponse.datacenters) &&
        Objects.equals(this.meta, datacentersGetAllResponse.meta) &&
        Objects.equals(this.recommendation, datacentersGetAllResponse.recommendation)&&
        Objects.equals(this.additionalProperties, datacentersGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datacenters, meta, recommendation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatacentersGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatacentersGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatacentersGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatacentersGetAllResponse is not found in the empty JSON string", DatacentersGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatacentersGetAllResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydatacenters.size(); i++) {
        DatacentersGetAllResponseDatacentersInner.validateJsonObject(jsonArraydatacenters.get(i).getAsJsonObject());
      };
      // validate the required field `meta`
      ListMetaProperty5.validateJsonObject(jsonObj.getAsJsonObject("meta"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatacentersGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatacentersGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatacentersGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatacentersGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DatacentersGetAllResponse>() {
           @Override
           public void write(JsonWriter out, DatacentersGetAllResponse value) throws IOException {
           ...
           @Override
           public DatacentersGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatacentersGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatacentersGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatacentersGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to DatacentersGetAllResponse
  */
  public static DatacentersGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatacentersGetAllResponse.class);
  }

 /**
  * Convert an instance of DatacentersGetAllResponse to an JSON string
  *
  * @return JSON string
  */
