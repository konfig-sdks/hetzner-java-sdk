...
public class PricesPriceHourly {
  ...
  public PricesPriceHourly() {
  }

  public PricesPriceHourly gross(BigDecimal gross) {
  ...
  **/
  ...
  public PricesPriceHourly net(BigDecimal net) {
  ...
  **/
   ...
   * @return the PricesPriceHourly instance itself
   */
  public PricesPriceHourly putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PricesPriceHourly pricesPriceHourly = (PricesPriceHourly) o;
    return Objects.equals(this.gross, pricesPriceHourly.gross) &&
        Objects.equals(this.net, pricesPriceHourly.net)&&
        Objects.equals(this.additionalProperties, pricesPriceHourly.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricesPriceHourly {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PricesPriceHourly
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PricesPriceHourly.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricesPriceHourly is not found in the empty JSON string", PricesPriceHourly.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricesPriceHourly.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricesPriceHourly.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricesPriceHourly' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricesPriceHourly> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricesPriceHourly.class));

       return (TypeAdapter<T>) new TypeAdapter<PricesPriceHourly>() {
           @Override
           public void write(JsonWriter out, PricesPriceHourly value) throws IOException {
           ...
           @Override
           public PricesPriceHourly read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PricesPriceHourly instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PricesPriceHourly given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PricesPriceHourly
  * @throws IOException if the JSON string is invalid with respect to PricesPriceHourly
  */
  public static PricesPriceHourly fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricesPriceHourly.class);
  }

 /**
  * Convert an instance of PricesPriceHourly to an JSON string
  *
  * @return JSON string
  */
