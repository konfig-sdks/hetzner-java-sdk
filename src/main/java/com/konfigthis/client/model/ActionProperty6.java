...
import com.konfigthis.client.model.ActionProperty6Error;
import com.konfigthis.client.model.ActionProperty6ResourcesInner;
...
public class ActionProperty6 {
  ...
  private ActionProperty6Error error;
  ...
  private List<ActionProperty6ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty6() {
  }

  public ActionProperty6 command(String command) {
  ...
  **/
  ...
  public ActionProperty6 error(ActionProperty6Error error) {
  ...
  **/
  ...
  public ActionProperty6Error getError() {
    return error;
  }


  public void setError(ActionProperty6Error error) {
  ...
  public ActionProperty6 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty6 id(Long id) {
  ...
  **/
  ...
  public ActionProperty6 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty6 resources(List<ActionProperty6ResourcesInner> resources) {
  ...
  public ActionProperty6 addResourcesItem(ActionProperty6ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty6ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty6ResourcesInner> resources) {
  ...
  public ActionProperty6 started(String started) {
  ...
  **/
  ...
  public ActionProperty6 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty6 instance itself
   */
  public ActionProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty6 actionProperty6 = (ActionProperty6) o;
    return Objects.equals(this.command, actionProperty6.command) &&
        Objects.equals(this.error, actionProperty6.error) &&
        Objects.equals(this.finished, actionProperty6.finished) &&
        Objects.equals(this.id, actionProperty6.id) &&
        Objects.equals(this.progress, actionProperty6.progress) &&
        Objects.equals(this.resources, actionProperty6.resources) &&
        Objects.equals(this.started, actionProperty6.started) &&
        Objects.equals(this.status, actionProperty6.status)&&
        Objects.equals(this.additionalProperties, actionProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty6 is not found in the empty JSON string", ActionProperty6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty6.openapiRequiredFields) {
      ...
      ActionProperty6Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty6ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty6>() {
           @Override
           public void write(JsonWriter out, ActionProperty6 value) throws IOException {
           ...
           @Override
           public ActionProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty6
  * @throws IOException if the JSON string is invalid with respect to ActionProperty6
  */
  public static ActionProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty6.class);
  }

 /**
  * Convert an instance of ActionProperty6 to an JSON string
  *
  * @return JSON string
  */
