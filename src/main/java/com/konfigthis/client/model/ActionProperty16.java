...
import com.konfigthis.client.model.ActionProperty16Error;
import com.konfigthis.client.model.ActionProperty16ResourcesInner;
...
public class ActionProperty16 {
  ...
  private ActionProperty16Error error;
  ...
  private List<ActionProperty16ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty16() {
  }

  public ActionProperty16 command(String command) {
  ...
  **/
  ...
  public ActionProperty16 error(ActionProperty16Error error) {
  ...
  **/
  ...
  public ActionProperty16Error getError() {
    return error;
  }


  public void setError(ActionProperty16Error error) {
  ...
  public ActionProperty16 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty16 id(Long id) {
  ...
  **/
  ...
  public ActionProperty16 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty16 resources(List<ActionProperty16ResourcesInner> resources) {
  ...
  public ActionProperty16 addResourcesItem(ActionProperty16ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty16ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty16ResourcesInner> resources) {
  ...
  public ActionProperty16 started(String started) {
  ...
  **/
  ...
  public ActionProperty16 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty16 instance itself
   */
  public ActionProperty16 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty16 actionProperty16 = (ActionProperty16) o;
    return Objects.equals(this.command, actionProperty16.command) &&
        Objects.equals(this.error, actionProperty16.error) &&
        Objects.equals(this.finished, actionProperty16.finished) &&
        Objects.equals(this.id, actionProperty16.id) &&
        Objects.equals(this.progress, actionProperty16.progress) &&
        Objects.equals(this.resources, actionProperty16.resources) &&
        Objects.equals(this.started, actionProperty16.started) &&
        Objects.equals(this.status, actionProperty16.status)&&
        Objects.equals(this.additionalProperties, actionProperty16.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty16 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty16
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty16.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty16 is not found in the empty JSON string", ActionProperty16.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty16.openapiRequiredFields) {
      ...
      ActionProperty16Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty16ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty16.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty16' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty16> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty16.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty16>() {
           @Override
           public void write(JsonWriter out, ActionProperty16 value) throws IOException {
           ...
           @Override
           public ActionProperty16 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty16 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty16 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty16
  * @throws IOException if the JSON string is invalid with respect to ActionProperty16
  */
  public static ActionProperty16 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty16.class);
  }

 /**
  * Convert an instance of ActionProperty16 to an JSON string
  *
  * @return JSON string
  */
