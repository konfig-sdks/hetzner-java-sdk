...
public class Action19Error {
  ...
  public Action19Error() {
  }

  public Action19Error code(String code) {
  ...
  **/
  ...
  public Action19Error message(String message) {
  ...
  **/
   ...
   * @return the Action19Error instance itself
   */
  public Action19Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action19Error action19Error = (Action19Error) o;
    return Objects.equals(this.code, action19Error.code) &&
        Objects.equals(this.message, action19Error.message)&&
        Objects.equals(this.additionalProperties, action19Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action19Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action19Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action19Error is not found in the empty JSON string", Action19Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action19Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action19Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action19Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action19Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action19Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action19Error>() {
           @Override
           public void write(JsonWriter out, Action19Error value) throws IOException {
           ...
           @Override
           public Action19Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action19Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action19Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action19Error
  * @throws IOException if the JSON string is invalid with respect to Action19Error
  */
  public static Action19Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action19Error.class);
  }

 /**
  * Convert an instance of Action19Error to an JSON string
  *
  * @return JSON string
  */
