...
/**
 * ActionProperty42ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty42ResourcesInner {
  ...
  public ActionProperty42ResourcesInner() {
  }

  public ActionProperty42ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty42ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty42ResourcesInner instance itself
   */
  public ActionProperty42ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty42ResourcesInner actionProperty42ResourcesInner = (ActionProperty42ResourcesInner) o;
    return Objects.equals(this.id, actionProperty42ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty42ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty42ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty42ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty42ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty42ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty42ResourcesInner is not found in the empty JSON string", ActionProperty42ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty42ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty42ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty42ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty42ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty42ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty42ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty42ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty42ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty42ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty42ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty42ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty42ResourcesInner
  */
  public static ActionProperty42ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty42ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty42ResourcesInner to an JSON string
  *
  * @return JSON string
  */
