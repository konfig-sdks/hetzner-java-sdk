...
/**
 * Action18ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action18ResourcesInner {
  ...
  public Action18ResourcesInner() {
  }

  public Action18ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action18ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action18ResourcesInner instance itself
   */
  public Action18ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action18ResourcesInner action18ResourcesInner = (Action18ResourcesInner) o;
    return Objects.equals(this.id, action18ResourcesInner.id) &&
        Objects.equals(this.type, action18ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action18ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action18ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action18ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action18ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action18ResourcesInner is not found in the empty JSON string", Action18ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action18ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action18ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action18ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action18ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action18ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action18ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action18ResourcesInner value) throws IOException {
           ...
           @Override
           public Action18ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action18ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action18ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action18ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action18ResourcesInner
  */
  public static Action18ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action18ResourcesInner.class);
  }

 /**
  * Convert an instance of Action18ResourcesInner to an JSON string
  *
  * @return JSON string
  */
