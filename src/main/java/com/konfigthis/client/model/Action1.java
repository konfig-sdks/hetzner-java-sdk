...
import com.konfigthis.client.model.Action1Error;
import com.konfigthis.client.model.Action1ResourcesInner;
...
public class Action1 {
  ...
  private List<Action1ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action1 command(String command) {
  ...
  **/
  ...
  public Action1 error(Action1Error error) {
  ...
  **/
  ...
  public Action1Error getError() {
    return error;
  }


  public void setError(Action1Error error) {
  ...
  public Action1 finished(String finished) {
  ...
  **/
  ...
  public Action1 progress(Integer progress) {
  ...
  **/
  ...
  public Action1 resources(List<Action1ResourcesInner> resources) {
  ...
  public Action1 addResourcesItem(Action1ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action1ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action1ResourcesInner> resources) {
  ...
  public Action1 started(String started) {
  ...
  **/
  ...
  public Action1 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action1 instance itself
   */
  public Action1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.command, action1.command) &&
        Objects.equals(this.error, action1.error) &&
        Objects.equals(this.finished, action1.finished) &&
        Objects.equals(this.id, action1.id) &&
        Objects.equals(this.progress, action1.progress) &&
        Objects.equals(this.resources, action1.resources) &&
        Objects.equals(this.started, action1.started) &&
        Objects.equals(this.status, action1.status)&&
        Objects.equals(this.additionalProperties, action1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action1 is not found in the empty JSON string", Action1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action1.openapiRequiredFields) {
      ...
      Action1Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action1ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action1.class));

       return (TypeAdapter<T>) new TypeAdapter<Action1>() {
           @Override
           public void write(JsonWriter out, Action1 value) throws IOException {
           ...
           @Override
           public Action1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action1
  * @throws IOException if the JSON string is invalid with respect to Action1
  */
  public static Action1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action1.class);
  }

 /**
  * Convert an instance of Action1 to an JSON string
  *
  * @return JSON string
  */
