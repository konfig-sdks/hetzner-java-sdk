...
public class NetworkActionsAddSubnetRequest {
 ...
 public enum TypeEnum {
  ...
  public NetworkActionsAddSubnetRequest() {
  }

  public NetworkActionsAddSubnetRequest ipRange(String ipRange) {
  ...
  **/
  ...
  @ApiModelProperty(example = "10.0.1.0/24", value = "Range to allocate IPs from. Must be a Subnet of the ip_range of the parent network object and must not overlap with any other subnets or with any destinations in routes. If the Subnet is of type vSwitch, it also can not overlap with any gateway in routes. Minimum Network size is /30. We suggest that you pick a bigger Network with a /24 netmask.")
  ...
  public NetworkActionsAddSubnetRequest networkZone(String networkZone) {
  ...
  **/
  ...
  public NetworkActionsAddSubnetRequest type(TypeEnum type) {
  ...
  **/
  ...
  public NetworkActionsAddSubnetRequest vswitchId(Long vswitchId) {
  ...
  **/
   ...
   * @return the NetworkActionsAddSubnetRequest instance itself
   */
  public NetworkActionsAddSubnetRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsAddSubnetRequest networkActionsAddSubnetRequest = (NetworkActionsAddSubnetRequest) o;
    return Objects.equals(this.ipRange, networkActionsAddSubnetRequest.ipRange) &&
        Objects.equals(this.networkZone, networkActionsAddSubnetRequest.networkZone) &&
        Objects.equals(this.type, networkActionsAddSubnetRequest.type) &&
        Objects.equals(this.vswitchId, networkActionsAddSubnetRequest.vswitchId)&&
        Objects.equals(this.additionalProperties, networkActionsAddSubnetRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsAddSubnetRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsAddSubnetRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsAddSubnetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsAddSubnetRequest is not found in the empty JSON string", NetworkActionsAddSubnetRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsAddSubnetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsAddSubnetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsAddSubnetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsAddSubnetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsAddSubnetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsAddSubnetRequest>() {
           @Override
           public void write(JsonWriter out, NetworkActionsAddSubnetRequest value) throws IOException {
           ...
           @Override
           public NetworkActionsAddSubnetRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsAddSubnetRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsAddSubnetRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsAddSubnetRequest
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsAddSubnetRequest
  */
  public static NetworkActionsAddSubnetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsAddSubnetRequest.class);
  }

 /**
  * Convert an instance of NetworkActionsAddSubnetRequest to an JSON string
  *
  * @return JSON string
  */
