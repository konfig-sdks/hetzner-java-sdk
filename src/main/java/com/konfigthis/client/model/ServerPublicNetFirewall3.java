...
public class ServerPublicNetFirewall3 {
 ...
 public enum StatusEnum {
  ...
  public ServerPublicNetFirewall3() {
  }

  public ServerPublicNetFirewall3 id(Long id) {
  ...
  **/
  ...
  public ServerPublicNetFirewall3 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ServerPublicNetFirewall3 instance itself
   */
  public ServerPublicNetFirewall3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerPublicNetFirewall3 serverPublicNetFirewall3 = (ServerPublicNetFirewall3) o;
    return Objects.equals(this.id, serverPublicNetFirewall3.id) &&
        Objects.equals(this.status, serverPublicNetFirewall3.status)&&
        Objects.equals(this.additionalProperties, serverPublicNetFirewall3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerPublicNetFirewall3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerPublicNetFirewall3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerPublicNetFirewall3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerPublicNetFirewall3 is not found in the empty JSON string", ServerPublicNetFirewall3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerPublicNetFirewall3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerPublicNetFirewall3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerPublicNetFirewall3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerPublicNetFirewall3.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerPublicNetFirewall3>() {
           @Override
           public void write(JsonWriter out, ServerPublicNetFirewall3 value) throws IOException {
           ...
           @Override
           public ServerPublicNetFirewall3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerPublicNetFirewall3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerPublicNetFirewall3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerPublicNetFirewall3
  * @throws IOException if the JSON string is invalid with respect to ServerPublicNetFirewall3
  */
  public static ServerPublicNetFirewall3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerPublicNetFirewall3.class);
  }

 /**
  * Convert an instance of ServerPublicNetFirewall3 to an JSON string
  *
  * @return JSON string
  */
