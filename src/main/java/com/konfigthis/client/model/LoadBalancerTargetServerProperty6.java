...
public class LoadBalancerTargetServerProperty6 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty6() {
  }

  public LoadBalancerTargetServerProperty6 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty6 instance itself
   */
  public LoadBalancerTargetServerProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty6 loadBalancerTargetServerProperty6 = (LoadBalancerTargetServerProperty6) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty6.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty6 is not found in the empty JSON string", LoadBalancerTargetServerProperty6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty6>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty6 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty6
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty6
  */
  public static LoadBalancerTargetServerProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty6.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty6 to an JSON string
  *
  * @return JSON string
  */
