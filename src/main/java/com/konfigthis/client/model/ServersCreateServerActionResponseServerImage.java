...
import com.konfigthis.client.model.ServersCreateServerActionResponseServerImageCreatedFrom;
import com.konfigthis.client.model.ServersCreateServerActionResponseServerImageProtection;
...
public class ServersCreateServerActionResponseServerImage {
 ...
 public enum ArchitectureEnum {
  ...
  private ServersCreateServerActionResponseServerImageCreatedFrom createdFrom;
 ...
 public enum OsFlavorEnum {
  ...
  private ServersCreateServerActionResponseServerImageProtection protection;
 ...
 public enum TypeEnum {
  ...
  public ServersCreateServerActionResponseServerImage() {
  }

  public ServersCreateServerActionResponseServerImage description(String description) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage boundTo(Long boundTo) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage created(String created) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage createdFrom(ServersCreateServerActionResponseServerImageCreatedFrom createdFrom) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImageCreatedFrom getCreatedFrom() {
    return createdFrom;
  }


  public void setCreatedFrom(ServersCreateServerActionResponseServerImageCreatedFrom createdFrom) {
  ...
  public ServersCreateServerActionResponseServerImage deleted(String deleted) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage deprecated(String deprecated) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage diskSize(Double diskSize) {
  ...
  public ServersCreateServerActionResponseServerImage diskSize(Integer diskSize) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage id(Long id) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage imageSize(Double imageSize) {
  ...
  public ServersCreateServerActionResponseServerImage imageSize(Integer imageSize) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage labels(Map<String, String> labels) {
  ...
  public ServersCreateServerActionResponseServerImage putLabelsItem(String key, String labelsItem) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage name(String name) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage osFlavor(OsFlavorEnum osFlavor) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage osVersion(String osVersion) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage protection(ServersCreateServerActionResponseServerImageProtection protection) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImageProtection getProtection() {
    return protection;
  }


  public void setProtection(ServersCreateServerActionResponseServerImageProtection protection) {
  ...
  public ServersCreateServerActionResponseServerImage rapidDeploy(Boolean rapidDeploy) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage status(StatusEnum status) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerImage type(TypeEnum type) {
  ...
  **/
   ...
   * @return the ServersCreateServerActionResponseServerImage instance itself
   */
  public ServersCreateServerActionResponseServerImage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersCreateServerActionResponseServerImage serversCreateServerActionResponseServerImage = (ServersCreateServerActionResponseServerImage) o;
    return Objects.equals(this.description, serversCreateServerActionResponseServerImage.description) &&
        Objects.equals(this.architecture, serversCreateServerActionResponseServerImage.architecture) &&
        Objects.equals(this.boundTo, serversCreateServerActionResponseServerImage.boundTo) &&
        Objects.equals(this.created, serversCreateServerActionResponseServerImage.created) &&
        Objects.equals(this.createdFrom, serversCreateServerActionResponseServerImage.createdFrom) &&
        Objects.equals(this.deleted, serversCreateServerActionResponseServerImage.deleted) &&
        Objects.equals(this.deprecated, serversCreateServerActionResponseServerImage.deprecated) &&
        Objects.equals(this.diskSize, serversCreateServerActionResponseServerImage.diskSize) &&
        Objects.equals(this.id, serversCreateServerActionResponseServerImage.id) &&
        Objects.equals(this.imageSize, serversCreateServerActionResponseServerImage.imageSize) &&
        Objects.equals(this.labels, serversCreateServerActionResponseServerImage.labels) &&
        Objects.equals(this.name, serversCreateServerActionResponseServerImage.name) &&
        Objects.equals(this.osFlavor, serversCreateServerActionResponseServerImage.osFlavor) &&
        Objects.equals(this.osVersion, serversCreateServerActionResponseServerImage.osVersion) &&
        Objects.equals(this.protection, serversCreateServerActionResponseServerImage.protection) &&
        Objects.equals(this.rapidDeploy, serversCreateServerActionResponseServerImage.rapidDeploy) &&
        Objects.equals(this.status, serversCreateServerActionResponseServerImage.status) &&
        Objects.equals(this.type, serversCreateServerActionResponseServerImage.type)&&
        Objects.equals(this.additionalProperties, serversCreateServerActionResponseServerImage.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersCreateServerActionResponseServerImage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersCreateServerActionResponseServerImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersCreateServerActionResponseServerImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersCreateServerActionResponseServerImage is not found in the empty JSON string", ServersCreateServerActionResponseServerImage.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersCreateServerActionResponseServerImage.openapiRequiredFields) {
      ...
      ServersCreateServerActionResponseServerImageCreatedFrom.validateJsonObject(jsonObj.getAsJsonObject("created_from"));
      ...
      ServersCreateServerActionResponseServerImageProtection.validateJsonObject(jsonObj.getAsJsonObject("protection"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersCreateServerActionResponseServerImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersCreateServerActionResponseServerImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersCreateServerActionResponseServerImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersCreateServerActionResponseServerImage.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersCreateServerActionResponseServerImage>() {
           @Override
           public void write(JsonWriter out, ServersCreateServerActionResponseServerImage value) throws IOException {
           ...
           @Override
           public ServersCreateServerActionResponseServerImage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersCreateServerActionResponseServerImage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersCreateServerActionResponseServerImage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersCreateServerActionResponseServerImage
  * @throws IOException if the JSON string is invalid with respect to ServersCreateServerActionResponseServerImage
  */
  public static ServersCreateServerActionResponseServerImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersCreateServerActionResponseServerImage.class);
  }

 /**
  * Convert an instance of ServersCreateServerActionResponseServerImage to an JSON string
  *
  * @return JSON string
  */
