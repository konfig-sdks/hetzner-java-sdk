...
public class ActionProperty42Error {
  ...
  public ActionProperty42Error() {
  }

  public ActionProperty42Error code(String code) {
  ...
  **/
  ...
  public ActionProperty42Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty42Error instance itself
   */
  public ActionProperty42Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty42Error actionProperty42Error = (ActionProperty42Error) o;
    return Objects.equals(this.code, actionProperty42Error.code) &&
        Objects.equals(this.message, actionProperty42Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty42Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty42Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty42Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty42Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty42Error is not found in the empty JSON string", ActionProperty42Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty42Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty42Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty42Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty42Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty42Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty42Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty42Error value) throws IOException {
           ...
           @Override
           public ActionProperty42Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty42Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty42Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty42Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty42Error
  */
  public static ActionProperty42Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty42Error.class);
  }

 /**
  * Convert an instance of ActionProperty42Error to an JSON string
  *
  * @return JSON string
  */
