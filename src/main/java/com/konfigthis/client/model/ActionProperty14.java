...
import com.konfigthis.client.model.ActionProperty14Error;
import com.konfigthis.client.model.ActionProperty14ResourcesInner;
...
public class ActionProperty14 {
  ...
  private ActionProperty14Error error;
  ...
  private List<ActionProperty14ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty14() {
  }

  public ActionProperty14 command(String command) {
  ...
  **/
  ...
  public ActionProperty14 error(ActionProperty14Error error) {
  ...
  **/
  ...
  public ActionProperty14Error getError() {
    return error;
  }


  public void setError(ActionProperty14Error error) {
  ...
  public ActionProperty14 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty14 id(Long id) {
  ...
  **/
  ...
  public ActionProperty14 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty14 resources(List<ActionProperty14ResourcesInner> resources) {
  ...
  public ActionProperty14 addResourcesItem(ActionProperty14ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty14ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty14ResourcesInner> resources) {
  ...
  public ActionProperty14 started(String started) {
  ...
  **/
  ...
  public ActionProperty14 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty14 instance itself
   */
  public ActionProperty14 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty14 actionProperty14 = (ActionProperty14) o;
    return Objects.equals(this.command, actionProperty14.command) &&
        Objects.equals(this.error, actionProperty14.error) &&
        Objects.equals(this.finished, actionProperty14.finished) &&
        Objects.equals(this.id, actionProperty14.id) &&
        Objects.equals(this.progress, actionProperty14.progress) &&
        Objects.equals(this.resources, actionProperty14.resources) &&
        Objects.equals(this.started, actionProperty14.started) &&
        Objects.equals(this.status, actionProperty14.status)&&
        Objects.equals(this.additionalProperties, actionProperty14.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty14 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty14
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty14.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty14 is not found in the empty JSON string", ActionProperty14.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty14.openapiRequiredFields) {
      ...
      ActionProperty14Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty14ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty14.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty14>() {
           @Override
           public void write(JsonWriter out, ActionProperty14 value) throws IOException {
           ...
           @Override
           public ActionProperty14 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty14 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty14 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty14
  * @throws IOException if the JSON string is invalid with respect to ActionProperty14
  */
  public static ActionProperty14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty14.class);
  }

 /**
  * Convert an instance of ActionProperty14 to an JSON string
  *
  * @return JSON string
  */
