...
import com.konfigthis.client.model.ActionProperty40Error;
import com.konfigthis.client.model.ActionProperty40ResourcesInner;
...
public class ActionProperty40 {
  ...
  private ActionProperty40Error error;
  ...
  private List<ActionProperty40ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty40() {
  }

  public ActionProperty40 command(String command) {
  ...
  **/
  ...
  public ActionProperty40 error(ActionProperty40Error error) {
  ...
  **/
  ...
  public ActionProperty40Error getError() {
    return error;
  }


  public void setError(ActionProperty40Error error) {
  ...
  public ActionProperty40 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty40 id(Long id) {
  ...
  **/
  ...
  public ActionProperty40 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty40 resources(List<ActionProperty40ResourcesInner> resources) {
  ...
  public ActionProperty40 addResourcesItem(ActionProperty40ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty40ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty40ResourcesInner> resources) {
  ...
  public ActionProperty40 started(String started) {
  ...
  **/
  ...
  public ActionProperty40 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty40 instance itself
   */
  public ActionProperty40 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty40 actionProperty40 = (ActionProperty40) o;
    return Objects.equals(this.command, actionProperty40.command) &&
        Objects.equals(this.error, actionProperty40.error) &&
        Objects.equals(this.finished, actionProperty40.finished) &&
        Objects.equals(this.id, actionProperty40.id) &&
        Objects.equals(this.progress, actionProperty40.progress) &&
        Objects.equals(this.resources, actionProperty40.resources) &&
        Objects.equals(this.started, actionProperty40.started) &&
        Objects.equals(this.status, actionProperty40.status)&&
        Objects.equals(this.additionalProperties, actionProperty40.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty40 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty40
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty40.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty40 is not found in the empty JSON string", ActionProperty40.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty40.openapiRequiredFields) {
      ...
      ActionProperty40Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty40ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty40.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty40' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty40> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty40.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty40>() {
           @Override
           public void write(JsonWriter out, ActionProperty40 value) throws IOException {
           ...
           @Override
           public ActionProperty40 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty40 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty40 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty40
  * @throws IOException if the JSON string is invalid with respect to ActionProperty40
  */
  public static ActionProperty40 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty40.class);
  }

 /**
  * Convert an instance of ActionProperty40 to an JSON string
  *
  * @return JSON string
  */
