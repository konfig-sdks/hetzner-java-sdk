...
/**
 * ActionProperty36ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty36ResourcesInner {
  ...
  public ActionProperty36ResourcesInner() {
  }

  public ActionProperty36ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty36ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty36ResourcesInner instance itself
   */
  public ActionProperty36ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty36ResourcesInner actionProperty36ResourcesInner = (ActionProperty36ResourcesInner) o;
    return Objects.equals(this.id, actionProperty36ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty36ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty36ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty36ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty36ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty36ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty36ResourcesInner is not found in the empty JSON string", ActionProperty36ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty36ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty36ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty36ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty36ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty36ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty36ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty36ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty36ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty36ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty36ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty36ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty36ResourcesInner
  */
  public static ActionProperty36ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty36ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty36ResourcesInner to an JSON string
  *
  * @return JSON string
  */
