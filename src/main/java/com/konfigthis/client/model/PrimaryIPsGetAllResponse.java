...
import com.konfigthis.client.model.ListMetaProperty27;
import com.konfigthis.client.model.PrimaryIP;
...
public class PrimaryIPsGetAllResponse {
  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty27 meta;
  ...
  public PrimaryIPsGetAllResponse() {
  }

  public PrimaryIPsGetAllResponse meta(ListMetaProperty27 meta) {
  ...
  **/
  ...
  public ListMetaProperty27 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty27 meta) {
  ...
  public PrimaryIPsGetAllResponse primaryIps(List<PrimaryIP> primaryIps) {
  ...
  public PrimaryIPsGetAllResponse addPrimaryIpsItem(PrimaryIP primaryIpsItem) {
  ...
  **/
   ...
   * @return the PrimaryIPsGetAllResponse instance itself
   */
  public PrimaryIPsGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPsGetAllResponse primaryIPsGetAllResponse = (PrimaryIPsGetAllResponse) o;
    return Objects.equals(this.meta, primaryIPsGetAllResponse.meta) &&
        Objects.equals(this.primaryIps, primaryIPsGetAllResponse.primaryIps)&&
        Objects.equals(this.additionalProperties, primaryIPsGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, primaryIps, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrimaryIPsGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPsGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPsGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPsGetAllResponse is not found in the empty JSON string", PrimaryIPsGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPsGetAllResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty27.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
      ...
      for (int i = 0; i < jsonArrayprimaryIps.size(); i++) {
        PrimaryIP.validateJsonObject(jsonArrayprimaryIps.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPsGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPsGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPsGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPsGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPsGetAllResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryIPsGetAllResponse value) throws IOException {
           ...
           @Override
           public PrimaryIPsGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPsGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPsGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPsGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPsGetAllResponse
  */
  public static PrimaryIPsGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPsGetAllResponse.class);
  }

 /**
  * Convert an instance of PrimaryIPsGetAllResponse to an JSON string
  *
  * @return JSON string
  */
