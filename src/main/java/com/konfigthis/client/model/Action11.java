...
import com.konfigthis.client.model.Action11Error;
import com.konfigthis.client.model.Action11ResourcesInner;
...
public class Action11 {
  ...
  private List<Action11ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action11 command(String command) {
  ...
  **/
  ...
  public Action11 error(Action11Error error) {
  ...
  **/
  ...
  public Action11Error getError() {
    return error;
  }


  public void setError(Action11Error error) {
  ...
  public Action11 finished(String finished) {
  ...
  **/
  ...
  public Action11 progress(Integer progress) {
  ...
  **/
  ...
  public Action11 resources(List<Action11ResourcesInner> resources) {
  ...
  public Action11 addResourcesItem(Action11ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action11ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action11ResourcesInner> resources) {
  ...
  public Action11 started(String started) {
  ...
  **/
  ...
  public Action11 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action11 instance itself
   */
  public Action11 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action11 action11 = (Action11) o;
    return Objects.equals(this.command, action11.command) &&
        Objects.equals(this.error, action11.error) &&
        Objects.equals(this.finished, action11.finished) &&
        Objects.equals(this.id, action11.id) &&
        Objects.equals(this.progress, action11.progress) &&
        Objects.equals(this.resources, action11.resources) &&
        Objects.equals(this.started, action11.started) &&
        Objects.equals(this.status, action11.status)&&
        Objects.equals(this.additionalProperties, action11.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action11
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action11.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action11 is not found in the empty JSON string", Action11.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action11.openapiRequiredFields) {
      ...
      Action11Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action11ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action11.class));

       return (TypeAdapter<T>) new TypeAdapter<Action11>() {
           @Override
           public void write(JsonWriter out, Action11 value) throws IOException {
           ...
           @Override
           public Action11 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action11 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action11 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action11
  * @throws IOException if the JSON string is invalid with respect to Action11
  */
  public static Action11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action11.class);
  }

 /**
  * Convert an instance of Action11 to an JSON string
  *
  * @return JSON string
  */
