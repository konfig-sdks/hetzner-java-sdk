...
import com.konfigthis.client.model.Action8Error;
import com.konfigthis.client.model.Action8ResourcesInner;
...
public class Action8 {
  ...
  private List<Action8ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action8 command(String command) {
  ...
  **/
  ...
  public Action8 error(Action8Error error) {
  ...
  **/
  ...
  public Action8Error getError() {
    return error;
  }


  public void setError(Action8Error error) {
  ...
  public Action8 finished(String finished) {
  ...
  **/
  ...
  public Action8 progress(Integer progress) {
  ...
  **/
  ...
  public Action8 resources(List<Action8ResourcesInner> resources) {
  ...
  public Action8 addResourcesItem(Action8ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action8ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action8ResourcesInner> resources) {
  ...
  public Action8 started(String started) {
  ...
  **/
  ...
  public Action8 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action8 instance itself
   */
  public Action8 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action8 action8 = (Action8) o;
    return Objects.equals(this.command, action8.command) &&
        Objects.equals(this.error, action8.error) &&
        Objects.equals(this.finished, action8.finished) &&
        Objects.equals(this.id, action8.id) &&
        Objects.equals(this.progress, action8.progress) &&
        Objects.equals(this.resources, action8.resources) &&
        Objects.equals(this.started, action8.started) &&
        Objects.equals(this.status, action8.status)&&
        Objects.equals(this.additionalProperties, action8.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action8 is not found in the empty JSON string", Action8.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action8.openapiRequiredFields) {
      ...
      Action8Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action8ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action8.class));

       return (TypeAdapter<T>) new TypeAdapter<Action8>() {
           @Override
           public void write(JsonWriter out, Action8 value) throws IOException {
           ...
           @Override
           public Action8 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action8 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action8
  * @throws IOException if the JSON string is invalid with respect to Action8
  */
  public static Action8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action8.class);
  }

 /**
  * Convert an instance of Action8 to an JSON string
  *
  * @return JSON string
  */
