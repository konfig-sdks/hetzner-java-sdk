...
import com.konfigthis.client.model.Action23Error;
import com.konfigthis.client.model.Action23ResourcesInner;
...
public class Action23 {
  ...
  private List<Action23ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action23 command(String command) {
  ...
  **/
  ...
  public Action23 error(Action23Error error) {
  ...
  **/
  ...
  public Action23Error getError() {
    return error;
  }


  public void setError(Action23Error error) {
  ...
  public Action23 finished(String finished) {
  ...
  **/
  ...
  public Action23 progress(Integer progress) {
  ...
  **/
  ...
  public Action23 resources(List<Action23ResourcesInner> resources) {
  ...
  public Action23 addResourcesItem(Action23ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action23ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action23ResourcesInner> resources) {
  ...
  public Action23 started(String started) {
  ...
  **/
  ...
  public Action23 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action23 instance itself
   */
  public Action23 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action23 action23 = (Action23) o;
    return Objects.equals(this.command, action23.command) &&
        Objects.equals(this.error, action23.error) &&
        Objects.equals(this.finished, action23.finished) &&
        Objects.equals(this.id, action23.id) &&
        Objects.equals(this.progress, action23.progress) &&
        Objects.equals(this.resources, action23.resources) &&
        Objects.equals(this.started, action23.started) &&
        Objects.equals(this.status, action23.status)&&
        Objects.equals(this.additionalProperties, action23.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action23
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action23.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action23 is not found in the empty JSON string", Action23.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action23.openapiRequiredFields) {
      ...
      Action23Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action23ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action23.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action23' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action23> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action23.class));

       return (TypeAdapter<T>) new TypeAdapter<Action23>() {
           @Override
           public void write(JsonWriter out, Action23 value) throws IOException {
           ...
           @Override
           public Action23 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action23 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action23 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action23
  * @throws IOException if the JSON string is invalid with respect to Action23
  */
  public static Action23 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action23.class);
  }

 /**
  * Convert an instance of Action23 to an JSON string
  *
  * @return JSON string
  */
