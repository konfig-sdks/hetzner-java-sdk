...
public class ActionProperty45Error {
  ...
  public ActionProperty45Error() {
  }

  public ActionProperty45Error code(String code) {
  ...
  **/
  ...
  public ActionProperty45Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty45Error instance itself
   */
  public ActionProperty45Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty45Error actionProperty45Error = (ActionProperty45Error) o;
    return Objects.equals(this.code, actionProperty45Error.code) &&
        Objects.equals(this.message, actionProperty45Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty45Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty45Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty45Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty45Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty45Error is not found in the empty JSON string", ActionProperty45Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty45Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty45Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty45Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty45Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty45Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty45Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty45Error value) throws IOException {
           ...
           @Override
           public ActionProperty45Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty45Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty45Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty45Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty45Error
  */
  public static ActionProperty45Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty45Error.class);
  }

 /**
  * Convert an instance of ActionProperty45Error to an JSON string
  *
  * @return JSON string
  */
