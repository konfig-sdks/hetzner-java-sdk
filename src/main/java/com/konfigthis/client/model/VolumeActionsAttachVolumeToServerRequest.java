...
public class VolumeActionsAttachVolumeToServerRequest {
  ...
  public VolumeActionsAttachVolumeToServerRequest() {
  }

  public VolumeActionsAttachVolumeToServerRequest automount(Boolean automount) {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", value = "Auto-mount the Volume after attaching it")
  ...
  public VolumeActionsAttachVolumeToServerRequest server(Long server) {
  ...
  **/
  ...
  @ApiModelProperty(example = "43", required = true, value = "ID of the Server the Volume will be attached to")
   ...
   * @return the VolumeActionsAttachVolumeToServerRequest instance itself
   */
  public VolumeActionsAttachVolumeToServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeActionsAttachVolumeToServerRequest volumeActionsAttachVolumeToServerRequest = (VolumeActionsAttachVolumeToServerRequest) o;
    return Objects.equals(this.automount, volumeActionsAttachVolumeToServerRequest.automount) &&
        Objects.equals(this.server, volumeActionsAttachVolumeToServerRequest.server)&&
        Objects.equals(this.additionalProperties, volumeActionsAttachVolumeToServerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(automount, server, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VolumeActionsAttachVolumeToServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionsAttachVolumeToServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionsAttachVolumeToServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionsAttachVolumeToServerRequest is not found in the empty JSON string", VolumeActionsAttachVolumeToServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionsAttachVolumeToServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionsAttachVolumeToServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionsAttachVolumeToServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionsAttachVolumeToServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionsAttachVolumeToServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionsAttachVolumeToServerRequest>() {
           @Override
           public void write(JsonWriter out, VolumeActionsAttachVolumeToServerRequest value) throws IOException {
           ...
           @Override
           public VolumeActionsAttachVolumeToServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionsAttachVolumeToServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionsAttachVolumeToServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionsAttachVolumeToServerRequest
  * @throws IOException if the JSON string is invalid with respect to VolumeActionsAttachVolumeToServerRequest
  */
  public static VolumeActionsAttachVolumeToServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionsAttachVolumeToServerRequest.class);
  }

 /**
  * Convert an instance of VolumeActionsAttachVolumeToServerRequest to an JSON string
  *
  * @return JSON string
  */
