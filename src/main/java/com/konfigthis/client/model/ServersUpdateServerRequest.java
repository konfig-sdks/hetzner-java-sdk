...
public class ServersUpdateServerRequest {
  ...
  public ServersUpdateServerRequest() {
  }

  public ServersUpdateServerRequest labels(Object labels) {
  ...
  **/
  ...
  public ServersUpdateServerRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "my-server", value = "New name to set")
   ...
   * @return the ServersUpdateServerRequest instance itself
   */
  public ServersUpdateServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersUpdateServerRequest serversUpdateServerRequest = (ServersUpdateServerRequest) o;
    return Objects.equals(this.labels, serversUpdateServerRequest.labels) &&
        Objects.equals(this.name, serversUpdateServerRequest.name)&&
        Objects.equals(this.additionalProperties, serversUpdateServerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersUpdateServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersUpdateServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersUpdateServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersUpdateServerRequest is not found in the empty JSON string", ServersUpdateServerRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersUpdateServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersUpdateServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersUpdateServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersUpdateServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersUpdateServerRequest>() {
           @Override
           public void write(JsonWriter out, ServersUpdateServerRequest value) throws IOException {
           ...
           @Override
           public ServersUpdateServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersUpdateServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersUpdateServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersUpdateServerRequest
  * @throws IOException if the JSON string is invalid with respect to ServersUpdateServerRequest
  */
  public static ServersUpdateServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersUpdateServerRequest.class);
  }

 /**
  * Convert an instance of ServersUpdateServerRequest to an JSON string
  *
  * @return JSON string
  */
