...
import com.konfigthis.client.model.ActionProperty42Error;
import com.konfigthis.client.model.ActionProperty42ResourcesInner;
...
public class ActionProperty42 {
  ...
  private ActionProperty42Error error;
  ...
  private List<ActionProperty42ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty42() {
  }

  public ActionProperty42 command(String command) {
  ...
  **/
  ...
  public ActionProperty42 error(ActionProperty42Error error) {
  ...
  **/
  ...
  public ActionProperty42Error getError() {
    return error;
  }


  public void setError(ActionProperty42Error error) {
  ...
  public ActionProperty42 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty42 id(Long id) {
  ...
  **/
  ...
  public ActionProperty42 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty42 resources(List<ActionProperty42ResourcesInner> resources) {
  ...
  public ActionProperty42 addResourcesItem(ActionProperty42ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty42ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty42ResourcesInner> resources) {
  ...
  public ActionProperty42 started(String started) {
  ...
  **/
  ...
  public ActionProperty42 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty42 instance itself
   */
  public ActionProperty42 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty42 actionProperty42 = (ActionProperty42) o;
    return Objects.equals(this.command, actionProperty42.command) &&
        Objects.equals(this.error, actionProperty42.error) &&
        Objects.equals(this.finished, actionProperty42.finished) &&
        Objects.equals(this.id, actionProperty42.id) &&
        Objects.equals(this.progress, actionProperty42.progress) &&
        Objects.equals(this.resources, actionProperty42.resources) &&
        Objects.equals(this.started, actionProperty42.started) &&
        Objects.equals(this.status, actionProperty42.status)&&
        Objects.equals(this.additionalProperties, actionProperty42.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty42 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty42
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty42.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty42 is not found in the empty JSON string", ActionProperty42.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty42.openapiRequiredFields) {
      ...
      ActionProperty42Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty42ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty42.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty42' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty42> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty42.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty42>() {
           @Override
           public void write(JsonWriter out, ActionProperty42 value) throws IOException {
           ...
           @Override
           public ActionProperty42 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty42 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty42 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty42
  * @throws IOException if the JSON string is invalid with respect to ActionProperty42
  */
  public static ActionProperty42 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty42.class);
  }

 /**
  * Convert an instance of ActionProperty42 to an JSON string
  *
  * @return JSON string
  */
