...
/**
 * FirewallAppliedToInnerServer
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FirewallAppliedToInnerServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public FirewallAppliedToInnerServer() {
  }

  public FirewallAppliedToInnerServer id(Long id) {
  ...
  **/
   ...
   * @return the FirewallAppliedToInnerServer instance itself
   */
  public FirewallAppliedToInnerServer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallAppliedToInnerServer firewallAppliedToInnerServer = (FirewallAppliedToInnerServer) o;
    return Objects.equals(this.id, firewallAppliedToInnerServer.id)&&
        Objects.equals(this.additionalProperties, firewallAppliedToInnerServer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallAppliedToInnerServer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallAppliedToInnerServer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallAppliedToInnerServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallAppliedToInnerServer is not found in the empty JSON string", FirewallAppliedToInnerServer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallAppliedToInnerServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallAppliedToInnerServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallAppliedToInnerServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallAppliedToInnerServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallAppliedToInnerServer.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallAppliedToInnerServer>() {
           @Override
           public void write(JsonWriter out, FirewallAppliedToInnerServer value) throws IOException {
           ...
           @Override
           public FirewallAppliedToInnerServer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallAppliedToInnerServer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallAppliedToInnerServer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallAppliedToInnerServer
  * @throws IOException if the JSON string is invalid with respect to FirewallAppliedToInnerServer
  */
  public static FirewallAppliedToInnerServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallAppliedToInnerServer.class);
  }

 /**
  * Convert an instance of FirewallAppliedToInnerServer to an JSON string
  *
  * @return JSON string
  */
