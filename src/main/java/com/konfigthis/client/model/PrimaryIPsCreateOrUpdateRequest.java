...
public class PrimaryIPsCreateOrUpdateRequest {
 ...
 public enum TypeEnum {
  ...
  public PrimaryIPsCreateOrUpdateRequest() {
  }

  public PrimaryIPsCreateOrUpdateRequest assigneeId(Long assigneeId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "17", value = "ID of the resource the Primary IP should be assigned to. Omitted if it should not be assigned.")
  ...
  public PrimaryIPsCreateOrUpdateRequest assigneeType(AssigneeTypeEnum assigneeType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "SERVER", required = true, value = "Resource type the Primary IP can be assigned to")
  ...
  public PrimaryIPsCreateOrUpdateRequest autoDelete(Boolean autoDelete) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Delete the Primary IP when the Server it is assigned to is deleted.")
  ...
  public PrimaryIPsCreateOrUpdateRequest datacenter(String datacenter) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "fsn1-dc8", value = "ID or name of Datacenter the Primary IP will be bound to. Needs to be omitted if `assignee_id` is passed.")
  ...
  public PrimaryIPsCreateOrUpdateRequest labels(Object labels) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"labelkey\":\"value\"}", value = "User-defined labels (key-value pairs)")
  ...
  public PrimaryIPsCreateOrUpdateRequest name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "my-ip", required = true, value = "")
  ...
  public PrimaryIPsCreateOrUpdateRequest type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Primary IP type")
   ...
   * @return the PrimaryIPsCreateOrUpdateRequest instance itself
   */
  public PrimaryIPsCreateOrUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPsCreateOrUpdateRequest primaryIPsCreateOrUpdateRequest = (PrimaryIPsCreateOrUpdateRequest) o;
    return Objects.equals(this.assigneeId, primaryIPsCreateOrUpdateRequest.assigneeId) &&
        Objects.equals(this.assigneeType, primaryIPsCreateOrUpdateRequest.assigneeType) &&
        Objects.equals(this.autoDelete, primaryIPsCreateOrUpdateRequest.autoDelete) &&
        Objects.equals(this.datacenter, primaryIPsCreateOrUpdateRequest.datacenter) &&
        Objects.equals(this.labels, primaryIPsCreateOrUpdateRequest.labels) &&
        Objects.equals(this.name, primaryIPsCreateOrUpdateRequest.name) &&
        Objects.equals(this.type, primaryIPsCreateOrUpdateRequest.type)&&
        Objects.equals(this.additionalProperties, primaryIPsCreateOrUpdateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assigneeId, assigneeType, autoDelete, datacenter, labels, name, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrimaryIPsCreateOrUpdateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPsCreateOrUpdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPsCreateOrUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPsCreateOrUpdateRequest is not found in the empty JSON string", PrimaryIPsCreateOrUpdateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPsCreateOrUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPsCreateOrUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPsCreateOrUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPsCreateOrUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPsCreateOrUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPsCreateOrUpdateRequest>() {
           @Override
           public void write(JsonWriter out, PrimaryIPsCreateOrUpdateRequest value) throws IOException {
           ...
           @Override
           public PrimaryIPsCreateOrUpdateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPsCreateOrUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPsCreateOrUpdateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPsCreateOrUpdateRequest
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPsCreateOrUpdateRequest
  */
  public static PrimaryIPsCreateOrUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPsCreateOrUpdateRequest.class);
  }

 /**
  * Convert an instance of PrimaryIPsCreateOrUpdateRequest to an JSON string
  *
  * @return JSON string
  */
