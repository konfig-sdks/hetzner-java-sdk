...
public class ActionProperty19Error {
  ...
  public ActionProperty19Error() {
  }

  public ActionProperty19Error code(String code) {
  ...
  **/
  ...
  public ActionProperty19Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty19Error instance itself
   */
  public ActionProperty19Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty19Error actionProperty19Error = (ActionProperty19Error) o;
    return Objects.equals(this.code, actionProperty19Error.code) &&
        Objects.equals(this.message, actionProperty19Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty19Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty19Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty19Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty19Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty19Error is not found in the empty JSON string", ActionProperty19Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty19Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty19Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty19Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty19Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty19Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty19Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty19Error value) throws IOException {
           ...
           @Override
           public ActionProperty19Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty19Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty19Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty19Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty19Error
  */
  public static ActionProperty19Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty19Error.class);
  }

 /**
  * Convert an instance of ActionProperty19Error to an JSON string
  *
  * @return JSON string
  */
