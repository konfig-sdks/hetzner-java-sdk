...
public class ActionProperty75Error {
  ...
  public ActionProperty75Error() {
  }

  public ActionProperty75Error code(String code) {
  ...
  **/
  ...
  public ActionProperty75Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty75Error instance itself
   */
  public ActionProperty75Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty75Error actionProperty75Error = (ActionProperty75Error) o;
    return Objects.equals(this.code, actionProperty75Error.code) &&
        Objects.equals(this.message, actionProperty75Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty75Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty75Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty75Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty75Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty75Error is not found in the empty JSON string", ActionProperty75Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty75Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty75Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty75Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty75Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty75Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty75Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty75Error value) throws IOException {
           ...
           @Override
           public ActionProperty75Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty75Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty75Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty75Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty75Error
  */
  public static ActionProperty75Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty75Error.class);
  }

 /**
  * Convert an instance of ActionProperty75Error to an JSON string
  *
  * @return JSON string
  */
