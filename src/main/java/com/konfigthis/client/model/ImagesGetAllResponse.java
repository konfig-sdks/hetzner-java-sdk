...
import com.konfigthis.client.model.ImagesGetAllResponseImagesInner;
import com.konfigthis.client.model.ListMetaProperty15;
...
public class ImagesGetAllResponse {
  public static final String SERIALIZED_NAME_IMAGES = "images";
  @SerializedName(SERIALIZED_NAME_IMAGES)
  private List<ImagesGetAllResponseImagesInner> images = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty15 meta;

  public ImagesGetAllResponse() {
  }

  public ImagesGetAllResponse images(List<ImagesGetAllResponseImagesInner> images) {
  ...
  public ImagesGetAllResponse addImagesItem(ImagesGetAllResponseImagesInner imagesItem) {
  ...
  **/
  ...
  public List<ImagesGetAllResponseImagesInner> getImages() {
    return images;
  }


  public void setImages(List<ImagesGetAllResponseImagesInner> images) {
  ...
  public ImagesGetAllResponse meta(ListMetaProperty15 meta) {
  ...
  **/
  ...
  public ListMetaProperty15 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty15 meta) {
   ...
   * @return the ImagesGetAllResponse instance itself
   */
  public ImagesGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesGetAllResponse imagesGetAllResponse = (ImagesGetAllResponse) o;
    return Objects.equals(this.images, imagesGetAllResponse.images) &&
        Objects.equals(this.meta, imagesGetAllResponse.meta)&&
        Objects.equals(this.additionalProperties, imagesGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(images, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImagesGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGetAllResponse is not found in the empty JSON string", ImagesGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesGetAllResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayimages.size(); i++) {
        ImagesGetAllResponseImagesInner.validateJsonObject(jsonArrayimages.get(i).getAsJsonObject());
      };
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty15.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGetAllResponse>() {
           @Override
           public void write(JsonWriter out, ImagesGetAllResponse value) throws IOException {
           ...
           @Override
           public ImagesGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to ImagesGetAllResponse
  */
  public static ImagesGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGetAllResponse.class);
  }

 /**
  * Convert an instance of ImagesGetAllResponse to an JSON string
  *
  * @return JSON string
  */
