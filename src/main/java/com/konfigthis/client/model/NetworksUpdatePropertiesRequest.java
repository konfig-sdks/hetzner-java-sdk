...
public class NetworksUpdatePropertiesRequest {
  ...
  public NetworksUpdatePropertiesRequest() {
  }

  public NetworksUpdatePropertiesRequest exposeRoutesToVswitch(Boolean exposeRoutesToVswitch) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesRequest labels(NetworksUpdatePropertiesRequestLabels labels) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesRequestLabels getLabels() {
    return labels;
  }


  public void setLabels(NetworksUpdatePropertiesRequestLabels labels) {
  ...
  public NetworksUpdatePropertiesRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "new-name", value = "New network name")
   ...
   * @return the NetworksUpdatePropertiesRequest instance itself
   */
  public NetworksUpdatePropertiesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksUpdatePropertiesRequest networksUpdatePropertiesRequest = (NetworksUpdatePropertiesRequest) o;
    return Objects.equals(this.exposeRoutesToVswitch, networksUpdatePropertiesRequest.exposeRoutesToVswitch) &&
        Objects.equals(this.labels, networksUpdatePropertiesRequest.labels) &&
        Objects.equals(this.name, networksUpdatePropertiesRequest.name)&&
        Objects.equals(this.additionalProperties, networksUpdatePropertiesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exposeRoutesToVswitch, labels, name, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NetworksUpdatePropertiesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksUpdatePropertiesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksUpdatePropertiesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksUpdatePropertiesRequest is not found in the empty JSON string", NetworksUpdatePropertiesRequest.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `labels`
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        NetworksUpdatePropertiesRequestLabels.validateJsonObject(jsonObj.getAsJsonObject("labels"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksUpdatePropertiesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksUpdatePropertiesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksUpdatePropertiesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksUpdatePropertiesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksUpdatePropertiesRequest>() {
           @Override
           public void write(JsonWriter out, NetworksUpdatePropertiesRequest value) throws IOException {
           ...
           @Override
           public NetworksUpdatePropertiesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksUpdatePropertiesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksUpdatePropertiesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksUpdatePropertiesRequest
  * @throws IOException if the JSON string is invalid with respect to NetworksUpdatePropertiesRequest
  */
  public static NetworksUpdatePropertiesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksUpdatePropertiesRequest.class);
  }

 /**
  * Convert an instance of NetworksUpdatePropertiesRequest to an JSON string
  *
  * @return JSON string
  */
