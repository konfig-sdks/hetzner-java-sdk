...
/**
 * Action7ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action7ResourcesInner {
  ...
  public Action7ResourcesInner() {
  }

  public Action7ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action7ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action7ResourcesInner instance itself
   */
  public Action7ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action7ResourcesInner action7ResourcesInner = (Action7ResourcesInner) o;
    return Objects.equals(this.id, action7ResourcesInner.id) &&
        Objects.equals(this.type, action7ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action7ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action7ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action7ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action7ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action7ResourcesInner is not found in the empty JSON string", Action7ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action7ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action7ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action7ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action7ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action7ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action7ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action7ResourcesInner value) throws IOException {
           ...
           @Override
           public Action7ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action7ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action7ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action7ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action7ResourcesInner
  */
  public static Action7ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action7ResourcesInner.class);
  }

 /**
  * Convert an instance of Action7ResourcesInner to an JSON string
  *
  * @return JSON string
  */
