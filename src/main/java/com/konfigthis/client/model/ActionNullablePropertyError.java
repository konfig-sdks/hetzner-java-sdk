...
public class ActionNullablePropertyError {
  ...
  public ActionNullablePropertyError() {
  }

  public ActionNullablePropertyError code(String code) {
  ...
  **/
  ...
  public ActionNullablePropertyError message(String message) {
  ...
  **/
   ...
   * @return the ActionNullablePropertyError instance itself
   */
  public ActionNullablePropertyError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullablePropertyError actionNullablePropertyError = (ActionNullablePropertyError) o;
    return Objects.equals(this.code, actionNullablePropertyError.code) &&
        Objects.equals(this.message, actionNullablePropertyError.message)&&
        Objects.equals(this.additionalProperties, actionNullablePropertyError.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullablePropertyError {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullablePropertyError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullablePropertyError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullablePropertyError is not found in the empty JSON string", ActionNullablePropertyError.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullablePropertyError.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullablePropertyError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullablePropertyError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullablePropertyError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullablePropertyError.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullablePropertyError>() {
           @Override
           public void write(JsonWriter out, ActionNullablePropertyError value) throws IOException {
           ...
           @Override
           public ActionNullablePropertyError read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullablePropertyError instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullablePropertyError given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullablePropertyError
  * @throws IOException if the JSON string is invalid with respect to ActionNullablePropertyError
  */
  public static ActionNullablePropertyError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullablePropertyError.class);
  }

 /**
  * Convert an instance of ActionNullablePropertyError to an JSON string
  *
  * @return JSON string
  */
