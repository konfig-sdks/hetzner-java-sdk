...
/**
 * ActionProperty43ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty43ResourcesInner {
  ...
  public ActionProperty43ResourcesInner() {
  }

  public ActionProperty43ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty43ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty43ResourcesInner instance itself
   */
  public ActionProperty43ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty43ResourcesInner actionProperty43ResourcesInner = (ActionProperty43ResourcesInner) o;
    return Objects.equals(this.id, actionProperty43ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty43ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty43ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty43ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty43ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty43ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty43ResourcesInner is not found in the empty JSON string", ActionProperty43ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty43ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty43ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty43ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty43ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty43ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty43ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty43ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty43ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty43ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty43ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty43ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty43ResourcesInner
  */
  public static ActionProperty43ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty43ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty43ResourcesInner to an JSON string
  *
  * @return JSON string
  */
