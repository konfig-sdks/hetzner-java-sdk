...
public class NetworksGetAllResponseNetworksInnerProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public NetworksGetAllResponseNetworksInnerProtection() {
  }

  public NetworksGetAllResponseNetworksInnerProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the NetworksGetAllResponseNetworksInnerProtection instance itself
   */
  public NetworksGetAllResponseNetworksInnerProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksGetAllResponseNetworksInnerProtection networksGetAllResponseNetworksInnerProtection = (NetworksGetAllResponseNetworksInnerProtection) o;
    return Objects.equals(this.delete, networksGetAllResponseNetworksInnerProtection.delete)&&
        Objects.equals(this.additionalProperties, networksGetAllResponseNetworksInnerProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGetAllResponseNetworksInnerProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksGetAllResponseNetworksInnerProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksGetAllResponseNetworksInnerProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGetAllResponseNetworksInnerProtection is not found in the empty JSON string", NetworksGetAllResponseNetworksInnerProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGetAllResponseNetworksInnerProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGetAllResponseNetworksInnerProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGetAllResponseNetworksInnerProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGetAllResponseNetworksInnerProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGetAllResponseNetworksInnerProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGetAllResponseNetworksInnerProtection>() {
           @Override
           public void write(JsonWriter out, NetworksGetAllResponseNetworksInnerProtection value) throws IOException {
           ...
           @Override
           public NetworksGetAllResponseNetworksInnerProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksGetAllResponseNetworksInnerProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksGetAllResponseNetworksInnerProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksGetAllResponseNetworksInnerProtection
  * @throws IOException if the JSON string is invalid with respect to NetworksGetAllResponseNetworksInnerProtection
  */
  public static NetworksGetAllResponseNetworksInnerProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGetAllResponseNetworksInnerProtection.class);
  }

 /**
  * Convert an instance of NetworksGetAllResponseNetworksInnerProtection to an JSON string
  *
  * @return JSON string
  */
