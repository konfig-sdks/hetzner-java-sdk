...
public class ListMetaProperty25Pagination {
  ...
  public ListMetaProperty25Pagination() {
  }

  public ListMetaProperty25Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty25Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty25Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty25Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty25Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty25Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty25Pagination instance itself
   */
  public ListMetaProperty25Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty25Pagination listMetaProperty25Pagination = (ListMetaProperty25Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty25Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty25Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty25Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty25Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty25Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty25Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty25Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty25Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty25Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty25Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty25Pagination is not found in the empty JSON string", ListMetaProperty25Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty25Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty25Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty25Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty25Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty25Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty25Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty25Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty25Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty25Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty25Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty25Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty25Pagination
  */
  public static ListMetaProperty25Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty25Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty25Pagination to an JSON string
  *
  * @return JSON string
  */
