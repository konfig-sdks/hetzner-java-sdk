...
public class ActionProperty78Error {
  ...
  public ActionProperty78Error() {
  }

  public ActionProperty78Error code(String code) {
  ...
  **/
  ...
  public ActionProperty78Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty78Error instance itself
   */
  public ActionProperty78Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty78Error actionProperty78Error = (ActionProperty78Error) o;
    return Objects.equals(this.code, actionProperty78Error.code) &&
        Objects.equals(this.message, actionProperty78Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty78Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty78Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty78Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty78Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty78Error is not found in the empty JSON string", ActionProperty78Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty78Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty78Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty78Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty78Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty78Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty78Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty78Error value) throws IOException {
           ...
           @Override
           public ActionProperty78Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty78Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty78Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty78Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty78Error
  */
  public static ActionProperty78Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty78Error.class);
  }

 /**
  * Convert an instance of ActionProperty78Error to an JSON string
  *
  * @return JSON string
  */
