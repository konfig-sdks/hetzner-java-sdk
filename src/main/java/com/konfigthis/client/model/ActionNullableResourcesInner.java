...
/**
 * ActionNullableResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionNullableResourcesInner {
  ...
  public ActionNullableResourcesInner() {
  }

  public ActionNullableResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionNullableResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionNullableResourcesInner instance itself
   */
  public ActionNullableResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullableResourcesInner actionNullableResourcesInner = (ActionNullableResourcesInner) o;
    return Objects.equals(this.id, actionNullableResourcesInner.id) &&
        Objects.equals(this.type, actionNullableResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionNullableResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullableResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullableResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullableResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullableResourcesInner is not found in the empty JSON string", ActionNullableResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullableResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullableResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullableResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullableResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullableResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullableResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionNullableResourcesInner value) throws IOException {
           ...
           @Override
           public ActionNullableResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullableResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullableResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullableResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionNullableResourcesInner
  */
  public static ActionNullableResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullableResourcesInner.class);
  }

 /**
  * Convert an instance of ActionNullableResourcesInner to an JSON string
  *
  * @return JSON string
  */
