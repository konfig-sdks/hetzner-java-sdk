...
public class ListMetaProperty28Pagination {
  ...
  public ListMetaProperty28Pagination() {
  }

  public ListMetaProperty28Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty28Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty28Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty28Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty28Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty28Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty28Pagination instance itself
   */
  public ListMetaProperty28Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty28Pagination listMetaProperty28Pagination = (ListMetaProperty28Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty28Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty28Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty28Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty28Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty28Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty28Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty28Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty28Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty28Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty28Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty28Pagination is not found in the empty JSON string", ListMetaProperty28Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty28Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty28Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty28Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty28Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty28Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty28Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty28Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty28Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty28Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty28Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty28Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty28Pagination
  */
  public static ListMetaProperty28Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty28Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty28Pagination to an JSON string
  *
  * @return JSON string
  */
