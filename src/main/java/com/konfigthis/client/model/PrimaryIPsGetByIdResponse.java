...
import com.konfigthis.client.model.PrimaryIPProperty1;
...
public class PrimaryIPsGetByIdResponse {
  public static final String SERIALIZED_NAME_PRIMARY_IP = "primary_ip";
  @SerializedName(SERIALIZED_NAME_PRIMARY_IP)
  private PrimaryIPProperty1 primaryIp;

  public PrimaryIPsGetByIdResponse() {
  }

  public PrimaryIPsGetByIdResponse primaryIp(PrimaryIPProperty1 primaryIp) {
  ...
  **/
  ...
  public PrimaryIPProperty1 getPrimaryIp() {
    return primaryIp;
  }


  public void setPrimaryIp(PrimaryIPProperty1 primaryIp) {
   ...
   * @return the PrimaryIPsGetByIdResponse instance itself
   */
  public PrimaryIPsGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPsGetByIdResponse primaryIPsGetByIdResponse = (PrimaryIPsGetByIdResponse) o;
    return Objects.equals(this.primaryIp, primaryIPsGetByIdResponse.primaryIp)&&
        Objects.equals(this.additionalProperties, primaryIPsGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPsGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPsGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPsGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPsGetByIdResponse is not found in the empty JSON string", PrimaryIPsGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPsGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `primary_ip`
      PrimaryIPProperty1.validateJsonObject(jsonObj.getAsJsonObject("primary_ip"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPsGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPsGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPsGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPsGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPsGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryIPsGetByIdResponse value) throws IOException {
           ...
           @Override
           public PrimaryIPsGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPsGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPsGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPsGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPsGetByIdResponse
  */
  public static PrimaryIPsGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPsGetByIdResponse.class);
  }

 /**
  * Convert an instance of PrimaryIPsGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
