...
import com.konfigthis.client.model.ActionProperty53;
...
public class ServerActionsChangeAliasIpsResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty53 action;

  public ServerActionsChangeAliasIpsResponse() {
  }

  public ServerActionsChangeAliasIpsResponse action(ActionProperty53 action) {
  ...
  **/
  ...
  public ActionProperty53 getAction() {
    return action;
  }


  public void setAction(ActionProperty53 action) {
   ...
   * @return the ServerActionsChangeAliasIpsResponse instance itself
   */
  public ServerActionsChangeAliasIpsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsChangeAliasIpsResponse serverActionsChangeAliasIpsResponse = (ServerActionsChangeAliasIpsResponse) o;
    return Objects.equals(this.action, serverActionsChangeAliasIpsResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsChangeAliasIpsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsChangeAliasIpsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsChangeAliasIpsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsChangeAliasIpsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsChangeAliasIpsResponse is not found in the empty JSON string", ServerActionsChangeAliasIpsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsChangeAliasIpsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty53.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsChangeAliasIpsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsChangeAliasIpsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsChangeAliasIpsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsChangeAliasIpsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsChangeAliasIpsResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsChangeAliasIpsResponse value) throws IOException {
           ...
           @Override
           public ServerActionsChangeAliasIpsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsChangeAliasIpsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsChangeAliasIpsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsChangeAliasIpsResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsChangeAliasIpsResponse
  */
  public static ServerActionsChangeAliasIpsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsChangeAliasIpsResponse.class);
  }

 /**
  * Convert an instance of ServerActionsChangeAliasIpsResponse to an JSON string
  *
  * @return JSON string
  */
