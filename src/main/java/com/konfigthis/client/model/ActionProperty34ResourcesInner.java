...
public class ActionProperty34ResourcesInner {
  ...
  public ActionProperty34ResourcesInner() {
  }

  public ActionProperty34ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty34ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty34ResourcesInner instance itself
   */
  public ActionProperty34ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty34ResourcesInner actionProperty34ResourcesInner = (ActionProperty34ResourcesInner) o;
    return Objects.equals(this.id, actionProperty34ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty34ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty34ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty34ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty34ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty34ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty34ResourcesInner is not found in the empty JSON string", ActionProperty34ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty34ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty34ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty34ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty34ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty34ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty34ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty34ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty34ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty34ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty34ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty34ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty34ResourcesInner
  */
  public static ActionProperty34ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty34ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty34ResourcesInner to an JSON string
  *
  * @return JSON string
  */
