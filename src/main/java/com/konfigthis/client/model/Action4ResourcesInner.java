...
/**
 * Action4ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action4ResourcesInner {
  ...
  public Action4ResourcesInner() {
  }

  public Action4ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action4ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action4ResourcesInner instance itself
   */
  public Action4ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action4ResourcesInner action4ResourcesInner = (Action4ResourcesInner) o;
    return Objects.equals(this.id, action4ResourcesInner.id) &&
        Objects.equals(this.type, action4ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action4ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action4ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action4ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action4ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action4ResourcesInner is not found in the empty JSON string", Action4ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action4ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action4ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action4ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action4ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action4ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action4ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action4ResourcesInner value) throws IOException {
           ...
           @Override
           public Action4ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action4ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action4ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action4ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action4ResourcesInner
  */
  public static Action4ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action4ResourcesInner.class);
  }

 /**
  * Convert an instance of Action4ResourcesInner to an JSON string
  *
  * @return JSON string
  */
