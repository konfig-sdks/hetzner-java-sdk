...
import com.konfigthis.client.model.ImagesUpdateImageByIdResponseImageCreatedFrom;
import com.konfigthis.client.model.ImagesUpdateImageByIdResponseImageProtection;
...
public class ImagesUpdateImageByIdResponseImage {
 ...
 public enum ArchitectureEnum {
  ...
  private ImagesUpdateImageByIdResponseImageCreatedFrom createdFrom;
 ...
 public enum OsFlavorEnum {
  ...
  private ImagesUpdateImageByIdResponseImageProtection protection;
 ...
 public enum TypeEnum {
  ...
  public ImagesUpdateImageByIdResponseImage() {
  }

  public ImagesUpdateImageByIdResponseImage description(String description) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage boundTo(Long boundTo) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage created(String created) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage createdFrom(ImagesUpdateImageByIdResponseImageCreatedFrom createdFrom) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImageCreatedFrom getCreatedFrom() {
    return createdFrom;
  }


  public void setCreatedFrom(ImagesUpdateImageByIdResponseImageCreatedFrom createdFrom) {
  ...
  public ImagesUpdateImageByIdResponseImage deleted(String deleted) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage deprecated(String deprecated) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage diskSize(Double diskSize) {
  ...
  public ImagesUpdateImageByIdResponseImage diskSize(Integer diskSize) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage id(Long id) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage imageSize(Double imageSize) {
  ...
  public ImagesUpdateImageByIdResponseImage imageSize(Integer imageSize) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage labels(Map<String, String> labels) {
  ...
  public ImagesUpdateImageByIdResponseImage putLabelsItem(String key, String labelsItem) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage name(String name) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage osFlavor(OsFlavorEnum osFlavor) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage osVersion(String osVersion) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage protection(ImagesUpdateImageByIdResponseImageProtection protection) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImageProtection getProtection() {
    return protection;
  }


  public void setProtection(ImagesUpdateImageByIdResponseImageProtection protection) {
  ...
  public ImagesUpdateImageByIdResponseImage rapidDeploy(Boolean rapidDeploy) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage status(StatusEnum status) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage type(TypeEnum type) {
  ...
  **/
   ...
   * @return the ImagesUpdateImageByIdResponseImage instance itself
   */
  public ImagesUpdateImageByIdResponseImage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesUpdateImageByIdResponseImage imagesUpdateImageByIdResponseImage = (ImagesUpdateImageByIdResponseImage) o;
    return Objects.equals(this.description, imagesUpdateImageByIdResponseImage.description) &&
        Objects.equals(this.architecture, imagesUpdateImageByIdResponseImage.architecture) &&
        Objects.equals(this.boundTo, imagesUpdateImageByIdResponseImage.boundTo) &&
        Objects.equals(this.created, imagesUpdateImageByIdResponseImage.created) &&
        Objects.equals(this.createdFrom, imagesUpdateImageByIdResponseImage.createdFrom) &&
        Objects.equals(this.deleted, imagesUpdateImageByIdResponseImage.deleted) &&
        Objects.equals(this.deprecated, imagesUpdateImageByIdResponseImage.deprecated) &&
        Objects.equals(this.diskSize, imagesUpdateImageByIdResponseImage.diskSize) &&
        Objects.equals(this.id, imagesUpdateImageByIdResponseImage.id) &&
        Objects.equals(this.imageSize, imagesUpdateImageByIdResponseImage.imageSize) &&
        Objects.equals(this.labels, imagesUpdateImageByIdResponseImage.labels) &&
        Objects.equals(this.name, imagesUpdateImageByIdResponseImage.name) &&
        Objects.equals(this.osFlavor, imagesUpdateImageByIdResponseImage.osFlavor) &&
        Objects.equals(this.osVersion, imagesUpdateImageByIdResponseImage.osVersion) &&
        Objects.equals(this.protection, imagesUpdateImageByIdResponseImage.protection) &&
        Objects.equals(this.rapidDeploy, imagesUpdateImageByIdResponseImage.rapidDeploy) &&
        Objects.equals(this.status, imagesUpdateImageByIdResponseImage.status) &&
        Objects.equals(this.type, imagesUpdateImageByIdResponseImage.type)&&
        Objects.equals(this.additionalProperties, imagesUpdateImageByIdResponseImage.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesUpdateImageByIdResponseImage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesUpdateImageByIdResponseImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesUpdateImageByIdResponseImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesUpdateImageByIdResponseImage is not found in the empty JSON string", ImagesUpdateImageByIdResponseImage.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesUpdateImageByIdResponseImage.openapiRequiredFields) {
      ...
      ImagesUpdateImageByIdResponseImageCreatedFrom.validateJsonObject(jsonObj.getAsJsonObject("created_from"));
      ...
      ImagesUpdateImageByIdResponseImageProtection.validateJsonObject(jsonObj.getAsJsonObject("protection"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesUpdateImageByIdResponseImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesUpdateImageByIdResponseImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesUpdateImageByIdResponseImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesUpdateImageByIdResponseImage.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesUpdateImageByIdResponseImage>() {
           @Override
           public void write(JsonWriter out, ImagesUpdateImageByIdResponseImage value) throws IOException {
           ...
           @Override
           public ImagesUpdateImageByIdResponseImage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesUpdateImageByIdResponseImage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesUpdateImageByIdResponseImage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesUpdateImageByIdResponseImage
  * @throws IOException if the JSON string is invalid with respect to ImagesUpdateImageByIdResponseImage
  */
  public static ImagesUpdateImageByIdResponseImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesUpdateImageByIdResponseImage.class);
  }

 /**
  * Convert an instance of ImagesUpdateImageByIdResponseImage to an JSON string
  *
  * @return JSON string
  */
