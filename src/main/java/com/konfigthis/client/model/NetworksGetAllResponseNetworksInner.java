...
import com.konfigthis.client.model.NetworksGetAllResponseNetworksInnerProtection;
import com.konfigthis.client.model.NetworksGetAllResponseNetworksInnerRoutesInner;
import com.konfigthis.client.model.NetworksGetAllResponseNetworksInnerSubnetsInner;
...
public class NetworksGetAllResponseNetworksInner {
  ...
  private NetworksGetAllResponseNetworksInnerProtection protection;

  public static final String SERIALIZED_NAME_ROUTES = "routes";
  @SerializedName(SERIALIZED_NAME_ROUTES)
  private List<NetworksGetAllResponseNetworksInnerRoutesInner> routes = new ArrayList<>();

  public static final String SERIALIZED_NAME_SUBNETS = "subnets";
  @SerializedName(SERIALIZED_NAME_SUBNETS)
  private List<NetworksGetAllResponseNetworksInnerSubnetsInner> subnets = new ArrayList<>();

  public NetworksGetAllResponseNetworksInner() {
  }

  public NetworksGetAllResponseNetworksInner servers(List<Long> servers) {
  ...
  public NetworksGetAllResponseNetworksInner addServersItem(Long serversItem) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner created(String created) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner exposeRoutesToVswitch(Boolean exposeRoutesToVswitch) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner id(Long id) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner ipRange(String ipRange) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner labels(Object labels) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner loadBalancers(List<Long> loadBalancers) {
  ...
  public NetworksGetAllResponseNetworksInner addLoadBalancersItem(Long loadBalancersItem) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner name(String name) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInner protection(NetworksGetAllResponseNetworksInnerProtection protection) {
  ...
  **/
  ...
  public NetworksGetAllResponseNetworksInnerProtection getProtection() {
    return protection;
  }


  public void setProtection(NetworksGetAllResponseNetworksInnerProtection protection) {
  ...
  public NetworksGetAllResponseNetworksInner routes(List<NetworksGetAllResponseNetworksInnerRoutesInner> routes) {
  ...
  public NetworksGetAllResponseNetworksInner addRoutesItem(NetworksGetAllResponseNetworksInnerRoutesInner routesItem) {
  ...
  **/
  ...
  public List<NetworksGetAllResponseNetworksInnerRoutesInner> getRoutes() {
    return routes;
  }


  public void setRoutes(List<NetworksGetAllResponseNetworksInnerRoutesInner> routes) {
  ...
  public NetworksGetAllResponseNetworksInner subnets(List<NetworksGetAllResponseNetworksInnerSubnetsInner> subnets) {
  ...
  public NetworksGetAllResponseNetworksInner addSubnetsItem(NetworksGetAllResponseNetworksInnerSubnetsInner subnetsItem) {
  ...
  **/
  ...
  public List<NetworksGetAllResponseNetworksInnerSubnetsInner> getSubnets() {
    return subnets;
  }


  public void setSubnets(List<NetworksGetAllResponseNetworksInnerSubnetsInner> subnets) {
   ...
   * @return the NetworksGetAllResponseNetworksInner instance itself
   */
  public NetworksGetAllResponseNetworksInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksGetAllResponseNetworksInner networksGetAllResponseNetworksInner = (NetworksGetAllResponseNetworksInner) o;
    return Objects.equals(this.servers, networksGetAllResponseNetworksInner.servers) &&
        Objects.equals(this.created, networksGetAllResponseNetworksInner.created) &&
        Objects.equals(this.exposeRoutesToVswitch, networksGetAllResponseNetworksInner.exposeRoutesToVswitch) &&
        Objects.equals(this.id, networksGetAllResponseNetworksInner.id) &&
        Objects.equals(this.ipRange, networksGetAllResponseNetworksInner.ipRange) &&
        Objects.equals(this.labels, networksGetAllResponseNetworksInner.labels) &&
        Objects.equals(this.loadBalancers, networksGetAllResponseNetworksInner.loadBalancers) &&
        Objects.equals(this.name, networksGetAllResponseNetworksInner.name) &&
        Objects.equals(this.protection, networksGetAllResponseNetworksInner.protection) &&
        Objects.equals(this.routes, networksGetAllResponseNetworksInner.routes) &&
        Objects.equals(this.subnets, networksGetAllResponseNetworksInner.subnets)&&
        Objects.equals(this.additionalProperties, networksGetAllResponseNetworksInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGetAllResponseNetworksInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksGetAllResponseNetworksInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksGetAllResponseNetworksInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGetAllResponseNetworksInner is not found in the empty JSON string", NetworksGetAllResponseNetworksInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGetAllResponseNetworksInner.openapiRequiredFields) {
      ...
      NetworksGetAllResponseNetworksInnerProtection.validateJsonObject(jsonObj.getAsJsonObject("protection"));
      ...
      for (int i = 0; i < jsonArrayroutes.size(); i++) {
        NetworksGetAllResponseNetworksInnerRoutesInner.validateJsonObject(jsonArrayroutes.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArraysubnets.size(); i++) {
        NetworksGetAllResponseNetworksInnerSubnetsInner.validateJsonObject(jsonArraysubnets.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGetAllResponseNetworksInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGetAllResponseNetworksInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGetAllResponseNetworksInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGetAllResponseNetworksInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGetAllResponseNetworksInner>() {
           @Override
           public void write(JsonWriter out, NetworksGetAllResponseNetworksInner value) throws IOException {
           ...
           @Override
           public NetworksGetAllResponseNetworksInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksGetAllResponseNetworksInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksGetAllResponseNetworksInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksGetAllResponseNetworksInner
  * @throws IOException if the JSON string is invalid with respect to NetworksGetAllResponseNetworksInner
  */
  public static NetworksGetAllResponseNetworksInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGetAllResponseNetworksInner.class);
  }

 /**
  * Convert an instance of NetworksGetAllResponseNetworksInner to an JSON string
  *
  * @return JSON string
  */
