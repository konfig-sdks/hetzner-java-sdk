...
/**
 * ActionProperty71ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty71ResourcesInner {
  ...
  public ActionProperty71ResourcesInner() {
  }

  public ActionProperty71ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty71ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty71ResourcesInner instance itself
   */
  public ActionProperty71ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty71ResourcesInner actionProperty71ResourcesInner = (ActionProperty71ResourcesInner) o;
    return Objects.equals(this.id, actionProperty71ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty71ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty71ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty71ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty71ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty71ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty71ResourcesInner is not found in the empty JSON string", ActionProperty71ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty71ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty71ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty71ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty71ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty71ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty71ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty71ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty71ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty71ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty71ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty71ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty71ResourcesInner
  */
  public static ActionProperty71ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty71ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty71ResourcesInner to an JSON string
  *
  * @return JSON string
  */
