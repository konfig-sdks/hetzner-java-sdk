...
public class Rule5 {
 ...
 public enum ProtocolEnum {
  ...
  public Rule5 description(String description) {
  ...
  **/
  ...
  public Rule5 destinationIps(List<String> destinationIps) {
  ...
  public Rule5 addDestinationIpsItem(String destinationIpsItem) {
  ...
  **/
  ...
  public Rule5 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public Rule5 protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public Rule5 sourceIps(List<String> sourceIps) {
  ...
  public Rule5 addSourceIpsItem(String sourceIpsItem) {
  ...
  **/
   ...
   * @return the Rule5 instance itself
   */
  public Rule5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Rule5 rule5 = (Rule5) o;
    return Objects.equals(this.description, rule5.description) &&
        Objects.equals(this.destinationIps, rule5.destinationIps) &&
        Objects.equals(this.direction, rule5.direction) &&
        Objects.equals(this.port, rule5.port) &&
        Objects.equals(this.protocol, rule5.protocol) &&
        Objects.equals(this.sourceIps, rule5.sourceIps)&&
        Objects.equals(this.additionalProperties, rule5.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Rule5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Rule5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rule5 is not found in the empty JSON string", Rule5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rule5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rule5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rule5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rule5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rule5.class));

       return (TypeAdapter<T>) new TypeAdapter<Rule5>() {
           @Override
           public void write(JsonWriter out, Rule5 value) throws IOException {
           ...
           @Override
           public Rule5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Rule5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Rule5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Rule5
  * @throws IOException if the JSON string is invalid with respect to Rule5
  */
  public static Rule5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rule5.class);
  }

 /**
  * Convert an instance of Rule5 to an JSON string
  *
  * @return JSON string
  */
