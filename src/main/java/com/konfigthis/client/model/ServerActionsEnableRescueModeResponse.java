...
import com.konfigthis.client.model.ActionProperty63;
...
public class ServerActionsEnableRescueModeResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty63 action;

  public static final String SERIALIZED_NAME_ROOT_PASSWORD = "root_password";
  @SerializedName(SERIALIZED_NAME_ROOT_PASSWORD)
  private String rootPassword;

  public ServerActionsEnableRescueModeResponse() {
  }

  public ServerActionsEnableRescueModeResponse action(ActionProperty63 action) {
  ...
  **/
  ...
  public ActionProperty63 getAction() {
    return action;
  }


  public void setAction(ActionProperty63 action) {
  ...
  public ServerActionsEnableRescueModeResponse rootPassword(String rootPassword) {
  ...
  **/
   ...
   * @return the ServerActionsEnableRescueModeResponse instance itself
   */
  public ServerActionsEnableRescueModeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsEnableRescueModeResponse serverActionsEnableRescueModeResponse = (ServerActionsEnableRescueModeResponse) o;
    return Objects.equals(this.action, serverActionsEnableRescueModeResponse.action) &&
        Objects.equals(this.rootPassword, serverActionsEnableRescueModeResponse.rootPassword)&&
        Objects.equals(this.additionalProperties, serverActionsEnableRescueModeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsEnableRescueModeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsEnableRescueModeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsEnableRescueModeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsEnableRescueModeResponse is not found in the empty JSON string", ServerActionsEnableRescueModeResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `action`
      if (jsonObj.get("action") != null && !jsonObj.get("action").isJsonNull()) {
        ActionProperty63.validateJsonObject(jsonObj.getAsJsonObject("action"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsEnableRescueModeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsEnableRescueModeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsEnableRescueModeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsEnableRescueModeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsEnableRescueModeResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsEnableRescueModeResponse value) throws IOException {
           ...
           @Override
           public ServerActionsEnableRescueModeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsEnableRescueModeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsEnableRescueModeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsEnableRescueModeResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsEnableRescueModeResponse
  */
  public static ServerActionsEnableRescueModeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsEnableRescueModeResponse.class);
  }

 /**
  * Convert an instance of ServerActionsEnableRescueModeResponse to an JSON string
  *
  * @return JSON string
  */
