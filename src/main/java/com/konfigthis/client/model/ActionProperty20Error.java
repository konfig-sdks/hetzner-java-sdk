...
public class ActionProperty20Error {
  ...
  public ActionProperty20Error() {
  }

  public ActionProperty20Error code(String code) {
  ...
  **/
  ...
  public ActionProperty20Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty20Error instance itself
   */
  public ActionProperty20Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty20Error actionProperty20Error = (ActionProperty20Error) o;
    return Objects.equals(this.code, actionProperty20Error.code) &&
        Objects.equals(this.message, actionProperty20Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty20Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty20Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty20Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty20Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty20Error is not found in the empty JSON string", ActionProperty20Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty20Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty20Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty20Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty20Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty20Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty20Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty20Error value) throws IOException {
           ...
           @Override
           public ActionProperty20Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty20Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty20Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty20Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty20Error
  */
  public static ActionProperty20Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty20Error.class);
  }

 /**
  * Convert an instance of ActionProperty20Error to an JSON string
  *
  * @return JSON string
  */
