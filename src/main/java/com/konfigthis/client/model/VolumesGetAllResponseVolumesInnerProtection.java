...
public class VolumesGetAllResponseVolumesInnerProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public VolumesGetAllResponseVolumesInnerProtection() {
  }

  public VolumesGetAllResponseVolumesInnerProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the VolumesGetAllResponseVolumesInnerProtection instance itself
   */
  public VolumesGetAllResponseVolumesInnerProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesGetAllResponseVolumesInnerProtection volumesGetAllResponseVolumesInnerProtection = (VolumesGetAllResponseVolumesInnerProtection) o;
    return Objects.equals(this.delete, volumesGetAllResponseVolumesInnerProtection.delete)&&
        Objects.equals(this.additionalProperties, volumesGetAllResponseVolumesInnerProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesGetAllResponseVolumesInnerProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesGetAllResponseVolumesInnerProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesGetAllResponseVolumesInnerProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesGetAllResponseVolumesInnerProtection is not found in the empty JSON string", VolumesGetAllResponseVolumesInnerProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesGetAllResponseVolumesInnerProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesGetAllResponseVolumesInnerProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesGetAllResponseVolumesInnerProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesGetAllResponseVolumesInnerProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesGetAllResponseVolumesInnerProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesGetAllResponseVolumesInnerProtection>() {
           @Override
           public void write(JsonWriter out, VolumesGetAllResponseVolumesInnerProtection value) throws IOException {
           ...
           @Override
           public VolumesGetAllResponseVolumesInnerProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesGetAllResponseVolumesInnerProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesGetAllResponseVolumesInnerProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesGetAllResponseVolumesInnerProtection
  * @throws IOException if the JSON string is invalid with respect to VolumesGetAllResponseVolumesInnerProtection
  */
  public static VolumesGetAllResponseVolumesInnerProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesGetAllResponseVolumesInnerProtection.class);
  }

 /**
  * Convert an instance of VolumesGetAllResponseVolumesInnerProtection to an JSON string
  *
  * @return JSON string
  */
