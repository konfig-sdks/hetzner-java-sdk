...
/**
 * ActionProperty48ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty48ResourcesInner {
  ...
  public ActionProperty48ResourcesInner() {
  }

  public ActionProperty48ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty48ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty48ResourcesInner instance itself
   */
  public ActionProperty48ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty48ResourcesInner actionProperty48ResourcesInner = (ActionProperty48ResourcesInner) o;
    return Objects.equals(this.id, actionProperty48ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty48ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty48ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty48ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty48ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty48ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty48ResourcesInner is not found in the empty JSON string", ActionProperty48ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty48ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty48ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty48ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty48ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty48ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty48ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty48ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty48ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty48ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty48ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty48ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty48ResourcesInner
  */
  public static ActionProperty48ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty48ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty48ResourcesInner to an JSON string
  *
  * @return JSON string
  */
