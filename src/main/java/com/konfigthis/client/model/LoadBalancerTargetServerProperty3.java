...
public class LoadBalancerTargetServerProperty3 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty3() {
  }

  public LoadBalancerTargetServerProperty3 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty3 instance itself
   */
  public LoadBalancerTargetServerProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty3 loadBalancerTargetServerProperty3 = (LoadBalancerTargetServerProperty3) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty3.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty3 is not found in the empty JSON string", LoadBalancerTargetServerProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty3>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty3 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty3
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty3
  */
  public static LoadBalancerTargetServerProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty3.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty3 to an JSON string
  *
  * @return JSON string
  */
