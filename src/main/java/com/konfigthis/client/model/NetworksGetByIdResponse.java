...
import com.konfigthis.client.model.NetworksGetByIdResponseNetwork;
...
public class NetworksGetByIdResponse {
  public static final String SERIALIZED_NAME_NETWORK = "network";
  @SerializedName(SERIALIZED_NAME_NETWORK)
  private NetworksGetByIdResponseNetwork network;

  public NetworksGetByIdResponse() {
  }

  public NetworksGetByIdResponse network(NetworksGetByIdResponseNetwork network) {
  ...
  **/
  ...
  public NetworksGetByIdResponseNetwork getNetwork() {
    return network;
  }


  public void setNetwork(NetworksGetByIdResponseNetwork network) {
   ...
   * @return the NetworksGetByIdResponse instance itself
   */
  public NetworksGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksGetByIdResponse networksGetByIdResponse = (NetworksGetByIdResponse) o;
    return Objects.equals(this.network, networksGetByIdResponse.network)&&
        Objects.equals(this.additionalProperties, networksGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGetByIdResponse is not found in the empty JSON string", NetworksGetByIdResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `network`
      if (jsonObj.get("network") != null && !jsonObj.get("network").isJsonNull()) {
        NetworksGetByIdResponseNetwork.validateJsonObject(jsonObj.getAsJsonObject("network"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, NetworksGetByIdResponse value) throws IOException {
           ...
           @Override
           public NetworksGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to NetworksGetByIdResponse
  */
  public static NetworksGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGetByIdResponse.class);
  }

 /**
  * Convert an instance of NetworksGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
