...
public class LoadBalancerTargetLabelSelectorProperty4 {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public LoadBalancerTargetLabelSelectorProperty4() {
  }

  public LoadBalancerTargetLabelSelectorProperty4 selector(String selector) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetLabelSelectorProperty4 instance itself
   */
  public LoadBalancerTargetLabelSelectorProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetLabelSelectorProperty4 loadBalancerTargetLabelSelectorProperty4 = (LoadBalancerTargetLabelSelectorProperty4) o;
    return Objects.equals(this.selector, loadBalancerTargetLabelSelectorProperty4.selector)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetLabelSelectorProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetLabelSelectorProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetLabelSelectorProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetLabelSelectorProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetLabelSelectorProperty4 is not found in the empty JSON string", LoadBalancerTargetLabelSelectorProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetLabelSelectorProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetLabelSelectorProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetLabelSelectorProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetLabelSelectorProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetLabelSelectorProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetLabelSelectorProperty4>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetLabelSelectorProperty4 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetLabelSelectorProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetLabelSelectorProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetLabelSelectorProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetLabelSelectorProperty4
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetLabelSelectorProperty4
  */
  public static LoadBalancerTargetLabelSelectorProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetLabelSelectorProperty4.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetLabelSelectorProperty4 to an JSON string
  *
  * @return JSON string
  */
