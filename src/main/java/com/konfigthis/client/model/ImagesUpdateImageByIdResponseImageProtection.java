...
public class ImagesUpdateImageByIdResponseImageProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ImagesUpdateImageByIdResponseImageProtection() {
  }

  public ImagesUpdateImageByIdResponseImageProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the ImagesUpdateImageByIdResponseImageProtection instance itself
   */
  public ImagesUpdateImageByIdResponseImageProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesUpdateImageByIdResponseImageProtection imagesUpdateImageByIdResponseImageProtection = (ImagesUpdateImageByIdResponseImageProtection) o;
    return Objects.equals(this.delete, imagesUpdateImageByIdResponseImageProtection.delete)&&
        Objects.equals(this.additionalProperties, imagesUpdateImageByIdResponseImageProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesUpdateImageByIdResponseImageProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesUpdateImageByIdResponseImageProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesUpdateImageByIdResponseImageProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesUpdateImageByIdResponseImageProtection is not found in the empty JSON string", ImagesUpdateImageByIdResponseImageProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesUpdateImageByIdResponseImageProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesUpdateImageByIdResponseImageProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesUpdateImageByIdResponseImageProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesUpdateImageByIdResponseImageProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesUpdateImageByIdResponseImageProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesUpdateImageByIdResponseImageProtection>() {
           @Override
           public void write(JsonWriter out, ImagesUpdateImageByIdResponseImageProtection value) throws IOException {
           ...
           @Override
           public ImagesUpdateImageByIdResponseImageProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesUpdateImageByIdResponseImageProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesUpdateImageByIdResponseImageProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesUpdateImageByIdResponseImageProtection
  * @throws IOException if the JSON string is invalid with respect to ImagesUpdateImageByIdResponseImageProtection
  */
  public static ImagesUpdateImageByIdResponseImageProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesUpdateImageByIdResponseImageProtection.class);
  }

 /**
  * Convert an instance of ImagesUpdateImageByIdResponseImageProtection to an JSON string
  *
  * @return JSON string
  */
