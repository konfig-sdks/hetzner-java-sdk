...
import com.konfigthis.client.model.ActionProperty19Error;
import com.konfigthis.client.model.ActionProperty19ResourcesInner;
...
public class ActionProperty19 {
  ...
  private ActionProperty19Error error;
  ...
  private List<ActionProperty19ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty19() {
  }

  public ActionProperty19 command(String command) {
  ...
  **/
  ...
  public ActionProperty19 error(ActionProperty19Error error) {
  ...
  **/
  ...
  public ActionProperty19Error getError() {
    return error;
  }


  public void setError(ActionProperty19Error error) {
  ...
  public ActionProperty19 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty19 id(Long id) {
  ...
  **/
  ...
  public ActionProperty19 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty19 resources(List<ActionProperty19ResourcesInner> resources) {
  ...
  public ActionProperty19 addResourcesItem(ActionProperty19ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty19ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty19ResourcesInner> resources) {
  ...
  public ActionProperty19 started(String started) {
  ...
  **/
  ...
  public ActionProperty19 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty19 instance itself
   */
  public ActionProperty19 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty19 actionProperty19 = (ActionProperty19) o;
    return Objects.equals(this.command, actionProperty19.command) &&
        Objects.equals(this.error, actionProperty19.error) &&
        Objects.equals(this.finished, actionProperty19.finished) &&
        Objects.equals(this.id, actionProperty19.id) &&
        Objects.equals(this.progress, actionProperty19.progress) &&
        Objects.equals(this.resources, actionProperty19.resources) &&
        Objects.equals(this.started, actionProperty19.started) &&
        Objects.equals(this.status, actionProperty19.status)&&
        Objects.equals(this.additionalProperties, actionProperty19.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty19 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty19
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty19.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty19 is not found in the empty JSON string", ActionProperty19.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty19.openapiRequiredFields) {
      ...
      ActionProperty19Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty19ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty19.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty19' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty19> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty19.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty19>() {
           @Override
           public void write(JsonWriter out, ActionProperty19 value) throws IOException {
           ...
           @Override
           public ActionProperty19 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty19 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty19 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty19
  * @throws IOException if the JSON string is invalid with respect to ActionProperty19
  */
  public static ActionProperty19 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty19.class);
  }

 /**
  * Convert an instance of ActionProperty19 to an JSON string
  *
  * @return JSON string
  */
