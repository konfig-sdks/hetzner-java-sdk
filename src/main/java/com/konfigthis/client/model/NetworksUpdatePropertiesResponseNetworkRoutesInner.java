...
public class NetworksUpdatePropertiesResponseNetworkRoutesInner {
  ...
  public NetworksUpdatePropertiesResponseNetworkRoutesInner() {
  }

  public NetworksUpdatePropertiesResponseNetworkRoutesInner destination(String destination) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetworkRoutesInner gateway(String gateway) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "10.0.1.1", required = true, value = "Gateway for the route. Cannot be the first IP of the networks ip_range and also cannot be 172.31.1.1 as this IP is being used as a gateway for the public network interface of Servers.")
   ...
   * @return the NetworksUpdatePropertiesResponseNetworkRoutesInner instance itself
   */
  public NetworksUpdatePropertiesResponseNetworkRoutesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksUpdatePropertiesResponseNetworkRoutesInner networksUpdatePropertiesResponseNetworkRoutesInner = (NetworksUpdatePropertiesResponseNetworkRoutesInner) o;
    return Objects.equals(this.destination, networksUpdatePropertiesResponseNetworkRoutesInner.destination) &&
        Objects.equals(this.gateway, networksUpdatePropertiesResponseNetworkRoutesInner.gateway)&&
        Objects.equals(this.additionalProperties, networksUpdatePropertiesResponseNetworkRoutesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksUpdatePropertiesResponseNetworkRoutesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksUpdatePropertiesResponseNetworkRoutesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksUpdatePropertiesResponseNetworkRoutesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksUpdatePropertiesResponseNetworkRoutesInner is not found in the empty JSON string", NetworksUpdatePropertiesResponseNetworkRoutesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksUpdatePropertiesResponseNetworkRoutesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksUpdatePropertiesResponseNetworkRoutesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksUpdatePropertiesResponseNetworkRoutesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksUpdatePropertiesResponseNetworkRoutesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksUpdatePropertiesResponseNetworkRoutesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksUpdatePropertiesResponseNetworkRoutesInner>() {
           @Override
           public void write(JsonWriter out, NetworksUpdatePropertiesResponseNetworkRoutesInner value) throws IOException {
           ...
           @Override
           public NetworksUpdatePropertiesResponseNetworkRoutesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksUpdatePropertiesResponseNetworkRoutesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksUpdatePropertiesResponseNetworkRoutesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksUpdatePropertiesResponseNetworkRoutesInner
  * @throws IOException if the JSON string is invalid with respect to NetworksUpdatePropertiesResponseNetworkRoutesInner
  */
  public static NetworksUpdatePropertiesResponseNetworkRoutesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksUpdatePropertiesResponseNetworkRoutesInner.class);
  }

 /**
  * Convert an instance of NetworksUpdatePropertiesResponseNetworkRoutesInner to an JSON string
  *
  * @return JSON string
  */
