...
public class PrimaryIpActionsChangeProtectionPrimaryIpRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public PrimaryIpActionsChangeProtectionPrimaryIpRequest() {
  }

  public PrimaryIpActionsChangeProtectionPrimaryIpRequest delete(Boolean delete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "If true, prevents the Primary IP from being deleted")
   ...
   * @return the PrimaryIpActionsChangeProtectionPrimaryIpRequest instance itself
   */
  public PrimaryIpActionsChangeProtectionPrimaryIpRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIpActionsChangeProtectionPrimaryIpRequest primaryIpActionsChangeProtectionPrimaryIpRequest = (PrimaryIpActionsChangeProtectionPrimaryIpRequest) o;
    return Objects.equals(this.delete, primaryIpActionsChangeProtectionPrimaryIpRequest.delete)&&
        Objects.equals(this.additionalProperties, primaryIpActionsChangeProtectionPrimaryIpRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIpActionsChangeProtectionPrimaryIpRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIpActionsChangeProtectionPrimaryIpRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIpActionsChangeProtectionPrimaryIpRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIpActionsChangeProtectionPrimaryIpRequest is not found in the empty JSON string", PrimaryIpActionsChangeProtectionPrimaryIpRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIpActionsChangeProtectionPrimaryIpRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIpActionsChangeProtectionPrimaryIpRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIpActionsChangeProtectionPrimaryIpRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIpActionsChangeProtectionPrimaryIpRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIpActionsChangeProtectionPrimaryIpRequest>() {
           @Override
           public void write(JsonWriter out, PrimaryIpActionsChangeProtectionPrimaryIpRequest value) throws IOException {
           ...
           @Override
           public PrimaryIpActionsChangeProtectionPrimaryIpRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIpActionsChangeProtectionPrimaryIpRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIpActionsChangeProtectionPrimaryIpRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIpActionsChangeProtectionPrimaryIpRequest
  * @throws IOException if the JSON string is invalid with respect to PrimaryIpActionsChangeProtectionPrimaryIpRequest
  */
  public static PrimaryIpActionsChangeProtectionPrimaryIpRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIpActionsChangeProtectionPrimaryIpRequest.class);
  }

 /**
  * Convert an instance of PrimaryIpActionsChangeProtectionPrimaryIpRequest to an JSON string
  *
  * @return JSON string
  */
