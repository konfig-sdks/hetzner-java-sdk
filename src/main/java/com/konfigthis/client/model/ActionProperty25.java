...
import com.konfigthis.client.model.ActionProperty25Error;
import com.konfigthis.client.model.ActionProperty25ResourcesInner;
...
public class ActionProperty25 {
  ...
  private ActionProperty25Error error;
  ...
  private List<ActionProperty25ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty25() {
  }

  public ActionProperty25 command(String command) {
  ...
  **/
  ...
  public ActionProperty25 error(ActionProperty25Error error) {
  ...
  **/
  ...
  public ActionProperty25Error getError() {
    return error;
  }


  public void setError(ActionProperty25Error error) {
  ...
  public ActionProperty25 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty25 id(Long id) {
  ...
  **/
  ...
  public ActionProperty25 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty25 resources(List<ActionProperty25ResourcesInner> resources) {
  ...
  public ActionProperty25 addResourcesItem(ActionProperty25ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty25ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty25ResourcesInner> resources) {
  ...
  public ActionProperty25 started(String started) {
  ...
  **/
  ...
  public ActionProperty25 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty25 instance itself
   */
  public ActionProperty25 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty25 actionProperty25 = (ActionProperty25) o;
    return Objects.equals(this.command, actionProperty25.command) &&
        Objects.equals(this.error, actionProperty25.error) &&
        Objects.equals(this.finished, actionProperty25.finished) &&
        Objects.equals(this.id, actionProperty25.id) &&
        Objects.equals(this.progress, actionProperty25.progress) &&
        Objects.equals(this.resources, actionProperty25.resources) &&
        Objects.equals(this.started, actionProperty25.started) &&
        Objects.equals(this.status, actionProperty25.status)&&
        Objects.equals(this.additionalProperties, actionProperty25.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty25 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty25
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty25.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty25 is not found in the empty JSON string", ActionProperty25.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty25.openapiRequiredFields) {
      ...
      ActionProperty25Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty25ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty25.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty25' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty25> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty25.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty25>() {
           @Override
           public void write(JsonWriter out, ActionProperty25 value) throws IOException {
           ...
           @Override
           public ActionProperty25 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty25 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty25 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty25
  * @throws IOException if the JSON string is invalid with respect to ActionProperty25
  */
  public static ActionProperty25 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty25.class);
  }

 /**
  * Convert an instance of ActionProperty25 to an JSON string
  *
  * @return JSON string
  */
