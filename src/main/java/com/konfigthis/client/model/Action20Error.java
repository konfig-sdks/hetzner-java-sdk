...
public class Action20Error {
  ...
  public Action20Error() {
  }

  public Action20Error code(String code) {
  ...
  **/
  ...
  public Action20Error message(String message) {
  ...
  **/
   ...
   * @return the Action20Error instance itself
   */
  public Action20Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action20Error action20Error = (Action20Error) o;
    return Objects.equals(this.code, action20Error.code) &&
        Objects.equals(this.message, action20Error.message)&&
        Objects.equals(this.additionalProperties, action20Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action20Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action20Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action20Error is not found in the empty JSON string", Action20Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action20Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action20Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action20Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action20Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action20Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action20Error>() {
           @Override
           public void write(JsonWriter out, Action20Error value) throws IOException {
           ...
           @Override
           public Action20Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action20Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action20Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action20Error
  * @throws IOException if the JSON string is invalid with respect to Action20Error
  */
  public static Action20Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action20Error.class);
  }

 /**
  * Convert an instance of Action20Error to an JSON string
  *
  * @return JSON string
  */
