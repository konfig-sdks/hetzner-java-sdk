...
public class Action13Error {
  ...
  public Action13Error() {
  }

  public Action13Error code(String code) {
  ...
  **/
  ...
  public Action13Error message(String message) {
  ...
  **/
   ...
   * @return the Action13Error instance itself
   */
  public Action13Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action13Error action13Error = (Action13Error) o;
    return Objects.equals(this.code, action13Error.code) &&
        Objects.equals(this.message, action13Error.message)&&
        Objects.equals(this.additionalProperties, action13Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action13Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action13Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action13Error is not found in the empty JSON string", Action13Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action13Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action13Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action13Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action13Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action13Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action13Error>() {
           @Override
           public void write(JsonWriter out, Action13Error value) throws IOException {
           ...
           @Override
           public Action13Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action13Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action13Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action13Error
  * @throws IOException if the JSON string is invalid with respect to Action13Error
  */
  public static Action13Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action13Error.class);
  }

 /**
  * Convert an instance of Action13Error to an JSON string
  *
  * @return JSON string
  */
