...
import com.konfigthis.client.model.ListMetaProperty6;
...
public class FirewallsListAllResponse {
  ...
  private ListMetaProperty6 meta;

  public FirewallsListAllResponse() {
  }

  public FirewallsListAllResponse firewalls(List<Firewall> firewalls) {
  ...
  public FirewallsListAllResponse addFirewallsItem(Firewall firewallsItem) {
  ...
  **/
  ...
  public FirewallsListAllResponse meta(ListMetaProperty6 meta) {
  ...
  **/
  ...
  public ListMetaProperty6 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty6 meta) {
   ...
   * @return the FirewallsListAllResponse instance itself
   */
  public FirewallsListAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsListAllResponse firewallsListAllResponse = (FirewallsListAllResponse) o;
    return Objects.equals(this.firewalls, firewallsListAllResponse.firewalls) &&
        Objects.equals(this.meta, firewallsListAllResponse.meta)&&
        Objects.equals(this.additionalProperties, firewallsListAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewalls, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirewallsListAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsListAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsListAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsListAllResponse is not found in the empty JSON string", FirewallsListAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsListAllResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty6.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsListAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsListAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsListAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsListAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsListAllResponse>() {
           @Override
           public void write(JsonWriter out, FirewallsListAllResponse value) throws IOException {
           ...
           @Override
           public FirewallsListAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsListAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsListAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsListAllResponse
  * @throws IOException if the JSON string is invalid with respect to FirewallsListAllResponse
  */
  public static FirewallsListAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsListAllResponse.class);
  }

 /**
  * Convert an instance of FirewallsListAllResponse to an JSON string
  *
  * @return JSON string
  */
