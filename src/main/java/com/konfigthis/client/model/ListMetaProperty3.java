...
import com.konfigthis.client.model.ListMetaProperty3Pagination;
...
public class ListMetaProperty3 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty3Pagination pagination;

  public ListMetaProperty3() {
  }

  public ListMetaProperty3 pagination(ListMetaProperty3Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty3Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty3Pagination pagination) {
   ...
   * @return the ListMetaProperty3 instance itself
   */
  public ListMetaProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty3 listMetaProperty3 = (ListMetaProperty3) o;
    return Objects.equals(this.pagination, listMetaProperty3.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty3 is not found in the empty JSON string", ListMetaProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty3.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty3Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty3>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty3 value) throws IOException {
           ...
           @Override
           public ListMetaProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty3
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty3
  */
  public static ListMetaProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty3.class);
  }

 /**
  * Convert an instance of ListMetaProperty3 to an JSON string
  *
  * @return JSON string
  */
