...
public class ActionProperty59Error {
  ...
  public ActionProperty59Error() {
  }

  public ActionProperty59Error code(String code) {
  ...
  **/
  ...
  public ActionProperty59Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty59Error instance itself
   */
  public ActionProperty59Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty59Error actionProperty59Error = (ActionProperty59Error) o;
    return Objects.equals(this.code, actionProperty59Error.code) &&
        Objects.equals(this.message, actionProperty59Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty59Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty59Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty59Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty59Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty59Error is not found in the empty JSON string", ActionProperty59Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty59Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty59Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty59Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty59Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty59Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty59Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty59Error value) throws IOException {
           ...
           @Override
           public ActionProperty59Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty59Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty59Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty59Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty59Error
  */
  public static ActionProperty59Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty59Error.class);
  }

 /**
  * Convert an instance of ActionProperty59Error to an JSON string
  *
  * @return JSON string
  */
