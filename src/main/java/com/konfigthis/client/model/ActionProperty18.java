...
import com.konfigthis.client.model.ActionProperty18Error;
import com.konfigthis.client.model.ActionProperty18ResourcesInner;
...
public class ActionProperty18 {
  ...
  private ActionProperty18Error error;
  ...
  private List<ActionProperty18ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty18() {
  }

  public ActionProperty18 command(String command) {
  ...
  **/
  ...
  public ActionProperty18 error(ActionProperty18Error error) {
  ...
  **/
  ...
  public ActionProperty18Error getError() {
    return error;
  }


  public void setError(ActionProperty18Error error) {
  ...
  public ActionProperty18 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty18 id(Long id) {
  ...
  **/
  ...
  public ActionProperty18 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty18 resources(List<ActionProperty18ResourcesInner> resources) {
  ...
  public ActionProperty18 addResourcesItem(ActionProperty18ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty18ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty18ResourcesInner> resources) {
  ...
  public ActionProperty18 started(String started) {
  ...
  **/
  ...
  public ActionProperty18 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty18 instance itself
   */
  public ActionProperty18 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty18 actionProperty18 = (ActionProperty18) o;
    return Objects.equals(this.command, actionProperty18.command) &&
        Objects.equals(this.error, actionProperty18.error) &&
        Objects.equals(this.finished, actionProperty18.finished) &&
        Objects.equals(this.id, actionProperty18.id) &&
        Objects.equals(this.progress, actionProperty18.progress) &&
        Objects.equals(this.resources, actionProperty18.resources) &&
        Objects.equals(this.started, actionProperty18.started) &&
        Objects.equals(this.status, actionProperty18.status)&&
        Objects.equals(this.additionalProperties, actionProperty18.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty18 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty18
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty18.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty18 is not found in the empty JSON string", ActionProperty18.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty18.openapiRequiredFields) {
      ...
      ActionProperty18Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty18ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty18.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty18' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty18> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty18.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty18>() {
           @Override
           public void write(JsonWriter out, ActionProperty18 value) throws IOException {
           ...
           @Override
           public ActionProperty18 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty18 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty18 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty18
  * @throws IOException if the JSON string is invalid with respect to ActionProperty18
  */
  public static ActionProperty18 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty18.class);
  }

 /**
  * Convert an instance of ActionProperty18 to an JSON string
  *
  * @return JSON string
  */
