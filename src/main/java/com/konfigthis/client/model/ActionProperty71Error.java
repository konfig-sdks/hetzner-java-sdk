...
public class ActionProperty71Error {
  ...
  public ActionProperty71Error() {
  }

  public ActionProperty71Error code(String code) {
  ...
  **/
  ...
  public ActionProperty71Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty71Error instance itself
   */
  public ActionProperty71Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty71Error actionProperty71Error = (ActionProperty71Error) o;
    return Objects.equals(this.code, actionProperty71Error.code) &&
        Objects.equals(this.message, actionProperty71Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty71Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty71Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty71Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty71Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty71Error is not found in the empty JSON string", ActionProperty71Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty71Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty71Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty71Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty71Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty71Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty71Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty71Error value) throws IOException {
           ...
           @Override
           public ActionProperty71Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty71Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty71Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty71Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty71Error
  */
  public static ActionProperty71Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty71Error.class);
  }

 /**
  * Convert an instance of ActionProperty71Error to an JSON string
  *
  * @return JSON string
  */
