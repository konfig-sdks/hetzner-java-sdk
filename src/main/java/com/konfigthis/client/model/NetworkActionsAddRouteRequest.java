...
public class NetworkActionsAddRouteRequest {
  ...
  public NetworkActionsAddRouteRequest() {
  }

  public NetworkActionsAddRouteRequest destination(String destination) {
  ...
  **/
  ...
  public NetworkActionsAddRouteRequest gateway(String gateway) {
  ...
  **/
   ...
   * @return the NetworkActionsAddRouteRequest instance itself
   */
  public NetworkActionsAddRouteRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsAddRouteRequest networkActionsAddRouteRequest = (NetworkActionsAddRouteRequest) o;
    return Objects.equals(this.destination, networkActionsAddRouteRequest.destination) &&
        Objects.equals(this.gateway, networkActionsAddRouteRequest.gateway)&&
        Objects.equals(this.additionalProperties, networkActionsAddRouteRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsAddRouteRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsAddRouteRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsAddRouteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsAddRouteRequest is not found in the empty JSON string", NetworkActionsAddRouteRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsAddRouteRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsAddRouteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsAddRouteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsAddRouteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsAddRouteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsAddRouteRequest>() {
           @Override
           public void write(JsonWriter out, NetworkActionsAddRouteRequest value) throws IOException {
           ...
           @Override
           public NetworkActionsAddRouteRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsAddRouteRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsAddRouteRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsAddRouteRequest
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsAddRouteRequest
  */
  public static NetworkActionsAddRouteRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsAddRouteRequest.class);
  }

 /**
  * Convert an instance of NetworkActionsAddRouteRequest to an JSON string
  *
  * @return JSON string
  */
