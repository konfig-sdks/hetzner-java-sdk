...
/**
 * ActionProperty1ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty1ResourcesInner {
  ...
  public ActionProperty1ResourcesInner() {
  }

  public ActionProperty1ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty1ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty1ResourcesInner instance itself
   */
  public ActionProperty1ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty1ResourcesInner actionProperty1ResourcesInner = (ActionProperty1ResourcesInner) o;
    return Objects.equals(this.id, actionProperty1ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty1ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty1ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty1ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty1ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty1ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty1ResourcesInner is not found in the empty JSON string", ActionProperty1ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty1ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty1ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty1ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty1ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty1ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty1ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty1ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty1ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty1ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty1ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty1ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty1ResourcesInner
  */
  public static ActionProperty1ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty1ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty1ResourcesInner to an JSON string
  *
  * @return JSON string
  */
