...
import com.konfigthis.client.model.ActionProperty56Error;
import com.konfigthis.client.model.ActionProperty56ResourcesInner;
...
public class ActionProperty56 {
  ...
  private ActionProperty56Error error;
  ...
  private List<ActionProperty56ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty56() {
  }

  public ActionProperty56 command(String command) {
  ...
  **/
  ...
  public ActionProperty56 error(ActionProperty56Error error) {
  ...
  **/
  ...
  public ActionProperty56Error getError() {
    return error;
  }


  public void setError(ActionProperty56Error error) {
  ...
  public ActionProperty56 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty56 id(Long id) {
  ...
  **/
  ...
  public ActionProperty56 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty56 resources(List<ActionProperty56ResourcesInner> resources) {
  ...
  public ActionProperty56 addResourcesItem(ActionProperty56ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty56ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty56ResourcesInner> resources) {
  ...
  public ActionProperty56 started(String started) {
  ...
  **/
  ...
  public ActionProperty56 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty56 instance itself
   */
  public ActionProperty56 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty56 actionProperty56 = (ActionProperty56) o;
    return Objects.equals(this.command, actionProperty56.command) &&
        Objects.equals(this.error, actionProperty56.error) &&
        Objects.equals(this.finished, actionProperty56.finished) &&
        Objects.equals(this.id, actionProperty56.id) &&
        Objects.equals(this.progress, actionProperty56.progress) &&
        Objects.equals(this.resources, actionProperty56.resources) &&
        Objects.equals(this.started, actionProperty56.started) &&
        Objects.equals(this.status, actionProperty56.status)&&
        Objects.equals(this.additionalProperties, actionProperty56.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty56 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty56
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty56.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty56 is not found in the empty JSON string", ActionProperty56.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty56.openapiRequiredFields) {
      ...
      ActionProperty56Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty56ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty56.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty56' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty56> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty56.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty56>() {
           @Override
           public void write(JsonWriter out, ActionProperty56 value) throws IOException {
           ...
           @Override
           public ActionProperty56 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty56 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty56 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty56
  * @throws IOException if the JSON string is invalid with respect to ActionProperty56
  */
  public static ActionProperty56 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty56.class);
  }

 /**
  * Convert an instance of ActionProperty56 to an JSON string
  *
  * @return JSON string
  */
