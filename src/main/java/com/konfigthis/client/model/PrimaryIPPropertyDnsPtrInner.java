...
public class PrimaryIPPropertyDnsPtrInner {
  ...
  public PrimaryIPPropertyDnsPtrInner() {
  }

  public PrimaryIPPropertyDnsPtrInner dnsPtr(String dnsPtr) {
  ...
  **/
  ...
  public PrimaryIPPropertyDnsPtrInner ip(String ip) {
  ...
  **/
   ...
   * @return the PrimaryIPPropertyDnsPtrInner instance itself
   */
  public PrimaryIPPropertyDnsPtrInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPPropertyDnsPtrInner primaryIPPropertyDnsPtrInner = (PrimaryIPPropertyDnsPtrInner) o;
    return Objects.equals(this.dnsPtr, primaryIPPropertyDnsPtrInner.dnsPtr) &&
        Objects.equals(this.ip, primaryIPPropertyDnsPtrInner.ip)&&
        Objects.equals(this.additionalProperties, primaryIPPropertyDnsPtrInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPPropertyDnsPtrInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPPropertyDnsPtrInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPPropertyDnsPtrInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPPropertyDnsPtrInner is not found in the empty JSON string", PrimaryIPPropertyDnsPtrInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPPropertyDnsPtrInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPPropertyDnsPtrInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPPropertyDnsPtrInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPPropertyDnsPtrInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPPropertyDnsPtrInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPPropertyDnsPtrInner>() {
           @Override
           public void write(JsonWriter out, PrimaryIPPropertyDnsPtrInner value) throws IOException {
           ...
           @Override
           public PrimaryIPPropertyDnsPtrInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPPropertyDnsPtrInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPPropertyDnsPtrInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPPropertyDnsPtrInner
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPPropertyDnsPtrInner
  */
  public static PrimaryIPPropertyDnsPtrInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPPropertyDnsPtrInner.class);
  }

 /**
  * Convert an instance of PrimaryIPPropertyDnsPtrInner to an JSON string
  *
  * @return JSON string
  */
