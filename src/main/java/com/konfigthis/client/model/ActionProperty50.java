...
import com.konfigthis.client.model.ActionProperty50Error;
import com.konfigthis.client.model.ActionProperty50ResourcesInner;
...
public class ActionProperty50 {
  ...
  private ActionProperty50Error error;
  ...
  private List<ActionProperty50ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty50() {
  }

  public ActionProperty50 command(String command) {
  ...
  **/
  ...
  public ActionProperty50 error(ActionProperty50Error error) {
  ...
  **/
  ...
  public ActionProperty50Error getError() {
    return error;
  }


  public void setError(ActionProperty50Error error) {
  ...
  public ActionProperty50 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty50 id(Long id) {
  ...
  **/
  ...
  public ActionProperty50 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty50 resources(List<ActionProperty50ResourcesInner> resources) {
  ...
  public ActionProperty50 addResourcesItem(ActionProperty50ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty50ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty50ResourcesInner> resources) {
  ...
  public ActionProperty50 started(String started) {
  ...
  **/
  ...
  public ActionProperty50 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty50 instance itself
   */
  public ActionProperty50 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty50 actionProperty50 = (ActionProperty50) o;
    return Objects.equals(this.command, actionProperty50.command) &&
        Objects.equals(this.error, actionProperty50.error) &&
        Objects.equals(this.finished, actionProperty50.finished) &&
        Objects.equals(this.id, actionProperty50.id) &&
        Objects.equals(this.progress, actionProperty50.progress) &&
        Objects.equals(this.resources, actionProperty50.resources) &&
        Objects.equals(this.started, actionProperty50.started) &&
        Objects.equals(this.status, actionProperty50.status)&&
        Objects.equals(this.additionalProperties, actionProperty50.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty50 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty50
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty50.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty50 is not found in the empty JSON string", ActionProperty50.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty50.openapiRequiredFields) {
      ...
      ActionProperty50Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty50ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty50.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty50' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty50> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty50.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty50>() {
           @Override
           public void write(JsonWriter out, ActionProperty50 value) throws IOException {
           ...
           @Override
           public ActionProperty50 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty50 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty50 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty50
  * @throws IOException if the JSON string is invalid with respect to ActionProperty50
  */
  public static ActionProperty50 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty50.class);
  }

 /**
  * Convert an instance of ActionProperty50 to an JSON string
  *
  * @return JSON string
  */
