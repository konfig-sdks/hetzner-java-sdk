...
import com.konfigthis.client.model.LoadBalancerServiceHTTPProperty;
import com.konfigthis.client.model.LoadBalancerServiceHealthCheckProperty;
...
public class LoadBalancerService {
  ...
  private LoadBalancerServiceHealthCheckProperty healthCheck;

  public static final String SERIALIZED_NAME_HTTP = "http";
  @SerializedName(SERIALIZED_NAME_HTTP)
  private LoadBalancerServiceHTTPProperty http;
  ...
  **/
  ...
  public LoadBalancerService healthCheck(LoadBalancerServiceHealthCheckProperty healthCheck) {
  ...
  **/
  ...
  public LoadBalancerServiceHealthCheckProperty getHealthCheck() {
    return healthCheck;
  }


  public void setHealthCheck(LoadBalancerServiceHealthCheckProperty healthCheck) {
  ...
  public LoadBalancerService http(LoadBalancerServiceHTTPProperty http) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty getHttp() {
    return http;
  }


  public void setHttp(LoadBalancerServiceHTTPProperty http) {
  ...
  **/
   ...
   * @return the LoadBalancerService instance itself
   */
  public LoadBalancerService putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.destinationPort, loadBalancerService.destinationPort) &&
        ...
        Objects.equals(this.additionalProperties, loadBalancerService.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerService
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerService.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      LoadBalancerServiceHealthCheckProperty.validateJsonObject(jsonObj.getAsJsonObject("health_check"));
      // validate the optional field `http`
      if (jsonObj.get("http") != null && !jsonObj.get("http").isJsonNull()) {
        LoadBalancerServiceHTTPProperty.validateJsonObject(jsonObj.getAsJsonObject("http"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerService>() {
           ...
           public LoadBalancerService read(JsonReader in) throws IOException {
             ...
             LoadBalancerService instance = thisAdapter.fromJsonTree(jsonObj);
