...
import com.konfigthis.client.model.ActionProperty54Error;
import com.konfigthis.client.model.ActionProperty54ResourcesInner;
...
public class ActionProperty54 {
  ...
  private ActionProperty54Error error;
  ...
  private List<ActionProperty54ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty54() {
  }

  public ActionProperty54 command(String command) {
  ...
  **/
  ...
  public ActionProperty54 error(ActionProperty54Error error) {
  ...
  **/
  ...
  public ActionProperty54Error getError() {
    return error;
  }


  public void setError(ActionProperty54Error error) {
  ...
  public ActionProperty54 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty54 id(Long id) {
  ...
  **/
  ...
  public ActionProperty54 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty54 resources(List<ActionProperty54ResourcesInner> resources) {
  ...
  public ActionProperty54 addResourcesItem(ActionProperty54ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty54ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty54ResourcesInner> resources) {
  ...
  public ActionProperty54 started(String started) {
  ...
  **/
  ...
  public ActionProperty54 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty54 instance itself
   */
  public ActionProperty54 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty54 actionProperty54 = (ActionProperty54) o;
    return Objects.equals(this.command, actionProperty54.command) &&
        Objects.equals(this.error, actionProperty54.error) &&
        Objects.equals(this.finished, actionProperty54.finished) &&
        Objects.equals(this.id, actionProperty54.id) &&
        Objects.equals(this.progress, actionProperty54.progress) &&
        Objects.equals(this.resources, actionProperty54.resources) &&
        Objects.equals(this.started, actionProperty54.started) &&
        Objects.equals(this.status, actionProperty54.status)&&
        Objects.equals(this.additionalProperties, actionProperty54.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty54 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty54
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty54.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty54 is not found in the empty JSON string", ActionProperty54.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty54.openapiRequiredFields) {
      ...
      ActionProperty54Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty54ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty54.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty54' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty54> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty54.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty54>() {
           @Override
           public void write(JsonWriter out, ActionProperty54 value) throws IOException {
           ...
           @Override
           public ActionProperty54 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty54 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty54 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty54
  * @throws IOException if the JSON string is invalid with respect to ActionProperty54
  */
  public static ActionProperty54 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty54.class);
  }

 /**
  * Convert an instance of ActionProperty54 to an JSON string
  *
  * @return JSON string
  */
