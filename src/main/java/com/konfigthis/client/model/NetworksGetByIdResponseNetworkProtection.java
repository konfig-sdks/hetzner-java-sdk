...
public class NetworksGetByIdResponseNetworkProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public NetworksGetByIdResponseNetworkProtection() {
  }

  public NetworksGetByIdResponseNetworkProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the NetworksGetByIdResponseNetworkProtection instance itself
   */
  public NetworksGetByIdResponseNetworkProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksGetByIdResponseNetworkProtection networksGetByIdResponseNetworkProtection = (NetworksGetByIdResponseNetworkProtection) o;
    return Objects.equals(this.delete, networksGetByIdResponseNetworkProtection.delete)&&
        Objects.equals(this.additionalProperties, networksGetByIdResponseNetworkProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksGetByIdResponseNetworkProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksGetByIdResponseNetworkProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksGetByIdResponseNetworkProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGetByIdResponseNetworkProtection is not found in the empty JSON string", NetworksGetByIdResponseNetworkProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGetByIdResponseNetworkProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGetByIdResponseNetworkProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGetByIdResponseNetworkProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGetByIdResponseNetworkProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGetByIdResponseNetworkProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGetByIdResponseNetworkProtection>() {
           @Override
           public void write(JsonWriter out, NetworksGetByIdResponseNetworkProtection value) throws IOException {
           ...
           @Override
           public NetworksGetByIdResponseNetworkProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksGetByIdResponseNetworkProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksGetByIdResponseNetworkProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksGetByIdResponseNetworkProtection
  * @throws IOException if the JSON string is invalid with respect to NetworksGetByIdResponseNetworkProtection
  */
  public static NetworksGetByIdResponseNetworkProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGetByIdResponseNetworkProtection.class);
  }

 /**
  * Convert an instance of NetworksGetByIdResponseNetworkProtection to an JSON string
  *
  * @return JSON string
  */
