...
/**
 * ActionProperty68ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty68ResourcesInner {
  ...
  public ActionProperty68ResourcesInner() {
  }

  public ActionProperty68ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty68ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty68ResourcesInner instance itself
   */
  public ActionProperty68ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty68ResourcesInner actionProperty68ResourcesInner = (ActionProperty68ResourcesInner) o;
    return Objects.equals(this.id, actionProperty68ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty68ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty68ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty68ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty68ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty68ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty68ResourcesInner is not found in the empty JSON string", ActionProperty68ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty68ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty68ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty68ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty68ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty68ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty68ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty68ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty68ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty68ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty68ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty68ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty68ResourcesInner
  */
  public static ActionProperty68ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty68ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty68ResourcesInner to an JSON string
  *
  * @return JSON string
  */
