...
import com.konfigthis.client.model.ActionProperty72Error;
import com.konfigthis.client.model.ActionProperty72ResourcesInner;
...
public class ActionProperty72 {
  ...
  private ActionProperty72Error error;
  ...
  private List<ActionProperty72ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty72() {
  }

  public ActionProperty72 command(String command) {
  ...
  **/
  ...
  public ActionProperty72 error(ActionProperty72Error error) {
  ...
  **/
  ...
  public ActionProperty72Error getError() {
    return error;
  }


  public void setError(ActionProperty72Error error) {
  ...
  public ActionProperty72 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty72 id(Long id) {
  ...
  **/
  ...
  public ActionProperty72 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty72 resources(List<ActionProperty72ResourcesInner> resources) {
  ...
  public ActionProperty72 addResourcesItem(ActionProperty72ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty72ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty72ResourcesInner> resources) {
  ...
  public ActionProperty72 started(String started) {
  ...
  **/
  ...
  public ActionProperty72 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty72 instance itself
   */
  public ActionProperty72 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty72 actionProperty72 = (ActionProperty72) o;
    return Objects.equals(this.command, actionProperty72.command) &&
        Objects.equals(this.error, actionProperty72.error) &&
        Objects.equals(this.finished, actionProperty72.finished) &&
        Objects.equals(this.id, actionProperty72.id) &&
        Objects.equals(this.progress, actionProperty72.progress) &&
        Objects.equals(this.resources, actionProperty72.resources) &&
        Objects.equals(this.started, actionProperty72.started) &&
        Objects.equals(this.status, actionProperty72.status)&&
        Objects.equals(this.additionalProperties, actionProperty72.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty72 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty72
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty72.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty72 is not found in the empty JSON string", ActionProperty72.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty72.openapiRequiredFields) {
      ...
      ActionProperty72Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty72ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty72.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty72' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty72> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty72.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty72>() {
           @Override
           public void write(JsonWriter out, ActionProperty72 value) throws IOException {
           ...
           @Override
           public ActionProperty72 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty72 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty72 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty72
  * @throws IOException if the JSON string is invalid with respect to ActionProperty72
  */
  public static ActionProperty72 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty72.class);
  }

 /**
  * Convert an instance of ActionProperty72 to an JSON string
  *
  * @return JSON string
  */
