...
public class ActionProperty38Error {
  ...
  public ActionProperty38Error() {
  }

  public ActionProperty38Error code(String code) {
  ...
  **/
  ...
  public ActionProperty38Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty38Error instance itself
   */
  public ActionProperty38Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty38Error actionProperty38Error = (ActionProperty38Error) o;
    return Objects.equals(this.code, actionProperty38Error.code) &&
        Objects.equals(this.message, actionProperty38Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty38Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty38Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty38Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty38Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty38Error is not found in the empty JSON string", ActionProperty38Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty38Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty38Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty38Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty38Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty38Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty38Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty38Error value) throws IOException {
           ...
           @Override
           public ActionProperty38Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty38Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty38Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty38Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty38Error
  */
  public static ActionProperty38Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty38Error.class);
  }

 /**
  * Convert an instance of ActionProperty38Error to an JSON string
  *
  * @return JSON string
  */
