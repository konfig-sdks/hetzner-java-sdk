...
import com.konfigthis.client.model.ServersGetServerResponseServer;
...
public class ServersGetServerResponse {
  public static final String SERIALIZED_NAME_SERVER = "server";
  @SerializedName(SERIALIZED_NAME_SERVER)
  private ServersGetServerResponseServer server;

  public ServersGetServerResponse() {
  }

  public ServersGetServerResponse server(ServersGetServerResponseServer server) {
  ...
  **/
  ...
  public ServersGetServerResponseServer getServer() {
    return server;
  }


  public void setServer(ServersGetServerResponseServer server) {
   ...
   * @return the ServersGetServerResponse instance itself
   */
  public ServersGetServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGetServerResponse serversGetServerResponse = (ServersGetServerResponse) o;
    return Objects.equals(this.server, serversGetServerResponse.server)&&
        Objects.equals(this.additionalProperties, serversGetServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersGetServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersGetServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersGetServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGetServerResponse is not found in the empty JSON string", ServersGetServerResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `server`
      if (jsonObj.get("server") != null && !jsonObj.get("server").isJsonNull()) {
        ServersGetServerResponseServer.validateJsonObject(jsonObj.getAsJsonObject("server"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGetServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGetServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGetServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGetServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGetServerResponse>() {
           @Override
           public void write(JsonWriter out, ServersGetServerResponse value) throws IOException {
           ...
           @Override
           public ServersGetServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersGetServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersGetServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersGetServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServersGetServerResponse
  */
  public static ServersGetServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGetServerResponse.class);
  }

 /**
  * Convert an instance of ServersGetServerResponse to an JSON string
  *
  * @return JSON string
  */
