...
public class DeprecationInfoProperty2 {
  ...
  public DeprecationInfoProperty2() {
  }

  public DeprecationInfoProperty2 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty2 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty2 instance itself
   */
  public DeprecationInfoProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty2 deprecationInfoProperty2 = (DeprecationInfoProperty2) o;
    return Objects.equals(this.announced, deprecationInfoProperty2.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty2.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty2 is not found in the empty JSON string", DeprecationInfoProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty2>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty2 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty2
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty2
  */
  public static DeprecationInfoProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty2.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty2 to an JSON string
  *
  * @return JSON string
  */
