...
import com.konfigthis.client.model.ActionProperty1;
...
public class ActionsGetByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty1 action;

  public ActionsGetByIdResponse() {
  }

  public ActionsGetByIdResponse action(ActionProperty1 action) {
  ...
  **/
  ...
  public ActionProperty1 getAction() {
    return action;
  }


  public void setAction(ActionProperty1 action) {
   ...
   * @return the ActionsGetByIdResponse instance itself
   */
  public ActionsGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionsGetByIdResponse actionsGetByIdResponse = (ActionsGetByIdResponse) o;
    return Objects.equals(this.action, actionsGetByIdResponse.action)&&
        Objects.equals(this.additionalProperties, actionsGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionsGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionsGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionsGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionsGetByIdResponse is not found in the empty JSON string", ActionsGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionsGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty1.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionsGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionsGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionsGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionsGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionsGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, ActionsGetByIdResponse value) throws IOException {
           ...
           @Override
           public ActionsGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionsGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionsGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionsGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to ActionsGetByIdResponse
  */
  public static ActionsGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionsGetByIdResponse.class);
  }

 /**
  * Convert an instance of ActionsGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
