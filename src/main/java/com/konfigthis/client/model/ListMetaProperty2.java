...
import com.konfigthis.client.model.ListMetaProperty2Pagination;
...
public class ListMetaProperty2 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty2Pagination pagination;

  public ListMetaProperty2() {
  }

  public ListMetaProperty2 pagination(ListMetaProperty2Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty2Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty2Pagination pagination) {
   ...
   * @return the ListMetaProperty2 instance itself
   */
  public ListMetaProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty2 listMetaProperty2 = (ListMetaProperty2) o;
    return Objects.equals(this.pagination, listMetaProperty2.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty2 is not found in the empty JSON string", ListMetaProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty2.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty2Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty2>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty2 value) throws IOException {
           ...
           @Override
           public ListMetaProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty2
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty2
  */
  public static ListMetaProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty2.class);
  }

 /**
  * Convert an instance of ListMetaProperty2 to an JSON string
  *
  * @return JSON string
  */
