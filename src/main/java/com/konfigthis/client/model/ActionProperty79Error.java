...
public class ActionProperty79Error {
  ...
  public ActionProperty79Error() {
  }

  public ActionProperty79Error code(String code) {
  ...
  **/
  ...
  public ActionProperty79Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty79Error instance itself
   */
  public ActionProperty79Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty79Error actionProperty79Error = (ActionProperty79Error) o;
    return Objects.equals(this.code, actionProperty79Error.code) &&
        Objects.equals(this.message, actionProperty79Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty79Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty79Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty79Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty79Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty79Error is not found in the empty JSON string", ActionProperty79Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty79Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty79Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty79Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty79Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty79Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty79Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty79Error value) throws IOException {
           ...
           @Override
           public ActionProperty79Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty79Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty79Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty79Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty79Error
  */
  public static ActionProperty79Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty79Error.class);
  }

 /**
  * Convert an instance of ActionProperty79Error to an JSON string
  *
  * @return JSON string
  */
