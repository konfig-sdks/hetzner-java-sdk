...
/**
 * ActionProperty60ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty60ResourcesInner {
  ...
  public ActionProperty60ResourcesInner() {
  }

  public ActionProperty60ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty60ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty60ResourcesInner instance itself
   */
  public ActionProperty60ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty60ResourcesInner actionProperty60ResourcesInner = (ActionProperty60ResourcesInner) o;
    return Objects.equals(this.id, actionProperty60ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty60ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty60ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty60ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty60ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty60ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty60ResourcesInner is not found in the empty JSON string", ActionProperty60ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty60ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty60ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty60ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty60ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty60ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty60ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty60ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty60ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty60ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty60ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty60ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty60ResourcesInner
  */
  public static ActionProperty60ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty60ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty60ResourcesInner to an JSON string
  *
  * @return JSON string
  */
