...
/**
 * ActionProperty52ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty52ResourcesInner {
  ...
  public ActionProperty52ResourcesInner() {
  }

  public ActionProperty52ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty52ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty52ResourcesInner instance itself
   */
  public ActionProperty52ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty52ResourcesInner actionProperty52ResourcesInner = (ActionProperty52ResourcesInner) o;
    return Objects.equals(this.id, actionProperty52ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty52ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty52ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty52ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty52ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty52ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty52ResourcesInner is not found in the empty JSON string", ActionProperty52ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty52ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty52ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty52ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty52ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty52ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty52ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty52ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty52ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty52ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty52ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty52ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty52ResourcesInner
  */
  public static ActionProperty52ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty52ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty52ResourcesInner to an JSON string
  *
  * @return JSON string
  */
