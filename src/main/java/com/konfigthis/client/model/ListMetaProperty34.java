...
import com.konfigthis.client.model.ListMetaProperty34Pagination;
...
public class ListMetaProperty34 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty34Pagination pagination;

  public ListMetaProperty34() {
  }

  public ListMetaProperty34 pagination(ListMetaProperty34Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty34Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty34Pagination pagination) {
   ...
   * @return the ListMetaProperty34 instance itself
   */
  public ListMetaProperty34 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty34 listMetaProperty34 = (ListMetaProperty34) o;
    return Objects.equals(this.pagination, listMetaProperty34.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty34.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty34 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty34
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty34.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty34 is not found in the empty JSON string", ListMetaProperty34.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty34.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty34Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty34.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty34' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty34> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty34.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty34>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty34 value) throws IOException {
           ...
           @Override
           public ListMetaProperty34 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty34 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty34 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty34
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty34
  */
  public static ListMetaProperty34 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty34.class);
  }

 /**
  * Convert an instance of ListMetaProperty34 to an JSON string
  *
  * @return JSON string
  */
