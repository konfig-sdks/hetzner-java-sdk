...
import com.konfigthis.client.model.ListMetaProperty29Pagination;
...
public class ListMetaProperty29 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty29Pagination pagination;

  public ListMetaProperty29() {
  }

  public ListMetaProperty29 pagination(ListMetaProperty29Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty29Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty29Pagination pagination) {
   ...
   * @return the ListMetaProperty29 instance itself
   */
  public ListMetaProperty29 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty29 listMetaProperty29 = (ListMetaProperty29) o;
    return Objects.equals(this.pagination, listMetaProperty29.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty29.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty29 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty29
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty29.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty29 is not found in the empty JSON string", ListMetaProperty29.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty29.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty29Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty29.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty29' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty29> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty29.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty29>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty29 value) throws IOException {
           ...
           @Override
           public ListMetaProperty29 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty29 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty29 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty29
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty29
  */
  public static ListMetaProperty29 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty29.class);
  }

 /**
  * Convert an instance of ListMetaProperty29 to an JSON string
  *
  * @return JSON string
  */
