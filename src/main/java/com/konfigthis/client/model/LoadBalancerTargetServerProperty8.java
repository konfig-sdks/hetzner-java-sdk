...
public class LoadBalancerTargetServerProperty8 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty8() {
  }

  public LoadBalancerTargetServerProperty8 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty8 instance itself
   */
  public LoadBalancerTargetServerProperty8 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty8 loadBalancerTargetServerProperty8 = (LoadBalancerTargetServerProperty8) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty8.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty8.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty8 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty8 is not found in the empty JSON string", LoadBalancerTargetServerProperty8.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty8.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty8.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty8>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty8 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty8 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty8 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty8
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty8
  */
  public static LoadBalancerTargetServerProperty8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty8.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty8 to an JSON string
  *
  * @return JSON string
  */
