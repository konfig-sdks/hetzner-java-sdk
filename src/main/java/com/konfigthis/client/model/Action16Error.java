...
public class Action16Error {
  ...
  public Action16Error() {
  }

  public Action16Error code(String code) {
  ...
  **/
  ...
  public Action16Error message(String message) {
  ...
  **/
   ...
   * @return the Action16Error instance itself
   */
  public Action16Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action16Error action16Error = (Action16Error) o;
    return Objects.equals(this.code, action16Error.code) &&
        Objects.equals(this.message, action16Error.message)&&
        Objects.equals(this.additionalProperties, action16Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action16Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action16Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action16Error is not found in the empty JSON string", Action16Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action16Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action16Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action16Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action16Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action16Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action16Error>() {
           @Override
           public void write(JsonWriter out, Action16Error value) throws IOException {
           ...
           @Override
           public Action16Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action16Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action16Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action16Error
  * @throws IOException if the JSON string is invalid with respect to Action16Error
  */
  public static Action16Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action16Error.class);
  }

 /**
  * Convert an instance of Action16Error to an JSON string
  *
  * @return JSON string
  */
