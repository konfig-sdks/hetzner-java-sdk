...
import com.konfigthis.client.model.ActionProperty14;
...
public class ImageActionsGetActionByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty14 action;

  public ImageActionsGetActionByIdResponse() {
  }

  public ImageActionsGetActionByIdResponse action(ActionProperty14 action) {
  ...
  **/
  ...
  public ActionProperty14 getAction() {
    return action;
  }


  public void setAction(ActionProperty14 action) {
   ...
   * @return the ImageActionsGetActionByIdResponse instance itself
   */
  public ImageActionsGetActionByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImageActionsGetActionByIdResponse imageActionsGetActionByIdResponse = (ImageActionsGetActionByIdResponse) o;
    return Objects.equals(this.action, imageActionsGetActionByIdResponse.action)&&
        Objects.equals(this.additionalProperties, imageActionsGetActionByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageActionsGetActionByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageActionsGetActionByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageActionsGetActionByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageActionsGetActionByIdResponse is not found in the empty JSON string", ImageActionsGetActionByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageActionsGetActionByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty14.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageActionsGetActionByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageActionsGetActionByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageActionsGetActionByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageActionsGetActionByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageActionsGetActionByIdResponse>() {
           @Override
           public void write(JsonWriter out, ImageActionsGetActionByIdResponse value) throws IOException {
           ...
           @Override
           public ImageActionsGetActionByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageActionsGetActionByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageActionsGetActionByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageActionsGetActionByIdResponse
  * @throws IOException if the JSON string is invalid with respect to ImageActionsGetActionByIdResponse
  */
  public static ImageActionsGetActionByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageActionsGetActionByIdResponse.class);
  }

 /**
  * Convert an instance of ImageActionsGetActionByIdResponse to an JSON string
  *
  * @return JSON string
  */
