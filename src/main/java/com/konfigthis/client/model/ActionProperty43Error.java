...
public class ActionProperty43Error {
  ...
  public ActionProperty43Error() {
  }

  public ActionProperty43Error code(String code) {
  ...
  **/
  ...
  public ActionProperty43Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty43Error instance itself
   */
  public ActionProperty43Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty43Error actionProperty43Error = (ActionProperty43Error) o;
    return Objects.equals(this.code, actionProperty43Error.code) &&
        Objects.equals(this.message, actionProperty43Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty43Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty43Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty43Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty43Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty43Error is not found in the empty JSON string", ActionProperty43Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty43Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty43Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty43Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty43Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty43Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty43Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty43Error value) throws IOException {
           ...
           @Override
           public ActionProperty43Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty43Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty43Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty43Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty43Error
  */
  public static ActionProperty43Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty43Error.class);
  }

 /**
  * Convert an instance of ActionProperty43Error to an JSON string
  *
  * @return JSON string
  */
