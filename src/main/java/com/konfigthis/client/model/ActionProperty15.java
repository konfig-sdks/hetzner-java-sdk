...
import com.konfigthis.client.model.ActionProperty15Error;
import com.konfigthis.client.model.ActionProperty15ResourcesInner;
...
public class ActionProperty15 {
  ...
  private ActionProperty15Error error;
  ...
  private List<ActionProperty15ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty15() {
  }

  public ActionProperty15 command(String command) {
  ...
  **/
  ...
  public ActionProperty15 error(ActionProperty15Error error) {
  ...
  **/
  ...
  public ActionProperty15Error getError() {
    return error;
  }


  public void setError(ActionProperty15Error error) {
  ...
  public ActionProperty15 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty15 id(Long id) {
  ...
  **/
  ...
  public ActionProperty15 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty15 resources(List<ActionProperty15ResourcesInner> resources) {
  ...
  public ActionProperty15 addResourcesItem(ActionProperty15ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty15ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty15ResourcesInner> resources) {
  ...
  public ActionProperty15 started(String started) {
  ...
  **/
  ...
  public ActionProperty15 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty15 instance itself
   */
  public ActionProperty15 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty15 actionProperty15 = (ActionProperty15) o;
    return Objects.equals(this.command, actionProperty15.command) &&
        Objects.equals(this.error, actionProperty15.error) &&
        Objects.equals(this.finished, actionProperty15.finished) &&
        Objects.equals(this.id, actionProperty15.id) &&
        Objects.equals(this.progress, actionProperty15.progress) &&
        Objects.equals(this.resources, actionProperty15.resources) &&
        Objects.equals(this.started, actionProperty15.started) &&
        Objects.equals(this.status, actionProperty15.status)&&
        Objects.equals(this.additionalProperties, actionProperty15.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty15 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty15
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty15.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty15 is not found in the empty JSON string", ActionProperty15.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty15.openapiRequiredFields) {
      ...
      ActionProperty15Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty15ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty15.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty15>() {
           @Override
           public void write(JsonWriter out, ActionProperty15 value) throws IOException {
           ...
           @Override
           public ActionProperty15 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty15 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty15 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty15
  * @throws IOException if the JSON string is invalid with respect to ActionProperty15
  */
  public static ActionProperty15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty15.class);
  }

 /**
  * Convert an instance of ActionProperty15 to an JSON string
  *
  * @return JSON string
  */
