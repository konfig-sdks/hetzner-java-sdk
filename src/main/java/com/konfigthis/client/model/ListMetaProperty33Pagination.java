...
public class ListMetaProperty33Pagination {
  ...
  public ListMetaProperty33Pagination() {
  }

  public ListMetaProperty33Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty33Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty33Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty33Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty33Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty33Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty33Pagination instance itself
   */
  public ListMetaProperty33Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty33Pagination listMetaProperty33Pagination = (ListMetaProperty33Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty33Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty33Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty33Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty33Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty33Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty33Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty33Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty33Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty33Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty33Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty33Pagination is not found in the empty JSON string", ListMetaProperty33Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty33Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty33Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty33Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty33Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty33Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty33Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty33Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty33Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty33Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty33Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty33Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty33Pagination
  */
  public static ListMetaProperty33Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty33Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty33Pagination to an JSON string
  *
  * @return JSON string
  */
