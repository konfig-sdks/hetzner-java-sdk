...
import com.konfigthis.client.model.ListMetaProperty25Pagination;
...
public class ListMetaProperty25 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty25Pagination pagination;

  public ListMetaProperty25() {
  }

  public ListMetaProperty25 pagination(ListMetaProperty25Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty25Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty25Pagination pagination) {
   ...
   * @return the ListMetaProperty25 instance itself
   */
  public ListMetaProperty25 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty25 listMetaProperty25 = (ListMetaProperty25) o;
    return Objects.equals(this.pagination, listMetaProperty25.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty25.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty25 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty25
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty25.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty25 is not found in the empty JSON string", ListMetaProperty25.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty25.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty25Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty25.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty25' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty25> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty25.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty25>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty25 value) throws IOException {
           ...
           @Override
           public ListMetaProperty25 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty25 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty25 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty25
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty25
  */
  public static ListMetaProperty25 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty25.class);
  }

 /**
  * Convert an instance of ListMetaProperty25 to an JSON string
  *
  * @return JSON string
  */
