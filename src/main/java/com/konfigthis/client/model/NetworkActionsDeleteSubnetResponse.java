...
import com.konfigthis.client.model.ActionProperty39;
...
public class NetworkActionsDeleteSubnetResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty39 action;

  public NetworkActionsDeleteSubnetResponse() {
  }

  public NetworkActionsDeleteSubnetResponse action(ActionProperty39 action) {
  ...
  **/
  ...
  public ActionProperty39 getAction() {
    return action;
  }


  public void setAction(ActionProperty39 action) {
   ...
   * @return the NetworkActionsDeleteSubnetResponse instance itself
   */
  public NetworkActionsDeleteSubnetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsDeleteSubnetResponse networkActionsDeleteSubnetResponse = (NetworkActionsDeleteSubnetResponse) o;
    return Objects.equals(this.action, networkActionsDeleteSubnetResponse.action)&&
        Objects.equals(this.additionalProperties, networkActionsDeleteSubnetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsDeleteSubnetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsDeleteSubnetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsDeleteSubnetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsDeleteSubnetResponse is not found in the empty JSON string", NetworkActionsDeleteSubnetResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsDeleteSubnetResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty39.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsDeleteSubnetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsDeleteSubnetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsDeleteSubnetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsDeleteSubnetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsDeleteSubnetResponse>() {
           @Override
           public void write(JsonWriter out, NetworkActionsDeleteSubnetResponse value) throws IOException {
           ...
           @Override
           public NetworkActionsDeleteSubnetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsDeleteSubnetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsDeleteSubnetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsDeleteSubnetResponse
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsDeleteSubnetResponse
  */
  public static NetworkActionsDeleteSubnetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsDeleteSubnetResponse.class);
  }

 /**
  * Convert an instance of NetworkActionsDeleteSubnetResponse to an JSON string
  *
  * @return JSON string
  */
