...
import com.konfigthis.client.model.LoadBalancersUpdateBalancerResponseLoadBalancer;
...
public class LoadBalancersUpdateBalancerResponse {
  public static final String SERIALIZED_NAME_LOAD_BALANCER = "load_balancer";
  @SerializedName(SERIALIZED_NAME_LOAD_BALANCER)
  private LoadBalancersUpdateBalancerResponseLoadBalancer loadBalancer;

  public LoadBalancersUpdateBalancerResponse() {
  }

  public LoadBalancersUpdateBalancerResponse loadBalancer(LoadBalancersUpdateBalancerResponseLoadBalancer loadBalancer) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancer getLoadBalancer() {
    return loadBalancer;
  }


  public void setLoadBalancer(LoadBalancersUpdateBalancerResponseLoadBalancer loadBalancer) {
   ...
   * @return the LoadBalancersUpdateBalancerResponse instance itself
   */
  public LoadBalancersUpdateBalancerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersUpdateBalancerResponse loadBalancersUpdateBalancerResponse = (LoadBalancersUpdateBalancerResponse) o;
    return Objects.equals(this.loadBalancer, loadBalancersUpdateBalancerResponse.loadBalancer)&&
        Objects.equals(this.additionalProperties, loadBalancersUpdateBalancerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersUpdateBalancerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersUpdateBalancerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersUpdateBalancerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersUpdateBalancerResponse is not found in the empty JSON string", LoadBalancersUpdateBalancerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersUpdateBalancerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `load_balancer`
      LoadBalancersUpdateBalancerResponseLoadBalancer.validateJsonObject(jsonObj.getAsJsonObject("load_balancer"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersUpdateBalancerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersUpdateBalancerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersUpdateBalancerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersUpdateBalancerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersUpdateBalancerResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancersUpdateBalancerResponse value) throws IOException {
           ...
           @Override
           public LoadBalancersUpdateBalancerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersUpdateBalancerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersUpdateBalancerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersUpdateBalancerResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersUpdateBalancerResponse
  */
  public static LoadBalancersUpdateBalancerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersUpdateBalancerResponse.class);
  }

 /**
  * Convert an instance of LoadBalancersUpdateBalancerResponse to an JSON string
  *
  * @return JSON string
  */
