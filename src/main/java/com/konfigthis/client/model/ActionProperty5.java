...
import com.konfigthis.client.model.ActionProperty5Error;
import com.konfigthis.client.model.ActionProperty5ResourcesInner;
...
public class ActionProperty5 {
  ...
  private ActionProperty5Error error;
  ...
  private List<ActionProperty5ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty5() {
  }

  public ActionProperty5 command(String command) {
  ...
  **/
  ...
  public ActionProperty5 error(ActionProperty5Error error) {
  ...
  **/
  ...
  public ActionProperty5Error getError() {
    return error;
  }


  public void setError(ActionProperty5Error error) {
  ...
  public ActionProperty5 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty5 id(Long id) {
  ...
  **/
  ...
  public ActionProperty5 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty5 resources(List<ActionProperty5ResourcesInner> resources) {
  ...
  public ActionProperty5 addResourcesItem(ActionProperty5ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty5ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty5ResourcesInner> resources) {
  ...
  public ActionProperty5 started(String started) {
  ...
  **/
  ...
  public ActionProperty5 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty5 instance itself
   */
  public ActionProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty5 actionProperty5 = (ActionProperty5) o;
    return Objects.equals(this.command, actionProperty5.command) &&
        Objects.equals(this.error, actionProperty5.error) &&
        Objects.equals(this.finished, actionProperty5.finished) &&
        Objects.equals(this.id, actionProperty5.id) &&
        Objects.equals(this.progress, actionProperty5.progress) &&
        Objects.equals(this.resources, actionProperty5.resources) &&
        Objects.equals(this.started, actionProperty5.started) &&
        Objects.equals(this.status, actionProperty5.status)&&
        Objects.equals(this.additionalProperties, actionProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty5 is not found in the empty JSON string", ActionProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty5.openapiRequiredFields) {
      ...
      ActionProperty5Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty5ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty5>() {
           @Override
           public void write(JsonWriter out, ActionProperty5 value) throws IOException {
           ...
           @Override
           public ActionProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty5
  * @throws IOException if the JSON string is invalid with respect to ActionProperty5
  */
  public static ActionProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty5.class);
  }

 /**
  * Convert an instance of ActionProperty5 to an JSON string
  *
  * @return JSON string
  */
