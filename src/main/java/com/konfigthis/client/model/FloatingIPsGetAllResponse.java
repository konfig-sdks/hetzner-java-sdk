...
import com.konfigthis.client.model.FloatingIPsGetAllResponseFloatingIpsInner;
import com.konfigthis.client.model.ListMetaProperty12;
...
public class FloatingIPsGetAllResponse {
  public static final String SERIALIZED_NAME_FLOATING_IPS = "floating_ips";
  @SerializedName(SERIALIZED_NAME_FLOATING_IPS)
  private List<FloatingIPsGetAllResponseFloatingIpsInner> floatingIps = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty12 meta;

  public FloatingIPsGetAllResponse() {
  }

  public FloatingIPsGetAllResponse floatingIps(List<FloatingIPsGetAllResponseFloatingIpsInner> floatingIps) {
  ...
  public FloatingIPsGetAllResponse addFloatingIpsItem(FloatingIPsGetAllResponseFloatingIpsInner floatingIpsItem) {
  ...
  **/
  ...
  public List<FloatingIPsGetAllResponseFloatingIpsInner> getFloatingIps() {
    return floatingIps;
  }


  public void setFloatingIps(List<FloatingIPsGetAllResponseFloatingIpsInner> floatingIps) {
  ...
  public FloatingIPsGetAllResponse meta(ListMetaProperty12 meta) {
  ...
  **/
  ...
  public ListMetaProperty12 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty12 meta) {
   ...
   * @return the FloatingIPsGetAllResponse instance itself
   */
  public FloatingIPsGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIPsGetAllResponse floatingIPsGetAllResponse = (FloatingIPsGetAllResponse) o;
    return Objects.equals(this.floatingIps, floatingIPsGetAllResponse.floatingIps) &&
        Objects.equals(this.meta, floatingIPsGetAllResponse.meta)&&
        Objects.equals(this.additionalProperties, floatingIPsGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(floatingIps, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FloatingIPsGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIPsGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIPsGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIPsGetAllResponse is not found in the empty JSON string", FloatingIPsGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIPsGetAllResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayfloatingIps.size(); i++) {
        FloatingIPsGetAllResponseFloatingIpsInner.validateJsonObject(jsonArrayfloatingIps.get(i).getAsJsonObject());
      };
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty12.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIPsGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIPsGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIPsGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIPsGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIPsGetAllResponse>() {
           @Override
           public void write(JsonWriter out, FloatingIPsGetAllResponse value) throws IOException {
           ...
           @Override
           public FloatingIPsGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIPsGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIPsGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIPsGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to FloatingIPsGetAllResponse
  */
  public static FloatingIPsGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIPsGetAllResponse.class);
  }

 /**
  * Convert an instance of FloatingIPsGetAllResponse to an JSON string
  *
  * @return JSON string
  */
