...
import com.konfigthis.client.model.ActionProperty31Error;
import com.konfigthis.client.model.ActionProperty31ResourcesInner;
...
public class ActionProperty31 {
  ...
  private ActionProperty31Error error;
  ...
  private List<ActionProperty31ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty31() {
  }

  public ActionProperty31 command(String command) {
  ...
  **/
  ...
  public ActionProperty31 error(ActionProperty31Error error) {
  ...
  **/
  ...
  public ActionProperty31Error getError() {
    return error;
  }


  public void setError(ActionProperty31Error error) {
  ...
  public ActionProperty31 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty31 id(Long id) {
  ...
  **/
  ...
  public ActionProperty31 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty31 resources(List<ActionProperty31ResourcesInner> resources) {
  ...
  public ActionProperty31 addResourcesItem(ActionProperty31ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty31ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty31ResourcesInner> resources) {
  ...
  public ActionProperty31 started(String started) {
  ...
  **/
  ...
  public ActionProperty31 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty31 instance itself
   */
  public ActionProperty31 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty31 actionProperty31 = (ActionProperty31) o;
    return Objects.equals(this.command, actionProperty31.command) &&
        Objects.equals(this.error, actionProperty31.error) &&
        Objects.equals(this.finished, actionProperty31.finished) &&
        Objects.equals(this.id, actionProperty31.id) &&
        Objects.equals(this.progress, actionProperty31.progress) &&
        Objects.equals(this.resources, actionProperty31.resources) &&
        Objects.equals(this.started, actionProperty31.started) &&
        Objects.equals(this.status, actionProperty31.status)&&
        Objects.equals(this.additionalProperties, actionProperty31.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty31 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty31
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty31.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty31 is not found in the empty JSON string", ActionProperty31.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty31.openapiRequiredFields) {
      ...
      ActionProperty31Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty31ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty31.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty31' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty31> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty31.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty31>() {
           @Override
           public void write(JsonWriter out, ActionProperty31 value) throws IOException {
           ...
           @Override
           public ActionProperty31 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty31 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty31 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty31
  * @throws IOException if the JSON string is invalid with respect to ActionProperty31
  */
  public static ActionProperty31 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty31.class);
  }

 /**
  * Convert an instance of ActionProperty31 to an JSON string
  *
  * @return JSON string
  */
