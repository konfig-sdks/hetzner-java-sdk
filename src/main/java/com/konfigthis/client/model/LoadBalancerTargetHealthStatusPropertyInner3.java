...
/**
 * LoadBalancerTargetHealthStatusPropertyInner3
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LoadBalancerTargetHealthStatusPropertyInner3 {
 ...
 public enum StatusEnum {
  ...
  public LoadBalancerTargetHealthStatusPropertyInner3() {
  }

  public LoadBalancerTargetHealthStatusPropertyInner3 listenPort(Integer listenPort) {
  ...
  **/
  ...
  public LoadBalancerTargetHealthStatusPropertyInner3 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetHealthStatusPropertyInner3 instance itself
   */
  public LoadBalancerTargetHealthStatusPropertyInner3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetHealthStatusPropertyInner3 loadBalancerTargetHealthStatusPropertyInner3 = (LoadBalancerTargetHealthStatusPropertyInner3) o;
    return Objects.equals(this.listenPort, loadBalancerTargetHealthStatusPropertyInner3.listenPort) &&
        Objects.equals(this.status, loadBalancerTargetHealthStatusPropertyInner3.status)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetHealthStatusPropertyInner3.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(listenPort, status, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancerTargetHealthStatusPropertyInner3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetHealthStatusPropertyInner3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetHealthStatusPropertyInner3 is not found in the empty JSON string", LoadBalancerTargetHealthStatusPropertyInner3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetHealthStatusPropertyInner3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetHealthStatusPropertyInner3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetHealthStatusPropertyInner3.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner3>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetHealthStatusPropertyInner3 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetHealthStatusPropertyInner3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetHealthStatusPropertyInner3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetHealthStatusPropertyInner3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetHealthStatusPropertyInner3
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner3
  */
  public static LoadBalancerTargetHealthStatusPropertyInner3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetHealthStatusPropertyInner3.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetHealthStatusPropertyInner3 to an JSON string
  *
  * @return JSON string
  */
