...
/**
 * ActionProperty79ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty79ResourcesInner {
  ...
  public ActionProperty79ResourcesInner() {
  }

  public ActionProperty79ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty79ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty79ResourcesInner instance itself
   */
  public ActionProperty79ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty79ResourcesInner actionProperty79ResourcesInner = (ActionProperty79ResourcesInner) o;
    return Objects.equals(this.id, actionProperty79ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty79ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty79ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty79ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty79ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty79ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty79ResourcesInner is not found in the empty JSON string", ActionProperty79ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty79ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty79ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty79ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty79ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty79ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty79ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty79ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty79ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty79ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty79ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty79ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty79ResourcesInner
  */
  public static ActionProperty79ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty79ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty79ResourcesInner to an JSON string
  *
  * @return JSON string
  */
