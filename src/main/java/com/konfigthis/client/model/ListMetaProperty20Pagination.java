...
public class ListMetaProperty20Pagination {
  ...
  public ListMetaProperty20Pagination() {
  }

  public ListMetaProperty20Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty20Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty20Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty20Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty20Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty20Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty20Pagination instance itself
   */
  public ListMetaProperty20Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty20Pagination listMetaProperty20Pagination = (ListMetaProperty20Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty20Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty20Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty20Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty20Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty20Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty20Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty20Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty20Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty20Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty20Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty20Pagination is not found in the empty JSON string", ListMetaProperty20Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty20Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty20Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty20Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty20Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty20Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty20Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty20Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty20Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty20Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty20Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty20Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty20Pagination
  */
  public static ListMetaProperty20Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty20Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty20Pagination to an JSON string
  *
  * @return JSON string
  */
