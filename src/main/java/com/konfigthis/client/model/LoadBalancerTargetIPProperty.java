...
public class LoadBalancerTargetIPProperty {
  public static final String SERIALIZED_NAME_IP = "ip";
  @SerializedName(SERIALIZED_NAME_IP)
  private String ip;

  public LoadBalancerTargetIPProperty() {
  }

  public LoadBalancerTargetIPProperty ip(String ip) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetIPProperty instance itself
   */
  public LoadBalancerTargetIPProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetIPProperty loadBalancerTargetIPProperty = (LoadBalancerTargetIPProperty) o;
    return Objects.equals(this.ip, loadBalancerTargetIPProperty.ip)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetIPProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetIPProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetIPProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetIPProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetIPProperty is not found in the empty JSON string", LoadBalancerTargetIPProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetIPProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetIPProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetIPProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetIPProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetIPProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetIPProperty>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetIPProperty value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetIPProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetIPProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetIPProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetIPProperty
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetIPProperty
  */
  public static LoadBalancerTargetIPProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetIPProperty.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetIPProperty to an JSON string
  *
  * @return JSON string
  */
