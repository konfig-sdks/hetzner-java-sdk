...
import com.konfigthis.client.model.ActionProperty48Error;
import com.konfigthis.client.model.ActionProperty48ResourcesInner;
...
public class ActionProperty48 {
  ...
  private ActionProperty48Error error;
  ...
  private List<ActionProperty48ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty48() {
  }

  public ActionProperty48 command(String command) {
  ...
  **/
  ...
  public ActionProperty48 error(ActionProperty48Error error) {
  ...
  **/
  ...
  public ActionProperty48Error getError() {
    return error;
  }


  public void setError(ActionProperty48Error error) {
  ...
  public ActionProperty48 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty48 id(Long id) {
  ...
  **/
  ...
  public ActionProperty48 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty48 resources(List<ActionProperty48ResourcesInner> resources) {
  ...
  public ActionProperty48 addResourcesItem(ActionProperty48ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty48ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty48ResourcesInner> resources) {
  ...
  public ActionProperty48 started(String started) {
  ...
  **/
  ...
  public ActionProperty48 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty48 instance itself
   */
  public ActionProperty48 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty48 actionProperty48 = (ActionProperty48) o;
    return Objects.equals(this.command, actionProperty48.command) &&
        Objects.equals(this.error, actionProperty48.error) &&
        Objects.equals(this.finished, actionProperty48.finished) &&
        Objects.equals(this.id, actionProperty48.id) &&
        Objects.equals(this.progress, actionProperty48.progress) &&
        Objects.equals(this.resources, actionProperty48.resources) &&
        Objects.equals(this.started, actionProperty48.started) &&
        Objects.equals(this.status, actionProperty48.status)&&
        Objects.equals(this.additionalProperties, actionProperty48.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty48 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty48
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty48.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty48 is not found in the empty JSON string", ActionProperty48.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty48.openapiRequiredFields) {
      ...
      ActionProperty48Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty48ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty48.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty48' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty48> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty48.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty48>() {
           @Override
           public void write(JsonWriter out, ActionProperty48 value) throws IOException {
           ...
           @Override
           public ActionProperty48 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty48 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty48 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty48
  * @throws IOException if the JSON string is invalid with respect to ActionProperty48
  */
  public static ActionProperty48 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty48.class);
  }

 /**
  * Convert an instance of ActionProperty48 to an JSON string
  *
  * @return JSON string
  */
