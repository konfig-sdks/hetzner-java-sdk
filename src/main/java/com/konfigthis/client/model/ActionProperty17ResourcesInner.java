...
/**
 * ActionProperty17ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty17ResourcesInner {
  ...
  public ActionProperty17ResourcesInner() {
  }

  public ActionProperty17ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty17ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty17ResourcesInner instance itself
   */
  public ActionProperty17ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty17ResourcesInner actionProperty17ResourcesInner = (ActionProperty17ResourcesInner) o;
    return Objects.equals(this.id, actionProperty17ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty17ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty17ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty17ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty17ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty17ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty17ResourcesInner is not found in the empty JSON string", ActionProperty17ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty17ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty17ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty17ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty17ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty17ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty17ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty17ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty17ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty17ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty17ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty17ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty17ResourcesInner
  */
  public static ActionProperty17ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty17ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty17ResourcesInner to an JSON string
  *
  * @return JSON string
  */
