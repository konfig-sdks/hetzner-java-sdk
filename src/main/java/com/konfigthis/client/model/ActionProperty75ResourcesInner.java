...
/**
 * ActionProperty75ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty75ResourcesInner {
  ...
  public ActionProperty75ResourcesInner() {
  }

  public ActionProperty75ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty75ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty75ResourcesInner instance itself
   */
  public ActionProperty75ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty75ResourcesInner actionProperty75ResourcesInner = (ActionProperty75ResourcesInner) o;
    return Objects.equals(this.id, actionProperty75ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty75ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty75ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty75ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty75ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty75ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty75ResourcesInner is not found in the empty JSON string", ActionProperty75ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty75ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty75ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty75ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty75ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty75ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty75ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty75ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty75ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty75ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty75ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty75ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty75ResourcesInner
  */
  public static ActionProperty75ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty75ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty75ResourcesInner to an JSON string
  *
  * @return JSON string
  */
