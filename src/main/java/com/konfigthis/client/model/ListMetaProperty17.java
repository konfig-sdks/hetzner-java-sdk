...
import com.konfigthis.client.model.ListMetaProperty17Pagination;
...
public class ListMetaProperty17 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty17Pagination pagination;

  public ListMetaProperty17() {
  }

  public ListMetaProperty17 pagination(ListMetaProperty17Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty17Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty17Pagination pagination) {
   ...
   * @return the ListMetaProperty17 instance itself
   */
  public ListMetaProperty17 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty17 listMetaProperty17 = (ListMetaProperty17) o;
    return Objects.equals(this.pagination, listMetaProperty17.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty17.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty17 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty17
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty17.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty17 is not found in the empty JSON string", ListMetaProperty17.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty17.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty17Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty17.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty17' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty17> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty17.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty17>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty17 value) throws IOException {
           ...
           @Override
           public ListMetaProperty17 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty17 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty17 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty17
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty17
  */
  public static ListMetaProperty17 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty17.class);
  }

 /**
  * Convert an instance of ListMetaProperty17 to an JSON string
  *
  * @return JSON string
  */
