...
import com.konfigthis.client.model.Action25Error;
import com.konfigthis.client.model.Action25ResourcesInner;
...
public class Action25 {
  ...
  private List<Action25ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action25 command(String command) {
  ...
  **/
  ...
  public Action25 error(Action25Error error) {
  ...
  **/
  ...
  public Action25Error getError() {
    return error;
  }


  public void setError(Action25Error error) {
  ...
  public Action25 finished(String finished) {
  ...
  **/
  ...
  public Action25 progress(Integer progress) {
  ...
  **/
  ...
  public Action25 resources(List<Action25ResourcesInner> resources) {
  ...
  public Action25 addResourcesItem(Action25ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action25ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action25ResourcesInner> resources) {
  ...
  public Action25 started(String started) {
  ...
  **/
  ...
  public Action25 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action25 instance itself
   */
  public Action25 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action25 action25 = (Action25) o;
    return Objects.equals(this.command, action25.command) &&
        Objects.equals(this.error, action25.error) &&
        Objects.equals(this.finished, action25.finished) &&
        Objects.equals(this.id, action25.id) &&
        Objects.equals(this.progress, action25.progress) &&
        Objects.equals(this.resources, action25.resources) &&
        Objects.equals(this.started, action25.started) &&
        Objects.equals(this.status, action25.status)&&
        Objects.equals(this.additionalProperties, action25.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action25
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action25.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action25 is not found in the empty JSON string", Action25.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action25.openapiRequiredFields) {
      ...
      Action25Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action25ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action25.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action25' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action25> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action25.class));

       return (TypeAdapter<T>) new TypeAdapter<Action25>() {
           @Override
           public void write(JsonWriter out, Action25 value) throws IOException {
           ...
           @Override
           public Action25 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action25 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action25 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action25
  * @throws IOException if the JSON string is invalid with respect to Action25
  */
  public static Action25 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action25.class);
  }

 /**
  * Convert an instance of Action25 to an JSON string
  *
  * @return JSON string
  */
