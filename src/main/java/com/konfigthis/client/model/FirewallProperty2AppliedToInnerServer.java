...
/**
 * FirewallProperty2AppliedToInnerServer
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FirewallProperty2AppliedToInnerServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public FirewallProperty2AppliedToInnerServer() {
  }

  public FirewallProperty2AppliedToInnerServer id(Long id) {
  ...
  **/
   ...
   * @return the FirewallProperty2AppliedToInnerServer instance itself
   */
  public FirewallProperty2AppliedToInnerServer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallProperty2AppliedToInnerServer firewallProperty2AppliedToInnerServer = (FirewallProperty2AppliedToInnerServer) o;
    return Objects.equals(this.id, firewallProperty2AppliedToInnerServer.id)&&
        Objects.equals(this.additionalProperties, firewallProperty2AppliedToInnerServer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallProperty2AppliedToInnerServer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallProperty2AppliedToInnerServer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallProperty2AppliedToInnerServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallProperty2AppliedToInnerServer is not found in the empty JSON string", FirewallProperty2AppliedToInnerServer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallProperty2AppliedToInnerServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallProperty2AppliedToInnerServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallProperty2AppliedToInnerServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallProperty2AppliedToInnerServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallProperty2AppliedToInnerServer.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallProperty2AppliedToInnerServer>() {
           @Override
           public void write(JsonWriter out, FirewallProperty2AppliedToInnerServer value) throws IOException {
           ...
           @Override
           public FirewallProperty2AppliedToInnerServer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallProperty2AppliedToInnerServer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallProperty2AppliedToInnerServer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallProperty2AppliedToInnerServer
  * @throws IOException if the JSON string is invalid with respect to FirewallProperty2AppliedToInnerServer
  */
  public static FirewallProperty2AppliedToInnerServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallProperty2AppliedToInnerServer.class);
  }

 /**
  * Convert an instance of FirewallProperty2AppliedToInnerServer to an JSON string
  *
  * @return JSON string
  */
