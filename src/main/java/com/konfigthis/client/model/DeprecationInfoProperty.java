...
public class DeprecationInfoProperty {
  ...
  public DeprecationInfoProperty() {
  }

  public DeprecationInfoProperty announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty instance itself
   */
  public DeprecationInfoProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty deprecationInfoProperty = (DeprecationInfoProperty) o;
    return Objects.equals(this.announced, deprecationInfoProperty.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty is not found in the empty JSON string", DeprecationInfoProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty
  */
  public static DeprecationInfoProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty to an JSON string
  *
  * @return JSON string
  */
