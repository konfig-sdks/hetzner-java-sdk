...
import com.konfigthis.client.model.ActionProperty52;
...
public class ServerActionsAttachToNetworkResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty52 action;

  public ServerActionsAttachToNetworkResponse() {
  }

  public ServerActionsAttachToNetworkResponse action(ActionProperty52 action) {
  ...
  **/
  ...
  public ActionProperty52 getAction() {
    return action;
  }


  public void setAction(ActionProperty52 action) {
   ...
   * @return the ServerActionsAttachToNetworkResponse instance itself
   */
  public ServerActionsAttachToNetworkResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsAttachToNetworkResponse serverActionsAttachToNetworkResponse = (ServerActionsAttachToNetworkResponse) o;
    return Objects.equals(this.action, serverActionsAttachToNetworkResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsAttachToNetworkResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsAttachToNetworkResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsAttachToNetworkResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsAttachToNetworkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsAttachToNetworkResponse is not found in the empty JSON string", ServerActionsAttachToNetworkResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsAttachToNetworkResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty52.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsAttachToNetworkResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsAttachToNetworkResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsAttachToNetworkResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsAttachToNetworkResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsAttachToNetworkResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsAttachToNetworkResponse value) throws IOException {
           ...
           @Override
           public ServerActionsAttachToNetworkResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsAttachToNetworkResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsAttachToNetworkResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsAttachToNetworkResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsAttachToNetworkResponse
  */
  public static ServerActionsAttachToNetworkResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsAttachToNetworkResponse.class);
  }

 /**
  * Convert an instance of ServerActionsAttachToNetworkResponse to an JSON string
  *
  * @return JSON string
  */
