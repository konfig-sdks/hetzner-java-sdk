...
/**
 * ActionProperty58ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty58ResourcesInner {
  ...
  public ActionProperty58ResourcesInner() {
  }

  public ActionProperty58ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty58ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty58ResourcesInner instance itself
   */
  public ActionProperty58ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty58ResourcesInner actionProperty58ResourcesInner = (ActionProperty58ResourcesInner) o;
    return Objects.equals(this.id, actionProperty58ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty58ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty58ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty58ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty58ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty58ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty58ResourcesInner is not found in the empty JSON string", ActionProperty58ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty58ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty58ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty58ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty58ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty58ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty58ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty58ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty58ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty58ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty58ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty58ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty58ResourcesInner
  */
  public static ActionProperty58ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty58ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty58ResourcesInner to an JSON string
  *
  * @return JSON string
  */
