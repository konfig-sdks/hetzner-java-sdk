...
public class FloatingIpActionsChangeDnsPtrRequest {
  ...
  public FloatingIpActionsChangeDnsPtrRequest() {
  }

  public FloatingIpActionsChangeDnsPtrRequest dnsPtr(String dnsPtr) {
  ...
  **/
  ...
  @ApiModelProperty(example = "server02.example.com", required = true, value = "Hostname to set as a reverse DNS PTR entry, will reset to original default value if `null`")
  ...
  public FloatingIpActionsChangeDnsPtrRequest ip(String ip) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1.2.3.4", required = true, value = "IP address for which to set the reverse DNS entry")
   ...
   * @return the FloatingIpActionsChangeDnsPtrRequest instance itself
   */
  public FloatingIpActionsChangeDnsPtrRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpActionsChangeDnsPtrRequest floatingIpActionsChangeDnsPtrRequest = (FloatingIpActionsChangeDnsPtrRequest) o;
    return Objects.equals(this.dnsPtr, floatingIpActionsChangeDnsPtrRequest.dnsPtr) &&
        Objects.equals(this.ip, floatingIpActionsChangeDnsPtrRequest.ip)&&
        Objects.equals(this.additionalProperties, floatingIpActionsChangeDnsPtrRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpActionsChangeDnsPtrRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionsChangeDnsPtrRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionsChangeDnsPtrRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionsChangeDnsPtrRequest is not found in the empty JSON string", FloatingIpActionsChangeDnsPtrRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionsChangeDnsPtrRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionsChangeDnsPtrRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionsChangeDnsPtrRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionsChangeDnsPtrRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionsChangeDnsPtrRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionsChangeDnsPtrRequest>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionsChangeDnsPtrRequest value) throws IOException {
           ...
           @Override
           public FloatingIpActionsChangeDnsPtrRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionsChangeDnsPtrRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionsChangeDnsPtrRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionsChangeDnsPtrRequest
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionsChangeDnsPtrRequest
  */
  public static FloatingIpActionsChangeDnsPtrRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionsChangeDnsPtrRequest.class);
  }

 /**
  * Convert an instance of FloatingIpActionsChangeDnsPtrRequest to an JSON string
  *
  * @return JSON string
  */
