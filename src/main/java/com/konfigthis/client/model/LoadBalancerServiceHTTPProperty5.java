...
public class LoadBalancerServiceHTTPProperty5 {
  ...
  public LoadBalancerServiceHTTPProperty5() {
  }

  public LoadBalancerServiceHTTPProperty5 certificates(List<Long> certificates) {
  ...
  public LoadBalancerServiceHTTPProperty5 addCertificatesItem(Long certificatesItem) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty5 cookieLifetime(Integer cookieLifetime) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty5 cookieName(String cookieName) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty5 redirectHttp(Boolean redirectHttp) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty5 stickySessions(Boolean stickySessions) {
  ...
  **/
   ...
   * @return the LoadBalancerServiceHTTPProperty5 instance itself
   */
  public LoadBalancerServiceHTTPProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerServiceHTTPProperty5 loadBalancerServiceHTTPProperty5 = (LoadBalancerServiceHTTPProperty5) o;
    return Objects.equals(this.certificates, loadBalancerServiceHTTPProperty5.certificates) &&
        Objects.equals(this.cookieLifetime, loadBalancerServiceHTTPProperty5.cookieLifetime) &&
        Objects.equals(this.cookieName, loadBalancerServiceHTTPProperty5.cookieName) &&
        Objects.equals(this.redirectHttp, loadBalancerServiceHTTPProperty5.redirectHttp) &&
        Objects.equals(this.stickySessions, loadBalancerServiceHTTPProperty5.stickySessions)&&
        Objects.equals(this.additionalProperties, loadBalancerServiceHTTPProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerServiceHTTPProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerServiceHTTPProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerServiceHTTPProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerServiceHTTPProperty5 is not found in the empty JSON string", LoadBalancerServiceHTTPProperty5.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerServiceHTTPProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerServiceHTTPProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerServiceHTTPProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerServiceHTTPProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerServiceHTTPProperty5>() {
           @Override
           public void write(JsonWriter out, LoadBalancerServiceHTTPProperty5 value) throws IOException {
           ...
           @Override
           public LoadBalancerServiceHTTPProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerServiceHTTPProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerServiceHTTPProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerServiceHTTPProperty5
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerServiceHTTPProperty5
  */
  public static LoadBalancerServiceHTTPProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerServiceHTTPProperty5.class);
  }

 /**
  * Convert an instance of LoadBalancerServiceHTTPProperty5 to an JSON string
  *
  * @return JSON string
  */
