...
public class ActionProperty37Error {
  ...
  public ActionProperty37Error() {
  }

  public ActionProperty37Error code(String code) {
  ...
  **/
  ...
  public ActionProperty37Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty37Error instance itself
   */
  public ActionProperty37Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty37Error actionProperty37Error = (ActionProperty37Error) o;
    return Objects.equals(this.code, actionProperty37Error.code) &&
        Objects.equals(this.message, actionProperty37Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty37Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty37Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty37Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty37Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty37Error is not found in the empty JSON string", ActionProperty37Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty37Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty37Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty37Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty37Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty37Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty37Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty37Error value) throws IOException {
           ...
           @Override
           public ActionProperty37Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty37Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty37Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty37Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty37Error
  */
  public static ActionProperty37Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty37Error.class);
  }

 /**
  * Convert an instance of ActionProperty37Error to an JSON string
  *
  * @return JSON string
  */
