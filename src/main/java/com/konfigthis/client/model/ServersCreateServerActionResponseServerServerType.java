...
import com.konfigthis.client.model.DeprecationInfoProperty7;
import com.konfigthis.client.model.ServersCreateServerActionResponseServerServerTypePricesInner;
...
public class ServersCreateServerActionResponseServerServerType {
 ...
 public enum CpuTypeEnum {
  ...
  private DeprecationInfoProperty7 deprecation;
  ...
  private List<ServersCreateServerActionResponseServerServerTypePricesInner> prices = new ArrayList<>();
 ...
 public enum StorageTypeEnum {
  ...
  public ServersCreateServerActionResponseServerServerType() {
  }

  public ServersCreateServerActionResponseServerServerType description(String description) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType cores(Double cores) {
  ...
  public ServersCreateServerActionResponseServerServerType cores(Integer cores) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType cpuType(CpuTypeEnum cpuType) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType deprecated(Boolean deprecated) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType deprecation(DeprecationInfoProperty7 deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty7 getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty7 deprecation) {
  ...
  public ServersCreateServerActionResponseServerServerType disk(Double disk) {
  ...
  public ServersCreateServerActionResponseServerServerType disk(Integer disk) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType id(Long id) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType includedTraffic(Long includedTraffic) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType memory(Double memory) {
  ...
  public ServersCreateServerActionResponseServerServerType memory(Integer memory) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType name(String name) {
  ...
  **/
  ...
  public ServersCreateServerActionResponseServerServerType prices(List<ServersCreateServerActionResponseServerServerTypePricesInner> prices) {
  ...
  public ServersCreateServerActionResponseServerServerType addPricesItem(ServersCreateServerActionResponseServerServerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<ServersCreateServerActionResponseServerServerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<ServersCreateServerActionResponseServerServerTypePricesInner> prices) {
  ...
  public ServersCreateServerActionResponseServerServerType storageType(StorageTypeEnum storageType) {
  ...
  **/
   ...
   * @return the ServersCreateServerActionResponseServerServerType instance itself
   */
  public ServersCreateServerActionResponseServerServerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersCreateServerActionResponseServerServerType serversCreateServerActionResponseServerServerType = (ServersCreateServerActionResponseServerServerType) o;
    return Objects.equals(this.description, serversCreateServerActionResponseServerServerType.description) &&
        Objects.equals(this.architecture, serversCreateServerActionResponseServerServerType.architecture) &&
        Objects.equals(this.cores, serversCreateServerActionResponseServerServerType.cores) &&
        Objects.equals(this.cpuType, serversCreateServerActionResponseServerServerType.cpuType) &&
        Objects.equals(this.deprecated, serversCreateServerActionResponseServerServerType.deprecated) &&
        Objects.equals(this.deprecation, serversCreateServerActionResponseServerServerType.deprecation) &&
        Objects.equals(this.disk, serversCreateServerActionResponseServerServerType.disk) &&
        Objects.equals(this.id, serversCreateServerActionResponseServerServerType.id) &&
        Objects.equals(this.includedTraffic, serversCreateServerActionResponseServerServerType.includedTraffic) &&
        Objects.equals(this.memory, serversCreateServerActionResponseServerServerType.memory) &&
        Objects.equals(this.name, serversCreateServerActionResponseServerServerType.name) &&
        Objects.equals(this.prices, serversCreateServerActionResponseServerServerType.prices) &&
        Objects.equals(this.storageType, serversCreateServerActionResponseServerServerType.storageType)&&
        Objects.equals(this.additionalProperties, serversCreateServerActionResponseServerServerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersCreateServerActionResponseServerServerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersCreateServerActionResponseServerServerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersCreateServerActionResponseServerServerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersCreateServerActionResponseServerServerType is not found in the empty JSON string", ServersCreateServerActionResponseServerServerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersCreateServerActionResponseServerServerType.openapiRequiredFields) {
      ...
      if (jsonObj.get("deprecation") != null && !jsonObj.get("deprecation").isJsonNull()) {
        DeprecationInfoProperty7.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
      }
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        ServersCreateServerActionResponseServerServerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersCreateServerActionResponseServerServerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersCreateServerActionResponseServerServerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersCreateServerActionResponseServerServerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersCreateServerActionResponseServerServerType.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersCreateServerActionResponseServerServerType>() {
           @Override
           public void write(JsonWriter out, ServersCreateServerActionResponseServerServerType value) throws IOException {
           ...
           @Override
           public ServersCreateServerActionResponseServerServerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersCreateServerActionResponseServerServerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersCreateServerActionResponseServerServerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersCreateServerActionResponseServerServerType
  * @throws IOException if the JSON string is invalid with respect to ServersCreateServerActionResponseServerServerType
  */
  public static ServersCreateServerActionResponseServerServerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersCreateServerActionResponseServerServerType.class);
  }

 /**
  * Convert an instance of ServersCreateServerActionResponseServerServerType to an JSON string
  *
  * @return JSON string
  */
