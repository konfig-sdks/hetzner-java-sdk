 ...
 */
@ApiModel(description = "Public Network options")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ServersCreateServerActionRequestPublicNet {
  ...
  public ServersCreateServerActionRequestPublicNet() {
  }

  public ServersCreateServerActionRequestPublicNet enableIpv4(Boolean enableIpv4) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "Attach an IPv4 on the public NIC. If false, no IPv4 address will be attached.")
  ...
  public ServersCreateServerActionRequestPublicNet enableIpv6(Boolean enableIpv6) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Attach an IPv6 on the public NIC. If false, no IPv6 address will be attached.")
  ...
  public ServersCreateServerActionRequestPublicNet ipv4(Integer ipv4) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the ipv4 Primary IP to use. If omitted and enable_ipv4 is true, a new ipv4 Primary IP will automatically be created.")
  ...
  public ServersCreateServerActionRequestPublicNet ipv6(Integer ipv6) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the ipv6 Primary IP to use. If omitted and enable_ipv6 is true, a new ipv6 Primary IP will automatically be created.")
   ...
   * @return the ServersCreateServerActionRequestPublicNet instance itself
   */
  public ServersCreateServerActionRequestPublicNet putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersCreateServerActionRequestPublicNet serversCreateServerActionRequestPublicNet = (ServersCreateServerActionRequestPublicNet) o;
    return Objects.equals(this.enableIpv4, serversCreateServerActionRequestPublicNet.enableIpv4) &&
        Objects.equals(this.enableIpv6, serversCreateServerActionRequestPublicNet.enableIpv6) &&
        Objects.equals(this.ipv4, serversCreateServerActionRequestPublicNet.ipv4) &&
        Objects.equals(this.ipv6, serversCreateServerActionRequestPublicNet.ipv6)&&
        Objects.equals(this.additionalProperties, serversCreateServerActionRequestPublicNet.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enableIpv4, enableIpv6, ipv4, ipv6, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersCreateServerActionRequestPublicNet {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersCreateServerActionRequestPublicNet
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersCreateServerActionRequestPublicNet.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersCreateServerActionRequestPublicNet is not found in the empty JSON string", ServersCreateServerActionRequestPublicNet.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersCreateServerActionRequestPublicNet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersCreateServerActionRequestPublicNet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersCreateServerActionRequestPublicNet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersCreateServerActionRequestPublicNet.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersCreateServerActionRequestPublicNet>() {
           @Override
           public void write(JsonWriter out, ServersCreateServerActionRequestPublicNet value) throws IOException {
           ...
           @Override
           public ServersCreateServerActionRequestPublicNet read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersCreateServerActionRequestPublicNet instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersCreateServerActionRequestPublicNet given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersCreateServerActionRequestPublicNet
  * @throws IOException if the JSON string is invalid with respect to ServersCreateServerActionRequestPublicNet
  */
  public static ServersCreateServerActionRequestPublicNet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersCreateServerActionRequestPublicNet.class);
  }

 /**
  * Convert an instance of ServersCreateServerActionRequestPublicNet to an JSON string
  *
  * @return JSON string
  */
