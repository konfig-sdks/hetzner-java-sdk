...
import com.konfigthis.client.model.ActionProperty57Error;
import com.konfigthis.client.model.ActionProperty57ResourcesInner;
...
public class ActionProperty57 {
  ...
  private ActionProperty57Error error;
  ...
  private List<ActionProperty57ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty57() {
  }

  public ActionProperty57 command(String command) {
  ...
  **/
  ...
  public ActionProperty57 error(ActionProperty57Error error) {
  ...
  **/
  ...
  public ActionProperty57Error getError() {
    return error;
  }


  public void setError(ActionProperty57Error error) {
  ...
  public ActionProperty57 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty57 id(Long id) {
  ...
  **/
  ...
  public ActionProperty57 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty57 resources(List<ActionProperty57ResourcesInner> resources) {
  ...
  public ActionProperty57 addResourcesItem(ActionProperty57ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty57ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty57ResourcesInner> resources) {
  ...
  public ActionProperty57 started(String started) {
  ...
  **/
  ...
  public ActionProperty57 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty57 instance itself
   */
  public ActionProperty57 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty57 actionProperty57 = (ActionProperty57) o;
    return Objects.equals(this.command, actionProperty57.command) &&
        Objects.equals(this.error, actionProperty57.error) &&
        Objects.equals(this.finished, actionProperty57.finished) &&
        Objects.equals(this.id, actionProperty57.id) &&
        Objects.equals(this.progress, actionProperty57.progress) &&
        Objects.equals(this.resources, actionProperty57.resources) &&
        Objects.equals(this.started, actionProperty57.started) &&
        Objects.equals(this.status, actionProperty57.status)&&
        Objects.equals(this.additionalProperties, actionProperty57.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty57 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty57
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty57.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty57 is not found in the empty JSON string", ActionProperty57.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty57.openapiRequiredFields) {
      ...
      ActionProperty57Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty57ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty57.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty57' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty57> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty57.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty57>() {
           @Override
           public void write(JsonWriter out, ActionProperty57 value) throws IOException {
           ...
           @Override
           public ActionProperty57 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty57 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty57 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty57
  * @throws IOException if the JSON string is invalid with respect to ActionProperty57
  */
  public static ActionProperty57 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty57.class);
  }

 /**
  * Convert an instance of ActionProperty57 to an JSON string
  *
  * @return JSON string
  */
