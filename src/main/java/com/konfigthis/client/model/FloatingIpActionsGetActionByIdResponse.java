...
import com.konfigthis.client.model.ActionProperty8;
...
public class FloatingIpActionsGetActionByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty8 action;

  public FloatingIpActionsGetActionByIdResponse() {
  }

  public FloatingIpActionsGetActionByIdResponse action(ActionProperty8 action) {
  ...
  **/
  ...
  public ActionProperty8 getAction() {
    return action;
  }


  public void setAction(ActionProperty8 action) {
   ...
   * @return the FloatingIpActionsGetActionByIdResponse instance itself
   */
  public FloatingIpActionsGetActionByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpActionsGetActionByIdResponse floatingIpActionsGetActionByIdResponse = (FloatingIpActionsGetActionByIdResponse) o;
    return Objects.equals(this.action, floatingIpActionsGetActionByIdResponse.action)&&
        Objects.equals(this.additionalProperties, floatingIpActionsGetActionByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpActionsGetActionByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionsGetActionByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionsGetActionByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionsGetActionByIdResponse is not found in the empty JSON string", FloatingIpActionsGetActionByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionsGetActionByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty8.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionsGetActionByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionsGetActionByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionsGetActionByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionsGetActionByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionsGetActionByIdResponse>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionsGetActionByIdResponse value) throws IOException {
           ...
           @Override
           public FloatingIpActionsGetActionByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionsGetActionByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionsGetActionByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionsGetActionByIdResponse
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionsGetActionByIdResponse
  */
  public static FloatingIpActionsGetActionByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionsGetActionByIdResponse.class);
  }

 /**
  * Convert an instance of FloatingIpActionsGetActionByIdResponse to an JSON string
  *
  * @return JSON string
  */
