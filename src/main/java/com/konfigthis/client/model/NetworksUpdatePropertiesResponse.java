...
import com.konfigthis.client.model.NetworksUpdatePropertiesResponseNetwork;
...
public class NetworksUpdatePropertiesResponse {
  public static final String SERIALIZED_NAME_NETWORK = "network";
  @SerializedName(SERIALIZED_NAME_NETWORK)
  private NetworksUpdatePropertiesResponseNetwork network;

  public NetworksUpdatePropertiesResponse() {
  }

  public NetworksUpdatePropertiesResponse network(NetworksUpdatePropertiesResponseNetwork network) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork getNetwork() {
    return network;
  }


  public void setNetwork(NetworksUpdatePropertiesResponseNetwork network) {
   ...
   * @return the NetworksUpdatePropertiesResponse instance itself
   */
  public NetworksUpdatePropertiesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksUpdatePropertiesResponse networksUpdatePropertiesResponse = (NetworksUpdatePropertiesResponse) o;
    return Objects.equals(this.network, networksUpdatePropertiesResponse.network)&&
        Objects.equals(this.additionalProperties, networksUpdatePropertiesResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksUpdatePropertiesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksUpdatePropertiesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksUpdatePropertiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksUpdatePropertiesResponse is not found in the empty JSON string", NetworksUpdatePropertiesResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `network`
      if (jsonObj.get("network") != null && !jsonObj.get("network").isJsonNull()) {
        NetworksUpdatePropertiesResponseNetwork.validateJsonObject(jsonObj.getAsJsonObject("network"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksUpdatePropertiesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksUpdatePropertiesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksUpdatePropertiesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksUpdatePropertiesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksUpdatePropertiesResponse>() {
           @Override
           public void write(JsonWriter out, NetworksUpdatePropertiesResponse value) throws IOException {
           ...
           @Override
           public NetworksUpdatePropertiesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksUpdatePropertiesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksUpdatePropertiesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksUpdatePropertiesResponse
  * @throws IOException if the JSON string is invalid with respect to NetworksUpdatePropertiesResponse
  */
  public static NetworksUpdatePropertiesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksUpdatePropertiesResponse.class);
  }

 /**
  * Convert an instance of NetworksUpdatePropertiesResponse to an JSON string
  *
  * @return JSON string
  */
