...
public class ServerActionsAttachIsoToServerRequest {
  public static final String SERIALIZED_NAME_ISO = "iso";
  @SerializedName(SERIALIZED_NAME_ISO)
  private String iso;

  public ServerActionsAttachIsoToServerRequest() {
  }

  public ServerActionsAttachIsoToServerRequest iso(String iso) {
  ...
  **/
  ...
  @ApiModelProperty(example = "FreeBSD-11.0-RELEASE-amd64-dvd1", required = true, value = "ID or name of ISO to attach to the Server as listed in GET `/isos`")
   ...
   * @return the ServerActionsAttachIsoToServerRequest instance itself
   */
  public ServerActionsAttachIsoToServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsAttachIsoToServerRequest serverActionsAttachIsoToServerRequest = (ServerActionsAttachIsoToServerRequest) o;
    return Objects.equals(this.iso, serverActionsAttachIsoToServerRequest.iso)&&
        Objects.equals(this.additionalProperties, serverActionsAttachIsoToServerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(iso, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerActionsAttachIsoToServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsAttachIsoToServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsAttachIsoToServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsAttachIsoToServerRequest is not found in the empty JSON string", ServerActionsAttachIsoToServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsAttachIsoToServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsAttachIsoToServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsAttachIsoToServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsAttachIsoToServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsAttachIsoToServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsAttachIsoToServerRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsAttachIsoToServerRequest value) throws IOException {
           ...
           @Override
           public ServerActionsAttachIsoToServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsAttachIsoToServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsAttachIsoToServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsAttachIsoToServerRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsAttachIsoToServerRequest
  */
  public static ServerActionsAttachIsoToServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsAttachIsoToServerRequest.class);
  }

 /**
  * Convert an instance of ServerActionsAttachIsoToServerRequest to an JSON string
  *
  * @return JSON string
  */
