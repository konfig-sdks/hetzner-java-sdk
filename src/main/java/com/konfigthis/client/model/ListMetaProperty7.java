...
import com.konfigthis.client.model.ListMetaProperty7Pagination;
...
public class ListMetaProperty7 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty7Pagination pagination;

  public ListMetaProperty7() {
  }

  public ListMetaProperty7 pagination(ListMetaProperty7Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty7Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty7Pagination pagination) {
   ...
   * @return the ListMetaProperty7 instance itself
   */
  public ListMetaProperty7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty7 listMetaProperty7 = (ListMetaProperty7) o;
    return Objects.equals(this.pagination, listMetaProperty7.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty7.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty7 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty7 is not found in the empty JSON string", ListMetaProperty7.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty7.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty7Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty7.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty7>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty7 value) throws IOException {
           ...
           @Override
           public ListMetaProperty7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty7
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty7
  */
  public static ListMetaProperty7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty7.class);
  }

 /**
  * Convert an instance of ListMetaProperty7 to an JSON string
  *
  * @return JSON string
  */
