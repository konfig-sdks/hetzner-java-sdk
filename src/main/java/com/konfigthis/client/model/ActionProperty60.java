...
import com.konfigthis.client.model.ActionProperty60Error;
import com.konfigthis.client.model.ActionProperty60ResourcesInner;
...
public class ActionProperty60 {
  ...
  private ActionProperty60Error error;
  ...
  private List<ActionProperty60ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty60() {
  }

  public ActionProperty60 command(String command) {
  ...
  **/
  ...
  public ActionProperty60 error(ActionProperty60Error error) {
  ...
  **/
  ...
  public ActionProperty60Error getError() {
    return error;
  }


  public void setError(ActionProperty60Error error) {
  ...
  public ActionProperty60 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty60 id(Long id) {
  ...
  **/
  ...
  public ActionProperty60 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty60 resources(List<ActionProperty60ResourcesInner> resources) {
  ...
  public ActionProperty60 addResourcesItem(ActionProperty60ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty60ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty60ResourcesInner> resources) {
  ...
  public ActionProperty60 started(String started) {
  ...
  **/
  ...
  public ActionProperty60 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty60 instance itself
   */
  public ActionProperty60 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty60 actionProperty60 = (ActionProperty60) o;
    return Objects.equals(this.command, actionProperty60.command) &&
        Objects.equals(this.error, actionProperty60.error) &&
        Objects.equals(this.finished, actionProperty60.finished) &&
        Objects.equals(this.id, actionProperty60.id) &&
        Objects.equals(this.progress, actionProperty60.progress) &&
        Objects.equals(this.resources, actionProperty60.resources) &&
        Objects.equals(this.started, actionProperty60.started) &&
        Objects.equals(this.status, actionProperty60.status)&&
        Objects.equals(this.additionalProperties, actionProperty60.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty60 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty60
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty60.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty60 is not found in the empty JSON string", ActionProperty60.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty60.openapiRequiredFields) {
      ...
      ActionProperty60Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty60ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty60.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty60' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty60> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty60.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty60>() {
           @Override
           public void write(JsonWriter out, ActionProperty60 value) throws IOException {
           ...
           @Override
           public ActionProperty60 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty60 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty60 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty60
  * @throws IOException if the JSON string is invalid with respect to ActionProperty60
  */
  public static ActionProperty60 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty60.class);
  }

 /**
  * Convert an instance of ActionProperty60 to an JSON string
  *
  * @return JSON string
  */
