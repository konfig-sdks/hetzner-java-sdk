...
public class ActionNullableError {
  ...
  public ActionNullableError() {
  }

  public ActionNullableError code(String code) {
  ...
  **/
  ...
  public ActionNullableError message(String message) {
  ...
  **/
   ...
   * @return the ActionNullableError instance itself
   */
  public ActionNullableError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullableError actionNullableError = (ActionNullableError) o;
    return Objects.equals(this.code, actionNullableError.code) &&
        Objects.equals(this.message, actionNullableError.message)&&
        Objects.equals(this.additionalProperties, actionNullableError.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullableError {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullableError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullableError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullableError is not found in the empty JSON string", ActionNullableError.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullableError.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullableError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullableError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullableError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullableError.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullableError>() {
           @Override
           public void write(JsonWriter out, ActionNullableError value) throws IOException {
           ...
           @Override
           public ActionNullableError read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullableError instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullableError given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullableError
  * @throws IOException if the JSON string is invalid with respect to ActionNullableError
  */
  public static ActionNullableError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullableError.class);
  }

 /**
  * Convert an instance of ActionNullableError to an JSON string
  *
  * @return JSON string
  */
