...
public class DeprecationInfoProperty6 {
  ...
  public DeprecationInfoProperty6() {
  }

  public DeprecationInfoProperty6 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty6 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty6 instance itself
   */
  public DeprecationInfoProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty6 deprecationInfoProperty6 = (DeprecationInfoProperty6) o;
    return Objects.equals(this.announced, deprecationInfoProperty6.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty6.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty6 is not found in the empty JSON string", DeprecationInfoProperty6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty6>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty6 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty6
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty6
  */
  public static DeprecationInfoProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty6.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty6 to an JSON string
  *
  * @return JSON string
  */
