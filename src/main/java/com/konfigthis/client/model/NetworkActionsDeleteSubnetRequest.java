...
public class NetworkActionsDeleteSubnetRequest {
  public static final String SERIALIZED_NAME_IP_RANGE = "ip_range";
  @SerializedName(SERIALIZED_NAME_IP_RANGE)
  private String ipRange;

  public NetworkActionsDeleteSubnetRequest() {
  }

  public NetworkActionsDeleteSubnetRequest ipRange(String ipRange) {
  ...
  **/
  ...
  @ApiModelProperty(example = "10.0.1.0/24", required = true, value = "IP range of subnet to delete")
   ...
   * @return the NetworkActionsDeleteSubnetRequest instance itself
   */
  public NetworkActionsDeleteSubnetRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsDeleteSubnetRequest networkActionsDeleteSubnetRequest = (NetworkActionsDeleteSubnetRequest) o;
    return Objects.equals(this.ipRange, networkActionsDeleteSubnetRequest.ipRange)&&
        Objects.equals(this.additionalProperties, networkActionsDeleteSubnetRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsDeleteSubnetRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsDeleteSubnetRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsDeleteSubnetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsDeleteSubnetRequest is not found in the empty JSON string", NetworkActionsDeleteSubnetRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsDeleteSubnetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsDeleteSubnetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsDeleteSubnetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsDeleteSubnetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsDeleteSubnetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsDeleteSubnetRequest>() {
           @Override
           public void write(JsonWriter out, NetworkActionsDeleteSubnetRequest value) throws IOException {
           ...
           @Override
           public NetworkActionsDeleteSubnetRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsDeleteSubnetRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsDeleteSubnetRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsDeleteSubnetRequest
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsDeleteSubnetRequest
  */
  public static NetworkActionsDeleteSubnetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsDeleteSubnetRequest.class);
  }

 /**
  * Convert an instance of NetworkActionsDeleteSubnetRequest to an JSON string
  *
  * @return JSON string
  */
