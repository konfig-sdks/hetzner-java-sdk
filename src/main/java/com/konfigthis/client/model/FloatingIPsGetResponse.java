...
import com.konfigthis.client.model.FloatingIPsGetResponseFloatingIp;
...
public class FloatingIPsGetResponse {
  ...
  private FloatingIPsGetResponseFloatingIp floatingIp;

  public FloatingIPsGetResponse() {
  }

  public FloatingIPsGetResponse floatingIp(FloatingIPsGetResponseFloatingIp floatingIp) {
  ...
  **/
  ...
  public FloatingIPsGetResponseFloatingIp getFloatingIp() {
    return floatingIp;
  }


  public void setFloatingIp(FloatingIPsGetResponseFloatingIp floatingIp) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (String requiredField : FloatingIPsGetResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `floating_ip`
      FloatingIPsGetResponseFloatingIp.validateJsonObject(jsonObj.getAsJsonObject("floating_ip"));
  }
