...
/**
 * ActionProperty49ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty49ResourcesInner {
  ...
  public ActionProperty49ResourcesInner() {
  }

  public ActionProperty49ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty49ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty49ResourcesInner instance itself
   */
  public ActionProperty49ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty49ResourcesInner actionProperty49ResourcesInner = (ActionProperty49ResourcesInner) o;
    return Objects.equals(this.id, actionProperty49ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty49ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty49ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty49ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty49ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty49ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty49ResourcesInner is not found in the empty JSON string", ActionProperty49ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty49ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty49ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty49ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty49ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty49ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty49ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty49ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty49ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty49ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty49ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty49ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty49ResourcesInner
  */
  public static ActionProperty49ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty49ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty49ResourcesInner to an JSON string
  *
  * @return JSON string
  */
