...
import com.konfigthis.client.model.ActionProperty68Error;
import com.konfigthis.client.model.ActionProperty68ResourcesInner;
...
public class ActionProperty68 {
  ...
  private ActionProperty68Error error;
  ...
  private List<ActionProperty68ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty68() {
  }

  public ActionProperty68 command(String command) {
  ...
  **/
  ...
  public ActionProperty68 error(ActionProperty68Error error) {
  ...
  **/
  ...
  public ActionProperty68Error getError() {
    return error;
  }


  public void setError(ActionProperty68Error error) {
  ...
  public ActionProperty68 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty68 id(Long id) {
  ...
  **/
  ...
  public ActionProperty68 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty68 resources(List<ActionProperty68ResourcesInner> resources) {
  ...
  public ActionProperty68 addResourcesItem(ActionProperty68ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty68ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty68ResourcesInner> resources) {
  ...
  public ActionProperty68 started(String started) {
  ...
  **/
  ...
  public ActionProperty68 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty68 instance itself
   */
  public ActionProperty68 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty68 actionProperty68 = (ActionProperty68) o;
    return Objects.equals(this.command, actionProperty68.command) &&
        Objects.equals(this.error, actionProperty68.error) &&
        Objects.equals(this.finished, actionProperty68.finished) &&
        Objects.equals(this.id, actionProperty68.id) &&
        Objects.equals(this.progress, actionProperty68.progress) &&
        Objects.equals(this.resources, actionProperty68.resources) &&
        Objects.equals(this.started, actionProperty68.started) &&
        Objects.equals(this.status, actionProperty68.status)&&
        Objects.equals(this.additionalProperties, actionProperty68.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty68 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty68
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty68.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty68 is not found in the empty JSON string", ActionProperty68.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty68.openapiRequiredFields) {
      ...
      ActionProperty68Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty68ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty68.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty68' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty68> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty68.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty68>() {
           @Override
           public void write(JsonWriter out, ActionProperty68 value) throws IOException {
           ...
           @Override
           public ActionProperty68 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty68 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty68 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty68
  * @throws IOException if the JSON string is invalid with respect to ActionProperty68
  */
  public static ActionProperty68 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty68.class);
  }

 /**
  * Convert an instance of ActionProperty68 to an JSON string
  *
  * @return JSON string
  */
