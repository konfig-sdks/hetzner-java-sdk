...
public class PrimaryIpActionsChangeDnsPtrRequest {
  ...
  public PrimaryIpActionsChangeDnsPtrRequest() {
  }

  public PrimaryIpActionsChangeDnsPtrRequest dnsPtr(String dnsPtr) {
  ...
  **/
  ...
  public PrimaryIpActionsChangeDnsPtrRequest ip(String ip) {
  ...
  **/
   ...
   * @return the PrimaryIpActionsChangeDnsPtrRequest instance itself
   */
  public PrimaryIpActionsChangeDnsPtrRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIpActionsChangeDnsPtrRequest primaryIpActionsChangeDnsPtrRequest = (PrimaryIpActionsChangeDnsPtrRequest) o;
    return Objects.equals(this.dnsPtr, primaryIpActionsChangeDnsPtrRequest.dnsPtr) &&
        Objects.equals(this.ip, primaryIpActionsChangeDnsPtrRequest.ip)&&
        Objects.equals(this.additionalProperties, primaryIpActionsChangeDnsPtrRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIpActionsChangeDnsPtrRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIpActionsChangeDnsPtrRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIpActionsChangeDnsPtrRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIpActionsChangeDnsPtrRequest is not found in the empty JSON string", PrimaryIpActionsChangeDnsPtrRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIpActionsChangeDnsPtrRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIpActionsChangeDnsPtrRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIpActionsChangeDnsPtrRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIpActionsChangeDnsPtrRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIpActionsChangeDnsPtrRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIpActionsChangeDnsPtrRequest>() {
           @Override
           public void write(JsonWriter out, PrimaryIpActionsChangeDnsPtrRequest value) throws IOException {
           ...
           @Override
           public PrimaryIpActionsChangeDnsPtrRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIpActionsChangeDnsPtrRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIpActionsChangeDnsPtrRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIpActionsChangeDnsPtrRequest
  * @throws IOException if the JSON string is invalid with respect to PrimaryIpActionsChangeDnsPtrRequest
  */
  public static PrimaryIpActionsChangeDnsPtrRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIpActionsChangeDnsPtrRequest.class);
  }

 /**
  * Convert an instance of PrimaryIpActionsChangeDnsPtrRequest to an JSON string
  *
  * @return JSON string
  */
