...
import com.konfigthis.client.model.ActionProperty58;
...
public class ServerActionsDetachFromNetworkResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty58 action;

  public ServerActionsDetachFromNetworkResponse() {
  }

  public ServerActionsDetachFromNetworkResponse action(ActionProperty58 action) {
  ...
  **/
  ...
  public ActionProperty58 getAction() {
    return action;
  }


  public void setAction(ActionProperty58 action) {
   ...
   * @return the ServerActionsDetachFromNetworkResponse instance itself
   */
  public ServerActionsDetachFromNetworkResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsDetachFromNetworkResponse serverActionsDetachFromNetworkResponse = (ServerActionsDetachFromNetworkResponse) o;
    return Objects.equals(this.action, serverActionsDetachFromNetworkResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsDetachFromNetworkResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsDetachFromNetworkResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsDetachFromNetworkResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsDetachFromNetworkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsDetachFromNetworkResponse is not found in the empty JSON string", ServerActionsDetachFromNetworkResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsDetachFromNetworkResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty58.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsDetachFromNetworkResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsDetachFromNetworkResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsDetachFromNetworkResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsDetachFromNetworkResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsDetachFromNetworkResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsDetachFromNetworkResponse value) throws IOException {
           ...
           @Override
           public ServerActionsDetachFromNetworkResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsDetachFromNetworkResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsDetachFromNetworkResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsDetachFromNetworkResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsDetachFromNetworkResponse
  */
  public static ServerActionsDetachFromNetworkResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsDetachFromNetworkResponse.class);
  }

 /**
  * Convert an instance of ServerActionsDetachFromNetworkResponse to an JSON string
  *
  * @return JSON string
  */
