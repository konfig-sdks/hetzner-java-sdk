...
import com.konfigthis.client.model.ActionPropertyError;
import com.konfigthis.client.model.ActionPropertyResourcesInner;
...
public class ActionProperty {
  ...
  private ActionPropertyError error;
  ...
  private List<ActionPropertyResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty command(String command) {
  ...
  **/
  ...
  public ActionProperty error(ActionPropertyError error) {
  ...
  **/
  ...
  public ActionPropertyError getError() {
    return error;
  }


  public void setError(ActionPropertyError error) {
  ...
  public ActionProperty finished(String finished) {
  ...
  **/
  ...
  public ActionProperty id(Long id) {
  ...
  **/
  ...
  public ActionProperty progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty resources(List<ActionPropertyResourcesInner> resources) {
  ...
  public ActionProperty addResourcesItem(ActionPropertyResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionPropertyResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionPropertyResourcesInner> resources) {
  ...
  public ActionProperty started(String started) {
  ...
  **/
  ...
  public ActionProperty status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty instance itself
   */
  public ActionProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty actionProperty = (ActionProperty) o;
    return Objects.equals(this.command, actionProperty.command) &&
        Objects.equals(this.error, actionProperty.error) &&
        Objects.equals(this.finished, actionProperty.finished) &&
        Objects.equals(this.id, actionProperty.id) &&
        Objects.equals(this.progress, actionProperty.progress) &&
        Objects.equals(this.resources, actionProperty.resources) &&
        Objects.equals(this.started, actionProperty.started) &&
        Objects.equals(this.status, actionProperty.status)&&
        Objects.equals(this.additionalProperties, actionProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty is not found in the empty JSON string", ActionProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty.openapiRequiredFields) {
      ...
      ActionPropertyError.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionPropertyResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty>() {
           @Override
           public void write(JsonWriter out, ActionProperty value) throws IOException {
           ...
           @Override
           public ActionProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty
  * @throws IOException if the JSON string is invalid with respect to ActionProperty
  */
  public static ActionProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty.class);
  }

 /**
  * Convert an instance of ActionProperty to an JSON string
  *
  * @return JSON string
  */
