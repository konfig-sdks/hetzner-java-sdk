...
public class ListMetaProperty9Pagination {
  ...
  public ListMetaProperty9Pagination() {
  }

  public ListMetaProperty9Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty9Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty9Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty9Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty9Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty9Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty9Pagination instance itself
   */
  public ListMetaProperty9Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty9Pagination listMetaProperty9Pagination = (ListMetaProperty9Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty9Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty9Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty9Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty9Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty9Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty9Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty9Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty9Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty9Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty9Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty9Pagination is not found in the empty JSON string", ListMetaProperty9Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty9Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty9Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty9Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty9Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty9Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty9Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty9Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty9Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty9Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty9Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty9Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty9Pagination
  */
  public static ListMetaProperty9Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty9Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty9Pagination to an JSON string
  *
  * @return JSON string
  */
