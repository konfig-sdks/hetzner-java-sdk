...
public class ActionProperty57Error {
  ...
  public ActionProperty57Error() {
  }

  public ActionProperty57Error code(String code) {
  ...
  **/
  ...
  public ActionProperty57Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty57Error instance itself
   */
  public ActionProperty57Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty57Error actionProperty57Error = (ActionProperty57Error) o;
    return Objects.equals(this.code, actionProperty57Error.code) &&
        Objects.equals(this.message, actionProperty57Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty57Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty57Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty57Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty57Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty57Error is not found in the empty JSON string", ActionProperty57Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty57Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty57Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty57Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty57Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty57Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty57Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty57Error value) throws IOException {
           ...
           @Override
           public ActionProperty57Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty57Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty57Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty57Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty57Error
  */
  public static ActionProperty57Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty57Error.class);
  }

 /**
  * Convert an instance of ActionProperty57Error to an JSON string
  *
  * @return JSON string
  */
