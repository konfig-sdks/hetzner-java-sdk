...
public class ActionProperty44Error {
  ...
  public ActionProperty44Error() {
  }

  public ActionProperty44Error code(String code) {
  ...
  **/
  ...
  public ActionProperty44Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty44Error instance itself
   */
  public ActionProperty44Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty44Error actionProperty44Error = (ActionProperty44Error) o;
    return Objects.equals(this.code, actionProperty44Error.code) &&
        Objects.equals(this.message, actionProperty44Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty44Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty44Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty44Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty44Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty44Error is not found in the empty JSON string", ActionProperty44Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty44Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty44Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty44Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty44Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty44Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty44Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty44Error value) throws IOException {
           ...
           @Override
           public ActionProperty44Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty44Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty44Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty44Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty44Error
  */
  public static ActionProperty44Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty44Error.class);
  }

 /**
  * Convert an instance of ActionProperty44Error to an JSON string
  *
  * @return JSON string
  */
