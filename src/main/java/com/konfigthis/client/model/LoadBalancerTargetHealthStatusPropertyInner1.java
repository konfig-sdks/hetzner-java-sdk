...
public class LoadBalancerTargetHealthStatusPropertyInner1 {
 ...
 public enum StatusEnum {
  ...
  public LoadBalancerTargetHealthStatusPropertyInner1() {
  }

  public LoadBalancerTargetHealthStatusPropertyInner1 listenPort(Integer listenPort) {
  ...
  **/
  ...
  public LoadBalancerTargetHealthStatusPropertyInner1 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetHealthStatusPropertyInner1 instance itself
   */
  public LoadBalancerTargetHealthStatusPropertyInner1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetHealthStatusPropertyInner1 loadBalancerTargetHealthStatusPropertyInner1 = (LoadBalancerTargetHealthStatusPropertyInner1) o;
    return Objects.equals(this.listenPort, loadBalancerTargetHealthStatusPropertyInner1.listenPort) &&
        Objects.equals(this.status, loadBalancerTargetHealthStatusPropertyInner1.status)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetHealthStatusPropertyInner1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetHealthStatusPropertyInner1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetHealthStatusPropertyInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetHealthStatusPropertyInner1 is not found in the empty JSON string", LoadBalancerTargetHealthStatusPropertyInner1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetHealthStatusPropertyInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetHealthStatusPropertyInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetHealthStatusPropertyInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner1>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetHealthStatusPropertyInner1 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetHealthStatusPropertyInner1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetHealthStatusPropertyInner1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetHealthStatusPropertyInner1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetHealthStatusPropertyInner1
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner1
  */
  public static LoadBalancerTargetHealthStatusPropertyInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetHealthStatusPropertyInner1.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetHealthStatusPropertyInner1 to an JSON string
  *
  * @return JSON string
  */
