...
import com.konfigthis.client.model.SshKeysUpdateKeyResponseSshKey;
...
public class SshKeysUpdateKeyResponse {
  public static final String SERIALIZED_NAME_SSH_KEY = "ssh_key";
  @SerializedName(SERIALIZED_NAME_SSH_KEY)
  private SshKeysUpdateKeyResponseSshKey sshKey;

  public SshKeysUpdateKeyResponse() {
  }

  public SshKeysUpdateKeyResponse sshKey(SshKeysUpdateKeyResponseSshKey sshKey) {
  ...
  **/
  ...
  public SshKeysUpdateKeyResponseSshKey getSshKey() {
    return sshKey;
  }


  public void setSshKey(SshKeysUpdateKeyResponseSshKey sshKey) {
   ...
   * @return the SshKeysUpdateKeyResponse instance itself
   */
  public SshKeysUpdateKeyResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysUpdateKeyResponse sshKeysUpdateKeyResponse = (SshKeysUpdateKeyResponse) o;
    return Objects.equals(this.sshKey, sshKeysUpdateKeyResponse.sshKey)&&
        Objects.equals(this.additionalProperties, sshKeysUpdateKeyResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysUpdateKeyResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysUpdateKeyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysUpdateKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysUpdateKeyResponse is not found in the empty JSON string", SshKeysUpdateKeyResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysUpdateKeyResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `ssh_key`
      SshKeysUpdateKeyResponseSshKey.validateJsonObject(jsonObj.getAsJsonObject("ssh_key"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysUpdateKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysUpdateKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysUpdateKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysUpdateKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysUpdateKeyResponse>() {
           @Override
           public void write(JsonWriter out, SshKeysUpdateKeyResponse value) throws IOException {
           ...
           @Override
           public SshKeysUpdateKeyResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysUpdateKeyResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysUpdateKeyResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysUpdateKeyResponse
  * @throws IOException if the JSON string is invalid with respect to SshKeysUpdateKeyResponse
  */
  public static SshKeysUpdateKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysUpdateKeyResponse.class);
  }

 /**
  * Convert an instance of SshKeysUpdateKeyResponse to an JSON string
  *
  * @return JSON string
  */
