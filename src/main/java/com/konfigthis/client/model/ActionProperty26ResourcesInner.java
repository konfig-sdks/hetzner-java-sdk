...
/**
 * ActionProperty26ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty26ResourcesInner {
  ...
  public ActionProperty26ResourcesInner() {
  }

  public ActionProperty26ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty26ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty26ResourcesInner instance itself
   */
  public ActionProperty26ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty26ResourcesInner actionProperty26ResourcesInner = (ActionProperty26ResourcesInner) o;
    return Objects.equals(this.id, actionProperty26ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty26ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty26ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty26ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty26ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty26ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty26ResourcesInner is not found in the empty JSON string", ActionProperty26ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty26ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty26ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty26ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty26ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty26ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty26ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty26ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty26ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty26ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty26ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty26ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty26ResourcesInner
  */
  public static ActionProperty26ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty26ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty26ResourcesInner to an JSON string
  *
  * @return JSON string
  */
