...
import com.konfigthis.client.model.ActionProperty36Error;
import com.konfigthis.client.model.ActionProperty36ResourcesInner;
...
public class ActionProperty36 {
  ...
  private ActionProperty36Error error;
  ...
  private List<ActionProperty36ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty36() {
  }

  public ActionProperty36 command(String command) {
  ...
  **/
  ...
  public ActionProperty36 error(ActionProperty36Error error) {
  ...
  **/
  ...
  public ActionProperty36Error getError() {
    return error;
  }


  public void setError(ActionProperty36Error error) {
  ...
  public ActionProperty36 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty36 id(Long id) {
  ...
  **/
  ...
  public ActionProperty36 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty36 resources(List<ActionProperty36ResourcesInner> resources) {
  ...
  public ActionProperty36 addResourcesItem(ActionProperty36ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty36ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty36ResourcesInner> resources) {
  ...
  public ActionProperty36 started(String started) {
  ...
  **/
  ...
  public ActionProperty36 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty36 instance itself
   */
  public ActionProperty36 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty36 actionProperty36 = (ActionProperty36) o;
    return Objects.equals(this.command, actionProperty36.command) &&
        Objects.equals(this.error, actionProperty36.error) &&
        Objects.equals(this.finished, actionProperty36.finished) &&
        Objects.equals(this.id, actionProperty36.id) &&
        Objects.equals(this.progress, actionProperty36.progress) &&
        Objects.equals(this.resources, actionProperty36.resources) &&
        Objects.equals(this.started, actionProperty36.started) &&
        Objects.equals(this.status, actionProperty36.status)&&
        Objects.equals(this.additionalProperties, actionProperty36.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty36 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty36
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty36.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty36 is not found in the empty JSON string", ActionProperty36.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty36.openapiRequiredFields) {
      ...
      ActionProperty36Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty36ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty36.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty36' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty36> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty36.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty36>() {
           @Override
           public void write(JsonWriter out, ActionProperty36 value) throws IOException {
           ...
           @Override
           public ActionProperty36 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty36 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty36 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty36
  * @throws IOException if the JSON string is invalid with respect to ActionProperty36
  */
  public static ActionProperty36 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty36.class);
  }

 /**
  * Convert an instance of ActionProperty36 to an JSON string
  *
  * @return JSON string
  */
