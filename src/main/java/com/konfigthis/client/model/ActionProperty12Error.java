...
public class ActionProperty12Error {
  ...
  public ActionProperty12Error() {
  }

  public ActionProperty12Error code(String code) {
  ...
  **/
  ...
  public ActionProperty12Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty12Error instance itself
   */
  public ActionProperty12Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty12Error actionProperty12Error = (ActionProperty12Error) o;
    return Objects.equals(this.code, actionProperty12Error.code) &&
        Objects.equals(this.message, actionProperty12Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty12Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty12Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty12Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty12Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty12Error is not found in the empty JSON string", ActionProperty12Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty12Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty12Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty12Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty12Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty12Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty12Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty12Error value) throws IOException {
           ...
           @Override
           public ActionProperty12Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty12Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty12Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty12Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty12Error
  */
  public static ActionProperty12Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty12Error.class);
  }

 /**
  * Convert an instance of ActionProperty12Error to an JSON string
  *
  * @return JSON string
  */
