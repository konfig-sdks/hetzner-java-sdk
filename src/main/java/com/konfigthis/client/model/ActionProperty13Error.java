...
public class ActionProperty13Error {
  ...
  public ActionProperty13Error() {
  }

  public ActionProperty13Error code(String code) {
  ...
  **/
  ...
  public ActionProperty13Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty13Error instance itself
   */
  public ActionProperty13Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty13Error actionProperty13Error = (ActionProperty13Error) o;
    return Objects.equals(this.code, actionProperty13Error.code) &&
        Objects.equals(this.message, actionProperty13Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty13Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty13Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty13Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty13Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty13Error is not found in the empty JSON string", ActionProperty13Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty13Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty13Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty13Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty13Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty13Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty13Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty13Error value) throws IOException {
           ...
           @Override
           public ActionProperty13Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty13Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty13Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty13Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty13Error
  */
  public static ActionProperty13Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty13Error.class);
  }

 /**
  * Convert an instance of ActionProperty13Error to an JSON string
  *
  * @return JSON string
  */
