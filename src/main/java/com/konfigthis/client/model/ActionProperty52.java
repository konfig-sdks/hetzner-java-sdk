...
import com.konfigthis.client.model.ActionProperty52Error;
import com.konfigthis.client.model.ActionProperty52ResourcesInner;
...
public class ActionProperty52 {
  ...
  private ActionProperty52Error error;
  ...
  private List<ActionProperty52ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty52() {
  }

  public ActionProperty52 command(String command) {
  ...
  **/
  ...
  public ActionProperty52 error(ActionProperty52Error error) {
  ...
  **/
  ...
  public ActionProperty52Error getError() {
    return error;
  }


  public void setError(ActionProperty52Error error) {
  ...
  public ActionProperty52 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty52 id(Long id) {
  ...
  **/
  ...
  public ActionProperty52 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty52 resources(List<ActionProperty52ResourcesInner> resources) {
  ...
  public ActionProperty52 addResourcesItem(ActionProperty52ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty52ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty52ResourcesInner> resources) {
  ...
  public ActionProperty52 started(String started) {
  ...
  **/
  ...
  public ActionProperty52 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty52 instance itself
   */
  public ActionProperty52 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty52 actionProperty52 = (ActionProperty52) o;
    return Objects.equals(this.command, actionProperty52.command) &&
        Objects.equals(this.error, actionProperty52.error) &&
        Objects.equals(this.finished, actionProperty52.finished) &&
        Objects.equals(this.id, actionProperty52.id) &&
        Objects.equals(this.progress, actionProperty52.progress) &&
        Objects.equals(this.resources, actionProperty52.resources) &&
        Objects.equals(this.started, actionProperty52.started) &&
        Objects.equals(this.status, actionProperty52.status)&&
        Objects.equals(this.additionalProperties, actionProperty52.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty52 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty52
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty52.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty52 is not found in the empty JSON string", ActionProperty52.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty52.openapiRequiredFields) {
      ...
      ActionProperty52Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty52ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty52.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty52' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty52> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty52.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty52>() {
           @Override
           public void write(JsonWriter out, ActionProperty52 value) throws IOException {
           ...
           @Override
           public ActionProperty52 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty52 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty52 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty52
  * @throws IOException if the JSON string is invalid with respect to ActionProperty52
  */
  public static ActionProperty52 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty52.class);
  }

 /**
  * Convert an instance of ActionProperty52 to an JSON string
  *
  * @return JSON string
  */
