...
import com.konfigthis.client.model.ActionProperty5;
...
public class FirewallActionsGetActionByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty5 action;

  public FirewallActionsGetActionByIdResponse() {
  }

  public FirewallActionsGetActionByIdResponse action(ActionProperty5 action) {
  ...
  **/
  ...
  public ActionProperty5 getAction() {
    return action;
  }


  public void setAction(ActionProperty5 action) {
   ...
   * @return the FirewallActionsGetActionByIdResponse instance itself
   */
  public FirewallActionsGetActionByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallActionsGetActionByIdResponse firewallActionsGetActionByIdResponse = (FirewallActionsGetActionByIdResponse) o;
    return Objects.equals(this.action, firewallActionsGetActionByIdResponse.action)&&
        Objects.equals(this.additionalProperties, firewallActionsGetActionByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallActionsGetActionByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallActionsGetActionByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallActionsGetActionByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallActionsGetActionByIdResponse is not found in the empty JSON string", FirewallActionsGetActionByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallActionsGetActionByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty5.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallActionsGetActionByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallActionsGetActionByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallActionsGetActionByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallActionsGetActionByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallActionsGetActionByIdResponse>() {
           @Override
           public void write(JsonWriter out, FirewallActionsGetActionByIdResponse value) throws IOException {
           ...
           @Override
           public FirewallActionsGetActionByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallActionsGetActionByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallActionsGetActionByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallActionsGetActionByIdResponse
  * @throws IOException if the JSON string is invalid with respect to FirewallActionsGetActionByIdResponse
  */
  public static FirewallActionsGetActionByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallActionsGetActionByIdResponse.class);
  }

 /**
  * Convert an instance of FirewallActionsGetActionByIdResponse to an JSON string
  *
  * @return JSON string
  */
