...
/**
 * ActionProperty41ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty41ResourcesInner {
  ...
  public ActionProperty41ResourcesInner() {
  }

  public ActionProperty41ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty41ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty41ResourcesInner instance itself
   */
  public ActionProperty41ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty41ResourcesInner actionProperty41ResourcesInner = (ActionProperty41ResourcesInner) o;
    return Objects.equals(this.id, actionProperty41ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty41ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty41ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty41ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty41ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty41ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty41ResourcesInner is not found in the empty JSON string", ActionProperty41ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty41ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty41ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty41ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty41ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty41ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty41ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty41ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty41ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty41ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty41ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty41ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty41ResourcesInner
  */
  public static ActionProperty41ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty41ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty41ResourcesInner to an JSON string
  *
  * @return JSON string
  */
