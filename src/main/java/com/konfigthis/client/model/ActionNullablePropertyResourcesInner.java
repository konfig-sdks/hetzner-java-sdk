...
/**
 * ActionNullablePropertyResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionNullablePropertyResourcesInner {
  ...
  public ActionNullablePropertyResourcesInner() {
  }

  public ActionNullablePropertyResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionNullablePropertyResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionNullablePropertyResourcesInner instance itself
   */
  public ActionNullablePropertyResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullablePropertyResourcesInner actionNullablePropertyResourcesInner = (ActionNullablePropertyResourcesInner) o;
    return Objects.equals(this.id, actionNullablePropertyResourcesInner.id) &&
        Objects.equals(this.type, actionNullablePropertyResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionNullablePropertyResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullablePropertyResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullablePropertyResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullablePropertyResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullablePropertyResourcesInner is not found in the empty JSON string", ActionNullablePropertyResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullablePropertyResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullablePropertyResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullablePropertyResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullablePropertyResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullablePropertyResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullablePropertyResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionNullablePropertyResourcesInner value) throws IOException {
           ...
           @Override
           public ActionNullablePropertyResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullablePropertyResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullablePropertyResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullablePropertyResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionNullablePropertyResourcesInner
  */
  public static ActionNullablePropertyResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullablePropertyResourcesInner.class);
  }

 /**
  * Convert an instance of ActionNullablePropertyResourcesInner to an JSON string
  *
  * @return JSON string
  */
