 ...
 */
@ApiModel(description = "#### Call specific error codes  | Code                          | Description                                                   | |------------------------------ |-------------------------------------------------------------- | | `floating_ip_assigned`        | The floating IP is already assigned                           | ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FloatingIpActionsAssignToServerRequest {
  public static final String SERIALIZED_NAME_SERVER = "server";
  @SerializedName(SERIALIZED_NAME_SERVER)
  private Long server;

  public FloatingIpActionsAssignToServerRequest() {
  }

  public FloatingIpActionsAssignToServerRequest server(Long server) {
  ...
  **/
  ...
  @ApiModelProperty(example = "42", required = true, value = "ID of the Server the Floating IP shall be assigned to")
   ...
   * @return the FloatingIpActionsAssignToServerRequest instance itself
   */
  public FloatingIpActionsAssignToServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpActionsAssignToServerRequest floatingIpActionsAssignToServerRequest = (FloatingIpActionsAssignToServerRequest) o;
    return Objects.equals(this.server, floatingIpActionsAssignToServerRequest.server)&&
        Objects.equals(this.additionalProperties, floatingIpActionsAssignToServerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(server, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FloatingIpActionsAssignToServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionsAssignToServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionsAssignToServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionsAssignToServerRequest is not found in the empty JSON string", FloatingIpActionsAssignToServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionsAssignToServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionsAssignToServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionsAssignToServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionsAssignToServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionsAssignToServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionsAssignToServerRequest>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionsAssignToServerRequest value) throws IOException {
           ...
           @Override
           public FloatingIpActionsAssignToServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionsAssignToServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionsAssignToServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionsAssignToServerRequest
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionsAssignToServerRequest
  */
  public static FloatingIpActionsAssignToServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionsAssignToServerRequest.class);
  }

 /**
  * Convert an instance of FloatingIpActionsAssignToServerRequest to an JSON string
  *
  * @return JSON string
  */
