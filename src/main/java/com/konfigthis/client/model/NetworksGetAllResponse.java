...
import com.konfigthis.client.model.ListMetaProperty23;
import com.konfigthis.client.model.NetworksGetAllResponseNetworksInner;
...
public class NetworksGetAllResponse {
  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty23 meta;

  public static final String SERIALIZED_NAME_NETWORKS = "networks";
  @SerializedName(SERIALIZED_NAME_NETWORKS)
  private List<NetworksGetAllResponseNetworksInner> networks = new ArrayList<>();

  public NetworksGetAllResponse() {
  }

  public NetworksGetAllResponse meta(ListMetaProperty23 meta) {
  ...
  **/
  ...
  public ListMetaProperty23 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty23 meta) {
  ...
  public NetworksGetAllResponse networks(List<NetworksGetAllResponseNetworksInner> networks) {
  ...
  public NetworksGetAllResponse addNetworksItem(NetworksGetAllResponseNetworksInner networksItem) {
  ...
  **/
  ...
  public List<NetworksGetAllResponseNetworksInner> getNetworks() {
    return networks;
  }


  public void setNetworks(List<NetworksGetAllResponseNetworksInner> networks) {
   ...
   * @return the NetworksGetAllResponse instance itself
   */
  public NetworksGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksGetAllResponse networksGetAllResponse = (NetworksGetAllResponse) o;
    return Objects.equals(this.meta, networksGetAllResponse.meta) &&
        Objects.equals(this.networks, networksGetAllResponse.networks)&&
        Objects.equals(this.additionalProperties, networksGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, networks, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NetworksGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksGetAllResponse is not found in the empty JSON string", NetworksGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksGetAllResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty23.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
      ...
      for (int i = 0; i < jsonArraynetworks.size(); i++) {
        NetworksGetAllResponseNetworksInner.validateJsonObject(jsonArraynetworks.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksGetAllResponse>() {
           @Override
           public void write(JsonWriter out, NetworksGetAllResponse value) throws IOException {
           ...
           @Override
           public NetworksGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to NetworksGetAllResponse
  */
  public static NetworksGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksGetAllResponse.class);
  }

 /**
  * Convert an instance of NetworksGetAllResponse to an JSON string
  *
  * @return JSON string
  */
