...
public class NetworkActionsDeleteRouteRequest {
  ...
  public NetworkActionsDeleteRouteRequest() {
  }

  public NetworkActionsDeleteRouteRequest destination(String destination) {
  ...
  **/
  ...
  public NetworkActionsDeleteRouteRequest gateway(String gateway) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "10.0.1.1", required = true, value = "Gateway for the route. Cannot be the first IP of the networks ip_range, an IP behind a vSwitch or 172.31.1.1, as this IP is being used as a gateway for the public network interface of Servers.")
   ...
   * @return the NetworkActionsDeleteRouteRequest instance itself
   */
  public NetworkActionsDeleteRouteRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsDeleteRouteRequest networkActionsDeleteRouteRequest = (NetworkActionsDeleteRouteRequest) o;
    return Objects.equals(this.destination, networkActionsDeleteRouteRequest.destination) &&
        Objects.equals(this.gateway, networkActionsDeleteRouteRequest.gateway)&&
        Objects.equals(this.additionalProperties, networkActionsDeleteRouteRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsDeleteRouteRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsDeleteRouteRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsDeleteRouteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsDeleteRouteRequest is not found in the empty JSON string", NetworkActionsDeleteRouteRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsDeleteRouteRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsDeleteRouteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsDeleteRouteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsDeleteRouteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsDeleteRouteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsDeleteRouteRequest>() {
           @Override
           public void write(JsonWriter out, NetworkActionsDeleteRouteRequest value) throws IOException {
           ...
           @Override
           public NetworkActionsDeleteRouteRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsDeleteRouteRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsDeleteRouteRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsDeleteRouteRequest
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsDeleteRouteRequest
  */
  public static NetworkActionsDeleteRouteRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsDeleteRouteRequest.class);
  }

 /**
  * Convert an instance of NetworkActionsDeleteRouteRequest to an JSON string
  *
  * @return JSON string
  */
