...
import com.konfigthis.client.model.ActionProperty77Error;
import com.konfigthis.client.model.ActionProperty77ResourcesInner;
...
public class ActionProperty77 {
  ...
  private ActionProperty77Error error;
  ...
  private List<ActionProperty77ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty77() {
  }

  public ActionProperty77 command(String command) {
  ...
  **/
  ...
  public ActionProperty77 error(ActionProperty77Error error) {
  ...
  **/
  ...
  public ActionProperty77Error getError() {
    return error;
  }


  public void setError(ActionProperty77Error error) {
  ...
  public ActionProperty77 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty77 id(Long id) {
  ...
  **/
  ...
  public ActionProperty77 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty77 resources(List<ActionProperty77ResourcesInner> resources) {
  ...
  public ActionProperty77 addResourcesItem(ActionProperty77ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty77ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty77ResourcesInner> resources) {
  ...
  public ActionProperty77 started(String started) {
  ...
  **/
  ...
  public ActionProperty77 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty77 instance itself
   */
  public ActionProperty77 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty77 actionProperty77 = (ActionProperty77) o;
    return Objects.equals(this.command, actionProperty77.command) &&
        Objects.equals(this.error, actionProperty77.error) &&
        Objects.equals(this.finished, actionProperty77.finished) &&
        Objects.equals(this.id, actionProperty77.id) &&
        Objects.equals(this.progress, actionProperty77.progress) &&
        Objects.equals(this.resources, actionProperty77.resources) &&
        Objects.equals(this.started, actionProperty77.started) &&
        Objects.equals(this.status, actionProperty77.status)&&
        Objects.equals(this.additionalProperties, actionProperty77.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty77 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty77
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty77.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty77 is not found in the empty JSON string", ActionProperty77.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty77.openapiRequiredFields) {
      ...
      ActionProperty77Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty77ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty77.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty77' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty77> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty77.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty77>() {
           @Override
           public void write(JsonWriter out, ActionProperty77 value) throws IOException {
           ...
           @Override
           public ActionProperty77 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty77 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty77 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty77
  * @throws IOException if the JSON string is invalid with respect to ActionProperty77
  */
  public static ActionProperty77 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty77.class);
  }

 /**
  * Convert an instance of ActionProperty77 to an JSON string
  *
  * @return JSON string
  */
