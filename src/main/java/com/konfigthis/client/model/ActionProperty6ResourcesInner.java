...
/**
 * ActionProperty6ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty6ResourcesInner {
  ...
  public ActionProperty6ResourcesInner() {
  }

  public ActionProperty6ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty6ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty6ResourcesInner instance itself
   */
  public ActionProperty6ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty6ResourcesInner actionProperty6ResourcesInner = (ActionProperty6ResourcesInner) o;
    return Objects.equals(this.id, actionProperty6ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty6ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty6ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty6ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty6ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty6ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty6ResourcesInner is not found in the empty JSON string", ActionProperty6ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty6ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty6ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty6ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty6ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty6ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty6ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty6ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty6ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty6ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty6ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty6ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty6ResourcesInner
  */
  public static ActionProperty6ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty6ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty6ResourcesInner to an JSON string
  *
  * @return JSON string
  */
