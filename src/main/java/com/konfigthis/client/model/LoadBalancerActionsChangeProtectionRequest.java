...
public class LoadBalancerActionsChangeProtectionRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public LoadBalancerActionsChangeProtectionRequest() {
  }

  public LoadBalancerActionsChangeProtectionRequest delete(Boolean delete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "If true, prevents the Load Balancer from being deleted")
   ...
   * @return the LoadBalancerActionsChangeProtectionRequest instance itself
   */
  public LoadBalancerActionsChangeProtectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsChangeProtectionRequest loadBalancerActionsChangeProtectionRequest = (LoadBalancerActionsChangeProtectionRequest) o;
    return Objects.equals(this.delete, loadBalancerActionsChangeProtectionRequest.delete)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsChangeProtectionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsChangeProtectionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsChangeProtectionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsChangeProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsChangeProtectionRequest is not found in the empty JSON string", LoadBalancerActionsChangeProtectionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsChangeProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsChangeProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsChangeProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsChangeProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsChangeProtectionRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsChangeProtectionRequest value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsChangeProtectionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsChangeProtectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsChangeProtectionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsChangeProtectionRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsChangeProtectionRequest
  */
  public static LoadBalancerActionsChangeProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsChangeProtectionRequest.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsChangeProtectionRequest to an JSON string
  *
  * @return JSON string
  */
