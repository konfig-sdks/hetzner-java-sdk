...
import com.konfigthis.client.model.ActionProperty39Error;
import com.konfigthis.client.model.ActionProperty39ResourcesInner;
...
public class ActionProperty39 {
  ...
  private ActionProperty39Error error;
  ...
  private List<ActionProperty39ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty39() {
  }

  public ActionProperty39 command(String command) {
  ...
  **/
  ...
  public ActionProperty39 error(ActionProperty39Error error) {
  ...
  **/
  ...
  public ActionProperty39Error getError() {
    return error;
  }


  public void setError(ActionProperty39Error error) {
  ...
  public ActionProperty39 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty39 id(Long id) {
  ...
  **/
  ...
  public ActionProperty39 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty39 resources(List<ActionProperty39ResourcesInner> resources) {
  ...
  public ActionProperty39 addResourcesItem(ActionProperty39ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty39ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty39ResourcesInner> resources) {
  ...
  public ActionProperty39 started(String started) {
  ...
  **/
  ...
  public ActionProperty39 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty39 instance itself
   */
  public ActionProperty39 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty39 actionProperty39 = (ActionProperty39) o;
    return Objects.equals(this.command, actionProperty39.command) &&
        Objects.equals(this.error, actionProperty39.error) &&
        Objects.equals(this.finished, actionProperty39.finished) &&
        Objects.equals(this.id, actionProperty39.id) &&
        Objects.equals(this.progress, actionProperty39.progress) &&
        Objects.equals(this.resources, actionProperty39.resources) &&
        Objects.equals(this.started, actionProperty39.started) &&
        Objects.equals(this.status, actionProperty39.status)&&
        Objects.equals(this.additionalProperties, actionProperty39.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty39 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty39
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty39.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty39 is not found in the empty JSON string", ActionProperty39.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty39.openapiRequiredFields) {
      ...
      ActionProperty39Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty39ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty39.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty39' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty39> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty39.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty39>() {
           @Override
           public void write(JsonWriter out, ActionProperty39 value) throws IOException {
           ...
           @Override
           public ActionProperty39 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty39 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty39 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty39
  * @throws IOException if the JSON string is invalid with respect to ActionProperty39
  */
  public static ActionProperty39 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty39.class);
  }

 /**
  * Convert an instance of ActionProperty39 to an JSON string
  *
  * @return JSON string
  */
