 ...
 */
@ApiModel(description = "Label selector used to determine targets. Only present for target type \"label_selector\".")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LoadBalancerTargetLabelSelectorProperty3 {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public LoadBalancerTargetLabelSelectorProperty3() {
  }

  public LoadBalancerTargetLabelSelectorProperty3 selector(String selector) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetLabelSelectorProperty3 instance itself
   */
  public LoadBalancerTargetLabelSelectorProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetLabelSelectorProperty3 loadBalancerTargetLabelSelectorProperty3 = (LoadBalancerTargetLabelSelectorProperty3) o;
    return Objects.equals(this.selector, loadBalancerTargetLabelSelectorProperty3.selector)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetLabelSelectorProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetLabelSelectorProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetLabelSelectorProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetLabelSelectorProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetLabelSelectorProperty3 is not found in the empty JSON string", LoadBalancerTargetLabelSelectorProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetLabelSelectorProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetLabelSelectorProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetLabelSelectorProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetLabelSelectorProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetLabelSelectorProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetLabelSelectorProperty3>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetLabelSelectorProperty3 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetLabelSelectorProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetLabelSelectorProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetLabelSelectorProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetLabelSelectorProperty3
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetLabelSelectorProperty3
  */
  public static LoadBalancerTargetLabelSelectorProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetLabelSelectorProperty3.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetLabelSelectorProperty3 to an JSON string
  *
  * @return JSON string
  */
