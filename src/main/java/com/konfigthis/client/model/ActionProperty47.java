...
import com.konfigthis.client.model.ActionProperty47Error;
import com.konfigthis.client.model.ActionProperty47ResourcesInner;
...
public class ActionProperty47 {
  ...
  private ActionProperty47Error error;
  ...
  private List<ActionProperty47ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty47() {
  }

  public ActionProperty47 command(String command) {
  ...
  **/
  ...
  public ActionProperty47 error(ActionProperty47Error error) {
  ...
  **/
  ...
  public ActionProperty47Error getError() {
    return error;
  }


  public void setError(ActionProperty47Error error) {
  ...
  public ActionProperty47 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty47 id(Long id) {
  ...
  **/
  ...
  public ActionProperty47 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty47 resources(List<ActionProperty47ResourcesInner> resources) {
  ...
  public ActionProperty47 addResourcesItem(ActionProperty47ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty47ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty47ResourcesInner> resources) {
  ...
  public ActionProperty47 started(String started) {
  ...
  **/
  ...
  public ActionProperty47 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty47 instance itself
   */
  public ActionProperty47 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty47 actionProperty47 = (ActionProperty47) o;
    return Objects.equals(this.command, actionProperty47.command) &&
        Objects.equals(this.error, actionProperty47.error) &&
        Objects.equals(this.finished, actionProperty47.finished) &&
        Objects.equals(this.id, actionProperty47.id) &&
        Objects.equals(this.progress, actionProperty47.progress) &&
        Objects.equals(this.resources, actionProperty47.resources) &&
        Objects.equals(this.started, actionProperty47.started) &&
        Objects.equals(this.status, actionProperty47.status)&&
        Objects.equals(this.additionalProperties, actionProperty47.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty47 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty47
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty47.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty47 is not found in the empty JSON string", ActionProperty47.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty47.openapiRequiredFields) {
      ...
      ActionProperty47Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty47ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty47.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty47' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty47> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty47.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty47>() {
           @Override
           public void write(JsonWriter out, ActionProperty47 value) throws IOException {
           ...
           @Override
           public ActionProperty47 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty47 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty47 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty47
  * @throws IOException if the JSON string is invalid with respect to ActionProperty47
  */
  public static ActionProperty47 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty47.class);
  }

 /**
  * Convert an instance of ActionProperty47 to an JSON string
  *
  * @return JSON string
  */
