...
public class LoadBalancerTargetIPProperty2 {
  public static final String SERIALIZED_NAME_IP = "ip";
  @SerializedName(SERIALIZED_NAME_IP)
  private String ip;

  public LoadBalancerTargetIPProperty2() {
  }

  public LoadBalancerTargetIPProperty2 ip(String ip) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetIPProperty2 instance itself
   */
  public LoadBalancerTargetIPProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetIPProperty2 loadBalancerTargetIPProperty2 = (LoadBalancerTargetIPProperty2) o;
    return Objects.equals(this.ip, loadBalancerTargetIPProperty2.ip)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetIPProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetIPProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetIPProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetIPProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetIPProperty2 is not found in the empty JSON string", LoadBalancerTargetIPProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetIPProperty2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetIPProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetIPProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetIPProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetIPProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetIPProperty2>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetIPProperty2 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetIPProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetIPProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetIPProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetIPProperty2
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetIPProperty2
  */
  public static LoadBalancerTargetIPProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetIPProperty2.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetIPProperty2 to an JSON string
  *
  * @return JSON string
  */
