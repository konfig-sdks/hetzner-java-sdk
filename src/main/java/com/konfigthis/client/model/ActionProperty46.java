...
import com.konfigthis.client.model.ActionProperty46Error;
import com.konfigthis.client.model.ActionProperty46ResourcesInner;
...
public class ActionProperty46 {
  ...
  private ActionProperty46Error error;
  ...
  private List<ActionProperty46ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty46() {
  }

  public ActionProperty46 command(String command) {
  ...
  **/
  ...
  public ActionProperty46 error(ActionProperty46Error error) {
  ...
  **/
  ...
  public ActionProperty46Error getError() {
    return error;
  }


  public void setError(ActionProperty46Error error) {
  ...
  public ActionProperty46 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty46 id(Long id) {
  ...
  **/
  ...
  public ActionProperty46 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty46 resources(List<ActionProperty46ResourcesInner> resources) {
  ...
  public ActionProperty46 addResourcesItem(ActionProperty46ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty46ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty46ResourcesInner> resources) {
  ...
  public ActionProperty46 started(String started) {
  ...
  **/
  ...
  public ActionProperty46 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty46 instance itself
   */
  public ActionProperty46 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty46 actionProperty46 = (ActionProperty46) o;
    return Objects.equals(this.command, actionProperty46.command) &&
        Objects.equals(this.error, actionProperty46.error) &&
        Objects.equals(this.finished, actionProperty46.finished) &&
        Objects.equals(this.id, actionProperty46.id) &&
        Objects.equals(this.progress, actionProperty46.progress) &&
        Objects.equals(this.resources, actionProperty46.resources) &&
        Objects.equals(this.started, actionProperty46.started) &&
        Objects.equals(this.status, actionProperty46.status)&&
        Objects.equals(this.additionalProperties, actionProperty46.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty46 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty46
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty46.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty46 is not found in the empty JSON string", ActionProperty46.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty46.openapiRequiredFields) {
      ...
      ActionProperty46Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty46ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty46.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty46' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty46> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty46.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty46>() {
           @Override
           public void write(JsonWriter out, ActionProperty46 value) throws IOException {
           ...
           @Override
           public ActionProperty46 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty46 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty46 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty46
  * @throws IOException if the JSON string is invalid with respect to ActionProperty46
  */
  public static ActionProperty46 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty46.class);
  }

 /**
  * Convert an instance of ActionProperty46 to an JSON string
  *
  * @return JSON string
  */
