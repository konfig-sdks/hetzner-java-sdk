...
public class CertificateProperty1StatusError {
  ...
  public CertificateProperty1StatusError() {
  }

  public CertificateProperty1StatusError code(String code) {
  ...
  **/
  ...
  public CertificateProperty1StatusError message(String message) {
  ...
  **/
   ...
   * @return the CertificateProperty1StatusError instance itself
   */
  public CertificateProperty1StatusError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateProperty1StatusError certificateProperty1StatusError = (CertificateProperty1StatusError) o;
    return Objects.equals(this.code, certificateProperty1StatusError.code) &&
        Objects.equals(this.message, certificateProperty1StatusError.message)&&
        Objects.equals(this.additionalProperties, certificateProperty1StatusError.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateProperty1StatusError {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateProperty1StatusError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateProperty1StatusError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateProperty1StatusError is not found in the empty JSON string", CertificateProperty1StatusError.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateProperty1StatusError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateProperty1StatusError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateProperty1StatusError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateProperty1StatusError.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateProperty1StatusError>() {
           @Override
           public void write(JsonWriter out, CertificateProperty1StatusError value) throws IOException {
           ...
           @Override
           public CertificateProperty1StatusError read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateProperty1StatusError instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateProperty1StatusError given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateProperty1StatusError
  * @throws IOException if the JSON string is invalid with respect to CertificateProperty1StatusError
  */
  public static CertificateProperty1StatusError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateProperty1StatusError.class);
  }

 /**
  * Convert an instance of CertificateProperty1StatusError to an JSON string
  *
  * @return JSON string
  */
