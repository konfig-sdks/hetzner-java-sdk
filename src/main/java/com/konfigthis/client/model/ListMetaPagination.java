...
public class ListMetaPagination {
  ...
  public ListMetaPagination() {
  }

  public ListMetaPagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaPagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaPagination page(Long page) {
  ...
  **/
  ...
  public ListMetaPagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaPagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaPagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaPagination instance itself
   */
  public ListMetaPagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaPagination listMetaPagination = (ListMetaPagination) o;
    return Objects.equals(this.lastPage, listMetaPagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaPagination.nextPage) &&
        Objects.equals(this.page, listMetaPagination.page) &&
        Objects.equals(this.perPage, listMetaPagination.perPage) &&
        Objects.equals(this.previousPage, listMetaPagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaPagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaPagination.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaPagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaPagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaPagination is not found in the empty JSON string", ListMetaPagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaPagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaPagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaPagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaPagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaPagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaPagination>() {
           @Override
           public void write(JsonWriter out, ListMetaPagination value) throws IOException {
           ...
           @Override
           public ListMetaPagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaPagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaPagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaPagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaPagination
  */
  public static ListMetaPagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaPagination.class);
  }

 /**
  * Convert an instance of ListMetaPagination to an JSON string
  *
  * @return JSON string
  */
