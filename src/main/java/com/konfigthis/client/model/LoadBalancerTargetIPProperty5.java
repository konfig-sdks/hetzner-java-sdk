...
public class LoadBalancerTargetIPProperty5 {
  public static final String SERIALIZED_NAME_IP = "ip";
  @SerializedName(SERIALIZED_NAME_IP)
  private String ip;

  public LoadBalancerTargetIPProperty5() {
  }

  public LoadBalancerTargetIPProperty5 ip(String ip) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetIPProperty5 instance itself
   */
  public LoadBalancerTargetIPProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetIPProperty5 loadBalancerTargetIPProperty5 = (LoadBalancerTargetIPProperty5) o;
    return Objects.equals(this.ip, loadBalancerTargetIPProperty5.ip)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetIPProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetIPProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetIPProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetIPProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetIPProperty5 is not found in the empty JSON string", LoadBalancerTargetIPProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetIPProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetIPProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetIPProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetIPProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetIPProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetIPProperty5>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetIPProperty5 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetIPProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetIPProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetIPProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetIPProperty5
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetIPProperty5
  */
  public static LoadBalancerTargetIPProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetIPProperty5.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetIPProperty5 to an JSON string
  *
  * @return JSON string
  */
