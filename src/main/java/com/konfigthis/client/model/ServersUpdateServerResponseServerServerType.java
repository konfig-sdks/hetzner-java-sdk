...
import com.konfigthis.client.model.DeprecationInfoProperty11;
import com.konfigthis.client.model.ServersUpdateServerResponseServerServerTypePricesInner;
...
public class ServersUpdateServerResponseServerServerType {
 ...
 public enum CpuTypeEnum {
  ...
  private DeprecationInfoProperty11 deprecation;
  ...
  private List<ServersUpdateServerResponseServerServerTypePricesInner> prices = new ArrayList<>();
 ...
 public enum StorageTypeEnum {
  ...
  public ServersUpdateServerResponseServerServerType() {
  }

  public ServersUpdateServerResponseServerServerType description(String description) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType cores(Double cores) {
  ...
  public ServersUpdateServerResponseServerServerType cores(Integer cores) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType cpuType(CpuTypeEnum cpuType) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType deprecated(Boolean deprecated) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType deprecation(DeprecationInfoProperty11 deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty11 getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty11 deprecation) {
  ...
  public ServersUpdateServerResponseServerServerType disk(Double disk) {
  ...
  public ServersUpdateServerResponseServerServerType disk(Integer disk) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType id(Long id) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType includedTraffic(Long includedTraffic) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType memory(Double memory) {
  ...
  public ServersUpdateServerResponseServerServerType memory(Integer memory) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType name(String name) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServerServerType prices(List<ServersUpdateServerResponseServerServerTypePricesInner> prices) {
  ...
  public ServersUpdateServerResponseServerServerType addPricesItem(ServersUpdateServerResponseServerServerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<ServersUpdateServerResponseServerServerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<ServersUpdateServerResponseServerServerTypePricesInner> prices) {
  ...
  public ServersUpdateServerResponseServerServerType storageType(StorageTypeEnum storageType) {
  ...
  **/
   ...
   * @return the ServersUpdateServerResponseServerServerType instance itself
   */
  public ServersUpdateServerResponseServerServerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersUpdateServerResponseServerServerType serversUpdateServerResponseServerServerType = (ServersUpdateServerResponseServerServerType) o;
    return Objects.equals(this.description, serversUpdateServerResponseServerServerType.description) &&
        Objects.equals(this.architecture, serversUpdateServerResponseServerServerType.architecture) &&
        Objects.equals(this.cores, serversUpdateServerResponseServerServerType.cores) &&
        Objects.equals(this.cpuType, serversUpdateServerResponseServerServerType.cpuType) &&
        Objects.equals(this.deprecated, serversUpdateServerResponseServerServerType.deprecated) &&
        Objects.equals(this.deprecation, serversUpdateServerResponseServerServerType.deprecation) &&
        Objects.equals(this.disk, serversUpdateServerResponseServerServerType.disk) &&
        Objects.equals(this.id, serversUpdateServerResponseServerServerType.id) &&
        Objects.equals(this.includedTraffic, serversUpdateServerResponseServerServerType.includedTraffic) &&
        Objects.equals(this.memory, serversUpdateServerResponseServerServerType.memory) &&
        Objects.equals(this.name, serversUpdateServerResponseServerServerType.name) &&
        Objects.equals(this.prices, serversUpdateServerResponseServerServerType.prices) &&
        Objects.equals(this.storageType, serversUpdateServerResponseServerServerType.storageType)&&
        Objects.equals(this.additionalProperties, serversUpdateServerResponseServerServerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersUpdateServerResponseServerServerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersUpdateServerResponseServerServerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersUpdateServerResponseServerServerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersUpdateServerResponseServerServerType is not found in the empty JSON string", ServersUpdateServerResponseServerServerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersUpdateServerResponseServerServerType.openapiRequiredFields) {
      ...
      if (jsonObj.get("deprecation") != null && !jsonObj.get("deprecation").isJsonNull()) {
        DeprecationInfoProperty11.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
      }
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        ServersUpdateServerResponseServerServerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersUpdateServerResponseServerServerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersUpdateServerResponseServerServerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersUpdateServerResponseServerServerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersUpdateServerResponseServerServerType.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersUpdateServerResponseServerServerType>() {
           @Override
           public void write(JsonWriter out, ServersUpdateServerResponseServerServerType value) throws IOException {
           ...
           @Override
           public ServersUpdateServerResponseServerServerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersUpdateServerResponseServerServerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersUpdateServerResponseServerServerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersUpdateServerResponseServerServerType
  * @throws IOException if the JSON string is invalid with respect to ServersUpdateServerResponseServerServerType
  */
  public static ServersUpdateServerResponseServerServerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersUpdateServerResponseServerServerType.class);
  }

 /**
  * Convert an instance of ServersUpdateServerResponseServerServerType to an JSON string
  *
  * @return JSON string
  */
