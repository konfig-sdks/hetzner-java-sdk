...
public class Action23ResourcesInner {
  ...
  public Action23ResourcesInner() {
  }

  public Action23ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action23ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action23ResourcesInner instance itself
   */
  public Action23ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action23ResourcesInner action23ResourcesInner = (Action23ResourcesInner) o;
    return Objects.equals(this.id, action23ResourcesInner.id) &&
        Objects.equals(this.type, action23ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action23ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action23ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action23ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action23ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action23ResourcesInner is not found in the empty JSON string", Action23ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action23ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action23ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action23ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action23ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action23ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action23ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action23ResourcesInner value) throws IOException {
           ...
           @Override
           public Action23ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action23ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action23ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action23ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action23ResourcesInner
  */
  public static Action23ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action23ResourcesInner.class);
  }

 /**
  * Convert an instance of Action23ResourcesInner to an JSON string
  *
  * @return JSON string
  */
