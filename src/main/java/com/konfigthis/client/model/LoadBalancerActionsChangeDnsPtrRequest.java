...
public class LoadBalancerActionsChangeDnsPtrRequest {
  ...
  public LoadBalancerActionsChangeDnsPtrRequest() {
  }

  public LoadBalancerActionsChangeDnsPtrRequest dnsPtr(String dnsPtr) {
  ...
  **/
  ...
  @ApiModelProperty(example = "lb1.example.com", required = true, value = "Hostname to set as a reverse DNS PTR entry")
  ...
  public LoadBalancerActionsChangeDnsPtrRequest ip(String ip) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1.2.3.4", required = true, value = "Public IP address for which the reverse DNS entry should be set")
   ...
   * @return the LoadBalancerActionsChangeDnsPtrRequest instance itself
   */
  public LoadBalancerActionsChangeDnsPtrRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsChangeDnsPtrRequest loadBalancerActionsChangeDnsPtrRequest = (LoadBalancerActionsChangeDnsPtrRequest) o;
    return Objects.equals(this.dnsPtr, loadBalancerActionsChangeDnsPtrRequest.dnsPtr) &&
        Objects.equals(this.ip, loadBalancerActionsChangeDnsPtrRequest.ip)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsChangeDnsPtrRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsChangeDnsPtrRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsChangeDnsPtrRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsChangeDnsPtrRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsChangeDnsPtrRequest is not found in the empty JSON string", LoadBalancerActionsChangeDnsPtrRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsChangeDnsPtrRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("dns_ptr").isJsonNull() && !jsonObj.get("dns_ptr").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsChangeDnsPtrRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsChangeDnsPtrRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsChangeDnsPtrRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsChangeDnsPtrRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsChangeDnsPtrRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsChangeDnsPtrRequest value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsChangeDnsPtrRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsChangeDnsPtrRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsChangeDnsPtrRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsChangeDnsPtrRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsChangeDnsPtrRequest
  */
  public static LoadBalancerActionsChangeDnsPtrRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsChangeDnsPtrRequest.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsChangeDnsPtrRequest to an JSON string
  *
  * @return JSON string
  */
