...
public class NetworksCreateNetworkRequest {
  ...
  private List<NetworksCreateNetworkRequestRoutesInner> routes = null;

  public static final String SERIALIZED_NAME_SUBNETS = "subnets";
  @SerializedName(SERIALIZED_NAME_SUBNETS)
  private List<NetworksCreateNetworkRequestSubnetsInner> subnets = null;

  public NetworksCreateNetworkRequest() {
  }

  public NetworksCreateNetworkRequest exposeRoutesToVswitch(Boolean exposeRoutesToVswitch) {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", value = "Indicates if the routes from this network should be exposed to the vSwitch connection. The exposing only takes effect if a vSwitch connection is active.")
  ...
  public NetworksCreateNetworkRequest ipRange(String ipRange) {
  ...
  **/
  ...
  @ApiModelProperty(example = "10.0.0.0/16", required = true, value = "IP range of the whole network which must span all included subnets. Must be one of the private IPv4 ranges of RFC1918. Minimum network size is /24. We highly recommend that you pick a larger network with a /16 netmask.")
  ...
  public NetworksCreateNetworkRequest labels(NetworksCreateNetworkRequestLabels labels) {
  ...
  **/
  ...
  public NetworksCreateNetworkRequestLabels getLabels() {
    return labels;
  }


  public void setLabels(NetworksCreateNetworkRequestLabels labels) {
  ...
  public NetworksCreateNetworkRequest name(String name) {
  ...
  **/
  ...
  public NetworksCreateNetworkRequest routes(List<NetworksCreateNetworkRequestRoutesInner> routes) {
  ...
  public NetworksCreateNetworkRequest addRoutesItem(NetworksCreateNetworkRequestRoutesInner routesItem) {
    if (this.routes == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of routes set in this network. The destination of the route must be one of the private IPv4 ranges of RFC1918. The gateway must be a subnet/IP of the ip_range of the network object. The destination must not overlap with an existing ip_range in any subnets or with any destinations in other routes or with the first IP of the networks ip_range or with 172.31.1.1. The gateway cannot be the first IP of the networks ip_range and also cannot be 172.31.1.1.")

  public List<NetworksCreateNetworkRequestRoutesInner> getRoutes() {
    return routes;
  }


  public void setRoutes(List<NetworksCreateNetworkRequestRoutesInner> routes) {
  ...
  public NetworksCreateNetworkRequest subnets(List<NetworksCreateNetworkRequestSubnetsInner> subnets) {
  ...
  public NetworksCreateNetworkRequest addSubnetsItem(NetworksCreateNetworkRequestSubnetsInner subnetsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of subnets allocated.")

  public List<NetworksCreateNetworkRequestSubnetsInner> getSubnets() {
    return subnets;
  }


  public void setSubnets(List<NetworksCreateNetworkRequestSubnetsInner> subnets) {
   ...
   * @return the NetworksCreateNetworkRequest instance itself
   */
  public NetworksCreateNetworkRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksCreateNetworkRequest networksCreateNetworkRequest = (NetworksCreateNetworkRequest) o;
    return Objects.equals(this.exposeRoutesToVswitch, networksCreateNetworkRequest.exposeRoutesToVswitch) &&
        Objects.equals(this.ipRange, networksCreateNetworkRequest.ipRange) &&
        Objects.equals(this.labels, networksCreateNetworkRequest.labels) &&
        Objects.equals(this.name, networksCreateNetworkRequest.name) &&
        Objects.equals(this.routes, networksCreateNetworkRequest.routes) &&
        Objects.equals(this.subnets, networksCreateNetworkRequest.subnets)&&
        Objects.equals(this.additionalProperties, networksCreateNetworkRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exposeRoutesToVswitch, ipRange, labels, name, routes, subnets, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NetworksCreateNetworkRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksCreateNetworkRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksCreateNetworkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksCreateNetworkRequest is not found in the empty JSON string", NetworksCreateNetworkRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksCreateNetworkRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        NetworksCreateNetworkRequestLabels.validateJsonObject(jsonObj.getAsJsonObject("labels"));
      }
      ...
      if (jsonObj.get("routes") != null && !jsonObj.get("routes").isJsonNull()) {
        ...
        if (jsonArrayroutes != null) {
          ...
          for (int i = 0; i < jsonArrayroutes.size(); i++) {
            NetworksCreateNetworkRequestRoutesInner.validateJsonObject(jsonArrayroutes.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("subnets") != null && !jsonObj.get("subnets").isJsonNull()) {
        ...
        if (jsonArraysubnets != null) {
          ...
          for (int i = 0; i < jsonArraysubnets.size(); i++) {
            NetworksCreateNetworkRequestSubnetsInner.validateJsonObject(jsonArraysubnets.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksCreateNetworkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksCreateNetworkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksCreateNetworkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksCreateNetworkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksCreateNetworkRequest>() {
           @Override
           public void write(JsonWriter out, NetworksCreateNetworkRequest value) throws IOException {
           ...
           @Override
           public NetworksCreateNetworkRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksCreateNetworkRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksCreateNetworkRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksCreateNetworkRequest
  * @throws IOException if the JSON string is invalid with respect to NetworksCreateNetworkRequest
  */
  public static NetworksCreateNetworkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksCreateNetworkRequest.class);
  }

 /**
  * Convert an instance of NetworksCreateNetworkRequest to an JSON string
  *
  * @return JSON string
  */
