...
public class ServerPublicNetFirewall2 {
 ...
 public enum StatusEnum {
  ...
  public ServerPublicNetFirewall2() {
  }

  public ServerPublicNetFirewall2 id(Long id) {
  ...
  **/
  ...
  public ServerPublicNetFirewall2 status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "APPLIED", value = "Status of the Firewall on the Server")
   ...
   * @return the ServerPublicNetFirewall2 instance itself
   */
  public ServerPublicNetFirewall2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerPublicNetFirewall2 serverPublicNetFirewall2 = (ServerPublicNetFirewall2) o;
    return Objects.equals(this.id, serverPublicNetFirewall2.id) &&
        Objects.equals(this.status, serverPublicNetFirewall2.status)&&
        Objects.equals(this.additionalProperties, serverPublicNetFirewall2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerPublicNetFirewall2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerPublicNetFirewall2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerPublicNetFirewall2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerPublicNetFirewall2 is not found in the empty JSON string", ServerPublicNetFirewall2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerPublicNetFirewall2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerPublicNetFirewall2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerPublicNetFirewall2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerPublicNetFirewall2.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerPublicNetFirewall2>() {
           @Override
           public void write(JsonWriter out, ServerPublicNetFirewall2 value) throws IOException {
           ...
           @Override
           public ServerPublicNetFirewall2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerPublicNetFirewall2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerPublicNetFirewall2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerPublicNetFirewall2
  * @throws IOException if the JSON string is invalid with respect to ServerPublicNetFirewall2
  */
  public static ServerPublicNetFirewall2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerPublicNetFirewall2.class);
  }

 /**
  * Convert an instance of ServerPublicNetFirewall2 to an JSON string
  *
  * @return JSON string
  */
