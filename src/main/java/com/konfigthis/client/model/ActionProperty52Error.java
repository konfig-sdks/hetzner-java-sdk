...
public class ActionProperty52Error {
  ...
  public ActionProperty52Error() {
  }

  public ActionProperty52Error code(String code) {
  ...
  **/
  ...
  public ActionProperty52Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty52Error instance itself
   */
  public ActionProperty52Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty52Error actionProperty52Error = (ActionProperty52Error) o;
    return Objects.equals(this.code, actionProperty52Error.code) &&
        Objects.equals(this.message, actionProperty52Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty52Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty52Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty52Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty52Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty52Error is not found in the empty JSON string", ActionProperty52Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty52Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty52Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty52Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty52Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty52Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty52Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty52Error value) throws IOException {
           ...
           @Override
           public ActionProperty52Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty52Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty52Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty52Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty52Error
  */
  public static ActionProperty52Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty52Error.class);
  }

 /**
  * Convert an instance of ActionProperty52Error to an JSON string
  *
  * @return JSON string
  */
