...
public class ActionProperty77Error {
  ...
  public ActionProperty77Error() {
  }

  public ActionProperty77Error code(String code) {
  ...
  **/
  ...
  public ActionProperty77Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty77Error instance itself
   */
  public ActionProperty77Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty77Error actionProperty77Error = (ActionProperty77Error) o;
    return Objects.equals(this.code, actionProperty77Error.code) &&
        Objects.equals(this.message, actionProperty77Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty77Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty77Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty77Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty77Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty77Error is not found in the empty JSON string", ActionProperty77Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty77Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty77Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty77Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty77Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty77Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty77Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty77Error value) throws IOException {
           ...
           @Override
           public ActionProperty77Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty77Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty77Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty77Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty77Error
  */
  public static ActionProperty77Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty77Error.class);
  }

 /**
  * Convert an instance of ActionProperty77Error to an JSON string
  *
  * @return JSON string
  */
