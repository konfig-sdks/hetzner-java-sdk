...
import com.konfigthis.client.model.ActionProperty38;
...
public class NetworkActionsDeleteRouteResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty38 action;

  public NetworkActionsDeleteRouteResponse() {
  }

  public NetworkActionsDeleteRouteResponse action(ActionProperty38 action) {
  ...
  **/
  ...
  public ActionProperty38 getAction() {
    return action;
  }


  public void setAction(ActionProperty38 action) {
   ...
   * @return the NetworkActionsDeleteRouteResponse instance itself
   */
  public NetworkActionsDeleteRouteResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsDeleteRouteResponse networkActionsDeleteRouteResponse = (NetworkActionsDeleteRouteResponse) o;
    return Objects.equals(this.action, networkActionsDeleteRouteResponse.action)&&
        Objects.equals(this.additionalProperties, networkActionsDeleteRouteResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsDeleteRouteResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsDeleteRouteResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsDeleteRouteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsDeleteRouteResponse is not found in the empty JSON string", NetworkActionsDeleteRouteResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsDeleteRouteResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty38.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsDeleteRouteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsDeleteRouteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsDeleteRouteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsDeleteRouteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsDeleteRouteResponse>() {
           @Override
           public void write(JsonWriter out, NetworkActionsDeleteRouteResponse value) throws IOException {
           ...
           @Override
           public NetworkActionsDeleteRouteResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsDeleteRouteResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsDeleteRouteResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsDeleteRouteResponse
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsDeleteRouteResponse
  */
  public static NetworkActionsDeleteRouteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsDeleteRouteResponse.class);
  }

 /**
  * Convert an instance of NetworkActionsDeleteRouteResponse to an JSON string
  *
  * @return JSON string
  */
