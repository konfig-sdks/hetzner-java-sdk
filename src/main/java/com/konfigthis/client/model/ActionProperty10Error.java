...
public class ActionProperty10Error {
  ...
  public ActionProperty10Error() {
  }

  public ActionProperty10Error code(String code) {
  ...
  **/
  ...
  public ActionProperty10Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty10Error instance itself
   */
  public ActionProperty10Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty10Error actionProperty10Error = (ActionProperty10Error) o;
    return Objects.equals(this.code, actionProperty10Error.code) &&
        Objects.equals(this.message, actionProperty10Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty10Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty10Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty10Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty10Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty10Error is not found in the empty JSON string", ActionProperty10Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty10Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty10Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty10Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty10Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty10Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty10Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty10Error value) throws IOException {
           ...
           @Override
           public ActionProperty10Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty10Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty10Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty10Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty10Error
  */
  public static ActionProperty10Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty10Error.class);
  }

 /**
  * Convert an instance of ActionProperty10Error to an JSON string
  *
  * @return JSON string
  */
