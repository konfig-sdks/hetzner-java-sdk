...
import com.konfigthis.client.model.ActionProperty4Error;
import com.konfigthis.client.model.ActionProperty4ResourcesInner;
...
public class ActionProperty4 {
  ...
  private ActionProperty4Error error;
  ...
  private List<ActionProperty4ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty4() {
  }

  public ActionProperty4 command(String command) {
  ...
  **/
  ...
  public ActionProperty4 error(ActionProperty4Error error) {
  ...
  **/
  ...
  public ActionProperty4Error getError() {
    return error;
  }


  public void setError(ActionProperty4Error error) {
  ...
  public ActionProperty4 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty4 id(Long id) {
  ...
  **/
  ...
  public ActionProperty4 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty4 resources(List<ActionProperty4ResourcesInner> resources) {
  ...
  public ActionProperty4 addResourcesItem(ActionProperty4ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty4ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty4ResourcesInner> resources) {
  ...
  public ActionProperty4 started(String started) {
  ...
  **/
  ...
  public ActionProperty4 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty4 instance itself
   */
  public ActionProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty4 actionProperty4 = (ActionProperty4) o;
    return Objects.equals(this.command, actionProperty4.command) &&
        Objects.equals(this.error, actionProperty4.error) &&
        Objects.equals(this.finished, actionProperty4.finished) &&
        Objects.equals(this.id, actionProperty4.id) &&
        Objects.equals(this.progress, actionProperty4.progress) &&
        Objects.equals(this.resources, actionProperty4.resources) &&
        Objects.equals(this.started, actionProperty4.started) &&
        Objects.equals(this.status, actionProperty4.status)&&
        Objects.equals(this.additionalProperties, actionProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty4 is not found in the empty JSON string", ActionProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty4.openapiRequiredFields) {
      ...
      ActionProperty4Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty4ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty4>() {
           @Override
           public void write(JsonWriter out, ActionProperty4 value) throws IOException {
           ...
           @Override
           public ActionProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty4
  * @throws IOException if the JSON string is invalid with respect to ActionProperty4
  */
  public static ActionProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty4.class);
  }

 /**
  * Convert an instance of ActionProperty4 to an JSON string
  *
  * @return JSON string
  */
