...
import com.konfigthis.client.model.ListMetaProperty28Pagination;
...
public class ListMetaProperty28 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty28Pagination pagination;

  public ListMetaProperty28() {
  }

  public ListMetaProperty28 pagination(ListMetaProperty28Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty28Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty28Pagination pagination) {
   ...
   * @return the ListMetaProperty28 instance itself
   */
  public ListMetaProperty28 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty28 listMetaProperty28 = (ListMetaProperty28) o;
    return Objects.equals(this.pagination, listMetaProperty28.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty28.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty28 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty28
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty28.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty28 is not found in the empty JSON string", ListMetaProperty28.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty28.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty28Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty28.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty28' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty28> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty28.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty28>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty28 value) throws IOException {
           ...
           @Override
           public ListMetaProperty28 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty28 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty28 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty28
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty28
  */
  public static ListMetaProperty28 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty28.class);
  }

 /**
  * Convert an instance of ListMetaProperty28 to an JSON string
  *
  * @return JSON string
  */
