...
import com.konfigthis.client.model.Action4Error;
import com.konfigthis.client.model.Action4ResourcesInner;
...
public class Action4 {
  ...
  private List<Action4ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action4 command(String command) {
  ...
  **/
  ...
  public Action4 error(Action4Error error) {
  ...
  **/
  ...
  public Action4Error getError() {
    return error;
  }


  public void setError(Action4Error error) {
  ...
  public Action4 finished(String finished) {
  ...
  **/
  ...
  public Action4 progress(Integer progress) {
  ...
  **/
  ...
  public Action4 resources(List<Action4ResourcesInner> resources) {
  ...
  public Action4 addResourcesItem(Action4ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action4ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action4ResourcesInner> resources) {
  ...
  public Action4 started(String started) {
  ...
  **/
  ...
  public Action4 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action4 instance itself
   */
  public Action4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.command, action4.command) &&
        Objects.equals(this.error, action4.error) &&
        Objects.equals(this.finished, action4.finished) &&
        Objects.equals(this.id, action4.id) &&
        Objects.equals(this.progress, action4.progress) &&
        Objects.equals(this.resources, action4.resources) &&
        Objects.equals(this.started, action4.started) &&
        Objects.equals(this.status, action4.status)&&
        Objects.equals(this.additionalProperties, action4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action4 is not found in the empty JSON string", Action4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action4.openapiRequiredFields) {
      ...
      Action4Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action4ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action4.class));

       return (TypeAdapter<T>) new TypeAdapter<Action4>() {
           @Override
           public void write(JsonWriter out, Action4 value) throws IOException {
           ...
           @Override
           public Action4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action4
  * @throws IOException if the JSON string is invalid with respect to Action4
  */
  public static Action4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action4.class);
  }

 /**
  * Convert an instance of Action4 to an JSON string
  *
  * @return JSON string
  */
