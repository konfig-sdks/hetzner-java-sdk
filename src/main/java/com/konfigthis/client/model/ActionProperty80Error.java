...
public class ActionProperty80Error {
  ...
  public ActionProperty80Error() {
  }

  public ActionProperty80Error code(String code) {
  ...
  **/
  ...
  public ActionProperty80Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty80Error instance itself
   */
  public ActionProperty80Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty80Error actionProperty80Error = (ActionProperty80Error) o;
    return Objects.equals(this.code, actionProperty80Error.code) &&
        Objects.equals(this.message, actionProperty80Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty80Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty80Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty80Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty80Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty80Error is not found in the empty JSON string", ActionProperty80Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty80Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty80Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty80Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty80Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty80Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty80Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty80Error value) throws IOException {
           ...
           @Override
           public ActionProperty80Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty80Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty80Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty80Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty80Error
  */
  public static ActionProperty80Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty80Error.class);
  }

 /**
  * Convert an instance of ActionProperty80Error to an JSON string
  *
  * @return JSON string
  */
