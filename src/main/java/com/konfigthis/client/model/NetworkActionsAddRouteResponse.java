...
import com.konfigthis.client.model.ActionProperty34;
...
public class NetworkActionsAddRouteResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty34 action;

  public NetworkActionsAddRouteResponse() {
  }

  public NetworkActionsAddRouteResponse action(ActionProperty34 action) {
  ...
  **/
  ...
  public ActionProperty34 getAction() {
    return action;
  }


  public void setAction(ActionProperty34 action) {
   ...
   * @return the NetworkActionsAddRouteResponse instance itself
   */
  public NetworkActionsAddRouteResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsAddRouteResponse networkActionsAddRouteResponse = (NetworkActionsAddRouteResponse) o;
    return Objects.equals(this.action, networkActionsAddRouteResponse.action)&&
        Objects.equals(this.additionalProperties, networkActionsAddRouteResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsAddRouteResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsAddRouteResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsAddRouteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsAddRouteResponse is not found in the empty JSON string", NetworkActionsAddRouteResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsAddRouteResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty34.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsAddRouteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsAddRouteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsAddRouteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsAddRouteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsAddRouteResponse>() {
           @Override
           public void write(JsonWriter out, NetworkActionsAddRouteResponse value) throws IOException {
           ...
           @Override
           public NetworkActionsAddRouteResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsAddRouteResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsAddRouteResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsAddRouteResponse
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsAddRouteResponse
  */
  public static NetworkActionsAddRouteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsAddRouteResponse.class);
  }

 /**
  * Convert an instance of NetworkActionsAddRouteResponse to an JSON string
  *
  * @return JSON string
  */
