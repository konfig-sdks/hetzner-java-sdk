...
public class LoadBalancerServiceHTTPProperty {
  ...
  public LoadBalancerServiceHTTPProperty() {
  }

  public LoadBalancerServiceHTTPProperty certificates(List<Long> certificates) {
  ...
  public LoadBalancerServiceHTTPProperty addCertificatesItem(Long certificatesItem) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty cookieLifetime(Integer cookieLifetime) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty cookieName(String cookieName) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty redirectHttp(Boolean redirectHttp) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty stickySessions(Boolean stickySessions) {
  ...
  **/
   ...
   * @return the LoadBalancerServiceHTTPProperty instance itself
   */
  public LoadBalancerServiceHTTPProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerServiceHTTPProperty loadBalancerServiceHTTPProperty = (LoadBalancerServiceHTTPProperty) o;
    return Objects.equals(this.certificates, loadBalancerServiceHTTPProperty.certificates) &&
        Objects.equals(this.cookieLifetime, loadBalancerServiceHTTPProperty.cookieLifetime) &&
        Objects.equals(this.cookieName, loadBalancerServiceHTTPProperty.cookieName) &&
        Objects.equals(this.redirectHttp, loadBalancerServiceHTTPProperty.redirectHttp) &&
        Objects.equals(this.stickySessions, loadBalancerServiceHTTPProperty.stickySessions)&&
        Objects.equals(this.additionalProperties, loadBalancerServiceHTTPProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerServiceHTTPProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerServiceHTTPProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerServiceHTTPProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerServiceHTTPProperty is not found in the empty JSON string", LoadBalancerServiceHTTPProperty.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerServiceHTTPProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerServiceHTTPProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerServiceHTTPProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerServiceHTTPProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerServiceHTTPProperty>() {
           @Override
           public void write(JsonWriter out, LoadBalancerServiceHTTPProperty value) throws IOException {
           ...
           @Override
           public LoadBalancerServiceHTTPProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerServiceHTTPProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerServiceHTTPProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerServiceHTTPProperty
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerServiceHTTPProperty
  */
  public static LoadBalancerServiceHTTPProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerServiceHTTPProperty.class);
  }

 /**
  * Convert an instance of LoadBalancerServiceHTTPProperty to an JSON string
  *
  * @return JSON string
  */
