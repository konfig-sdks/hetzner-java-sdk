...
import com.konfigthis.client.model.PricingGetAllPricesResponsePricing;
...
public class PricingGetAllPricesResponse {
  public static final String SERIALIZED_NAME_PRICING = "pricing";
  @SerializedName(SERIALIZED_NAME_PRICING)
  private PricingGetAllPricesResponsePricing pricing;

  public PricingGetAllPricesResponse() {
  }

  public PricingGetAllPricesResponse pricing(PricingGetAllPricesResponsePricing pricing) {
  ...
  **/
  ...
  public PricingGetAllPricesResponsePricing getPricing() {
    return pricing;
  }


  public void setPricing(PricingGetAllPricesResponsePricing pricing) {
   ...
   * @return the PricingGetAllPricesResponse instance itself
   */
  public PricingGetAllPricesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PricingGetAllPricesResponse pricingGetAllPricesResponse = (PricingGetAllPricesResponse) o;
    return Objects.equals(this.pricing, pricingGetAllPricesResponse.pricing)&&
        Objects.equals(this.additionalProperties, pricingGetAllPricesResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingGetAllPricesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PricingGetAllPricesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PricingGetAllPricesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingGetAllPricesResponse is not found in the empty JSON string", PricingGetAllPricesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingGetAllPricesResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pricing`
      PricingGetAllPricesResponsePricing.validateJsonObject(jsonObj.getAsJsonObject("pricing"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingGetAllPricesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingGetAllPricesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingGetAllPricesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingGetAllPricesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingGetAllPricesResponse>() {
           @Override
           public void write(JsonWriter out, PricingGetAllPricesResponse value) throws IOException {
           ...
           @Override
           public PricingGetAllPricesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PricingGetAllPricesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PricingGetAllPricesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PricingGetAllPricesResponse
  * @throws IOException if the JSON string is invalid with respect to PricingGetAllPricesResponse
  */
  public static PricingGetAllPricesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingGetAllPricesResponse.class);
  }

 /**
  * Convert an instance of PricingGetAllPricesResponse to an JSON string
  *
  * @return JSON string
  */
