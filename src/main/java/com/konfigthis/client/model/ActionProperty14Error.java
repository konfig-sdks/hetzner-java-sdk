...
public class ActionProperty14Error {
  ...
  public ActionProperty14Error() {
  }

  public ActionProperty14Error code(String code) {
  ...
  **/
  ...
  public ActionProperty14Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty14Error instance itself
   */
  public ActionProperty14Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty14Error actionProperty14Error = (ActionProperty14Error) o;
    return Objects.equals(this.code, actionProperty14Error.code) &&
        Objects.equals(this.message, actionProperty14Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty14Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty14Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty14Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty14Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty14Error is not found in the empty JSON string", ActionProperty14Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty14Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty14Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty14Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty14Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty14Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty14Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty14Error value) throws IOException {
           ...
           @Override
           public ActionProperty14Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty14Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty14Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty14Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty14Error
  */
  public static ActionProperty14Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty14Error.class);
  }

 /**
  * Convert an instance of ActionProperty14Error to an JSON string
  *
  * @return JSON string
  */
