...
/**
 * Action21ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action21ResourcesInner {
  ...
  public Action21ResourcesInner() {
  }

  public Action21ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action21ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action21ResourcesInner instance itself
   */
  public Action21ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action21ResourcesInner action21ResourcesInner = (Action21ResourcesInner) o;
    return Objects.equals(this.id, action21ResourcesInner.id) &&
        Objects.equals(this.type, action21ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action21ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action21ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action21ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action21ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action21ResourcesInner is not found in the empty JSON string", Action21ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action21ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action21ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action21ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action21ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action21ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action21ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action21ResourcesInner value) throws IOException {
           ...
           @Override
           public Action21ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action21ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action21ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action21ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action21ResourcesInner
  */
  public static Action21ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action21ResourcesInner.class);
  }

 /**
  * Convert an instance of Action21ResourcesInner to an JSON string
  *
  * @return JSON string
  */
