...
public class LoadBalancerActionsDetachFromNetworkRequest {
  public static final String SERIALIZED_NAME_NETWORK = "network";
  @SerializedName(SERIALIZED_NAME_NETWORK)
  private Long network;

  public LoadBalancerActionsDetachFromNetworkRequest() {
  }

  public LoadBalancerActionsDetachFromNetworkRequest network(Long network) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4711", required = true, value = "ID of an existing network to detach the Load Balancer from")
   ...
   * @return the LoadBalancerActionsDetachFromNetworkRequest instance itself
   */
  public LoadBalancerActionsDetachFromNetworkRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsDetachFromNetworkRequest loadBalancerActionsDetachFromNetworkRequest = (LoadBalancerActionsDetachFromNetworkRequest) o;
    return Objects.equals(this.network, loadBalancerActionsDetachFromNetworkRequest.network)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsDetachFromNetworkRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(network, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancerActionsDetachFromNetworkRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsDetachFromNetworkRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsDetachFromNetworkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsDetachFromNetworkRequest is not found in the empty JSON string", LoadBalancerActionsDetachFromNetworkRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsDetachFromNetworkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsDetachFromNetworkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsDetachFromNetworkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsDetachFromNetworkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsDetachFromNetworkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsDetachFromNetworkRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsDetachFromNetworkRequest value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsDetachFromNetworkRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsDetachFromNetworkRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsDetachFromNetworkRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsDetachFromNetworkRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsDetachFromNetworkRequest
  */
  public static LoadBalancerActionsDetachFromNetworkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsDetachFromNetworkRequest.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsDetachFromNetworkRequest to an JSON string
  *
  * @return JSON string
  */
