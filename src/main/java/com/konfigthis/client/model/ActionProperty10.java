...
import com.konfigthis.client.model.ActionProperty10Error;
import com.konfigthis.client.model.ActionProperty10ResourcesInner;
...
public class ActionProperty10 {
  ...
  private ActionProperty10Error error;
  ...
  private List<ActionProperty10ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty10() {
  }

  public ActionProperty10 command(String command) {
  ...
  **/
  ...
  public ActionProperty10 error(ActionProperty10Error error) {
  ...
  **/
  ...
  public ActionProperty10Error getError() {
    return error;
  }


  public void setError(ActionProperty10Error error) {
  ...
  public ActionProperty10 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty10 id(Long id) {
  ...
  **/
  ...
  public ActionProperty10 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty10 resources(List<ActionProperty10ResourcesInner> resources) {
  ...
  public ActionProperty10 addResourcesItem(ActionProperty10ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty10ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty10ResourcesInner> resources) {
  ...
  public ActionProperty10 started(String started) {
  ...
  **/
  ...
  public ActionProperty10 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty10 instance itself
   */
  public ActionProperty10 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty10 actionProperty10 = (ActionProperty10) o;
    return Objects.equals(this.command, actionProperty10.command) &&
        Objects.equals(this.error, actionProperty10.error) &&
        Objects.equals(this.finished, actionProperty10.finished) &&
        Objects.equals(this.id, actionProperty10.id) &&
        Objects.equals(this.progress, actionProperty10.progress) &&
        Objects.equals(this.resources, actionProperty10.resources) &&
        Objects.equals(this.started, actionProperty10.started) &&
        Objects.equals(this.status, actionProperty10.status)&&
        Objects.equals(this.additionalProperties, actionProperty10.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty10 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty10
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty10.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty10 is not found in the empty JSON string", ActionProperty10.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty10.openapiRequiredFields) {
      ...
      ActionProperty10Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty10ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty10.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty10>() {
           @Override
           public void write(JsonWriter out, ActionProperty10 value) throws IOException {
           ...
           @Override
           public ActionProperty10 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty10 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty10 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty10
  * @throws IOException if the JSON string is invalid with respect to ActionProperty10
  */
  public static ActionProperty10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty10.class);
  }

 /**
  * Convert an instance of ActionProperty10 to an JSON string
  *
  * @return JSON string
  */
