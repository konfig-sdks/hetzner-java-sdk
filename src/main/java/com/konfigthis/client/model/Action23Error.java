...
public class Action23Error {
  ...
  public Action23Error() {
  }

  public Action23Error code(String code) {
  ...
  **/
  ...
  public Action23Error message(String message) {
  ...
  **/
   ...
   * @return the Action23Error instance itself
   */
  public Action23Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action23Error action23Error = (Action23Error) o;
    return Objects.equals(this.code, action23Error.code) &&
        Objects.equals(this.message, action23Error.message)&&
        Objects.equals(this.additionalProperties, action23Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action23Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action23Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action23Error is not found in the empty JSON string", Action23Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action23Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action23Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action23Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action23Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action23Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action23Error>() {
           @Override
           public void write(JsonWriter out, Action23Error value) throws IOException {
           ...
           @Override
           public Action23Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action23Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action23Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action23Error
  * @throws IOException if the JSON string is invalid with respect to Action23Error
  */
  public static Action23Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action23Error.class);
  }

 /**
  * Convert an instance of Action23Error to an JSON string
  *
  * @return JSON string
  */
