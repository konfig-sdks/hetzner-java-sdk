...
import com.konfigthis.client.model.ActionProperty27Error;
import com.konfigthis.client.model.ActionProperty27ResourcesInner;
...
public class ActionProperty27 {
  ...
  private ActionProperty27Error error;
  ...
  private List<ActionProperty27ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty27() {
  }

  public ActionProperty27 command(String command) {
  ...
  **/
  ...
  public ActionProperty27 error(ActionProperty27Error error) {
  ...
  **/
  ...
  public ActionProperty27Error getError() {
    return error;
  }


  public void setError(ActionProperty27Error error) {
  ...
  public ActionProperty27 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty27 id(Long id) {
  ...
  **/
  ...
  public ActionProperty27 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty27 resources(List<ActionProperty27ResourcesInner> resources) {
  ...
  public ActionProperty27 addResourcesItem(ActionProperty27ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty27ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty27ResourcesInner> resources) {
  ...
  public ActionProperty27 started(String started) {
  ...
  **/
  ...
  public ActionProperty27 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty27 instance itself
   */
  public ActionProperty27 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty27 actionProperty27 = (ActionProperty27) o;
    return Objects.equals(this.command, actionProperty27.command) &&
        Objects.equals(this.error, actionProperty27.error) &&
        Objects.equals(this.finished, actionProperty27.finished) &&
        Objects.equals(this.id, actionProperty27.id) &&
        Objects.equals(this.progress, actionProperty27.progress) &&
        Objects.equals(this.resources, actionProperty27.resources) &&
        Objects.equals(this.started, actionProperty27.started) &&
        Objects.equals(this.status, actionProperty27.status)&&
        Objects.equals(this.additionalProperties, actionProperty27.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty27 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty27
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty27.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty27 is not found in the empty JSON string", ActionProperty27.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty27.openapiRequiredFields) {
      ...
      ActionProperty27Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty27ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty27.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty27' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty27> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty27.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty27>() {
           @Override
           public void write(JsonWriter out, ActionProperty27 value) throws IOException {
           ...
           @Override
           public ActionProperty27 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty27 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty27 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty27
  * @throws IOException if the JSON string is invalid with respect to ActionProperty27
  */
  public static ActionProperty27 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty27.class);
  }

 /**
  * Convert an instance of ActionProperty27 to an JSON string
  *
  * @return JSON string
  */
