...
import com.konfigthis.client.model.DeprecationInfoProperty;
...
public class IsOsGetAllResponseIsosInner {
 ...
 public enum ArchitectureEnum {
  ...
  private DeprecationInfoProperty deprecation;
 ...
 public enum TypeEnum {
  ...
  public IsOsGetAllResponseIsosInner() {
  }

  public IsOsGetAllResponseIsosInner description(String description) {
  ...
  **/
  ...
  public IsOsGetAllResponseIsosInner architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public IsOsGetAllResponseIsosInner deprecation(DeprecationInfoProperty deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty deprecation) {
  ...
  public IsOsGetAllResponseIsosInner id(Long id) {
  ...
  **/
  ...
  public IsOsGetAllResponseIsosInner name(String name) {
  ...
  **/
  ...
  public IsOsGetAllResponseIsosInner type(TypeEnum type) {
  ...
  **/
   ...
   * @return the IsOsGetAllResponseIsosInner instance itself
   */
  public IsOsGetAllResponseIsosInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IsOsGetAllResponseIsosInner isOsGetAllResponseIsosInner = (IsOsGetAllResponseIsosInner) o;
    return Objects.equals(this.description, isOsGetAllResponseIsosInner.description) &&
        Objects.equals(this.architecture, isOsGetAllResponseIsosInner.architecture) &&
        Objects.equals(this.deprecation, isOsGetAllResponseIsosInner.deprecation) &&
        Objects.equals(this.id, isOsGetAllResponseIsosInner.id) &&
        Objects.equals(this.name, isOsGetAllResponseIsosInner.name) &&
        Objects.equals(this.type, isOsGetAllResponseIsosInner.type)&&
        Objects.equals(this.additionalProperties, isOsGetAllResponseIsosInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsOsGetAllResponseIsosInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IsOsGetAllResponseIsosInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IsOsGetAllResponseIsosInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsOsGetAllResponseIsosInner is not found in the empty JSON string", IsOsGetAllResponseIsosInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsOsGetAllResponseIsosInner.openapiRequiredFields) {
      ...
      DeprecationInfoProperty.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsOsGetAllResponseIsosInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsOsGetAllResponseIsosInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsOsGetAllResponseIsosInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsOsGetAllResponseIsosInner.class));

       return (TypeAdapter<T>) new TypeAdapter<IsOsGetAllResponseIsosInner>() {
           @Override
           public void write(JsonWriter out, IsOsGetAllResponseIsosInner value) throws IOException {
           ...
           @Override
           public IsOsGetAllResponseIsosInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IsOsGetAllResponseIsosInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IsOsGetAllResponseIsosInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IsOsGetAllResponseIsosInner
  * @throws IOException if the JSON string is invalid with respect to IsOsGetAllResponseIsosInner
  */
  public static IsOsGetAllResponseIsosInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsOsGetAllResponseIsosInner.class);
  }

 /**
  * Convert an instance of IsOsGetAllResponseIsosInner to an JSON string
  *
  * @return JSON string
  */
