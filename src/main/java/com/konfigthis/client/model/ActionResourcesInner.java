...
public class ActionResourcesInner {
  ...
  public ActionResourcesInner id(Long id) {
  ...
  **/
   ...
   * @return the ActionResourcesInner instance itself
   */
  public ActionResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, actionResourcesInner.id) &&
        ...
        Objects.equals(this.additionalProperties, actionResourcesInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ActionResourcesInner>() {
           ...
           public ActionResourcesInner read(JsonReader in) throws IOException {
             ...
             ActionResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
