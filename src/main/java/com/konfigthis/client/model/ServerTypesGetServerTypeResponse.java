...
import com.konfigthis.client.model.ServerTypesGetServerTypeResponseServerType;
...
public class ServerTypesGetServerTypeResponse {
  public static final String SERIALIZED_NAME_SERVER_TYPE = "server_type";
  @SerializedName(SERIALIZED_NAME_SERVER_TYPE)
  private ServerTypesGetServerTypeResponseServerType serverType;

  public ServerTypesGetServerTypeResponse() {
  }

  public ServerTypesGetServerTypeResponse serverType(ServerTypesGetServerTypeResponseServerType serverType) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType getServerType() {
    return serverType;
  }


  public void setServerType(ServerTypesGetServerTypeResponseServerType serverType) {
   ...
   * @return the ServerTypesGetServerTypeResponse instance itself
   */
  public ServerTypesGetServerTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerTypesGetServerTypeResponse serverTypesGetServerTypeResponse = (ServerTypesGetServerTypeResponse) o;
    return Objects.equals(this.serverType, serverTypesGetServerTypeResponse.serverType)&&
        Objects.equals(this.additionalProperties, serverTypesGetServerTypeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerTypesGetServerTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerTypesGetServerTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerTypesGetServerTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerTypesGetServerTypeResponse is not found in the empty JSON string", ServerTypesGetServerTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerTypesGetServerTypeResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `server_type`
      ServerTypesGetServerTypeResponseServerType.validateJsonObject(jsonObj.getAsJsonObject("server_type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerTypesGetServerTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerTypesGetServerTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerTypesGetServerTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerTypesGetServerTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerTypesGetServerTypeResponse>() {
           @Override
           public void write(JsonWriter out, ServerTypesGetServerTypeResponse value) throws IOException {
           ...
           @Override
           public ServerTypesGetServerTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerTypesGetServerTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerTypesGetServerTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerTypesGetServerTypeResponse
  * @throws IOException if the JSON string is invalid with respect to ServerTypesGetServerTypeResponse
  */
  public static ServerTypesGetServerTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerTypesGetServerTypeResponse.class);
  }

 /**
  * Convert an instance of ServerTypesGetServerTypeResponse to an JSON string
  *
  * @return JSON string
  */
