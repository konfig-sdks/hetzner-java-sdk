...
public class ServerActionsChangeServerTypeRequest {
  ...
  public ServerActionsChangeServerTypeRequest() {
  }

  public ServerActionsChangeServerTypeRequest serverType(String serverType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "cx11", required = true, value = "ID or name of Server type the Server should migrate to")
  ...
  public ServerActionsChangeServerTypeRequest upgradeDisk(Boolean upgradeDisk) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "If false, do not upgrade the disk (this allows downgrading the Server type later)")
   ...
   * @return the ServerActionsChangeServerTypeRequest instance itself
   */
  public ServerActionsChangeServerTypeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsChangeServerTypeRequest serverActionsChangeServerTypeRequest = (ServerActionsChangeServerTypeRequest) o;
    return Objects.equals(this.serverType, serverActionsChangeServerTypeRequest.serverType) &&
        Objects.equals(this.upgradeDisk, serverActionsChangeServerTypeRequest.upgradeDisk)&&
        Objects.equals(this.additionalProperties, serverActionsChangeServerTypeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverType, upgradeDisk, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerActionsChangeServerTypeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsChangeServerTypeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsChangeServerTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsChangeServerTypeRequest is not found in the empty JSON string", ServerActionsChangeServerTypeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsChangeServerTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsChangeServerTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsChangeServerTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsChangeServerTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsChangeServerTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsChangeServerTypeRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsChangeServerTypeRequest value) throws IOException {
           ...
           @Override
           public ServerActionsChangeServerTypeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsChangeServerTypeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsChangeServerTypeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsChangeServerTypeRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsChangeServerTypeRequest
  */
  public static ServerActionsChangeServerTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsChangeServerTypeRequest.class);
  }

 /**
  * Convert an instance of ServerActionsChangeServerTypeRequest to an JSON string
  *
  * @return JSON string
  */
