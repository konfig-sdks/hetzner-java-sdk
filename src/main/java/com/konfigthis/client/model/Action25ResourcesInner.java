...
/**
 * Action25ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action25ResourcesInner {
  ...
  public Action25ResourcesInner() {
  }

  public Action25ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action25ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action25ResourcesInner instance itself
   */
  public Action25ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action25ResourcesInner action25ResourcesInner = (Action25ResourcesInner) o;
    return Objects.equals(this.id, action25ResourcesInner.id) &&
        Objects.equals(this.type, action25ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action25ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action25ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action25ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action25ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action25ResourcesInner is not found in the empty JSON string", Action25ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action25ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action25ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action25ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action25ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action25ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action25ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action25ResourcesInner value) throws IOException {
           ...
           @Override
           public Action25ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action25ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action25ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action25ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action25ResourcesInner
  */
  public static Action25ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action25ResourcesInner.class);
  }

 /**
  * Convert an instance of Action25ResourcesInner to an JSON string
  *
  * @return JSON string
  */
