...
/**
 * ActionProperty32ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty32ResourcesInner {
  ...
  public ActionProperty32ResourcesInner() {
  }

  public ActionProperty32ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty32ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty32ResourcesInner instance itself
   */
  public ActionProperty32ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty32ResourcesInner actionProperty32ResourcesInner = (ActionProperty32ResourcesInner) o;
    return Objects.equals(this.id, actionProperty32ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty32ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty32ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty32ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty32ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty32ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty32ResourcesInner is not found in the empty JSON string", ActionProperty32ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty32ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty32ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty32ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty32ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty32ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty32ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty32ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty32ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty32ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty32ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty32ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty32ResourcesInner
  */
  public static ActionProperty32ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty32ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty32ResourcesInner to an JSON string
  *
  * @return JSON string
  */
