...
/**
 * Action2ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action2ResourcesInner {
  ...
  public Action2ResourcesInner() {
  }

  public Action2ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action2ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action2ResourcesInner instance itself
   */
  public Action2ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action2ResourcesInner action2ResourcesInner = (Action2ResourcesInner) o;
    return Objects.equals(this.id, action2ResourcesInner.id) &&
        Objects.equals(this.type, action2ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action2ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action2ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action2ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action2ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action2ResourcesInner is not found in the empty JSON string", Action2ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action2ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action2ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action2ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action2ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action2ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action2ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action2ResourcesInner value) throws IOException {
           ...
           @Override
           public Action2ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action2ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action2ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action2ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action2ResourcesInner
  */
  public static Action2ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action2ResourcesInner.class);
  }

 /**
  * Convert an instance of Action2ResourcesInner to an JSON string
  *
  * @return JSON string
  */
