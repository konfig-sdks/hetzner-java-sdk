...
public class Action7Error {
  ...
  public Action7Error code(String code) {
  ...
  **/
  ...
  public Action7Error message(String message) {
  ...
  **/
   ...
   * @return the Action7Error instance itself
   */
  public Action7Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action7Error action7Error = (Action7Error) o;
    return Objects.equals(this.code, action7Error.code) &&
        Objects.equals(this.message, action7Error.message)&&
        Objects.equals(this.additionalProperties, action7Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action7Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action7Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action7Error is not found in the empty JSON string", Action7Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action7Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action7Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action7Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action7Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action7Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action7Error>() {
           @Override
           public void write(JsonWriter out, Action7Error value) throws IOException {
           ...
           @Override
           public Action7Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action7Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action7Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action7Error
  * @throws IOException if the JSON string is invalid with respect to Action7Error
  */
  public static Action7Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action7Error.class);
  }

 /**
  * Convert an instance of Action7Error to an JSON string
  *
  * @return JSON string
  */
