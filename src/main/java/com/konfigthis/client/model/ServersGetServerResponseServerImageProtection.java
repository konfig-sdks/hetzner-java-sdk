...
public class ServersGetServerResponseServerImageProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ServersGetServerResponseServerImageProtection() {
  }

  public ServersGetServerResponseServerImageProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the ServersGetServerResponseServerImageProtection instance itself
   */
  public ServersGetServerResponseServerImageProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGetServerResponseServerImageProtection serversGetServerResponseServerImageProtection = (ServersGetServerResponseServerImageProtection) o;
    return Objects.equals(this.delete, serversGetServerResponseServerImageProtection.delete)&&
        Objects.equals(this.additionalProperties, serversGetServerResponseServerImageProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersGetServerResponseServerImageProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersGetServerResponseServerImageProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersGetServerResponseServerImageProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGetServerResponseServerImageProtection is not found in the empty JSON string", ServersGetServerResponseServerImageProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGetServerResponseServerImageProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGetServerResponseServerImageProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGetServerResponseServerImageProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGetServerResponseServerImageProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGetServerResponseServerImageProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGetServerResponseServerImageProtection>() {
           @Override
           public void write(JsonWriter out, ServersGetServerResponseServerImageProtection value) throws IOException {
           ...
           @Override
           public ServersGetServerResponseServerImageProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersGetServerResponseServerImageProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersGetServerResponseServerImageProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersGetServerResponseServerImageProtection
  * @throws IOException if the JSON string is invalid with respect to ServersGetServerResponseServerImageProtection
  */
  public static ServersGetServerResponseServerImageProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGetServerResponseServerImageProtection.class);
  }

 /**
  * Convert an instance of ServersGetServerResponseServerImageProtection to an JSON string
  *
  * @return JSON string
  */
