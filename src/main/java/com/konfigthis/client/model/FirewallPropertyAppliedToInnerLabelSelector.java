...
public class FirewallPropertyAppliedToInnerLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public FirewallPropertyAppliedToInnerLabelSelector() {
  }

  public FirewallPropertyAppliedToInnerLabelSelector selector(String selector) {
  ...
  **/
   ...
   * @return the FirewallPropertyAppliedToInnerLabelSelector instance itself
   */
  public FirewallPropertyAppliedToInnerLabelSelector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallPropertyAppliedToInnerLabelSelector firewallPropertyAppliedToInnerLabelSelector = (FirewallPropertyAppliedToInnerLabelSelector) o;
    return Objects.equals(this.selector, firewallPropertyAppliedToInnerLabelSelector.selector)&&
        Objects.equals(this.additionalProperties, firewallPropertyAppliedToInnerLabelSelector.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallPropertyAppliedToInnerLabelSelector {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallPropertyAppliedToInnerLabelSelector
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallPropertyAppliedToInnerLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallPropertyAppliedToInnerLabelSelector is not found in the empty JSON string", FirewallPropertyAppliedToInnerLabelSelector.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallPropertyAppliedToInnerLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallPropertyAppliedToInnerLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallPropertyAppliedToInnerLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallPropertyAppliedToInnerLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallPropertyAppliedToInnerLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallPropertyAppliedToInnerLabelSelector>() {
           @Override
           public void write(JsonWriter out, FirewallPropertyAppliedToInnerLabelSelector value) throws IOException {
           ...
           @Override
           public FirewallPropertyAppliedToInnerLabelSelector read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallPropertyAppliedToInnerLabelSelector instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallPropertyAppliedToInnerLabelSelector given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallPropertyAppliedToInnerLabelSelector
  * @throws IOException if the JSON string is invalid with respect to FirewallPropertyAppliedToInnerLabelSelector
  */
  public static FirewallPropertyAppliedToInnerLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallPropertyAppliedToInnerLabelSelector.class);
  }

 /**
  * Convert an instance of FirewallPropertyAppliedToInnerLabelSelector to an JSON string
  *
  * @return JSON string
  */
