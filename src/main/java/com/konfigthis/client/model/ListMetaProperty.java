...
import com.konfigthis.client.model.ListMetaPropertyPagination;
...
public class ListMetaProperty {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaPropertyPagination pagination;

  public ListMetaProperty() {
  }

  public ListMetaProperty pagination(ListMetaPropertyPagination pagination) {
  ...
  **/
  ...
  public ListMetaPropertyPagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaPropertyPagination pagination) {
   ...
   * @return the ListMetaProperty instance itself
   */
  public ListMetaProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty listMetaProperty = (ListMetaProperty) o;
    return Objects.equals(this.pagination, listMetaProperty.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty is not found in the empty JSON string", ListMetaProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaPropertyPagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty value) throws IOException {
           ...
           @Override
           public ListMetaProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty
  */
  public static ListMetaProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty.class);
  }

 /**
  * Convert an instance of ListMetaProperty to an JSON string
  *
  * @return JSON string
  */
