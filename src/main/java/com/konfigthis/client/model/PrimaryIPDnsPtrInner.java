...
public class PrimaryIPDnsPtrInner {
  ...
  **/
   ...
   * @return the PrimaryIPDnsPtrInner instance itself
   */
  public PrimaryIPDnsPtrInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dnsPtr, primaryIPDnsPtrInner.dnsPtr) &&
        ...
        Objects.equals(this.additionalProperties, primaryIPDnsPtrInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPDnsPtrInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPDnsPtrInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPDnsPtrInner>() {
           ...
           public PrimaryIPDnsPtrInner read(JsonReader in) throws IOException {
             ...
             PrimaryIPDnsPtrInner instance = thisAdapter.fromJsonTree(jsonObj);
