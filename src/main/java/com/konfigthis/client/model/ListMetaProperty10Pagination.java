...
public class ListMetaProperty10Pagination {
  ...
  public ListMetaProperty10Pagination() {
  }

  public ListMetaProperty10Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty10Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty10Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty10Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty10Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty10Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty10Pagination instance itself
   */
  public ListMetaProperty10Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty10Pagination listMetaProperty10Pagination = (ListMetaProperty10Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty10Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty10Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty10Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty10Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty10Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty10Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty10Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty10Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty10Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty10Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty10Pagination is not found in the empty JSON string", ListMetaProperty10Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty10Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty10Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty10Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty10Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty10Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty10Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty10Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty10Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty10Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty10Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty10Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty10Pagination
  */
  public static ListMetaProperty10Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty10Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty10Pagination to an JSON string
  *
  * @return JSON string
  */
