...
import com.konfigthis.client.model.ListMetaProperty2;
...
public class CertificatesGetAllResponse {
  ...
  private ListMetaProperty2 meta;

  public CertificatesGetAllResponse() {
  }

  public CertificatesGetAllResponse certificates(List<Certificate> certificates) {
  ...
  public CertificatesGetAllResponse addCertificatesItem(Certificate certificatesItem) {
  ...
  **/
  ...
  public CertificatesGetAllResponse meta(ListMetaProperty2 meta) {
  ...
  **/
  ...
  public ListMetaProperty2 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty2 meta) {
   ...
   * @return the CertificatesGetAllResponse instance itself
   */
  public CertificatesGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatesGetAllResponse certificatesGetAllResponse = (CertificatesGetAllResponse) o;
    return Objects.equals(this.certificates, certificatesGetAllResponse.certificates) &&
        Objects.equals(this.meta, certificatesGetAllResponse.meta)&&
        Objects.equals(this.additionalProperties, certificatesGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificates, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CertificatesGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatesGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatesGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesGetAllResponse is not found in the empty JSON string", CertificatesGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificatesGetAllResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty2.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesGetAllResponse>() {
           @Override
           public void write(JsonWriter out, CertificatesGetAllResponse value) throws IOException {
           ...
           @Override
           public CertificatesGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatesGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatesGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatesGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to CertificatesGetAllResponse
  */
  public static CertificatesGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesGetAllResponse.class);
  }

 /**
  * Convert an instance of CertificatesGetAllResponse to an JSON string
  *
  * @return JSON string
  */
