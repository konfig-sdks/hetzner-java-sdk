...
import com.konfigthis.client.model.LocationsGetLocationByIdResponseLocation;
...
public class LocationsGetLocationByIdResponse {
  public static final String SERIALIZED_NAME_LOCATION = "location";
  @SerializedName(SERIALIZED_NAME_LOCATION)
  private LocationsGetLocationByIdResponseLocation location;

  public LocationsGetLocationByIdResponse() {
  }

  public LocationsGetLocationByIdResponse location(LocationsGetLocationByIdResponseLocation location) {
  ...
  **/
  ...
  public LocationsGetLocationByIdResponseLocation getLocation() {
    return location;
  }


  public void setLocation(LocationsGetLocationByIdResponseLocation location) {
   ...
   * @return the LocationsGetLocationByIdResponse instance itself
   */
  public LocationsGetLocationByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LocationsGetLocationByIdResponse locationsGetLocationByIdResponse = (LocationsGetLocationByIdResponse) o;
    return Objects.equals(this.location, locationsGetLocationByIdResponse.location)&&
        Objects.equals(this.additionalProperties, locationsGetLocationByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LocationsGetLocationByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationsGetLocationByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationsGetLocationByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationsGetLocationByIdResponse is not found in the empty JSON string", LocationsGetLocationByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LocationsGetLocationByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `location`
      LocationsGetLocationByIdResponseLocation.validateJsonObject(jsonObj.getAsJsonObject("location"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationsGetLocationByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationsGetLocationByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationsGetLocationByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationsGetLocationByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationsGetLocationByIdResponse>() {
           @Override
           public void write(JsonWriter out, LocationsGetLocationByIdResponse value) throws IOException {
           ...
           @Override
           public LocationsGetLocationByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LocationsGetLocationByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LocationsGetLocationByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationsGetLocationByIdResponse
  * @throws IOException if the JSON string is invalid with respect to LocationsGetLocationByIdResponse
  */
  public static LocationsGetLocationByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationsGetLocationByIdResponse.class);
  }

 /**
  * Convert an instance of LocationsGetLocationByIdResponse to an JSON string
  *
  * @return JSON string
  */
