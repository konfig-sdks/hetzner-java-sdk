...
public class ActionProperty16Error {
  ...
  public ActionProperty16Error() {
  }

  public ActionProperty16Error code(String code) {
  ...
  **/
  ...
  public ActionProperty16Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty16Error instance itself
   */
  public ActionProperty16Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty16Error actionProperty16Error = (ActionProperty16Error) o;
    return Objects.equals(this.code, actionProperty16Error.code) &&
        Objects.equals(this.message, actionProperty16Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty16Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty16Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty16Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty16Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty16Error is not found in the empty JSON string", ActionProperty16Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty16Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty16Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty16Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty16Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty16Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty16Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty16Error value) throws IOException {
           ...
           @Override
           public ActionProperty16Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty16Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty16Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty16Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty16Error
  */
  public static ActionProperty16Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty16Error.class);
  }

 /**
  * Convert an instance of ActionProperty16Error to an JSON string
  *
  * @return JSON string
  */
