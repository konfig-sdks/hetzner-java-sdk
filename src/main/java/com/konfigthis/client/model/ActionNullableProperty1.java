...
import com.konfigthis.client.model.ActionNullableProperty1Error;
import com.konfigthis.client.model.ActionNullableProperty1ResourcesInner;
...
/**
 * ActionNullableProperty1
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionNullableProperty1 {
  ...
  private ActionNullableProperty1Error error;
  ...
  private List<ActionNullableProperty1ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionNullableProperty1() {
  }

  public ActionNullableProperty1 command(String command) {
  ...
  **/
  ...
  public ActionNullableProperty1 error(ActionNullableProperty1Error error) {
  ...
  **/
  ...
  public ActionNullableProperty1Error getError() {
    return error;
  }


  public void setError(ActionNullableProperty1Error error) {
  ...
  public ActionNullableProperty1 finished(String finished) {
  ...
  **/
  ...
  public ActionNullableProperty1 id(Long id) {
  ...
  **/
  ...
  public ActionNullableProperty1 progress(Integer progress) {
  ...
  **/
  ...
  public ActionNullableProperty1 resources(List<ActionNullableProperty1ResourcesInner> resources) {
  ...
  public ActionNullableProperty1 addResourcesItem(ActionNullableProperty1ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionNullableProperty1ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionNullableProperty1ResourcesInner> resources) {
  ...
  public ActionNullableProperty1 started(String started) {
  ...
  **/
  ...
  public ActionNullableProperty1 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionNullableProperty1 instance itself
   */
  public ActionNullableProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullableProperty1 actionNullableProperty1 = (ActionNullableProperty1) o;
    return Objects.equals(this.command, actionNullableProperty1.command) &&
        Objects.equals(this.error, actionNullableProperty1.error) &&
        Objects.equals(this.finished, actionNullableProperty1.finished) &&
        Objects.equals(this.id, actionNullableProperty1.id) &&
        Objects.equals(this.progress, actionNullableProperty1.progress) &&
        Objects.equals(this.resources, actionNullableProperty1.resources) &&
        Objects.equals(this.started, actionNullableProperty1.started) &&
        Objects.equals(this.status, actionNullableProperty1.status)&&
        Objects.equals(this.additionalProperties, actionNullableProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullableProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullableProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullableProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullableProperty1 is not found in the empty JSON string", ActionNullableProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullableProperty1.openapiRequiredFields) {
      ...
      ActionNullableProperty1Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionNullableProperty1ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullableProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullableProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullableProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullableProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullableProperty1>() {
           @Override
           public void write(JsonWriter out, ActionNullableProperty1 value) throws IOException {
           ...
           @Override
           public ActionNullableProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullableProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullableProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullableProperty1
  * @throws IOException if the JSON string is invalid with respect to ActionNullableProperty1
  */
  public static ActionNullableProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullableProperty1.class);
  }

 /**
  * Convert an instance of ActionNullableProperty1 to an JSON string
  *
  * @return JSON string
  */
