...
/**
 * ActionProperty23ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty23ResourcesInner {
  ...
  public ActionProperty23ResourcesInner() {
  }

  public ActionProperty23ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty23ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty23ResourcesInner instance itself
   */
  public ActionProperty23ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty23ResourcesInner actionProperty23ResourcesInner = (ActionProperty23ResourcesInner) o;
    return Objects.equals(this.id, actionProperty23ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty23ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty23ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty23ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty23ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty23ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty23ResourcesInner is not found in the empty JSON string", ActionProperty23ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty23ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty23ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty23ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty23ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty23ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty23ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty23ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty23ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty23ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty23ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty23ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty23ResourcesInner
  */
  public static ActionProperty23ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty23ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty23ResourcesInner to an JSON string
  *
  * @return JSON string
  */
