...
import com.konfigthis.client.model.LoadBalancersGetMetricsResponseMetrics;
...
public class LoadBalancersGetMetricsResponse {
  public static final String SERIALIZED_NAME_METRICS = "metrics";
  @SerializedName(SERIALIZED_NAME_METRICS)
  private LoadBalancersGetMetricsResponseMetrics metrics;

  public LoadBalancersGetMetricsResponse() {
  }

  public LoadBalancersGetMetricsResponse metrics(LoadBalancersGetMetricsResponseMetrics metrics) {
  ...
  **/
  ...
  public LoadBalancersGetMetricsResponseMetrics getMetrics() {
    return metrics;
  }


  public void setMetrics(LoadBalancersGetMetricsResponseMetrics metrics) {
   ...
   * @return the LoadBalancersGetMetricsResponse instance itself
   */
  public LoadBalancersGetMetricsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersGetMetricsResponse loadBalancersGetMetricsResponse = (LoadBalancersGetMetricsResponse) o;
    return Objects.equals(this.metrics, loadBalancersGetMetricsResponse.metrics)&&
        Objects.equals(this.additionalProperties, loadBalancersGetMetricsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersGetMetricsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersGetMetricsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersGetMetricsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersGetMetricsResponse is not found in the empty JSON string", LoadBalancersGetMetricsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersGetMetricsResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `metrics`
      LoadBalancersGetMetricsResponseMetrics.validateJsonObject(jsonObj.getAsJsonObject("metrics"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersGetMetricsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersGetMetricsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersGetMetricsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersGetMetricsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersGetMetricsResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancersGetMetricsResponse value) throws IOException {
           ...
           @Override
           public LoadBalancersGetMetricsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersGetMetricsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersGetMetricsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersGetMetricsResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersGetMetricsResponse
  */
  public static LoadBalancersGetMetricsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersGetMetricsResponse.class);
  }

 /**
  * Convert an instance of LoadBalancersGetMetricsResponse to an JSON string
  *
  * @return JSON string
  */
