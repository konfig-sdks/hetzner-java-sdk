...
import com.konfigthis.client.model.ActionProperty32Error;
import com.konfigthis.client.model.ActionProperty32ResourcesInner;
...
public class ActionProperty32 {
  ...
  private ActionProperty32Error error;
  ...
  private List<ActionProperty32ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty32() {
  }

  public ActionProperty32 command(String command) {
  ...
  **/
  ...
  public ActionProperty32 error(ActionProperty32Error error) {
  ...
  **/
  ...
  public ActionProperty32Error getError() {
    return error;
  }


  public void setError(ActionProperty32Error error) {
  ...
  public ActionProperty32 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty32 id(Long id) {
  ...
  **/
  ...
  public ActionProperty32 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty32 resources(List<ActionProperty32ResourcesInner> resources) {
  ...
  public ActionProperty32 addResourcesItem(ActionProperty32ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty32ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty32ResourcesInner> resources) {
  ...
  public ActionProperty32 started(String started) {
  ...
  **/
  ...
  public ActionProperty32 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty32 instance itself
   */
  public ActionProperty32 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty32 actionProperty32 = (ActionProperty32) o;
    return Objects.equals(this.command, actionProperty32.command) &&
        Objects.equals(this.error, actionProperty32.error) &&
        Objects.equals(this.finished, actionProperty32.finished) &&
        Objects.equals(this.id, actionProperty32.id) &&
        Objects.equals(this.progress, actionProperty32.progress) &&
        Objects.equals(this.resources, actionProperty32.resources) &&
        Objects.equals(this.started, actionProperty32.started) &&
        Objects.equals(this.status, actionProperty32.status)&&
        Objects.equals(this.additionalProperties, actionProperty32.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty32 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty32
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty32.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty32 is not found in the empty JSON string", ActionProperty32.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty32.openapiRequiredFields) {
      ...
      ActionProperty32Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty32ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty32.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty32' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty32> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty32.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty32>() {
           @Override
           public void write(JsonWriter out, ActionProperty32 value) throws IOException {
           ...
           @Override
           public ActionProperty32 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty32 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty32 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty32
  * @throws IOException if the JSON string is invalid with respect to ActionProperty32
  */
  public static ActionProperty32 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty32.class);
  }

 /**
  * Convert an instance of ActionProperty32 to an JSON string
  *
  * @return JSON string
  */
