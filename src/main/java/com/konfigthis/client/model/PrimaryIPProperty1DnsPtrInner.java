...
public class PrimaryIPProperty1DnsPtrInner {
  ...
  public PrimaryIPProperty1DnsPtrInner() {
  }

  public PrimaryIPProperty1DnsPtrInner dnsPtr(String dnsPtr) {
  ...
  **/
  ...
  public PrimaryIPProperty1DnsPtrInner ip(String ip) {
  ...
  **/
   ...
   * @return the PrimaryIPProperty1DnsPtrInner instance itself
   */
  public PrimaryIPProperty1DnsPtrInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPProperty1DnsPtrInner primaryIPProperty1DnsPtrInner = (PrimaryIPProperty1DnsPtrInner) o;
    return Objects.equals(this.dnsPtr, primaryIPProperty1DnsPtrInner.dnsPtr) &&
        Objects.equals(this.ip, primaryIPProperty1DnsPtrInner.ip)&&
        Objects.equals(this.additionalProperties, primaryIPProperty1DnsPtrInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPProperty1DnsPtrInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPProperty1DnsPtrInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPProperty1DnsPtrInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPProperty1DnsPtrInner is not found in the empty JSON string", PrimaryIPProperty1DnsPtrInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPProperty1DnsPtrInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPProperty1DnsPtrInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPProperty1DnsPtrInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPProperty1DnsPtrInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPProperty1DnsPtrInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPProperty1DnsPtrInner>() {
           @Override
           public void write(JsonWriter out, PrimaryIPProperty1DnsPtrInner value) throws IOException {
           ...
           @Override
           public PrimaryIPProperty1DnsPtrInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPProperty1DnsPtrInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPProperty1DnsPtrInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPProperty1DnsPtrInner
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPProperty1DnsPtrInner
  */
  public static PrimaryIPProperty1DnsPtrInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPProperty1DnsPtrInner.class);
  }

 /**
  * Convert an instance of PrimaryIPProperty1DnsPtrInner to an JSON string
  *
  * @return JSON string
  */
