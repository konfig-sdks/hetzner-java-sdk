...
/**
 * ActionNullableProperty1ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionNullableProperty1ResourcesInner {
  ...
  public ActionNullableProperty1ResourcesInner() {
  }

  public ActionNullableProperty1ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionNullableProperty1ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionNullableProperty1ResourcesInner instance itself
   */
  public ActionNullableProperty1ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullableProperty1ResourcesInner actionNullableProperty1ResourcesInner = (ActionNullableProperty1ResourcesInner) o;
    return Objects.equals(this.id, actionNullableProperty1ResourcesInner.id) &&
        Objects.equals(this.type, actionNullableProperty1ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionNullableProperty1ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullableProperty1ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullableProperty1ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullableProperty1ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullableProperty1ResourcesInner is not found in the empty JSON string", ActionNullableProperty1ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullableProperty1ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullableProperty1ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullableProperty1ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullableProperty1ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullableProperty1ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullableProperty1ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionNullableProperty1ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionNullableProperty1ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullableProperty1ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullableProperty1ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullableProperty1ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionNullableProperty1ResourcesInner
  */
  public static ActionNullableProperty1ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullableProperty1ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionNullableProperty1ResourcesInner to an JSON string
  *
  * @return JSON string
  */
