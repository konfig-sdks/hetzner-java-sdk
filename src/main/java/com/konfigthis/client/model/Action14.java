...
import com.konfigthis.client.model.Action14Error;
import com.konfigthis.client.model.Action14ResourcesInner;
...
public class Action14 {
  ...
  private List<Action14ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action14 command(String command) {
  ...
  **/
  ...
  public Action14 error(Action14Error error) {
  ...
  **/
  ...
  public Action14Error getError() {
    return error;
  }


  public void setError(Action14Error error) {
  ...
  public Action14 finished(String finished) {
  ...
  **/
  ...
  public Action14 progress(Integer progress) {
  ...
  **/
  ...
  public Action14 resources(List<Action14ResourcesInner> resources) {
  ...
  public Action14 addResourcesItem(Action14ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action14ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action14ResourcesInner> resources) {
  ...
  public Action14 started(String started) {
  ...
  **/
  ...
  public Action14 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action14 instance itself
   */
  public Action14 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action14 action14 = (Action14) o;
    return Objects.equals(this.command, action14.command) &&
        Objects.equals(this.error, action14.error) &&
        Objects.equals(this.finished, action14.finished) &&
        Objects.equals(this.id, action14.id) &&
        Objects.equals(this.progress, action14.progress) &&
        Objects.equals(this.resources, action14.resources) &&
        Objects.equals(this.started, action14.started) &&
        Objects.equals(this.status, action14.status)&&
        Objects.equals(this.additionalProperties, action14.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action14
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action14.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action14 is not found in the empty JSON string", Action14.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action14.openapiRequiredFields) {
      ...
      Action14Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action14ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action14.class));

       return (TypeAdapter<T>) new TypeAdapter<Action14>() {
           @Override
           public void write(JsonWriter out, Action14 value) throws IOException {
           ...
           @Override
           public Action14 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action14 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action14 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action14
  * @throws IOException if the JSON string is invalid with respect to Action14
  */
  public static Action14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action14.class);
  }

 /**
  * Convert an instance of Action14 to an JSON string
  *
  * @return JSON string
  */
