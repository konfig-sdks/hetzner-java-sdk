...
import com.konfigthis.client.model.ActionProperty38Error;
import com.konfigthis.client.model.ActionProperty38ResourcesInner;
...
public class ActionProperty38 {
  ...
  private ActionProperty38Error error;
  ...
  private List<ActionProperty38ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty38() {
  }

  public ActionProperty38 command(String command) {
  ...
  **/
  ...
  public ActionProperty38 error(ActionProperty38Error error) {
  ...
  **/
  ...
  public ActionProperty38Error getError() {
    return error;
  }


  public void setError(ActionProperty38Error error) {
  ...
  public ActionProperty38 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty38 id(Long id) {
  ...
  **/
  ...
  public ActionProperty38 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty38 resources(List<ActionProperty38ResourcesInner> resources) {
  ...
  public ActionProperty38 addResourcesItem(ActionProperty38ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty38ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty38ResourcesInner> resources) {
  ...
  public ActionProperty38 started(String started) {
  ...
  **/
  ...
  public ActionProperty38 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty38 instance itself
   */
  public ActionProperty38 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty38 actionProperty38 = (ActionProperty38) o;
    return Objects.equals(this.command, actionProperty38.command) &&
        Objects.equals(this.error, actionProperty38.error) &&
        Objects.equals(this.finished, actionProperty38.finished) &&
        Objects.equals(this.id, actionProperty38.id) &&
        Objects.equals(this.progress, actionProperty38.progress) &&
        Objects.equals(this.resources, actionProperty38.resources) &&
        Objects.equals(this.started, actionProperty38.started) &&
        Objects.equals(this.status, actionProperty38.status)&&
        Objects.equals(this.additionalProperties, actionProperty38.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty38 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty38
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty38.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty38 is not found in the empty JSON string", ActionProperty38.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty38.openapiRequiredFields) {
      ...
      ActionProperty38Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty38ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty38.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty38' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty38> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty38.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty38>() {
           @Override
           public void write(JsonWriter out, ActionProperty38 value) throws IOException {
           ...
           @Override
           public ActionProperty38 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty38 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty38 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty38
  * @throws IOException if the JSON string is invalid with respect to ActionProperty38
  */
  public static ActionProperty38 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty38.class);
  }

 /**
  * Convert an instance of ActionProperty38 to an JSON string
  *
  * @return JSON string
  */
