...
public class LoadBalancerServiceHTTPProperty4 {
  ...
  public LoadBalancerServiceHTTPProperty4() {
  }

  public LoadBalancerServiceHTTPProperty4 certificates(List<Long> certificates) {
  ...
  public LoadBalancerServiceHTTPProperty4 addCertificatesItem(Long certificatesItem) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty4 cookieLifetime(Integer cookieLifetime) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty4 cookieName(String cookieName) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty4 redirectHttp(Boolean redirectHttp) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty4 stickySessions(Boolean stickySessions) {
  ...
  **/
   ...
   * @return the LoadBalancerServiceHTTPProperty4 instance itself
   */
  public LoadBalancerServiceHTTPProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerServiceHTTPProperty4 loadBalancerServiceHTTPProperty4 = (LoadBalancerServiceHTTPProperty4) o;
    return Objects.equals(this.certificates, loadBalancerServiceHTTPProperty4.certificates) &&
        Objects.equals(this.cookieLifetime, loadBalancerServiceHTTPProperty4.cookieLifetime) &&
        Objects.equals(this.cookieName, loadBalancerServiceHTTPProperty4.cookieName) &&
        Objects.equals(this.redirectHttp, loadBalancerServiceHTTPProperty4.redirectHttp) &&
        Objects.equals(this.stickySessions, loadBalancerServiceHTTPProperty4.stickySessions)&&
        Objects.equals(this.additionalProperties, loadBalancerServiceHTTPProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerServiceHTTPProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerServiceHTTPProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerServiceHTTPProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerServiceHTTPProperty4 is not found in the empty JSON string", LoadBalancerServiceHTTPProperty4.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerServiceHTTPProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerServiceHTTPProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerServiceHTTPProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerServiceHTTPProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerServiceHTTPProperty4>() {
           @Override
           public void write(JsonWriter out, LoadBalancerServiceHTTPProperty4 value) throws IOException {
           ...
           @Override
           public LoadBalancerServiceHTTPProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerServiceHTTPProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerServiceHTTPProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerServiceHTTPProperty4
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerServiceHTTPProperty4
  */
  public static LoadBalancerServiceHTTPProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerServiceHTTPProperty4.class);
  }

 /**
  * Convert an instance of LoadBalancerServiceHTTPProperty4 to an JSON string
  *
  * @return JSON string
  */
