...
public class ListMetaProperty34Pagination {
  ...
  public ListMetaProperty34Pagination() {
  }

  public ListMetaProperty34Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty34Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty34Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty34Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty34Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty34Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty34Pagination instance itself
   */
  public ListMetaProperty34Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty34Pagination listMetaProperty34Pagination = (ListMetaProperty34Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty34Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty34Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty34Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty34Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty34Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty34Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty34Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty34Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty34Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty34Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty34Pagination is not found in the empty JSON string", ListMetaProperty34Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty34Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty34Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty34Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty34Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty34Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty34Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty34Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty34Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty34Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty34Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty34Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty34Pagination
  */
  public static ListMetaProperty34Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty34Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty34Pagination to an JSON string
  *
  * @return JSON string
  */
