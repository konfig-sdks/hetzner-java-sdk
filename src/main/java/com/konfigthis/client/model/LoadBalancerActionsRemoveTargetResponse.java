...
import com.konfigthis.client.model.ActionProperty30;
...
public class LoadBalancerActionsRemoveTargetResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty30 action;

  public LoadBalancerActionsRemoveTargetResponse() {
  }

  public LoadBalancerActionsRemoveTargetResponse action(ActionProperty30 action) {
  ...
  **/
  ...
  public ActionProperty30 getAction() {
    return action;
  }


  public void setAction(ActionProperty30 action) {
   ...
   * @return the LoadBalancerActionsRemoveTargetResponse instance itself
   */
  public LoadBalancerActionsRemoveTargetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsRemoveTargetResponse loadBalancerActionsRemoveTargetResponse = (LoadBalancerActionsRemoveTargetResponse) o;
    return Objects.equals(this.action, loadBalancerActionsRemoveTargetResponse.action)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsRemoveTargetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsRemoveTargetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsRemoveTargetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsRemoveTargetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsRemoveTargetResponse is not found in the empty JSON string", LoadBalancerActionsRemoveTargetResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsRemoveTargetResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty30.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsRemoveTargetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsRemoveTargetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsRemoveTargetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsRemoveTargetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsRemoveTargetResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsRemoveTargetResponse value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsRemoveTargetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsRemoveTargetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsRemoveTargetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsRemoveTargetResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsRemoveTargetResponse
  */
  public static LoadBalancerActionsRemoveTargetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsRemoveTargetResponse.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsRemoveTargetResponse to an JSON string
  *
  * @return JSON string
  */
