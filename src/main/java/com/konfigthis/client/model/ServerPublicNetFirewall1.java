...
public class ServerPublicNetFirewall1 {
 ...
 public enum StatusEnum {
  ...
  public ServerPublicNetFirewall1() {
  }

  public ServerPublicNetFirewall1 id(Long id) {
  ...
  **/
  ...
  public ServerPublicNetFirewall1 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ServerPublicNetFirewall1 instance itself
   */
  public ServerPublicNetFirewall1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerPublicNetFirewall1 serverPublicNetFirewall1 = (ServerPublicNetFirewall1) o;
    return Objects.equals(this.id, serverPublicNetFirewall1.id) &&
        Objects.equals(this.status, serverPublicNetFirewall1.status)&&
        Objects.equals(this.additionalProperties, serverPublicNetFirewall1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerPublicNetFirewall1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerPublicNetFirewall1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerPublicNetFirewall1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerPublicNetFirewall1 is not found in the empty JSON string", ServerPublicNetFirewall1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerPublicNetFirewall1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerPublicNetFirewall1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerPublicNetFirewall1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerPublicNetFirewall1.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerPublicNetFirewall1>() {
           @Override
           public void write(JsonWriter out, ServerPublicNetFirewall1 value) throws IOException {
           ...
           @Override
           public ServerPublicNetFirewall1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerPublicNetFirewall1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerPublicNetFirewall1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerPublicNetFirewall1
  * @throws IOException if the JSON string is invalid with respect to ServerPublicNetFirewall1
  */
  public static ServerPublicNetFirewall1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerPublicNetFirewall1.class);
  }

 /**
  * Convert an instance of ServerPublicNetFirewall1 to an JSON string
  *
  * @return JSON string
  */
