...
/**
 * Action19ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action19ResourcesInner {
  ...
  public Action19ResourcesInner() {
  }

  public Action19ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action19ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action19ResourcesInner instance itself
   */
  public Action19ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action19ResourcesInner action19ResourcesInner = (Action19ResourcesInner) o;
    return Objects.equals(this.id, action19ResourcesInner.id) &&
        Objects.equals(this.type, action19ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action19ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action19ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action19ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action19ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action19ResourcesInner is not found in the empty JSON string", Action19ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action19ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action19ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action19ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action19ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action19ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action19ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action19ResourcesInner value) throws IOException {
           ...
           @Override
           public Action19ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action19ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action19ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action19ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action19ResourcesInner
  */
  public static Action19ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action19ResourcesInner.class);
  }

 /**
  * Convert an instance of Action19ResourcesInner to an JSON string
  *
  * @return JSON string
  */
