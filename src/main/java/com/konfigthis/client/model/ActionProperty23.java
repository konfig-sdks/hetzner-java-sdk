...
import com.konfigthis.client.model.ActionProperty23Error;
import com.konfigthis.client.model.ActionProperty23ResourcesInner;
...
public class ActionProperty23 {
  ...
  private ActionProperty23Error error;
  ...
  private List<ActionProperty23ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty23() {
  }

  public ActionProperty23 command(String command) {
  ...
  **/
  ...
  public ActionProperty23 error(ActionProperty23Error error) {
  ...
  **/
  ...
  public ActionProperty23Error getError() {
    return error;
  }


  public void setError(ActionProperty23Error error) {
  ...
  public ActionProperty23 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty23 id(Long id) {
  ...
  **/
  ...
  public ActionProperty23 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty23 resources(List<ActionProperty23ResourcesInner> resources) {
  ...
  public ActionProperty23 addResourcesItem(ActionProperty23ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty23ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty23ResourcesInner> resources) {
  ...
  public ActionProperty23 started(String started) {
  ...
  **/
  ...
  public ActionProperty23 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty23 instance itself
   */
  public ActionProperty23 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty23 actionProperty23 = (ActionProperty23) o;
    return Objects.equals(this.command, actionProperty23.command) &&
        Objects.equals(this.error, actionProperty23.error) &&
        Objects.equals(this.finished, actionProperty23.finished) &&
        Objects.equals(this.id, actionProperty23.id) &&
        Objects.equals(this.progress, actionProperty23.progress) &&
        Objects.equals(this.resources, actionProperty23.resources) &&
        Objects.equals(this.started, actionProperty23.started) &&
        Objects.equals(this.status, actionProperty23.status)&&
        Objects.equals(this.additionalProperties, actionProperty23.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty23 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty23
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty23.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty23 is not found in the empty JSON string", ActionProperty23.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty23.openapiRequiredFields) {
      ...
      ActionProperty23Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty23ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty23.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty23' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty23> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty23.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty23>() {
           @Override
           public void write(JsonWriter out, ActionProperty23 value) throws IOException {
           ...
           @Override
           public ActionProperty23 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty23 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty23 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty23
  * @throws IOException if the JSON string is invalid with respect to ActionProperty23
  */
  public static ActionProperty23 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty23.class);
  }

 /**
  * Convert an instance of ActionProperty23 to an JSON string
  *
  * @return JSON string
  */
