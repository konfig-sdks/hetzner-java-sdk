...
import com.konfigthis.client.model.ListMetaProperty14Pagination;
...
public class ListMetaProperty14 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty14Pagination pagination;

  public ListMetaProperty14() {
  }

  public ListMetaProperty14 pagination(ListMetaProperty14Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty14Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty14Pagination pagination) {
   ...
   * @return the ListMetaProperty14 instance itself
   */
  public ListMetaProperty14 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty14 listMetaProperty14 = (ListMetaProperty14) o;
    return Objects.equals(this.pagination, listMetaProperty14.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty14.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty14 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty14
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty14.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty14 is not found in the empty JSON string", ListMetaProperty14.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty14.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty14Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty14.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty14>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty14 value) throws IOException {
           ...
           @Override
           public ListMetaProperty14 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty14 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty14 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty14
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty14
  */
  public static ListMetaProperty14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty14.class);
  }

 /**
  * Convert an instance of ListMetaProperty14 to an JSON string
  *
  * @return JSON string
  */
