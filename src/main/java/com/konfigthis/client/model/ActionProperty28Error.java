...
public class ActionProperty28Error {
  ...
  public ActionProperty28Error() {
  }

  public ActionProperty28Error code(String code) {
  ...
  **/
  ...
  public ActionProperty28Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty28Error instance itself
   */
  public ActionProperty28Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty28Error actionProperty28Error = (ActionProperty28Error) o;
    return Objects.equals(this.code, actionProperty28Error.code) &&
        Objects.equals(this.message, actionProperty28Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty28Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty28Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty28Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty28Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty28Error is not found in the empty JSON string", ActionProperty28Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty28Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty28Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty28Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty28Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty28Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty28Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty28Error value) throws IOException {
           ...
           @Override
           public ActionProperty28Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty28Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty28Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty28Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty28Error
  */
  public static ActionProperty28Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty28Error.class);
  }

 /**
  * Convert an instance of ActionProperty28Error to an JSON string
  *
  * @return JSON string
  */
