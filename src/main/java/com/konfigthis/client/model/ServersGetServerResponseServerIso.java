...
import com.konfigthis.client.model.DeprecationInfoProperty8;
...
public class ServersGetServerResponseServerIso {
 ...
 public enum ArchitectureEnum {
  ...
  private DeprecationInfoProperty8 deprecation;
 ...
 public enum TypeEnum {
  ...
  public ServersGetServerResponseServerIso() {
  }

  public ServersGetServerResponseServerIso description(String description) {
  ...
  **/
  ...
  public ServersGetServerResponseServerIso architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServersGetServerResponseServerIso deprecation(DeprecationInfoProperty8 deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty8 getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty8 deprecation) {
  ...
  public ServersGetServerResponseServerIso id(Long id) {
  ...
  **/
  ...
  public ServersGetServerResponseServerIso name(String name) {
  ...
  **/
  ...
  public ServersGetServerResponseServerIso type(TypeEnum type) {
  ...
  **/
   ...
   * @return the ServersGetServerResponseServerIso instance itself
   */
  public ServersGetServerResponseServerIso putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGetServerResponseServerIso serversGetServerResponseServerIso = (ServersGetServerResponseServerIso) o;
    return Objects.equals(this.description, serversGetServerResponseServerIso.description) &&
        Objects.equals(this.architecture, serversGetServerResponseServerIso.architecture) &&
        Objects.equals(this.deprecation, serversGetServerResponseServerIso.deprecation) &&
        Objects.equals(this.id, serversGetServerResponseServerIso.id) &&
        Objects.equals(this.name, serversGetServerResponseServerIso.name) &&
        Objects.equals(this.type, serversGetServerResponseServerIso.type)&&
        Objects.equals(this.additionalProperties, serversGetServerResponseServerIso.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersGetServerResponseServerIso {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersGetServerResponseServerIso
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersGetServerResponseServerIso.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGetServerResponseServerIso is not found in the empty JSON string", ServersGetServerResponseServerIso.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGetServerResponseServerIso.openapiRequiredFields) {
      ...
      DeprecationInfoProperty8.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGetServerResponseServerIso.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGetServerResponseServerIso' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGetServerResponseServerIso> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGetServerResponseServerIso.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGetServerResponseServerIso>() {
           @Override
           public void write(JsonWriter out, ServersGetServerResponseServerIso value) throws IOException {
           ...
           @Override
           public ServersGetServerResponseServerIso read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersGetServerResponseServerIso instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersGetServerResponseServerIso given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersGetServerResponseServerIso
  * @throws IOException if the JSON string is invalid with respect to ServersGetServerResponseServerIso
  */
  public static ServersGetServerResponseServerIso fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGetServerResponseServerIso.class);
  }

 /**
  * Convert an instance of ServersGetServerResponseServerIso to an JSON string
  *
  * @return JSON string
  */
