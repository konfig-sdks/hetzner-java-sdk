...
/**
 * ActionProperty9ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty9ResourcesInner {
  ...
  public ActionProperty9ResourcesInner() {
  }

  public ActionProperty9ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty9ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty9ResourcesInner instance itself
   */
  public ActionProperty9ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty9ResourcesInner actionProperty9ResourcesInner = (ActionProperty9ResourcesInner) o;
    return Objects.equals(this.id, actionProperty9ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty9ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty9ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty9ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty9ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty9ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty9ResourcesInner is not found in the empty JSON string", ActionProperty9ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty9ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty9ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty9ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty9ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty9ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty9ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty9ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty9ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty9ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty9ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty9ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty9ResourcesInner
  */
  public static ActionProperty9ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty9ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty9ResourcesInner to an JSON string
  *
  * @return JSON string
  */
