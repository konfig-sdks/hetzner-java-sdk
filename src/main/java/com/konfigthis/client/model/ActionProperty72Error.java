...
public class ActionProperty72Error {
  ...
  public ActionProperty72Error() {
  }

  public ActionProperty72Error code(String code) {
  ...
  **/
  ...
  public ActionProperty72Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty72Error instance itself
   */
  public ActionProperty72Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty72Error actionProperty72Error = (ActionProperty72Error) o;
    return Objects.equals(this.code, actionProperty72Error.code) &&
        Objects.equals(this.message, actionProperty72Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty72Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty72Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty72Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty72Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty72Error is not found in the empty JSON string", ActionProperty72Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty72Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty72Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty72Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty72Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty72Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty72Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty72Error value) throws IOException {
           ...
           @Override
           public ActionProperty72Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty72Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty72Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty72Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty72Error
  */
  public static ActionProperty72Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty72Error.class);
  }

 /**
  * Convert an instance of ActionProperty72Error to an JSON string
  *
  * @return JSON string
  */
