...
import com.konfigthis.client.model.ListMetaProperty8Pagination;
...
public class ListMetaProperty8 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty8Pagination pagination;

  public ListMetaProperty8() {
  }

  public ListMetaProperty8 pagination(ListMetaProperty8Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty8Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty8Pagination pagination) {
   ...
   * @return the ListMetaProperty8 instance itself
   */
  public ListMetaProperty8 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty8 listMetaProperty8 = (ListMetaProperty8) o;
    return Objects.equals(this.pagination, listMetaProperty8.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty8.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty8 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty8 is not found in the empty JSON string", ListMetaProperty8.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty8.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty8Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty8.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty8>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty8 value) throws IOException {
           ...
           @Override
           public ListMetaProperty8 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty8 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty8
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty8
  */
  public static ListMetaProperty8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty8.class);
  }

 /**
  * Convert an instance of ListMetaProperty8 to an JSON string
  *
  * @return JSON string
  */
