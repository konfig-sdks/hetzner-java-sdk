...
public class DeprecationInfoProperty10 {
  ...
  public DeprecationInfoProperty10() {
  }

  public DeprecationInfoProperty10 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty10 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty10 instance itself
   */
  public DeprecationInfoProperty10 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty10 deprecationInfoProperty10 = (DeprecationInfoProperty10) o;
    return Objects.equals(this.announced, deprecationInfoProperty10.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty10.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty10.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty10 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty10
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty10.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty10 is not found in the empty JSON string", DeprecationInfoProperty10.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty10.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty10.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty10>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty10 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty10 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty10 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty10 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty10
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty10
  */
  public static DeprecationInfoProperty10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty10.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty10 to an JSON string
  *
  * @return JSON string
  */
