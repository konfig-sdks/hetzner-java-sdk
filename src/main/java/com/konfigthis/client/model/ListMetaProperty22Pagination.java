...
public class ListMetaProperty22Pagination {
  ...
  public ListMetaProperty22Pagination() {
  }

  public ListMetaProperty22Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty22Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty22Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty22Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty22Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty22Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty22Pagination instance itself
   */
  public ListMetaProperty22Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty22Pagination listMetaProperty22Pagination = (ListMetaProperty22Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty22Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty22Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty22Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty22Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty22Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty22Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty22Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty22Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty22Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty22Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty22Pagination is not found in the empty JSON string", ListMetaProperty22Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty22Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty22Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty22Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty22Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty22Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty22Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty22Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty22Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty22Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty22Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty22Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty22Pagination
  */
  public static ListMetaProperty22Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty22Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty22Pagination to an JSON string
  *
  * @return JSON string
  */
