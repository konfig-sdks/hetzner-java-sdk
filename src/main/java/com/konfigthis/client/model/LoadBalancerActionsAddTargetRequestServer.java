...
public class LoadBalancerActionsAddTargetRequestServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerActionsAddTargetRequestServer() {
  }

  public LoadBalancerActionsAddTargetRequestServer id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerActionsAddTargetRequestServer instance itself
   */
  public LoadBalancerActionsAddTargetRequestServer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsAddTargetRequestServer loadBalancerActionsAddTargetRequestServer = (LoadBalancerActionsAddTargetRequestServer) o;
    return Objects.equals(this.id, loadBalancerActionsAddTargetRequestServer.id)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsAddTargetRequestServer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsAddTargetRequestServer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsAddTargetRequestServer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsAddTargetRequestServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsAddTargetRequestServer is not found in the empty JSON string", LoadBalancerActionsAddTargetRequestServer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsAddTargetRequestServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsAddTargetRequestServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsAddTargetRequestServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsAddTargetRequestServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsAddTargetRequestServer.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsAddTargetRequestServer>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsAddTargetRequestServer value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsAddTargetRequestServer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsAddTargetRequestServer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsAddTargetRequestServer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsAddTargetRequestServer
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsAddTargetRequestServer
  */
  public static LoadBalancerActionsAddTargetRequestServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsAddTargetRequestServer.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsAddTargetRequestServer to an JSON string
  *
  * @return JSON string
  */
