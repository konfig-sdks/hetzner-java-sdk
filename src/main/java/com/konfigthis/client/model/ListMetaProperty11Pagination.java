...
public class ListMetaProperty11Pagination {
  ...
  public ListMetaProperty11Pagination() {
  }

  public ListMetaProperty11Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty11Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty11Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty11Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty11Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty11Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty11Pagination instance itself
   */
  public ListMetaProperty11Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty11Pagination listMetaProperty11Pagination = (ListMetaProperty11Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty11Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty11Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty11Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty11Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty11Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty11Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty11Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty11Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty11Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty11Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty11Pagination is not found in the empty JSON string", ListMetaProperty11Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty11Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty11Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty11Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty11Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty11Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty11Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty11Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty11Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty11Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty11Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty11Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty11Pagination
  */
  public static ListMetaProperty11Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty11Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty11Pagination to an JSON string
  *
  * @return JSON string
  */
