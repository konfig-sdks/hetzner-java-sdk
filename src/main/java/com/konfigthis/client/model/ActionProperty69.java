...
import com.konfigthis.client.model.ActionProperty69Error;
import com.konfigthis.client.model.ActionProperty69ResourcesInner;
...
public class ActionProperty69 {
  ...
  private ActionProperty69Error error;
  ...
  private List<ActionProperty69ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty69() {
  }

  public ActionProperty69 command(String command) {
  ...
  **/
  ...
  public ActionProperty69 error(ActionProperty69Error error) {
  ...
  **/
  ...
  public ActionProperty69Error getError() {
    return error;
  }


  public void setError(ActionProperty69Error error) {
  ...
  public ActionProperty69 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty69 id(Long id) {
  ...
  **/
  ...
  public ActionProperty69 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty69 resources(List<ActionProperty69ResourcesInner> resources) {
  ...
  public ActionProperty69 addResourcesItem(ActionProperty69ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty69ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty69ResourcesInner> resources) {
  ...
  public ActionProperty69 started(String started) {
  ...
  **/
  ...
  public ActionProperty69 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty69 instance itself
   */
  public ActionProperty69 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty69 actionProperty69 = (ActionProperty69) o;
    return Objects.equals(this.command, actionProperty69.command) &&
        Objects.equals(this.error, actionProperty69.error) &&
        Objects.equals(this.finished, actionProperty69.finished) &&
        Objects.equals(this.id, actionProperty69.id) &&
        Objects.equals(this.progress, actionProperty69.progress) &&
        Objects.equals(this.resources, actionProperty69.resources) &&
        Objects.equals(this.started, actionProperty69.started) &&
        Objects.equals(this.status, actionProperty69.status)&&
        Objects.equals(this.additionalProperties, actionProperty69.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty69 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty69
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty69.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty69 is not found in the empty JSON string", ActionProperty69.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty69.openapiRequiredFields) {
      ...
      ActionProperty69Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty69ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty69.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty69' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty69> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty69.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty69>() {
           @Override
           public void write(JsonWriter out, ActionProperty69 value) throws IOException {
           ...
           @Override
           public ActionProperty69 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty69 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty69 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty69
  * @throws IOException if the JSON string is invalid with respect to ActionProperty69
  */
  public static ActionProperty69 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty69.class);
  }

 /**
  * Convert an instance of ActionProperty69 to an JSON string
  *
  * @return JSON string
  */
