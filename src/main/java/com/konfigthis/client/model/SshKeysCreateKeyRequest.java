...
public class SshKeysCreateKeyRequest {
  ...
  public SshKeysCreateKeyRequest() {
  }

  public SshKeysCreateKeyRequest labels(Object labels) {
  ...
  **/
  ...
  public SshKeysCreateKeyRequest name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "My ssh key", required = true, value = "Name of the SSH key")
  ...
  public SshKeysCreateKeyRequest publicKey(String publicKey) {
  ...
  **/
   ...
   * @return the SshKeysCreateKeyRequest instance itself
   */
  public SshKeysCreateKeyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysCreateKeyRequest sshKeysCreateKeyRequest = (SshKeysCreateKeyRequest) o;
    return Objects.equals(this.labels, sshKeysCreateKeyRequest.labels) &&
        Objects.equals(this.name, sshKeysCreateKeyRequest.name) &&
        Objects.equals(this.publicKey, sshKeysCreateKeyRequest.publicKey)&&
        Objects.equals(this.additionalProperties, sshKeysCreateKeyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(labels, name, publicKey, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeysCreateKeyRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysCreateKeyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysCreateKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysCreateKeyRequest is not found in the empty JSON string", SshKeysCreateKeyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysCreateKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysCreateKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysCreateKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysCreateKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysCreateKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysCreateKeyRequest>() {
           @Override
           public void write(JsonWriter out, SshKeysCreateKeyRequest value) throws IOException {
           ...
           @Override
           public SshKeysCreateKeyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysCreateKeyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysCreateKeyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysCreateKeyRequest
  * @throws IOException if the JSON string is invalid with respect to SshKeysCreateKeyRequest
  */
  public static SshKeysCreateKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysCreateKeyRequest.class);
  }

 /**
  * Convert an instance of SshKeysCreateKeyRequest to an JSON string
  *
  * @return JSON string
  */
