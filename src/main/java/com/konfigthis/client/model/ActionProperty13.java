...
import com.konfigthis.client.model.ActionProperty13Error;
import com.konfigthis.client.model.ActionProperty13ResourcesInner;
...
public class ActionProperty13 {
  ...
  private ActionProperty13Error error;
  ...
  private List<ActionProperty13ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty13() {
  }

  public ActionProperty13 command(String command) {
  ...
  **/
  ...
  public ActionProperty13 error(ActionProperty13Error error) {
  ...
  **/
  ...
  public ActionProperty13Error getError() {
    return error;
  }


  public void setError(ActionProperty13Error error) {
  ...
  public ActionProperty13 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty13 id(Long id) {
  ...
  **/
  ...
  public ActionProperty13 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty13 resources(List<ActionProperty13ResourcesInner> resources) {
  ...
  public ActionProperty13 addResourcesItem(ActionProperty13ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty13ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty13ResourcesInner> resources) {
  ...
  public ActionProperty13 started(String started) {
  ...
  **/
  ...
  public ActionProperty13 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty13 instance itself
   */
  public ActionProperty13 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty13 actionProperty13 = (ActionProperty13) o;
    return Objects.equals(this.command, actionProperty13.command) &&
        Objects.equals(this.error, actionProperty13.error) &&
        Objects.equals(this.finished, actionProperty13.finished) &&
        Objects.equals(this.id, actionProperty13.id) &&
        Objects.equals(this.progress, actionProperty13.progress) &&
        Objects.equals(this.resources, actionProperty13.resources) &&
        Objects.equals(this.started, actionProperty13.started) &&
        Objects.equals(this.status, actionProperty13.status)&&
        Objects.equals(this.additionalProperties, actionProperty13.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty13 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty13
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty13.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty13 is not found in the empty JSON string", ActionProperty13.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty13.openapiRequiredFields) {
      ...
      ActionProperty13Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty13ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty13.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty13>() {
           @Override
           public void write(JsonWriter out, ActionProperty13 value) throws IOException {
           ...
           @Override
           public ActionProperty13 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty13 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty13 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty13
  * @throws IOException if the JSON string is invalid with respect to ActionProperty13
  */
  public static ActionProperty13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty13.class);
  }

 /**
  * Convert an instance of ActionProperty13 to an JSON string
  *
  * @return JSON string
  */
