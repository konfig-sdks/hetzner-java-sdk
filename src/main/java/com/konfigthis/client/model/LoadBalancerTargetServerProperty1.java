...
public class LoadBalancerTargetServerProperty1 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty1() {
  }

  public LoadBalancerTargetServerProperty1 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty1 instance itself
   */
  public LoadBalancerTargetServerProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty1 loadBalancerTargetServerProperty1 = (LoadBalancerTargetServerProperty1) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty1.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty1 is not found in the empty JSON string", LoadBalancerTargetServerProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty1>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty1 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty1
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty1
  */
  public static LoadBalancerTargetServerProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty1.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty1 to an JSON string
  *
  * @return JSON string
  */
