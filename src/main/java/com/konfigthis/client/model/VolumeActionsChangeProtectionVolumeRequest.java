...
public class VolumeActionsChangeProtectionVolumeRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public VolumeActionsChangeProtectionVolumeRequest() {
  }

  public VolumeActionsChangeProtectionVolumeRequest delete(Boolean delete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "If true, prevents the Volume from being deleted")
   ...
   * @return the VolumeActionsChangeProtectionVolumeRequest instance itself
   */
  public VolumeActionsChangeProtectionVolumeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeActionsChangeProtectionVolumeRequest volumeActionsChangeProtectionVolumeRequest = (VolumeActionsChangeProtectionVolumeRequest) o;
    return Objects.equals(this.delete, volumeActionsChangeProtectionVolumeRequest.delete)&&
        Objects.equals(this.additionalProperties, volumeActionsChangeProtectionVolumeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumeActionsChangeProtectionVolumeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionsChangeProtectionVolumeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionsChangeProtectionVolumeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionsChangeProtectionVolumeRequest is not found in the empty JSON string", VolumeActionsChangeProtectionVolumeRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionsChangeProtectionVolumeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionsChangeProtectionVolumeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionsChangeProtectionVolumeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionsChangeProtectionVolumeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionsChangeProtectionVolumeRequest>() {
           @Override
           public void write(JsonWriter out, VolumeActionsChangeProtectionVolumeRequest value) throws IOException {
           ...
           @Override
           public VolumeActionsChangeProtectionVolumeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionsChangeProtectionVolumeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionsChangeProtectionVolumeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionsChangeProtectionVolumeRequest
  * @throws IOException if the JSON string is invalid with respect to VolumeActionsChangeProtectionVolumeRequest
  */
  public static VolumeActionsChangeProtectionVolumeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionsChangeProtectionVolumeRequest.class);
  }

 /**
  * Convert an instance of VolumeActionsChangeProtectionVolumeRequest to an JSON string
  *
  * @return JSON string
  */
