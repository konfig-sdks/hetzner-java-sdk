...
public class ServerActionsChangeDnsPtrRequest {
  ...
  public ServerActionsChangeDnsPtrRequest() {
  }

  public ServerActionsChangeDnsPtrRequest dnsPtr(String dnsPtr) {
  ...
  **/
  ...
  @ApiModelProperty(example = "server01.example.com", required = true, value = "Hostname to set as a reverse DNS PTR entry, reset to original value if `null`")
  ...
  public ServerActionsChangeDnsPtrRequest ip(String ip) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1.2.3.4", required = true, value = "Primary IP address for which the reverse DNS entry should be set")
   ...
   * @return the ServerActionsChangeDnsPtrRequest instance itself
   */
  public ServerActionsChangeDnsPtrRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsChangeDnsPtrRequest serverActionsChangeDnsPtrRequest = (ServerActionsChangeDnsPtrRequest) o;
    return Objects.equals(this.dnsPtr, serverActionsChangeDnsPtrRequest.dnsPtr) &&
        Objects.equals(this.ip, serverActionsChangeDnsPtrRequest.ip)&&
        Objects.equals(this.additionalProperties, serverActionsChangeDnsPtrRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsChangeDnsPtrRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsChangeDnsPtrRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsChangeDnsPtrRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsChangeDnsPtrRequest is not found in the empty JSON string", ServerActionsChangeDnsPtrRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsChangeDnsPtrRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsChangeDnsPtrRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsChangeDnsPtrRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsChangeDnsPtrRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsChangeDnsPtrRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsChangeDnsPtrRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsChangeDnsPtrRequest value) throws IOException {
           ...
           @Override
           public ServerActionsChangeDnsPtrRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsChangeDnsPtrRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsChangeDnsPtrRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsChangeDnsPtrRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsChangeDnsPtrRequest
  */
  public static ServerActionsChangeDnsPtrRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsChangeDnsPtrRequest.class);
  }

 /**
  * Convert an instance of ServerActionsChangeDnsPtrRequest to an JSON string
  *
  * @return JSON string
  */
