...
/**
 * ActionProperty5ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty5ResourcesInner {
  ...
  public ActionProperty5ResourcesInner() {
  }

  public ActionProperty5ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty5ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty5ResourcesInner instance itself
   */
  public ActionProperty5ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty5ResourcesInner actionProperty5ResourcesInner = (ActionProperty5ResourcesInner) o;
    return Objects.equals(this.id, actionProperty5ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty5ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty5ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty5ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty5ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty5ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty5ResourcesInner is not found in the empty JSON string", ActionProperty5ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty5ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty5ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty5ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty5ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty5ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty5ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty5ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty5ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty5ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty5ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty5ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty5ResourcesInner
  */
  public static ActionProperty5ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty5ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty5ResourcesInner to an JSON string
  *
  * @return JSON string
  */
