...
public class Action15Error {
  ...
  public Action15Error() {
  }

  public Action15Error code(String code) {
  ...
  **/
  ...
  public Action15Error message(String message) {
  ...
  **/
   ...
   * @return the Action15Error instance itself
   */
  public Action15Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action15Error action15Error = (Action15Error) o;
    return Objects.equals(this.code, action15Error.code) &&
        Objects.equals(this.message, action15Error.message)&&
        Objects.equals(this.additionalProperties, action15Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action15Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action15Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action15Error is not found in the empty JSON string", Action15Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action15Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action15Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action15Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action15Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action15Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action15Error>() {
           @Override
           public void write(JsonWriter out, Action15Error value) throws IOException {
           ...
           @Override
           public Action15Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action15Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action15Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action15Error
  * @throws IOException if the JSON string is invalid with respect to Action15Error
  */
  public static Action15Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action15Error.class);
  }

 /**
  * Convert an instance of Action15Error to an JSON string
  *
  * @return JSON string
  */
