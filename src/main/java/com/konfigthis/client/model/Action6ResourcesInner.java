...
/**
 * Action6ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action6ResourcesInner {
  ...
  public Action6ResourcesInner() {
  }

  public Action6ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action6ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action6ResourcesInner instance itself
   */
  public Action6ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action6ResourcesInner action6ResourcesInner = (Action6ResourcesInner) o;
    return Objects.equals(this.id, action6ResourcesInner.id) &&
        Objects.equals(this.type, action6ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action6ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action6ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action6ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action6ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action6ResourcesInner is not found in the empty JSON string", Action6ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action6ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action6ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action6ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action6ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action6ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action6ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action6ResourcesInner value) throws IOException {
           ...
           @Override
           public Action6ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action6ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action6ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action6ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action6ResourcesInner
  */
  public static Action6ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action6ResourcesInner.class);
  }

 /**
  * Convert an instance of Action6ResourcesInner to an JSON string
  *
  * @return JSON string
  */
