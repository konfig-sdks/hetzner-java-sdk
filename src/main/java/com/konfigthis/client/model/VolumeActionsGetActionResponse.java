...
import com.konfigthis.client.model.ActionProperty80;
...
public class VolumeActionsGetActionResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty80 action;

  public VolumeActionsGetActionResponse() {
  }

  public VolumeActionsGetActionResponse action(ActionProperty80 action) {
  ...
  **/
  ...
  public ActionProperty80 getAction() {
    return action;
  }


  public void setAction(ActionProperty80 action) {
   ...
   * @return the VolumeActionsGetActionResponse instance itself
   */
  public VolumeActionsGetActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeActionsGetActionResponse volumeActionsGetActionResponse = (VolumeActionsGetActionResponse) o;
    return Objects.equals(this.action, volumeActionsGetActionResponse.action)&&
        Objects.equals(this.additionalProperties, volumeActionsGetActionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumeActionsGetActionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionsGetActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionsGetActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionsGetActionResponse is not found in the empty JSON string", VolumeActionsGetActionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionsGetActionResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty80.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionsGetActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionsGetActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionsGetActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionsGetActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionsGetActionResponse>() {
           @Override
           public void write(JsonWriter out, VolumeActionsGetActionResponse value) throws IOException {
           ...
           @Override
           public VolumeActionsGetActionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionsGetActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionsGetActionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionsGetActionResponse
  * @throws IOException if the JSON string is invalid with respect to VolumeActionsGetActionResponse
  */
  public static VolumeActionsGetActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionsGetActionResponse.class);
  }

 /**
  * Convert an instance of VolumeActionsGetActionResponse to an JSON string
  *
  * @return JSON string
  */
