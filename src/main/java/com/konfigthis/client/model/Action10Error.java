...
public class Action10Error {
  ...
  public Action10Error() {
  }

  public Action10Error code(String code) {
  ...
  **/
  ...
  public Action10Error message(String message) {
  ...
  **/
   ...
   * @return the Action10Error instance itself
   */
  public Action10Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action10Error action10Error = (Action10Error) o;
    return Objects.equals(this.code, action10Error.code) &&
        Objects.equals(this.message, action10Error.message)&&
        Objects.equals(this.additionalProperties, action10Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action10Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action10Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action10Error is not found in the empty JSON string", Action10Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action10Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action10Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action10Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action10Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action10Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action10Error>() {
           @Override
           public void write(JsonWriter out, Action10Error value) throws IOException {
           ...
           @Override
           public Action10Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action10Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action10Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action10Error
  * @throws IOException if the JSON string is invalid with respect to Action10Error
  */
  public static Action10Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action10Error.class);
  }

 /**
  * Convert an instance of Action10Error to an JSON string
  *
  * @return JSON string
  */
