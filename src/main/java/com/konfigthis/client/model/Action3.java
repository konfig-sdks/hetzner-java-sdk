...
import com.konfigthis.client.model.Action3Error;
import com.konfigthis.client.model.Action3ResourcesInner;
...
public class Action3 {
  ...
  private List<Action3ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action3 command(String command) {
  ...
  **/
  ...
  public Action3 error(Action3Error error) {
  ...
  **/
  ...
  public Action3Error getError() {
    return error;
  }


  public void setError(Action3Error error) {
  ...
  public Action3 finished(String finished) {
  ...
  **/
  ...
  public Action3 progress(Integer progress) {
  ...
  **/
  ...
  public Action3 resources(List<Action3ResourcesInner> resources) {
  ...
  public Action3 addResourcesItem(Action3ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action3ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action3ResourcesInner> resources) {
  ...
  public Action3 started(String started) {
  ...
  **/
  ...
  public Action3 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action3 instance itself
   */
  public Action3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.command, action3.command) &&
        Objects.equals(this.error, action3.error) &&
        Objects.equals(this.finished, action3.finished) &&
        Objects.equals(this.id, action3.id) &&
        Objects.equals(this.progress, action3.progress) &&
        Objects.equals(this.resources, action3.resources) &&
        Objects.equals(this.started, action3.started) &&
        Objects.equals(this.status, action3.status)&&
        Objects.equals(this.additionalProperties, action3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action3 is not found in the empty JSON string", Action3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action3.openapiRequiredFields) {
      ...
      Action3Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action3ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action3.class));

       return (TypeAdapter<T>) new TypeAdapter<Action3>() {
           @Override
           public void write(JsonWriter out, Action3 value) throws IOException {
           ...
           @Override
           public Action3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action3
  * @throws IOException if the JSON string is invalid with respect to Action3
  */
  public static Action3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action3.class);
  }

 /**
  * Convert an instance of Action3 to an JSON string
  *
  * @return JSON string
  */
