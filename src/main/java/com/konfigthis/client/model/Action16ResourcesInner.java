...
/**
 * Action16ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action16ResourcesInner {
  ...
  public Action16ResourcesInner() {
  }

  public Action16ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action16ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action16ResourcesInner instance itself
   */
  public Action16ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action16ResourcesInner action16ResourcesInner = (Action16ResourcesInner) o;
    return Objects.equals(this.id, action16ResourcesInner.id) &&
        Objects.equals(this.type, action16ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action16ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action16ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action16ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action16ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action16ResourcesInner is not found in the empty JSON string", Action16ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action16ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action16ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action16ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action16ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action16ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action16ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action16ResourcesInner value) throws IOException {
           ...
           @Override
           public Action16ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action16ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action16ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action16ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action16ResourcesInner
  */
  public static Action16ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action16ResourcesInner.class);
  }

 /**
  * Convert an instance of Action16ResourcesInner to an JSON string
  *
  * @return JSON string
  */
