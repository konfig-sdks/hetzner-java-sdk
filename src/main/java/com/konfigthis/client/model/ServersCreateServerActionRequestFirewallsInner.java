...
public class ServersCreateServerActionRequestFirewallsInner {
  public static final String SERIALIZED_NAME_FIREWALL = "firewall";
  @SerializedName(SERIALIZED_NAME_FIREWALL)
  private Long firewall;

  public ServersCreateServerActionRequestFirewallsInner() {
  }

  public ServersCreateServerActionRequestFirewallsInner firewall(Long firewall) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "ID of the Firewall")
   ...
   * @return the ServersCreateServerActionRequestFirewallsInner instance itself
   */
  public ServersCreateServerActionRequestFirewallsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersCreateServerActionRequestFirewallsInner serversCreateServerActionRequestFirewallsInner = (ServersCreateServerActionRequestFirewallsInner) o;
    return Objects.equals(this.firewall, serversCreateServerActionRequestFirewallsInner.firewall)&&
        Objects.equals(this.additionalProperties, serversCreateServerActionRequestFirewallsInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersCreateServerActionRequestFirewallsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersCreateServerActionRequestFirewallsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersCreateServerActionRequestFirewallsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersCreateServerActionRequestFirewallsInner is not found in the empty JSON string", ServersCreateServerActionRequestFirewallsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersCreateServerActionRequestFirewallsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersCreateServerActionRequestFirewallsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersCreateServerActionRequestFirewallsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersCreateServerActionRequestFirewallsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersCreateServerActionRequestFirewallsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersCreateServerActionRequestFirewallsInner>() {
           @Override
           public void write(JsonWriter out, ServersCreateServerActionRequestFirewallsInner value) throws IOException {
           ...
           @Override
           public ServersCreateServerActionRequestFirewallsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersCreateServerActionRequestFirewallsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersCreateServerActionRequestFirewallsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersCreateServerActionRequestFirewallsInner
  * @throws IOException if the JSON string is invalid with respect to ServersCreateServerActionRequestFirewallsInner
  */
  public static ServersCreateServerActionRequestFirewallsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersCreateServerActionRequestFirewallsInner.class);
  }

 /**
  * Convert an instance of ServersCreateServerActionRequestFirewallsInner to an JSON string
  *
  * @return JSON string
  */
