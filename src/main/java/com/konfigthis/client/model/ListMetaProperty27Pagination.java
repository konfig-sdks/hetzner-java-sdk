...
public class ListMetaProperty27Pagination {
  ...
  public ListMetaProperty27Pagination() {
  }

  public ListMetaProperty27Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty27Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty27Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty27Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty27Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty27Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty27Pagination instance itself
   */
  public ListMetaProperty27Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty27Pagination listMetaProperty27Pagination = (ListMetaProperty27Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty27Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty27Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty27Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty27Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty27Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty27Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty27Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty27Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty27Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty27Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty27Pagination is not found in the empty JSON string", ListMetaProperty27Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty27Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty27Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty27Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty27Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty27Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty27Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty27Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty27Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty27Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty27Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty27Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty27Pagination
  */
  public static ListMetaProperty27Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty27Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty27Pagination to an JSON string
  *
  * @return JSON string
  */
