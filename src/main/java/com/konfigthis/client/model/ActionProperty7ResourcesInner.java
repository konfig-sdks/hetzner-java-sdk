...
/**
 * ActionProperty7ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty7ResourcesInner {
  ...
  public ActionProperty7ResourcesInner() {
  }

  public ActionProperty7ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty7ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty7ResourcesInner instance itself
   */
  public ActionProperty7ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty7ResourcesInner actionProperty7ResourcesInner = (ActionProperty7ResourcesInner) o;
    return Objects.equals(this.id, actionProperty7ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty7ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty7ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty7ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty7ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty7ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty7ResourcesInner is not found in the empty JSON string", ActionProperty7ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty7ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty7ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty7ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty7ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty7ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty7ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty7ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty7ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty7ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty7ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty7ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty7ResourcesInner
  */
  public static ActionProperty7ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty7ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty7ResourcesInner to an JSON string
  *
  * @return JSON string
  */
