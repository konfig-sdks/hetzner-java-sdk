...
import com.konfigthis.client.model.ListMetaProperty11Pagination;
...
public class ListMetaProperty11 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty11Pagination pagination;

  public ListMetaProperty11() {
  }

  public ListMetaProperty11 pagination(ListMetaProperty11Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty11Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty11Pagination pagination) {
   ...
   * @return the ListMetaProperty11 instance itself
   */
  public ListMetaProperty11 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty11 listMetaProperty11 = (ListMetaProperty11) o;
    return Objects.equals(this.pagination, listMetaProperty11.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty11.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty11 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty11
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty11.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty11 is not found in the empty JSON string", ListMetaProperty11.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty11.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty11Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty11.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty11>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty11 value) throws IOException {
           ...
           @Override
           public ListMetaProperty11 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty11 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty11 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty11
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty11
  */
  public static ListMetaProperty11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty11.class);
  }

 /**
  * Convert an instance of ListMetaProperty11 to an JSON string
  *
  * @return JSON string
  */
