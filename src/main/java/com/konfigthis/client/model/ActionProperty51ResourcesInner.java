...
/**
 * ActionProperty51ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty51ResourcesInner {
  ...
  public ActionProperty51ResourcesInner() {
  }

  public ActionProperty51ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty51ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty51ResourcesInner instance itself
   */
  public ActionProperty51ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty51ResourcesInner actionProperty51ResourcesInner = (ActionProperty51ResourcesInner) o;
    return Objects.equals(this.id, actionProperty51ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty51ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty51ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty51ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty51ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty51ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty51ResourcesInner is not found in the empty JSON string", ActionProperty51ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty51ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty51ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty51ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty51ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty51ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty51ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty51ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty51ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty51ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty51ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty51ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty51ResourcesInner
  */
  public static ActionProperty51ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty51ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty51ResourcesInner to an JSON string
  *
  * @return JSON string
  */
