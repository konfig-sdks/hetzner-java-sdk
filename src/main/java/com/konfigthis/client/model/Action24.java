...
import com.konfigthis.client.model.Action24Error;
import com.konfigthis.client.model.Action24ResourcesInner;
...
public class Action24 {
  ...
  private List<Action24ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action24 command(String command) {
  ...
  **/
  ...
  public Action24 error(Action24Error error) {
  ...
  **/
  ...
  public Action24Error getError() {
    return error;
  }


  public void setError(Action24Error error) {
  ...
  public Action24 finished(String finished) {
  ...
  **/
  ...
  public Action24 progress(Integer progress) {
  ...
  **/
  ...
  public Action24 resources(List<Action24ResourcesInner> resources) {
  ...
  public Action24 addResourcesItem(Action24ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action24ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action24ResourcesInner> resources) {
  ...
  public Action24 started(String started) {
  ...
  **/
  ...
  public Action24 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action24 instance itself
   */
  public Action24 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action24 action24 = (Action24) o;
    return Objects.equals(this.command, action24.command) &&
        Objects.equals(this.error, action24.error) &&
        Objects.equals(this.finished, action24.finished) &&
        Objects.equals(this.id, action24.id) &&
        Objects.equals(this.progress, action24.progress) &&
        Objects.equals(this.resources, action24.resources) &&
        Objects.equals(this.started, action24.started) &&
        Objects.equals(this.status, action24.status)&&
        Objects.equals(this.additionalProperties, action24.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action24
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action24.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action24 is not found in the empty JSON string", Action24.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action24.openapiRequiredFields) {
      ...
      Action24Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action24ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action24.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action24' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action24> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action24.class));

       return (TypeAdapter<T>) new TypeAdapter<Action24>() {
           @Override
           public void write(JsonWriter out, Action24 value) throws IOException {
           ...
           @Override
           public Action24 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action24 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action24 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action24
  * @throws IOException if the JSON string is invalid with respect to Action24
  */
  public static Action24 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action24.class);
  }

 /**
  * Convert an instance of Action24 to an JSON string
  *
  * @return JSON string
  */
