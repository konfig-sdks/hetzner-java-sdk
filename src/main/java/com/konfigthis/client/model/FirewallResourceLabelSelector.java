...
public class FirewallResourceLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public FirewallResourceLabelSelector() {
  }

  public FirewallResourceLabelSelector selector(String selector) {
  ...
  **/
   ...
   * @return the FirewallResourceLabelSelector instance itself
   */
  public FirewallResourceLabelSelector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallResourceLabelSelector firewallResourceLabelSelector = (FirewallResourceLabelSelector) o;
    return Objects.equals(this.selector, firewallResourceLabelSelector.selector)&&
        Objects.equals(this.additionalProperties, firewallResourceLabelSelector.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallResourceLabelSelector {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallResourceLabelSelector
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallResourceLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallResourceLabelSelector is not found in the empty JSON string", FirewallResourceLabelSelector.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallResourceLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallResourceLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallResourceLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallResourceLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallResourceLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallResourceLabelSelector>() {
           @Override
           public void write(JsonWriter out, FirewallResourceLabelSelector value) throws IOException {
           ...
           @Override
           public FirewallResourceLabelSelector read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallResourceLabelSelector instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallResourceLabelSelector given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallResourceLabelSelector
  * @throws IOException if the JSON string is invalid with respect to FirewallResourceLabelSelector
  */
  public static FirewallResourceLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallResourceLabelSelector.class);
  }

 /**
  * Convert an instance of FirewallResourceLabelSelector to an JSON string
  *
  * @return JSON string
  */
