...
import com.konfigthis.client.model.ActionProperty51;
...
public class ServerActionsAttachIsoToServerResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty51 action;

  public ServerActionsAttachIsoToServerResponse() {
  }

  public ServerActionsAttachIsoToServerResponse action(ActionProperty51 action) {
  ...
  **/
  ...
  public ActionProperty51 getAction() {
    return action;
  }


  public void setAction(ActionProperty51 action) {
   ...
   * @return the ServerActionsAttachIsoToServerResponse instance itself
   */
  public ServerActionsAttachIsoToServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsAttachIsoToServerResponse serverActionsAttachIsoToServerResponse = (ServerActionsAttachIsoToServerResponse) o;
    return Objects.equals(this.action, serverActionsAttachIsoToServerResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsAttachIsoToServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsAttachIsoToServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsAttachIsoToServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsAttachIsoToServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsAttachIsoToServerResponse is not found in the empty JSON string", ServerActionsAttachIsoToServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsAttachIsoToServerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty51.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsAttachIsoToServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsAttachIsoToServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsAttachIsoToServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsAttachIsoToServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsAttachIsoToServerResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsAttachIsoToServerResponse value) throws IOException {
           ...
           @Override
           public ServerActionsAttachIsoToServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsAttachIsoToServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsAttachIsoToServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsAttachIsoToServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsAttachIsoToServerResponse
  */
  public static ServerActionsAttachIsoToServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsAttachIsoToServerResponse.class);
  }

 /**
  * Convert an instance of ServerActionsAttachIsoToServerResponse to an JSON string
  *
  * @return JSON string
  */
