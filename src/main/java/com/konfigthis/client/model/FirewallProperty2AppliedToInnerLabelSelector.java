...
public class FirewallProperty2AppliedToInnerLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public FirewallProperty2AppliedToInnerLabelSelector() {
  }

  public FirewallProperty2AppliedToInnerLabelSelector selector(String selector) {
  ...
  **/
   ...
   * @return the FirewallProperty2AppliedToInnerLabelSelector instance itself
   */
  public FirewallProperty2AppliedToInnerLabelSelector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallProperty2AppliedToInnerLabelSelector firewallProperty2AppliedToInnerLabelSelector = (FirewallProperty2AppliedToInnerLabelSelector) o;
    return Objects.equals(this.selector, firewallProperty2AppliedToInnerLabelSelector.selector)&&
        Objects.equals(this.additionalProperties, firewallProperty2AppliedToInnerLabelSelector.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallProperty2AppliedToInnerLabelSelector {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallProperty2AppliedToInnerLabelSelector
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallProperty2AppliedToInnerLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallProperty2AppliedToInnerLabelSelector is not found in the empty JSON string", FirewallProperty2AppliedToInnerLabelSelector.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallProperty2AppliedToInnerLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallProperty2AppliedToInnerLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallProperty2AppliedToInnerLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallProperty2AppliedToInnerLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallProperty2AppliedToInnerLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallProperty2AppliedToInnerLabelSelector>() {
           @Override
           public void write(JsonWriter out, FirewallProperty2AppliedToInnerLabelSelector value) throws IOException {
           ...
           @Override
           public FirewallProperty2AppliedToInnerLabelSelector read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallProperty2AppliedToInnerLabelSelector instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallProperty2AppliedToInnerLabelSelector given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallProperty2AppliedToInnerLabelSelector
  * @throws IOException if the JSON string is invalid with respect to FirewallProperty2AppliedToInnerLabelSelector
  */
  public static FirewallProperty2AppliedToInnerLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallProperty2AppliedToInnerLabelSelector.class);
  }

 /**
  * Convert an instance of FirewallProperty2AppliedToInnerLabelSelector to an JSON string
  *
  * @return JSON string
  */
