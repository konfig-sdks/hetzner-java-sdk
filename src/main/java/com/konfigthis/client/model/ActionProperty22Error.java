...
public class ActionProperty22Error {
  ...
  public ActionProperty22Error() {
  }

  public ActionProperty22Error code(String code) {
  ...
  **/
  ...
  public ActionProperty22Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty22Error instance itself
   */
  public ActionProperty22Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty22Error actionProperty22Error = (ActionProperty22Error) o;
    return Objects.equals(this.code, actionProperty22Error.code) &&
        Objects.equals(this.message, actionProperty22Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty22Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty22Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty22Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty22Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty22Error is not found in the empty JSON string", ActionProperty22Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty22Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty22Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty22Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty22Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty22Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty22Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty22Error value) throws IOException {
           ...
           @Override
           public ActionProperty22Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty22Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty22Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty22Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty22Error
  */
  public static ActionProperty22Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty22Error.class);
  }

 /**
  * Convert an instance of ActionProperty22Error to an JSON string
  *
  * @return JSON string
  */
