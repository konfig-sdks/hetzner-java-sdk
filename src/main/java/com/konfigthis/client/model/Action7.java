...
import com.konfigthis.client.model.Action7Error;
import com.konfigthis.client.model.Action7ResourcesInner;
...
public class Action7 {
  ...
  private List<Action7ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action7 command(String command) {
  ...
  **/
  ...
  public Action7 error(Action7Error error) {
  ...
  **/
  ...
  public Action7Error getError() {
    return error;
  }


  public void setError(Action7Error error) {
  ...
  public Action7 finished(String finished) {
  ...
  **/
  ...
  public Action7 progress(Integer progress) {
  ...
  **/
  ...
  public Action7 resources(List<Action7ResourcesInner> resources) {
  ...
  public Action7 addResourcesItem(Action7ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action7ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action7ResourcesInner> resources) {
  ...
  public Action7 started(String started) {
  ...
  **/
  ...
  public Action7 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action7 instance itself
   */
  public Action7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action7 action7 = (Action7) o;
    return Objects.equals(this.command, action7.command) &&
        Objects.equals(this.error, action7.error) &&
        Objects.equals(this.finished, action7.finished) &&
        Objects.equals(this.id, action7.id) &&
        Objects.equals(this.progress, action7.progress) &&
        Objects.equals(this.resources, action7.resources) &&
        Objects.equals(this.started, action7.started) &&
        Objects.equals(this.status, action7.status)&&
        Objects.equals(this.additionalProperties, action7.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action7 is not found in the empty JSON string", Action7.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action7.openapiRequiredFields) {
      ...
      Action7Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action7ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action7.class));

       return (TypeAdapter<T>) new TypeAdapter<Action7>() {
           @Override
           public void write(JsonWriter out, Action7 value) throws IOException {
           ...
           @Override
           public Action7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action7
  * @throws IOException if the JSON string is invalid with respect to Action7
  */
  public static Action7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action7.class);
  }

 /**
  * Convert an instance of Action7 to an JSON string
  *
  * @return JSON string
  */
