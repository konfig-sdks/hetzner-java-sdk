...
public class ServerActionsCreateImageRequest {
 ...
 public enum TypeEnum {
  ...
  private TypeEnum type = TypeEnum.SNAPSHOT;

  public ServerActionsCreateImageRequest() {
  }

  public ServerActionsCreateImageRequest description(String description) {
  ...
  **/
  ...
  @ApiModelProperty(example = "my image", value = "Description of the Image, will be auto-generated if not set")
  ...
  public ServerActionsCreateImageRequest labels(ServerActionsCreateImageRequestLabels labels) {
  ...
  **/
  ...
  public ServerActionsCreateImageRequestLabels getLabels() {
    return labels;
  }


  public void setLabels(ServerActionsCreateImageRequestLabels labels) {
  ...
  public ServerActionsCreateImageRequest type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SNAPSHOT", value = "Type of Image to create.")
   ...
   * @return the ServerActionsCreateImageRequest instance itself
   */
  public ServerActionsCreateImageRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsCreateImageRequest serverActionsCreateImageRequest = (ServerActionsCreateImageRequest) o;
    return Objects.equals(this.description, serverActionsCreateImageRequest.description) &&
        Objects.equals(this.labels, serverActionsCreateImageRequest.labels) &&
        Objects.equals(this.type, serverActionsCreateImageRequest.type)&&
        Objects.equals(this.additionalProperties, serverActionsCreateImageRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, labels, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerActionsCreateImageRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsCreateImageRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsCreateImageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsCreateImageRequest is not found in the empty JSON string", ServerActionsCreateImageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        ServerActionsCreateImageRequestLabels.validateJsonObject(jsonObj.getAsJsonObject("labels"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsCreateImageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsCreateImageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsCreateImageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsCreateImageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsCreateImageRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsCreateImageRequest value) throws IOException {
           ...
           @Override
           public ServerActionsCreateImageRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsCreateImageRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsCreateImageRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsCreateImageRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsCreateImageRequest
  */
  public static ServerActionsCreateImageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsCreateImageRequest.class);
  }

 /**
  * Convert an instance of ServerActionsCreateImageRequest to an JSON string
  *
  * @return JSON string
  */
