...
public class LoadBalancerServiceHTTPProperty6 {
  ...
  public LoadBalancerServiceHTTPProperty6() {
  }

  public LoadBalancerServiceHTTPProperty6 certificates(List<Long> certificates) {
  ...
  public LoadBalancerServiceHTTPProperty6 addCertificatesItem(Long certificatesItem) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty6 cookieLifetime(Integer cookieLifetime) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty6 cookieName(String cookieName) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty6 redirectHttp(Boolean redirectHttp) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty6 stickySessions(Boolean stickySessions) {
  ...
  **/
   ...
   * @return the LoadBalancerServiceHTTPProperty6 instance itself
   */
  public LoadBalancerServiceHTTPProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerServiceHTTPProperty6 loadBalancerServiceHTTPProperty6 = (LoadBalancerServiceHTTPProperty6) o;
    return Objects.equals(this.certificates, loadBalancerServiceHTTPProperty6.certificates) &&
        Objects.equals(this.cookieLifetime, loadBalancerServiceHTTPProperty6.cookieLifetime) &&
        Objects.equals(this.cookieName, loadBalancerServiceHTTPProperty6.cookieName) &&
        Objects.equals(this.redirectHttp, loadBalancerServiceHTTPProperty6.redirectHttp) &&
        Objects.equals(this.stickySessions, loadBalancerServiceHTTPProperty6.stickySessions)&&
        Objects.equals(this.additionalProperties, loadBalancerServiceHTTPProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerServiceHTTPProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerServiceHTTPProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerServiceHTTPProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerServiceHTTPProperty6 is not found in the empty JSON string", LoadBalancerServiceHTTPProperty6.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerServiceHTTPProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerServiceHTTPProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerServiceHTTPProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerServiceHTTPProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerServiceHTTPProperty6>() {
           @Override
           public void write(JsonWriter out, LoadBalancerServiceHTTPProperty6 value) throws IOException {
           ...
           @Override
           public LoadBalancerServiceHTTPProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerServiceHTTPProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerServiceHTTPProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerServiceHTTPProperty6
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerServiceHTTPProperty6
  */
  public static LoadBalancerServiceHTTPProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerServiceHTTPProperty6.class);
  }

 /**
  * Convert an instance of LoadBalancerServiceHTTPProperty6 to an JSON string
  *
  * @return JSON string
  */
