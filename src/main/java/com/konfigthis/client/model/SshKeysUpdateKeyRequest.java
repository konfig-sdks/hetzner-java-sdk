...
public class SshKeysUpdateKeyRequest {
  ...
  public SshKeysUpdateKeyRequest() {
  }

  public SshKeysUpdateKeyRequest labels(Object labels) {
  ...
  **/
  ...
  public SshKeysUpdateKeyRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "My ssh key", value = "New name Name to set")
   ...
   * @return the SshKeysUpdateKeyRequest instance itself
   */
  public SshKeysUpdateKeyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysUpdateKeyRequest sshKeysUpdateKeyRequest = (SshKeysUpdateKeyRequest) o;
    return Objects.equals(this.labels, sshKeysUpdateKeyRequest.labels) &&
        Objects.equals(this.name, sshKeysUpdateKeyRequest.name)&&
        Objects.equals(this.additionalProperties, sshKeysUpdateKeyRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysUpdateKeyRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysUpdateKeyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysUpdateKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysUpdateKeyRequest is not found in the empty JSON string", SshKeysUpdateKeyRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysUpdateKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysUpdateKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysUpdateKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysUpdateKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysUpdateKeyRequest>() {
           @Override
           public void write(JsonWriter out, SshKeysUpdateKeyRequest value) throws IOException {
           ...
           @Override
           public SshKeysUpdateKeyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysUpdateKeyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysUpdateKeyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysUpdateKeyRequest
  * @throws IOException if the JSON string is invalid with respect to SshKeysUpdateKeyRequest
  */
  public static SshKeysUpdateKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysUpdateKeyRequest.class);
  }

 /**
  * Convert an instance of SshKeysUpdateKeyRequest to an JSON string
  *
  * @return JSON string
  */
