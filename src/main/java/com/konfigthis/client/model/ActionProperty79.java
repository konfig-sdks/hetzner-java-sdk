...
import com.konfigthis.client.model.ActionProperty79Error;
import com.konfigthis.client.model.ActionProperty79ResourcesInner;
...
public class ActionProperty79 {
  ...
  private ActionProperty79Error error;
  ...
  private List<ActionProperty79ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty79() {
  }

  public ActionProperty79 command(String command) {
  ...
  **/
  ...
  public ActionProperty79 error(ActionProperty79Error error) {
  ...
  **/
  ...
  public ActionProperty79Error getError() {
    return error;
  }


  public void setError(ActionProperty79Error error) {
  ...
  public ActionProperty79 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty79 id(Long id) {
  ...
  **/
  ...
  public ActionProperty79 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty79 resources(List<ActionProperty79ResourcesInner> resources) {
  ...
  public ActionProperty79 addResourcesItem(ActionProperty79ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty79ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty79ResourcesInner> resources) {
  ...
  public ActionProperty79 started(String started) {
  ...
  **/
  ...
  public ActionProperty79 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty79 instance itself
   */
  public ActionProperty79 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty79 actionProperty79 = (ActionProperty79) o;
    return Objects.equals(this.command, actionProperty79.command) &&
        Objects.equals(this.error, actionProperty79.error) &&
        Objects.equals(this.finished, actionProperty79.finished) &&
        Objects.equals(this.id, actionProperty79.id) &&
        Objects.equals(this.progress, actionProperty79.progress) &&
        Objects.equals(this.resources, actionProperty79.resources) &&
        Objects.equals(this.started, actionProperty79.started) &&
        Objects.equals(this.status, actionProperty79.status)&&
        Objects.equals(this.additionalProperties, actionProperty79.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty79 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty79
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty79.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty79 is not found in the empty JSON string", ActionProperty79.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty79.openapiRequiredFields) {
      ...
      ActionProperty79Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty79ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty79.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty79' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty79> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty79.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty79>() {
           @Override
           public void write(JsonWriter out, ActionProperty79 value) throws IOException {
           ...
           @Override
           public ActionProperty79 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty79 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty79 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty79
  * @throws IOException if the JSON string is invalid with respect to ActionProperty79
  */
  public static ActionProperty79 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty79.class);
  }

 /**
  * Convert an instance of ActionProperty79 to an JSON string
  *
  * @return JSON string
  */
