...
import com.konfigthis.client.model.CertificateProperty1;
...
public class CertificatesGetByIdResponse {
  public static final String SERIALIZED_NAME_CERTIFICATE = "certificate";
  @SerializedName(SERIALIZED_NAME_CERTIFICATE)
  private CertificateProperty1 certificate;

  public CertificatesGetByIdResponse() {
  }

  public CertificatesGetByIdResponse certificate(CertificateProperty1 certificate) {
  ...
  **/
  ...
  public CertificateProperty1 getCertificate() {
    return certificate;
  }


  public void setCertificate(CertificateProperty1 certificate) {
   ...
   * @return the CertificatesGetByIdResponse instance itself
   */
  public CertificatesGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatesGetByIdResponse certificatesGetByIdResponse = (CertificatesGetByIdResponse) o;
    return Objects.equals(this.certificate, certificatesGetByIdResponse.certificate)&&
        Objects.equals(this.additionalProperties, certificatesGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificatesGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatesGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatesGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesGetByIdResponse is not found in the empty JSON string", CertificatesGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificatesGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `certificate`
      CertificateProperty1.validateJsonObject(jsonObj.getAsJsonObject("certificate"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, CertificatesGetByIdResponse value) throws IOException {
           ...
           @Override
           public CertificatesGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatesGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatesGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatesGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to CertificatesGetByIdResponse
  */
  public static CertificatesGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesGetByIdResponse.class);
  }

 /**
  * Convert an instance of CertificatesGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
