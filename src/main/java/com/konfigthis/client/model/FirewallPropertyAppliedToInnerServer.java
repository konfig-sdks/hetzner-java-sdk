...
public class FirewallPropertyAppliedToInnerServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public FirewallPropertyAppliedToInnerServer() {
  }

  public FirewallPropertyAppliedToInnerServer id(Long id) {
  ...
  **/
   ...
   * @return the FirewallPropertyAppliedToInnerServer instance itself
   */
  public FirewallPropertyAppliedToInnerServer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallPropertyAppliedToInnerServer firewallPropertyAppliedToInnerServer = (FirewallPropertyAppliedToInnerServer) o;
    return Objects.equals(this.id, firewallPropertyAppliedToInnerServer.id)&&
        Objects.equals(this.additionalProperties, firewallPropertyAppliedToInnerServer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallPropertyAppliedToInnerServer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallPropertyAppliedToInnerServer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallPropertyAppliedToInnerServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallPropertyAppliedToInnerServer is not found in the empty JSON string", FirewallPropertyAppliedToInnerServer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallPropertyAppliedToInnerServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallPropertyAppliedToInnerServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallPropertyAppliedToInnerServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallPropertyAppliedToInnerServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallPropertyAppliedToInnerServer.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallPropertyAppliedToInnerServer>() {
           @Override
           public void write(JsonWriter out, FirewallPropertyAppliedToInnerServer value) throws IOException {
           ...
           @Override
           public FirewallPropertyAppliedToInnerServer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallPropertyAppliedToInnerServer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallPropertyAppliedToInnerServer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallPropertyAppliedToInnerServer
  * @throws IOException if the JSON string is invalid with respect to FirewallPropertyAppliedToInnerServer
  */
  public static FirewallPropertyAppliedToInnerServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallPropertyAppliedToInnerServer.class);
  }

 /**
  * Convert an instance of FirewallPropertyAppliedToInnerServer to an JSON string
  *
  * @return JSON string
  */
