...
import com.konfigthis.client.model.ListMetaProperty1Pagination;
...
public class ListMetaProperty1 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty1Pagination pagination;

  public ListMetaProperty1() {
  }

  public ListMetaProperty1 pagination(ListMetaProperty1Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty1Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty1Pagination pagination) {
   ...
   * @return the ListMetaProperty1 instance itself
   */
  public ListMetaProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty1 listMetaProperty1 = (ListMetaProperty1) o;
    return Objects.equals(this.pagination, listMetaProperty1.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty1 is not found in the empty JSON string", ListMetaProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty1.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty1Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty1>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty1 value) throws IOException {
           ...
           @Override
           public ListMetaProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty1
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty1
  */
  public static ListMetaProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty1.class);
  }

 /**
  * Convert an instance of ListMetaProperty1 to an JSON string
  *
  * @return JSON string
  */
