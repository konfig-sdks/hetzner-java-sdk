...
import com.konfigthis.client.model.ActionProperty55Error;
import com.konfigthis.client.model.ActionProperty55ResourcesInner;
...
public class ActionProperty55 {
  ...
  private ActionProperty55Error error;
  ...
  private List<ActionProperty55ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty55() {
  }

  public ActionProperty55 command(String command) {
  ...
  **/
  ...
  public ActionProperty55 error(ActionProperty55Error error) {
  ...
  **/
  ...
  public ActionProperty55Error getError() {
    return error;
  }


  public void setError(ActionProperty55Error error) {
  ...
  public ActionProperty55 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty55 id(Long id) {
  ...
  **/
  ...
  public ActionProperty55 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty55 resources(List<ActionProperty55ResourcesInner> resources) {
  ...
  public ActionProperty55 addResourcesItem(ActionProperty55ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty55ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty55ResourcesInner> resources) {
  ...
  public ActionProperty55 started(String started) {
  ...
  **/
  ...
  public ActionProperty55 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty55 instance itself
   */
  public ActionProperty55 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty55 actionProperty55 = (ActionProperty55) o;
    return Objects.equals(this.command, actionProperty55.command) &&
        Objects.equals(this.error, actionProperty55.error) &&
        Objects.equals(this.finished, actionProperty55.finished) &&
        Objects.equals(this.id, actionProperty55.id) &&
        Objects.equals(this.progress, actionProperty55.progress) &&
        Objects.equals(this.resources, actionProperty55.resources) &&
        Objects.equals(this.started, actionProperty55.started) &&
        Objects.equals(this.status, actionProperty55.status)&&
        Objects.equals(this.additionalProperties, actionProperty55.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty55 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty55
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty55.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty55 is not found in the empty JSON string", ActionProperty55.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty55.openapiRequiredFields) {
      ...
      ActionProperty55Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty55ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty55.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty55' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty55> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty55.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty55>() {
           @Override
           public void write(JsonWriter out, ActionProperty55 value) throws IOException {
           ...
           @Override
           public ActionProperty55 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty55 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty55 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty55
  * @throws IOException if the JSON string is invalid with respect to ActionProperty55
  */
  public static ActionProperty55 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty55.class);
  }

 /**
  * Convert an instance of ActionProperty55 to an JSON string
  *
  * @return JSON string
  */
