...
import com.konfigthis.client.model.ActionProperty15;
...
public class ImageActionsChangeProtectionResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty15 action;

  public ImageActionsChangeProtectionResponse() {
  }

  public ImageActionsChangeProtectionResponse action(ActionProperty15 action) {
  ...
  **/
  ...
  public ActionProperty15 getAction() {
    return action;
  }


  public void setAction(ActionProperty15 action) {
   ...
   * @return the ImageActionsChangeProtectionResponse instance itself
   */
  public ImageActionsChangeProtectionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImageActionsChangeProtectionResponse imageActionsChangeProtectionResponse = (ImageActionsChangeProtectionResponse) o;
    return Objects.equals(this.action, imageActionsChangeProtectionResponse.action)&&
        Objects.equals(this.additionalProperties, imageActionsChangeProtectionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageActionsChangeProtectionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageActionsChangeProtectionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageActionsChangeProtectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageActionsChangeProtectionResponse is not found in the empty JSON string", ImageActionsChangeProtectionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageActionsChangeProtectionResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty15.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageActionsChangeProtectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageActionsChangeProtectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageActionsChangeProtectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageActionsChangeProtectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageActionsChangeProtectionResponse>() {
           @Override
           public void write(JsonWriter out, ImageActionsChangeProtectionResponse value) throws IOException {
           ...
           @Override
           public ImageActionsChangeProtectionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageActionsChangeProtectionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageActionsChangeProtectionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageActionsChangeProtectionResponse
  * @throws IOException if the JSON string is invalid with respect to ImageActionsChangeProtectionResponse
  */
  public static ImageActionsChangeProtectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageActionsChangeProtectionResponse.class);
  }

 /**
  * Convert an instance of ImageActionsChangeProtectionResponse to an JSON string
  *
  * @return JSON string
  */
