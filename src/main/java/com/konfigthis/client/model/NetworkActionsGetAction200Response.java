...
import com.konfigthis.client.model.ActionProperty40;
...
public class NetworkActionsGetAction200Response {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty40 action;

  public NetworkActionsGetAction200Response() {
  }

  public NetworkActionsGetAction200Response action(ActionProperty40 action) {
  ...
  **/
  ...
  public ActionProperty40 getAction() {
    return action;
  }


  public void setAction(ActionProperty40 action) {
   ...
   * @return the NetworkActionsGetAction200Response instance itself
   */
  public NetworkActionsGetAction200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsGetAction200Response networkActionsGetAction200Response = (NetworkActionsGetAction200Response) o;
    return Objects.equals(this.action, networkActionsGetAction200Response.action)&&
        Objects.equals(this.additionalProperties, networkActionsGetAction200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsGetAction200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsGetAction200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsGetAction200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsGetAction200Response is not found in the empty JSON string", NetworkActionsGetAction200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsGetAction200Response.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty40.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsGetAction200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsGetAction200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsGetAction200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsGetAction200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsGetAction200Response>() {
           @Override
           public void write(JsonWriter out, NetworkActionsGetAction200Response value) throws IOException {
           ...
           @Override
           public NetworkActionsGetAction200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsGetAction200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsGetAction200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsGetAction200Response
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsGetAction200Response
  */
  public static NetworkActionsGetAction200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsGetAction200Response.class);
  }

 /**
  * Convert an instance of NetworkActionsGetAction200Response to an JSON string
  *
  * @return JSON string
  */
