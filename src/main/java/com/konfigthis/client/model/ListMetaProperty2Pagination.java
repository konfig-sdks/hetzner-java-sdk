...
public class ListMetaProperty2Pagination {
  ...
  public ListMetaProperty2Pagination() {
  }

  public ListMetaProperty2Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty2Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty2Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty2Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty2Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty2Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty2Pagination instance itself
   */
  public ListMetaProperty2Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty2Pagination listMetaProperty2Pagination = (ListMetaProperty2Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty2Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty2Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty2Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty2Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty2Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty2Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty2Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty2Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty2Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty2Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty2Pagination is not found in the empty JSON string", ListMetaProperty2Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty2Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty2Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty2Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty2Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty2Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty2Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty2Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty2Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty2Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty2Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty2Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty2Pagination
  */
  public static ListMetaProperty2Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty2Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty2Pagination to an JSON string
  *
  * @return JSON string
  */
