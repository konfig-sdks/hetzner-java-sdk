...
import com.konfigthis.client.model.ActionProperty33Error;
import com.konfigthis.client.model.ActionProperty33ResourcesInner;
...
public class ActionProperty33 {
  ...
  private ActionProperty33Error error;
  ...
  private List<ActionProperty33ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty33() {
  }

  public ActionProperty33 command(String command) {
  ...
  **/
  ...
  public ActionProperty33 error(ActionProperty33Error error) {
  ...
  **/
  ...
  public ActionProperty33Error getError() {
    return error;
  }


  public void setError(ActionProperty33Error error) {
  ...
  public ActionProperty33 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty33 id(Long id) {
  ...
  **/
  ...
  public ActionProperty33 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty33 resources(List<ActionProperty33ResourcesInner> resources) {
  ...
  public ActionProperty33 addResourcesItem(ActionProperty33ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty33ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty33ResourcesInner> resources) {
  ...
  public ActionProperty33 started(String started) {
  ...
  **/
  ...
  public ActionProperty33 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty33 instance itself
   */
  public ActionProperty33 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty33 actionProperty33 = (ActionProperty33) o;
    return Objects.equals(this.command, actionProperty33.command) &&
        Objects.equals(this.error, actionProperty33.error) &&
        Objects.equals(this.finished, actionProperty33.finished) &&
        Objects.equals(this.id, actionProperty33.id) &&
        Objects.equals(this.progress, actionProperty33.progress) &&
        Objects.equals(this.resources, actionProperty33.resources) &&
        Objects.equals(this.started, actionProperty33.started) &&
        Objects.equals(this.status, actionProperty33.status)&&
        Objects.equals(this.additionalProperties, actionProperty33.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty33 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty33
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty33.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty33 is not found in the empty JSON string", ActionProperty33.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty33.openapiRequiredFields) {
      ...
      ActionProperty33Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty33ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty33.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty33' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty33> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty33.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty33>() {
           @Override
           public void write(JsonWriter out, ActionProperty33 value) throws IOException {
           ...
           @Override
           public ActionProperty33 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty33 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty33 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty33
  * @throws IOException if the JSON string is invalid with respect to ActionProperty33
  */
  public static ActionProperty33 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty33.class);
  }

 /**
  * Convert an instance of ActionProperty33 to an JSON string
  *
  * @return JSON string
  */
