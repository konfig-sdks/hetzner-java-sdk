...
public class Action2Error {
  ...
  public Action2Error code(String code) {
  ...
  **/
  ...
  public Action2Error message(String message) {
  ...
  **/
   ...
   * @return the Action2Error instance itself
   */
  public Action2Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action2Error action2Error = (Action2Error) o;
    return Objects.equals(this.code, action2Error.code) &&
        Objects.equals(this.message, action2Error.message)&&
        Objects.equals(this.additionalProperties, action2Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action2Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action2Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action2Error is not found in the empty JSON string", Action2Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action2Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action2Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action2Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action2Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action2Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action2Error>() {
           @Override
           public void write(JsonWriter out, Action2Error value) throws IOException {
           ...
           @Override
           public Action2Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action2Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action2Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action2Error
  * @throws IOException if the JSON string is invalid with respect to Action2Error
  */
  public static Action2Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action2Error.class);
  }

 /**
  * Convert an instance of Action2Error to an JSON string
  *
  * @return JSON string
  */
