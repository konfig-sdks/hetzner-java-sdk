...
public class Action3Error {
  ...
  public Action3Error code(String code) {
  ...
  **/
  ...
  public Action3Error message(String message) {
  ...
  **/
   ...
   * @return the Action3Error instance itself
   */
  public Action3Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action3Error action3Error = (Action3Error) o;
    return Objects.equals(this.code, action3Error.code) &&
        Objects.equals(this.message, action3Error.message)&&
        Objects.equals(this.additionalProperties, action3Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action3Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action3Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action3Error is not found in the empty JSON string", Action3Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action3Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action3Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action3Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action3Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action3Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action3Error>() {
           @Override
           public void write(JsonWriter out, Action3Error value) throws IOException {
           ...
           @Override
           public Action3Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action3Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action3Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action3Error
  * @throws IOException if the JSON string is invalid with respect to Action3Error
  */
  public static Action3Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action3Error.class);
  }

 /**
  * Convert an instance of Action3Error to an JSON string
  *
  * @return JSON string
  */
