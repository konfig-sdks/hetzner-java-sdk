...
import com.konfigthis.client.model.ImagesGetByIdResponseImage;
...
public class ImagesGetByIdResponse {
  public static final String SERIALIZED_NAME_IMAGE = "image";
  @SerializedName(SERIALIZED_NAME_IMAGE)
  private ImagesGetByIdResponseImage image;

  public ImagesGetByIdResponse() {
  }

  public ImagesGetByIdResponse image(ImagesGetByIdResponseImage image) {
  ...
  **/
  ...
  public ImagesGetByIdResponseImage getImage() {
    return image;
  }


  public void setImage(ImagesGetByIdResponseImage image) {
   ...
   * @return the ImagesGetByIdResponse instance itself
   */
  public ImagesGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesGetByIdResponse imagesGetByIdResponse = (ImagesGetByIdResponse) o;
    return Objects.equals(this.image, imagesGetByIdResponse.image)&&
        Objects.equals(this.additionalProperties, imagesGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGetByIdResponse is not found in the empty JSON string", ImagesGetByIdResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `image`
      if (jsonObj.get("image") != null && !jsonObj.get("image").isJsonNull()) {
        ImagesGetByIdResponseImage.validateJsonObject(jsonObj.getAsJsonObject("image"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, ImagesGetByIdResponse value) throws IOException {
           ...
           @Override
           public ImagesGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to ImagesGetByIdResponse
  */
  public static ImagesGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGetByIdResponse.class);
  }

 /**
  * Convert an instance of ImagesGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
