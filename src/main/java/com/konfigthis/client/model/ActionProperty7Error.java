...
public class ActionProperty7Error {
  ...
  public ActionProperty7Error() {
  }

  public ActionProperty7Error code(String code) {
  ...
  **/
  ...
  public ActionProperty7Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty7Error instance itself
   */
  public ActionProperty7Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty7Error actionProperty7Error = (ActionProperty7Error) o;
    return Objects.equals(this.code, actionProperty7Error.code) &&
        Objects.equals(this.message, actionProperty7Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty7Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty7Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty7Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty7Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty7Error is not found in the empty JSON string", ActionProperty7Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty7Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty7Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty7Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty7Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty7Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty7Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty7Error value) throws IOException {
           ...
           @Override
           public ActionProperty7Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty7Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty7Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty7Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty7Error
  */
  public static ActionProperty7Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty7Error.class);
  }

 /**
  * Convert an instance of ActionProperty7Error to an JSON string
  *
  * @return JSON string
  */
