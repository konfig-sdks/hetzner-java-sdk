...
import com.konfigthis.client.model.Action10Error;
import com.konfigthis.client.model.Action10ResourcesInner;
...
public class Action10 {
  ...
  private List<Action10ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action10 command(String command) {
  ...
  **/
  ...
  public Action10 error(Action10Error error) {
  ...
  **/
  ...
  public Action10Error getError() {
    return error;
  }


  public void setError(Action10Error error) {
  ...
  public Action10 finished(String finished) {
  ...
  **/
  ...
  public Action10 progress(Integer progress) {
  ...
  **/
  ...
  public Action10 resources(List<Action10ResourcesInner> resources) {
  ...
  public Action10 addResourcesItem(Action10ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action10ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action10ResourcesInner> resources) {
  ...
  public Action10 started(String started) {
  ...
  **/
  ...
  public Action10 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action10 instance itself
   */
  public Action10 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action10 action10 = (Action10) o;
    return Objects.equals(this.command, action10.command) &&
        Objects.equals(this.error, action10.error) &&
        Objects.equals(this.finished, action10.finished) &&
        Objects.equals(this.id, action10.id) &&
        Objects.equals(this.progress, action10.progress) &&
        Objects.equals(this.resources, action10.resources) &&
        Objects.equals(this.started, action10.started) &&
        Objects.equals(this.status, action10.status)&&
        Objects.equals(this.additionalProperties, action10.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action10
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action10.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action10 is not found in the empty JSON string", Action10.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action10.openapiRequiredFields) {
      ...
      Action10Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action10ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action10.class));

       return (TypeAdapter<T>) new TypeAdapter<Action10>() {
           @Override
           public void write(JsonWriter out, Action10 value) throws IOException {
           ...
           @Override
           public Action10 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action10 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action10 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action10
  * @throws IOException if the JSON string is invalid with respect to Action10
  */
  public static Action10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action10.class);
  }

 /**
  * Convert an instance of Action10 to an JSON string
  *
  * @return JSON string
  */
