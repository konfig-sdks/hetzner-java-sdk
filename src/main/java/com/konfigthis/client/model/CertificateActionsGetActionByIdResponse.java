...
import com.konfigthis.client.model.ActionProperty4;
...
public class CertificateActionsGetActionByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty4 action;

  public CertificateActionsGetActionByIdResponse() {
  }

  public CertificateActionsGetActionByIdResponse action(ActionProperty4 action) {
  ...
  **/
  ...
  public ActionProperty4 getAction() {
    return action;
  }


  public void setAction(ActionProperty4 action) {
   ...
   * @return the CertificateActionsGetActionByIdResponse instance itself
   */
  public CertificateActionsGetActionByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateActionsGetActionByIdResponse certificateActionsGetActionByIdResponse = (CertificateActionsGetActionByIdResponse) o;
    return Objects.equals(this.action, certificateActionsGetActionByIdResponse.action)&&
        Objects.equals(this.additionalProperties, certificateActionsGetActionByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateActionsGetActionByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateActionsGetActionByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateActionsGetActionByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateActionsGetActionByIdResponse is not found in the empty JSON string", CertificateActionsGetActionByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateActionsGetActionByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty4.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateActionsGetActionByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateActionsGetActionByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateActionsGetActionByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateActionsGetActionByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateActionsGetActionByIdResponse>() {
           @Override
           public void write(JsonWriter out, CertificateActionsGetActionByIdResponse value) throws IOException {
           ...
           @Override
           public CertificateActionsGetActionByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateActionsGetActionByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateActionsGetActionByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateActionsGetActionByIdResponse
  * @throws IOException if the JSON string is invalid with respect to CertificateActionsGetActionByIdResponse
  */
  public static CertificateActionsGetActionByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateActionsGetActionByIdResponse.class);
  }

 /**
  * Convert an instance of CertificateActionsGetActionByIdResponse to an JSON string
  *
  * @return JSON string
  */
