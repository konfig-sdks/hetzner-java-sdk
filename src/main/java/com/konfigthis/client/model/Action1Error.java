...
public class Action1Error {
  ...
  public Action1Error code(String code) {
  ...
  **/
  ...
  public Action1Error message(String message) {
  ...
  **/
   ...
   * @return the Action1Error instance itself
   */
  public Action1Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action1Error action1Error = (Action1Error) o;
    return Objects.equals(this.code, action1Error.code) &&
        Objects.equals(this.message, action1Error.message)&&
        Objects.equals(this.additionalProperties, action1Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action1Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action1Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action1Error is not found in the empty JSON string", Action1Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action1Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action1Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action1Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action1Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action1Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action1Error>() {
           @Override
           public void write(JsonWriter out, Action1Error value) throws IOException {
           ...
           @Override
           public Action1Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action1Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action1Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action1Error
  * @throws IOException if the JSON string is invalid with respect to Action1Error
  */
  public static Action1Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action1Error.class);
  }

 /**
  * Convert an instance of Action1Error to an JSON string
  *
  * @return JSON string
  */
