...
public class Action11Error {
  ...
  public Action11Error() {
  }

  public Action11Error code(String code) {
  ...
  **/
  ...
  public Action11Error message(String message) {
  ...
  **/
   ...
   * @return the Action11Error instance itself
   */
  public Action11Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action11Error action11Error = (Action11Error) o;
    return Objects.equals(this.code, action11Error.code) &&
        Objects.equals(this.message, action11Error.message)&&
        Objects.equals(this.additionalProperties, action11Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action11Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action11Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action11Error is not found in the empty JSON string", Action11Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action11Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action11Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action11Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action11Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action11Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action11Error>() {
           @Override
           public void write(JsonWriter out, Action11Error value) throws IOException {
           ...
           @Override
           public Action11Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action11Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action11Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action11Error
  * @throws IOException if the JSON string is invalid with respect to Action11Error
  */
  public static Action11Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action11Error.class);
  }

 /**
  * Convert an instance of Action11Error to an JSON string
  *
  * @return JSON string
  */
