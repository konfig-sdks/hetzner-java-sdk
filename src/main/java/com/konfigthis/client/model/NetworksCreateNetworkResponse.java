...
import com.konfigthis.client.model.NetworksCreateNetworkResponseNetwork;
...
public class NetworksCreateNetworkResponse {
  public static final String SERIALIZED_NAME_NETWORK = "network";
  @SerializedName(SERIALIZED_NAME_NETWORK)
  private NetworksCreateNetworkResponseNetwork network;

  public NetworksCreateNetworkResponse() {
  }

  public NetworksCreateNetworkResponse network(NetworksCreateNetworkResponseNetwork network) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork getNetwork() {
    return network;
  }


  public void setNetwork(NetworksCreateNetworkResponseNetwork network) {
   ...
   * @return the NetworksCreateNetworkResponse instance itself
   */
  public NetworksCreateNetworkResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksCreateNetworkResponse networksCreateNetworkResponse = (NetworksCreateNetworkResponse) o;
    return Objects.equals(this.network, networksCreateNetworkResponse.network)&&
        Objects.equals(this.additionalProperties, networksCreateNetworkResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksCreateNetworkResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksCreateNetworkResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksCreateNetworkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksCreateNetworkResponse is not found in the empty JSON string", NetworksCreateNetworkResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `network`
      if (jsonObj.get("network") != null && !jsonObj.get("network").isJsonNull()) {
        NetworksCreateNetworkResponseNetwork.validateJsonObject(jsonObj.getAsJsonObject("network"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksCreateNetworkResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksCreateNetworkResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksCreateNetworkResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksCreateNetworkResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksCreateNetworkResponse>() {
           @Override
           public void write(JsonWriter out, NetworksCreateNetworkResponse value) throws IOException {
           ...
           @Override
           public NetworksCreateNetworkResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksCreateNetworkResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksCreateNetworkResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksCreateNetworkResponse
  * @throws IOException if the JSON string is invalid with respect to NetworksCreateNetworkResponse
  */
  public static NetworksCreateNetworkResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksCreateNetworkResponse.class);
  }

 /**
  * Convert an instance of NetworksCreateNetworkResponse to an JSON string
  *
  * @return JSON string
  */
