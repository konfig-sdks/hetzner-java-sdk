...
import com.konfigthis.client.model.ActionProperty20;
...
public class LoadBalancerActionsAddTargetResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty20 action;

  public LoadBalancerActionsAddTargetResponse() {
  }

  public LoadBalancerActionsAddTargetResponse action(ActionProperty20 action) {
  ...
  **/
  ...
  public ActionProperty20 getAction() {
    return action;
  }


  public void setAction(ActionProperty20 action) {
   ...
   * @return the LoadBalancerActionsAddTargetResponse instance itself
   */
  public LoadBalancerActionsAddTargetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsAddTargetResponse loadBalancerActionsAddTargetResponse = (LoadBalancerActionsAddTargetResponse) o;
    return Objects.equals(this.action, loadBalancerActionsAddTargetResponse.action)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsAddTargetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsAddTargetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsAddTargetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsAddTargetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsAddTargetResponse is not found in the empty JSON string", LoadBalancerActionsAddTargetResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsAddTargetResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty20.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsAddTargetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsAddTargetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsAddTargetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsAddTargetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsAddTargetResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsAddTargetResponse value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsAddTargetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsAddTargetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsAddTargetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsAddTargetResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsAddTargetResponse
  */
  public static LoadBalancerActionsAddTargetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsAddTargetResponse.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsAddTargetResponse to an JSON string
  *
  * @return JSON string
  */
