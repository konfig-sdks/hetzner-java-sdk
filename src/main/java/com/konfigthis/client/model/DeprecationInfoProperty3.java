...
public class DeprecationInfoProperty3 {
  ...
  public DeprecationInfoProperty3() {
  }

  public DeprecationInfoProperty3 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty3 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty3 instance itself
   */
  public DeprecationInfoProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty3 deprecationInfoProperty3 = (DeprecationInfoProperty3) o;
    return Objects.equals(this.announced, deprecationInfoProperty3.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty3.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty3 is not found in the empty JSON string", DeprecationInfoProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty3>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty3 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty3
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty3
  */
  public static DeprecationInfoProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty3.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty3 to an JSON string
  *
  * @return JSON string
  */
