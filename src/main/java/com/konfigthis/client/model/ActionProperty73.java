...
import com.konfigthis.client.model.ActionProperty73Error;
import com.konfigthis.client.model.ActionProperty73ResourcesInner;
...
public class ActionProperty73 {
  ...
  private ActionProperty73Error error;
  ...
  private List<ActionProperty73ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty73() {
  }

  public ActionProperty73 command(String command) {
  ...
  **/
  ...
  public ActionProperty73 error(ActionProperty73Error error) {
  ...
  **/
  ...
  public ActionProperty73Error getError() {
    return error;
  }


  public void setError(ActionProperty73Error error) {
  ...
  public ActionProperty73 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty73 id(Long id) {
  ...
  **/
  ...
  public ActionProperty73 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty73 resources(List<ActionProperty73ResourcesInner> resources) {
  ...
  public ActionProperty73 addResourcesItem(ActionProperty73ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty73ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty73ResourcesInner> resources) {
  ...
  public ActionProperty73 started(String started) {
  ...
  **/
  ...
  public ActionProperty73 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty73 instance itself
   */
  public ActionProperty73 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty73 actionProperty73 = (ActionProperty73) o;
    return Objects.equals(this.command, actionProperty73.command) &&
        Objects.equals(this.error, actionProperty73.error) &&
        Objects.equals(this.finished, actionProperty73.finished) &&
        Objects.equals(this.id, actionProperty73.id) &&
        Objects.equals(this.progress, actionProperty73.progress) &&
        Objects.equals(this.resources, actionProperty73.resources) &&
        Objects.equals(this.started, actionProperty73.started) &&
        Objects.equals(this.status, actionProperty73.status)&&
        Objects.equals(this.additionalProperties, actionProperty73.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty73 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty73
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty73.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty73 is not found in the empty JSON string", ActionProperty73.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty73.openapiRequiredFields) {
      ...
      ActionProperty73Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty73ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty73.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty73' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty73> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty73.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty73>() {
           @Override
           public void write(JsonWriter out, ActionProperty73 value) throws IOException {
           ...
           @Override
           public ActionProperty73 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty73 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty73 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty73
  * @throws IOException if the JSON string is invalid with respect to ActionProperty73
  */
  public static ActionProperty73 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty73.class);
  }

 /**
  * Convert an instance of ActionProperty73 to an JSON string
  *
  * @return JSON string
  */
