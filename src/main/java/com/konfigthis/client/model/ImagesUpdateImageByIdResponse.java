...
import com.konfigthis.client.model.ImagesUpdateImageByIdResponseImage;
...
public class ImagesUpdateImageByIdResponse {
  public static final String SERIALIZED_NAME_IMAGE = "image";
  @SerializedName(SERIALIZED_NAME_IMAGE)
  private ImagesUpdateImageByIdResponseImage image;

  public ImagesUpdateImageByIdResponse() {
  }

  public ImagesUpdateImageByIdResponse image(ImagesUpdateImageByIdResponseImage image) {
  ...
  **/
  ...
  public ImagesUpdateImageByIdResponseImage getImage() {
    return image;
  }


  public void setImage(ImagesUpdateImageByIdResponseImage image) {
   ...
   * @return the ImagesUpdateImageByIdResponse instance itself
   */
  public ImagesUpdateImageByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesUpdateImageByIdResponse imagesUpdateImageByIdResponse = (ImagesUpdateImageByIdResponse) o;
    return Objects.equals(this.image, imagesUpdateImageByIdResponse.image)&&
        Objects.equals(this.additionalProperties, imagesUpdateImageByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesUpdateImageByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesUpdateImageByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesUpdateImageByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesUpdateImageByIdResponse is not found in the empty JSON string", ImagesUpdateImageByIdResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `image`
      if (jsonObj.get("image") != null && !jsonObj.get("image").isJsonNull()) {
        ImagesUpdateImageByIdResponseImage.validateJsonObject(jsonObj.getAsJsonObject("image"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesUpdateImageByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesUpdateImageByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesUpdateImageByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesUpdateImageByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesUpdateImageByIdResponse>() {
           @Override
           public void write(JsonWriter out, ImagesUpdateImageByIdResponse value) throws IOException {
           ...
           @Override
           public ImagesUpdateImageByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesUpdateImageByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesUpdateImageByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesUpdateImageByIdResponse
  * @throws IOException if the JSON string is invalid with respect to ImagesUpdateImageByIdResponse
  */
  public static ImagesUpdateImageByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesUpdateImageByIdResponse.class);
  }

 /**
  * Convert an instance of ImagesUpdateImageByIdResponse to an JSON string
  *
  * @return JSON string
  */
