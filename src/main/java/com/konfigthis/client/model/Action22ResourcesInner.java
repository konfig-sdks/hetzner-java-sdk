...
/**
 * Action22ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action22ResourcesInner {
  ...
  public Action22ResourcesInner() {
  }

  public Action22ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action22ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action22ResourcesInner instance itself
   */
  public Action22ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action22ResourcesInner action22ResourcesInner = (Action22ResourcesInner) o;
    return Objects.equals(this.id, action22ResourcesInner.id) &&
        Objects.equals(this.type, action22ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action22ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action22ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action22ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action22ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action22ResourcesInner is not found in the empty JSON string", Action22ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action22ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action22ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action22ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action22ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action22ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action22ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action22ResourcesInner value) throws IOException {
           ...
           @Override
           public Action22ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action22ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action22ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action22ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action22ResourcesInner
  */
  public static Action22ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action22ResourcesInner.class);
  }

 /**
  * Convert an instance of Action22ResourcesInner to an JSON string
  *
  * @return JSON string
  */
