...
public class ActionProperty61Error {
  ...
  public ActionProperty61Error() {
  }

  public ActionProperty61Error code(String code) {
  ...
  **/
  ...
  public ActionProperty61Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty61Error instance itself
   */
  public ActionProperty61Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty61Error actionProperty61Error = (ActionProperty61Error) o;
    return Objects.equals(this.code, actionProperty61Error.code) &&
        Objects.equals(this.message, actionProperty61Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty61Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty61Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty61Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty61Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty61Error is not found in the empty JSON string", ActionProperty61Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty61Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty61Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty61Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty61Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty61Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty61Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty61Error value) throws IOException {
           ...
           @Override
           public ActionProperty61Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty61Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty61Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty61Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty61Error
  */
  public static ActionProperty61Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty61Error.class);
  }

 /**
  * Convert an instance of ActionProperty61Error to an JSON string
  *
  * @return JSON string
  */
