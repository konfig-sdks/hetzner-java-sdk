...
/**
 * ActionProperty80ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty80ResourcesInner {
  ...
  public ActionProperty80ResourcesInner() {
  }

  public ActionProperty80ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty80ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty80ResourcesInner instance itself
   */
  public ActionProperty80ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty80ResourcesInner actionProperty80ResourcesInner = (ActionProperty80ResourcesInner) o;
    return Objects.equals(this.id, actionProperty80ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty80ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty80ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty80ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty80ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty80ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty80ResourcesInner is not found in the empty JSON string", ActionProperty80ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty80ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty80ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty80ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty80ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty80ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty80ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty80ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty80ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty80ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty80ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty80ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty80ResourcesInner
  */
  public static ActionProperty80ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty80ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty80ResourcesInner to an JSON string
  *
  * @return JSON string
  */
