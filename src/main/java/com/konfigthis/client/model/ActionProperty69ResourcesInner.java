...
/**
 * ActionProperty69ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty69ResourcesInner {
  ...
  public ActionProperty69ResourcesInner() {
  }

  public ActionProperty69ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty69ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty69ResourcesInner instance itself
   */
  public ActionProperty69ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty69ResourcesInner actionProperty69ResourcesInner = (ActionProperty69ResourcesInner) o;
    return Objects.equals(this.id, actionProperty69ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty69ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty69ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty69ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty69ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty69ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty69ResourcesInner is not found in the empty JSON string", ActionProperty69ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty69ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty69ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty69ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty69ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty69ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty69ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty69ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty69ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty69ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty69ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty69ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty69ResourcesInner
  */
  public static ActionProperty69ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty69ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty69ResourcesInner to an JSON string
  *
  * @return JSON string
  */
