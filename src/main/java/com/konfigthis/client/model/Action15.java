...
import com.konfigthis.client.model.Action15Error;
import com.konfigthis.client.model.Action15ResourcesInner;
...
public class Action15 {
  ...
  private List<Action15ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action15 command(String command) {
  ...
  **/
  ...
  public Action15 error(Action15Error error) {
  ...
  **/
  ...
  public Action15Error getError() {
    return error;
  }


  public void setError(Action15Error error) {
  ...
  public Action15 finished(String finished) {
  ...
  **/
  ...
  public Action15 progress(Integer progress) {
  ...
  **/
  ...
  public Action15 resources(List<Action15ResourcesInner> resources) {
  ...
  public Action15 addResourcesItem(Action15ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action15ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action15ResourcesInner> resources) {
  ...
  public Action15 started(String started) {
  ...
  **/
  ...
  public Action15 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action15 instance itself
   */
  public Action15 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action15 action15 = (Action15) o;
    return Objects.equals(this.command, action15.command) &&
        Objects.equals(this.error, action15.error) &&
        Objects.equals(this.finished, action15.finished) &&
        Objects.equals(this.id, action15.id) &&
        Objects.equals(this.progress, action15.progress) &&
        Objects.equals(this.resources, action15.resources) &&
        Objects.equals(this.started, action15.started) &&
        Objects.equals(this.status, action15.status)&&
        Objects.equals(this.additionalProperties, action15.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action15
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action15.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action15 is not found in the empty JSON string", Action15.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action15.openapiRequiredFields) {
      ...
      Action15Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action15ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action15.class));

       return (TypeAdapter<T>) new TypeAdapter<Action15>() {
           @Override
           public void write(JsonWriter out, Action15 value) throws IOException {
           ...
           @Override
           public Action15 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action15 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action15 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action15
  * @throws IOException if the JSON string is invalid with respect to Action15
  */
  public static Action15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action15.class);
  }

 /**
  * Convert an instance of Action15 to an JSON string
  *
  * @return JSON string
  */
