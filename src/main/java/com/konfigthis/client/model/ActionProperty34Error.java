...
public class ActionProperty34Error {
  ...
  public ActionProperty34Error() {
  }

  public ActionProperty34Error code(String code) {
  ...
  **/
  ...
  public ActionProperty34Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty34Error instance itself
   */
  public ActionProperty34Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty34Error actionProperty34Error = (ActionProperty34Error) o;
    return Objects.equals(this.code, actionProperty34Error.code) &&
        Objects.equals(this.message, actionProperty34Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty34Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty34Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty34Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty34Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty34Error is not found in the empty JSON string", ActionProperty34Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty34Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty34Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty34Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty34Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty34Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty34Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty34Error value) throws IOException {
           ...
           @Override
           public ActionProperty34Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty34Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty34Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty34Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty34Error
  */
  public static ActionProperty34Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty34Error.class);
  }

 /**
  * Convert an instance of ActionProperty34Error to an JSON string
  *
  * @return JSON string
  */
