...
import com.konfigthis.client.model.ActionNullablePropertyError;
import com.konfigthis.client.model.ActionNullablePropertyResourcesInner;
...
/**
 * ActionNullableProperty
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionNullableProperty {
  ...
  private ActionNullablePropertyError error;
  ...
  private List<ActionNullablePropertyResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionNullableProperty() {
  }

  public ActionNullableProperty command(String command) {
  ...
  **/
  ...
  public ActionNullableProperty error(ActionNullablePropertyError error) {
  ...
  **/
  ...
  public ActionNullablePropertyError getError() {
    return error;
  }


  public void setError(ActionNullablePropertyError error) {
  ...
  public ActionNullableProperty finished(String finished) {
  ...
  **/
  ...
  public ActionNullableProperty id(Long id) {
  ...
  **/
  ...
  public ActionNullableProperty progress(Integer progress) {
  ...
  **/
  ...
  public ActionNullableProperty resources(List<ActionNullablePropertyResourcesInner> resources) {
  ...
  public ActionNullableProperty addResourcesItem(ActionNullablePropertyResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionNullablePropertyResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionNullablePropertyResourcesInner> resources) {
  ...
  public ActionNullableProperty started(String started) {
  ...
  **/
  ...
  public ActionNullableProperty status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionNullableProperty instance itself
   */
  public ActionNullableProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullableProperty actionNullableProperty = (ActionNullableProperty) o;
    return Objects.equals(this.command, actionNullableProperty.command) &&
        Objects.equals(this.error, actionNullableProperty.error) &&
        Objects.equals(this.finished, actionNullableProperty.finished) &&
        Objects.equals(this.id, actionNullableProperty.id) &&
        Objects.equals(this.progress, actionNullableProperty.progress) &&
        Objects.equals(this.resources, actionNullableProperty.resources) &&
        Objects.equals(this.started, actionNullableProperty.started) &&
        Objects.equals(this.status, actionNullableProperty.status)&&
        Objects.equals(this.additionalProperties, actionNullableProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullableProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullableProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullableProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullableProperty is not found in the empty JSON string", ActionNullableProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullableProperty.openapiRequiredFields) {
      ...
      ActionNullablePropertyError.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionNullablePropertyResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullableProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullableProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullableProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullableProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullableProperty>() {
           @Override
           public void write(JsonWriter out, ActionNullableProperty value) throws IOException {
           ...
           @Override
           public ActionNullableProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullableProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullableProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullableProperty
  * @throws IOException if the JSON string is invalid with respect to ActionNullableProperty
  */
  public static ActionNullableProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullableProperty.class);
  }

 /**
  * Convert an instance of ActionNullableProperty to an JSON string
  *
  * @return JSON string
  */
