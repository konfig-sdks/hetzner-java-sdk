...
public class LoadBalancersUpdateBalancerRequest {
  ...
  public LoadBalancersUpdateBalancerRequest() {
  }

  public LoadBalancersUpdateBalancerRequest labels(Object labels) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "new-name", value = "New Load Balancer name")
   ...
   * @return the LoadBalancersUpdateBalancerRequest instance itself
   */
  public LoadBalancersUpdateBalancerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersUpdateBalancerRequest loadBalancersUpdateBalancerRequest = (LoadBalancersUpdateBalancerRequest) o;
    return Objects.equals(this.labels, loadBalancersUpdateBalancerRequest.labels) &&
        Objects.equals(this.name, loadBalancersUpdateBalancerRequest.name)&&
        Objects.equals(this.additionalProperties, loadBalancersUpdateBalancerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersUpdateBalancerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersUpdateBalancerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersUpdateBalancerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersUpdateBalancerRequest is not found in the empty JSON string", LoadBalancersUpdateBalancerRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersUpdateBalancerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersUpdateBalancerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersUpdateBalancerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersUpdateBalancerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersUpdateBalancerRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersUpdateBalancerRequest value) throws IOException {
           ...
           @Override
           public LoadBalancersUpdateBalancerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersUpdateBalancerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersUpdateBalancerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersUpdateBalancerRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersUpdateBalancerRequest
  */
  public static LoadBalancersUpdateBalancerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersUpdateBalancerRequest.class);
  }

 /**
  * Convert an instance of LoadBalancersUpdateBalancerRequest to an JSON string
  *
  * @return JSON string
  */
