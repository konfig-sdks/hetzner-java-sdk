...
public class ListMetaProperty6Pagination {
  ...
  public ListMetaProperty6Pagination() {
  }

  public ListMetaProperty6Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty6Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty6Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty6Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty6Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty6Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty6Pagination instance itself
   */
  public ListMetaProperty6Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty6Pagination listMetaProperty6Pagination = (ListMetaProperty6Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty6Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty6Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty6Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty6Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty6Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty6Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty6Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty6Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty6Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty6Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty6Pagination is not found in the empty JSON string", ListMetaProperty6Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty6Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty6Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty6Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty6Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty6Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty6Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty6Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty6Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty6Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty6Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty6Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty6Pagination
  */
  public static ListMetaProperty6Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty6Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty6Pagination to an JSON string
  *
  * @return JSON string
  */
