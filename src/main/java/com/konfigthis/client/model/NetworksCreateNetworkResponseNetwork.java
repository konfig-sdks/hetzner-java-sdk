...
import com.konfigthis.client.model.NetworksCreateNetworkResponseNetworkProtection;
import com.konfigthis.client.model.NetworksCreateNetworkResponseNetworkRoutesInner;
import com.konfigthis.client.model.NetworksCreateNetworkResponseNetworkSubnetsInner;
...
public class NetworksCreateNetworkResponseNetwork {
  ...
  private NetworksCreateNetworkResponseNetworkProtection protection;

  public static final String SERIALIZED_NAME_ROUTES = "routes";
  @SerializedName(SERIALIZED_NAME_ROUTES)
  private List<NetworksCreateNetworkResponseNetworkRoutesInner> routes = new ArrayList<>();

  public static final String SERIALIZED_NAME_SUBNETS = "subnets";
  @SerializedName(SERIALIZED_NAME_SUBNETS)
  private List<NetworksCreateNetworkResponseNetworkSubnetsInner> subnets = new ArrayList<>();

  public NetworksCreateNetworkResponseNetwork() {
  }

  public NetworksCreateNetworkResponseNetwork servers(List<Long> servers) {
  ...
  public NetworksCreateNetworkResponseNetwork addServersItem(Long serversItem) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork created(String created) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork exposeRoutesToVswitch(Boolean exposeRoutesToVswitch) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork id(Long id) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork ipRange(String ipRange) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork labels(Object labels) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork loadBalancers(List<Long> loadBalancers) {
  ...
  public NetworksCreateNetworkResponseNetwork addLoadBalancersItem(Long loadBalancersItem) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork name(String name) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetwork protection(NetworksCreateNetworkResponseNetworkProtection protection) {
  ...
  **/
  ...
  public NetworksCreateNetworkResponseNetworkProtection getProtection() {
    return protection;
  }


  public void setProtection(NetworksCreateNetworkResponseNetworkProtection protection) {
  ...
  public NetworksCreateNetworkResponseNetwork routes(List<NetworksCreateNetworkResponseNetworkRoutesInner> routes) {
  ...
  public NetworksCreateNetworkResponseNetwork addRoutesItem(NetworksCreateNetworkResponseNetworkRoutesInner routesItem) {
  ...
  **/
  ...
  public List<NetworksCreateNetworkResponseNetworkRoutesInner> getRoutes() {
    return routes;
  }


  public void setRoutes(List<NetworksCreateNetworkResponseNetworkRoutesInner> routes) {
  ...
  public NetworksCreateNetworkResponseNetwork subnets(List<NetworksCreateNetworkResponseNetworkSubnetsInner> subnets) {
  ...
  public NetworksCreateNetworkResponseNetwork addSubnetsItem(NetworksCreateNetworkResponseNetworkSubnetsInner subnetsItem) {
  ...
  **/
  ...
  public List<NetworksCreateNetworkResponseNetworkSubnetsInner> getSubnets() {
    return subnets;
  }


  public void setSubnets(List<NetworksCreateNetworkResponseNetworkSubnetsInner> subnets) {
   ...
   * @return the NetworksCreateNetworkResponseNetwork instance itself
   */
  public NetworksCreateNetworkResponseNetwork putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksCreateNetworkResponseNetwork networksCreateNetworkResponseNetwork = (NetworksCreateNetworkResponseNetwork) o;
    return Objects.equals(this.servers, networksCreateNetworkResponseNetwork.servers) &&
        Objects.equals(this.created, networksCreateNetworkResponseNetwork.created) &&
        Objects.equals(this.exposeRoutesToVswitch, networksCreateNetworkResponseNetwork.exposeRoutesToVswitch) &&
        Objects.equals(this.id, networksCreateNetworkResponseNetwork.id) &&
        Objects.equals(this.ipRange, networksCreateNetworkResponseNetwork.ipRange) &&
        Objects.equals(this.labels, networksCreateNetworkResponseNetwork.labels) &&
        Objects.equals(this.loadBalancers, networksCreateNetworkResponseNetwork.loadBalancers) &&
        Objects.equals(this.name, networksCreateNetworkResponseNetwork.name) &&
        Objects.equals(this.protection, networksCreateNetworkResponseNetwork.protection) &&
        Objects.equals(this.routes, networksCreateNetworkResponseNetwork.routes) &&
        Objects.equals(this.subnets, networksCreateNetworkResponseNetwork.subnets)&&
        Objects.equals(this.additionalProperties, networksCreateNetworkResponseNetwork.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksCreateNetworkResponseNetwork {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksCreateNetworkResponseNetwork
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksCreateNetworkResponseNetwork.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksCreateNetworkResponseNetwork is not found in the empty JSON string", NetworksCreateNetworkResponseNetwork.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksCreateNetworkResponseNetwork.openapiRequiredFields) {
      ...
      NetworksCreateNetworkResponseNetworkProtection.validateJsonObject(jsonObj.getAsJsonObject("protection"));
      ...
      for (int i = 0; i < jsonArrayroutes.size(); i++) {
        NetworksCreateNetworkResponseNetworkRoutesInner.validateJsonObject(jsonArrayroutes.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArraysubnets.size(); i++) {
        NetworksCreateNetworkResponseNetworkSubnetsInner.validateJsonObject(jsonArraysubnets.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksCreateNetworkResponseNetwork.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksCreateNetworkResponseNetwork' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksCreateNetworkResponseNetwork> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksCreateNetworkResponseNetwork.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksCreateNetworkResponseNetwork>() {
           @Override
           public void write(JsonWriter out, NetworksCreateNetworkResponseNetwork value) throws IOException {
           ...
           @Override
           public NetworksCreateNetworkResponseNetwork read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksCreateNetworkResponseNetwork instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksCreateNetworkResponseNetwork given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksCreateNetworkResponseNetwork
  * @throws IOException if the JSON string is invalid with respect to NetworksCreateNetworkResponseNetwork
  */
  public static NetworksCreateNetworkResponseNetwork fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksCreateNetworkResponseNetwork.class);
  }

 /**
  * Convert an instance of NetworksCreateNetworkResponseNetwork to an JSON string
  *
  * @return JSON string
  */
