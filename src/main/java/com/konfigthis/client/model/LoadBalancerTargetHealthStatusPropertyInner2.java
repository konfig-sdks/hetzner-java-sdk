...
public class LoadBalancerTargetHealthStatusPropertyInner2 {
 ...
 public enum StatusEnum {
  ...
  public LoadBalancerTargetHealthStatusPropertyInner2() {
  }

  public LoadBalancerTargetHealthStatusPropertyInner2 listenPort(Integer listenPort) {
  ...
  **/
  ...
  public LoadBalancerTargetHealthStatusPropertyInner2 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetHealthStatusPropertyInner2 instance itself
   */
  public LoadBalancerTargetHealthStatusPropertyInner2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetHealthStatusPropertyInner2 loadBalancerTargetHealthStatusPropertyInner2 = (LoadBalancerTargetHealthStatusPropertyInner2) o;
    return Objects.equals(this.listenPort, loadBalancerTargetHealthStatusPropertyInner2.listenPort) &&
        Objects.equals(this.status, loadBalancerTargetHealthStatusPropertyInner2.status)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetHealthStatusPropertyInner2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetHealthStatusPropertyInner2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetHealthStatusPropertyInner2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetHealthStatusPropertyInner2 is not found in the empty JSON string", LoadBalancerTargetHealthStatusPropertyInner2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetHealthStatusPropertyInner2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetHealthStatusPropertyInner2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetHealthStatusPropertyInner2.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner2>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetHealthStatusPropertyInner2 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetHealthStatusPropertyInner2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetHealthStatusPropertyInner2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetHealthStatusPropertyInner2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetHealthStatusPropertyInner2
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner2
  */
  public static LoadBalancerTargetHealthStatusPropertyInner2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetHealthStatusPropertyInner2.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetHealthStatusPropertyInner2 to an JSON string
  *
  * @return JSON string
  */
