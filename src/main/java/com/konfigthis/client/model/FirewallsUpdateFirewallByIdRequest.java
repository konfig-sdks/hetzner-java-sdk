...
public class FirewallsUpdateFirewallByIdRequest {
  ...
  public FirewallsUpdateFirewallByIdRequest() {
  }

  public FirewallsUpdateFirewallByIdRequest labels(Object labels) {
  ...
  **/
  ...
  public FirewallsUpdateFirewallByIdRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "new-name", value = "New Firewall name")
   ...
   * @return the FirewallsUpdateFirewallByIdRequest instance itself
   */
  public FirewallsUpdateFirewallByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsUpdateFirewallByIdRequest firewallsUpdateFirewallByIdRequest = (FirewallsUpdateFirewallByIdRequest) o;
    return Objects.equals(this.labels, firewallsUpdateFirewallByIdRequest.labels) &&
        Objects.equals(this.name, firewallsUpdateFirewallByIdRequest.name)&&
        Objects.equals(this.additionalProperties, firewallsUpdateFirewallByIdRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsUpdateFirewallByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsUpdateFirewallByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsUpdateFirewallByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsUpdateFirewallByIdRequest is not found in the empty JSON string", FirewallsUpdateFirewallByIdRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsUpdateFirewallByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsUpdateFirewallByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsUpdateFirewallByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsUpdateFirewallByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsUpdateFirewallByIdRequest>() {
           @Override
           public void write(JsonWriter out, FirewallsUpdateFirewallByIdRequest value) throws IOException {
           ...
           @Override
           public FirewallsUpdateFirewallByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsUpdateFirewallByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsUpdateFirewallByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsUpdateFirewallByIdRequest
  * @throws IOException if the JSON string is invalid with respect to FirewallsUpdateFirewallByIdRequest
  */
  public static FirewallsUpdateFirewallByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsUpdateFirewallByIdRequest.class);
  }

 /**
  * Convert an instance of FirewallsUpdateFirewallByIdRequest to an JSON string
  *
  * @return JSON string
  */
