...
/**
 * Action10ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action10ResourcesInner {
  ...
  public Action10ResourcesInner() {
  }

  public Action10ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action10ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action10ResourcesInner instance itself
   */
  public Action10ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action10ResourcesInner action10ResourcesInner = (Action10ResourcesInner) o;
    return Objects.equals(this.id, action10ResourcesInner.id) &&
        Objects.equals(this.type, action10ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action10ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action10ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action10ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action10ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action10ResourcesInner is not found in the empty JSON string", Action10ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action10ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action10ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action10ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action10ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action10ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action10ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action10ResourcesInner value) throws IOException {
           ...
           @Override
           public Action10ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action10ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action10ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action10ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action10ResourcesInner
  */
  public static Action10ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action10ResourcesInner.class);
  }

 /**
  * Convert an instance of Action10ResourcesInner to an JSON string
  *
  * @return JSON string
  */
