...
import com.konfigthis.client.model.Action18Error;
import com.konfigthis.client.model.Action18ResourcesInner;
...
public class Action18 {
  ...
  private List<Action18ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action18 command(String command) {
  ...
  **/
  ...
  public Action18 error(Action18Error error) {
  ...
  **/
  ...
  public Action18Error getError() {
    return error;
  }


  public void setError(Action18Error error) {
  ...
  public Action18 finished(String finished) {
  ...
  **/
  ...
  public Action18 progress(Integer progress) {
  ...
  **/
  ...
  public Action18 resources(List<Action18ResourcesInner> resources) {
  ...
  public Action18 addResourcesItem(Action18ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action18ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action18ResourcesInner> resources) {
  ...
  public Action18 started(String started) {
  ...
  **/
  ...
  public Action18 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action18 instance itself
   */
  public Action18 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action18 action18 = (Action18) o;
    return Objects.equals(this.command, action18.command) &&
        Objects.equals(this.error, action18.error) &&
        Objects.equals(this.finished, action18.finished) &&
        Objects.equals(this.id, action18.id) &&
        Objects.equals(this.progress, action18.progress) &&
        Objects.equals(this.resources, action18.resources) &&
        Objects.equals(this.started, action18.started) &&
        Objects.equals(this.status, action18.status)&&
        Objects.equals(this.additionalProperties, action18.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action18
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action18.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action18 is not found in the empty JSON string", Action18.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action18.openapiRequiredFields) {
      ...
      Action18Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action18ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action18.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action18' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action18> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action18.class));

       return (TypeAdapter<T>) new TypeAdapter<Action18>() {
           @Override
           public void write(JsonWriter out, Action18 value) throws IOException {
           ...
           @Override
           public Action18 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action18 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action18 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action18
  * @throws IOException if the JSON string is invalid with respect to Action18
  */
  public static Action18 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action18.class);
  }

 /**
  * Convert an instance of Action18 to an JSON string
  *
  * @return JSON string
  */
