...
import com.konfigthis.client.model.ActionProperty48;
...
public class ServerActionsGetActionByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty48 action;

  public ServerActionsGetActionByIdResponse() {
  }

  public ServerActionsGetActionByIdResponse action(ActionProperty48 action) {
  ...
  **/
  ...
  public ActionProperty48 getAction() {
    return action;
  }


  public void setAction(ActionProperty48 action) {
   ...
   * @return the ServerActionsGetActionByIdResponse instance itself
   */
  public ServerActionsGetActionByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsGetActionByIdResponse serverActionsGetActionByIdResponse = (ServerActionsGetActionByIdResponse) o;
    return Objects.equals(this.action, serverActionsGetActionByIdResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsGetActionByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsGetActionByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsGetActionByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsGetActionByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsGetActionByIdResponse is not found in the empty JSON string", ServerActionsGetActionByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsGetActionByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty48.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsGetActionByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsGetActionByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsGetActionByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsGetActionByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsGetActionByIdResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsGetActionByIdResponse value) throws IOException {
           ...
           @Override
           public ServerActionsGetActionByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsGetActionByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsGetActionByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsGetActionByIdResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsGetActionByIdResponse
  */
  public static ServerActionsGetActionByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsGetActionByIdResponse.class);
  }

 /**
  * Convert an instance of ServerActionsGetActionByIdResponse to an JSON string
  *
  * @return JSON string
  */
