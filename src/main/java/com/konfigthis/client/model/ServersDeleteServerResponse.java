...
import com.konfigthis.client.model.ActionProperty49;
...
public class ServersDeleteServerResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty49 action;

  public ServersDeleteServerResponse() {
  }

  public ServersDeleteServerResponse action(ActionProperty49 action) {
  ...
  **/
  ...
  public ActionProperty49 getAction() {
    return action;
  }


  public void setAction(ActionProperty49 action) {
   ...
   * @return the ServersDeleteServerResponse instance itself
   */
  public ServersDeleteServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersDeleteServerResponse serversDeleteServerResponse = (ServersDeleteServerResponse) o;
    return Objects.equals(this.action, serversDeleteServerResponse.action)&&
        Objects.equals(this.additionalProperties, serversDeleteServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersDeleteServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersDeleteServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersDeleteServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersDeleteServerResponse is not found in the empty JSON string", ServersDeleteServerResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `action`
      if (jsonObj.get("action") != null && !jsonObj.get("action").isJsonNull()) {
        ActionProperty49.validateJsonObject(jsonObj.getAsJsonObject("action"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersDeleteServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersDeleteServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersDeleteServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersDeleteServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersDeleteServerResponse>() {
           @Override
           public void write(JsonWriter out, ServersDeleteServerResponse value) throws IOException {
           ...
           @Override
           public ServersDeleteServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersDeleteServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersDeleteServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersDeleteServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServersDeleteServerResponse
  */
  public static ServersDeleteServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersDeleteServerResponse.class);
  }

 /**
  * Convert an instance of ServersDeleteServerResponse to an JSON string
  *
  * @return JSON string
  */
