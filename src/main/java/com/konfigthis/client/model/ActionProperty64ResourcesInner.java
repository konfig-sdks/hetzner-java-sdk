...
/**
 * ActionProperty64ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty64ResourcesInner {
  ...
  public ActionProperty64ResourcesInner() {
  }

  public ActionProperty64ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty64ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty64ResourcesInner instance itself
   */
  public ActionProperty64ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty64ResourcesInner actionProperty64ResourcesInner = (ActionProperty64ResourcesInner) o;
    return Objects.equals(this.id, actionProperty64ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty64ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty64ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty64ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty64ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty64ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty64ResourcesInner is not found in the empty JSON string", ActionProperty64ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty64ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty64ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty64ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty64ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty64ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty64ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty64ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty64ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty64ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty64ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty64ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty64ResourcesInner
  */
  public static ActionProperty64ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty64ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty64ResourcesInner to an JSON string
  *
  * @return JSON string
  */
