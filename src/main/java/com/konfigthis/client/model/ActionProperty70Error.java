...
public class ActionProperty70Error {
  ...
  public ActionProperty70Error() {
  }

  public ActionProperty70Error code(String code) {
  ...
  **/
  ...
  public ActionProperty70Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty70Error instance itself
   */
  public ActionProperty70Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty70Error actionProperty70Error = (ActionProperty70Error) o;
    return Objects.equals(this.code, actionProperty70Error.code) &&
        Objects.equals(this.message, actionProperty70Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty70Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty70Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty70Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty70Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty70Error is not found in the empty JSON string", ActionProperty70Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty70Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty70Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty70Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty70Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty70Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty70Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty70Error value) throws IOException {
           ...
           @Override
           public ActionProperty70Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty70Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty70Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty70Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty70Error
  */
  public static ActionProperty70Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty70Error.class);
  }

 /**
  * Convert an instance of ActionProperty70Error to an JSON string
  *
  * @return JSON string
  */
