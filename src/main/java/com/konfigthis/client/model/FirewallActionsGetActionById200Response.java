...
import com.konfigthis.client.model.ActionProperty6;
...
public class FirewallActionsGetActionById200Response {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty6 action;

  public FirewallActionsGetActionById200Response() {
  }

  public FirewallActionsGetActionById200Response action(ActionProperty6 action) {
  ...
  **/
  ...
  public ActionProperty6 getAction() {
    return action;
  }


  public void setAction(ActionProperty6 action) {
   ...
   * @return the FirewallActionsGetActionById200Response instance itself
   */
  public FirewallActionsGetActionById200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallActionsGetActionById200Response firewallActionsGetActionById200Response = (FirewallActionsGetActionById200Response) o;
    return Objects.equals(this.action, firewallActionsGetActionById200Response.action)&&
        Objects.equals(this.additionalProperties, firewallActionsGetActionById200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallActionsGetActionById200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallActionsGetActionById200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallActionsGetActionById200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallActionsGetActionById200Response is not found in the empty JSON string", FirewallActionsGetActionById200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallActionsGetActionById200Response.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty6.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallActionsGetActionById200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallActionsGetActionById200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallActionsGetActionById200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallActionsGetActionById200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallActionsGetActionById200Response>() {
           @Override
           public void write(JsonWriter out, FirewallActionsGetActionById200Response value) throws IOException {
           ...
           @Override
           public FirewallActionsGetActionById200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallActionsGetActionById200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallActionsGetActionById200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallActionsGetActionById200Response
  * @throws IOException if the JSON string is invalid with respect to FirewallActionsGetActionById200Response
  */
  public static FirewallActionsGetActionById200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallActionsGetActionById200Response.class);
  }

 /**
  * Convert an instance of FirewallActionsGetActionById200Response to an JSON string
  *
  * @return JSON string
  */
