...
import com.konfigthis.client.model.ActionProperty3Error;
import com.konfigthis.client.model.ActionProperty3ResourcesInner;
...
public class ActionProperty3 {
  ...
  private ActionProperty3Error error;
  ...
  private List<ActionProperty3ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty3() {
  }

  public ActionProperty3 command(String command) {
  ...
  **/
  ...
  public ActionProperty3 error(ActionProperty3Error error) {
  ...
  **/
  ...
  public ActionProperty3Error getError() {
    return error;
  }


  public void setError(ActionProperty3Error error) {
  ...
  public ActionProperty3 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty3 id(Long id) {
  ...
  **/
  ...
  public ActionProperty3 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty3 resources(List<ActionProperty3ResourcesInner> resources) {
  ...
  public ActionProperty3 addResourcesItem(ActionProperty3ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty3ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty3ResourcesInner> resources) {
  ...
  public ActionProperty3 started(String started) {
  ...
  **/
  ...
  public ActionProperty3 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty3 instance itself
   */
  public ActionProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty3 actionProperty3 = (ActionProperty3) o;
    return Objects.equals(this.command, actionProperty3.command) &&
        Objects.equals(this.error, actionProperty3.error) &&
        Objects.equals(this.finished, actionProperty3.finished) &&
        Objects.equals(this.id, actionProperty3.id) &&
        Objects.equals(this.progress, actionProperty3.progress) &&
        Objects.equals(this.resources, actionProperty3.resources) &&
        Objects.equals(this.started, actionProperty3.started) &&
        Objects.equals(this.status, actionProperty3.status)&&
        Objects.equals(this.additionalProperties, actionProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty3 is not found in the empty JSON string", ActionProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty3.openapiRequiredFields) {
      ...
      ActionProperty3Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty3ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty3>() {
           @Override
           public void write(JsonWriter out, ActionProperty3 value) throws IOException {
           ...
           @Override
           public ActionProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty3
  * @throws IOException if the JSON string is invalid with respect to ActionProperty3
  */
  public static ActionProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty3.class);
  }

 /**
  * Convert an instance of ActionProperty3 to an JSON string
  *
  * @return JSON string
  */
