...
import com.konfigthis.client.model.SshKeysGetByIdResponseSshKey;
...
public class SshKeysGetByIdResponse {
  public static final String SERIALIZED_NAME_SSH_KEY = "ssh_key";
  @SerializedName(SERIALIZED_NAME_SSH_KEY)
  private SshKeysGetByIdResponseSshKey sshKey;

  public SshKeysGetByIdResponse() {
  }

  public SshKeysGetByIdResponse sshKey(SshKeysGetByIdResponseSshKey sshKey) {
  ...
  **/
  ...
  public SshKeysGetByIdResponseSshKey getSshKey() {
    return sshKey;
  }


  public void setSshKey(SshKeysGetByIdResponseSshKey sshKey) {
   ...
   * @return the SshKeysGetByIdResponse instance itself
   */
  public SshKeysGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysGetByIdResponse sshKeysGetByIdResponse = (SshKeysGetByIdResponse) o;
    return Objects.equals(this.sshKey, sshKeysGetByIdResponse.sshKey)&&
        Objects.equals(this.additionalProperties, sshKeysGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysGetByIdResponse is not found in the empty JSON string", SshKeysGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `ssh_key`
      SshKeysGetByIdResponseSshKey.validateJsonObject(jsonObj.getAsJsonObject("ssh_key"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, SshKeysGetByIdResponse value) throws IOException {
           ...
           @Override
           public SshKeysGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to SshKeysGetByIdResponse
  */
  public static SshKeysGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysGetByIdResponse.class);
  }

 /**
  * Convert an instance of SshKeysGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
