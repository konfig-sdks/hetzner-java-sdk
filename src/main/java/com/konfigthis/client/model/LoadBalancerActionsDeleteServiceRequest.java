...
public class LoadBalancerActionsDeleteServiceRequest {
  public static final String SERIALIZED_NAME_LISTEN_PORT = "listen_port";
  @SerializedName(SERIALIZED_NAME_LISTEN_PORT)
  private Integer listenPort;

  public LoadBalancerActionsDeleteServiceRequest() {
  }

  public LoadBalancerActionsDeleteServiceRequest listenPort(Integer listenPort) {
  ...
  **/
  ...
  @ApiModelProperty(example = "443", required = true, value = "The listen port of the service you want to delete")
   ...
   * @return the LoadBalancerActionsDeleteServiceRequest instance itself
   */
  public LoadBalancerActionsDeleteServiceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsDeleteServiceRequest loadBalancerActionsDeleteServiceRequest = (LoadBalancerActionsDeleteServiceRequest) o;
    return Objects.equals(this.listenPort, loadBalancerActionsDeleteServiceRequest.listenPort)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsDeleteServiceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(listenPort, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancerActionsDeleteServiceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsDeleteServiceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsDeleteServiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsDeleteServiceRequest is not found in the empty JSON string", LoadBalancerActionsDeleteServiceRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsDeleteServiceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsDeleteServiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsDeleteServiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsDeleteServiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsDeleteServiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsDeleteServiceRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsDeleteServiceRequest value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsDeleteServiceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsDeleteServiceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsDeleteServiceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsDeleteServiceRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsDeleteServiceRequest
  */
  public static LoadBalancerActionsDeleteServiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsDeleteServiceRequest.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsDeleteServiceRequest to an JSON string
  *
  * @return JSON string
  */
