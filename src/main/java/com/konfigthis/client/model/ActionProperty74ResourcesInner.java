...
/**
 * ActionProperty74ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty74ResourcesInner {
  ...
  public ActionProperty74ResourcesInner() {
  }

  public ActionProperty74ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty74ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty74ResourcesInner instance itself
   */
  public ActionProperty74ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty74ResourcesInner actionProperty74ResourcesInner = (ActionProperty74ResourcesInner) o;
    return Objects.equals(this.id, actionProperty74ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty74ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty74ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty74ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty74ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty74ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty74ResourcesInner is not found in the empty JSON string", ActionProperty74ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty74ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty74ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty74ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty74ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty74ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty74ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty74ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty74ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty74ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty74ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty74ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty74ResourcesInner
  */
  public static ActionProperty74ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty74ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty74ResourcesInner to an JSON string
  *
  * @return JSON string
  */
