...
import com.konfigthis.client.model.ActionProperty54;
...
public class ServerActionsChangeDnsPtrResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty54 action;

  public ServerActionsChangeDnsPtrResponse() {
  }

  public ServerActionsChangeDnsPtrResponse action(ActionProperty54 action) {
  ...
  **/
  ...
  public ActionProperty54 getAction() {
    return action;
  }


  public void setAction(ActionProperty54 action) {
   ...
   * @return the ServerActionsChangeDnsPtrResponse instance itself
   */
  public ServerActionsChangeDnsPtrResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsChangeDnsPtrResponse serverActionsChangeDnsPtrResponse = (ServerActionsChangeDnsPtrResponse) o;
    return Objects.equals(this.action, serverActionsChangeDnsPtrResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsChangeDnsPtrResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsChangeDnsPtrResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsChangeDnsPtrResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsChangeDnsPtrResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsChangeDnsPtrResponse is not found in the empty JSON string", ServerActionsChangeDnsPtrResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsChangeDnsPtrResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty54.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsChangeDnsPtrResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsChangeDnsPtrResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsChangeDnsPtrResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsChangeDnsPtrResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsChangeDnsPtrResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsChangeDnsPtrResponse value) throws IOException {
           ...
           @Override
           public ServerActionsChangeDnsPtrResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsChangeDnsPtrResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsChangeDnsPtrResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsChangeDnsPtrResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsChangeDnsPtrResponse
  */
  public static ServerActionsChangeDnsPtrResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsChangeDnsPtrResponse.class);
  }

 /**
  * Convert an instance of ServerActionsChangeDnsPtrResponse to an JSON string
  *
  * @return JSON string
  */
