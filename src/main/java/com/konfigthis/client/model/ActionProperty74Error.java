...
public class ActionProperty74Error {
  ...
  public ActionProperty74Error() {
  }

  public ActionProperty74Error code(String code) {
  ...
  **/
  ...
  public ActionProperty74Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty74Error instance itself
   */
  public ActionProperty74Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty74Error actionProperty74Error = (ActionProperty74Error) o;
    return Objects.equals(this.code, actionProperty74Error.code) &&
        Objects.equals(this.message, actionProperty74Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty74Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty74Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty74Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty74Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty74Error is not found in the empty JSON string", ActionProperty74Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty74Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty74Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty74Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty74Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty74Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty74Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty74Error value) throws IOException {
           ...
           @Override
           public ActionProperty74Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty74Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty74Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty74Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty74Error
  */
  public static ActionProperty74Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty74Error.class);
  }

 /**
  * Convert an instance of ActionProperty74Error to an JSON string
  *
  * @return JSON string
  */
