...
/**
 * ActionProperty24ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty24ResourcesInner {
  ...
  public ActionProperty24ResourcesInner() {
  }

  public ActionProperty24ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty24ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty24ResourcesInner instance itself
   */
  public ActionProperty24ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty24ResourcesInner actionProperty24ResourcesInner = (ActionProperty24ResourcesInner) o;
    return Objects.equals(this.id, actionProperty24ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty24ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty24ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty24ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty24ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty24ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty24ResourcesInner is not found in the empty JSON string", ActionProperty24ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty24ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty24ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty24ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty24ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty24ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty24ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty24ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty24ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty24ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty24ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty24ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty24ResourcesInner
  */
  public static ActionProperty24ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty24ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty24ResourcesInner to an JSON string
  *
  * @return JSON string
  */
