...
public class ActionProperty25Error {
  ...
  public ActionProperty25Error() {
  }

  public ActionProperty25Error code(String code) {
  ...
  **/
  ...
  public ActionProperty25Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty25Error instance itself
   */
  public ActionProperty25Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty25Error actionProperty25Error = (ActionProperty25Error) o;
    return Objects.equals(this.code, actionProperty25Error.code) &&
        Objects.equals(this.message, actionProperty25Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty25Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty25Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty25Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty25Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty25Error is not found in the empty JSON string", ActionProperty25Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty25Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty25Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty25Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty25Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty25Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty25Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty25Error value) throws IOException {
           ...
           @Override
           public ActionProperty25Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty25Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty25Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty25Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty25Error
  */
  public static ActionProperty25Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty25Error.class);
  }

 /**
  * Convert an instance of ActionProperty25Error to an JSON string
  *
  * @return JSON string
  */
