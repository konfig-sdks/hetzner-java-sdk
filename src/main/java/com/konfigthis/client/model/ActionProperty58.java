...
import com.konfigthis.client.model.ActionProperty58Error;
import com.konfigthis.client.model.ActionProperty58ResourcesInner;
...
public class ActionProperty58 {
  ...
  private ActionProperty58Error error;
  ...
  private List<ActionProperty58ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty58() {
  }

  public ActionProperty58 command(String command) {
  ...
  **/
  ...
  public ActionProperty58 error(ActionProperty58Error error) {
  ...
  **/
  ...
  public ActionProperty58Error getError() {
    return error;
  }


  public void setError(ActionProperty58Error error) {
  ...
  public ActionProperty58 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty58 id(Long id) {
  ...
  **/
  ...
  public ActionProperty58 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty58 resources(List<ActionProperty58ResourcesInner> resources) {
  ...
  public ActionProperty58 addResourcesItem(ActionProperty58ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty58ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty58ResourcesInner> resources) {
  ...
  public ActionProperty58 started(String started) {
  ...
  **/
  ...
  public ActionProperty58 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty58 instance itself
   */
  public ActionProperty58 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty58 actionProperty58 = (ActionProperty58) o;
    return Objects.equals(this.command, actionProperty58.command) &&
        Objects.equals(this.error, actionProperty58.error) &&
        Objects.equals(this.finished, actionProperty58.finished) &&
        Objects.equals(this.id, actionProperty58.id) &&
        Objects.equals(this.progress, actionProperty58.progress) &&
        Objects.equals(this.resources, actionProperty58.resources) &&
        Objects.equals(this.started, actionProperty58.started) &&
        Objects.equals(this.status, actionProperty58.status)&&
        Objects.equals(this.additionalProperties, actionProperty58.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty58 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty58
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty58.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty58 is not found in the empty JSON string", ActionProperty58.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty58.openapiRequiredFields) {
      ...
      ActionProperty58Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty58ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty58.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty58' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty58> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty58.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty58>() {
           @Override
           public void write(JsonWriter out, ActionProperty58 value) throws IOException {
           ...
           @Override
           public ActionProperty58 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty58 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty58 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty58
  * @throws IOException if the JSON string is invalid with respect to ActionProperty58
  */
  public static ActionProperty58 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty58.class);
  }

 /**
  * Convert an instance of ActionProperty58 to an JSON string
  *
  * @return JSON string
  */
