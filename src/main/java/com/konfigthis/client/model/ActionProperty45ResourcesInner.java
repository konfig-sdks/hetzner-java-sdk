...
/**
 * ActionProperty45ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty45ResourcesInner {
  ...
  public ActionProperty45ResourcesInner() {
  }

  public ActionProperty45ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty45ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty45ResourcesInner instance itself
   */
  public ActionProperty45ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty45ResourcesInner actionProperty45ResourcesInner = (ActionProperty45ResourcesInner) o;
    return Objects.equals(this.id, actionProperty45ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty45ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty45ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty45ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty45ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty45ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty45ResourcesInner is not found in the empty JSON string", ActionProperty45ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty45ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty45ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty45ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty45ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty45ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty45ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty45ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty45ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty45ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty45ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty45ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty45ResourcesInner
  */
  public static ActionProperty45ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty45ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty45ResourcesInner to an JSON string
  *
  * @return JSON string
  */
