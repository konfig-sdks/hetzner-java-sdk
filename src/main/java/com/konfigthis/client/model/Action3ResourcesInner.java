...
public class Action3ResourcesInner {
  ...
  public Action3ResourcesInner() {
  }

  public Action3ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action3ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action3ResourcesInner instance itself
   */
  public Action3ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action3ResourcesInner action3ResourcesInner = (Action3ResourcesInner) o;
    return Objects.equals(this.id, action3ResourcesInner.id) &&
        Objects.equals(this.type, action3ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action3ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action3ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action3ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action3ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action3ResourcesInner is not found in the empty JSON string", Action3ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action3ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action3ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action3ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action3ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action3ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action3ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action3ResourcesInner value) throws IOException {
           ...
           @Override
           public Action3ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action3ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action3ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action3ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action3ResourcesInner
  */
  public static Action3ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action3ResourcesInner.class);
  }

 /**
  * Convert an instance of Action3ResourcesInner to an JSON string
  *
  * @return JSON string
  */
