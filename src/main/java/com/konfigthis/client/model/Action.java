...
import com.konfigthis.client.model.ActionError;
import com.konfigthis.client.model.ActionResourcesInner;
...
public class Action {
  ...
  **/
  ...
  public Action progress(Integer progress) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      ActionError.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
