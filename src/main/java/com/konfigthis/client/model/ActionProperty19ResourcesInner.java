...
/**
 * ActionProperty19ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty19ResourcesInner {
  ...
  public ActionProperty19ResourcesInner() {
  }

  public ActionProperty19ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty19ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty19ResourcesInner instance itself
   */
  public ActionProperty19ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty19ResourcesInner actionProperty19ResourcesInner = (ActionProperty19ResourcesInner) o;
    return Objects.equals(this.id, actionProperty19ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty19ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty19ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty19ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty19ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty19ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty19ResourcesInner is not found in the empty JSON string", ActionProperty19ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty19ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty19ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty19ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty19ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty19ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty19ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty19ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty19ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty19ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty19ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty19ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty19ResourcesInner
  */
  public static ActionProperty19ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty19ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty19ResourcesInner to an JSON string
  *
  * @return JSON string
  */
