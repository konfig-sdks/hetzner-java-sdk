...
/**
 * ActionProperty59ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty59ResourcesInner {
  ...
  public ActionProperty59ResourcesInner() {
  }

  public ActionProperty59ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty59ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty59ResourcesInner instance itself
   */
  public ActionProperty59ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty59ResourcesInner actionProperty59ResourcesInner = (ActionProperty59ResourcesInner) o;
    return Objects.equals(this.id, actionProperty59ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty59ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty59ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty59ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty59ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty59ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty59ResourcesInner is not found in the empty JSON string", ActionProperty59ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty59ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty59ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty59ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty59ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty59ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty59ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty59ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty59ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty59ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty59ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty59ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty59ResourcesInner
  */
  public static ActionProperty59ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty59ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty59ResourcesInner to an JSON string
  *
  * @return JSON string
  */
