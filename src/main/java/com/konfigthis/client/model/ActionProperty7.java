...
import com.konfigthis.client.model.ActionProperty7Error;
import com.konfigthis.client.model.ActionProperty7ResourcesInner;
...
public class ActionProperty7 {
  ...
  private ActionProperty7Error error;
  ...
  private List<ActionProperty7ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty7() {
  }

  public ActionProperty7 command(String command) {
  ...
  **/
  ...
  public ActionProperty7 error(ActionProperty7Error error) {
  ...
  **/
  ...
  public ActionProperty7Error getError() {
    return error;
  }


  public void setError(ActionProperty7Error error) {
  ...
  public ActionProperty7 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty7 id(Long id) {
  ...
  **/
  ...
  public ActionProperty7 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty7 resources(List<ActionProperty7ResourcesInner> resources) {
  ...
  public ActionProperty7 addResourcesItem(ActionProperty7ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty7ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty7ResourcesInner> resources) {
  ...
  public ActionProperty7 started(String started) {
  ...
  **/
  ...
  public ActionProperty7 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty7 instance itself
   */
  public ActionProperty7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty7 actionProperty7 = (ActionProperty7) o;
    return Objects.equals(this.command, actionProperty7.command) &&
        Objects.equals(this.error, actionProperty7.error) &&
        Objects.equals(this.finished, actionProperty7.finished) &&
        Objects.equals(this.id, actionProperty7.id) &&
        Objects.equals(this.progress, actionProperty7.progress) &&
        Objects.equals(this.resources, actionProperty7.resources) &&
        Objects.equals(this.started, actionProperty7.started) &&
        Objects.equals(this.status, actionProperty7.status)&&
        Objects.equals(this.additionalProperties, actionProperty7.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty7 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty7 is not found in the empty JSON string", ActionProperty7.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty7.openapiRequiredFields) {
      ...
      ActionProperty7Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty7ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty7.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty7>() {
           @Override
           public void write(JsonWriter out, ActionProperty7 value) throws IOException {
           ...
           @Override
           public ActionProperty7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty7
  * @throws IOException if the JSON string is invalid with respect to ActionProperty7
  */
  public static ActionProperty7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty7.class);
  }

 /**
  * Convert an instance of ActionProperty7 to an JSON string
  *
  * @return JSON string
  */
