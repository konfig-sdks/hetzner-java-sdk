...
import com.konfigthis.client.model.ActionProperty45Error;
import com.konfigthis.client.model.ActionProperty45ResourcesInner;
...
public class ActionProperty45 {
  ...
  private ActionProperty45Error error;
  ...
  private List<ActionProperty45ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty45() {
  }

  public ActionProperty45 command(String command) {
  ...
  **/
  ...
  public ActionProperty45 error(ActionProperty45Error error) {
  ...
  **/
  ...
  public ActionProperty45Error getError() {
    return error;
  }


  public void setError(ActionProperty45Error error) {
  ...
  public ActionProperty45 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty45 id(Long id) {
  ...
  **/
  ...
  public ActionProperty45 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty45 resources(List<ActionProperty45ResourcesInner> resources) {
  ...
  public ActionProperty45 addResourcesItem(ActionProperty45ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty45ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty45ResourcesInner> resources) {
  ...
  public ActionProperty45 started(String started) {
  ...
  **/
  ...
  public ActionProperty45 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty45 instance itself
   */
  public ActionProperty45 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty45 actionProperty45 = (ActionProperty45) o;
    return Objects.equals(this.command, actionProperty45.command) &&
        Objects.equals(this.error, actionProperty45.error) &&
        Objects.equals(this.finished, actionProperty45.finished) &&
        Objects.equals(this.id, actionProperty45.id) &&
        Objects.equals(this.progress, actionProperty45.progress) &&
        Objects.equals(this.resources, actionProperty45.resources) &&
        Objects.equals(this.started, actionProperty45.started) &&
        Objects.equals(this.status, actionProperty45.status)&&
        Objects.equals(this.additionalProperties, actionProperty45.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty45 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty45
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty45.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty45 is not found in the empty JSON string", ActionProperty45.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty45.openapiRequiredFields) {
      ...
      ActionProperty45Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty45ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty45.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty45' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty45> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty45.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty45>() {
           @Override
           public void write(JsonWriter out, ActionProperty45 value) throws IOException {
           ...
           @Override
           public ActionProperty45 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty45 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty45 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty45
  * @throws IOException if the JSON string is invalid with respect to ActionProperty45
  */
  public static ActionProperty45 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty45.class);
  }

 /**
  * Convert an instance of ActionProperty45 to an JSON string
  *
  * @return JSON string
  */
