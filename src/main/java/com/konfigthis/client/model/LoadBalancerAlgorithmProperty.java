...
public class LoadBalancerAlgorithmProperty {
  /**
 ...
 public enum TypeEnum {
  ...
  private TypeEnum type = TypeEnum.ROUND_ROBIN;

  public LoadBalancerAlgorithmProperty() {
  }

  public LoadBalancerAlgorithmProperty type(TypeEnum type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "ROUND_ROBIN", required = true, value = "Type of the algorithm.")
   ...
   * @return the LoadBalancerAlgorithmProperty instance itself
   */
  public LoadBalancerAlgorithmProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerAlgorithmProperty loadBalancerAlgorithmProperty = (LoadBalancerAlgorithmProperty) o;
    return Objects.equals(this.type, loadBalancerAlgorithmProperty.type)&&
        Objects.equals(this.additionalProperties, loadBalancerAlgorithmProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerAlgorithmProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerAlgorithmProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerAlgorithmProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerAlgorithmProperty is not found in the empty JSON string", LoadBalancerAlgorithmProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerAlgorithmProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerAlgorithmProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerAlgorithmProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerAlgorithmProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerAlgorithmProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerAlgorithmProperty>() {
           @Override
           public void write(JsonWriter out, LoadBalancerAlgorithmProperty value) throws IOException {
           ...
           @Override
           public LoadBalancerAlgorithmProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerAlgorithmProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerAlgorithmProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerAlgorithmProperty
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerAlgorithmProperty
  */
  public static LoadBalancerAlgorithmProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerAlgorithmProperty.class);
  }

 /**
  * Convert an instance of LoadBalancerAlgorithmProperty to an JSON string
  *
  * @return JSON string
  */
