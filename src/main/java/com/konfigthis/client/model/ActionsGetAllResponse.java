...
import com.konfigthis.client.model.Action2;
import com.konfigthis.client.model.ListMetaProperty1;
...
public class ActionsGetAllResponse {
  public static final String SERIALIZED_NAME_ACTIONS = "actions";
  @SerializedName(SERIALIZED_NAME_ACTIONS)
  private List<Action2> actions = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty1 meta;

  public ActionsGetAllResponse() {
  }

  public ActionsGetAllResponse actions(List<Action2> actions) {
  ...
  public ActionsGetAllResponse addActionsItem(Action2 actionsItem) {
  ...
  **/
  ...
  public void setActions(List<Action2> actions) {
  ...
  public ActionsGetAllResponse meta(ListMetaProperty1 meta) {
  ...
  **/
  ...
  public ListMetaProperty1 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty1 meta) {
   ...
   * @return the ActionsGetAllResponse instance itself
   */
  public ActionsGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionsGetAllResponse actionsGetAllResponse = (ActionsGetAllResponse) o;
    return Objects.equals(this.actions, actionsGetAllResponse.actions) &&
        Objects.equals(this.meta, actionsGetAllResponse.meta)&&
        Objects.equals(this.additionalProperties, actionsGetAllResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionsGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionsGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionsGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionsGetAllResponse is not found in the empty JSON string", ActionsGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionsGetAllResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayactions.size(); i++) {
        Action2.validateJsonObject(jsonArrayactions.get(i).getAsJsonObject());
      };
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty1.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionsGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionsGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionsGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionsGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionsGetAllResponse>() {
           @Override
           public void write(JsonWriter out, ActionsGetAllResponse value) throws IOException {
           ...
           @Override
           public ActionsGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionsGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionsGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionsGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to ActionsGetAllResponse
  */
  public static ActionsGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionsGetAllResponse.class);
  }

 /**
  * Convert an instance of ActionsGetAllResponse to an JSON string
  *
  * @return JSON string
  */
