...
/**
 * Action20ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action20ResourcesInner {
  ...
  public Action20ResourcesInner() {
  }

  public Action20ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action20ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action20ResourcesInner instance itself
   */
  public Action20ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action20ResourcesInner action20ResourcesInner = (Action20ResourcesInner) o;
    return Objects.equals(this.id, action20ResourcesInner.id) &&
        Objects.equals(this.type, action20ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action20ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action20ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action20ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action20ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action20ResourcesInner is not found in the empty JSON string", Action20ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action20ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action20ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action20ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action20ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action20ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action20ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action20ResourcesInner value) throws IOException {
           ...
           @Override
           public Action20ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action20ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action20ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action20ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action20ResourcesInner
  */
  public static Action20ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action20ResourcesInner.class);
  }

 /**
  * Convert an instance of Action20ResourcesInner to an JSON string
  *
  * @return JSON string
  */
