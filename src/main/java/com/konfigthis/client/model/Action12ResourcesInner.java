...
/**
 * Action12ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action12ResourcesInner {
  ...
  public Action12ResourcesInner() {
  }

  public Action12ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action12ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action12ResourcesInner instance itself
   */
  public Action12ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action12ResourcesInner action12ResourcesInner = (Action12ResourcesInner) o;
    return Objects.equals(this.id, action12ResourcesInner.id) &&
        Objects.equals(this.type, action12ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action12ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action12ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action12ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action12ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action12ResourcesInner is not found in the empty JSON string", Action12ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action12ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action12ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action12ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action12ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action12ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action12ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action12ResourcesInner value) throws IOException {
           ...
           @Override
           public Action12ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action12ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action12ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action12ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action12ResourcesInner
  */
  public static Action12ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action12ResourcesInner.class);
  }

 /**
  * Convert an instance of Action12ResourcesInner to an JSON string
  *
  * @return JSON string
  */
