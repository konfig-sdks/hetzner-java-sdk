...
public class CertificatesUpdateByIdRequest {
  ...
  public CertificatesUpdateByIdRequest() {
  }

  public CertificatesUpdateByIdRequest labels(Object labels) {
  ...
  **/
  ...
  public CertificatesUpdateByIdRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "my website cert", value = "New Certificate name")
   ...
   * @return the CertificatesUpdateByIdRequest instance itself
   */
  public CertificatesUpdateByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatesUpdateByIdRequest certificatesUpdateByIdRequest = (CertificatesUpdateByIdRequest) o;
    return Objects.equals(this.labels, certificatesUpdateByIdRequest.labels) &&
        Objects.equals(this.name, certificatesUpdateByIdRequest.name)&&
        Objects.equals(this.additionalProperties, certificatesUpdateByIdRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificatesUpdateByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatesUpdateByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatesUpdateByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesUpdateByIdRequest is not found in the empty JSON string", CertificatesUpdateByIdRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesUpdateByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesUpdateByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesUpdateByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesUpdateByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesUpdateByIdRequest>() {
           @Override
           public void write(JsonWriter out, CertificatesUpdateByIdRequest value) throws IOException {
           ...
           @Override
           public CertificatesUpdateByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatesUpdateByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatesUpdateByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatesUpdateByIdRequest
  * @throws IOException if the JSON string is invalid with respect to CertificatesUpdateByIdRequest
  */
  public static CertificatesUpdateByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesUpdateByIdRequest.class);
  }

 /**
  * Convert an instance of CertificatesUpdateByIdRequest to an JSON string
  *
  * @return JSON string
  */
