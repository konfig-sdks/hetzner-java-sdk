...
import com.konfigthis.client.model.Action21Error;
import com.konfigthis.client.model.Action21ResourcesInner;
...
public class Action21 {
  ...
  private List<Action21ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action21 command(String command) {
  ...
  **/
  ...
  public Action21 error(Action21Error error) {
  ...
  **/
  ...
  public Action21Error getError() {
    return error;
  }


  public void setError(Action21Error error) {
  ...
  public Action21 finished(String finished) {
  ...
  **/
  ...
  public Action21 progress(Integer progress) {
  ...
  **/
  ...
  public Action21 resources(List<Action21ResourcesInner> resources) {
  ...
  public Action21 addResourcesItem(Action21ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action21ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action21ResourcesInner> resources) {
  ...
  public Action21 started(String started) {
  ...
  **/
  ...
  public Action21 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action21 instance itself
   */
  public Action21 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action21 action21 = (Action21) o;
    return Objects.equals(this.command, action21.command) &&
        Objects.equals(this.error, action21.error) &&
        Objects.equals(this.finished, action21.finished) &&
        Objects.equals(this.id, action21.id) &&
        Objects.equals(this.progress, action21.progress) &&
        Objects.equals(this.resources, action21.resources) &&
        Objects.equals(this.started, action21.started) &&
        Objects.equals(this.status, action21.status)&&
        Objects.equals(this.additionalProperties, action21.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action21
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action21.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action21 is not found in the empty JSON string", Action21.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action21.openapiRequiredFields) {
      ...
      Action21Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action21ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action21.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action21' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action21> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action21.class));

       return (TypeAdapter<T>) new TypeAdapter<Action21>() {
           @Override
           public void write(JsonWriter out, Action21 value) throws IOException {
           ...
           @Override
           public Action21 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action21 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action21 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action21
  * @throws IOException if the JSON string is invalid with respect to Action21
  */
  public static Action21 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action21.class);
  }

 /**
  * Convert an instance of Action21 to an JSON string
  *
  * @return JSON string
  */
