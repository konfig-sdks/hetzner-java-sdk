...
import com.konfigthis.client.model.ListMetaProperty10Pagination;
...
public class ListMetaProperty10 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty10Pagination pagination;

  public ListMetaProperty10() {
  }

  public ListMetaProperty10 pagination(ListMetaProperty10Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty10Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty10Pagination pagination) {
   ...
   * @return the ListMetaProperty10 instance itself
   */
  public ListMetaProperty10 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty10 listMetaProperty10 = (ListMetaProperty10) o;
    return Objects.equals(this.pagination, listMetaProperty10.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty10.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty10 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty10
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty10.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty10 is not found in the empty JSON string", ListMetaProperty10.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty10.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty10Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty10.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty10>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty10 value) throws IOException {
           ...
           @Override
           public ListMetaProperty10 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty10 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty10 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty10
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty10
  */
  public static ListMetaProperty10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty10.class);
  }

 /**
  * Convert an instance of ListMetaProperty10 to an JSON string
  *
  * @return JSON string
  */
