...
import com.konfigthis.client.model.ActionProperty61Error;
import com.konfigthis.client.model.ActionProperty61ResourcesInner;
...
public class ActionProperty61 {
  ...
  private ActionProperty61Error error;
  ...
  private List<ActionProperty61ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty61() {
  }

  public ActionProperty61 command(String command) {
  ...
  **/
  ...
  public ActionProperty61 error(ActionProperty61Error error) {
  ...
  **/
  ...
  public ActionProperty61Error getError() {
    return error;
  }


  public void setError(ActionProperty61Error error) {
  ...
  public ActionProperty61 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty61 id(Long id) {
  ...
  **/
  ...
  public ActionProperty61 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty61 resources(List<ActionProperty61ResourcesInner> resources) {
  ...
  public ActionProperty61 addResourcesItem(ActionProperty61ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty61ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty61ResourcesInner> resources) {
  ...
  public ActionProperty61 started(String started) {
  ...
  **/
  ...
  public ActionProperty61 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty61 instance itself
   */
  public ActionProperty61 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty61 actionProperty61 = (ActionProperty61) o;
    return Objects.equals(this.command, actionProperty61.command) &&
        Objects.equals(this.error, actionProperty61.error) &&
        Objects.equals(this.finished, actionProperty61.finished) &&
        Objects.equals(this.id, actionProperty61.id) &&
        Objects.equals(this.progress, actionProperty61.progress) &&
        Objects.equals(this.resources, actionProperty61.resources) &&
        Objects.equals(this.started, actionProperty61.started) &&
        Objects.equals(this.status, actionProperty61.status)&&
        Objects.equals(this.additionalProperties, actionProperty61.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty61 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty61
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty61.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty61 is not found in the empty JSON string", ActionProperty61.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty61.openapiRequiredFields) {
      ...
      ActionProperty61Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty61ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty61.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty61' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty61> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty61.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty61>() {
           @Override
           public void write(JsonWriter out, ActionProperty61 value) throws IOException {
           ...
           @Override
           public ActionProperty61 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty61 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty61 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty61
  * @throws IOException if the JSON string is invalid with respect to ActionProperty61
  */
  public static ActionProperty61 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty61.class);
  }

 /**
  * Convert an instance of ActionProperty61 to an JSON string
  *
  * @return JSON string
  */
