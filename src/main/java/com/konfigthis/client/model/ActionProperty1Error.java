...
public class ActionProperty1Error {
  ...
  public ActionProperty1Error() {
  }

  public ActionProperty1Error code(String code) {
  ...
  **/
  ...
  public ActionProperty1Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty1Error instance itself
   */
  public ActionProperty1Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty1Error actionProperty1Error = (ActionProperty1Error) o;
    return Objects.equals(this.code, actionProperty1Error.code) &&
        Objects.equals(this.message, actionProperty1Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty1Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty1Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty1Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty1Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty1Error is not found in the empty JSON string", ActionProperty1Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty1Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty1Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty1Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty1Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty1Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty1Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty1Error value) throws IOException {
           ...
           @Override
           public ActionProperty1Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty1Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty1Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty1Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty1Error
  */
  public static ActionProperty1Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty1Error.class);
  }

 /**
  * Convert an instance of ActionProperty1Error to an JSON string
  *
  * @return JSON string
  */
