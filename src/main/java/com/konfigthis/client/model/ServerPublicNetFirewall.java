...
public class ServerPublicNetFirewall {
 ...
 public enum StatusEnum {
  ...
  public ServerPublicNetFirewall id(Long id) {
  ...
  **/
   ...
   * @return the ServerPublicNetFirewall instance itself
   */
  public ServerPublicNetFirewall putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, serverPublicNetFirewall.id) &&
        ...
        Objects.equals(this.additionalProperties, serverPublicNetFirewall.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerPublicNetFirewall
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerPublicNetFirewall.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ServerPublicNetFirewall>() {
           ...
           public ServerPublicNetFirewall read(JsonReader in) throws IOException {
             ...
             ServerPublicNetFirewall instance = thisAdapter.fromJsonTree(jsonObj);
