...
/**
 * ActionProperty38ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty38ResourcesInner {
  ...
  public ActionProperty38ResourcesInner() {
  }

  public ActionProperty38ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty38ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty38ResourcesInner instance itself
   */
  public ActionProperty38ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty38ResourcesInner actionProperty38ResourcesInner = (ActionProperty38ResourcesInner) o;
    return Objects.equals(this.id, actionProperty38ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty38ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty38ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty38ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty38ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty38ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty38ResourcesInner is not found in the empty JSON string", ActionProperty38ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty38ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty38ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty38ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty38ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty38ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty38ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty38ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty38ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty38ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty38ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty38ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty38ResourcesInner
  */
  public static ActionProperty38ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty38ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty38ResourcesInner to an JSON string
  *
  * @return JSON string
  */
