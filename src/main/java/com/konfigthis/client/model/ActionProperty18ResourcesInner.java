...
/**
 * ActionProperty18ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty18ResourcesInner {
  ...
  public ActionProperty18ResourcesInner() {
  }

  public ActionProperty18ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty18ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty18ResourcesInner instance itself
   */
  public ActionProperty18ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty18ResourcesInner actionProperty18ResourcesInner = (ActionProperty18ResourcesInner) o;
    return Objects.equals(this.id, actionProperty18ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty18ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty18ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty18ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty18ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty18ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty18ResourcesInner is not found in the empty JSON string", ActionProperty18ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty18ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty18ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty18ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty18ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty18ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty18ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty18ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty18ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty18ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty18ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty18ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty18ResourcesInner
  */
  public static ActionProperty18ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty18ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty18ResourcesInner to an JSON string
  *
  * @return JSON string
  */
