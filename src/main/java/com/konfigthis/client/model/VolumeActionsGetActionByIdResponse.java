...
import com.konfigthis.client.model.ActionProperty75;
...
public class VolumeActionsGetActionByIdResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty75 action;

  public VolumeActionsGetActionByIdResponse() {
  }

  public VolumeActionsGetActionByIdResponse action(ActionProperty75 action) {
  ...
  **/
  ...
  public ActionProperty75 getAction() {
    return action;
  }


  public void setAction(ActionProperty75 action) {
   ...
   * @return the VolumeActionsGetActionByIdResponse instance itself
   */
  public VolumeActionsGetActionByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeActionsGetActionByIdResponse volumeActionsGetActionByIdResponse = (VolumeActionsGetActionByIdResponse) o;
    return Objects.equals(this.action, volumeActionsGetActionByIdResponse.action)&&
        Objects.equals(this.additionalProperties, volumeActionsGetActionByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumeActionsGetActionByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionsGetActionByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionsGetActionByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionsGetActionByIdResponse is not found in the empty JSON string", VolumeActionsGetActionByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionsGetActionByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty75.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionsGetActionByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionsGetActionByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionsGetActionByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionsGetActionByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionsGetActionByIdResponse>() {
           @Override
           public void write(JsonWriter out, VolumeActionsGetActionByIdResponse value) throws IOException {
           ...
           @Override
           public VolumeActionsGetActionByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionsGetActionByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionsGetActionByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionsGetActionByIdResponse
  * @throws IOException if the JSON string is invalid with respect to VolumeActionsGetActionByIdResponse
  */
  public static VolumeActionsGetActionByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionsGetActionByIdResponse.class);
  }

 /**
  * Convert an instance of VolumeActionsGetActionByIdResponse to an JSON string
  *
  * @return JSON string
  */
