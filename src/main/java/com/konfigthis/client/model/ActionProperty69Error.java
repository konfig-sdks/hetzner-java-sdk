...
public class ActionProperty69Error {
  ...
  public ActionProperty69Error() {
  }

  public ActionProperty69Error code(String code) {
  ...
  **/
  ...
  public ActionProperty69Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty69Error instance itself
   */
  public ActionProperty69Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty69Error actionProperty69Error = (ActionProperty69Error) o;
    return Objects.equals(this.code, actionProperty69Error.code) &&
        Objects.equals(this.message, actionProperty69Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty69Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty69Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty69Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty69Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty69Error is not found in the empty JSON string", ActionProperty69Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty69Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty69Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty69Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty69Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty69Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty69Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty69Error value) throws IOException {
           ...
           @Override
           public ActionProperty69Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty69Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty69Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty69Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty69Error
  */
  public static ActionProperty69Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty69Error.class);
  }

 /**
  * Convert an instance of ActionProperty69Error to an JSON string
  *
  * @return JSON string
  */
