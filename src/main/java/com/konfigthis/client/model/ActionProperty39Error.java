...
public class ActionProperty39Error {
  ...
  public ActionProperty39Error() {
  }

  public ActionProperty39Error code(String code) {
  ...
  **/
  ...
  public ActionProperty39Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty39Error instance itself
   */
  public ActionProperty39Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty39Error actionProperty39Error = (ActionProperty39Error) o;
    return Objects.equals(this.code, actionProperty39Error.code) &&
        Objects.equals(this.message, actionProperty39Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty39Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty39Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty39Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty39Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty39Error is not found in the empty JSON string", ActionProperty39Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty39Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty39Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty39Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty39Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty39Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty39Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty39Error value) throws IOException {
           ...
           @Override
           public ActionProperty39Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty39Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty39Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty39Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty39Error
  */
  public static ActionProperty39Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty39Error.class);
  }

 /**
  * Convert an instance of ActionProperty39Error to an JSON string
  *
  * @return JSON string
  */
