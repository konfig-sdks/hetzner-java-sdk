...
public class Action6Error {
  ...
  public Action6Error code(String code) {
  ...
  **/
  ...
  public Action6Error message(String message) {
  ...
  **/
   ...
   * @return the Action6Error instance itself
   */
  public Action6Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action6Error action6Error = (Action6Error) o;
    return Objects.equals(this.code, action6Error.code) &&
        Objects.equals(this.message, action6Error.message)&&
        Objects.equals(this.additionalProperties, action6Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action6Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action6Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action6Error is not found in the empty JSON string", Action6Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action6Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action6Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action6Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action6Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action6Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action6Error>() {
           @Override
           public void write(JsonWriter out, Action6Error value) throws IOException {
           ...
           @Override
           public Action6Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action6Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action6Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action6Error
  * @throws IOException if the JSON string is invalid with respect to Action6Error
  */
  public static Action6Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action6Error.class);
  }

 /**
  * Convert an instance of Action6Error to an JSON string
  *
  * @return JSON string
  */
