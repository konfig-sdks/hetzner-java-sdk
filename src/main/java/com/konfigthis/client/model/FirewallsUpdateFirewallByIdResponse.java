...
import com.konfigthis.client.model.FirewallProperty2;
...
public class FirewallsUpdateFirewallByIdResponse {
  public static final String SERIALIZED_NAME_FIREWALL = "firewall";
  @SerializedName(SERIALIZED_NAME_FIREWALL)
  private FirewallProperty2 firewall;

  public FirewallsUpdateFirewallByIdResponse() {
  }

  public FirewallsUpdateFirewallByIdResponse firewall(FirewallProperty2 firewall) {
  ...
  **/
  ...
  public FirewallProperty2 getFirewall() {
    return firewall;
  }


  public void setFirewall(FirewallProperty2 firewall) {
   ...
   * @return the FirewallsUpdateFirewallByIdResponse instance itself
   */
  public FirewallsUpdateFirewallByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsUpdateFirewallByIdResponse firewallsUpdateFirewallByIdResponse = (FirewallsUpdateFirewallByIdResponse) o;
    return Objects.equals(this.firewall, firewallsUpdateFirewallByIdResponse.firewall)&&
        Objects.equals(this.additionalProperties, firewallsUpdateFirewallByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsUpdateFirewallByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsUpdateFirewallByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsUpdateFirewallByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsUpdateFirewallByIdResponse is not found in the empty JSON string", FirewallsUpdateFirewallByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsUpdateFirewallByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `firewall`
      FirewallProperty2.validateJsonObject(jsonObj.getAsJsonObject("firewall"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsUpdateFirewallByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsUpdateFirewallByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsUpdateFirewallByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsUpdateFirewallByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsUpdateFirewallByIdResponse>() {
           @Override
           public void write(JsonWriter out, FirewallsUpdateFirewallByIdResponse value) throws IOException {
           ...
           @Override
           public FirewallsUpdateFirewallByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsUpdateFirewallByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsUpdateFirewallByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsUpdateFirewallByIdResponse
  * @throws IOException if the JSON string is invalid with respect to FirewallsUpdateFirewallByIdResponse
  */
  public static FirewallsUpdateFirewallByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsUpdateFirewallByIdResponse.class);
  }

 /**
  * Convert an instance of FirewallsUpdateFirewallByIdResponse to an JSON string
  *
  * @return JSON string
  */
