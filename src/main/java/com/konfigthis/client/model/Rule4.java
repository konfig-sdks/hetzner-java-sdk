...
public class Rule4 {
 ...
 public enum ProtocolEnum {
  ...
  public Rule4 description(String description) {
  ...
  **/
  ...
  public Rule4 destinationIps(List<String> destinationIps) {
  ...
  public Rule4 addDestinationIpsItem(String destinationIpsItem) {
  ...
  **/
  ...
  public Rule4 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public Rule4 protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public Rule4 sourceIps(List<String> sourceIps) {
  ...
  public Rule4 addSourceIpsItem(String sourceIpsItem) {
  ...
  **/
   ...
   * @return the Rule4 instance itself
   */
  public Rule4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Rule4 rule4 = (Rule4) o;
    return Objects.equals(this.description, rule4.description) &&
        Objects.equals(this.destinationIps, rule4.destinationIps) &&
        Objects.equals(this.direction, rule4.direction) &&
        Objects.equals(this.port, rule4.port) &&
        Objects.equals(this.protocol, rule4.protocol) &&
        Objects.equals(this.sourceIps, rule4.sourceIps)&&
        Objects.equals(this.additionalProperties, rule4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Rule4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Rule4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rule4 is not found in the empty JSON string", Rule4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rule4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rule4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rule4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rule4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rule4.class));

       return (TypeAdapter<T>) new TypeAdapter<Rule4>() {
           @Override
           public void write(JsonWriter out, Rule4 value) throws IOException {
           ...
           @Override
           public Rule4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Rule4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Rule4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Rule4
  * @throws IOException if the JSON string is invalid with respect to Rule4
  */
  public static Rule4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rule4.class);
  }

 /**
  * Convert an instance of Rule4 to an JSON string
  *
  * @return JSON string
  */
