...
public class ListMetaProperty24Pagination {
  ...
  public ListMetaProperty24Pagination() {
  }

  public ListMetaProperty24Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty24Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty24Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty24Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty24Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty24Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty24Pagination instance itself
   */
  public ListMetaProperty24Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty24Pagination listMetaProperty24Pagination = (ListMetaProperty24Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty24Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty24Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty24Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty24Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty24Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty24Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty24Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty24Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty24Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty24Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty24Pagination is not found in the empty JSON string", ListMetaProperty24Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty24Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty24Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty24Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty24Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty24Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty24Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty24Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty24Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty24Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty24Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty24Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty24Pagination
  */
  public static ListMetaProperty24Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty24Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty24Pagination to an JSON string
  *
  * @return JSON string
  */
