...
import com.konfigthis.client.model.IsOsGetResponseIso;
...
public class IsOsGetResponse {
  public static final String SERIALIZED_NAME_ISO = "iso";
  @SerializedName(SERIALIZED_NAME_ISO)
  private IsOsGetResponseIso iso;

  public IsOsGetResponse() {
  }

  public IsOsGetResponse iso(IsOsGetResponseIso iso) {
  ...
  **/
  ...
  public IsOsGetResponseIso getIso() {
    return iso;
  }


  public void setIso(IsOsGetResponseIso iso) {
   ...
   * @return the IsOsGetResponse instance itself
   */
  public IsOsGetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IsOsGetResponse isOsGetResponse = (IsOsGetResponse) o;
    return Objects.equals(this.iso, isOsGetResponse.iso)&&
        Objects.equals(this.additionalProperties, isOsGetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsOsGetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IsOsGetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IsOsGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsOsGetResponse is not found in the empty JSON string", IsOsGetResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsOsGetResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `iso`
      IsOsGetResponseIso.validateJsonObject(jsonObj.getAsJsonObject("iso"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsOsGetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsOsGetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsOsGetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsOsGetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IsOsGetResponse>() {
           @Override
           public void write(JsonWriter out, IsOsGetResponse value) throws IOException {
           ...
           @Override
           public IsOsGetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IsOsGetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IsOsGetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IsOsGetResponse
  * @throws IOException if the JSON string is invalid with respect to IsOsGetResponse
  */
  public static IsOsGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsOsGetResponse.class);
  }

 /**
  * Convert an instance of IsOsGetResponse to an JSON string
  *
  * @return JSON string
  */
