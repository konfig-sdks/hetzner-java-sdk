...
import com.konfigthis.client.model.ServerTypesListAllServerTypesResponseServerTypesInner;
...
public class ServerTypesListAllServerTypesResponse {
  public static final String SERIALIZED_NAME_SERVER_TYPES = "server_types";
  @SerializedName(SERIALIZED_NAME_SERVER_TYPES)
  private List<ServerTypesListAllServerTypesResponseServerTypesInner> serverTypes = new ArrayList<>();

  public ServerTypesListAllServerTypesResponse() {
  }

  public ServerTypesListAllServerTypesResponse serverTypes(List<ServerTypesListAllServerTypesResponseServerTypesInner> serverTypes) {
  ...
  public ServerTypesListAllServerTypesResponse addServerTypesItem(ServerTypesListAllServerTypesResponseServerTypesInner serverTypesItem) {
  ...
  **/
  ...
  public List<ServerTypesListAllServerTypesResponseServerTypesInner> getServerTypes() {
    return serverTypes;
  }


  public void setServerTypes(List<ServerTypesListAllServerTypesResponseServerTypesInner> serverTypes) {
   ...
   * @return the ServerTypesListAllServerTypesResponse instance itself
   */
  public ServerTypesListAllServerTypesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerTypesListAllServerTypesResponse serverTypesListAllServerTypesResponse = (ServerTypesListAllServerTypesResponse) o;
    return Objects.equals(this.serverTypes, serverTypesListAllServerTypesResponse.serverTypes)&&
        Objects.equals(this.additionalProperties, serverTypesListAllServerTypesResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverTypes, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerTypesListAllServerTypesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerTypesListAllServerTypesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerTypesListAllServerTypesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerTypesListAllServerTypesResponse is not found in the empty JSON string", ServerTypesListAllServerTypesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerTypesListAllServerTypesResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayserverTypes.size(); i++) {
        ServerTypesListAllServerTypesResponseServerTypesInner.validateJsonObject(jsonArrayserverTypes.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerTypesListAllServerTypesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerTypesListAllServerTypesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerTypesListAllServerTypesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerTypesListAllServerTypesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerTypesListAllServerTypesResponse>() {
           @Override
           public void write(JsonWriter out, ServerTypesListAllServerTypesResponse value) throws IOException {
           ...
           @Override
           public ServerTypesListAllServerTypesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerTypesListAllServerTypesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerTypesListAllServerTypesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerTypesListAllServerTypesResponse
  * @throws IOException if the JSON string is invalid with respect to ServerTypesListAllServerTypesResponse
  */
  public static ServerTypesListAllServerTypesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerTypesListAllServerTypesResponse.class);
  }

 /**
  * Convert an instance of ServerTypesListAllServerTypesResponse to an JSON string
  *
  * @return JSON string
  */
