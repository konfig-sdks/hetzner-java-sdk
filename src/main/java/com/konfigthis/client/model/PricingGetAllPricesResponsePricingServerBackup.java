 ...
 */
@ApiModel(description = "Will increase base Server costs by specific percentage")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PricingGetAllPricesResponsePricingServerBackup {
  public static final String SERIALIZED_NAME_PERCENTAGE = "percentage";
  @SerializedName(SERIALIZED_NAME_PERCENTAGE)
  private BigDecimal percentage;

  public PricingGetAllPricesResponsePricingServerBackup() {
  }

  public PricingGetAllPricesResponsePricingServerBackup percentage(BigDecimal percentage) {
  ...
  **/
  ...
  @ApiModelProperty(example = "20.0000000000", required = true, value = "Percentage by how much the base price will increase")
   ...
   * @return the PricingGetAllPricesResponsePricingServerBackup instance itself
   */
  public PricingGetAllPricesResponsePricingServerBackup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PricingGetAllPricesResponsePricingServerBackup pricingGetAllPricesResponsePricingServerBackup = (PricingGetAllPricesResponsePricingServerBackup) o;
    return Objects.equals(this.percentage, pricingGetAllPricesResponsePricingServerBackup.percentage)&&
        Objects.equals(this.additionalProperties, pricingGetAllPricesResponsePricingServerBackup.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricingGetAllPricesResponsePricingServerBackup {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PricingGetAllPricesResponsePricingServerBackup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PricingGetAllPricesResponsePricingServerBackup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricingGetAllPricesResponsePricingServerBackup is not found in the empty JSON string", PricingGetAllPricesResponsePricingServerBackup.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricingGetAllPricesResponsePricingServerBackup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricingGetAllPricesResponsePricingServerBackup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricingGetAllPricesResponsePricingServerBackup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricingGetAllPricesResponsePricingServerBackup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricingGetAllPricesResponsePricingServerBackup.class));

       return (TypeAdapter<T>) new TypeAdapter<PricingGetAllPricesResponsePricingServerBackup>() {
           @Override
           public void write(JsonWriter out, PricingGetAllPricesResponsePricingServerBackup value) throws IOException {
           ...
           @Override
           public PricingGetAllPricesResponsePricingServerBackup read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PricingGetAllPricesResponsePricingServerBackup instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PricingGetAllPricesResponsePricingServerBackup given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PricingGetAllPricesResponsePricingServerBackup
  * @throws IOException if the JSON string is invalid with respect to PricingGetAllPricesResponsePricingServerBackup
  */
  public static PricingGetAllPricesResponsePricingServerBackup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricingGetAllPricesResponsePricingServerBackup.class);
  }

 /**
  * Convert an instance of PricingGetAllPricesResponsePricingServerBackup to an JSON string
  *
  * @return JSON string
  */
