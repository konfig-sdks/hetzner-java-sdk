...
public class LoadBalancerTargetLabelSelectorProperty {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public LoadBalancerTargetLabelSelectorProperty() {
  }

  public LoadBalancerTargetLabelSelectorProperty selector(String selector) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetLabelSelectorProperty instance itself
   */
  public LoadBalancerTargetLabelSelectorProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetLabelSelectorProperty loadBalancerTargetLabelSelectorProperty = (LoadBalancerTargetLabelSelectorProperty) o;
    return Objects.equals(this.selector, loadBalancerTargetLabelSelectorProperty.selector)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetLabelSelectorProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetLabelSelectorProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetLabelSelectorProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetLabelSelectorProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetLabelSelectorProperty is not found in the empty JSON string", LoadBalancerTargetLabelSelectorProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetLabelSelectorProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetLabelSelectorProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetLabelSelectorProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetLabelSelectorProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetLabelSelectorProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetLabelSelectorProperty>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetLabelSelectorProperty value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetLabelSelectorProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetLabelSelectorProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetLabelSelectorProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetLabelSelectorProperty
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetLabelSelectorProperty
  */
  public static LoadBalancerTargetLabelSelectorProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetLabelSelectorProperty.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetLabelSelectorProperty to an JSON string
  *
  * @return JSON string
  */
