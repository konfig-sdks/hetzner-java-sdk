...
public class PrimaryIPProperty2Protection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public PrimaryIPProperty2Protection() {
  }

  public PrimaryIPProperty2Protection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the PrimaryIPProperty2Protection instance itself
   */
  public PrimaryIPProperty2Protection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPProperty2Protection primaryIPProperty2Protection = (PrimaryIPProperty2Protection) o;
    return Objects.equals(this.delete, primaryIPProperty2Protection.delete)&&
        Objects.equals(this.additionalProperties, primaryIPProperty2Protection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPProperty2Protection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPProperty2Protection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPProperty2Protection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPProperty2Protection is not found in the empty JSON string", PrimaryIPProperty2Protection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPProperty2Protection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPProperty2Protection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPProperty2Protection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPProperty2Protection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPProperty2Protection.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPProperty2Protection>() {
           @Override
           public void write(JsonWriter out, PrimaryIPProperty2Protection value) throws IOException {
           ...
           @Override
           public PrimaryIPProperty2Protection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPProperty2Protection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPProperty2Protection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPProperty2Protection
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPProperty2Protection
  */
  public static PrimaryIPProperty2Protection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPProperty2Protection.class);
  }

 /**
  * Convert an instance of PrimaryIPProperty2Protection to an JSON string
  *
  * @return JSON string
  */
