...
public class Action8Error {
  ...
  public Action8Error code(String code) {
  ...
  **/
  ...
  public Action8Error message(String message) {
  ...
  **/
   ...
   * @return the Action8Error instance itself
   */
  public Action8Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action8Error action8Error = (Action8Error) o;
    return Objects.equals(this.code, action8Error.code) &&
        Objects.equals(this.message, action8Error.message)&&
        Objects.equals(this.additionalProperties, action8Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action8Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action8Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action8Error is not found in the empty JSON string", Action8Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action8Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action8Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action8Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action8Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action8Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action8Error>() {
           @Override
           public void write(JsonWriter out, Action8Error value) throws IOException {
           ...
           @Override
           public Action8Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action8Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action8Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action8Error
  * @throws IOException if the JSON string is invalid with respect to Action8Error
  */
  public static Action8Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action8Error.class);
  }

 /**
  * Convert an instance of Action8Error to an JSON string
  *
  * @return JSON string
  */
