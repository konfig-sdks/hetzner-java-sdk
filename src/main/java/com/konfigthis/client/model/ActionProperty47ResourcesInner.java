...
/**
 * ActionProperty47ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty47ResourcesInner {
  ...
  public ActionProperty47ResourcesInner() {
  }

  public ActionProperty47ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty47ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty47ResourcesInner instance itself
   */
  public ActionProperty47ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty47ResourcesInner actionProperty47ResourcesInner = (ActionProperty47ResourcesInner) o;
    return Objects.equals(this.id, actionProperty47ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty47ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty47ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty47ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty47ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty47ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty47ResourcesInner is not found in the empty JSON string", ActionProperty47ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty47ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty47ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty47ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty47ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty47ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty47ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty47ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty47ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty47ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty47ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty47ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty47ResourcesInner
  */
  public static ActionProperty47ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty47ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty47ResourcesInner to an JSON string
  *
  * @return JSON string
  */
