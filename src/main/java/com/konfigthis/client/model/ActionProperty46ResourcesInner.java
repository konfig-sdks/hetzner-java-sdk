...
/**
 * ActionProperty46ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty46ResourcesInner {
  ...
  public ActionProperty46ResourcesInner() {
  }

  public ActionProperty46ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty46ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty46ResourcesInner instance itself
   */
  public ActionProperty46ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty46ResourcesInner actionProperty46ResourcesInner = (ActionProperty46ResourcesInner) o;
    return Objects.equals(this.id, actionProperty46ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty46ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty46ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty46ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty46ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty46ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty46ResourcesInner is not found in the empty JSON string", ActionProperty46ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty46ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty46ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty46ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty46ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty46ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty46ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty46ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty46ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty46ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty46ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty46ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty46ResourcesInner
  */
  public static ActionProperty46ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty46ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty46ResourcesInner to an JSON string
  *
  * @return JSON string
  */
