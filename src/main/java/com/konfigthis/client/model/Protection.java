...
public class Protection {
  ...
  public Protection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the Protection instance itself
   */
  public Protection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.delete, protection.delete)&&
        Objects.equals(this.additionalProperties, protection.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Protection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Protection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Protection.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Protection>() {
           ...
           public Protection read(JsonReader in) throws IOException {
             ...
             Protection instance = thisAdapter.fromJsonTree(jsonObj);
