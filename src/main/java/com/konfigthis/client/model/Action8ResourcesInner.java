...
/**
 * Action8ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action8ResourcesInner {
  ...
  public Action8ResourcesInner() {
  }

  public Action8ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action8ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action8ResourcesInner instance itself
   */
  public Action8ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action8ResourcesInner action8ResourcesInner = (Action8ResourcesInner) o;
    return Objects.equals(this.id, action8ResourcesInner.id) &&
        Objects.equals(this.type, action8ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action8ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action8ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action8ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action8ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action8ResourcesInner is not found in the empty JSON string", Action8ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action8ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action8ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action8ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action8ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action8ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action8ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action8ResourcesInner value) throws IOException {
           ...
           @Override
           public Action8ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action8ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action8ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action8ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action8ResourcesInner
  */
  public static Action8ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action8ResourcesInner.class);
  }

 /**
  * Convert an instance of Action8ResourcesInner to an JSON string
  *
  * @return JSON string
  */
