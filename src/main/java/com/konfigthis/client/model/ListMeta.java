...
import com.konfigthis.client.model.ListMetaPagination;
...
public class ListMeta {
  ...
  private ListMetaPagination pagination;

  public ListMeta() {
  }

  public ListMeta pagination(ListMetaPagination pagination) {
  ...
  **/
  ...
  public ListMetaPagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaPagination pagination) {
   ...
   * @return the ListMeta instance itself
   */
  public ListMeta putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pagination, listMeta.pagination)&&
        Objects.equals(this.additionalProperties, listMeta.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : ListMeta.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaPagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListMeta>() {
           ...
           public ListMeta read(JsonReader in) throws IOException {
             ...
             ListMeta instance = thisAdapter.fromJsonTree(jsonObj);
