...
public class ActionProperty68Error {
  ...
  public ActionProperty68Error() {
  }

  public ActionProperty68Error code(String code) {
  ...
  **/
  ...
  public ActionProperty68Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty68Error instance itself
   */
  public ActionProperty68Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty68Error actionProperty68Error = (ActionProperty68Error) o;
    return Objects.equals(this.code, actionProperty68Error.code) &&
        Objects.equals(this.message, actionProperty68Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty68Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty68Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty68Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty68Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty68Error is not found in the empty JSON string", ActionProperty68Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty68Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty68Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty68Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty68Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty68Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty68Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty68Error value) throws IOException {
           ...
           @Override
           public ActionProperty68Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty68Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty68Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty68Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty68Error
  */
  public static ActionProperty68Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty68Error.class);
  }

 /**
  * Convert an instance of ActionProperty68Error to an JSON string
  *
  * @return JSON string
  */
