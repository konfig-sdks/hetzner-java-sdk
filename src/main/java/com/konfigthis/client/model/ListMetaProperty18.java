...
import com.konfigthis.client.model.ListMetaProperty18Pagination;
...
public class ListMetaProperty18 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty18Pagination pagination;

  public ListMetaProperty18() {
  }

  public ListMetaProperty18 pagination(ListMetaProperty18Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty18Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty18Pagination pagination) {
   ...
   * @return the ListMetaProperty18 instance itself
   */
  public ListMetaProperty18 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty18 listMetaProperty18 = (ListMetaProperty18) o;
    return Objects.equals(this.pagination, listMetaProperty18.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty18.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty18 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty18
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty18.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty18 is not found in the empty JSON string", ListMetaProperty18.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty18.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty18Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty18.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty18' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty18> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty18.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty18>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty18 value) throws IOException {
           ...
           @Override
           public ListMetaProperty18 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty18 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty18 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty18
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty18
  */
  public static ListMetaProperty18 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty18.class);
  }

 /**
  * Convert an instance of ListMetaProperty18 to an JSON string
  *
  * @return JSON string
  */
