...
public class FirewallProperty1AppliedToInnerLabelSelector {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public FirewallProperty1AppliedToInnerLabelSelector() {
  }

  public FirewallProperty1AppliedToInnerLabelSelector selector(String selector) {
  ...
  **/
   ...
   * @return the FirewallProperty1AppliedToInnerLabelSelector instance itself
   */
  public FirewallProperty1AppliedToInnerLabelSelector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallProperty1AppliedToInnerLabelSelector firewallProperty1AppliedToInnerLabelSelector = (FirewallProperty1AppliedToInnerLabelSelector) o;
    return Objects.equals(this.selector, firewallProperty1AppliedToInnerLabelSelector.selector)&&
        Objects.equals(this.additionalProperties, firewallProperty1AppliedToInnerLabelSelector.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallProperty1AppliedToInnerLabelSelector {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallProperty1AppliedToInnerLabelSelector
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallProperty1AppliedToInnerLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallProperty1AppliedToInnerLabelSelector is not found in the empty JSON string", FirewallProperty1AppliedToInnerLabelSelector.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallProperty1AppliedToInnerLabelSelector.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallProperty1AppliedToInnerLabelSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallProperty1AppliedToInnerLabelSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallProperty1AppliedToInnerLabelSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallProperty1AppliedToInnerLabelSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallProperty1AppliedToInnerLabelSelector>() {
           @Override
           public void write(JsonWriter out, FirewallProperty1AppliedToInnerLabelSelector value) throws IOException {
           ...
           @Override
           public FirewallProperty1AppliedToInnerLabelSelector read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallProperty1AppliedToInnerLabelSelector instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallProperty1AppliedToInnerLabelSelector given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallProperty1AppliedToInnerLabelSelector
  * @throws IOException if the JSON string is invalid with respect to FirewallProperty1AppliedToInnerLabelSelector
  */
  public static FirewallProperty1AppliedToInnerLabelSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallProperty1AppliedToInnerLabelSelector.class);
  }

 /**
  * Convert an instance of FirewallProperty1AppliedToInnerLabelSelector to an JSON string
  *
  * @return JSON string
  */
