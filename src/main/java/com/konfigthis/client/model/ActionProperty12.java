...
import com.konfigthis.client.model.ActionProperty12Error;
import com.konfigthis.client.model.ActionProperty12ResourcesInner;
...
public class ActionProperty12 {
  ...
  private ActionProperty12Error error;
  ...
  private List<ActionProperty12ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty12() {
  }

  public ActionProperty12 command(String command) {
  ...
  **/
  ...
  public ActionProperty12 error(ActionProperty12Error error) {
  ...
  **/
  ...
  public ActionProperty12Error getError() {
    return error;
  }


  public void setError(ActionProperty12Error error) {
  ...
  public ActionProperty12 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty12 id(Long id) {
  ...
  **/
  ...
  public ActionProperty12 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty12 resources(List<ActionProperty12ResourcesInner> resources) {
  ...
  public ActionProperty12 addResourcesItem(ActionProperty12ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty12ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty12ResourcesInner> resources) {
  ...
  public ActionProperty12 started(String started) {
  ...
  **/
  ...
  public ActionProperty12 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty12 instance itself
   */
  public ActionProperty12 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty12 actionProperty12 = (ActionProperty12) o;
    return Objects.equals(this.command, actionProperty12.command) &&
        Objects.equals(this.error, actionProperty12.error) &&
        Objects.equals(this.finished, actionProperty12.finished) &&
        Objects.equals(this.id, actionProperty12.id) &&
        Objects.equals(this.progress, actionProperty12.progress) &&
        Objects.equals(this.resources, actionProperty12.resources) &&
        Objects.equals(this.started, actionProperty12.started) &&
        Objects.equals(this.status, actionProperty12.status)&&
        Objects.equals(this.additionalProperties, actionProperty12.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty12 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty12
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty12.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty12 is not found in the empty JSON string", ActionProperty12.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty12.openapiRequiredFields) {
      ...
      ActionProperty12Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty12ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty12.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty12>() {
           @Override
           public void write(JsonWriter out, ActionProperty12 value) throws IOException {
           ...
           @Override
           public ActionProperty12 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty12 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty12 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty12
  * @throws IOException if the JSON string is invalid with respect to ActionProperty12
  */
  public static ActionProperty12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty12.class);
  }

 /**
  * Convert an instance of ActionProperty12 to an JSON string
  *
  * @return JSON string
  */
