...
import com.konfigthis.client.model.ActionProperty63Error;
import com.konfigthis.client.model.ActionProperty63ResourcesInner;
...
public class ActionProperty63 {
  ...
  private ActionProperty63Error error;
  ...
  private List<ActionProperty63ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty63() {
  }

  public ActionProperty63 command(String command) {
  ...
  **/
  ...
  public ActionProperty63 error(ActionProperty63Error error) {
  ...
  **/
  ...
  public ActionProperty63Error getError() {
    return error;
  }


  public void setError(ActionProperty63Error error) {
  ...
  public ActionProperty63 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty63 id(Long id) {
  ...
  **/
  ...
  public ActionProperty63 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty63 resources(List<ActionProperty63ResourcesInner> resources) {
  ...
  public ActionProperty63 addResourcesItem(ActionProperty63ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty63ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty63ResourcesInner> resources) {
  ...
  public ActionProperty63 started(String started) {
  ...
  **/
  ...
  public ActionProperty63 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty63 instance itself
   */
  public ActionProperty63 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty63 actionProperty63 = (ActionProperty63) o;
    return Objects.equals(this.command, actionProperty63.command) &&
        Objects.equals(this.error, actionProperty63.error) &&
        Objects.equals(this.finished, actionProperty63.finished) &&
        Objects.equals(this.id, actionProperty63.id) &&
        Objects.equals(this.progress, actionProperty63.progress) &&
        Objects.equals(this.resources, actionProperty63.resources) &&
        Objects.equals(this.started, actionProperty63.started) &&
        Objects.equals(this.status, actionProperty63.status)&&
        Objects.equals(this.additionalProperties, actionProperty63.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty63 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty63
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty63.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty63 is not found in the empty JSON string", ActionProperty63.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty63.openapiRequiredFields) {
      ...
      ActionProperty63Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty63ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty63.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty63' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty63> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty63.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty63>() {
           @Override
           public void write(JsonWriter out, ActionProperty63 value) throws IOException {
           ...
           @Override
           public ActionProperty63 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty63 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty63 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty63
  * @throws IOException if the JSON string is invalid with respect to ActionProperty63
  */
  public static ActionProperty63 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty63.class);
  }

 /**
  * Convert an instance of ActionProperty63 to an JSON string
  *
  * @return JSON string
  */
