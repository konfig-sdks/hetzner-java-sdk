...
/**
 * ActionProperty35ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty35ResourcesInner {
  ...
  public ActionProperty35ResourcesInner() {
  }

  public ActionProperty35ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty35ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty35ResourcesInner instance itself
   */
  public ActionProperty35ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty35ResourcesInner actionProperty35ResourcesInner = (ActionProperty35ResourcesInner) o;
    return Objects.equals(this.id, actionProperty35ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty35ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty35ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty35ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty35ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty35ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty35ResourcesInner is not found in the empty JSON string", ActionProperty35ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty35ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty35ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty35ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty35ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty35ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty35ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty35ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty35ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty35ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty35ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty35ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty35ResourcesInner
  */
  public static ActionProperty35ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty35ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty35ResourcesInner to an JSON string
  *
  * @return JSON string
  */
