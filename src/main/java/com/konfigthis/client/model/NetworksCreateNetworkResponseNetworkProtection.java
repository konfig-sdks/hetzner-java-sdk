...
public class NetworksCreateNetworkResponseNetworkProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public NetworksCreateNetworkResponseNetworkProtection() {
  }

  public NetworksCreateNetworkResponseNetworkProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the NetworksCreateNetworkResponseNetworkProtection instance itself
   */
  public NetworksCreateNetworkResponseNetworkProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksCreateNetworkResponseNetworkProtection networksCreateNetworkResponseNetworkProtection = (NetworksCreateNetworkResponseNetworkProtection) o;
    return Objects.equals(this.delete, networksCreateNetworkResponseNetworkProtection.delete)&&
        Objects.equals(this.additionalProperties, networksCreateNetworkResponseNetworkProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksCreateNetworkResponseNetworkProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksCreateNetworkResponseNetworkProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksCreateNetworkResponseNetworkProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksCreateNetworkResponseNetworkProtection is not found in the empty JSON string", NetworksCreateNetworkResponseNetworkProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksCreateNetworkResponseNetworkProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksCreateNetworkResponseNetworkProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksCreateNetworkResponseNetworkProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksCreateNetworkResponseNetworkProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksCreateNetworkResponseNetworkProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksCreateNetworkResponseNetworkProtection>() {
           @Override
           public void write(JsonWriter out, NetworksCreateNetworkResponseNetworkProtection value) throws IOException {
           ...
           @Override
           public NetworksCreateNetworkResponseNetworkProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksCreateNetworkResponseNetworkProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksCreateNetworkResponseNetworkProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksCreateNetworkResponseNetworkProtection
  * @throws IOException if the JSON string is invalid with respect to NetworksCreateNetworkResponseNetworkProtection
  */
  public static NetworksCreateNetworkResponseNetworkProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksCreateNetworkResponseNetworkProtection.class);
  }

 /**
  * Convert an instance of NetworksCreateNetworkResponseNetworkProtection to an JSON string
  *
  * @return JSON string
  */
