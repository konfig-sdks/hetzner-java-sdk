...
import com.konfigthis.client.model.LoadBalancerTypesGetByIdResponseLoadBalancerType;
...
public class LoadBalancerTypesGetByIdResponse {
  ...
  private LoadBalancerTypesGetByIdResponseLoadBalancerType loadBalancerType;

  public LoadBalancerTypesGetByIdResponse() {
  }

  public LoadBalancerTypesGetByIdResponse loadBalancerType(LoadBalancerTypesGetByIdResponseLoadBalancerType loadBalancerType) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType getLoadBalancerType() {
    return loadBalancerType;
  }


  public void setLoadBalancerType(LoadBalancerTypesGetByIdResponseLoadBalancerType loadBalancerType) {
   ...
   * @return the LoadBalancerTypesGetByIdResponse instance itself
   */
  public LoadBalancerTypesGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTypesGetByIdResponse loadBalancerTypesGetByIdResponse = (LoadBalancerTypesGetByIdResponse) o;
    return Objects.equals(this.loadBalancerType, loadBalancerTypesGetByIdResponse.loadBalancerType)&&
        Objects.equals(this.additionalProperties, loadBalancerTypesGetByIdResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadBalancerType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancerTypesGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTypesGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTypesGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTypesGetByIdResponse is not found in the empty JSON string", LoadBalancerTypesGetByIdResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("load_balancer_type") != null && !jsonObj.get("load_balancer_type").isJsonNull()) {
        LoadBalancerTypesGetByIdResponseLoadBalancerType.validateJsonObject(jsonObj.getAsJsonObject("load_balancer_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTypesGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTypesGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTypesGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTypesGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTypesGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTypesGetByIdResponse value) throws IOException {
           ...
           @Override
           public LoadBalancerTypesGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTypesGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTypesGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTypesGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTypesGetByIdResponse
  */
  public static LoadBalancerTypesGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTypesGetByIdResponse.class);
  }

 /**
  * Convert an instance of LoadBalancerTypesGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
