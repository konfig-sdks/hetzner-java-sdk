...
import com.konfigthis.client.model.ActionProperty70;
...
public class ServerActionsResetServerResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty70 action;

  public ServerActionsResetServerResponse() {
  }

  public ServerActionsResetServerResponse action(ActionProperty70 action) {
  ...
  **/
  ...
  public ActionProperty70 getAction() {
    return action;
  }


  public void setAction(ActionProperty70 action) {
   ...
   * @return the ServerActionsResetServerResponse instance itself
   */
  public ServerActionsResetServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsResetServerResponse serverActionsResetServerResponse = (ServerActionsResetServerResponse) o;
    return Objects.equals(this.action, serverActionsResetServerResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsResetServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsResetServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsResetServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsResetServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsResetServerResponse is not found in the empty JSON string", ServerActionsResetServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsResetServerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty70.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsResetServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsResetServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsResetServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsResetServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsResetServerResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsResetServerResponse value) throws IOException {
           ...
           @Override
           public ServerActionsResetServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsResetServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsResetServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsResetServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsResetServerResponse
  */
  public static ServerActionsResetServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsResetServerResponse.class);
  }

 /**
  * Convert an instance of ServerActionsResetServerResponse to an JSON string
  *
  * @return JSON string
  */
