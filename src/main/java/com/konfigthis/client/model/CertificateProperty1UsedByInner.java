...
public class CertificateProperty1UsedByInner {
  ...
  public CertificateProperty1UsedByInner() {
  }

  public CertificateProperty1UsedByInner id(Long id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4711", required = true, value = "ID of resource referenced")
  ...
  public CertificateProperty1UsedByInner type(String type) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "load_balancer", required = true, value = "Type of resource referenced")
   ...
   * @return the CertificateProperty1UsedByInner instance itself
   */
  public CertificateProperty1UsedByInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateProperty1UsedByInner certificateProperty1UsedByInner = (CertificateProperty1UsedByInner) o;
    return Objects.equals(this.id, certificateProperty1UsedByInner.id) &&
        Objects.equals(this.type, certificateProperty1UsedByInner.type)&&
        Objects.equals(this.additionalProperties, certificateProperty1UsedByInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateProperty1UsedByInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateProperty1UsedByInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateProperty1UsedByInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateProperty1UsedByInner is not found in the empty JSON string", CertificateProperty1UsedByInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateProperty1UsedByInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateProperty1UsedByInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateProperty1UsedByInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateProperty1UsedByInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateProperty1UsedByInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateProperty1UsedByInner>() {
           @Override
           public void write(JsonWriter out, CertificateProperty1UsedByInner value) throws IOException {
           ...
           @Override
           public CertificateProperty1UsedByInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateProperty1UsedByInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateProperty1UsedByInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateProperty1UsedByInner
  * @throws IOException if the JSON string is invalid with respect to CertificateProperty1UsedByInner
  */
  public static CertificateProperty1UsedByInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateProperty1UsedByInner.class);
  }

 /**
  * Convert an instance of CertificateProperty1UsedByInner to an JSON string
  *
  * @return JSON string
  */
