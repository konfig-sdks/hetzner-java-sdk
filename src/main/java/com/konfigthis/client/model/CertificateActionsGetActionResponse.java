...
import com.konfigthis.client.model.ActionProperty2;
...
public class CertificateActionsGetActionResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty2 action;

  public CertificateActionsGetActionResponse() {
  }

  public CertificateActionsGetActionResponse action(ActionProperty2 action) {
  ...
  **/
  ...
  public ActionProperty2 getAction() {
    return action;
  }


  public void setAction(ActionProperty2 action) {
   ...
   * @return the CertificateActionsGetActionResponse instance itself
   */
  public CertificateActionsGetActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateActionsGetActionResponse certificateActionsGetActionResponse = (CertificateActionsGetActionResponse) o;
    return Objects.equals(this.action, certificateActionsGetActionResponse.action)&&
        Objects.equals(this.additionalProperties, certificateActionsGetActionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateActionsGetActionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateActionsGetActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateActionsGetActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateActionsGetActionResponse is not found in the empty JSON string", CertificateActionsGetActionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateActionsGetActionResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty2.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateActionsGetActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateActionsGetActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateActionsGetActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateActionsGetActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateActionsGetActionResponse>() {
           @Override
           public void write(JsonWriter out, CertificateActionsGetActionResponse value) throws IOException {
           ...
           @Override
           public CertificateActionsGetActionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateActionsGetActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateActionsGetActionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateActionsGetActionResponse
  * @throws IOException if the JSON string is invalid with respect to CertificateActionsGetActionResponse
  */
  public static CertificateActionsGetActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateActionsGetActionResponse.class);
  }

 /**
  * Convert an instance of CertificateActionsGetActionResponse to an JSON string
  *
  * @return JSON string
  */
