...
/**
 * ActionProperty10ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty10ResourcesInner {
  ...
  public ActionProperty10ResourcesInner() {
  }

  public ActionProperty10ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty10ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty10ResourcesInner instance itself
   */
  public ActionProperty10ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty10ResourcesInner actionProperty10ResourcesInner = (ActionProperty10ResourcesInner) o;
    return Objects.equals(this.id, actionProperty10ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty10ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty10ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty10ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty10ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty10ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty10ResourcesInner is not found in the empty JSON string", ActionProperty10ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty10ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty10ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty10ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty10ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty10ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty10ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty10ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty10ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty10ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty10ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty10ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty10ResourcesInner
  */
  public static ActionProperty10ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty10ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty10ResourcesInner to an JSON string
  *
  * @return JSON string
  */
