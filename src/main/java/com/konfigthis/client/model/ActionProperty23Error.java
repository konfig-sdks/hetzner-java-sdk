...
public class ActionProperty23Error {
  ...
  public ActionProperty23Error() {
  }

  public ActionProperty23Error code(String code) {
  ...
  **/
  ...
  public ActionProperty23Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty23Error instance itself
   */
  public ActionProperty23Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty23Error actionProperty23Error = (ActionProperty23Error) o;
    return Objects.equals(this.code, actionProperty23Error.code) &&
        Objects.equals(this.message, actionProperty23Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty23Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty23Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty23Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty23Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty23Error is not found in the empty JSON string", ActionProperty23Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty23Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty23Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty23Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty23Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty23Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty23Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty23Error value) throws IOException {
           ...
           @Override
           public ActionProperty23Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty23Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty23Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty23Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty23Error
  */
  public static ActionProperty23Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty23Error.class);
  }

 /**
  * Convert an instance of ActionProperty23Error to an JSON string
  *
  * @return JSON string
  */
