...
/**
 * ActionProperty73ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty73ResourcesInner {
  ...
  public ActionProperty73ResourcesInner() {
  }

  public ActionProperty73ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty73ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty73ResourcesInner instance itself
   */
  public ActionProperty73ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty73ResourcesInner actionProperty73ResourcesInner = (ActionProperty73ResourcesInner) o;
    return Objects.equals(this.id, actionProperty73ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty73ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty73ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty73ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty73ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty73ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty73ResourcesInner is not found in the empty JSON string", ActionProperty73ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty73ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty73ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty73ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty73ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty73ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty73ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty73ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty73ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty73ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty73ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty73ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty73ResourcesInner
  */
  public static ActionProperty73ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty73ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty73ResourcesInner to an JSON string
  *
  * @return JSON string
  */
