...
import com.konfigthis.client.model.ActionProperty26Error;
import com.konfigthis.client.model.ActionProperty26ResourcesInner;
...
public class ActionProperty26 {
  ...
  private ActionProperty26Error error;
  ...
  private List<ActionProperty26ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty26() {
  }

  public ActionProperty26 command(String command) {
  ...
  **/
  ...
  public ActionProperty26 error(ActionProperty26Error error) {
  ...
  **/
  ...
  public ActionProperty26Error getError() {
    return error;
  }


  public void setError(ActionProperty26Error error) {
  ...
  public ActionProperty26 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty26 id(Long id) {
  ...
  **/
  ...
  public ActionProperty26 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty26 resources(List<ActionProperty26ResourcesInner> resources) {
  ...
  public ActionProperty26 addResourcesItem(ActionProperty26ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty26ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty26ResourcesInner> resources) {
  ...
  public ActionProperty26 started(String started) {
  ...
  **/
  ...
  public ActionProperty26 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty26 instance itself
   */
  public ActionProperty26 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty26 actionProperty26 = (ActionProperty26) o;
    return Objects.equals(this.command, actionProperty26.command) &&
        Objects.equals(this.error, actionProperty26.error) &&
        Objects.equals(this.finished, actionProperty26.finished) &&
        Objects.equals(this.id, actionProperty26.id) &&
        Objects.equals(this.progress, actionProperty26.progress) &&
        Objects.equals(this.resources, actionProperty26.resources) &&
        Objects.equals(this.started, actionProperty26.started) &&
        Objects.equals(this.status, actionProperty26.status)&&
        Objects.equals(this.additionalProperties, actionProperty26.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty26 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty26
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty26.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty26 is not found in the empty JSON string", ActionProperty26.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty26.openapiRequiredFields) {
      ...
      ActionProperty26Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty26ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty26.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty26' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty26> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty26.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty26>() {
           @Override
           public void write(JsonWriter out, ActionProperty26 value) throws IOException {
           ...
           @Override
           public ActionProperty26 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty26 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty26 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty26
  * @throws IOException if the JSON string is invalid with respect to ActionProperty26
  */
  public static ActionProperty26 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty26.class);
  }

 /**
  * Convert an instance of ActionProperty26 to an JSON string
  *
  * @return JSON string
  */
