...
public class ActionProperty36Error {
  ...
  public ActionProperty36Error() {
  }

  public ActionProperty36Error code(String code) {
  ...
  **/
  ...
  public ActionProperty36Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty36Error instance itself
   */
  public ActionProperty36Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty36Error actionProperty36Error = (ActionProperty36Error) o;
    return Objects.equals(this.code, actionProperty36Error.code) &&
        Objects.equals(this.message, actionProperty36Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty36Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty36Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty36Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty36Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty36Error is not found in the empty JSON string", ActionProperty36Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty36Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty36Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty36Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty36Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty36Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty36Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty36Error value) throws IOException {
           ...
           @Override
           public ActionProperty36Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty36Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty36Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty36Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty36Error
  */
  public static ActionProperty36Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty36Error.class);
  }

 /**
  * Convert an instance of ActionProperty36Error to an JSON string
  *
  * @return JSON string
  */
