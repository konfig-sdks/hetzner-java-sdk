...
public class LoadBalancerTargetIPProperty3 {
  public static final String SERIALIZED_NAME_IP = "ip";
  @SerializedName(SERIALIZED_NAME_IP)
  private String ip;

  public LoadBalancerTargetIPProperty3() {
  }

  public LoadBalancerTargetIPProperty3 ip(String ip) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetIPProperty3 instance itself
   */
  public LoadBalancerTargetIPProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetIPProperty3 loadBalancerTargetIPProperty3 = (LoadBalancerTargetIPProperty3) o;
    return Objects.equals(this.ip, loadBalancerTargetIPProperty3.ip)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetIPProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetIPProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetIPProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetIPProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetIPProperty3 is not found in the empty JSON string", LoadBalancerTargetIPProperty3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetIPProperty3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetIPProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetIPProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetIPProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetIPProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetIPProperty3>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetIPProperty3 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetIPProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetIPProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetIPProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetIPProperty3
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetIPProperty3
  */
  public static LoadBalancerTargetIPProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetIPProperty3.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetIPProperty3 to an JSON string
  *
  * @return JSON string
  */
