...
/**
 * ActionProperty21ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty21ResourcesInner {
  ...
  public ActionProperty21ResourcesInner() {
  }

  public ActionProperty21ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty21ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty21ResourcesInner instance itself
   */
  public ActionProperty21ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty21ResourcesInner actionProperty21ResourcesInner = (ActionProperty21ResourcesInner) o;
    return Objects.equals(this.id, actionProperty21ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty21ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty21ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty21ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty21ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty21ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty21ResourcesInner is not found in the empty JSON string", ActionProperty21ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty21ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty21ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty21ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty21ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty21ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty21ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty21ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty21ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty21ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty21ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty21ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty21ResourcesInner
  */
  public static ActionProperty21ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty21ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty21ResourcesInner to an JSON string
  *
  * @return JSON string
  */
