...
/**
 * ActionProperty77ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty77ResourcesInner {
  ...
  public ActionProperty77ResourcesInner() {
  }

  public ActionProperty77ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty77ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty77ResourcesInner instance itself
   */
  public ActionProperty77ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty77ResourcesInner actionProperty77ResourcesInner = (ActionProperty77ResourcesInner) o;
    return Objects.equals(this.id, actionProperty77ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty77ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty77ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty77ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty77ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty77ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty77ResourcesInner is not found in the empty JSON string", ActionProperty77ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty77ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty77ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty77ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty77ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty77ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty77ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty77ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty77ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty77ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty77ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty77ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty77ResourcesInner
  */
  public static ActionProperty77ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty77ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty77ResourcesInner to an JSON string
  *
  * @return JSON string
  */
