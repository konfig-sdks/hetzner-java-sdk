...
public class LoadBalancerActionsChangeAlgorithmRequest {
  /**
 ...
 public enum TypeEnum {
  ...
  public LoadBalancerActionsChangeAlgorithmRequest() {
  }

  public LoadBalancerActionsChangeAlgorithmRequest type(TypeEnum type) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Algorithm of the Load Balancer")
   ...
   * @return the LoadBalancerActionsChangeAlgorithmRequest instance itself
   */
  public LoadBalancerActionsChangeAlgorithmRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsChangeAlgorithmRequest loadBalancerActionsChangeAlgorithmRequest = (LoadBalancerActionsChangeAlgorithmRequest) o;
    return Objects.equals(this.type, loadBalancerActionsChangeAlgorithmRequest.type)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsChangeAlgorithmRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsChangeAlgorithmRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsChangeAlgorithmRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsChangeAlgorithmRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsChangeAlgorithmRequest is not found in the empty JSON string", LoadBalancerActionsChangeAlgorithmRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsChangeAlgorithmRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsChangeAlgorithmRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsChangeAlgorithmRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsChangeAlgorithmRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsChangeAlgorithmRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsChangeAlgorithmRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsChangeAlgorithmRequest value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsChangeAlgorithmRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsChangeAlgorithmRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsChangeAlgorithmRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsChangeAlgorithmRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsChangeAlgorithmRequest
  */
  public static LoadBalancerActionsChangeAlgorithmRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsChangeAlgorithmRequest.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsChangeAlgorithmRequest to an JSON string
  *
  * @return JSON string
  */
