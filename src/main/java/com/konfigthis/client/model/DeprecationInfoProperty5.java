...
public class DeprecationInfoProperty5 {
  ...
  public DeprecationInfoProperty5() {
  }

  public DeprecationInfoProperty5 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty5 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty5 instance itself
   */
  public DeprecationInfoProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty5 deprecationInfoProperty5 = (DeprecationInfoProperty5) o;
    return Objects.equals(this.announced, deprecationInfoProperty5.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty5.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty5 is not found in the empty JSON string", DeprecationInfoProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty5>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty5 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty5
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty5
  */
  public static DeprecationInfoProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty5.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty5 to an JSON string
  *
  * @return JSON string
  */
