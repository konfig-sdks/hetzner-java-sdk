...
public class VolumesGetByIdResponseVolumeProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public VolumesGetByIdResponseVolumeProtection() {
  }

  public VolumesGetByIdResponseVolumeProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the VolumesGetByIdResponseVolumeProtection instance itself
   */
  public VolumesGetByIdResponseVolumeProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesGetByIdResponseVolumeProtection volumesGetByIdResponseVolumeProtection = (VolumesGetByIdResponseVolumeProtection) o;
    return Objects.equals(this.delete, volumesGetByIdResponseVolumeProtection.delete)&&
        Objects.equals(this.additionalProperties, volumesGetByIdResponseVolumeProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesGetByIdResponseVolumeProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesGetByIdResponseVolumeProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesGetByIdResponseVolumeProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesGetByIdResponseVolumeProtection is not found in the empty JSON string", VolumesGetByIdResponseVolumeProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesGetByIdResponseVolumeProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesGetByIdResponseVolumeProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesGetByIdResponseVolumeProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesGetByIdResponseVolumeProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesGetByIdResponseVolumeProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesGetByIdResponseVolumeProtection>() {
           @Override
           public void write(JsonWriter out, VolumesGetByIdResponseVolumeProtection value) throws IOException {
           ...
           @Override
           public VolumesGetByIdResponseVolumeProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesGetByIdResponseVolumeProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesGetByIdResponseVolumeProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesGetByIdResponseVolumeProtection
  * @throws IOException if the JSON string is invalid with respect to VolumesGetByIdResponseVolumeProtection
  */
  public static VolumesGetByIdResponseVolumeProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesGetByIdResponseVolumeProtection.class);
  }

 /**
  * Convert an instance of VolumesGetByIdResponseVolumeProtection to an JSON string
  *
  * @return JSON string
  */
