...
public class Action22Error {
  ...
  public Action22Error() {
  }

  public Action22Error code(String code) {
  ...
  **/
  ...
  public Action22Error message(String message) {
  ...
  **/
   ...
   * @return the Action22Error instance itself
   */
  public Action22Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action22Error action22Error = (Action22Error) o;
    return Objects.equals(this.code, action22Error.code) &&
        Objects.equals(this.message, action22Error.message)&&
        Objects.equals(this.additionalProperties, action22Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action22Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action22Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action22Error is not found in the empty JSON string", Action22Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action22Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action22Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action22Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action22Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action22Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action22Error>() {
           @Override
           public void write(JsonWriter out, Action22Error value) throws IOException {
           ...
           @Override
           public Action22Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action22Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action22Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action22Error
  * @throws IOException if the JSON string is invalid with respect to Action22Error
  */
  public static Action22Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action22Error.class);
  }

 /**
  * Convert an instance of Action22Error to an JSON string
  *
  * @return JSON string
  */
