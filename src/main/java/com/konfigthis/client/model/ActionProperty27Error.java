...
public class ActionProperty27Error {
  ...
  public ActionProperty27Error() {
  }

  public ActionProperty27Error code(String code) {
  ...
  **/
  ...
  public ActionProperty27Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty27Error instance itself
   */
  public ActionProperty27Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty27Error actionProperty27Error = (ActionProperty27Error) o;
    return Objects.equals(this.code, actionProperty27Error.code) &&
        Objects.equals(this.message, actionProperty27Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty27Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty27Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty27Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty27Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty27Error is not found in the empty JSON string", ActionProperty27Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty27Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty27Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty27Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty27Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty27Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty27Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty27Error value) throws IOException {
           ...
           @Override
           public ActionProperty27Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty27Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty27Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty27Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty27Error
  */
  public static ActionProperty27Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty27Error.class);
  }

 /**
  * Convert an instance of ActionProperty27Error to an JSON string
  *
  * @return JSON string
  */
