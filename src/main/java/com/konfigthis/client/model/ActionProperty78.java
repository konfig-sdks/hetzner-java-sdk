...
import com.konfigthis.client.model.ActionProperty78Error;
import com.konfigthis.client.model.ActionProperty78ResourcesInner;
...
public class ActionProperty78 {
  ...
  private ActionProperty78Error error;
  ...
  private List<ActionProperty78ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty78() {
  }

  public ActionProperty78 command(String command) {
  ...
  **/
  ...
  public ActionProperty78 error(ActionProperty78Error error) {
  ...
  **/
  ...
  public ActionProperty78Error getError() {
    return error;
  }


  public void setError(ActionProperty78Error error) {
  ...
  public ActionProperty78 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty78 id(Long id) {
  ...
  **/
  ...
  public ActionProperty78 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty78 resources(List<ActionProperty78ResourcesInner> resources) {
  ...
  public ActionProperty78 addResourcesItem(ActionProperty78ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty78ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty78ResourcesInner> resources) {
  ...
  public ActionProperty78 started(String started) {
  ...
  **/
  ...
  public ActionProperty78 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty78 instance itself
   */
  public ActionProperty78 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty78 actionProperty78 = (ActionProperty78) o;
    return Objects.equals(this.command, actionProperty78.command) &&
        Objects.equals(this.error, actionProperty78.error) &&
        Objects.equals(this.finished, actionProperty78.finished) &&
        Objects.equals(this.id, actionProperty78.id) &&
        Objects.equals(this.progress, actionProperty78.progress) &&
        Objects.equals(this.resources, actionProperty78.resources) &&
        Objects.equals(this.started, actionProperty78.started) &&
        Objects.equals(this.status, actionProperty78.status)&&
        Objects.equals(this.additionalProperties, actionProperty78.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty78 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty78
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty78.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty78 is not found in the empty JSON string", ActionProperty78.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty78.openapiRequiredFields) {
      ...
      ActionProperty78Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty78ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty78.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty78' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty78> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty78.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty78>() {
           @Override
           public void write(JsonWriter out, ActionProperty78 value) throws IOException {
           ...
           @Override
           public ActionProperty78 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty78 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty78 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty78
  * @throws IOException if the JSON string is invalid with respect to ActionProperty78
  */
  public static ActionProperty78 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty78.class);
  }

 /**
  * Convert an instance of ActionProperty78 to an JSON string
  *
  * @return JSON string
  */
