...
import com.konfigthis.client.model.ListMetaProperty21Pagination;
...
public class ListMetaProperty21 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty21Pagination pagination;

  public ListMetaProperty21() {
  }

  public ListMetaProperty21 pagination(ListMetaProperty21Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty21Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty21Pagination pagination) {
   ...
   * @return the ListMetaProperty21 instance itself
   */
  public ListMetaProperty21 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty21 listMetaProperty21 = (ListMetaProperty21) o;
    return Objects.equals(this.pagination, listMetaProperty21.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty21.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty21 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty21
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty21.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty21 is not found in the empty JSON string", ListMetaProperty21.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty21.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty21Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty21.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty21' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty21> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty21.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty21>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty21 value) throws IOException {
           ...
           @Override
           public ListMetaProperty21 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty21 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty21 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty21
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty21
  */
  public static ListMetaProperty21 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty21.class);
  }

 /**
  * Convert an instance of ListMetaProperty21 to an JSON string
  *
  * @return JSON string
  */
