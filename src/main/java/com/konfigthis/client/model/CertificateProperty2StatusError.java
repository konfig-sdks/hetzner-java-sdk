 ...
 */
@ApiModel(description = "If issuance or renewal reports `failed`, this property contains information about what happened")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CertificateProperty2StatusError {
  ...
  public CertificateProperty2StatusError() {
  }

  public CertificateProperty2StatusError code(String code) {
  ...
  **/
  ...
  public CertificateProperty2StatusError message(String message) {
  ...
  **/
   ...
   * @return the CertificateProperty2StatusError instance itself
   */
  public CertificateProperty2StatusError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateProperty2StatusError certificateProperty2StatusError = (CertificateProperty2StatusError) o;
    return Objects.equals(this.code, certificateProperty2StatusError.code) &&
        Objects.equals(this.message, certificateProperty2StatusError.message)&&
        Objects.equals(this.additionalProperties, certificateProperty2StatusError.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateProperty2StatusError {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateProperty2StatusError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateProperty2StatusError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateProperty2StatusError is not found in the empty JSON string", CertificateProperty2StatusError.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateProperty2StatusError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateProperty2StatusError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateProperty2StatusError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateProperty2StatusError.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateProperty2StatusError>() {
           @Override
           public void write(JsonWriter out, CertificateProperty2StatusError value) throws IOException {
           ...
           @Override
           public CertificateProperty2StatusError read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateProperty2StatusError instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateProperty2StatusError given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateProperty2StatusError
  * @throws IOException if the JSON string is invalid with respect to CertificateProperty2StatusError
  */
  public static CertificateProperty2StatusError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateProperty2StatusError.class);
  }

 /**
  * Convert an instance of CertificateProperty2StatusError to an JSON string
  *
  * @return JSON string
  */
