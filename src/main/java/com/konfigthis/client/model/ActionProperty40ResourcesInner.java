...
/**
 * ActionProperty40ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty40ResourcesInner {
  ...
  public ActionProperty40ResourcesInner() {
  }

  public ActionProperty40ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty40ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty40ResourcesInner instance itself
   */
  public ActionProperty40ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty40ResourcesInner actionProperty40ResourcesInner = (ActionProperty40ResourcesInner) o;
    return Objects.equals(this.id, actionProperty40ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty40ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty40ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty40ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty40ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty40ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty40ResourcesInner is not found in the empty JSON string", ActionProperty40ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty40ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty40ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty40ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty40ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty40ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty40ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty40ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty40ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty40ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty40ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty40ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty40ResourcesInner
  */
  public static ActionProperty40ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty40ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty40ResourcesInner to an JSON string
  *
  * @return JSON string
  */
