...
public class ListMetaProperty4Pagination {
  ...
  public ListMetaProperty4Pagination() {
  }

  public ListMetaProperty4Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty4Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty4Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty4Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty4Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty4Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty4Pagination instance itself
   */
  public ListMetaProperty4Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty4Pagination listMetaProperty4Pagination = (ListMetaProperty4Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty4Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty4Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty4Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty4Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty4Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty4Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty4Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty4Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty4Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty4Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty4Pagination is not found in the empty JSON string", ListMetaProperty4Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty4Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty4Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty4Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty4Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty4Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty4Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty4Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty4Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty4Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty4Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty4Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty4Pagination
  */
  public static ListMetaProperty4Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty4Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty4Pagination to an JSON string
  *
  * @return JSON string
  */
