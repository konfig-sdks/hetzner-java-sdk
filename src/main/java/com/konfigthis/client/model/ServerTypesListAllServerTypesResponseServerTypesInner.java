...
import com.konfigthis.client.model.DeprecationInfoProperty2;
import com.konfigthis.client.model.ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner;
...
/**
 * ServerTypesListAllServerTypesResponseServerTypesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ServerTypesListAllServerTypesResponseServerTypesInner {
 ...
 public enum CpuTypeEnum {
  ...
  private DeprecationInfoProperty2 deprecation;
  ...
  private List<ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner> prices = new ArrayList<>();
 ...
 public enum StorageTypeEnum {
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner() {
  }

  public ServerTypesListAllServerTypesResponseServerTypesInner description(String description) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner cores(Double cores) {
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner cores(Integer cores) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner cpuType(CpuTypeEnum cpuType) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner deprecated(Boolean deprecated) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner deprecation(DeprecationInfoProperty2 deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty2 getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty2 deprecation) {
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner disk(Double disk) {
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner disk(Integer disk) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner id(Long id) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner includedTraffic(Long includedTraffic) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner memory(Double memory) {
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner memory(Integer memory) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner name(String name) {
  ...
  **/
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner prices(List<ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner> prices) {
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner addPricesItem(ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner pricesItem) {
  ...
  **/
  ...
  public List<ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner> prices) {
  ...
  public ServerTypesListAllServerTypesResponseServerTypesInner storageType(StorageTypeEnum storageType) {
  ...
  **/
   ...
   * @return the ServerTypesListAllServerTypesResponseServerTypesInner instance itself
   */
  public ServerTypesListAllServerTypesResponseServerTypesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerTypesListAllServerTypesResponseServerTypesInner serverTypesListAllServerTypesResponseServerTypesInner = (ServerTypesListAllServerTypesResponseServerTypesInner) o;
    return Objects.equals(this.description, serverTypesListAllServerTypesResponseServerTypesInner.description) &&
        Objects.equals(this.architecture, serverTypesListAllServerTypesResponseServerTypesInner.architecture) &&
        Objects.equals(this.cores, serverTypesListAllServerTypesResponseServerTypesInner.cores) &&
        Objects.equals(this.cpuType, serverTypesListAllServerTypesResponseServerTypesInner.cpuType) &&
        Objects.equals(this.deprecated, serverTypesListAllServerTypesResponseServerTypesInner.deprecated) &&
        Objects.equals(this.deprecation, serverTypesListAllServerTypesResponseServerTypesInner.deprecation) &&
        Objects.equals(this.disk, serverTypesListAllServerTypesResponseServerTypesInner.disk) &&
        Objects.equals(this.id, serverTypesListAllServerTypesResponseServerTypesInner.id) &&
        Objects.equals(this.includedTraffic, serverTypesListAllServerTypesResponseServerTypesInner.includedTraffic) &&
        Objects.equals(this.memory, serverTypesListAllServerTypesResponseServerTypesInner.memory) &&
        Objects.equals(this.name, serverTypesListAllServerTypesResponseServerTypesInner.name) &&
        Objects.equals(this.prices, serverTypesListAllServerTypesResponseServerTypesInner.prices) &&
        Objects.equals(this.storageType, serverTypesListAllServerTypesResponseServerTypesInner.storageType)&&
        Objects.equals(this.additionalProperties, serverTypesListAllServerTypesResponseServerTypesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerTypesListAllServerTypesResponseServerTypesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerTypesListAllServerTypesResponseServerTypesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerTypesListAllServerTypesResponseServerTypesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerTypesListAllServerTypesResponseServerTypesInner is not found in the empty JSON string", ServerTypesListAllServerTypesResponseServerTypesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerTypesListAllServerTypesResponseServerTypesInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("deprecation") != null && !jsonObj.get("deprecation").isJsonNull()) {
        DeprecationInfoProperty2.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
      }
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        ServerTypesListAllServerTypesResponseServerTypesInnerPricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerTypesListAllServerTypesResponseServerTypesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerTypesListAllServerTypesResponseServerTypesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerTypesListAllServerTypesResponseServerTypesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerTypesListAllServerTypesResponseServerTypesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerTypesListAllServerTypesResponseServerTypesInner>() {
           @Override
           public void write(JsonWriter out, ServerTypesListAllServerTypesResponseServerTypesInner value) throws IOException {
           ...
           @Override
           public ServerTypesListAllServerTypesResponseServerTypesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerTypesListAllServerTypesResponseServerTypesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerTypesListAllServerTypesResponseServerTypesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerTypesListAllServerTypesResponseServerTypesInner
  * @throws IOException if the JSON string is invalid with respect to ServerTypesListAllServerTypesResponseServerTypesInner
  */
  public static ServerTypesListAllServerTypesResponseServerTypesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerTypesListAllServerTypesResponseServerTypesInner.class);
  }

 /**
  * Convert an instance of ServerTypesListAllServerTypesResponseServerTypesInner to an JSON string
  *
  * @return JSON string
  */
