...
/**
 * ActionProperty15ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty15ResourcesInner {
  ...
  public ActionProperty15ResourcesInner() {
  }

  public ActionProperty15ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty15ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty15ResourcesInner instance itself
   */
  public ActionProperty15ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty15ResourcesInner actionProperty15ResourcesInner = (ActionProperty15ResourcesInner) o;
    return Objects.equals(this.id, actionProperty15ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty15ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty15ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty15ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty15ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty15ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty15ResourcesInner is not found in the empty JSON string", ActionProperty15ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty15ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty15ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty15ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty15ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty15ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty15ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty15ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty15ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty15ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty15ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty15ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty15ResourcesInner
  */
  public static ActionProperty15ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty15ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty15ResourcesInner to an JSON string
  *
  * @return JSON string
  */
