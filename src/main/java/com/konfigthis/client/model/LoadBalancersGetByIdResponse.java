...
import com.konfigthis.client.model.LoadBalancersGetByIdResponseLoadBalancer;
...
public class LoadBalancersGetByIdResponse {
  public static final String SERIALIZED_NAME_LOAD_BALANCER = "load_balancer";
  @SerializedName(SERIALIZED_NAME_LOAD_BALANCER)
  private LoadBalancersGetByIdResponseLoadBalancer loadBalancer;

  public LoadBalancersGetByIdResponse() {
  }

  public LoadBalancersGetByIdResponse loadBalancer(LoadBalancersGetByIdResponseLoadBalancer loadBalancer) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancer getLoadBalancer() {
    return loadBalancer;
  }


  public void setLoadBalancer(LoadBalancersGetByIdResponseLoadBalancer loadBalancer) {
   ...
   * @return the LoadBalancersGetByIdResponse instance itself
   */
  public LoadBalancersGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersGetByIdResponse loadBalancersGetByIdResponse = (LoadBalancersGetByIdResponse) o;
    return Objects.equals(this.loadBalancer, loadBalancersGetByIdResponse.loadBalancer)&&
        Objects.equals(this.additionalProperties, loadBalancersGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersGetByIdResponse is not found in the empty JSON string", LoadBalancersGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `load_balancer`
      LoadBalancersGetByIdResponseLoadBalancer.validateJsonObject(jsonObj.getAsJsonObject("load_balancer"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancersGetByIdResponse value) throws IOException {
           ...
           @Override
           public LoadBalancersGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersGetByIdResponse
  */
  public static LoadBalancersGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersGetByIdResponse.class);
  }

 /**
  * Convert an instance of LoadBalancersGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
