...
public class LoadBalancersCreateLoadBalancerRequest {
  ...
  private LoadBalancerAlgorithmProperty algorithm = {"type":"round_robin"};
  ...
  private List<LoadBalancerTarget> targets = null;

  public LoadBalancersCreateLoadBalancerRequest() {
  }

  public LoadBalancersCreateLoadBalancerRequest algorithm(LoadBalancerAlgorithmProperty algorithm) {
  ...
  **/
  ...
  public LoadBalancerAlgorithmProperty getAlgorithm() {
    return algorithm;
  }


  public void setAlgorithm(LoadBalancerAlgorithmProperty algorithm) {
  ...
  public LoadBalancersCreateLoadBalancerRequest labels(LoadBalancersCreateLoadBalancerRequestLabels labels) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerRequestLabels getLabels() {
    return labels;
  }


  public void setLabels(LoadBalancersCreateLoadBalancerRequestLabels labels) {
  ...
  public LoadBalancersCreateLoadBalancerRequest loadBalancerType(String loadBalancerType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "lb11", required = true, value = "ID or name of the Load Balancer type this Load Balancer should be created with")
  ...
  public LoadBalancersCreateLoadBalancerRequest location(String location) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID or name of Location to create Load Balancer in")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Web Frontend", required = true, value = "Name of the Load Balancer")
  ...
  public LoadBalancersCreateLoadBalancerRequest network(Long network) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123", value = "ID of the network the Load Balancer should be attached to on creation")
  ...
  public LoadBalancersCreateLoadBalancerRequest networkZone(String networkZone) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "eu-central", value = "Name of network zone")
  ...
  public LoadBalancersCreateLoadBalancerRequest publicInterface(Boolean publicInterface) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Enable or disable the public interface of the Load Balancer")
  ...
  public LoadBalancersCreateLoadBalancerRequest services(List<LoadBalancerService> services) {
  ...
  public LoadBalancersCreateLoadBalancerRequest addServicesItem(LoadBalancerService servicesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of services")
  ...
  public LoadBalancersCreateLoadBalancerRequest targets(List<LoadBalancerTarget> targets) {
  ...
  public LoadBalancersCreateLoadBalancerRequest addTargetsItem(LoadBalancerTarget targetsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of targets")
   ...
   * @return the LoadBalancersCreateLoadBalancerRequest instance itself
   */
  public LoadBalancersCreateLoadBalancerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.algorithm, loadBalancersCreateLoadBalancerRequest.algorithm) &&
        Objects.equals(this.labels, loadBalancersCreateLoadBalancerRequest.labels) &&
        Objects.equals(this.loadBalancerType, loadBalancersCreateLoadBalancerRequest.loadBalancerType) &&
        Objects.equals(this.location, loadBalancersCreateLoadBalancerRequest.location) &&
        Objects.equals(this.name, loadBalancersCreateLoadBalancerRequest.name) &&
        Objects.equals(this.network, loadBalancersCreateLoadBalancerRequest.network) &&
        Objects.equals(this.networkZone, loadBalancersCreateLoadBalancerRequest.networkZone) &&
        Objects.equals(this.publicInterface, loadBalancersCreateLoadBalancerRequest.publicInterface) &&
        Objects.equals(this.services, loadBalancersCreateLoadBalancerRequest.services) &&
        Objects.equals(this.targets, loadBalancersCreateLoadBalancerRequest.targets)&&
        Objects.equals(this.additionalProperties, loadBalancersCreateLoadBalancerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(algorithm, labels, loadBalancerType, location, name, network, networkZone, publicInterface, services, targets, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersCreateLoadBalancerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersCreateLoadBalancerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("algorithm") != null && !jsonObj.get("algorithm").isJsonNull()) {
        LoadBalancerAlgorithmProperty.validateJsonObject(jsonObj.getAsJsonObject("algorithm"));
      }
      // validate the optional field `labels`
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        LoadBalancersCreateLoadBalancerRequestLabels.validateJsonObject(jsonObj.getAsJsonObject("labels"));
      }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            LoadBalancerService.validateJsonObject(jsonArrayservices.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("targets") != null && !jsonObj.get("targets").isJsonNull()) {
        ...
        if (jsonArraytargets != null) {
          ...
          for (int i = 0; i < jsonArraytargets.size(); i++) {
            LoadBalancerTarget.validateJsonObject(jsonArraytargets.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersCreateLoadBalancerRequest>() {
           ...
           public LoadBalancersCreateLoadBalancerRequest read(JsonReader in) throws IOException {
             ...
             LoadBalancersCreateLoadBalancerRequest instance = thisAdapter.fromJsonTree(jsonObj);
