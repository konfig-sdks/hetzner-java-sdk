...
public class ActionProperty32Error {
  ...
  public ActionProperty32Error() {
  }

  public ActionProperty32Error code(String code) {
  ...
  **/
  ...
  public ActionProperty32Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty32Error instance itself
   */
  public ActionProperty32Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty32Error actionProperty32Error = (ActionProperty32Error) o;
    return Objects.equals(this.code, actionProperty32Error.code) &&
        Objects.equals(this.message, actionProperty32Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty32Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty32Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty32Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty32Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty32Error is not found in the empty JSON string", ActionProperty32Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty32Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty32Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty32Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty32Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty32Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty32Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty32Error value) throws IOException {
           ...
           @Override
           public ActionProperty32Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty32Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty32Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty32Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty32Error
  */
  public static ActionProperty32Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty32Error.class);
  }

 /**
  * Convert an instance of ActionProperty32Error to an JSON string
  *
  * @return JSON string
  */
