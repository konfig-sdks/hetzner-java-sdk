...
/**
 * ActionProperty20ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty20ResourcesInner {
  ...
  public ActionProperty20ResourcesInner() {
  }

  public ActionProperty20ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty20ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty20ResourcesInner instance itself
   */
  public ActionProperty20ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty20ResourcesInner actionProperty20ResourcesInner = (ActionProperty20ResourcesInner) o;
    return Objects.equals(this.id, actionProperty20ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty20ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty20ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty20ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty20ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty20ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty20ResourcesInner is not found in the empty JSON string", ActionProperty20ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty20ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty20ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty20ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty20ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty20ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty20ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty20ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty20ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty20ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty20ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty20ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty20ResourcesInner
  */
  public static ActionProperty20ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty20ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty20ResourcesInner to an JSON string
  *
  * @return JSON string
  */
