...
public class ActionProperty65Error {
  ...
  public ActionProperty65Error() {
  }

  public ActionProperty65Error code(String code) {
  ...
  **/
  ...
  public ActionProperty65Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty65Error instance itself
   */
  public ActionProperty65Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty65Error actionProperty65Error = (ActionProperty65Error) o;
    return Objects.equals(this.code, actionProperty65Error.code) &&
        Objects.equals(this.message, actionProperty65Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty65Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty65Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty65Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty65Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty65Error is not found in the empty JSON string", ActionProperty65Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty65Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty65Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty65Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty65Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty65Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty65Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty65Error value) throws IOException {
           ...
           @Override
           public ActionProperty65Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty65Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty65Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty65Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty65Error
  */
  public static ActionProperty65Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty65Error.class);
  }

 /**
  * Convert an instance of ActionProperty65Error to an JSON string
  *
  * @return JSON string
  */
