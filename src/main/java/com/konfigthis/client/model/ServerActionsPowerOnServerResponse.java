...
import com.konfigthis.client.model.ActionProperty65;
...
public class ServerActionsPowerOnServerResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty65 action;

  public ServerActionsPowerOnServerResponse() {
  }

  public ServerActionsPowerOnServerResponse action(ActionProperty65 action) {
  ...
  **/
  ...
  public ActionProperty65 getAction() {
    return action;
  }


  public void setAction(ActionProperty65 action) {
   ...
   * @return the ServerActionsPowerOnServerResponse instance itself
   */
  public ServerActionsPowerOnServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsPowerOnServerResponse serverActionsPowerOnServerResponse = (ServerActionsPowerOnServerResponse) o;
    return Objects.equals(this.action, serverActionsPowerOnServerResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsPowerOnServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsPowerOnServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsPowerOnServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsPowerOnServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsPowerOnServerResponse is not found in the empty JSON string", ServerActionsPowerOnServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsPowerOnServerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty65.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsPowerOnServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsPowerOnServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsPowerOnServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsPowerOnServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsPowerOnServerResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsPowerOnServerResponse value) throws IOException {
           ...
           @Override
           public ServerActionsPowerOnServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsPowerOnServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsPowerOnServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsPowerOnServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsPowerOnServerResponse
  */
  public static ServerActionsPowerOnServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsPowerOnServerResponse.class);
  }

 /**
  * Convert an instance of ServerActionsPowerOnServerResponse to an JSON string
  *
  * @return JSON string
  */
