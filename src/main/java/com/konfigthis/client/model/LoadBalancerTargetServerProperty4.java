...
public class LoadBalancerTargetServerProperty4 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty4() {
  }

  public LoadBalancerTargetServerProperty4 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty4 instance itself
   */
  public LoadBalancerTargetServerProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty4 loadBalancerTargetServerProperty4 = (LoadBalancerTargetServerProperty4) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty4.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty4 is not found in the empty JSON string", LoadBalancerTargetServerProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty4>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty4 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty4
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty4
  */
  public static LoadBalancerTargetServerProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty4.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty4 to an JSON string
  *
  * @return JSON string
  */
