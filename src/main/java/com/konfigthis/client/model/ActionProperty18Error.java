...
public class ActionProperty18Error {
  ...
  public ActionProperty18Error() {
  }

  public ActionProperty18Error code(String code) {
  ...
  **/
  ...
  public ActionProperty18Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty18Error instance itself
   */
  public ActionProperty18Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty18Error actionProperty18Error = (ActionProperty18Error) o;
    return Objects.equals(this.code, actionProperty18Error.code) &&
        Objects.equals(this.message, actionProperty18Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty18Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty18Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty18Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty18Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty18Error is not found in the empty JSON string", ActionProperty18Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty18Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty18Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty18Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty18Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty18Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty18Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty18Error value) throws IOException {
           ...
           @Override
           public ActionProperty18Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty18Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty18Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty18Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty18Error
  */
  public static ActionProperty18Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty18Error.class);
  }

 /**
  * Convert an instance of ActionProperty18Error to an JSON string
  *
  * @return JSON string
  */
