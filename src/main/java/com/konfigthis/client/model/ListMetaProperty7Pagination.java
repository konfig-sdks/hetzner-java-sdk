...
public class ListMetaProperty7Pagination {
  ...
  public ListMetaProperty7Pagination() {
  }

  public ListMetaProperty7Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty7Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty7Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty7Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty7Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty7Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty7Pagination instance itself
   */
  public ListMetaProperty7Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty7Pagination listMetaProperty7Pagination = (ListMetaProperty7Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty7Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty7Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty7Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty7Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty7Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty7Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty7Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty7Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty7Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty7Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty7Pagination is not found in the empty JSON string", ListMetaProperty7Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty7Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty7Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty7Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty7Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty7Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty7Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty7Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty7Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty7Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty7Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty7Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty7Pagination
  */
  public static ListMetaProperty7Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty7Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty7Pagination to an JSON string
  *
  * @return JSON string
  */
