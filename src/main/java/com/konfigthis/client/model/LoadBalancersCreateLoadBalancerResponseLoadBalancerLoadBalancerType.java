...
import com.konfigthis.client.model.LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner;
...
public class LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType {
  ...
  private List<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner> prices = new ArrayList<>();

  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType() {
  }

  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType description(String description) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType deprecated(String deprecated) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType id(Long id) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType maxAssignedCertificates(Long maxAssignedCertificates) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType maxConnections(Long maxConnections) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType maxServices(Long maxServices) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType maxTargets(Long maxTargets) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType name(String name) {
  ...
  **/
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType prices(List<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner> prices) {
  ...
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType addPricesItem(LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner> prices) {
   ...
   * @return the LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType instance itself
   */
  public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType = (LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType) o;
    return Objects.equals(this.description, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.description) &&
        Objects.equals(this.deprecated, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.deprecated) &&
        Objects.equals(this.id, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.id) &&
        Objects.equals(this.maxAssignedCertificates, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.maxAssignedCertificates) &&
        Objects.equals(this.maxConnections, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.maxConnections) &&
        Objects.equals(this.maxServices, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.maxServices) &&
        Objects.equals(this.maxTargets, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.maxTargets) &&
        Objects.equals(this.name, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.name) &&
        Objects.equals(this.prices, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.prices)&&
        Objects.equals(this.additionalProperties, loadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType is not found in the empty JSON string", LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType>() {
           @Override
           public void write(JsonWriter out, LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType value) throws IOException {
           ...
           @Override
           public LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType
  */
  public static LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType.class);
  }

 /**
  * Convert an instance of LoadBalancersCreateLoadBalancerResponseLoadBalancerLoadBalancerType to an JSON string
  *
  * @return JSON string
  */
