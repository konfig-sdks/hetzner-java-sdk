...
/**
 * ActionProperty65ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty65ResourcesInner {
  ...
  public ActionProperty65ResourcesInner() {
  }

  public ActionProperty65ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty65ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty65ResourcesInner instance itself
   */
  public ActionProperty65ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty65ResourcesInner actionProperty65ResourcesInner = (ActionProperty65ResourcesInner) o;
    return Objects.equals(this.id, actionProperty65ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty65ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty65ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty65ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty65ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty65ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty65ResourcesInner is not found in the empty JSON string", ActionProperty65ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty65ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty65ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty65ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty65ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty65ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty65ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty65ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty65ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty65ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty65ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty65ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty65ResourcesInner
  */
  public static ActionProperty65ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty65ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty65ResourcesInner to an JSON string
  *
  * @return JSON string
  */
