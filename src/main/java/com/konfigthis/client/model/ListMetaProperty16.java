...
import com.konfigthis.client.model.ListMetaProperty16Pagination;
...
public class ListMetaProperty16 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty16Pagination pagination;

  public ListMetaProperty16() {
  }

  public ListMetaProperty16 pagination(ListMetaProperty16Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty16Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty16Pagination pagination) {
   ...
   * @return the ListMetaProperty16 instance itself
   */
  public ListMetaProperty16 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty16 listMetaProperty16 = (ListMetaProperty16) o;
    return Objects.equals(this.pagination, listMetaProperty16.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty16.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty16 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty16
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty16.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty16 is not found in the empty JSON string", ListMetaProperty16.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty16.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty16Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty16.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty16' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty16> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty16.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty16>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty16 value) throws IOException {
           ...
           @Override
           public ListMetaProperty16 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty16 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty16 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty16
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty16
  */
  public static ListMetaProperty16 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty16.class);
  }

 /**
  * Convert an instance of ListMetaProperty16 to an JSON string
  *
  * @return JSON string
  */
