...
/**
 * ActionProperty11ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty11ResourcesInner {
  ...
  public ActionProperty11ResourcesInner() {
  }

  public ActionProperty11ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty11ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty11ResourcesInner instance itself
   */
  public ActionProperty11ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty11ResourcesInner actionProperty11ResourcesInner = (ActionProperty11ResourcesInner) o;
    return Objects.equals(this.id, actionProperty11ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty11ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty11ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty11ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty11ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty11ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty11ResourcesInner is not found in the empty JSON string", ActionProperty11ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty11ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty11ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty11ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty11ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty11ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty11ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty11ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty11ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty11ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty11ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty11ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty11ResourcesInner
  */
  public static ActionProperty11ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty11ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty11ResourcesInner to an JSON string
  *
  * @return JSON string
  */
