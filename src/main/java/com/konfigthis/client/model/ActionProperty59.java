...
import com.konfigthis.client.model.ActionProperty59Error;
import com.konfigthis.client.model.ActionProperty59ResourcesInner;
...
public class ActionProperty59 {
  ...
  private ActionProperty59Error error;
  ...
  private List<ActionProperty59ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty59() {
  }

  public ActionProperty59 command(String command) {
  ...
  **/
  ...
  public ActionProperty59 error(ActionProperty59Error error) {
  ...
  **/
  ...
  public ActionProperty59Error getError() {
    return error;
  }


  public void setError(ActionProperty59Error error) {
  ...
  public ActionProperty59 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty59 id(Long id) {
  ...
  **/
  ...
  public ActionProperty59 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty59 resources(List<ActionProperty59ResourcesInner> resources) {
  ...
  public ActionProperty59 addResourcesItem(ActionProperty59ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty59ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty59ResourcesInner> resources) {
  ...
  public ActionProperty59 started(String started) {
  ...
  **/
  ...
  public ActionProperty59 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty59 instance itself
   */
  public ActionProperty59 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty59 actionProperty59 = (ActionProperty59) o;
    return Objects.equals(this.command, actionProperty59.command) &&
        Objects.equals(this.error, actionProperty59.error) &&
        Objects.equals(this.finished, actionProperty59.finished) &&
        Objects.equals(this.id, actionProperty59.id) &&
        Objects.equals(this.progress, actionProperty59.progress) &&
        Objects.equals(this.resources, actionProperty59.resources) &&
        Objects.equals(this.started, actionProperty59.started) &&
        Objects.equals(this.status, actionProperty59.status)&&
        Objects.equals(this.additionalProperties, actionProperty59.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty59 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty59
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty59.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty59 is not found in the empty JSON string", ActionProperty59.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty59.openapiRequiredFields) {
      ...
      ActionProperty59Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty59ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty59.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty59' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty59> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty59.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty59>() {
           @Override
           public void write(JsonWriter out, ActionProperty59 value) throws IOException {
           ...
           @Override
           public ActionProperty59 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty59 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty59 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty59
  * @throws IOException if the JSON string is invalid with respect to ActionProperty59
  */
  public static ActionProperty59 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty59.class);
  }

 /**
  * Convert an instance of ActionProperty59 to an JSON string
  *
  * @return JSON string
  */
