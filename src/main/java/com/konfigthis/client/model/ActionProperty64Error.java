...
public class ActionProperty64Error {
  ...
  public ActionProperty64Error() {
  }

  public ActionProperty64Error code(String code) {
  ...
  **/
  ...
  public ActionProperty64Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty64Error instance itself
   */
  public ActionProperty64Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty64Error actionProperty64Error = (ActionProperty64Error) o;
    return Objects.equals(this.code, actionProperty64Error.code) &&
        Objects.equals(this.message, actionProperty64Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty64Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty64Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty64Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty64Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty64Error is not found in the empty JSON string", ActionProperty64Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty64Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty64Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty64Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty64Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty64Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty64Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty64Error value) throws IOException {
           ...
           @Override
           public ActionProperty64Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty64Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty64Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty64Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty64Error
  */
  public static ActionProperty64Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty64Error.class);
  }

 /**
  * Convert an instance of ActionProperty64Error to an JSON string
  *
  * @return JSON string
  */
