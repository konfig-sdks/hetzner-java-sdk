...
public class DeprecationInfo {
  ...
  public DeprecationInfo announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfo unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfo instance itself
   */
  public DeprecationInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfo deprecationInfo = (DeprecationInfo) o;
    return Objects.equals(this.announced, deprecationInfo.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfo.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfo.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfo is not found in the empty JSON string", DeprecationInfo.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfo>() {
           @Override
           public void write(JsonWriter out, DeprecationInfo value) throws IOException {
           ...
           @Override
           public DeprecationInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfo
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfo
  */
  public static DeprecationInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfo.class);
  }

 /**
  * Convert an instance of DeprecationInfo to an JSON string
  *
  * @return JSON string
  */
