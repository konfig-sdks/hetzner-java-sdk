...
/**
 * SshKeysGetAllSshKeysResponseSshKeysInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SshKeysGetAllSshKeysResponseSshKeysInner {
  ...
  public SshKeysGetAllSshKeysResponseSshKeysInner() {
  }

  public SshKeysGetAllSshKeysResponseSshKeysInner created(String created) {
  ...
  **/
  ...
  public SshKeysGetAllSshKeysResponseSshKeysInner fingerprint(String fingerprint) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "b7:2f:30:a0:2f:6c:58:6c:21:04:58:61:ba:06:3b:2f", required = true, value = "Fingerprint of public key")
  ...
  public SshKeysGetAllSshKeysResponseSshKeysInner id(Long id) {
  ...
  **/
  ...
  public SshKeysGetAllSshKeysResponseSshKeysInner labels(Map<String, String> labels) {
  ...
  public SshKeysGetAllSshKeysResponseSshKeysInner putLabelsItem(String key, String labelsItem) {
  ...
  **/
  ...
  public SshKeysGetAllSshKeysResponseSshKeysInner name(String name) {
  ...
  **/
  ...
  public SshKeysGetAllSshKeysResponseSshKeysInner publicKey(String publicKey) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "ssh-rsa AAAjjk76kgf...Xt", required = true, value = "Public key")
   ...
   * @return the SshKeysGetAllSshKeysResponseSshKeysInner instance itself
   */
  public SshKeysGetAllSshKeysResponseSshKeysInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysGetAllSshKeysResponseSshKeysInner sshKeysGetAllSshKeysResponseSshKeysInner = (SshKeysGetAllSshKeysResponseSshKeysInner) o;
    return Objects.equals(this.created, sshKeysGetAllSshKeysResponseSshKeysInner.created) &&
        Objects.equals(this.fingerprint, sshKeysGetAllSshKeysResponseSshKeysInner.fingerprint) &&
        Objects.equals(this.id, sshKeysGetAllSshKeysResponseSshKeysInner.id) &&
        Objects.equals(this.labels, sshKeysGetAllSshKeysResponseSshKeysInner.labels) &&
        Objects.equals(this.name, sshKeysGetAllSshKeysResponseSshKeysInner.name) &&
        Objects.equals(this.publicKey, sshKeysGetAllSshKeysResponseSshKeysInner.publicKey)&&
        Objects.equals(this.additionalProperties, sshKeysGetAllSshKeysResponseSshKeysInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, fingerprint, id, labels, name, publicKey, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeysGetAllSshKeysResponseSshKeysInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysGetAllSshKeysResponseSshKeysInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysGetAllSshKeysResponseSshKeysInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysGetAllSshKeysResponseSshKeysInner is not found in the empty JSON string", SshKeysGetAllSshKeysResponseSshKeysInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysGetAllSshKeysResponseSshKeysInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysGetAllSshKeysResponseSshKeysInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysGetAllSshKeysResponseSshKeysInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysGetAllSshKeysResponseSshKeysInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysGetAllSshKeysResponseSshKeysInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysGetAllSshKeysResponseSshKeysInner>() {
           @Override
           public void write(JsonWriter out, SshKeysGetAllSshKeysResponseSshKeysInner value) throws IOException {
           ...
           @Override
           public SshKeysGetAllSshKeysResponseSshKeysInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysGetAllSshKeysResponseSshKeysInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysGetAllSshKeysResponseSshKeysInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysGetAllSshKeysResponseSshKeysInner
  * @throws IOException if the JSON string is invalid with respect to SshKeysGetAllSshKeysResponseSshKeysInner
  */
  public static SshKeysGetAllSshKeysResponseSshKeysInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysGetAllSshKeysResponseSshKeysInner.class);
  }

 /**
  * Convert an instance of SshKeysGetAllSshKeysResponseSshKeysInner to an JSON string
  *
  * @return JSON string
  */
