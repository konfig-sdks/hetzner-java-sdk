...
import com.konfigthis.client.model.ServersGetMetricsForServerResponseMetrics;
...
public class ServersGetMetricsForServerResponse {
  public static final String SERIALIZED_NAME_METRICS = "metrics";
  @SerializedName(SERIALIZED_NAME_METRICS)
  private ServersGetMetricsForServerResponseMetrics metrics;

  public ServersGetMetricsForServerResponse() {
  }

  public ServersGetMetricsForServerResponse metrics(ServersGetMetricsForServerResponseMetrics metrics) {
  ...
  **/
  ...
  public ServersGetMetricsForServerResponseMetrics getMetrics() {
    return metrics;
  }


  public void setMetrics(ServersGetMetricsForServerResponseMetrics metrics) {
   ...
   * @return the ServersGetMetricsForServerResponse instance itself
   */
  public ServersGetMetricsForServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGetMetricsForServerResponse serversGetMetricsForServerResponse = (ServersGetMetricsForServerResponse) o;
    return Objects.equals(this.metrics, serversGetMetricsForServerResponse.metrics)&&
        Objects.equals(this.additionalProperties, serversGetMetricsForServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersGetMetricsForServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersGetMetricsForServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersGetMetricsForServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGetMetricsForServerResponse is not found in the empty JSON string", ServersGetMetricsForServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGetMetricsForServerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `metrics`
      ServersGetMetricsForServerResponseMetrics.validateJsonObject(jsonObj.getAsJsonObject("metrics"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGetMetricsForServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGetMetricsForServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGetMetricsForServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGetMetricsForServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGetMetricsForServerResponse>() {
           @Override
           public void write(JsonWriter out, ServersGetMetricsForServerResponse value) throws IOException {
           ...
           @Override
           public ServersGetMetricsForServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersGetMetricsForServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersGetMetricsForServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersGetMetricsForServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServersGetMetricsForServerResponse
  */
  public static ServersGetMetricsForServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGetMetricsForServerResponse.class);
  }

 /**
  * Convert an instance of ServersGetMetricsForServerResponse to an JSON string
  *
  * @return JSON string
  */
