...
public class ActionProperty62Error {
  ...
  public ActionProperty62Error() {
  }

  public ActionProperty62Error code(String code) {
  ...
  **/
  ...
  public ActionProperty62Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty62Error instance itself
   */
  public ActionProperty62Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty62Error actionProperty62Error = (ActionProperty62Error) o;
    return Objects.equals(this.code, actionProperty62Error.code) &&
        Objects.equals(this.message, actionProperty62Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty62Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty62Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty62Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty62Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty62Error is not found in the empty JSON string", ActionProperty62Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty62Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty62Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty62Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty62Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty62Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty62Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty62Error value) throws IOException {
           ...
           @Override
           public ActionProperty62Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty62Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty62Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty62Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty62Error
  */
  public static ActionProperty62Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty62Error.class);
  }

 /**
  * Convert an instance of ActionProperty62Error to an JSON string
  *
  * @return JSON string
  */
