...
public class ActionProperty48Error {
  ...
  public ActionProperty48Error() {
  }

  public ActionProperty48Error code(String code) {
  ...
  **/
  ...
  public ActionProperty48Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty48Error instance itself
   */
  public ActionProperty48Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty48Error actionProperty48Error = (ActionProperty48Error) o;
    return Objects.equals(this.code, actionProperty48Error.code) &&
        Objects.equals(this.message, actionProperty48Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty48Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty48Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty48Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty48Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty48Error is not found in the empty JSON string", ActionProperty48Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty48Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty48Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty48Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty48Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty48Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty48Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty48Error value) throws IOException {
           ...
           @Override
           public ActionProperty48Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty48Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty48Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty48Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty48Error
  */
  public static ActionProperty48Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty48Error.class);
  }

 /**
  * Convert an instance of ActionProperty48Error to an JSON string
  *
  * @return JSON string
  */
