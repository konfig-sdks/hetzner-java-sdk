...
import com.konfigthis.client.model.Action13Error;
import com.konfigthis.client.model.Action13ResourcesInner;
...
public class Action13 {
  ...
  private List<Action13ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action13 command(String command) {
  ...
  **/
  ...
  public Action13 error(Action13Error error) {
  ...
  **/
  ...
  public Action13Error getError() {
    return error;
  }


  public void setError(Action13Error error) {
  ...
  public Action13 finished(String finished) {
  ...
  **/
  ...
  public Action13 progress(Integer progress) {
  ...
  **/
  ...
  public Action13 resources(List<Action13ResourcesInner> resources) {
  ...
  public Action13 addResourcesItem(Action13ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action13ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action13ResourcesInner> resources) {
  ...
  public Action13 started(String started) {
  ...
  **/
  ...
  public Action13 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action13 instance itself
   */
  public Action13 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action13 action13 = (Action13) o;
    return Objects.equals(this.command, action13.command) &&
        Objects.equals(this.error, action13.error) &&
        Objects.equals(this.finished, action13.finished) &&
        Objects.equals(this.id, action13.id) &&
        Objects.equals(this.progress, action13.progress) &&
        Objects.equals(this.resources, action13.resources) &&
        Objects.equals(this.started, action13.started) &&
        Objects.equals(this.status, action13.status)&&
        Objects.equals(this.additionalProperties, action13.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action13
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action13.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action13 is not found in the empty JSON string", Action13.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action13.openapiRequiredFields) {
      ...
      Action13Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action13ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action13.class));

       return (TypeAdapter<T>) new TypeAdapter<Action13>() {
           @Override
           public void write(JsonWriter out, Action13 value) throws IOException {
           ...
           @Override
           public Action13 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action13 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action13 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action13
  * @throws IOException if the JSON string is invalid with respect to Action13
  */
  public static Action13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action13.class);
  }

 /**
  * Convert an instance of Action13 to an JSON string
  *
  * @return JSON string
  */
