...
/**
 * ActionProperty70ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty70ResourcesInner {
  ...
  public ActionProperty70ResourcesInner() {
  }

  public ActionProperty70ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty70ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty70ResourcesInner instance itself
   */
  public ActionProperty70ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty70ResourcesInner actionProperty70ResourcesInner = (ActionProperty70ResourcesInner) o;
    return Objects.equals(this.id, actionProperty70ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty70ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty70ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty70ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty70ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty70ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty70ResourcesInner is not found in the empty JSON string", ActionProperty70ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty70ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty70ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty70ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty70ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty70ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty70ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty70ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty70ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty70ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty70ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty70ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty70ResourcesInner
  */
  public static ActionProperty70ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty70ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty70ResourcesInner to an JSON string
  *
  * @return JSON string
  */
