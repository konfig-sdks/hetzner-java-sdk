...
import com.konfigthis.client.model.Action12Error;
import com.konfigthis.client.model.Action12ResourcesInner;
...
public class Action12 {
  ...
  private List<Action12ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action12 command(String command) {
  ...
  **/
  ...
  public Action12 error(Action12Error error) {
  ...
  **/
  ...
  public Action12Error getError() {
    return error;
  }


  public void setError(Action12Error error) {
  ...
  public Action12 finished(String finished) {
  ...
  **/
  ...
  public Action12 progress(Integer progress) {
  ...
  **/
  ...
  public Action12 resources(List<Action12ResourcesInner> resources) {
  ...
  public Action12 addResourcesItem(Action12ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action12ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action12ResourcesInner> resources) {
  ...
  public Action12 started(String started) {
  ...
  **/
  ...
  public Action12 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action12 instance itself
   */
  public Action12 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action12 action12 = (Action12) o;
    return Objects.equals(this.command, action12.command) &&
        Objects.equals(this.error, action12.error) &&
        Objects.equals(this.finished, action12.finished) &&
        Objects.equals(this.id, action12.id) &&
        Objects.equals(this.progress, action12.progress) &&
        Objects.equals(this.resources, action12.resources) &&
        Objects.equals(this.started, action12.started) &&
        Objects.equals(this.status, action12.status)&&
        Objects.equals(this.additionalProperties, action12.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action12
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action12.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action12 is not found in the empty JSON string", Action12.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action12.openapiRequiredFields) {
      ...
      Action12Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action12ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action12.class));

       return (TypeAdapter<T>) new TypeAdapter<Action12>() {
           @Override
           public void write(JsonWriter out, Action12 value) throws IOException {
           ...
           @Override
           public Action12 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action12 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action12 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action12
  * @throws IOException if the JSON string is invalid with respect to Action12
  */
  public static Action12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action12.class);
  }

 /**
  * Convert an instance of Action12 to an JSON string
  *
  * @return JSON string
  */
