...
/**
 * ActionProperty62ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty62ResourcesInner {
  ...
  public ActionProperty62ResourcesInner() {
  }

  public ActionProperty62ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty62ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty62ResourcesInner instance itself
   */
  public ActionProperty62ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty62ResourcesInner actionProperty62ResourcesInner = (ActionProperty62ResourcesInner) o;
    return Objects.equals(this.id, actionProperty62ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty62ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty62ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty62ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty62ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty62ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty62ResourcesInner is not found in the empty JSON string", ActionProperty62ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty62ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty62ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty62ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty62ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty62ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty62ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty62ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty62ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty62ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty62ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty62ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty62ResourcesInner
  */
  public static ActionProperty62ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty62ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty62ResourcesInner to an JSON string
  *
  * @return JSON string
  */
