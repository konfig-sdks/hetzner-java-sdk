...
public class ActionProperty66Error {
  ...
  public ActionProperty66Error() {
  }

  public ActionProperty66Error code(String code) {
  ...
  **/
  ...
  public ActionProperty66Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty66Error instance itself
   */
  public ActionProperty66Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty66Error actionProperty66Error = (ActionProperty66Error) o;
    return Objects.equals(this.code, actionProperty66Error.code) &&
        Objects.equals(this.message, actionProperty66Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty66Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty66Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty66Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty66Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty66Error is not found in the empty JSON string", ActionProperty66Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty66Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty66Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty66Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty66Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty66Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty66Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty66Error value) throws IOException {
           ...
           @Override
           public ActionProperty66Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty66Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty66Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty66Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty66Error
  */
  public static ActionProperty66Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty66Error.class);
  }

 /**
  * Convert an instance of ActionProperty66Error to an JSON string
  *
  * @return JSON string
  */
