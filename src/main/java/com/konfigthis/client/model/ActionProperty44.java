...
import com.konfigthis.client.model.ActionProperty44Error;
import com.konfigthis.client.model.ActionProperty44ResourcesInner;
...
public class ActionProperty44 {
  ...
  private ActionProperty44Error error;
  ...
  private List<ActionProperty44ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty44() {
  }

  public ActionProperty44 command(String command) {
  ...
  **/
  ...
  public ActionProperty44 error(ActionProperty44Error error) {
  ...
  **/
  ...
  public ActionProperty44Error getError() {
    return error;
  }


  public void setError(ActionProperty44Error error) {
  ...
  public ActionProperty44 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty44 id(Long id) {
  ...
  **/
  ...
  public ActionProperty44 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty44 resources(List<ActionProperty44ResourcesInner> resources) {
  ...
  public ActionProperty44 addResourcesItem(ActionProperty44ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty44ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty44ResourcesInner> resources) {
  ...
  public ActionProperty44 started(String started) {
  ...
  **/
  ...
  public ActionProperty44 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty44 instance itself
   */
  public ActionProperty44 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty44 actionProperty44 = (ActionProperty44) o;
    return Objects.equals(this.command, actionProperty44.command) &&
        Objects.equals(this.error, actionProperty44.error) &&
        Objects.equals(this.finished, actionProperty44.finished) &&
        Objects.equals(this.id, actionProperty44.id) &&
        Objects.equals(this.progress, actionProperty44.progress) &&
        Objects.equals(this.resources, actionProperty44.resources) &&
        Objects.equals(this.started, actionProperty44.started) &&
        Objects.equals(this.status, actionProperty44.status)&&
        Objects.equals(this.additionalProperties, actionProperty44.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty44 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty44
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty44.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty44 is not found in the empty JSON string", ActionProperty44.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty44.openapiRequiredFields) {
      ...
      ActionProperty44Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty44ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty44.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty44' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty44> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty44.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty44>() {
           @Override
           public void write(JsonWriter out, ActionProperty44 value) throws IOException {
           ...
           @Override
           public ActionProperty44 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty44 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty44 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty44
  * @throws IOException if the JSON string is invalid with respect to ActionProperty44
  */
  public static ActionProperty44 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty44.class);
  }

 /**
  * Convert an instance of ActionProperty44 to an JSON string
  *
  * @return JSON string
  */
