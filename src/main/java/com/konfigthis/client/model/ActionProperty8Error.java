...
public class ActionProperty8Error {
  ...
  public ActionProperty8Error() {
  }

  public ActionProperty8Error code(String code) {
  ...
  **/
  ...
  public ActionProperty8Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty8Error instance itself
   */
  public ActionProperty8Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty8Error actionProperty8Error = (ActionProperty8Error) o;
    return Objects.equals(this.code, actionProperty8Error.code) &&
        Objects.equals(this.message, actionProperty8Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty8Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty8Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty8Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty8Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty8Error is not found in the empty JSON string", ActionProperty8Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty8Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty8Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty8Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty8Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty8Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty8Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty8Error value) throws IOException {
           ...
           @Override
           public ActionProperty8Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty8Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty8Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty8Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty8Error
  */
  public static ActionProperty8Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty8Error.class);
  }

 /**
  * Convert an instance of ActionProperty8Error to an JSON string
  *
  * @return JSON string
  */
