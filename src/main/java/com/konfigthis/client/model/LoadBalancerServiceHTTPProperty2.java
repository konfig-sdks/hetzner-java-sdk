...
public class LoadBalancerServiceHTTPProperty2 {
  ...
  public LoadBalancerServiceHTTPProperty2() {
  }

  public LoadBalancerServiceHTTPProperty2 certificates(List<Long> certificates) {
  ...
  public LoadBalancerServiceHTTPProperty2 addCertificatesItem(Long certificatesItem) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty2 cookieLifetime(Integer cookieLifetime) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty2 cookieName(String cookieName) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty2 redirectHttp(Boolean redirectHttp) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty2 stickySessions(Boolean stickySessions) {
  ...
  **/
   ...
   * @return the LoadBalancerServiceHTTPProperty2 instance itself
   */
  public LoadBalancerServiceHTTPProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerServiceHTTPProperty2 loadBalancerServiceHTTPProperty2 = (LoadBalancerServiceHTTPProperty2) o;
    return Objects.equals(this.certificates, loadBalancerServiceHTTPProperty2.certificates) &&
        Objects.equals(this.cookieLifetime, loadBalancerServiceHTTPProperty2.cookieLifetime) &&
        Objects.equals(this.cookieName, loadBalancerServiceHTTPProperty2.cookieName) &&
        Objects.equals(this.redirectHttp, loadBalancerServiceHTTPProperty2.redirectHttp) &&
        Objects.equals(this.stickySessions, loadBalancerServiceHTTPProperty2.stickySessions)&&
        Objects.equals(this.additionalProperties, loadBalancerServiceHTTPProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerServiceHTTPProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerServiceHTTPProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerServiceHTTPProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerServiceHTTPProperty2 is not found in the empty JSON string", LoadBalancerServiceHTTPProperty2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerServiceHTTPProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerServiceHTTPProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerServiceHTTPProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerServiceHTTPProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerServiceHTTPProperty2>() {
           @Override
           public void write(JsonWriter out, LoadBalancerServiceHTTPProperty2 value) throws IOException {
           ...
           @Override
           public LoadBalancerServiceHTTPProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerServiceHTTPProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerServiceHTTPProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerServiceHTTPProperty2
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerServiceHTTPProperty2
  */
  public static LoadBalancerServiceHTTPProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerServiceHTTPProperty2.class);
  }

 /**
  * Convert an instance of LoadBalancerServiceHTTPProperty2 to an JSON string
  *
  * @return JSON string
  */
