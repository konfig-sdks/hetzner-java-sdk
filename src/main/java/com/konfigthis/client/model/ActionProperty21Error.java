...
public class ActionProperty21Error {
  ...
  public ActionProperty21Error() {
  }

  public ActionProperty21Error code(String code) {
  ...
  **/
  ...
  public ActionProperty21Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty21Error instance itself
   */
  public ActionProperty21Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty21Error actionProperty21Error = (ActionProperty21Error) o;
    return Objects.equals(this.code, actionProperty21Error.code) &&
        Objects.equals(this.message, actionProperty21Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty21Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty21Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty21Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty21Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty21Error is not found in the empty JSON string", ActionProperty21Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty21Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty21Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty21Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty21Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty21Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty21Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty21Error value) throws IOException {
           ...
           @Override
           public ActionProperty21Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty21Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty21Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty21Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty21Error
  */
  public static ActionProperty21Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty21Error.class);
  }

 /**
  * Convert an instance of ActionProperty21Error to an JSON string
  *
  * @return JSON string
  */
