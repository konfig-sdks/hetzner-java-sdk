...
import com.konfigthis.client.model.ListMetaProperty12Pagination;
...
public class ListMetaProperty12 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty12Pagination pagination;

  public ListMetaProperty12() {
  }

  public ListMetaProperty12 pagination(ListMetaProperty12Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty12Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty12Pagination pagination) {
   ...
   * @return the ListMetaProperty12 instance itself
   */
  public ListMetaProperty12 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty12 listMetaProperty12 = (ListMetaProperty12) o;
    return Objects.equals(this.pagination, listMetaProperty12.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty12.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty12 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty12
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty12.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty12 is not found in the empty JSON string", ListMetaProperty12.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty12.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty12Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty12.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty12>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty12 value) throws IOException {
           ...
           @Override
           public ListMetaProperty12 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty12 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty12 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty12
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty12
  */
  public static ListMetaProperty12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty12.class);
  }

 /**
  * Convert an instance of ListMetaProperty12 to an JSON string
  *
  * @return JSON string
  */
