...
import com.konfigthis.client.model.ListMetaProperty6Pagination;
...
public class ListMetaProperty6 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty6Pagination pagination;

  public ListMetaProperty6() {
  }

  public ListMetaProperty6 pagination(ListMetaProperty6Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty6Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty6Pagination pagination) {
   ...
   * @return the ListMetaProperty6 instance itself
   */
  public ListMetaProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty6 listMetaProperty6 = (ListMetaProperty6) o;
    return Objects.equals(this.pagination, listMetaProperty6.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty6 is not found in the empty JSON string", ListMetaProperty6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty6.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty6Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty6>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty6 value) throws IOException {
           ...
           @Override
           public ListMetaProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty6
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty6
  */
  public static ListMetaProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty6.class);
  }

 /**
  * Convert an instance of ListMetaProperty6 to an JSON string
  *
  * @return JSON string
  */
