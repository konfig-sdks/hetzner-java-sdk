...
import com.konfigthis.client.model.ActionProperty66Error;
import com.konfigthis.client.model.ActionProperty66ResourcesInner;
...
public class ActionProperty66 {
  ...
  private ActionProperty66Error error;
  ...
  private List<ActionProperty66ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty66() {
  }

  public ActionProperty66 command(String command) {
  ...
  **/
  ...
  public ActionProperty66 error(ActionProperty66Error error) {
  ...
  **/
  ...
  public ActionProperty66Error getError() {
    return error;
  }


  public void setError(ActionProperty66Error error) {
  ...
  public ActionProperty66 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty66 id(Long id) {
  ...
  **/
  ...
  public ActionProperty66 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty66 resources(List<ActionProperty66ResourcesInner> resources) {
  ...
  public ActionProperty66 addResourcesItem(ActionProperty66ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty66ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty66ResourcesInner> resources) {
  ...
  public ActionProperty66 started(String started) {
  ...
  **/
  ...
  public ActionProperty66 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty66 instance itself
   */
  public ActionProperty66 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty66 actionProperty66 = (ActionProperty66) o;
    return Objects.equals(this.command, actionProperty66.command) &&
        Objects.equals(this.error, actionProperty66.error) &&
        Objects.equals(this.finished, actionProperty66.finished) &&
        Objects.equals(this.id, actionProperty66.id) &&
        Objects.equals(this.progress, actionProperty66.progress) &&
        Objects.equals(this.resources, actionProperty66.resources) &&
        Objects.equals(this.started, actionProperty66.started) &&
        Objects.equals(this.status, actionProperty66.status)&&
        Objects.equals(this.additionalProperties, actionProperty66.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty66 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty66
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty66.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty66 is not found in the empty JSON string", ActionProperty66.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty66.openapiRequiredFields) {
      ...
      ActionProperty66Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty66ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty66.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty66' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty66> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty66.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty66>() {
           @Override
           public void write(JsonWriter out, ActionProperty66 value) throws IOException {
           ...
           @Override
           public ActionProperty66 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty66 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty66 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty66
  * @throws IOException if the JSON string is invalid with respect to ActionProperty66
  */
  public static ActionProperty66 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty66.class);
  }

 /**
  * Convert an instance of ActionProperty66 to an JSON string
  *
  * @return JSON string
  */
