...
import com.konfigthis.client.model.ActionProperty22Error;
import com.konfigthis.client.model.ActionProperty22ResourcesInner;
...
public class ActionProperty22 {
  ...
  private ActionProperty22Error error;
  ...
  private List<ActionProperty22ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty22() {
  }

  public ActionProperty22 command(String command) {
  ...
  **/
  ...
  public ActionProperty22 error(ActionProperty22Error error) {
  ...
  **/
  ...
  public ActionProperty22Error getError() {
    return error;
  }


  public void setError(ActionProperty22Error error) {
  ...
  public ActionProperty22 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty22 id(Long id) {
  ...
  **/
  ...
  public ActionProperty22 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty22 resources(List<ActionProperty22ResourcesInner> resources) {
  ...
  public ActionProperty22 addResourcesItem(ActionProperty22ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty22ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty22ResourcesInner> resources) {
  ...
  public ActionProperty22 started(String started) {
  ...
  **/
  ...
  public ActionProperty22 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty22 instance itself
   */
  public ActionProperty22 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty22 actionProperty22 = (ActionProperty22) o;
    return Objects.equals(this.command, actionProperty22.command) &&
        Objects.equals(this.error, actionProperty22.error) &&
        Objects.equals(this.finished, actionProperty22.finished) &&
        Objects.equals(this.id, actionProperty22.id) &&
        Objects.equals(this.progress, actionProperty22.progress) &&
        Objects.equals(this.resources, actionProperty22.resources) &&
        Objects.equals(this.started, actionProperty22.started) &&
        Objects.equals(this.status, actionProperty22.status)&&
        Objects.equals(this.additionalProperties, actionProperty22.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty22 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty22
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty22.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty22 is not found in the empty JSON string", ActionProperty22.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty22.openapiRequiredFields) {
      ...
      ActionProperty22Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty22ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty22.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty22' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty22> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty22.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty22>() {
           @Override
           public void write(JsonWriter out, ActionProperty22 value) throws IOException {
           ...
           @Override
           public ActionProperty22 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty22 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty22 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty22
  * @throws IOException if the JSON string is invalid with respect to ActionProperty22
  */
  public static ActionProperty22 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty22.class);
  }

 /**
  * Convert an instance of ActionProperty22 to an JSON string
  *
  * @return JSON string
  */
