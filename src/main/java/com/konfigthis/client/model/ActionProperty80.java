...
import com.konfigthis.client.model.ActionProperty80Error;
import com.konfigthis.client.model.ActionProperty80ResourcesInner;
...
public class ActionProperty80 {
  ...
  private ActionProperty80Error error;
  ...
  private List<ActionProperty80ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty80() {
  }

  public ActionProperty80 command(String command) {
  ...
  **/
  ...
  public ActionProperty80 error(ActionProperty80Error error) {
  ...
  **/
  ...
  public ActionProperty80Error getError() {
    return error;
  }


  public void setError(ActionProperty80Error error) {
  ...
  public ActionProperty80 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty80 id(Long id) {
  ...
  **/
  ...
  public ActionProperty80 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty80 resources(List<ActionProperty80ResourcesInner> resources) {
  ...
  public ActionProperty80 addResourcesItem(ActionProperty80ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty80ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty80ResourcesInner> resources) {
  ...
  public ActionProperty80 started(String started) {
  ...
  **/
  ...
  public ActionProperty80 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty80 instance itself
   */
  public ActionProperty80 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty80 actionProperty80 = (ActionProperty80) o;
    return Objects.equals(this.command, actionProperty80.command) &&
        Objects.equals(this.error, actionProperty80.error) &&
        Objects.equals(this.finished, actionProperty80.finished) &&
        Objects.equals(this.id, actionProperty80.id) &&
        Objects.equals(this.progress, actionProperty80.progress) &&
        Objects.equals(this.resources, actionProperty80.resources) &&
        Objects.equals(this.started, actionProperty80.started) &&
        Objects.equals(this.status, actionProperty80.status)&&
        Objects.equals(this.additionalProperties, actionProperty80.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty80 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty80
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty80.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty80 is not found in the empty JSON string", ActionProperty80.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty80.openapiRequiredFields) {
      ...
      ActionProperty80Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty80ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty80.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty80' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty80> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty80.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty80>() {
           @Override
           public void write(JsonWriter out, ActionProperty80 value) throws IOException {
           ...
           @Override
           public ActionProperty80 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty80 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty80 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty80
  * @throws IOException if the JSON string is invalid with respect to ActionProperty80
  */
  public static ActionProperty80 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty80.class);
  }

 /**
  * Convert an instance of ActionProperty80 to an JSON string
  *
  * @return JSON string
  */
