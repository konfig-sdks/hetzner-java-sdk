...
import com.konfigthis.client.model.ActionProperty23;
...
public class LoadBalancerActionsChangeDnsPtrResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty23 action;

  public LoadBalancerActionsChangeDnsPtrResponse() {
  }

  public LoadBalancerActionsChangeDnsPtrResponse action(ActionProperty23 action) {
  ...
  **/
  ...
  public ActionProperty23 getAction() {
    return action;
  }


  public void setAction(ActionProperty23 action) {
   ...
   * @return the LoadBalancerActionsChangeDnsPtrResponse instance itself
   */
  public LoadBalancerActionsChangeDnsPtrResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsChangeDnsPtrResponse loadBalancerActionsChangeDnsPtrResponse = (LoadBalancerActionsChangeDnsPtrResponse) o;
    return Objects.equals(this.action, loadBalancerActionsChangeDnsPtrResponse.action)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsChangeDnsPtrResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsChangeDnsPtrResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsChangeDnsPtrResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsChangeDnsPtrResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsChangeDnsPtrResponse is not found in the empty JSON string", LoadBalancerActionsChangeDnsPtrResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsChangeDnsPtrResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty23.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsChangeDnsPtrResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsChangeDnsPtrResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsChangeDnsPtrResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsChangeDnsPtrResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsChangeDnsPtrResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsChangeDnsPtrResponse value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsChangeDnsPtrResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsChangeDnsPtrResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsChangeDnsPtrResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsChangeDnsPtrResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsChangeDnsPtrResponse
  */
  public static LoadBalancerActionsChangeDnsPtrResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsChangeDnsPtrResponse.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsChangeDnsPtrResponse to an JSON string
  *
  * @return JSON string
  */
