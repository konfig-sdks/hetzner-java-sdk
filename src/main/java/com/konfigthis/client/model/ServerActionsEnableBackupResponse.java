...
import com.konfigthis.client.model.ActionProperty62;
...
public class ServerActionsEnableBackupResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty62 action;

  public ServerActionsEnableBackupResponse() {
  }

  public ServerActionsEnableBackupResponse action(ActionProperty62 action) {
  ...
  **/
  ...
  public ActionProperty62 getAction() {
    return action;
  }


  public void setAction(ActionProperty62 action) {
   ...
   * @return the ServerActionsEnableBackupResponse instance itself
   */
  public ServerActionsEnableBackupResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsEnableBackupResponse serverActionsEnableBackupResponse = (ServerActionsEnableBackupResponse) o;
    return Objects.equals(this.action, serverActionsEnableBackupResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsEnableBackupResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsEnableBackupResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsEnableBackupResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsEnableBackupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsEnableBackupResponse is not found in the empty JSON string", ServerActionsEnableBackupResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsEnableBackupResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty62.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsEnableBackupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsEnableBackupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsEnableBackupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsEnableBackupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsEnableBackupResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsEnableBackupResponse value) throws IOException {
           ...
           @Override
           public ServerActionsEnableBackupResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsEnableBackupResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsEnableBackupResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsEnableBackupResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsEnableBackupResponse
  */
  public static ServerActionsEnableBackupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsEnableBackupResponse.class);
  }

 /**
  * Convert an instance of ServerActionsEnableBackupResponse to an JSON string
  *
  * @return JSON string
  */
