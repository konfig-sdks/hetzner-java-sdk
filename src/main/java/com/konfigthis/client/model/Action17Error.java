...
public class Action17Error {
  ...
  public Action17Error() {
  }

  public Action17Error code(String code) {
  ...
  **/
  ...
  public Action17Error message(String message) {
  ...
  **/
   ...
   * @return the Action17Error instance itself
   */
  public Action17Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action17Error action17Error = (Action17Error) o;
    return Objects.equals(this.code, action17Error.code) &&
        Objects.equals(this.message, action17Error.message)&&
        Objects.equals(this.additionalProperties, action17Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action17Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action17Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action17Error is not found in the empty JSON string", Action17Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action17Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action17Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action17Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action17Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action17Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action17Error>() {
           @Override
           public void write(JsonWriter out, Action17Error value) throws IOException {
           ...
           @Override
           public Action17Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action17Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action17Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action17Error
  * @throws IOException if the JSON string is invalid with respect to Action17Error
  */
  public static Action17Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action17Error.class);
  }

 /**
  * Convert an instance of Action17Error to an JSON string
  *
  * @return JSON string
  */
