...
import com.konfigthis.client.model.ActionProperty41Error;
import com.konfigthis.client.model.ActionProperty41ResourcesInner;
...
public class ActionProperty41 {
  ...
  private ActionProperty41Error error;
  ...
  private List<ActionProperty41ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty41() {
  }

  public ActionProperty41 command(String command) {
  ...
  **/
  ...
  public ActionProperty41 error(ActionProperty41Error error) {
  ...
  **/
  ...
  public ActionProperty41Error getError() {
    return error;
  }


  public void setError(ActionProperty41Error error) {
  ...
  public ActionProperty41 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty41 id(Long id) {
  ...
  **/
  ...
  public ActionProperty41 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty41 resources(List<ActionProperty41ResourcesInner> resources) {
  ...
  public ActionProperty41 addResourcesItem(ActionProperty41ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty41ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty41ResourcesInner> resources) {
  ...
  public ActionProperty41 started(String started) {
  ...
  **/
  ...
  public ActionProperty41 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty41 instance itself
   */
  public ActionProperty41 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty41 actionProperty41 = (ActionProperty41) o;
    return Objects.equals(this.command, actionProperty41.command) &&
        Objects.equals(this.error, actionProperty41.error) &&
        Objects.equals(this.finished, actionProperty41.finished) &&
        Objects.equals(this.id, actionProperty41.id) &&
        Objects.equals(this.progress, actionProperty41.progress) &&
        Objects.equals(this.resources, actionProperty41.resources) &&
        Objects.equals(this.started, actionProperty41.started) &&
        Objects.equals(this.status, actionProperty41.status)&&
        Objects.equals(this.additionalProperties, actionProperty41.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty41 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty41
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty41.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty41 is not found in the empty JSON string", ActionProperty41.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty41.openapiRequiredFields) {
      ...
      ActionProperty41Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty41ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty41.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty41' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty41> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty41.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty41>() {
           @Override
           public void write(JsonWriter out, ActionProperty41 value) throws IOException {
           ...
           @Override
           public ActionProperty41 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty41 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty41 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty41
  * @throws IOException if the JSON string is invalid with respect to ActionProperty41
  */
  public static ActionProperty41 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty41.class);
  }

 /**
  * Convert an instance of ActionProperty41 to an JSON string
  *
  * @return JSON string
  */
