...
import com.konfigthis.client.model.ListMetaProperty19Pagination;
...
public class ListMetaProperty19 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty19Pagination pagination;

  public ListMetaProperty19() {
  }

  public ListMetaProperty19 pagination(ListMetaProperty19Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty19Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty19Pagination pagination) {
   ...
   * @return the ListMetaProperty19 instance itself
   */
  public ListMetaProperty19 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty19 listMetaProperty19 = (ListMetaProperty19) o;
    return Objects.equals(this.pagination, listMetaProperty19.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty19.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty19 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty19
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty19.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty19 is not found in the empty JSON string", ListMetaProperty19.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty19.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty19Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty19.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty19' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty19> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty19.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty19>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty19 value) throws IOException {
           ...
           @Override
           public ListMetaProperty19 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty19 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty19 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty19
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty19
  */
  public static ListMetaProperty19 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty19.class);
  }

 /**
  * Convert an instance of ListMetaProperty19 to an JSON string
  *
  * @return JSON string
  */
