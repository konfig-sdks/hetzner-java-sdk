...
public class ListMetaProperty18Pagination {
  ...
  public ListMetaProperty18Pagination() {
  }

  public ListMetaProperty18Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty18Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty18Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty18Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty18Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty18Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty18Pagination instance itself
   */
  public ListMetaProperty18Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty18Pagination listMetaProperty18Pagination = (ListMetaProperty18Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty18Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty18Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty18Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty18Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty18Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty18Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty18Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty18Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty18Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty18Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty18Pagination is not found in the empty JSON string", ListMetaProperty18Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty18Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty18Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty18Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty18Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty18Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty18Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty18Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty18Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty18Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty18Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty18Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty18Pagination
  */
  public static ListMetaProperty18Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty18Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty18Pagination to an JSON string
  *
  * @return JSON string
  */
