...
import com.konfigthis.client.model.ActionProperty55;
...
public class ServerActionsChangeProtectionResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty55 action;

  public ServerActionsChangeProtectionResponse() {
  }

  public ServerActionsChangeProtectionResponse action(ActionProperty55 action) {
  ...
  **/
  ...
  public ActionProperty55 getAction() {
    return action;
  }


  public void setAction(ActionProperty55 action) {
   ...
   * @return the ServerActionsChangeProtectionResponse instance itself
   */
  public ServerActionsChangeProtectionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsChangeProtectionResponse serverActionsChangeProtectionResponse = (ServerActionsChangeProtectionResponse) o;
    return Objects.equals(this.action, serverActionsChangeProtectionResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsChangeProtectionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsChangeProtectionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsChangeProtectionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsChangeProtectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsChangeProtectionResponse is not found in the empty JSON string", ServerActionsChangeProtectionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsChangeProtectionResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty55.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsChangeProtectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsChangeProtectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsChangeProtectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsChangeProtectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsChangeProtectionResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsChangeProtectionResponse value) throws IOException {
           ...
           @Override
           public ServerActionsChangeProtectionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsChangeProtectionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsChangeProtectionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsChangeProtectionResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsChangeProtectionResponse
  */
  public static ServerActionsChangeProtectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsChangeProtectionResponse.class);
  }

 /**
  * Convert an instance of ServerActionsChangeProtectionResponse to an JSON string
  *
  * @return JSON string
  */
