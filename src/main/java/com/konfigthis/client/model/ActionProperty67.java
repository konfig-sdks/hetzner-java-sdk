...
import com.konfigthis.client.model.ActionProperty67Error;
import com.konfigthis.client.model.ActionProperty67ResourcesInner;
...
public class ActionProperty67 {
  ...
  private ActionProperty67Error error;
  ...
  private List<ActionProperty67ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty67() {
  }

  public ActionProperty67 command(String command) {
  ...
  **/
  ...
  public ActionProperty67 error(ActionProperty67Error error) {
  ...
  **/
  ...
  public ActionProperty67Error getError() {
    return error;
  }


  public void setError(ActionProperty67Error error) {
  ...
  public ActionProperty67 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty67 id(Long id) {
  ...
  **/
  ...
  public ActionProperty67 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty67 resources(List<ActionProperty67ResourcesInner> resources) {
  ...
  public ActionProperty67 addResourcesItem(ActionProperty67ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty67ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty67ResourcesInner> resources) {
  ...
  public ActionProperty67 started(String started) {
  ...
  **/
  ...
  public ActionProperty67 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty67 instance itself
   */
  public ActionProperty67 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty67 actionProperty67 = (ActionProperty67) o;
    return Objects.equals(this.command, actionProperty67.command) &&
        Objects.equals(this.error, actionProperty67.error) &&
        Objects.equals(this.finished, actionProperty67.finished) &&
        Objects.equals(this.id, actionProperty67.id) &&
        Objects.equals(this.progress, actionProperty67.progress) &&
        Objects.equals(this.resources, actionProperty67.resources) &&
        Objects.equals(this.started, actionProperty67.started) &&
        Objects.equals(this.status, actionProperty67.status)&&
        Objects.equals(this.additionalProperties, actionProperty67.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty67 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty67
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty67.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty67 is not found in the empty JSON string", ActionProperty67.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty67.openapiRequiredFields) {
      ...
      ActionProperty67Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty67ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty67.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty67' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty67> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty67.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty67>() {
           @Override
           public void write(JsonWriter out, ActionProperty67 value) throws IOException {
           ...
           @Override
           public ActionProperty67 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty67 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty67 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty67
  * @throws IOException if the JSON string is invalid with respect to ActionProperty67
  */
  public static ActionProperty67 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty67.class);
  }

 /**
  * Convert an instance of ActionProperty67 to an JSON string
  *
  * @return JSON string
  */
