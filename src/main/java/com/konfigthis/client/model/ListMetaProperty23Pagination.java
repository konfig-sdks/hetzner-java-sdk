...
public class ListMetaProperty23Pagination {
  ...
  public ListMetaProperty23Pagination() {
  }

  public ListMetaProperty23Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty23Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty23Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty23Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty23Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty23Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty23Pagination instance itself
   */
  public ListMetaProperty23Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty23Pagination listMetaProperty23Pagination = (ListMetaProperty23Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty23Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty23Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty23Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty23Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty23Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty23Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty23Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty23Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty23Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty23Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty23Pagination is not found in the empty JSON string", ListMetaProperty23Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty23Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty23Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty23Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty23Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty23Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty23Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty23Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty23Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty23Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty23Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty23Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty23Pagination
  */
  public static ListMetaProperty23Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty23Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty23Pagination to an JSON string
  *
  * @return JSON string
  */
