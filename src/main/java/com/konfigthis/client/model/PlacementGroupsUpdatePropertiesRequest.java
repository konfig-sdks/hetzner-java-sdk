...
public class PlacementGroupsUpdatePropertiesRequest {
  ...
  public PlacementGroupsUpdatePropertiesRequest() {
  }

  public PlacementGroupsUpdatePropertiesRequest labels(Object labels) {
  ...
  **/
  ...
  public PlacementGroupsUpdatePropertiesRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "my Placement Group", value = "New PlacementGroup name")
   ...
   * @return the PlacementGroupsUpdatePropertiesRequest instance itself
   */
  public PlacementGroupsUpdatePropertiesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PlacementGroupsUpdatePropertiesRequest placementGroupsUpdatePropertiesRequest = (PlacementGroupsUpdatePropertiesRequest) o;
    return Objects.equals(this.labels, placementGroupsUpdatePropertiesRequest.labels) &&
        Objects.equals(this.name, placementGroupsUpdatePropertiesRequest.name)&&
        Objects.equals(this.additionalProperties, placementGroupsUpdatePropertiesRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlacementGroupsUpdatePropertiesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PlacementGroupsUpdatePropertiesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PlacementGroupsUpdatePropertiesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlacementGroupsUpdatePropertiesRequest is not found in the empty JSON string", PlacementGroupsUpdatePropertiesRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlacementGroupsUpdatePropertiesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlacementGroupsUpdatePropertiesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlacementGroupsUpdatePropertiesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlacementGroupsUpdatePropertiesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PlacementGroupsUpdatePropertiesRequest>() {
           @Override
           public void write(JsonWriter out, PlacementGroupsUpdatePropertiesRequest value) throws IOException {
           ...
           @Override
           public PlacementGroupsUpdatePropertiesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PlacementGroupsUpdatePropertiesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PlacementGroupsUpdatePropertiesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PlacementGroupsUpdatePropertiesRequest
  * @throws IOException if the JSON string is invalid with respect to PlacementGroupsUpdatePropertiesRequest
  */
  public static PlacementGroupsUpdatePropertiesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlacementGroupsUpdatePropertiesRequest.class);
  }

 /**
  * Convert an instance of PlacementGroupsUpdatePropertiesRequest to an JSON string
  *
  * @return JSON string
  */
