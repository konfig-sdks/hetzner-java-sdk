...
public class PricesPriceMonthly {
  ...
  public PricesPriceMonthly() {
  }

  public PricesPriceMonthly gross(BigDecimal gross) {
  ...
  **/
  ...
  public PricesPriceMonthly net(BigDecimal net) {
  ...
  **/
   ...
   * @return the PricesPriceMonthly instance itself
   */
  public PricesPriceMonthly putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PricesPriceMonthly pricesPriceMonthly = (PricesPriceMonthly) o;
    return Objects.equals(this.gross, pricesPriceMonthly.gross) &&
        Objects.equals(this.net, pricesPriceMonthly.net)&&
        Objects.equals(this.additionalProperties, pricesPriceMonthly.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricesPriceMonthly {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PricesPriceMonthly
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PricesPriceMonthly.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricesPriceMonthly is not found in the empty JSON string", PricesPriceMonthly.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PricesPriceMonthly.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PricesPriceMonthly.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PricesPriceMonthly' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PricesPriceMonthly> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PricesPriceMonthly.class));

       return (TypeAdapter<T>) new TypeAdapter<PricesPriceMonthly>() {
           @Override
           public void write(JsonWriter out, PricesPriceMonthly value) throws IOException {
           ...
           @Override
           public PricesPriceMonthly read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PricesPriceMonthly instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PricesPriceMonthly given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PricesPriceMonthly
  * @throws IOException if the JSON string is invalid with respect to PricesPriceMonthly
  */
  public static PricesPriceMonthly fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PricesPriceMonthly.class);
  }

 /**
  * Convert an instance of PricesPriceMonthly to an JSON string
  *
  * @return JSON string
  */
