...
import com.konfigthis.client.model.Action5Error;
import com.konfigthis.client.model.Action5ResourcesInner;
...
public class Action5 {
  ...
  private List<Action5ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action5 command(String command) {
  ...
  **/
  ...
  public Action5 error(Action5Error error) {
  ...
  **/
  ...
  public Action5Error getError() {
    return error;
  }


  public void setError(Action5Error error) {
  ...
  public Action5 finished(String finished) {
  ...
  **/
  ...
  public Action5 progress(Integer progress) {
  ...
  **/
  ...
  public Action5 resources(List<Action5ResourcesInner> resources) {
  ...
  public Action5 addResourcesItem(Action5ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action5ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action5ResourcesInner> resources) {
  ...
  public Action5 started(String started) {
  ...
  **/
  ...
  public Action5 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action5 instance itself
   */
  public Action5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action5 action5 = (Action5) o;
    return Objects.equals(this.command, action5.command) &&
        Objects.equals(this.error, action5.error) &&
        Objects.equals(this.finished, action5.finished) &&
        Objects.equals(this.id, action5.id) &&
        Objects.equals(this.progress, action5.progress) &&
        Objects.equals(this.resources, action5.resources) &&
        Objects.equals(this.started, action5.started) &&
        Objects.equals(this.status, action5.status)&&
        Objects.equals(this.additionalProperties, action5.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action5 is not found in the empty JSON string", Action5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action5.openapiRequiredFields) {
      ...
      Action5Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action5ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action5.class));

       return (TypeAdapter<T>) new TypeAdapter<Action5>() {
           @Override
           public void write(JsonWriter out, Action5 value) throws IOException {
           ...
           @Override
           public Action5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action5
  * @throws IOException if the JSON string is invalid with respect to Action5
  */
  public static Action5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action5.class);
  }

 /**
  * Convert an instance of Action5 to an JSON string
  *
  * @return JSON string
  */
