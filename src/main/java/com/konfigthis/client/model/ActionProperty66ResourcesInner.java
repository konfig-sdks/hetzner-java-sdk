...
/**
 * ActionProperty66ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty66ResourcesInner {
  ...
  public ActionProperty66ResourcesInner() {
  }

  public ActionProperty66ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty66ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty66ResourcesInner instance itself
   */
  public ActionProperty66ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty66ResourcesInner actionProperty66ResourcesInner = (ActionProperty66ResourcesInner) o;
    return Objects.equals(this.id, actionProperty66ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty66ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty66ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty66ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty66ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty66ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty66ResourcesInner is not found in the empty JSON string", ActionProperty66ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty66ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty66ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty66ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty66ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty66ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty66ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty66ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty66ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty66ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty66ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty66ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty66ResourcesInner
  */
  public static ActionProperty66ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty66ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty66ResourcesInner to an JSON string
  *
  * @return JSON string
  */
