...
public class DeprecationInfoProperty1 {
  ...
  public DeprecationInfoProperty1() {
  }

  public DeprecationInfoProperty1 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty1 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty1 instance itself
   */
  public DeprecationInfoProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty1 deprecationInfoProperty1 = (DeprecationInfoProperty1) o;
    return Objects.equals(this.announced, deprecationInfoProperty1.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty1.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty1 is not found in the empty JSON string", DeprecationInfoProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty1>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty1 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty1
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty1
  */
  public static DeprecationInfoProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty1.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty1 to an JSON string
  *
  * @return JSON string
  */
