...
import com.konfigthis.client.model.ListMetaProperty24Pagination;
...
public class ListMetaProperty24 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty24Pagination pagination;

  public ListMetaProperty24() {
  }

  public ListMetaProperty24 pagination(ListMetaProperty24Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty24Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty24Pagination pagination) {
   ...
   * @return the ListMetaProperty24 instance itself
   */
  public ListMetaProperty24 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty24 listMetaProperty24 = (ListMetaProperty24) o;
    return Objects.equals(this.pagination, listMetaProperty24.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty24.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty24 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty24
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty24.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty24 is not found in the empty JSON string", ListMetaProperty24.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty24.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty24Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty24.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty24' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty24> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty24.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty24>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty24 value) throws IOException {
           ...
           @Override
           public ListMetaProperty24 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty24 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty24 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty24
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty24
  */
  public static ListMetaProperty24 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty24.class);
  }

 /**
  * Convert an instance of ListMetaProperty24 to an JSON string
  *
  * @return JSON string
  */
