...
import com.konfigthis.client.model.ActionProperty37Error;
import com.konfigthis.client.model.ActionProperty37ResourcesInner;
...
public class ActionProperty37 {
  ...
  private ActionProperty37Error error;
  ...
  private List<ActionProperty37ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty37() {
  }

  public ActionProperty37 command(String command) {
  ...
  **/
  ...
  public ActionProperty37 error(ActionProperty37Error error) {
  ...
  **/
  ...
  public ActionProperty37Error getError() {
    return error;
  }


  public void setError(ActionProperty37Error error) {
  ...
  public ActionProperty37 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty37 id(Long id) {
  ...
  **/
  ...
  public ActionProperty37 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty37 resources(List<ActionProperty37ResourcesInner> resources) {
  ...
  public ActionProperty37 addResourcesItem(ActionProperty37ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty37ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty37ResourcesInner> resources) {
  ...
  public ActionProperty37 started(String started) {
  ...
  **/
  ...
  public ActionProperty37 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty37 instance itself
   */
  public ActionProperty37 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty37 actionProperty37 = (ActionProperty37) o;
    return Objects.equals(this.command, actionProperty37.command) &&
        Objects.equals(this.error, actionProperty37.error) &&
        Objects.equals(this.finished, actionProperty37.finished) &&
        Objects.equals(this.id, actionProperty37.id) &&
        Objects.equals(this.progress, actionProperty37.progress) &&
        Objects.equals(this.resources, actionProperty37.resources) &&
        Objects.equals(this.started, actionProperty37.started) &&
        Objects.equals(this.status, actionProperty37.status)&&
        Objects.equals(this.additionalProperties, actionProperty37.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty37 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty37
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty37.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty37 is not found in the empty JSON string", ActionProperty37.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty37.openapiRequiredFields) {
      ...
      ActionProperty37Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty37ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty37.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty37' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty37> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty37.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty37>() {
           @Override
           public void write(JsonWriter out, ActionProperty37 value) throws IOException {
           ...
           @Override
           public ActionProperty37 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty37 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty37 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty37
  * @throws IOException if the JSON string is invalid with respect to ActionProperty37
  */
  public static ActionProperty37 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty37.class);
  }

 /**
  * Convert an instance of ActionProperty37 to an JSON string
  *
  * @return JSON string
  */
