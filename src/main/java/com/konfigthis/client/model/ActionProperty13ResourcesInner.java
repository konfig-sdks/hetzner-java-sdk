...
/**
 * ActionProperty13ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty13ResourcesInner {
  ...
  public ActionProperty13ResourcesInner() {
  }

  public ActionProperty13ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty13ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty13ResourcesInner instance itself
   */
  public ActionProperty13ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty13ResourcesInner actionProperty13ResourcesInner = (ActionProperty13ResourcesInner) o;
    return Objects.equals(this.id, actionProperty13ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty13ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty13ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty13ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty13ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty13ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty13ResourcesInner is not found in the empty JSON string", ActionProperty13ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty13ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty13ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty13ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty13ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty13ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty13ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty13ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty13ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty13ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty13ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty13ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty13ResourcesInner
  */
  public static ActionProperty13ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty13ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty13ResourcesInner to an JSON string
  *
  * @return JSON string
  */
