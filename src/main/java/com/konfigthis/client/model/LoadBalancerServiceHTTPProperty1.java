...
public class LoadBalancerServiceHTTPProperty1 {
  ...
  public LoadBalancerServiceHTTPProperty1() {
  }

  public LoadBalancerServiceHTTPProperty1 certificates(List<Long> certificates) {
  ...
  public LoadBalancerServiceHTTPProperty1 addCertificatesItem(Long certificatesItem) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty1 cookieLifetime(Integer cookieLifetime) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty1 cookieName(String cookieName) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty1 redirectHttp(Boolean redirectHttp) {
  ...
  **/
  ...
  public LoadBalancerServiceHTTPProperty1 stickySessions(Boolean stickySessions) {
  ...
  **/
   ...
   * @return the LoadBalancerServiceHTTPProperty1 instance itself
   */
  public LoadBalancerServiceHTTPProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerServiceHTTPProperty1 loadBalancerServiceHTTPProperty1 = (LoadBalancerServiceHTTPProperty1) o;
    return Objects.equals(this.certificates, loadBalancerServiceHTTPProperty1.certificates) &&
        Objects.equals(this.cookieLifetime, loadBalancerServiceHTTPProperty1.cookieLifetime) &&
        Objects.equals(this.cookieName, loadBalancerServiceHTTPProperty1.cookieName) &&
        Objects.equals(this.redirectHttp, loadBalancerServiceHTTPProperty1.redirectHttp) &&
        Objects.equals(this.stickySessions, loadBalancerServiceHTTPProperty1.stickySessions)&&
        Objects.equals(this.additionalProperties, loadBalancerServiceHTTPProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerServiceHTTPProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerServiceHTTPProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerServiceHTTPProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerServiceHTTPProperty1 is not found in the empty JSON string", LoadBalancerServiceHTTPProperty1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerServiceHTTPProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerServiceHTTPProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerServiceHTTPProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerServiceHTTPProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerServiceHTTPProperty1>() {
           @Override
           public void write(JsonWriter out, LoadBalancerServiceHTTPProperty1 value) throws IOException {
           ...
           @Override
           public LoadBalancerServiceHTTPProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerServiceHTTPProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerServiceHTTPProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerServiceHTTPProperty1
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerServiceHTTPProperty1
  */
  public static LoadBalancerServiceHTTPProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerServiceHTTPProperty1.class);
  }

 /**
  * Convert an instance of LoadBalancerServiceHTTPProperty1 to an JSON string
  *
  * @return JSON string
  */
