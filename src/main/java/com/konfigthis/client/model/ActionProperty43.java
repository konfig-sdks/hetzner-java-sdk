...
import com.konfigthis.client.model.ActionProperty43Error;
import com.konfigthis.client.model.ActionProperty43ResourcesInner;
...
public class ActionProperty43 {
  ...
  private ActionProperty43Error error;
  ...
  private List<ActionProperty43ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty43() {
  }

  public ActionProperty43 command(String command) {
  ...
  **/
  ...
  public ActionProperty43 error(ActionProperty43Error error) {
  ...
  **/
  ...
  public ActionProperty43Error getError() {
    return error;
  }


  public void setError(ActionProperty43Error error) {
  ...
  public ActionProperty43 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty43 id(Long id) {
  ...
  **/
  ...
  public ActionProperty43 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty43 resources(List<ActionProperty43ResourcesInner> resources) {
  ...
  public ActionProperty43 addResourcesItem(ActionProperty43ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty43ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty43ResourcesInner> resources) {
  ...
  public ActionProperty43 started(String started) {
  ...
  **/
  ...
  public ActionProperty43 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty43 instance itself
   */
  public ActionProperty43 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty43 actionProperty43 = (ActionProperty43) o;
    return Objects.equals(this.command, actionProperty43.command) &&
        Objects.equals(this.error, actionProperty43.error) &&
        Objects.equals(this.finished, actionProperty43.finished) &&
        Objects.equals(this.id, actionProperty43.id) &&
        Objects.equals(this.progress, actionProperty43.progress) &&
        Objects.equals(this.resources, actionProperty43.resources) &&
        Objects.equals(this.started, actionProperty43.started) &&
        Objects.equals(this.status, actionProperty43.status)&&
        Objects.equals(this.additionalProperties, actionProperty43.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty43 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty43
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty43.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty43 is not found in the empty JSON string", ActionProperty43.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty43.openapiRequiredFields) {
      ...
      ActionProperty43Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty43ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty43.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty43' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty43> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty43.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty43>() {
           @Override
           public void write(JsonWriter out, ActionProperty43 value) throws IOException {
           ...
           @Override
           public ActionProperty43 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty43 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty43 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty43
  * @throws IOException if the JSON string is invalid with respect to ActionProperty43
  */
  public static ActionProperty43 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty43.class);
  }

 /**
  * Convert an instance of ActionProperty43 to an JSON string
  *
  * @return JSON string
  */
