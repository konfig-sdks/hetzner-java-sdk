...
/**
 * ActionProperty2ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty2ResourcesInner {
  ...
  public ActionProperty2ResourcesInner() {
  }

  public ActionProperty2ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty2ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty2ResourcesInner instance itself
   */
  public ActionProperty2ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty2ResourcesInner actionProperty2ResourcesInner = (ActionProperty2ResourcesInner) o;
    return Objects.equals(this.id, actionProperty2ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty2ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty2ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty2ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty2ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty2ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty2ResourcesInner is not found in the empty JSON string", ActionProperty2ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty2ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty2ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty2ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty2ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty2ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty2ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty2ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty2ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty2ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty2ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty2ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty2ResourcesInner
  */
  public static ActionProperty2ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty2ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty2ResourcesInner to an JSON string
  *
  * @return JSON string
  */
