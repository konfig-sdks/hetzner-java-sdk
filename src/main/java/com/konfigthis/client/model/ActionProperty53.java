...
import com.konfigthis.client.model.ActionProperty53Error;
import com.konfigthis.client.model.ActionProperty53ResourcesInner;
...
public class ActionProperty53 {
  ...
  private ActionProperty53Error error;
  ...
  private List<ActionProperty53ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty53() {
  }

  public ActionProperty53 command(String command) {
  ...
  **/
  ...
  public ActionProperty53 error(ActionProperty53Error error) {
  ...
  **/
  ...
  public ActionProperty53Error getError() {
    return error;
  }


  public void setError(ActionProperty53Error error) {
  ...
  public ActionProperty53 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty53 id(Long id) {
  ...
  **/
  ...
  public ActionProperty53 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty53 resources(List<ActionProperty53ResourcesInner> resources) {
  ...
  public ActionProperty53 addResourcesItem(ActionProperty53ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty53ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty53ResourcesInner> resources) {
  ...
  public ActionProperty53 started(String started) {
  ...
  **/
  ...
  public ActionProperty53 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty53 instance itself
   */
  public ActionProperty53 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty53 actionProperty53 = (ActionProperty53) o;
    return Objects.equals(this.command, actionProperty53.command) &&
        Objects.equals(this.error, actionProperty53.error) &&
        Objects.equals(this.finished, actionProperty53.finished) &&
        Objects.equals(this.id, actionProperty53.id) &&
        Objects.equals(this.progress, actionProperty53.progress) &&
        Objects.equals(this.resources, actionProperty53.resources) &&
        Objects.equals(this.started, actionProperty53.started) &&
        Objects.equals(this.status, actionProperty53.status)&&
        Objects.equals(this.additionalProperties, actionProperty53.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty53 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty53
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty53.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty53 is not found in the empty JSON string", ActionProperty53.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty53.openapiRequiredFields) {
      ...
      ActionProperty53Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty53ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty53.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty53' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty53> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty53.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty53>() {
           @Override
           public void write(JsonWriter out, ActionProperty53 value) throws IOException {
           ...
           @Override
           public ActionProperty53 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty53 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty53 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty53
  * @throws IOException if the JSON string is invalid with respect to ActionProperty53
  */
  public static ActionProperty53 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty53.class);
  }

 /**
  * Convert an instance of ActionProperty53 to an JSON string
  *
  * @return JSON string
  */
