...
public class ImagesGetByIdResponseImageProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public ImagesGetByIdResponseImageProtection() {
  }

  public ImagesGetByIdResponseImageProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the ImagesGetByIdResponseImageProtection instance itself
   */
  public ImagesGetByIdResponseImageProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImagesGetByIdResponseImageProtection imagesGetByIdResponseImageProtection = (ImagesGetByIdResponseImageProtection) o;
    return Objects.equals(this.delete, imagesGetByIdResponseImageProtection.delete)&&
        Objects.equals(this.additionalProperties, imagesGetByIdResponseImageProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesGetByIdResponseImageProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesGetByIdResponseImageProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesGetByIdResponseImageProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGetByIdResponseImageProtection is not found in the empty JSON string", ImagesGetByIdResponseImageProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesGetByIdResponseImageProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGetByIdResponseImageProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGetByIdResponseImageProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGetByIdResponseImageProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGetByIdResponseImageProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGetByIdResponseImageProtection>() {
           @Override
           public void write(JsonWriter out, ImagesGetByIdResponseImageProtection value) throws IOException {
           ...
           @Override
           public ImagesGetByIdResponseImageProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesGetByIdResponseImageProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesGetByIdResponseImageProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesGetByIdResponseImageProtection
  * @throws IOException if the JSON string is invalid with respect to ImagesGetByIdResponseImageProtection
  */
  public static ImagesGetByIdResponseImageProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGetByIdResponseImageProtection.class);
  }

 /**
  * Convert an instance of ImagesGetByIdResponseImageProtection to an JSON string
  *
  * @return JSON string
  */
