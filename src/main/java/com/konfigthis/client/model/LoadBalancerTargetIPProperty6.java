...
public class LoadBalancerTargetIPProperty6 {
  public static final String SERIALIZED_NAME_IP = "ip";
  @SerializedName(SERIALIZED_NAME_IP)
  private String ip;

  public LoadBalancerTargetIPProperty6() {
  }

  public LoadBalancerTargetIPProperty6 ip(String ip) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetIPProperty6 instance itself
   */
  public LoadBalancerTargetIPProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetIPProperty6 loadBalancerTargetIPProperty6 = (LoadBalancerTargetIPProperty6) o;
    return Objects.equals(this.ip, loadBalancerTargetIPProperty6.ip)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetIPProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetIPProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetIPProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetIPProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetIPProperty6 is not found in the empty JSON string", LoadBalancerTargetIPProperty6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetIPProperty6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetIPProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetIPProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetIPProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetIPProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetIPProperty6>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetIPProperty6 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetIPProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetIPProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetIPProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetIPProperty6
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetIPProperty6
  */
  public static LoadBalancerTargetIPProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetIPProperty6.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetIPProperty6 to an JSON string
  *
  * @return JSON string
  */
