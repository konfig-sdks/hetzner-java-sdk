...
public class ListMetaProperty3Pagination {
  ...
  public ListMetaProperty3Pagination() {
  }

  public ListMetaProperty3Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty3Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty3Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty3Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty3Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty3Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty3Pagination instance itself
   */
  public ListMetaProperty3Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty3Pagination listMetaProperty3Pagination = (ListMetaProperty3Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty3Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty3Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty3Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty3Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty3Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty3Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty3Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty3Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty3Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty3Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty3Pagination is not found in the empty JSON string", ListMetaProperty3Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty3Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty3Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty3Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty3Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty3Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty3Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty3Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty3Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty3Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty3Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty3Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty3Pagination
  */
  public static ListMetaProperty3Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty3Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty3Pagination to an JSON string
  *
  * @return JSON string
  */
