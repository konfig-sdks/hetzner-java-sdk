...
public class Action4Error {
  ...
  public Action4Error code(String code) {
  ...
  **/
  ...
  public Action4Error message(String message) {
  ...
  **/
   ...
   * @return the Action4Error instance itself
   */
  public Action4Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action4Error action4Error = (Action4Error) o;
    return Objects.equals(this.code, action4Error.code) &&
        Objects.equals(this.message, action4Error.message)&&
        Objects.equals(this.additionalProperties, action4Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action4Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action4Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action4Error is not found in the empty JSON string", Action4Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action4Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action4Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action4Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action4Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action4Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action4Error>() {
           @Override
           public void write(JsonWriter out, Action4Error value) throws IOException {
           ...
           @Override
           public Action4Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action4Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action4Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action4Error
  * @throws IOException if the JSON string is invalid with respect to Action4Error
  */
  public static Action4Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action4Error.class);
  }

 /**
  * Convert an instance of Action4Error to an JSON string
  *
  * @return JSON string
  */
