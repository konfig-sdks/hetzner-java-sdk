...
/**
 * ActionProperty76ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty76ResourcesInner {
  ...
  public ActionProperty76ResourcesInner() {
  }

  public ActionProperty76ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty76ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty76ResourcesInner instance itself
   */
  public ActionProperty76ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty76ResourcesInner actionProperty76ResourcesInner = (ActionProperty76ResourcesInner) o;
    return Objects.equals(this.id, actionProperty76ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty76ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty76ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty76ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty76ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty76ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty76ResourcesInner is not found in the empty JSON string", ActionProperty76ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty76ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty76ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty76ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty76ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty76ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty76ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty76ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty76ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty76ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty76ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty76ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty76ResourcesInner
  */
  public static ActionProperty76ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty76ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty76ResourcesInner to an JSON string
  *
  * @return JSON string
  */
