...
import com.konfigthis.client.model.ActionProperty73;
...
public class ServerActionsGetActionById200Response {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty73 action;

  public ServerActionsGetActionById200Response() {
  }

  public ServerActionsGetActionById200Response action(ActionProperty73 action) {
  ...
  **/
  ...
  public ActionProperty73 getAction() {
    return action;
  }


  public void setAction(ActionProperty73 action) {
   ...
   * @return the ServerActionsGetActionById200Response instance itself
   */
  public ServerActionsGetActionById200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsGetActionById200Response serverActionsGetActionById200Response = (ServerActionsGetActionById200Response) o;
    return Objects.equals(this.action, serverActionsGetActionById200Response.action)&&
        Objects.equals(this.additionalProperties, serverActionsGetActionById200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsGetActionById200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsGetActionById200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsGetActionById200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsGetActionById200Response is not found in the empty JSON string", ServerActionsGetActionById200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsGetActionById200Response.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty73.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsGetActionById200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsGetActionById200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsGetActionById200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsGetActionById200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsGetActionById200Response>() {
           @Override
           public void write(JsonWriter out, ServerActionsGetActionById200Response value) throws IOException {
           ...
           @Override
           public ServerActionsGetActionById200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsGetActionById200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsGetActionById200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsGetActionById200Response
  * @throws IOException if the JSON string is invalid with respect to ServerActionsGetActionById200Response
  */
  public static ServerActionsGetActionById200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsGetActionById200Response.class);
  }

 /**
  * Convert an instance of ServerActionsGetActionById200Response to an JSON string
  *
  * @return JSON string
  */
