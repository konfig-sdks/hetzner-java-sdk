...
import com.konfigthis.client.model.ActionProperty56;
...
public class ServerActionsChangeServerTypeResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty56 action;

  public ServerActionsChangeServerTypeResponse() {
  }

  public ServerActionsChangeServerTypeResponse action(ActionProperty56 action) {
  ...
  **/
  ...
  public ActionProperty56 getAction() {
    return action;
  }


  public void setAction(ActionProperty56 action) {
   ...
   * @return the ServerActionsChangeServerTypeResponse instance itself
   */
  public ServerActionsChangeServerTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsChangeServerTypeResponse serverActionsChangeServerTypeResponse = (ServerActionsChangeServerTypeResponse) o;
    return Objects.equals(this.action, serverActionsChangeServerTypeResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsChangeServerTypeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsChangeServerTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsChangeServerTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsChangeServerTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsChangeServerTypeResponse is not found in the empty JSON string", ServerActionsChangeServerTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsChangeServerTypeResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty56.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsChangeServerTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsChangeServerTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsChangeServerTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsChangeServerTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsChangeServerTypeResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsChangeServerTypeResponse value) throws IOException {
           ...
           @Override
           public ServerActionsChangeServerTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsChangeServerTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsChangeServerTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsChangeServerTypeResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsChangeServerTypeResponse
  */
  public static ServerActionsChangeServerTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsChangeServerTypeResponse.class);
  }

 /**
  * Convert an instance of ServerActionsChangeServerTypeResponse to an JSON string
  *
  * @return JSON string
  */
