...
public class ListMetaProperty26Pagination {
  ...
  public ListMetaProperty26Pagination() {
  }

  public ListMetaProperty26Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty26Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty26Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty26Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty26Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty26Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty26Pagination instance itself
   */
  public ListMetaProperty26Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty26Pagination listMetaProperty26Pagination = (ListMetaProperty26Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty26Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty26Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty26Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty26Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty26Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty26Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty26Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty26Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty26Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty26Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty26Pagination is not found in the empty JSON string", ListMetaProperty26Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty26Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty26Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty26Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty26Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty26Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty26Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty26Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty26Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty26Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty26Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty26Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty26Pagination
  */
  public static ListMetaProperty26Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty26Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty26Pagination to an JSON string
  *
  * @return JSON string
  */
