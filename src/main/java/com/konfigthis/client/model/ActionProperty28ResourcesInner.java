...
/**
 * ActionProperty28ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty28ResourcesInner {
  ...
  public ActionProperty28ResourcesInner() {
  }

  public ActionProperty28ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty28ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty28ResourcesInner instance itself
   */
  public ActionProperty28ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty28ResourcesInner actionProperty28ResourcesInner = (ActionProperty28ResourcesInner) o;
    return Objects.equals(this.id, actionProperty28ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty28ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty28ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty28ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty28ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty28ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty28ResourcesInner is not found in the empty JSON string", ActionProperty28ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty28ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty28ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty28ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty28ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty28ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty28ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty28ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty28ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty28ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty28ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty28ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty28ResourcesInner
  */
  public static ActionProperty28ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty28ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty28ResourcesInner to an JSON string
  *
  * @return JSON string
  */
