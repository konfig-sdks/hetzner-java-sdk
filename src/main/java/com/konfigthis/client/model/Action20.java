...
import com.konfigthis.client.model.Action20Error;
import com.konfigthis.client.model.Action20ResourcesInner;
...
public class Action20 {
  ...
  private List<Action20ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action20 command(String command) {
  ...
  **/
  ...
  public Action20 error(Action20Error error) {
  ...
  **/
  ...
  public Action20Error getError() {
    return error;
  }


  public void setError(Action20Error error) {
  ...
  public Action20 finished(String finished) {
  ...
  **/
  ...
  public Action20 progress(Integer progress) {
  ...
  **/
  ...
  public Action20 resources(List<Action20ResourcesInner> resources) {
  ...
  public Action20 addResourcesItem(Action20ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action20ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action20ResourcesInner> resources) {
  ...
  public Action20 started(String started) {
  ...
  **/
  ...
  public Action20 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action20 instance itself
   */
  public Action20 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action20 action20 = (Action20) o;
    return Objects.equals(this.command, action20.command) &&
        Objects.equals(this.error, action20.error) &&
        Objects.equals(this.finished, action20.finished) &&
        Objects.equals(this.id, action20.id) &&
        Objects.equals(this.progress, action20.progress) &&
        Objects.equals(this.resources, action20.resources) &&
        Objects.equals(this.started, action20.started) &&
        Objects.equals(this.status, action20.status)&&
        Objects.equals(this.additionalProperties, action20.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action20
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action20.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action20 is not found in the empty JSON string", Action20.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action20.openapiRequiredFields) {
      ...
      Action20Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action20ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action20.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action20' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action20> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action20.class));

       return (TypeAdapter<T>) new TypeAdapter<Action20>() {
           @Override
           public void write(JsonWriter out, Action20 value) throws IOException {
           ...
           @Override
           public Action20 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action20 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action20 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action20
  * @throws IOException if the JSON string is invalid with respect to Action20
  */
  public static Action20 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action20.class);
  }

 /**
  * Convert an instance of Action20 to an JSON string
  *
  * @return JSON string
  */
