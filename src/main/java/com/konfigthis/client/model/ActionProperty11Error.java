...
public class ActionProperty11Error {
  ...
  public ActionProperty11Error() {
  }

  public ActionProperty11Error code(String code) {
  ...
  **/
  ...
  public ActionProperty11Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty11Error instance itself
   */
  public ActionProperty11Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty11Error actionProperty11Error = (ActionProperty11Error) o;
    return Objects.equals(this.code, actionProperty11Error.code) &&
        Objects.equals(this.message, actionProperty11Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty11Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty11Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty11Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty11Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty11Error is not found in the empty JSON string", ActionProperty11Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty11Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty11Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty11Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty11Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty11Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty11Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty11Error value) throws IOException {
           ...
           @Override
           public ActionProperty11Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty11Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty11Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty11Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty11Error
  */
  public static ActionProperty11Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty11Error.class);
  }

 /**
  * Convert an instance of ActionProperty11Error to an JSON string
  *
  * @return JSON string
  */
