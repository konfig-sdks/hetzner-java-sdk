...
/**
 * NetworksCreateNetworkRequestRoutesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class NetworksCreateNetworkRequestRoutesInner {
  ...
  public NetworksCreateNetworkRequestRoutesInner() {
  }

  public NetworksCreateNetworkRequestRoutesInner destination(String destination) {
  ...
  **/
  ...
  public NetworksCreateNetworkRequestRoutesInner gateway(String gateway) {
  ...
  **/
   ...
   * @return the NetworksCreateNetworkRequestRoutesInner instance itself
   */
  public NetworksCreateNetworkRequestRoutesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksCreateNetworkRequestRoutesInner networksCreateNetworkRequestRoutesInner = (NetworksCreateNetworkRequestRoutesInner) o;
    return Objects.equals(this.destination, networksCreateNetworkRequestRoutesInner.destination) &&
        Objects.equals(this.gateway, networksCreateNetworkRequestRoutesInner.gateway)&&
        Objects.equals(this.additionalProperties, networksCreateNetworkRequestRoutesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksCreateNetworkRequestRoutesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksCreateNetworkRequestRoutesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksCreateNetworkRequestRoutesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksCreateNetworkRequestRoutesInner is not found in the empty JSON string", NetworksCreateNetworkRequestRoutesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksCreateNetworkRequestRoutesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksCreateNetworkRequestRoutesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksCreateNetworkRequestRoutesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksCreateNetworkRequestRoutesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksCreateNetworkRequestRoutesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksCreateNetworkRequestRoutesInner>() {
           @Override
           public void write(JsonWriter out, NetworksCreateNetworkRequestRoutesInner value) throws IOException {
           ...
           @Override
           public NetworksCreateNetworkRequestRoutesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksCreateNetworkRequestRoutesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksCreateNetworkRequestRoutesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksCreateNetworkRequestRoutesInner
  * @throws IOException if the JSON string is invalid with respect to NetworksCreateNetworkRequestRoutesInner
  */
  public static NetworksCreateNetworkRequestRoutesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksCreateNetworkRequestRoutesInner.class);
  }

 /**
  * Convert an instance of NetworksCreateNetworkRequestRoutesInner to an JSON string
  *
  * @return JSON string
  */
