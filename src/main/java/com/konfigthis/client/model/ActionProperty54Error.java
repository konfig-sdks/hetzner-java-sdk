...
public class ActionProperty54Error {
  ...
  public ActionProperty54Error() {
  }

  public ActionProperty54Error code(String code) {
  ...
  **/
  ...
  public ActionProperty54Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty54Error instance itself
   */
  public ActionProperty54Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty54Error actionProperty54Error = (ActionProperty54Error) o;
    return Objects.equals(this.code, actionProperty54Error.code) &&
        Objects.equals(this.message, actionProperty54Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty54Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty54Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty54Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty54Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty54Error is not found in the empty JSON string", ActionProperty54Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty54Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty54Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty54Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty54Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty54Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty54Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty54Error value) throws IOException {
           ...
           @Override
           public ActionProperty54Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty54Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty54Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty54Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty54Error
  */
  public static ActionProperty54Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty54Error.class);
  }

 /**
  * Convert an instance of ActionProperty54Error to an JSON string
  *
  * @return JSON string
  */
