...
public class ActionProperty46Error {
  ...
  public ActionProperty46Error() {
  }

  public ActionProperty46Error code(String code) {
  ...
  **/
  ...
  public ActionProperty46Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty46Error instance itself
   */
  public ActionProperty46Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty46Error actionProperty46Error = (ActionProperty46Error) o;
    return Objects.equals(this.code, actionProperty46Error.code) &&
        Objects.equals(this.message, actionProperty46Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty46Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty46Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty46Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty46Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty46Error is not found in the empty JSON string", ActionProperty46Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty46Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty46Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty46Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty46Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty46Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty46Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty46Error value) throws IOException {
           ...
           @Override
           public ActionProperty46Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty46Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty46Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty46Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty46Error
  */
  public static ActionProperty46Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty46Error.class);
  }

 /**
  * Convert an instance of ActionProperty46Error to an JSON string
  *
  * @return JSON string
  */
