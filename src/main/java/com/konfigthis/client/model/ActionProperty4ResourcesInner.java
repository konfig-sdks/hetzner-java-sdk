...
/**
 * ActionProperty4ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty4ResourcesInner {
  ...
  public ActionProperty4ResourcesInner() {
  }

  public ActionProperty4ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty4ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty4ResourcesInner instance itself
   */
  public ActionProperty4ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty4ResourcesInner actionProperty4ResourcesInner = (ActionProperty4ResourcesInner) o;
    return Objects.equals(this.id, actionProperty4ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty4ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty4ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty4ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty4ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty4ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty4ResourcesInner is not found in the empty JSON string", ActionProperty4ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty4ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty4ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty4ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty4ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty4ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty4ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty4ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty4ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty4ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty4ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty4ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty4ResourcesInner
  */
  public static ActionProperty4ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty4ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty4ResourcesInner to an JSON string
  *
  * @return JSON string
  */
