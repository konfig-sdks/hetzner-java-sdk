...
public class FirewallActionsSetRulesRequest {
  public static final String SERIALIZED_NAME_RULES = "rules";
  @SerializedName(SERIALIZED_NAME_RULES)
  private List<Rule1> rules = new ArrayList<>();

  public FirewallActionsSetRulesRequest() {
  }

  public FirewallActionsSetRulesRequest rules(List<Rule1> rules) {
  ...
  public FirewallActionsSetRulesRequest addRulesItem(Rule1 rulesItem) {
  ...
  **/
  ...
  public List<Rule1> getRules() {
    return rules;
  }


  public void setRules(List<Rule1> rules) {
   ...
   * @return the FirewallActionsSetRulesRequest instance itself
   */
  public FirewallActionsSetRulesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallActionsSetRulesRequest firewallActionsSetRulesRequest = (FirewallActionsSetRulesRequest) o;
    return Objects.equals(this.rules, firewallActionsSetRulesRequest.rules)&&
        Objects.equals(this.additionalProperties, firewallActionsSetRulesRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallActionsSetRulesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallActionsSetRulesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallActionsSetRulesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallActionsSetRulesRequest is not found in the empty JSON string", FirewallActionsSetRulesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallActionsSetRulesRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayrules.size(); i++) {
        Rule1.validateJsonObject(jsonArrayrules.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallActionsSetRulesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallActionsSetRulesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallActionsSetRulesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallActionsSetRulesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallActionsSetRulesRequest>() {
           @Override
           public void write(JsonWriter out, FirewallActionsSetRulesRequest value) throws IOException {
           ...
           @Override
           public FirewallActionsSetRulesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallActionsSetRulesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallActionsSetRulesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallActionsSetRulesRequest
  * @throws IOException if the JSON string is invalid with respect to FirewallActionsSetRulesRequest
  */
  public static FirewallActionsSetRulesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallActionsSetRulesRequest.class);
  }

 /**
  * Convert an instance of FirewallActionsSetRulesRequest to an JSON string
  *
  * @return JSON string
  */
