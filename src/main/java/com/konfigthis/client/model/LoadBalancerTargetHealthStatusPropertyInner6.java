...
/**
 * LoadBalancerTargetHealthStatusPropertyInner6
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LoadBalancerTargetHealthStatusPropertyInner6 {
 ...
 public enum StatusEnum {
  ...
  public LoadBalancerTargetHealthStatusPropertyInner6() {
  }

  public LoadBalancerTargetHealthStatusPropertyInner6 listenPort(Integer listenPort) {
  ...
  **/
  ...
  public LoadBalancerTargetHealthStatusPropertyInner6 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetHealthStatusPropertyInner6 instance itself
   */
  public LoadBalancerTargetHealthStatusPropertyInner6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetHealthStatusPropertyInner6 loadBalancerTargetHealthStatusPropertyInner6 = (LoadBalancerTargetHealthStatusPropertyInner6) o;
    return Objects.equals(this.listenPort, loadBalancerTargetHealthStatusPropertyInner6.listenPort) &&
        Objects.equals(this.status, loadBalancerTargetHealthStatusPropertyInner6.status)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetHealthStatusPropertyInner6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetHealthStatusPropertyInner6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetHealthStatusPropertyInner6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetHealthStatusPropertyInner6 is not found in the empty JSON string", LoadBalancerTargetHealthStatusPropertyInner6.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetHealthStatusPropertyInner6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetHealthStatusPropertyInner6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetHealthStatusPropertyInner6.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetHealthStatusPropertyInner6>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetHealthStatusPropertyInner6 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetHealthStatusPropertyInner6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetHealthStatusPropertyInner6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetHealthStatusPropertyInner6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetHealthStatusPropertyInner6
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetHealthStatusPropertyInner6
  */
  public static LoadBalancerTargetHealthStatusPropertyInner6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetHealthStatusPropertyInner6.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetHealthStatusPropertyInner6 to an JSON string
  *
  * @return JSON string
  */
