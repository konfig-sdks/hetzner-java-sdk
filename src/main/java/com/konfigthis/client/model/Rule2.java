...
public class Rule2 {
 ...
 public enum ProtocolEnum {
  ...
  public Rule2 description(String description) {
  ...
  **/
  ...
  public Rule2 destinationIps(List<String> destinationIps) {
  ...
  public Rule2 addDestinationIpsItem(String destinationIpsItem) {
  ...
  **/
  ...
  public Rule2 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public Rule2 protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public Rule2 sourceIps(List<String> sourceIps) {
  ...
  public Rule2 addSourceIpsItem(String sourceIpsItem) {
  ...
  **/
   ...
   * @return the Rule2 instance itself
   */
  public Rule2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Rule2 rule2 = (Rule2) o;
    return Objects.equals(this.description, rule2.description) &&
        Objects.equals(this.destinationIps, rule2.destinationIps) &&
        Objects.equals(this.direction, rule2.direction) &&
        Objects.equals(this.port, rule2.port) &&
        Objects.equals(this.protocol, rule2.protocol) &&
        Objects.equals(this.sourceIps, rule2.sourceIps)&&
        Objects.equals(this.additionalProperties, rule2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Rule2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Rule2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rule2 is not found in the empty JSON string", Rule2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rule2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rule2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rule2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rule2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rule2.class));

       return (TypeAdapter<T>) new TypeAdapter<Rule2>() {
           @Override
           public void write(JsonWriter out, Rule2 value) throws IOException {
           ...
           @Override
           public Rule2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Rule2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Rule2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Rule2
  * @throws IOException if the JSON string is invalid with respect to Rule2
  */
  public static Rule2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rule2.class);
  }

 /**
  * Convert an instance of Rule2 to an JSON string
  *
  * @return JSON string
  */
