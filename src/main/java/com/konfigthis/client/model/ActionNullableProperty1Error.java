 ...
 */
@ApiModel(description = "Error message for the Action if error occurred, otherwise null")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionNullableProperty1Error {
  ...
  public ActionNullableProperty1Error() {
  }

  public ActionNullableProperty1Error code(String code) {
  ...
  **/
  ...
  @ApiModelProperty(example = "action_failed", required = true, value = "Fixed machine readable code")
  ...
  public ActionNullableProperty1Error message(String message) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Action failed", required = true, value = "Humanized error message")
   ...
   * @return the ActionNullableProperty1Error instance itself
   */
  public ActionNullableProperty1Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullableProperty1Error actionNullableProperty1Error = (ActionNullableProperty1Error) o;
    return Objects.equals(this.code, actionNullableProperty1Error.code) &&
        Objects.equals(this.message, actionNullableProperty1Error.message)&&
        Objects.equals(this.additionalProperties, actionNullableProperty1Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionNullableProperty1Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullableProperty1Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullableProperty1Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullableProperty1Error is not found in the empty JSON string", ActionNullableProperty1Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullableProperty1Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullableProperty1Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullableProperty1Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullableProperty1Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullableProperty1Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullableProperty1Error>() {
           @Override
           public void write(JsonWriter out, ActionNullableProperty1Error value) throws IOException {
           ...
           @Override
           public ActionNullableProperty1Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullableProperty1Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullableProperty1Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullableProperty1Error
  * @throws IOException if the JSON string is invalid with respect to ActionNullableProperty1Error
  */
  public static ActionNullableProperty1Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullableProperty1Error.class);
  }

 /**
  * Convert an instance of ActionNullableProperty1Error to an JSON string
  *
  * @return JSON string
  */
