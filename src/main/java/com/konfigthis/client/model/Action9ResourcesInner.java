...
/**
 * Action9ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action9ResourcesInner {
  ...
  public Action9ResourcesInner() {
  }

  public Action9ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action9ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action9ResourcesInner instance itself
   */
  public Action9ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action9ResourcesInner action9ResourcesInner = (Action9ResourcesInner) o;
    return Objects.equals(this.id, action9ResourcesInner.id) &&
        Objects.equals(this.type, action9ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action9ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action9ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action9ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action9ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action9ResourcesInner is not found in the empty JSON string", Action9ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action9ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action9ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action9ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action9ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action9ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action9ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action9ResourcesInner value) throws IOException {
           ...
           @Override
           public Action9ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action9ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action9ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action9ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action9ResourcesInner
  */
  public static Action9ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action9ResourcesInner.class);
  }

 /**
  * Convert an instance of Action9ResourcesInner to an JSON string
  *
  * @return JSON string
  */
