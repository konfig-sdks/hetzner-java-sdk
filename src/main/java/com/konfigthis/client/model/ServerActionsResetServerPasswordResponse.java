...
import com.konfigthis.client.model.ActionProperty71;
...
public class ServerActionsResetServerPasswordResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty71 action;

  public static final String SERIALIZED_NAME_ROOT_PASSWORD = "root_password";
  @SerializedName(SERIALIZED_NAME_ROOT_PASSWORD)
  private String rootPassword;

  public ServerActionsResetServerPasswordResponse() {
  }

  public ServerActionsResetServerPasswordResponse action(ActionProperty71 action) {
  ...
  **/
  ...
  public ActionProperty71 getAction() {
    return action;
  }


  public void setAction(ActionProperty71 action) {
  ...
  public ServerActionsResetServerPasswordResponse rootPassword(String rootPassword) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "zCWbFhnu950dUTko5f40", value = "Password that will be set for this Server once the Action succeeds")
   ...
   * @return the ServerActionsResetServerPasswordResponse instance itself
   */
  public ServerActionsResetServerPasswordResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsResetServerPasswordResponse serverActionsResetServerPasswordResponse = (ServerActionsResetServerPasswordResponse) o;
    return Objects.equals(this.action, serverActionsResetServerPasswordResponse.action) &&
        Objects.equals(this.rootPassword, serverActionsResetServerPasswordResponse.rootPassword)&&
        Objects.equals(this.additionalProperties, serverActionsResetServerPasswordResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsResetServerPasswordResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsResetServerPasswordResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsResetServerPasswordResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsResetServerPasswordResponse is not found in the empty JSON string", ServerActionsResetServerPasswordResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `action`
      if (jsonObj.get("action") != null && !jsonObj.get("action").isJsonNull()) {
        ActionProperty71.validateJsonObject(jsonObj.getAsJsonObject("action"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsResetServerPasswordResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsResetServerPasswordResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsResetServerPasswordResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsResetServerPasswordResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsResetServerPasswordResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsResetServerPasswordResponse value) throws IOException {
           ...
           @Override
           public ServerActionsResetServerPasswordResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsResetServerPasswordResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsResetServerPasswordResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsResetServerPasswordResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsResetServerPasswordResponse
  */
  public static ServerActionsResetServerPasswordResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsResetServerPasswordResponse.class);
  }

 /**
  * Convert an instance of ServerActionsResetServerPasswordResponse to an JSON string
  *
  * @return JSON string
  */
