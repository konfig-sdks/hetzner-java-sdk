...
import com.konfigthis.client.model.ActionProperty44;
...
public class PrimaryIpActionsChangeDnsPtrResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty44 action;

  public PrimaryIpActionsChangeDnsPtrResponse() {
  }

  public PrimaryIpActionsChangeDnsPtrResponse action(ActionProperty44 action) {
  ...
  **/
  ...
  public ActionProperty44 getAction() {
    return action;
  }


  public void setAction(ActionProperty44 action) {
   ...
   * @return the PrimaryIpActionsChangeDnsPtrResponse instance itself
   */
  public PrimaryIpActionsChangeDnsPtrResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIpActionsChangeDnsPtrResponse primaryIpActionsChangeDnsPtrResponse = (PrimaryIpActionsChangeDnsPtrResponse) o;
    return Objects.equals(this.action, primaryIpActionsChangeDnsPtrResponse.action)&&
        Objects.equals(this.additionalProperties, primaryIpActionsChangeDnsPtrResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIpActionsChangeDnsPtrResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIpActionsChangeDnsPtrResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIpActionsChangeDnsPtrResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIpActionsChangeDnsPtrResponse is not found in the empty JSON string", PrimaryIpActionsChangeDnsPtrResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIpActionsChangeDnsPtrResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty44.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIpActionsChangeDnsPtrResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIpActionsChangeDnsPtrResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIpActionsChangeDnsPtrResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIpActionsChangeDnsPtrResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIpActionsChangeDnsPtrResponse>() {
           @Override
           public void write(JsonWriter out, PrimaryIpActionsChangeDnsPtrResponse value) throws IOException {
           ...
           @Override
           public PrimaryIpActionsChangeDnsPtrResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIpActionsChangeDnsPtrResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIpActionsChangeDnsPtrResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIpActionsChangeDnsPtrResponse
  * @throws IOException if the JSON string is invalid with respect to PrimaryIpActionsChangeDnsPtrResponse
  */
  public static PrimaryIpActionsChangeDnsPtrResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIpActionsChangeDnsPtrResponse.class);
  }

 /**
  * Convert an instance of PrimaryIpActionsChangeDnsPtrResponse to an JSON string
  *
  * @return JSON string
  */
