...
/**
 * Action24ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action24ResourcesInner {
  ...
  public Action24ResourcesInner() {
  }

  public Action24ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action24ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action24ResourcesInner instance itself
   */
  public Action24ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action24ResourcesInner action24ResourcesInner = (Action24ResourcesInner) o;
    return Objects.equals(this.id, action24ResourcesInner.id) &&
        Objects.equals(this.type, action24ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action24ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action24ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action24ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action24ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action24ResourcesInner is not found in the empty JSON string", Action24ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action24ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action24ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action24ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action24ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action24ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action24ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action24ResourcesInner value) throws IOException {
           ...
           @Override
           public Action24ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action24ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action24ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action24ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action24ResourcesInner
  */
  public static Action24ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action24ResourcesInner.class);
  }

 /**
  * Convert an instance of Action24ResourcesInner to an JSON string
  *
  * @return JSON string
  */
