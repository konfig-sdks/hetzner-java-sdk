...
import com.konfigthis.client.model.ActionProperty16;
...
public class ImageActionsGetActionById200Response {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty16 action;

  public ImageActionsGetActionById200Response() {
  }

  public ImageActionsGetActionById200Response action(ActionProperty16 action) {
  ...
  **/
  ...
  public ActionProperty16 getAction() {
    return action;
  }


  public void setAction(ActionProperty16 action) {
   ...
   * @return the ImageActionsGetActionById200Response instance itself
   */
  public ImageActionsGetActionById200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ImageActionsGetActionById200Response imageActionsGetActionById200Response = (ImageActionsGetActionById200Response) o;
    return Objects.equals(this.action, imageActionsGetActionById200Response.action)&&
        Objects.equals(this.additionalProperties, imageActionsGetActionById200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageActionsGetActionById200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageActionsGetActionById200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageActionsGetActionById200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageActionsGetActionById200Response is not found in the empty JSON string", ImageActionsGetActionById200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageActionsGetActionById200Response.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty16.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageActionsGetActionById200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageActionsGetActionById200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageActionsGetActionById200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageActionsGetActionById200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageActionsGetActionById200Response>() {
           @Override
           public void write(JsonWriter out, ImageActionsGetActionById200Response value) throws IOException {
           ...
           @Override
           public ImageActionsGetActionById200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageActionsGetActionById200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageActionsGetActionById200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageActionsGetActionById200Response
  * @throws IOException if the JSON string is invalid with respect to ImageActionsGetActionById200Response
  */
  public static ImageActionsGetActionById200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageActionsGetActionById200Response.class);
  }

 /**
  * Convert an instance of ImageActionsGetActionById200Response to an JSON string
  *
  * @return JSON string
  */
