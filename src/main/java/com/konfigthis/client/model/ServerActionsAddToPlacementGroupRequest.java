...
public class ServerActionsAddToPlacementGroupRequest {
  ...
  public ServerActionsAddToPlacementGroupRequest() {
  }

  public ServerActionsAddToPlacementGroupRequest placementGroup(Long placementGroup) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1", required = true, value = "ID of Placement Group the Server should be added to")
   ...
   * @return the ServerActionsAddToPlacementGroupRequest instance itself
   */
  public ServerActionsAddToPlacementGroupRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsAddToPlacementGroupRequest serverActionsAddToPlacementGroupRequest = (ServerActionsAddToPlacementGroupRequest) o;
    return Objects.equals(this.placementGroup, serverActionsAddToPlacementGroupRequest.placementGroup)&&
        Objects.equals(this.additionalProperties, serverActionsAddToPlacementGroupRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsAddToPlacementGroupRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsAddToPlacementGroupRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsAddToPlacementGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsAddToPlacementGroupRequest is not found in the empty JSON string", ServerActionsAddToPlacementGroupRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsAddToPlacementGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsAddToPlacementGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsAddToPlacementGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsAddToPlacementGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsAddToPlacementGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsAddToPlacementGroupRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsAddToPlacementGroupRequest value) throws IOException {
           ...
           @Override
           public ServerActionsAddToPlacementGroupRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsAddToPlacementGroupRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsAddToPlacementGroupRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsAddToPlacementGroupRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsAddToPlacementGroupRequest
  */
  public static ServerActionsAddToPlacementGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsAddToPlacementGroupRequest.class);
  }

 /**
  * Convert an instance of ServerActionsAddToPlacementGroupRequest to an JSON string
  *
  * @return JSON string
  */
