...
public class ActionProperty67Error {
  ...
  public ActionProperty67Error() {
  }

  public ActionProperty67Error code(String code) {
  ...
  **/
  ...
  public ActionProperty67Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty67Error instance itself
   */
  public ActionProperty67Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty67Error actionProperty67Error = (ActionProperty67Error) o;
    return Objects.equals(this.code, actionProperty67Error.code) &&
        Objects.equals(this.message, actionProperty67Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty67Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty67Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty67Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty67Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty67Error is not found in the empty JSON string", ActionProperty67Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty67Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty67Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty67Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty67Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty67Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty67Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty67Error value) throws IOException {
           ...
           @Override
           public ActionProperty67Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty67Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty67Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty67Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty67Error
  */
  public static ActionProperty67Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty67Error.class);
  }

 /**
  * Convert an instance of ActionProperty67Error to an JSON string
  *
  * @return JSON string
  */
