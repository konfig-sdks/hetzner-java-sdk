...
import com.konfigthis.client.model.ListMetaProperty13Pagination;
...
public class ListMetaProperty13 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty13Pagination pagination;

  public ListMetaProperty13() {
  }

  public ListMetaProperty13 pagination(ListMetaProperty13Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty13Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty13Pagination pagination) {
   ...
   * @return the ListMetaProperty13 instance itself
   */
  public ListMetaProperty13 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty13 listMetaProperty13 = (ListMetaProperty13) o;
    return Objects.equals(this.pagination, listMetaProperty13.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty13.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty13 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty13
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty13.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty13 is not found in the empty JSON string", ListMetaProperty13.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty13.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty13Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty13.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty13>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty13 value) throws IOException {
           ...
           @Override
           public ListMetaProperty13 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty13 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty13 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty13
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty13
  */
  public static ListMetaProperty13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty13.class);
  }

 /**
  * Convert an instance of ListMetaProperty13 to an JSON string
  *
  * @return JSON string
  */
