...
import com.konfigthis.client.model.ListMetaProperty22Pagination;
...
public class ListMetaProperty22 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty22Pagination pagination;

  public ListMetaProperty22() {
  }

  public ListMetaProperty22 pagination(ListMetaProperty22Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty22Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty22Pagination pagination) {
   ...
   * @return the ListMetaProperty22 instance itself
   */
  public ListMetaProperty22 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty22 listMetaProperty22 = (ListMetaProperty22) o;
    return Objects.equals(this.pagination, listMetaProperty22.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty22.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty22 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty22
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty22.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty22 is not found in the empty JSON string", ListMetaProperty22.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty22.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty22Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty22.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty22' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty22> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty22.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty22>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty22 value) throws IOException {
           ...
           @Override
           public ListMetaProperty22 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty22 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty22 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty22
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty22
  */
  public static ListMetaProperty22 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty22.class);
  }

 /**
  * Convert an instance of ListMetaProperty22 to an JSON string
  *
  * @return JSON string
  */
