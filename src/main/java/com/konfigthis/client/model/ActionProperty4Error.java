...
public class ActionProperty4Error {
  ...
  public ActionProperty4Error() {
  }

  public ActionProperty4Error code(String code) {
  ...
  **/
  ...
  public ActionProperty4Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty4Error instance itself
   */
  public ActionProperty4Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty4Error actionProperty4Error = (ActionProperty4Error) o;
    return Objects.equals(this.code, actionProperty4Error.code) &&
        Objects.equals(this.message, actionProperty4Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty4Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty4Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty4Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty4Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty4Error is not found in the empty JSON string", ActionProperty4Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty4Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty4Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty4Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty4Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty4Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty4Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty4Error value) throws IOException {
           ...
           @Override
           public ActionProperty4Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty4Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty4Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty4Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty4Error
  */
  public static ActionProperty4Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty4Error.class);
  }

 /**
  * Convert an instance of ActionProperty4Error to an JSON string
  *
  * @return JSON string
  */
