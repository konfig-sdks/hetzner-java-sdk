...
/**
 * ActionProperty44ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty44ResourcesInner {
  ...
  public ActionProperty44ResourcesInner() {
  }

  public ActionProperty44ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty44ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty44ResourcesInner instance itself
   */
  public ActionProperty44ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty44ResourcesInner actionProperty44ResourcesInner = (ActionProperty44ResourcesInner) o;
    return Objects.equals(this.id, actionProperty44ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty44ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty44ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty44ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty44ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty44ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty44ResourcesInner is not found in the empty JSON string", ActionProperty44ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty44ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty44ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty44ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty44ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty44ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty44ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty44ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty44ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty44ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty44ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty44ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty44ResourcesInner
  */
  public static ActionProperty44ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty44ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty44ResourcesInner to an JSON string
  *
  * @return JSON string
  */
