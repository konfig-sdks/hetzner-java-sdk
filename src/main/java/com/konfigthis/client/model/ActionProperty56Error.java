...
public class ActionProperty56Error {
  ...
  public ActionProperty56Error() {
  }

  public ActionProperty56Error code(String code) {
  ...
  **/
  ...
  public ActionProperty56Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty56Error instance itself
   */
  public ActionProperty56Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty56Error actionProperty56Error = (ActionProperty56Error) o;
    return Objects.equals(this.code, actionProperty56Error.code) &&
        Objects.equals(this.message, actionProperty56Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty56Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty56Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty56Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty56Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty56Error is not found in the empty JSON string", ActionProperty56Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty56Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty56Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty56Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty56Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty56Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty56Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty56Error value) throws IOException {
           ...
           @Override
           public ActionProperty56Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty56Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty56Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty56Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty56Error
  */
  public static ActionProperty56Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty56Error.class);
  }

 /**
  * Convert an instance of ActionProperty56Error to an JSON string
  *
  * @return JSON string
  */
