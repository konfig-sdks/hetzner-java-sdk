...
import com.konfigthis.client.model.ActionProperty11Error;
import com.konfigthis.client.model.ActionProperty11ResourcesInner;
...
public class ActionProperty11 {
  ...
  private ActionProperty11Error error;
  ...
  private List<ActionProperty11ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty11() {
  }

  public ActionProperty11 command(String command) {
  ...
  **/
  ...
  public ActionProperty11 error(ActionProperty11Error error) {
  ...
  **/
  ...
  public ActionProperty11Error getError() {
    return error;
  }


  public void setError(ActionProperty11Error error) {
  ...
  public ActionProperty11 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty11 id(Long id) {
  ...
  **/
  ...
  public ActionProperty11 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty11 resources(List<ActionProperty11ResourcesInner> resources) {
  ...
  public ActionProperty11 addResourcesItem(ActionProperty11ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty11ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty11ResourcesInner> resources) {
  ...
  public ActionProperty11 started(String started) {
  ...
  **/
  ...
  public ActionProperty11 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty11 instance itself
   */
  public ActionProperty11 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty11 actionProperty11 = (ActionProperty11) o;
    return Objects.equals(this.command, actionProperty11.command) &&
        Objects.equals(this.error, actionProperty11.error) &&
        Objects.equals(this.finished, actionProperty11.finished) &&
        Objects.equals(this.id, actionProperty11.id) &&
        Objects.equals(this.progress, actionProperty11.progress) &&
        Objects.equals(this.resources, actionProperty11.resources) &&
        Objects.equals(this.started, actionProperty11.started) &&
        Objects.equals(this.status, actionProperty11.status)&&
        Objects.equals(this.additionalProperties, actionProperty11.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty11 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty11
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty11.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty11 is not found in the empty JSON string", ActionProperty11.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty11.openapiRequiredFields) {
      ...
      ActionProperty11Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty11ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty11.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty11>() {
           @Override
           public void write(JsonWriter out, ActionProperty11 value) throws IOException {
           ...
           @Override
           public ActionProperty11 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty11 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty11 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty11
  * @throws IOException if the JSON string is invalid with respect to ActionProperty11
  */
  public static ActionProperty11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty11.class);
  }

 /**
  * Convert an instance of ActionProperty11 to an JSON string
  *
  * @return JSON string
  */
