...
/**
 * ActionProperty30ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty30ResourcesInner {
  ...
  public ActionProperty30ResourcesInner() {
  }

  public ActionProperty30ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty30ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty30ResourcesInner instance itself
   */
  public ActionProperty30ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty30ResourcesInner actionProperty30ResourcesInner = (ActionProperty30ResourcesInner) o;
    return Objects.equals(this.id, actionProperty30ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty30ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty30ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty30ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty30ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty30ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty30ResourcesInner is not found in the empty JSON string", ActionProperty30ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty30ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty30ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty30ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty30ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty30ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty30ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty30ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty30ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty30ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty30ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty30ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty30ResourcesInner
  */
  public static ActionProperty30ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty30ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty30ResourcesInner to an JSON string
  *
  * @return JSON string
  */
