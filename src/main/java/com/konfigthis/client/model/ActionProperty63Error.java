...
public class ActionProperty63Error {
  ...
  public ActionProperty63Error() {
  }

  public ActionProperty63Error code(String code) {
  ...
  **/
  ...
  public ActionProperty63Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty63Error instance itself
   */
  public ActionProperty63Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty63Error actionProperty63Error = (ActionProperty63Error) o;
    return Objects.equals(this.code, actionProperty63Error.code) &&
        Objects.equals(this.message, actionProperty63Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty63Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty63Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty63Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty63Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty63Error is not found in the empty JSON string", ActionProperty63Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty63Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty63Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty63Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty63Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty63Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty63Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty63Error value) throws IOException {
           ...
           @Override
           public ActionProperty63Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty63Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty63Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty63Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty63Error
  */
  public static ActionProperty63Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty63Error.class);
  }

 /**
  * Convert an instance of ActionProperty63Error to an JSON string
  *
  * @return JSON string
  */
