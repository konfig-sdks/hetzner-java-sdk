...
public class ActionProperty24Error {
  ...
  public ActionProperty24Error() {
  }

  public ActionProperty24Error code(String code) {
  ...
  **/
  ...
  public ActionProperty24Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty24Error instance itself
   */
  public ActionProperty24Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty24Error actionProperty24Error = (ActionProperty24Error) o;
    return Objects.equals(this.code, actionProperty24Error.code) &&
        Objects.equals(this.message, actionProperty24Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty24Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty24Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty24Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty24Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty24Error is not found in the empty JSON string", ActionProperty24Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty24Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty24Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty24Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty24Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty24Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty24Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty24Error value) throws IOException {
           ...
           @Override
           public ActionProperty24Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty24Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty24Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty24Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty24Error
  */
  public static ActionProperty24Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty24Error.class);
  }

 /**
  * Convert an instance of ActionProperty24Error to an JSON string
  *
  * @return JSON string
  */
