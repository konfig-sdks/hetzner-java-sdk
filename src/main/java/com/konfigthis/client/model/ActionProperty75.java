...
import com.konfigthis.client.model.ActionProperty75Error;
import com.konfigthis.client.model.ActionProperty75ResourcesInner;
...
public class ActionProperty75 {
  ...
  private ActionProperty75Error error;
  ...
  private List<ActionProperty75ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty75() {
  }

  public ActionProperty75 command(String command) {
  ...
  **/
  ...
  public ActionProperty75 error(ActionProperty75Error error) {
  ...
  **/
  ...
  public ActionProperty75Error getError() {
    return error;
  }


  public void setError(ActionProperty75Error error) {
  ...
  public ActionProperty75 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty75 id(Long id) {
  ...
  **/
  ...
  public ActionProperty75 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty75 resources(List<ActionProperty75ResourcesInner> resources) {
  ...
  public ActionProperty75 addResourcesItem(ActionProperty75ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty75ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty75ResourcesInner> resources) {
  ...
  public ActionProperty75 started(String started) {
  ...
  **/
  ...
  public ActionProperty75 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty75 instance itself
   */
  public ActionProperty75 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty75 actionProperty75 = (ActionProperty75) o;
    return Objects.equals(this.command, actionProperty75.command) &&
        Objects.equals(this.error, actionProperty75.error) &&
        Objects.equals(this.finished, actionProperty75.finished) &&
        Objects.equals(this.id, actionProperty75.id) &&
        Objects.equals(this.progress, actionProperty75.progress) &&
        Objects.equals(this.resources, actionProperty75.resources) &&
        Objects.equals(this.started, actionProperty75.started) &&
        Objects.equals(this.status, actionProperty75.status)&&
        Objects.equals(this.additionalProperties, actionProperty75.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty75 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty75
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty75.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty75 is not found in the empty JSON string", ActionProperty75.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty75.openapiRequiredFields) {
      ...
      ActionProperty75Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty75ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty75.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty75' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty75> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty75.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty75>() {
           @Override
           public void write(JsonWriter out, ActionProperty75 value) throws IOException {
           ...
           @Override
           public ActionProperty75 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty75 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty75 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty75
  * @throws IOException if the JSON string is invalid with respect to ActionProperty75
  */
  public static ActionProperty75 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty75.class);
  }

 /**
  * Convert an instance of ActionProperty75 to an JSON string
  *
  * @return JSON string
  */
