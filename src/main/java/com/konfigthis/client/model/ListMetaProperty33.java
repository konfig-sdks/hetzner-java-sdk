...
import com.konfigthis.client.model.ListMetaProperty33Pagination;
...
public class ListMetaProperty33 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty33Pagination pagination;

  public ListMetaProperty33() {
  }

  public ListMetaProperty33 pagination(ListMetaProperty33Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty33Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty33Pagination pagination) {
   ...
   * @return the ListMetaProperty33 instance itself
   */
  public ListMetaProperty33 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty33 listMetaProperty33 = (ListMetaProperty33) o;
    return Objects.equals(this.pagination, listMetaProperty33.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty33.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty33 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty33
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty33.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty33 is not found in the empty JSON string", ListMetaProperty33.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty33.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty33Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty33.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty33' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty33> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty33.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty33>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty33 value) throws IOException {
           ...
           @Override
           public ListMetaProperty33 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty33 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty33 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty33
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty33
  */
  public static ListMetaProperty33 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty33.class);
  }

 /**
  * Convert an instance of ListMetaProperty33 to an JSON string
  *
  * @return JSON string
  */
