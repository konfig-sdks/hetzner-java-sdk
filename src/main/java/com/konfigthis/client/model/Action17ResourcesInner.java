...
public class Action17ResourcesInner {
  ...
  public Action17ResourcesInner() {
  }

  public Action17ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action17ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action17ResourcesInner instance itself
   */
  public Action17ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action17ResourcesInner action17ResourcesInner = (Action17ResourcesInner) o;
    return Objects.equals(this.id, action17ResourcesInner.id) &&
        Objects.equals(this.type, action17ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action17ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action17ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action17ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action17ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action17ResourcesInner is not found in the empty JSON string", Action17ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action17ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action17ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action17ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action17ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action17ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action17ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action17ResourcesInner value) throws IOException {
           ...
           @Override
           public Action17ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action17ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action17ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action17ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action17ResourcesInner
  */
  public static Action17ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action17ResourcesInner.class);
  }

 /**
  * Convert an instance of Action17ResourcesInner to an JSON string
  *
  * @return JSON string
  */
