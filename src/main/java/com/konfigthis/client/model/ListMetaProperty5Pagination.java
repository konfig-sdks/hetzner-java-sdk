...
public class ListMetaProperty5Pagination {
  ...
  public ListMetaProperty5Pagination() {
  }

  public ListMetaProperty5Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty5Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty5Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty5Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty5Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty5Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty5Pagination instance itself
   */
  public ListMetaProperty5Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty5Pagination listMetaProperty5Pagination = (ListMetaProperty5Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty5Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty5Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty5Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty5Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty5Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty5Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty5Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty5Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty5Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty5Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty5Pagination is not found in the empty JSON string", ListMetaProperty5Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty5Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty5Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty5Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty5Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty5Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty5Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty5Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty5Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty5Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty5Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty5Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty5Pagination
  */
  public static ListMetaProperty5Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty5Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty5Pagination to an JSON string
  *
  * @return JSON string
  */
