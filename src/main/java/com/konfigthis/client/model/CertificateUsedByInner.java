...
public class CertificateUsedByInner {
  ...
  public CertificateUsedByInner id(Long id) {
  ...
  **/
   ...
   * @return the CertificateUsedByInner instance itself
   */
  public CertificateUsedByInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, certificateUsedByInner.id) &&
        ...
        Objects.equals(this.additionalProperties, certificateUsedByInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateUsedByInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateUsedByInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CertificateUsedByInner>() {
           ...
           public CertificateUsedByInner read(JsonReader in) throws IOException {
             ...
             CertificateUsedByInner instance = thisAdapter.fromJsonTree(jsonObj);
