...
public class ServerActionsEnableRescueModeRequest {
 ...
 public enum TypeEnum {
  ...
  private TypeEnum type = TypeEnum.LINUX64;

  public ServerActionsEnableRescueModeRequest() {
  }

  public ServerActionsEnableRescueModeRequest sshKeys(List<Long> sshKeys) {
  ...
  public ServerActionsEnableRescueModeRequest addSshKeysItem(Long sshKeysItem) {
  ...
  **/
  ...
  @ApiModelProperty(example = "[2323]", value = "Array of SSH key IDs which should be injected into the rescue system.")
  ...
  public ServerActionsEnableRescueModeRequest type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "LINUX64", value = "Type of rescue system to boot.")
   ...
   * @return the ServerActionsEnableRescueModeRequest instance itself
   */
  public ServerActionsEnableRescueModeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsEnableRescueModeRequest serverActionsEnableRescueModeRequest = (ServerActionsEnableRescueModeRequest) o;
    return Objects.equals(this.sshKeys, serverActionsEnableRescueModeRequest.sshKeys) &&
        Objects.equals(this.type, serverActionsEnableRescueModeRequest.type)&&
        Objects.equals(this.additionalProperties, serverActionsEnableRescueModeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sshKeys, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerActionsEnableRescueModeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsEnableRescueModeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsEnableRescueModeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsEnableRescueModeRequest is not found in the empty JSON string", ServerActionsEnableRescueModeRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsEnableRescueModeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsEnableRescueModeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsEnableRescueModeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsEnableRescueModeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsEnableRescueModeRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsEnableRescueModeRequest value) throws IOException {
           ...
           @Override
           public ServerActionsEnableRescueModeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsEnableRescueModeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsEnableRescueModeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsEnableRescueModeRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsEnableRescueModeRequest
  */
  public static ServerActionsEnableRescueModeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsEnableRescueModeRequest.class);
  }

 /**
  * Convert an instance of ServerActionsEnableRescueModeRequest to an JSON string
  *
  * @return JSON string
  */
