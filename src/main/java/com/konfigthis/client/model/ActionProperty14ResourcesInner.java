...
/**
 * ActionProperty14ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty14ResourcesInner {
  ...
  public ActionProperty14ResourcesInner() {
  }

  public ActionProperty14ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty14ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty14ResourcesInner instance itself
   */
  public ActionProperty14ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty14ResourcesInner actionProperty14ResourcesInner = (ActionProperty14ResourcesInner) o;
    return Objects.equals(this.id, actionProperty14ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty14ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty14ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty14ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty14ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty14ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty14ResourcesInner is not found in the empty JSON string", ActionProperty14ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty14ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty14ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty14ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty14ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty14ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty14ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty14ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty14ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty14ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty14ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty14ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty14ResourcesInner
  */
  public static ActionProperty14ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty14ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty14ResourcesInner to an JSON string
  *
  * @return JSON string
  */
