...
public class ActionProperty17Error {
  ...
  public ActionProperty17Error() {
  }

  public ActionProperty17Error code(String code) {
  ...
  **/
  ...
  public ActionProperty17Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty17Error instance itself
   */
  public ActionProperty17Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty17Error actionProperty17Error = (ActionProperty17Error) o;
    return Objects.equals(this.code, actionProperty17Error.code) &&
        Objects.equals(this.message, actionProperty17Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty17Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty17Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty17Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty17Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty17Error is not found in the empty JSON string", ActionProperty17Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty17Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty17Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty17Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty17Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty17Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty17Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty17Error value) throws IOException {
           ...
           @Override
           public ActionProperty17Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty17Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty17Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty17Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty17Error
  */
  public static ActionProperty17Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty17Error.class);
  }

 /**
  * Convert an instance of ActionProperty17Error to an JSON string
  *
  * @return JSON string
  */
