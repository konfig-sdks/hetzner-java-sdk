...
import com.konfigthis.client.model.ListMetaProperty35Pagination;
...
public class ListMetaProperty35 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty35Pagination pagination;

  public ListMetaProperty35() {
  }

  public ListMetaProperty35 pagination(ListMetaProperty35Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty35Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty35Pagination pagination) {
   ...
   * @return the ListMetaProperty35 instance itself
   */
  public ListMetaProperty35 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty35 listMetaProperty35 = (ListMetaProperty35) o;
    return Objects.equals(this.pagination, listMetaProperty35.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty35.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty35 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty35
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty35.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty35 is not found in the empty JSON string", ListMetaProperty35.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty35.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty35Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty35.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty35' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty35> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty35.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty35>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty35 value) throws IOException {
           ...
           @Override
           public ListMetaProperty35 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty35 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty35 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty35
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty35
  */
  public static ListMetaProperty35 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty35.class);
  }

 /**
  * Convert an instance of ListMetaProperty35 to an JSON string
  *
  * @return JSON string
  */
