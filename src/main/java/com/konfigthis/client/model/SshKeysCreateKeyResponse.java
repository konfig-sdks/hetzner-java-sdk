...
import com.konfigthis.client.model.SshKeysCreateKeyResponseSshKey;
...
public class SshKeysCreateKeyResponse {
  public static final String SERIALIZED_NAME_SSH_KEY = "ssh_key";
  @SerializedName(SERIALIZED_NAME_SSH_KEY)
  private SshKeysCreateKeyResponseSshKey sshKey;

  public SshKeysCreateKeyResponse() {
  }

  public SshKeysCreateKeyResponse sshKey(SshKeysCreateKeyResponseSshKey sshKey) {
  ...
  **/
  ...
  public SshKeysCreateKeyResponseSshKey getSshKey() {
    return sshKey;
  }


  public void setSshKey(SshKeysCreateKeyResponseSshKey sshKey) {
   ...
   * @return the SshKeysCreateKeyResponse instance itself
   */
  public SshKeysCreateKeyResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysCreateKeyResponse sshKeysCreateKeyResponse = (SshKeysCreateKeyResponse) o;
    return Objects.equals(this.sshKey, sshKeysCreateKeyResponse.sshKey)&&
        Objects.equals(this.additionalProperties, sshKeysCreateKeyResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysCreateKeyResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysCreateKeyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysCreateKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysCreateKeyResponse is not found in the empty JSON string", SshKeysCreateKeyResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysCreateKeyResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `ssh_key`
      SshKeysCreateKeyResponseSshKey.validateJsonObject(jsonObj.getAsJsonObject("ssh_key"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysCreateKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysCreateKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysCreateKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysCreateKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysCreateKeyResponse>() {
           @Override
           public void write(JsonWriter out, SshKeysCreateKeyResponse value) throws IOException {
           ...
           @Override
           public SshKeysCreateKeyResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysCreateKeyResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysCreateKeyResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysCreateKeyResponse
  * @throws IOException if the JSON string is invalid with respect to SshKeysCreateKeyResponse
  */
  public static SshKeysCreateKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysCreateKeyResponse.class);
  }

 /**
  * Convert an instance of SshKeysCreateKeyResponse to an JSON string
  *
  * @return JSON string
  */
