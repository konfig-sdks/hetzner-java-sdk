...
/**
 * Action13ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action13ResourcesInner {
  ...
  public Action13ResourcesInner() {
  }

  public Action13ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action13ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action13ResourcesInner instance itself
   */
  public Action13ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action13ResourcesInner action13ResourcesInner = (Action13ResourcesInner) o;
    return Objects.equals(this.id, action13ResourcesInner.id) &&
        Objects.equals(this.type, action13ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action13ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action13ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action13ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action13ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action13ResourcesInner is not found in the empty JSON string", Action13ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action13ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action13ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action13ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action13ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action13ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action13ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action13ResourcesInner value) throws IOException {
           ...
           @Override
           public Action13ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action13ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action13ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action13ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action13ResourcesInner
  */
  public static Action13ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action13ResourcesInner.class);
  }

 /**
  * Convert an instance of Action13ResourcesInner to an JSON string
  *
  * @return JSON string
  */
