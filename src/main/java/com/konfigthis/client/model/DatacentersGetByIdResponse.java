...
import com.konfigthis.client.model.DatacentersGetByIdResponseDatacenter;
...
public class DatacentersGetByIdResponse {
  public static final String SERIALIZED_NAME_DATACENTER = "datacenter";
  @SerializedName(SERIALIZED_NAME_DATACENTER)
  private DatacentersGetByIdResponseDatacenter datacenter;

  public DatacentersGetByIdResponse() {
  }

  public DatacentersGetByIdResponse datacenter(DatacentersGetByIdResponseDatacenter datacenter) {
  ...
  **/
  ...
  public DatacentersGetByIdResponseDatacenter getDatacenter() {
    return datacenter;
  }


  public void setDatacenter(DatacentersGetByIdResponseDatacenter datacenter) {
   ...
   * @return the DatacentersGetByIdResponse instance itself
   */
  public DatacentersGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatacentersGetByIdResponse datacentersGetByIdResponse = (DatacentersGetByIdResponse) o;
    return Objects.equals(this.datacenter, datacentersGetByIdResponse.datacenter)&&
        Objects.equals(this.additionalProperties, datacentersGetByIdResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datacenter, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatacentersGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatacentersGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatacentersGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatacentersGetByIdResponse is not found in the empty JSON string", DatacentersGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatacentersGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `datacenter`
      DatacentersGetByIdResponseDatacenter.validateJsonObject(jsonObj.getAsJsonObject("datacenter"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatacentersGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatacentersGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatacentersGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatacentersGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DatacentersGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, DatacentersGetByIdResponse value) throws IOException {
           ...
           @Override
           public DatacentersGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatacentersGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatacentersGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatacentersGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to DatacentersGetByIdResponse
  */
  public static DatacentersGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatacentersGetByIdResponse.class);
  }

 /**
  * Convert an instance of DatacentersGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
