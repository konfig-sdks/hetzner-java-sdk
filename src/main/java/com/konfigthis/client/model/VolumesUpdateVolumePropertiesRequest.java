...
public class VolumesUpdateVolumePropertiesRequest {
  ...
  public VolumesUpdateVolumePropertiesRequest() {
  }

  public VolumesUpdateVolumePropertiesRequest labels(VolumesUpdateVolumePropertiesRequestLabels labels) {
  ...
  **/
  ...
  public VolumesUpdateVolumePropertiesRequestLabels getLabels() {
    return labels;
  }


  public void setLabels(VolumesUpdateVolumePropertiesRequestLabels labels) {
  ...
  public VolumesUpdateVolumePropertiesRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "database-storage", value = "New Volume name")
   ...
   * @return the VolumesUpdateVolumePropertiesRequest instance itself
   */
  public VolumesUpdateVolumePropertiesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesUpdateVolumePropertiesRequest volumesUpdateVolumePropertiesRequest = (VolumesUpdateVolumePropertiesRequest) o;
    return Objects.equals(this.labels, volumesUpdateVolumePropertiesRequest.labels) &&
        Objects.equals(this.name, volumesUpdateVolumePropertiesRequest.name)&&
        Objects.equals(this.additionalProperties, volumesUpdateVolumePropertiesRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesUpdateVolumePropertiesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesUpdateVolumePropertiesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesUpdateVolumePropertiesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesUpdateVolumePropertiesRequest is not found in the empty JSON string", VolumesUpdateVolumePropertiesRequest.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `labels`
      if (jsonObj.get("labels") != null && !jsonObj.get("labels").isJsonNull()) {
        VolumesUpdateVolumePropertiesRequestLabels.validateJsonObject(jsonObj.getAsJsonObject("labels"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesUpdateVolumePropertiesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesUpdateVolumePropertiesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesUpdateVolumePropertiesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesUpdateVolumePropertiesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesUpdateVolumePropertiesRequest>() {
           @Override
           public void write(JsonWriter out, VolumesUpdateVolumePropertiesRequest value) throws IOException {
           ...
           @Override
           public VolumesUpdateVolumePropertiesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesUpdateVolumePropertiesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesUpdateVolumePropertiesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesUpdateVolumePropertiesRequest
  * @throws IOException if the JSON string is invalid with respect to VolumesUpdateVolumePropertiesRequest
  */
  public static VolumesUpdateVolumePropertiesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesUpdateVolumePropertiesRequest.class);
  }

 /**
  * Convert an instance of VolumesUpdateVolumePropertiesRequest to an JSON string
  *
  * @return JSON string
  */
