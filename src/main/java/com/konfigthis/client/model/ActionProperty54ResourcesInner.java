...
/**
 * ActionProperty54ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty54ResourcesInner {
  ...
  public ActionProperty54ResourcesInner() {
  }

  public ActionProperty54ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty54ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty54ResourcesInner instance itself
   */
  public ActionProperty54ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty54ResourcesInner actionProperty54ResourcesInner = (ActionProperty54ResourcesInner) o;
    return Objects.equals(this.id, actionProperty54ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty54ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty54ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty54ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty54ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty54ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty54ResourcesInner is not found in the empty JSON string", ActionProperty54ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty54ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty54ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty54ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty54ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty54ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty54ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty54ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty54ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty54ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty54ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty54ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty54ResourcesInner
  */
  public static ActionProperty54ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty54ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty54ResourcesInner to an JSON string
  *
  * @return JSON string
  */
