...
public class ActionProperty3ResourcesInner {
  ...
  public ActionProperty3ResourcesInner() {
  }

  public ActionProperty3ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty3ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty3ResourcesInner instance itself
   */
  public ActionProperty3ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty3ResourcesInner actionProperty3ResourcesInner = (ActionProperty3ResourcesInner) o;
    return Objects.equals(this.id, actionProperty3ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty3ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty3ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty3ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty3ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty3ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty3ResourcesInner is not found in the empty JSON string", ActionProperty3ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty3ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty3ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty3ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty3ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty3ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty3ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty3ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty3ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty3ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty3ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty3ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty3ResourcesInner
  */
  public static ActionProperty3ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty3ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty3ResourcesInner to an JSON string
  *
  * @return JSON string
  */
