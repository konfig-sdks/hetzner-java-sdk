...
public class FirewallResourceServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public FirewallResourceServer() {
  }

  public FirewallResourceServer id(Long id) {
  ...
  **/
   ...
   * @return the FirewallResourceServer instance itself
   */
  public FirewallResourceServer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallResourceServer firewallResourceServer = (FirewallResourceServer) o;
    return Objects.equals(this.id, firewallResourceServer.id)&&
        Objects.equals(this.additionalProperties, firewallResourceServer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallResourceServer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallResourceServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallResourceServer is not found in the empty JSON string", FirewallResourceServer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallResourceServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallResourceServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallResourceServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallResourceServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallResourceServer.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallResourceServer>() {
           @Override
           public void write(JsonWriter out, FirewallResourceServer value) throws IOException {
           ...
           @Override
           public FirewallResourceServer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallResourceServer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallResourceServer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallResourceServer
  * @throws IOException if the JSON string is invalid with respect to FirewallResourceServer
  */
  public static FirewallResourceServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallResourceServer.class);
  }

 /**
  * Convert an instance of FirewallResourceServer to an JSON string
  *
  * @return JSON string
  */
