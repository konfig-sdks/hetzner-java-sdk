...
public class DeprecationInfoProperty8 {
  ...
  public DeprecationInfoProperty8() {
  }

  public DeprecationInfoProperty8 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty8 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty8 instance itself
   */
  public DeprecationInfoProperty8 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty8 deprecationInfoProperty8 = (DeprecationInfoProperty8) o;
    return Objects.equals(this.announced, deprecationInfoProperty8.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty8.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty8.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty8 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty8 is not found in the empty JSON string", DeprecationInfoProperty8.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty8.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty8.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty8>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty8 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty8 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty8 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty8
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty8
  */
  public static DeprecationInfoProperty8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty8.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty8 to an JSON string
  *
  * @return JSON string
  */
