...
/**
 * Action14ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action14ResourcesInner {
  ...
  public Action14ResourcesInner() {
  }

  public Action14ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action14ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action14ResourcesInner instance itself
   */
  public Action14ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action14ResourcesInner action14ResourcesInner = (Action14ResourcesInner) o;
    return Objects.equals(this.id, action14ResourcesInner.id) &&
        Objects.equals(this.type, action14ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action14ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action14ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action14ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action14ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action14ResourcesInner is not found in the empty JSON string", Action14ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action14ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action14ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action14ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action14ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action14ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action14ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action14ResourcesInner value) throws IOException {
           ...
           @Override
           public Action14ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action14ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action14ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action14ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action14ResourcesInner
  */
  public static Action14ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action14ResourcesInner.class);
  }

 /**
  * Convert an instance of Action14ResourcesInner to an JSON string
  *
  * @return JSON string
  */
