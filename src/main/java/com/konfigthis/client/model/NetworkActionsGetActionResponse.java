...
import com.konfigthis.client.model.ActionProperty33;
...
public class NetworkActionsGetActionResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty33 action;

  public NetworkActionsGetActionResponse() {
  }

  public NetworkActionsGetActionResponse action(ActionProperty33 action) {
  ...
  **/
  ...
  public ActionProperty33 getAction() {
    return action;
  }


  public void setAction(ActionProperty33 action) {
   ...
   * @return the NetworkActionsGetActionResponse instance itself
   */
  public NetworkActionsGetActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsGetActionResponse networkActionsGetActionResponse = (NetworkActionsGetActionResponse) o;
    return Objects.equals(this.action, networkActionsGetActionResponse.action)&&
        Objects.equals(this.additionalProperties, networkActionsGetActionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsGetActionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsGetActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsGetActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsGetActionResponse is not found in the empty JSON string", NetworkActionsGetActionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsGetActionResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty33.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsGetActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsGetActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsGetActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsGetActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsGetActionResponse>() {
           @Override
           public void write(JsonWriter out, NetworkActionsGetActionResponse value) throws IOException {
           ...
           @Override
           public NetworkActionsGetActionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsGetActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsGetActionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsGetActionResponse
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsGetActionResponse
  */
  public static NetworkActionsGetActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsGetActionResponse.class);
  }

 /**
  * Convert an instance of NetworkActionsGetActionResponse to an JSON string
  *
  * @return JSON string
  */
