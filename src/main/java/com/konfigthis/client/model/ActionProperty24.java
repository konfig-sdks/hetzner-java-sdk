...
import com.konfigthis.client.model.ActionProperty24Error;
import com.konfigthis.client.model.ActionProperty24ResourcesInner;
...
public class ActionProperty24 {
  ...
  private ActionProperty24Error error;
  ...
  private List<ActionProperty24ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty24() {
  }

  public ActionProperty24 command(String command) {
  ...
  **/
  ...
  public ActionProperty24 error(ActionProperty24Error error) {
  ...
  **/
  ...
  public ActionProperty24Error getError() {
    return error;
  }


  public void setError(ActionProperty24Error error) {
  ...
  public ActionProperty24 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty24 id(Long id) {
  ...
  **/
  ...
  public ActionProperty24 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty24 resources(List<ActionProperty24ResourcesInner> resources) {
  ...
  public ActionProperty24 addResourcesItem(ActionProperty24ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty24ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty24ResourcesInner> resources) {
  ...
  public ActionProperty24 started(String started) {
  ...
  **/
  ...
  public ActionProperty24 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty24 instance itself
   */
  public ActionProperty24 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty24 actionProperty24 = (ActionProperty24) o;
    return Objects.equals(this.command, actionProperty24.command) &&
        Objects.equals(this.error, actionProperty24.error) &&
        Objects.equals(this.finished, actionProperty24.finished) &&
        Objects.equals(this.id, actionProperty24.id) &&
        Objects.equals(this.progress, actionProperty24.progress) &&
        Objects.equals(this.resources, actionProperty24.resources) &&
        Objects.equals(this.started, actionProperty24.started) &&
        Objects.equals(this.status, actionProperty24.status)&&
        Objects.equals(this.additionalProperties, actionProperty24.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty24 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty24
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty24.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty24 is not found in the empty JSON string", ActionProperty24.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty24.openapiRequiredFields) {
      ...
      ActionProperty24Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty24ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty24.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty24' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty24> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty24.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty24>() {
           @Override
           public void write(JsonWriter out, ActionProperty24 value) throws IOException {
           ...
           @Override
           public ActionProperty24 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty24 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty24 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty24
  * @throws IOException if the JSON string is invalid with respect to ActionProperty24
  */
  public static ActionProperty24 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty24.class);
  }

 /**
  * Convert an instance of ActionProperty24 to an JSON string
  *
  * @return JSON string
  */
