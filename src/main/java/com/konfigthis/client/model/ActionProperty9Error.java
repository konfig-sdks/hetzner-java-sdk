...
public class ActionProperty9Error {
  ...
  public ActionProperty9Error() {
  }

  public ActionProperty9Error code(String code) {
  ...
  **/
  ...
  public ActionProperty9Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty9Error instance itself
   */
  public ActionProperty9Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty9Error actionProperty9Error = (ActionProperty9Error) o;
    return Objects.equals(this.code, actionProperty9Error.code) &&
        Objects.equals(this.message, actionProperty9Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty9Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty9Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty9Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty9Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty9Error is not found in the empty JSON string", ActionProperty9Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty9Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty9Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty9Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty9Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty9Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty9Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty9Error value) throws IOException {
           ...
           @Override
           public ActionProperty9Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty9Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty9Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty9Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty9Error
  */
  public static ActionProperty9Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty9Error.class);
  }

 /**
  * Convert an instance of ActionProperty9Error to an JSON string
  *
  * @return JSON string
  */
