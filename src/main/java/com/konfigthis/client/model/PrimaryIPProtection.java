...
public class PrimaryIPProtection {
  ...
  public PrimaryIPProtection() {
  }

  public PrimaryIPProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the PrimaryIPProtection instance itself
   */
  public PrimaryIPProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPProtection primaryIPProtection = (PrimaryIPProtection) o;
    return Objects.equals(this.delete, primaryIPProtection.delete)&&
        Objects.equals(this.additionalProperties, primaryIPProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPProtection is not found in the empty JSON string", PrimaryIPProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPProtection>() {
           @Override
           public void write(JsonWriter out, PrimaryIPProtection value) throws IOException {
           ...
           @Override
           public PrimaryIPProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPProtection
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPProtection
  */
  public static PrimaryIPProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPProtection.class);
  }

 /**
  * Convert an instance of PrimaryIPProtection to an JSON string
  *
  * @return JSON string
  */
