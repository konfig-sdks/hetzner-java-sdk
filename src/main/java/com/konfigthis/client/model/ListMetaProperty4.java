...
import com.konfigthis.client.model.ListMetaProperty4Pagination;
...
public class ListMetaProperty4 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty4Pagination pagination;

  public ListMetaProperty4() {
  }

  public ListMetaProperty4 pagination(ListMetaProperty4Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty4Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty4Pagination pagination) {
   ...
   * @return the ListMetaProperty4 instance itself
   */
  public ListMetaProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty4 listMetaProperty4 = (ListMetaProperty4) o;
    return Objects.equals(this.pagination, listMetaProperty4.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty4 is not found in the empty JSON string", ListMetaProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty4.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty4Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty4>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty4 value) throws IOException {
           ...
           @Override
           public ListMetaProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty4
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty4
  */
  public static ListMetaProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty4.class);
  }

 /**
  * Convert an instance of ListMetaProperty4 to an JSON string
  *
  * @return JSON string
  */
