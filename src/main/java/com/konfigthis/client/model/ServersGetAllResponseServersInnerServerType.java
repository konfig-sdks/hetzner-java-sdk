...
import com.konfigthis.client.model.DeprecationInfoProperty5;
import com.konfigthis.client.model.ServersGetAllResponseServersInnerServerTypePricesInner;
...
public class ServersGetAllResponseServersInnerServerType {
 ...
 public enum CpuTypeEnum {
  ...
  private DeprecationInfoProperty5 deprecation;
  ...
  private List<ServersGetAllResponseServersInnerServerTypePricesInner> prices = new ArrayList<>();
 ...
 public enum StorageTypeEnum {
  ...
  public ServersGetAllResponseServersInnerServerType() {
  }

  public ServersGetAllResponseServersInnerServerType description(String description) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType cores(Double cores) {
  ...
  public ServersGetAllResponseServersInnerServerType cores(Integer cores) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType cpuType(CpuTypeEnum cpuType) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType deprecated(Boolean deprecated) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType deprecation(DeprecationInfoProperty5 deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty5 getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty5 deprecation) {
  ...
  public ServersGetAllResponseServersInnerServerType disk(Double disk) {
  ...
  public ServersGetAllResponseServersInnerServerType disk(Integer disk) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType id(Long id) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType includedTraffic(Long includedTraffic) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType memory(Double memory) {
  ...
  public ServersGetAllResponseServersInnerServerType memory(Integer memory) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType name(String name) {
  ...
  **/
  ...
  public ServersGetAllResponseServersInnerServerType prices(List<ServersGetAllResponseServersInnerServerTypePricesInner> prices) {
  ...
  public ServersGetAllResponseServersInnerServerType addPricesItem(ServersGetAllResponseServersInnerServerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<ServersGetAllResponseServersInnerServerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<ServersGetAllResponseServersInnerServerTypePricesInner> prices) {
  ...
  public ServersGetAllResponseServersInnerServerType storageType(StorageTypeEnum storageType) {
  ...
  **/
   ...
   * @return the ServersGetAllResponseServersInnerServerType instance itself
   */
  public ServersGetAllResponseServersInnerServerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGetAllResponseServersInnerServerType serversGetAllResponseServersInnerServerType = (ServersGetAllResponseServersInnerServerType) o;
    return Objects.equals(this.description, serversGetAllResponseServersInnerServerType.description) &&
        Objects.equals(this.architecture, serversGetAllResponseServersInnerServerType.architecture) &&
        Objects.equals(this.cores, serversGetAllResponseServersInnerServerType.cores) &&
        Objects.equals(this.cpuType, serversGetAllResponseServersInnerServerType.cpuType) &&
        Objects.equals(this.deprecated, serversGetAllResponseServersInnerServerType.deprecated) &&
        Objects.equals(this.deprecation, serversGetAllResponseServersInnerServerType.deprecation) &&
        Objects.equals(this.disk, serversGetAllResponseServersInnerServerType.disk) &&
        Objects.equals(this.id, serversGetAllResponseServersInnerServerType.id) &&
        Objects.equals(this.includedTraffic, serversGetAllResponseServersInnerServerType.includedTraffic) &&
        Objects.equals(this.memory, serversGetAllResponseServersInnerServerType.memory) &&
        Objects.equals(this.name, serversGetAllResponseServersInnerServerType.name) &&
        Objects.equals(this.prices, serversGetAllResponseServersInnerServerType.prices) &&
        Objects.equals(this.storageType, serversGetAllResponseServersInnerServerType.storageType)&&
        Objects.equals(this.additionalProperties, serversGetAllResponseServersInnerServerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersGetAllResponseServersInnerServerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersGetAllResponseServersInnerServerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersGetAllResponseServersInnerServerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGetAllResponseServersInnerServerType is not found in the empty JSON string", ServersGetAllResponseServersInnerServerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGetAllResponseServersInnerServerType.openapiRequiredFields) {
      ...
      if (jsonObj.get("deprecation") != null && !jsonObj.get("deprecation").isJsonNull()) {
        DeprecationInfoProperty5.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
      }
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        ServersGetAllResponseServersInnerServerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGetAllResponseServersInnerServerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGetAllResponseServersInnerServerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGetAllResponseServersInnerServerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGetAllResponseServersInnerServerType.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGetAllResponseServersInnerServerType>() {
           @Override
           public void write(JsonWriter out, ServersGetAllResponseServersInnerServerType value) throws IOException {
           ...
           @Override
           public ServersGetAllResponseServersInnerServerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersGetAllResponseServersInnerServerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersGetAllResponseServersInnerServerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersGetAllResponseServersInnerServerType
  * @throws IOException if the JSON string is invalid with respect to ServersGetAllResponseServersInnerServerType
  */
  public static ServersGetAllResponseServersInnerServerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGetAllResponseServersInnerServerType.class);
  }

 /**
  * Convert an instance of ServersGetAllResponseServersInnerServerType to an JSON string
  *
  * @return JSON string
  */
