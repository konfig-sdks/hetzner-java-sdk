...
public class ListMetaProperty16Pagination {
  ...
  public ListMetaProperty16Pagination() {
  }

  public ListMetaProperty16Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty16Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty16Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty16Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty16Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty16Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty16Pagination instance itself
   */
  public ListMetaProperty16Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty16Pagination listMetaProperty16Pagination = (ListMetaProperty16Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty16Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty16Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty16Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty16Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty16Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty16Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty16Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty16Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty16Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty16Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty16Pagination is not found in the empty JSON string", ListMetaProperty16Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty16Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty16Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty16Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty16Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty16Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty16Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty16Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty16Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty16Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty16Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty16Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty16Pagination
  */
  public static ListMetaProperty16Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty16Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty16Pagination to an JSON string
  *
  * @return JSON string
  */
