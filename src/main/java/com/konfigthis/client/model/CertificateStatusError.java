...
public class CertificateStatusError {
  ...
  **/
   ...
   * @return the CertificateStatusError instance itself
   */
  public CertificateStatusError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, certificateStatusError.code) &&
        ...
        Objects.equals(this.additionalProperties, certificateStatusError.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateStatusError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateStatusError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CertificateStatusError>() {
           ...
           public CertificateStatusError read(JsonReader in) throws IOException {
             ...
             CertificateStatusError instance = thisAdapter.fromJsonTree(jsonObj);
