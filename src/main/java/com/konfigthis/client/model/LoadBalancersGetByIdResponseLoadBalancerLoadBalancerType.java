...
import com.konfigthis.client.model.LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner;
...
public class LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType {
  ...
  private List<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner> prices = new ArrayList<>();

  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType() {
  }

  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType description(String description) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType deprecated(String deprecated) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType id(Long id) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType maxAssignedCertificates(Long maxAssignedCertificates) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType maxConnections(Long maxConnections) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType maxServices(Long maxServices) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType maxTargets(Long maxTargets) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType name(String name) {
  ...
  **/
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType prices(List<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner> prices) {
  ...
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType addPricesItem(LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner> prices) {
   ...
   * @return the LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType instance itself
   */
  public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType loadBalancersGetByIdResponseLoadBalancerLoadBalancerType = (LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType) o;
    return Objects.equals(this.description, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.description) &&
        Objects.equals(this.deprecated, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.deprecated) &&
        Objects.equals(this.id, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.id) &&
        Objects.equals(this.maxAssignedCertificates, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.maxAssignedCertificates) &&
        Objects.equals(this.maxConnections, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.maxConnections) &&
        Objects.equals(this.maxServices, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.maxServices) &&
        Objects.equals(this.maxTargets, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.maxTargets) &&
        Objects.equals(this.name, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.name) &&
        Objects.equals(this.prices, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.prices)&&
        Objects.equals(this.additionalProperties, loadBalancersGetByIdResponseLoadBalancerLoadBalancerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType is not found in the empty JSON string", LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType>() {
           @Override
           public void write(JsonWriter out, LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType value) throws IOException {
           ...
           @Override
           public LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType
  */
  public static LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType.class);
  }

 /**
  * Convert an instance of LoadBalancersGetByIdResponseLoadBalancerLoadBalancerType to an JSON string
  *
  * @return JSON string
  */
