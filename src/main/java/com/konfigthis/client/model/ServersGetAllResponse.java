...
import com.konfigthis.client.model.ListMetaProperty29;
import com.konfigthis.client.model.ServersGetAllResponseServersInner;
...
public class ServersGetAllResponse {
  public static final String SERIALIZED_NAME_SERVERS = "servers";
  @SerializedName(SERIALIZED_NAME_SERVERS)
  private List<ServersGetAllResponseServersInner> servers = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty29 meta;

  public ServersGetAllResponse() {
  }

  public ServersGetAllResponse servers(List<ServersGetAllResponseServersInner> servers) {
  ...
  public ServersGetAllResponse addServersItem(ServersGetAllResponseServersInner serversItem) {
  ...
  **/
  ...
  public List<ServersGetAllResponseServersInner> getServers() {
    return servers;
  }


  public void setServers(List<ServersGetAllResponseServersInner> servers) {
  ...
  public ServersGetAllResponse meta(ListMetaProperty29 meta) {
  ...
  **/
  ...
  public ListMetaProperty29 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty29 meta) {
   ...
   * @return the ServersGetAllResponse instance itself
   */
  public ServersGetAllResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGetAllResponse serversGetAllResponse = (ServersGetAllResponse) o;
    return Objects.equals(this.servers, serversGetAllResponse.servers) &&
        Objects.equals(this.meta, serversGetAllResponse.meta)&&
        Objects.equals(this.additionalProperties, serversGetAllResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(servers, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServersGetAllResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersGetAllResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersGetAllResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGetAllResponse is not found in the empty JSON string", ServersGetAllResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGetAllResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayservers.size(); i++) {
        ServersGetAllResponseServersInner.validateJsonObject(jsonArrayservers.get(i).getAsJsonObject());
      };
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty29.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGetAllResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGetAllResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGetAllResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGetAllResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGetAllResponse>() {
           @Override
           public void write(JsonWriter out, ServersGetAllResponse value) throws IOException {
           ...
           @Override
           public ServersGetAllResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersGetAllResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersGetAllResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersGetAllResponse
  * @throws IOException if the JSON string is invalid with respect to ServersGetAllResponse
  */
  public static ServersGetAllResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGetAllResponse.class);
  }

 /**
  * Convert an instance of ServersGetAllResponse to an JSON string
  *
  * @return JSON string
  */
