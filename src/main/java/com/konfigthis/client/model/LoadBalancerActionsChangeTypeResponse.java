...
import com.konfigthis.client.model.ActionProperty25;
...
public class LoadBalancerActionsChangeTypeResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty25 action;

  public LoadBalancerActionsChangeTypeResponse() {
  }

  public LoadBalancerActionsChangeTypeResponse action(ActionProperty25 action) {
  ...
  **/
  ...
  public ActionProperty25 getAction() {
    return action;
  }


  public void setAction(ActionProperty25 action) {
   ...
   * @return the LoadBalancerActionsChangeTypeResponse instance itself
   */
  public LoadBalancerActionsChangeTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsChangeTypeResponse loadBalancerActionsChangeTypeResponse = (LoadBalancerActionsChangeTypeResponse) o;
    return Objects.equals(this.action, loadBalancerActionsChangeTypeResponse.action)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsChangeTypeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsChangeTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsChangeTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsChangeTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsChangeTypeResponse is not found in the empty JSON string", LoadBalancerActionsChangeTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsChangeTypeResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty25.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsChangeTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsChangeTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsChangeTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsChangeTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsChangeTypeResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsChangeTypeResponse value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsChangeTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsChangeTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsChangeTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsChangeTypeResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsChangeTypeResponse
  */
  public static LoadBalancerActionsChangeTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsChangeTypeResponse.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsChangeTypeResponse to an JSON string
  *
  * @return JSON string
  */
