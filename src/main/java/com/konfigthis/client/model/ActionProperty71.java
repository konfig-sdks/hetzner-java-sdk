...
import com.konfigthis.client.model.ActionProperty71Error;
import com.konfigthis.client.model.ActionProperty71ResourcesInner;
...
public class ActionProperty71 {
  ...
  private ActionProperty71Error error;
  ...
  private List<ActionProperty71ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty71() {
  }

  public ActionProperty71 command(String command) {
  ...
  **/
  ...
  public ActionProperty71 error(ActionProperty71Error error) {
  ...
  **/
  ...
  public ActionProperty71Error getError() {
    return error;
  }


  public void setError(ActionProperty71Error error) {
  ...
  public ActionProperty71 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty71 id(Long id) {
  ...
  **/
  ...
  public ActionProperty71 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty71 resources(List<ActionProperty71ResourcesInner> resources) {
  ...
  public ActionProperty71 addResourcesItem(ActionProperty71ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty71ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty71ResourcesInner> resources) {
  ...
  public ActionProperty71 started(String started) {
  ...
  **/
  ...
  public ActionProperty71 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty71 instance itself
   */
  public ActionProperty71 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty71 actionProperty71 = (ActionProperty71) o;
    return Objects.equals(this.command, actionProperty71.command) &&
        Objects.equals(this.error, actionProperty71.error) &&
        Objects.equals(this.finished, actionProperty71.finished) &&
        Objects.equals(this.id, actionProperty71.id) &&
        Objects.equals(this.progress, actionProperty71.progress) &&
        Objects.equals(this.resources, actionProperty71.resources) &&
        Objects.equals(this.started, actionProperty71.started) &&
        Objects.equals(this.status, actionProperty71.status)&&
        Objects.equals(this.additionalProperties, actionProperty71.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty71 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty71
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty71.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty71 is not found in the empty JSON string", ActionProperty71.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty71.openapiRequiredFields) {
      ...
      ActionProperty71Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty71ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty71.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty71' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty71> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty71.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty71>() {
           @Override
           public void write(JsonWriter out, ActionProperty71 value) throws IOException {
           ...
           @Override
           public ActionProperty71 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty71 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty71 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty71
  * @throws IOException if the JSON string is invalid with respect to ActionProperty71
  */
  public static ActionProperty71 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty71.class);
  }

 /**
  * Convert an instance of ActionProperty71 to an JSON string
  *
  * @return JSON string
  */
