 ...
 */
@ApiModel(description = "Describes if, when and how the resource is deprecated. If this field is set to `null` the resource is not deprecated. If a value is set, it is considered deprecated. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DeprecationInfoProperty11 {
  public static final String SERIALIZED_NAME_ANNOUNCED = "announced";
  @SerializedName(SERIALIZED_NAME_ANNOUNCED)
  private String announced;

  public static final String SERIALIZED_NAME_UNAVAILABLE_AFTER = "unavailable_after";
  @SerializedName(SERIALIZED_NAME_UNAVAILABLE_AFTER)
  private String unavailableAfter;

  public DeprecationInfoProperty11() {
  }

  public DeprecationInfoProperty11 announced(String announced) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2023-06-01T00:00:00+00:00", required = true, value = "Date of the deprecation announcement. ")
  ...
  public DeprecationInfoProperty11 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty11 instance itself
   */
  public DeprecationInfoProperty11 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty11 deprecationInfoProperty11 = (DeprecationInfoProperty11) o;
    return Objects.equals(this.announced, deprecationInfoProperty11.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty11.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty11.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(announced, unavailableAfter, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeprecationInfoProperty11 {\n");
    sb.append("    announced: ").append(toIndentedString(announced)).append("\n");
    sb.append("    unavailableAfter: ").append(toIndentedString(unavailableAfter)).append("\n");
  ...
  static {
    ...
    openapiFields.add("announced");
    openapiFields.add("unavailable_after");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("announced");
    openapiRequiredFields.add("unavailable_after");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty11
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty11.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty11 is not found in the empty JSON string", DeprecationInfoProperty11.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty11.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("announced").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `announced` to be a primitive type in the JSON string but got `%s`", jsonObj.get("announced").toString()));
      }
      if (!jsonObj.get("unavailable_after").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `unavailable_after` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unavailable_after").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty11.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty11>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty11 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty11 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty11 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty11 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty11
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty11
  */
  public static DeprecationInfoProperty11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty11.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty11 to an JSON string
  *
  * @return JSON string
  */
