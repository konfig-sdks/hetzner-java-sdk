...
import com.konfigthis.client.model.ActionProperty62Error;
import com.konfigthis.client.model.ActionProperty62ResourcesInner;
...
public class ActionProperty62 {
  ...
  private ActionProperty62Error error;
  ...
  private List<ActionProperty62ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty62() {
  }

  public ActionProperty62 command(String command) {
  ...
  **/
  ...
  public ActionProperty62 error(ActionProperty62Error error) {
  ...
  **/
  ...
  public ActionProperty62Error getError() {
    return error;
  }


  public void setError(ActionProperty62Error error) {
  ...
  public ActionProperty62 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty62 id(Long id) {
  ...
  **/
  ...
  public ActionProperty62 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty62 resources(List<ActionProperty62ResourcesInner> resources) {
  ...
  public ActionProperty62 addResourcesItem(ActionProperty62ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty62ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty62ResourcesInner> resources) {
  ...
  public ActionProperty62 started(String started) {
  ...
  **/
  ...
  public ActionProperty62 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty62 instance itself
   */
  public ActionProperty62 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty62 actionProperty62 = (ActionProperty62) o;
    return Objects.equals(this.command, actionProperty62.command) &&
        Objects.equals(this.error, actionProperty62.error) &&
        Objects.equals(this.finished, actionProperty62.finished) &&
        Objects.equals(this.id, actionProperty62.id) &&
        Objects.equals(this.progress, actionProperty62.progress) &&
        Objects.equals(this.resources, actionProperty62.resources) &&
        Objects.equals(this.started, actionProperty62.started) &&
        Objects.equals(this.status, actionProperty62.status)&&
        Objects.equals(this.additionalProperties, actionProperty62.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty62 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty62
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty62.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty62 is not found in the empty JSON string", ActionProperty62.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty62.openapiRequiredFields) {
      ...
      ActionProperty62Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty62ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty62.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty62' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty62> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty62.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty62>() {
           @Override
           public void write(JsonWriter out, ActionProperty62 value) throws IOException {
           ...
           @Override
           public ActionProperty62 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty62 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty62 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty62
  * @throws IOException if the JSON string is invalid with respect to ActionProperty62
  */
  public static ActionProperty62 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty62.class);
  }

 /**
  * Convert an instance of ActionProperty62 to an JSON string
  *
  * @return JSON string
  */
