...
import com.konfigthis.client.model.ActionProperty64;
...
public class ServerActionsPowerOffServerResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty64 action;

  public ServerActionsPowerOffServerResponse() {
  }

  public ServerActionsPowerOffServerResponse action(ActionProperty64 action) {
  ...
  **/
  ...
  public ActionProperty64 getAction() {
    return action;
  }


  public void setAction(ActionProperty64 action) {
   ...
   * @return the ServerActionsPowerOffServerResponse instance itself
   */
  public ServerActionsPowerOffServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsPowerOffServerResponse serverActionsPowerOffServerResponse = (ServerActionsPowerOffServerResponse) o;
    return Objects.equals(this.action, serverActionsPowerOffServerResponse.action)&&
        Objects.equals(this.additionalProperties, serverActionsPowerOffServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsPowerOffServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsPowerOffServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsPowerOffServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsPowerOffServerResponse is not found in the empty JSON string", ServerActionsPowerOffServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsPowerOffServerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty64.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsPowerOffServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsPowerOffServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsPowerOffServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsPowerOffServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsPowerOffServerResponse>() {
           @Override
           public void write(JsonWriter out, ServerActionsPowerOffServerResponse value) throws IOException {
           ...
           @Override
           public ServerActionsPowerOffServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsPowerOffServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsPowerOffServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsPowerOffServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServerActionsPowerOffServerResponse
  */
  public static ServerActionsPowerOffServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsPowerOffServerResponse.class);
  }

 /**
  * Convert an instance of ServerActionsPowerOffServerResponse to an JSON string
  *
  * @return JSON string
  */
