...
public class ListMetaProperty29Pagination {
  ...
  public ListMetaProperty29Pagination() {
  }

  public ListMetaProperty29Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty29Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty29Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty29Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty29Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty29Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty29Pagination instance itself
   */
  public ListMetaProperty29Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty29Pagination listMetaProperty29Pagination = (ListMetaProperty29Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty29Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty29Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty29Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty29Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty29Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty29Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty29Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty29Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty29Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty29Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty29Pagination is not found in the empty JSON string", ListMetaProperty29Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty29Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty29Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty29Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty29Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty29Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty29Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty29Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty29Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty29Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty29Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty29Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty29Pagination
  */
  public static ListMetaProperty29Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty29Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty29Pagination to an JSON string
  *
  * @return JSON string
  */
