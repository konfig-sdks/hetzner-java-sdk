...
import com.konfigthis.client.model.ActionProperty74Error;
import com.konfigthis.client.model.ActionProperty74ResourcesInner;
...
public class ActionProperty74 {
  ...
  private ActionProperty74Error error;
  ...
  private List<ActionProperty74ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty74() {
  }

  public ActionProperty74 command(String command) {
  ...
  **/
  ...
  public ActionProperty74 error(ActionProperty74Error error) {
  ...
  **/
  ...
  public ActionProperty74Error getError() {
    return error;
  }


  public void setError(ActionProperty74Error error) {
  ...
  public ActionProperty74 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty74 id(Long id) {
  ...
  **/
  ...
  public ActionProperty74 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty74 resources(List<ActionProperty74ResourcesInner> resources) {
  ...
  public ActionProperty74 addResourcesItem(ActionProperty74ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty74ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty74ResourcesInner> resources) {
  ...
  public ActionProperty74 started(String started) {
  ...
  **/
  ...
  public ActionProperty74 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty74 instance itself
   */
  public ActionProperty74 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty74 actionProperty74 = (ActionProperty74) o;
    return Objects.equals(this.command, actionProperty74.command) &&
        Objects.equals(this.error, actionProperty74.error) &&
        Objects.equals(this.finished, actionProperty74.finished) &&
        Objects.equals(this.id, actionProperty74.id) &&
        Objects.equals(this.progress, actionProperty74.progress) &&
        Objects.equals(this.resources, actionProperty74.resources) &&
        Objects.equals(this.started, actionProperty74.started) &&
        Objects.equals(this.status, actionProperty74.status)&&
        Objects.equals(this.additionalProperties, actionProperty74.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty74 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty74
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty74.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty74 is not found in the empty JSON string", ActionProperty74.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty74.openapiRequiredFields) {
      ...
      ActionProperty74Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty74ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty74.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty74' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty74> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty74.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty74>() {
           @Override
           public void write(JsonWriter out, ActionProperty74 value) throws IOException {
           ...
           @Override
           public ActionProperty74 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty74 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty74 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty74
  * @throws IOException if the JSON string is invalid with respect to ActionProperty74
  */
  public static ActionProperty74 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty74.class);
  }

 /**
  * Convert an instance of ActionProperty74 to an JSON string
  *
  * @return JSON string
  */
