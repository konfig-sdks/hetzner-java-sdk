...
public class ListMetaProperty8Pagination {
  ...
  public ListMetaProperty8Pagination() {
  }

  public ListMetaProperty8Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty8Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty8Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty8Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty8Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty8Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty8Pagination instance itself
   */
  public ListMetaProperty8Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty8Pagination listMetaProperty8Pagination = (ListMetaProperty8Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty8Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty8Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty8Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty8Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty8Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty8Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty8Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty8Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty8Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty8Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty8Pagination is not found in the empty JSON string", ListMetaProperty8Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty8Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty8Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty8Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty8Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty8Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty8Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty8Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty8Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty8Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty8Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty8Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty8Pagination
  */
  public static ListMetaProperty8Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty8Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty8Pagination to an JSON string
  *
  * @return JSON string
  */
