...
public class ListMetaProperty32Pagination {
  ...
  public ListMetaProperty32Pagination() {
  }

  public ListMetaProperty32Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty32Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty32Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty32Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty32Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty32Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty32Pagination instance itself
   */
  public ListMetaProperty32Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty32Pagination listMetaProperty32Pagination = (ListMetaProperty32Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty32Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty32Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty32Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty32Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty32Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty32Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty32Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty32Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty32Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty32Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty32Pagination is not found in the empty JSON string", ListMetaProperty32Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty32Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty32Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty32Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty32Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty32Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty32Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty32Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty32Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty32Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty32Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty32Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty32Pagination
  */
  public static ListMetaProperty32Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty32Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty32Pagination to an JSON string
  *
  * @return JSON string
  */
