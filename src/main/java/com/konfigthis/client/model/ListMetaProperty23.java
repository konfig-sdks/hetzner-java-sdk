...
import com.konfigthis.client.model.ListMetaProperty23Pagination;
...
public class ListMetaProperty23 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty23Pagination pagination;

  public ListMetaProperty23() {
  }

  public ListMetaProperty23 pagination(ListMetaProperty23Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty23Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty23Pagination pagination) {
   ...
   * @return the ListMetaProperty23 instance itself
   */
  public ListMetaProperty23 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty23 listMetaProperty23 = (ListMetaProperty23) o;
    return Objects.equals(this.pagination, listMetaProperty23.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty23.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty23 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty23
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty23.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty23 is not found in the empty JSON string", ListMetaProperty23.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty23.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty23Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty23.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty23' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty23> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty23.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty23>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty23 value) throws IOException {
           ...
           @Override
           public ListMetaProperty23 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty23 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty23 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty23
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty23
  */
  public static ListMetaProperty23 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty23.class);
  }

 /**
  * Convert an instance of ListMetaProperty23 to an JSON string
  *
  * @return JSON string
  */
