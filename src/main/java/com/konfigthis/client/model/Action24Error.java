...
public class Action24Error {
  ...
  public Action24Error() {
  }

  public Action24Error code(String code) {
  ...
  **/
  ...
  public Action24Error message(String message) {
  ...
  **/
   ...
   * @return the Action24Error instance itself
   */
  public Action24Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action24Error action24Error = (Action24Error) o;
    return Objects.equals(this.code, action24Error.code) &&
        Objects.equals(this.message, action24Error.message)&&
        Objects.equals(this.additionalProperties, action24Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action24Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action24Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action24Error is not found in the empty JSON string", Action24Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action24Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action24Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action24Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action24Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action24Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action24Error>() {
           @Override
           public void write(JsonWriter out, Action24Error value) throws IOException {
           ...
           @Override
           public Action24Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action24Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action24Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action24Error
  * @throws IOException if the JSON string is invalid with respect to Action24Error
  */
  public static Action24Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action24Error.class);
  }

 /**
  * Convert an instance of Action24Error to an JSON string
  *
  * @return JSON string
  */
