...
import com.konfigthis.client.model.ListMetaProperty30Pagination;
...
public class ListMetaProperty30 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty30Pagination pagination;

  public ListMetaProperty30() {
  }

  public ListMetaProperty30 pagination(ListMetaProperty30Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty30Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty30Pagination pagination) {
   ...
   * @return the ListMetaProperty30 instance itself
   */
  public ListMetaProperty30 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty30 listMetaProperty30 = (ListMetaProperty30) o;
    return Objects.equals(this.pagination, listMetaProperty30.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty30.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty30 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty30
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty30.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty30 is not found in the empty JSON string", ListMetaProperty30.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty30.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty30Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty30.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty30' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty30> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty30.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty30>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty30 value) throws IOException {
           ...
           @Override
           public ListMetaProperty30 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty30 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty30 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty30
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty30
  */
  public static ListMetaProperty30 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty30.class);
  }

 /**
  * Convert an instance of ListMetaProperty30 to an JSON string
  *
  * @return JSON string
  */
