...
import com.konfigthis.client.model.ListMetaProperty20Pagination;
...
public class ListMetaProperty20 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty20Pagination pagination;

  public ListMetaProperty20() {
  }

  public ListMetaProperty20 pagination(ListMetaProperty20Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty20Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty20Pagination pagination) {
   ...
   * @return the ListMetaProperty20 instance itself
   */
  public ListMetaProperty20 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty20 listMetaProperty20 = (ListMetaProperty20) o;
    return Objects.equals(this.pagination, listMetaProperty20.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty20.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty20 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty20
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty20.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty20 is not found in the empty JSON string", ListMetaProperty20.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty20.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty20Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty20.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty20' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty20> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty20.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty20>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty20 value) throws IOException {
           ...
           @Override
           public ListMetaProperty20 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty20 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty20 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty20
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty20
  */
  public static ListMetaProperty20 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty20.class);
  }

 /**
  * Convert an instance of ListMetaProperty20 to an JSON string
  *
  * @return JSON string
  */
