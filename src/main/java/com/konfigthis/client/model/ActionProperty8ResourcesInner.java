...
/**
 * ActionProperty8ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty8ResourcesInner {
  ...
  public ActionProperty8ResourcesInner() {
  }

  public ActionProperty8ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty8ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty8ResourcesInner instance itself
   */
  public ActionProperty8ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty8ResourcesInner actionProperty8ResourcesInner = (ActionProperty8ResourcesInner) o;
    return Objects.equals(this.id, actionProperty8ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty8ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty8ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty8ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty8ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty8ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty8ResourcesInner is not found in the empty JSON string", ActionProperty8ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty8ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty8ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty8ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty8ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty8ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty8ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty8ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty8ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty8ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty8ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty8ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty8ResourcesInner
  */
  public static ActionProperty8ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty8ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty8ResourcesInner to an JSON string
  *
  * @return JSON string
  */
