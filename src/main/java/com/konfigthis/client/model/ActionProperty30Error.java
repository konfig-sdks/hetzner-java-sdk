...
public class ActionProperty30Error {
  ...
  public ActionProperty30Error() {
  }

  public ActionProperty30Error code(String code) {
  ...
  **/
  ...
  public ActionProperty30Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty30Error instance itself
   */
  public ActionProperty30Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty30Error actionProperty30Error = (ActionProperty30Error) o;
    return Objects.equals(this.code, actionProperty30Error.code) &&
        Objects.equals(this.message, actionProperty30Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty30Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty30Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty30Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty30Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty30Error is not found in the empty JSON string", ActionProperty30Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty30Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty30Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty30Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty30Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty30Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty30Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty30Error value) throws IOException {
           ...
           @Override
           public ActionProperty30Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty30Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty30Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty30Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty30Error
  */
  public static ActionProperty30Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty30Error.class);
  }

 /**
  * Convert an instance of ActionProperty30Error to an JSON string
  *
  * @return JSON string
  */
