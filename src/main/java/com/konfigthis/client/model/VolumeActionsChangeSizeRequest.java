...
public class VolumeActionsChangeSizeRequest {
  public static final String SERIALIZED_NAME_SIZE = "size";
  @SerializedName(SERIALIZED_NAME_SIZE)
  private Double size;

  public VolumeActionsChangeSizeRequest() {
  }

  public VolumeActionsChangeSizeRequest size(Double size) {
  ...
  public VolumeActionsChangeSizeRequest size(Integer size) {
  ...
  **/
  ...
  @ApiModelProperty(example = "50", required = true, value = "New Volume size in GB (must be greater than current size)")
   ...
   * @return the VolumeActionsChangeSizeRequest instance itself
   */
  public VolumeActionsChangeSizeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeActionsChangeSizeRequest volumeActionsChangeSizeRequest = (VolumeActionsChangeSizeRequest) o;
    return Objects.equals(this.size, volumeActionsChangeSizeRequest.size)&&
        Objects.equals(this.additionalProperties, volumeActionsChangeSizeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumeActionsChangeSizeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionsChangeSizeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionsChangeSizeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionsChangeSizeRequest is not found in the empty JSON string", VolumeActionsChangeSizeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionsChangeSizeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionsChangeSizeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionsChangeSizeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionsChangeSizeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionsChangeSizeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionsChangeSizeRequest>() {
           @Override
           public void write(JsonWriter out, VolumeActionsChangeSizeRequest value) throws IOException {
           ...
           @Override
           public VolumeActionsChangeSizeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionsChangeSizeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionsChangeSizeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionsChangeSizeRequest
  * @throws IOException if the JSON string is invalid with respect to VolumeActionsChangeSizeRequest
  */
  public static VolumeActionsChangeSizeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionsChangeSizeRequest.class);
  }

 /**
  * Convert an instance of VolumeActionsChangeSizeRequest to an JSON string
  *
  * @return JSON string
  */
