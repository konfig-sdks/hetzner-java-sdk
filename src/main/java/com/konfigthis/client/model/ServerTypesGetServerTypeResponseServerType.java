...
import com.konfigthis.client.model.DeprecationInfoProperty3;
import com.konfigthis.client.model.ServerTypesGetServerTypeResponseServerTypePricesInner;
...
public class ServerTypesGetServerTypeResponseServerType {
 ...
 public enum CpuTypeEnum {
  ...
  private DeprecationInfoProperty3 deprecation;
  ...
  private List<ServerTypesGetServerTypeResponseServerTypePricesInner> prices = new ArrayList<>();
 ...
 public enum StorageTypeEnum {
  ...
  public ServerTypesGetServerTypeResponseServerType() {
  }

  public ServerTypesGetServerTypeResponseServerType description(String description) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType architecture(ArchitectureEnum architecture) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType cores(Double cores) {
  ...
  public ServerTypesGetServerTypeResponseServerType cores(Integer cores) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType cpuType(CpuTypeEnum cpuType) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType deprecated(Boolean deprecated) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType deprecation(DeprecationInfoProperty3 deprecation) {
  ...
  **/
  ...
  public DeprecationInfoProperty3 getDeprecation() {
    return deprecation;
  }


  public void setDeprecation(DeprecationInfoProperty3 deprecation) {
  ...
  public ServerTypesGetServerTypeResponseServerType disk(Double disk) {
  ...
  public ServerTypesGetServerTypeResponseServerType disk(Integer disk) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType id(Long id) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType includedTraffic(Long includedTraffic) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType memory(Double memory) {
  ...
  public ServerTypesGetServerTypeResponseServerType memory(Integer memory) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType name(String name) {
  ...
  **/
  ...
  public ServerTypesGetServerTypeResponseServerType prices(List<ServerTypesGetServerTypeResponseServerTypePricesInner> prices) {
  ...
  public ServerTypesGetServerTypeResponseServerType addPricesItem(ServerTypesGetServerTypeResponseServerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<ServerTypesGetServerTypeResponseServerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<ServerTypesGetServerTypeResponseServerTypePricesInner> prices) {
  ...
  public ServerTypesGetServerTypeResponseServerType storageType(StorageTypeEnum storageType) {
  ...
  **/
   ...
   * @return the ServerTypesGetServerTypeResponseServerType instance itself
   */
  public ServerTypesGetServerTypeResponseServerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerTypesGetServerTypeResponseServerType serverTypesGetServerTypeResponseServerType = (ServerTypesGetServerTypeResponseServerType) o;
    return Objects.equals(this.description, serverTypesGetServerTypeResponseServerType.description) &&
        Objects.equals(this.architecture, serverTypesGetServerTypeResponseServerType.architecture) &&
        Objects.equals(this.cores, serverTypesGetServerTypeResponseServerType.cores) &&
        Objects.equals(this.cpuType, serverTypesGetServerTypeResponseServerType.cpuType) &&
        Objects.equals(this.deprecated, serverTypesGetServerTypeResponseServerType.deprecated) &&
        Objects.equals(this.deprecation, serverTypesGetServerTypeResponseServerType.deprecation) &&
        Objects.equals(this.disk, serverTypesGetServerTypeResponseServerType.disk) &&
        Objects.equals(this.id, serverTypesGetServerTypeResponseServerType.id) &&
        Objects.equals(this.includedTraffic, serverTypesGetServerTypeResponseServerType.includedTraffic) &&
        Objects.equals(this.memory, serverTypesGetServerTypeResponseServerType.memory) &&
        Objects.equals(this.name, serverTypesGetServerTypeResponseServerType.name) &&
        Objects.equals(this.prices, serverTypesGetServerTypeResponseServerType.prices) &&
        Objects.equals(this.storageType, serverTypesGetServerTypeResponseServerType.storageType)&&
        Objects.equals(this.additionalProperties, serverTypesGetServerTypeResponseServerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerTypesGetServerTypeResponseServerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerTypesGetServerTypeResponseServerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerTypesGetServerTypeResponseServerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerTypesGetServerTypeResponseServerType is not found in the empty JSON string", ServerTypesGetServerTypeResponseServerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerTypesGetServerTypeResponseServerType.openapiRequiredFields) {
      ...
      if (jsonObj.get("deprecation") != null && !jsonObj.get("deprecation").isJsonNull()) {
        DeprecationInfoProperty3.validateJsonObject(jsonObj.getAsJsonObject("deprecation"));
      }
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        ServerTypesGetServerTypeResponseServerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerTypesGetServerTypeResponseServerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerTypesGetServerTypeResponseServerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerTypesGetServerTypeResponseServerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerTypesGetServerTypeResponseServerType.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerTypesGetServerTypeResponseServerType>() {
           @Override
           public void write(JsonWriter out, ServerTypesGetServerTypeResponseServerType value) throws IOException {
           ...
           @Override
           public ServerTypesGetServerTypeResponseServerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerTypesGetServerTypeResponseServerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerTypesGetServerTypeResponseServerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerTypesGetServerTypeResponseServerType
  * @throws IOException if the JSON string is invalid with respect to ServerTypesGetServerTypeResponseServerType
  */
  public static ServerTypesGetServerTypeResponseServerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerTypesGetServerTypeResponseServerType.class);
  }

 /**
  * Convert an instance of ServerTypesGetServerTypeResponseServerType to an JSON string
  *
  * @return JSON string
  */
