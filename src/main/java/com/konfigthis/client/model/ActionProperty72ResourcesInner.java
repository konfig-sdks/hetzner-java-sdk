...
/**
 * ActionProperty72ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty72ResourcesInner {
  ...
  public ActionProperty72ResourcesInner() {
  }

  public ActionProperty72ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty72ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty72ResourcesInner instance itself
   */
  public ActionProperty72ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty72ResourcesInner actionProperty72ResourcesInner = (ActionProperty72ResourcesInner) o;
    return Objects.equals(this.id, actionProperty72ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty72ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty72ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty72ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty72ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty72ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty72ResourcesInner is not found in the empty JSON string", ActionProperty72ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty72ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty72ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty72ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty72ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty72ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty72ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty72ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty72ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty72ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty72ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty72ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty72ResourcesInner
  */
  public static ActionProperty72ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty72ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty72ResourcesInner to an JSON string
  *
  * @return JSON string
  */
