...
public class DeprecationInfoProperty7 {
  ...
  public DeprecationInfoProperty7() {
  }

  public DeprecationInfoProperty7 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty7 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty7 instance itself
   */
  public DeprecationInfoProperty7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty7 deprecationInfoProperty7 = (DeprecationInfoProperty7) o;
    return Objects.equals(this.announced, deprecationInfoProperty7.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty7.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty7.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty7 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty7 is not found in the empty JSON string", DeprecationInfoProperty7.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty7.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty7.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty7>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty7 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty7
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty7
  */
  public static DeprecationInfoProperty7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty7.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty7 to an JSON string
  *
  * @return JSON string
  */
