...
import com.konfigthis.client.model.Action1;
import com.konfigthis.client.model.ListMetaProperty;
...
public class ActionListResponse {
  ...
  private List<Action1> actions = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty meta;

  public ActionListResponse() {
  }

  public ActionListResponse actions(List<Action1> actions) {
  ...
  public ActionListResponse addActionsItem(Action1 actionsItem) {
  ...
  **/
  ...
  public void setActions(List<Action1> actions) {
  ...
  public ActionListResponse meta(ListMetaProperty meta) {
  ...
  **/
  ...
  public ListMetaProperty getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty meta) {
   ...
   * @return the ActionListResponse instance itself
   */
  public ActionListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actions, actionListResponse.actions) &&
        Objects.equals(this.meta, actionListResponse.meta)&&
        Objects.equals(this.additionalProperties, actionListResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionListResponse is not found in the empty JSON string", ActionListResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionListResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayactions.size(); i++) {
        Action1.validateJsonObject(jsonArrayactions.get(i).getAsJsonObject());
      };
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionListResponse>() {
           @Override
           public void write(JsonWriter out, ActionListResponse value) throws IOException {
           ...
           @Override
           public ActionListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionListResponse
  * @throws IOException if the JSON string is invalid with respect to ActionListResponse
  */
  public static ActionListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionListResponse.class);
  }

 /**
  * Convert an instance of ActionListResponse to an JSON string
  *
  * @return JSON string
  */
