...
import com.konfigthis.client.model.ListMetaProperty27Pagination;
...
public class ListMetaProperty27 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty27Pagination pagination;

  public ListMetaProperty27() {
  }

  public ListMetaProperty27 pagination(ListMetaProperty27Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty27Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty27Pagination pagination) {
   ...
   * @return the ListMetaProperty27 instance itself
   */
  public ListMetaProperty27 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty27 listMetaProperty27 = (ListMetaProperty27) o;
    return Objects.equals(this.pagination, listMetaProperty27.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty27.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty27 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty27
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty27.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty27 is not found in the empty JSON string", ListMetaProperty27.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty27.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty27Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty27.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty27' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty27> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty27.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty27>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty27 value) throws IOException {
           ...
           @Override
           public ListMetaProperty27 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty27 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty27 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty27
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty27
  */
  public static ListMetaProperty27 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty27.class);
  }

 /**
  * Convert an instance of ListMetaProperty27 to an JSON string
  *
  * @return JSON string
  */
