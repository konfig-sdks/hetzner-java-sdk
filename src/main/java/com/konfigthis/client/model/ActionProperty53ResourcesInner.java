...
/**
 * ActionProperty53ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty53ResourcesInner {
  ...
  public ActionProperty53ResourcesInner() {
  }

  public ActionProperty53ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty53ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty53ResourcesInner instance itself
   */
  public ActionProperty53ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty53ResourcesInner actionProperty53ResourcesInner = (ActionProperty53ResourcesInner) o;
    return Objects.equals(this.id, actionProperty53ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty53ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty53ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty53ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty53ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty53ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty53ResourcesInner is not found in the empty JSON string", ActionProperty53ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty53ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty53ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty53ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty53ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty53ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty53ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty53ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty53ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty53ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty53ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty53ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty53ResourcesInner
  */
  public static ActionProperty53ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty53ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty53ResourcesInner to an JSON string
  *
  * @return JSON string
  */
