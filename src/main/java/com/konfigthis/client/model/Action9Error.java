...
public class Action9Error {
  ...
  public Action9Error code(String code) {
  ...
  **/
  ...
  public Action9Error message(String message) {
  ...
  **/
   ...
   * @return the Action9Error instance itself
   */
  public Action9Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action9Error action9Error = (Action9Error) o;
    return Objects.equals(this.code, action9Error.code) &&
        Objects.equals(this.message, action9Error.message)&&
        Objects.equals(this.additionalProperties, action9Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action9Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action9Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action9Error is not found in the empty JSON string", Action9Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action9Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action9Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action9Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action9Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action9Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action9Error>() {
           @Override
           public void write(JsonWriter out, Action9Error value) throws IOException {
           ...
           @Override
           public Action9Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action9Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action9Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action9Error
  * @throws IOException if the JSON string is invalid with respect to Action9Error
  */
  public static Action9Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action9Error.class);
  }

 /**
  * Convert an instance of Action9Error to an JSON string
  *
  * @return JSON string
  */
