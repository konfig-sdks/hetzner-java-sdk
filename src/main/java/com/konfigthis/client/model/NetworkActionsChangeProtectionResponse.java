...
import com.konfigthis.client.model.ActionProperty37;
...
public class NetworkActionsChangeProtectionResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty37 action;

  public NetworkActionsChangeProtectionResponse() {
  }

  public NetworkActionsChangeProtectionResponse action(ActionProperty37 action) {
  ...
  **/
  ...
  public ActionProperty37 getAction() {
    return action;
  }


  public void setAction(ActionProperty37 action) {
   ...
   * @return the NetworkActionsChangeProtectionResponse instance itself
   */
  public NetworkActionsChangeProtectionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsChangeProtectionResponse networkActionsChangeProtectionResponse = (NetworkActionsChangeProtectionResponse) o;
    return Objects.equals(this.action, networkActionsChangeProtectionResponse.action)&&
        Objects.equals(this.additionalProperties, networkActionsChangeProtectionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsChangeProtectionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsChangeProtectionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsChangeProtectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsChangeProtectionResponse is not found in the empty JSON string", NetworkActionsChangeProtectionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsChangeProtectionResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty37.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsChangeProtectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsChangeProtectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsChangeProtectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsChangeProtectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsChangeProtectionResponse>() {
           @Override
           public void write(JsonWriter out, NetworkActionsChangeProtectionResponse value) throws IOException {
           ...
           @Override
           public NetworkActionsChangeProtectionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsChangeProtectionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsChangeProtectionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsChangeProtectionResponse
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsChangeProtectionResponse
  */
  public static NetworkActionsChangeProtectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsChangeProtectionResponse.class);
  }

 /**
  * Convert an instance of NetworkActionsChangeProtectionResponse to an JSON string
  *
  * @return JSON string
  */
