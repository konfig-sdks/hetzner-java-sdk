...
public class ActionProperty40Error {
  ...
  public ActionProperty40Error() {
  }

  public ActionProperty40Error code(String code) {
  ...
  **/
  ...
  public ActionProperty40Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty40Error instance itself
   */
  public ActionProperty40Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty40Error actionProperty40Error = (ActionProperty40Error) o;
    return Objects.equals(this.code, actionProperty40Error.code) &&
        Objects.equals(this.message, actionProperty40Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty40Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty40Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty40Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty40Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty40Error is not found in the empty JSON string", ActionProperty40Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty40Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty40Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty40Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty40Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty40Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty40Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty40Error value) throws IOException {
           ...
           @Override
           public ActionProperty40Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty40Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty40Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty40Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty40Error
  */
  public static ActionProperty40Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty40Error.class);
  }

 /**
  * Convert an instance of ActionProperty40Error to an JSON string
  *
  * @return JSON string
  */
