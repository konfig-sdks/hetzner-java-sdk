...
public class ActionProperty29Error {
  ...
  public ActionProperty29Error() {
  }

  public ActionProperty29Error code(String code) {
  ...
  **/
  ...
  public ActionProperty29Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty29Error instance itself
   */
  public ActionProperty29Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty29Error actionProperty29Error = (ActionProperty29Error) o;
    return Objects.equals(this.code, actionProperty29Error.code) &&
        Objects.equals(this.message, actionProperty29Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty29Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty29Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty29Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty29Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty29Error is not found in the empty JSON string", ActionProperty29Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty29Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty29Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty29Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty29Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty29Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty29Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty29Error value) throws IOException {
           ...
           @Override
           public ActionProperty29Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty29Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty29Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty29Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty29Error
  */
  public static ActionProperty29Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty29Error.class);
  }

 /**
  * Convert an instance of ActionProperty29Error to an JSON string
  *
  * @return JSON string
  */
