...
public class PaginationOffsetPagination {
  ...
  public PaginationOffsetPagination() {
  }

  public PaginationOffsetPagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public PaginationOffsetPagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public PaginationOffsetPagination page(Long page) {
  ...
  **/
  ...
  public PaginationOffsetPagination perPage(Long perPage) {
  ...
  **/
  ...
  public PaginationOffsetPagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public PaginationOffsetPagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the PaginationOffsetPagination instance itself
   */
  public PaginationOffsetPagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PaginationOffsetPagination paginationOffsetPagination = (PaginationOffsetPagination) o;
    return Objects.equals(this.lastPage, paginationOffsetPagination.lastPage) &&
        Objects.equals(this.nextPage, paginationOffsetPagination.nextPage) &&
        Objects.equals(this.page, paginationOffsetPagination.page) &&
        Objects.equals(this.perPage, paginationOffsetPagination.perPage) &&
        Objects.equals(this.previousPage, paginationOffsetPagination.previousPage) &&
        Objects.equals(this.totalEntries, paginationOffsetPagination.totalEntries)&&
        Objects.equals(this.additionalProperties, paginationOffsetPagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginationOffsetPagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaginationOffsetPagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaginationOffsetPagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginationOffsetPagination is not found in the empty JSON string", PaginationOffsetPagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaginationOffsetPagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginationOffsetPagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginationOffsetPagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginationOffsetPagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginationOffsetPagination.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginationOffsetPagination>() {
           @Override
           public void write(JsonWriter out, PaginationOffsetPagination value) throws IOException {
           ...
           @Override
           public PaginationOffsetPagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PaginationOffsetPagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PaginationOffsetPagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaginationOffsetPagination
  * @throws IOException if the JSON string is invalid with respect to PaginationOffsetPagination
  */
  public static PaginationOffsetPagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginationOffsetPagination.class);
  }

 /**
  * Convert an instance of PaginationOffsetPagination to an JSON string
  *
  * @return JSON string
  */
