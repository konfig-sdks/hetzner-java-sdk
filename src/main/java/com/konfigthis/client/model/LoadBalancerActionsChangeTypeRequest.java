...
public class LoadBalancerActionsChangeTypeRequest {
  ...
  public LoadBalancerActionsChangeTypeRequest() {
  }

  public LoadBalancerActionsChangeTypeRequest loadBalancerType(String loadBalancerType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "lb21", required = true, value = "ID or name of Load Balancer type the Load Balancer should migrate to")
   ...
   * @return the LoadBalancerActionsChangeTypeRequest instance itself
   */
  public LoadBalancerActionsChangeTypeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerActionsChangeTypeRequest loadBalancerActionsChangeTypeRequest = (LoadBalancerActionsChangeTypeRequest) o;
    return Objects.equals(this.loadBalancerType, loadBalancerActionsChangeTypeRequest.loadBalancerType)&&
        Objects.equals(this.additionalProperties, loadBalancerActionsChangeTypeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerActionsChangeTypeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerActionsChangeTypeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerActionsChangeTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerActionsChangeTypeRequest is not found in the empty JSON string", LoadBalancerActionsChangeTypeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerActionsChangeTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerActionsChangeTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerActionsChangeTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerActionsChangeTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerActionsChangeTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerActionsChangeTypeRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancerActionsChangeTypeRequest value) throws IOException {
           ...
           @Override
           public LoadBalancerActionsChangeTypeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerActionsChangeTypeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerActionsChangeTypeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerActionsChangeTypeRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerActionsChangeTypeRequest
  */
  public static LoadBalancerActionsChangeTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerActionsChangeTypeRequest.class);
  }

 /**
  * Convert an instance of LoadBalancerActionsChangeTypeRequest to an JSON string
  *
  * @return JSON string
  */
