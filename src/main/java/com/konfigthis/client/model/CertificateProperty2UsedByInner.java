...
public class CertificateProperty2UsedByInner {
  ...
  public CertificateProperty2UsedByInner() {
  }

  public CertificateProperty2UsedByInner id(Long id) {
  ...
  **/
  ...
  public CertificateProperty2UsedByInner type(String type) {
  ...
  **/
   ...
   * @return the CertificateProperty2UsedByInner instance itself
   */
  public CertificateProperty2UsedByInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateProperty2UsedByInner certificateProperty2UsedByInner = (CertificateProperty2UsedByInner) o;
    return Objects.equals(this.id, certificateProperty2UsedByInner.id) &&
        Objects.equals(this.type, certificateProperty2UsedByInner.type)&&
        Objects.equals(this.additionalProperties, certificateProperty2UsedByInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateProperty2UsedByInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateProperty2UsedByInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateProperty2UsedByInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateProperty2UsedByInner is not found in the empty JSON string", CertificateProperty2UsedByInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateProperty2UsedByInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateProperty2UsedByInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateProperty2UsedByInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateProperty2UsedByInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateProperty2UsedByInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateProperty2UsedByInner>() {
           @Override
           public void write(JsonWriter out, CertificateProperty2UsedByInner value) throws IOException {
           ...
           @Override
           public CertificateProperty2UsedByInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateProperty2UsedByInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateProperty2UsedByInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateProperty2UsedByInner
  * @throws IOException if the JSON string is invalid with respect to CertificateProperty2UsedByInner
  */
  public static CertificateProperty2UsedByInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateProperty2UsedByInner.class);
  }

 /**
  * Convert an instance of CertificateProperty2UsedByInner to an JSON string
  *
  * @return JSON string
  */
