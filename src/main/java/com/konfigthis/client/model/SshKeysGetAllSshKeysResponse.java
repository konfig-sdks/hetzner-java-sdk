...
import com.konfigthis.client.model.ListMetaProperty32;
import com.konfigthis.client.model.SshKeysGetAllSshKeysResponseSshKeysInner;
...
public class SshKeysGetAllSshKeysResponse {
  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private ListMetaProperty32 meta;

  public static final String SERIALIZED_NAME_SSH_KEYS = "ssh_keys";
  @SerializedName(SERIALIZED_NAME_SSH_KEYS)
  private List<SshKeysGetAllSshKeysResponseSshKeysInner> sshKeys = new ArrayList<>();

  public SshKeysGetAllSshKeysResponse() {
  }

  public SshKeysGetAllSshKeysResponse meta(ListMetaProperty32 meta) {
  ...
  **/
  ...
  public ListMetaProperty32 getMeta() {
    return meta;
  }


  public void setMeta(ListMetaProperty32 meta) {
  ...
  public SshKeysGetAllSshKeysResponse sshKeys(List<SshKeysGetAllSshKeysResponseSshKeysInner> sshKeys) {
  ...
  public SshKeysGetAllSshKeysResponse addSshKeysItem(SshKeysGetAllSshKeysResponseSshKeysInner sshKeysItem) {
  ...
  **/
  ...
  public List<SshKeysGetAllSshKeysResponseSshKeysInner> getSshKeys() {
    return sshKeys;
  }


  public void setSshKeys(List<SshKeysGetAllSshKeysResponseSshKeysInner> sshKeys) {
   ...
   * @return the SshKeysGetAllSshKeysResponse instance itself
   */
  public SshKeysGetAllSshKeysResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysGetAllSshKeysResponse sshKeysGetAllSshKeysResponse = (SshKeysGetAllSshKeysResponse) o;
    return Objects.equals(this.meta, sshKeysGetAllSshKeysResponse.meta) &&
        Objects.equals(this.sshKeys, sshKeysGetAllSshKeysResponse.sshKeys)&&
        Objects.equals(this.additionalProperties, sshKeysGetAllSshKeysResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, sshKeys, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeysGetAllSshKeysResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysGetAllSshKeysResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysGetAllSshKeysResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysGetAllSshKeysResponse is not found in the empty JSON string", SshKeysGetAllSshKeysResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysGetAllSshKeysResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        ListMetaProperty32.validateJsonObject(jsonObj.getAsJsonObject("meta"));
      }
      ...
      for (int i = 0; i < jsonArraysshKeys.size(); i++) {
        SshKeysGetAllSshKeysResponseSshKeysInner.validateJsonObject(jsonArraysshKeys.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysGetAllSshKeysResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysGetAllSshKeysResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysGetAllSshKeysResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysGetAllSshKeysResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysGetAllSshKeysResponse>() {
           @Override
           public void write(JsonWriter out, SshKeysGetAllSshKeysResponse value) throws IOException {
           ...
           @Override
           public SshKeysGetAllSshKeysResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysGetAllSshKeysResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysGetAllSshKeysResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysGetAllSshKeysResponse
  * @throws IOException if the JSON string is invalid with respect to SshKeysGetAllSshKeysResponse
  */
  public static SshKeysGetAllSshKeysResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysGetAllSshKeysResponse.class);
  }

 /**
  * Convert an instance of SshKeysGetAllSshKeysResponse to an JSON string
  *
  * @return JSON string
  */
