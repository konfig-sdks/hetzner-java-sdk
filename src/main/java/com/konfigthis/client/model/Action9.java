...
import com.konfigthis.client.model.Action9Error;
import com.konfigthis.client.model.Action9ResourcesInner;
...
public class Action9 {
  ...
  private List<Action9ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action9 command(String command) {
  ...
  **/
  ...
  public Action9 error(Action9Error error) {
  ...
  **/
  ...
  public Action9Error getError() {
    return error;
  }


  public void setError(Action9Error error) {
  ...
  public Action9 finished(String finished) {
  ...
  **/
  ...
  public Action9 progress(Integer progress) {
  ...
  **/
  ...
  public Action9 resources(List<Action9ResourcesInner> resources) {
  ...
  public Action9 addResourcesItem(Action9ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action9ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action9ResourcesInner> resources) {
  ...
  public Action9 started(String started) {
  ...
  **/
  ...
  public Action9 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action9 instance itself
   */
  public Action9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action9 action9 = (Action9) o;
    return Objects.equals(this.command, action9.command) &&
        Objects.equals(this.error, action9.error) &&
        Objects.equals(this.finished, action9.finished) &&
        Objects.equals(this.id, action9.id) &&
        Objects.equals(this.progress, action9.progress) &&
        Objects.equals(this.resources, action9.resources) &&
        Objects.equals(this.started, action9.started) &&
        Objects.equals(this.status, action9.status)&&
        Objects.equals(this.additionalProperties, action9.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action9 is not found in the empty JSON string", Action9.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action9.openapiRequiredFields) {
      ...
      Action9Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action9ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action9.class));

       return (TypeAdapter<T>) new TypeAdapter<Action9>() {
           @Override
           public void write(JsonWriter out, Action9 value) throws IOException {
           ...
           @Override
           public Action9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action9
  * @throws IOException if the JSON string is invalid with respect to Action9
  */
  public static Action9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action9.class);
  }

 /**
  * Convert an instance of Action9 to an JSON string
  *
  * @return JSON string
  */
