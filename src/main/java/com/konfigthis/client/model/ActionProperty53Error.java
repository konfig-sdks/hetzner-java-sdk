...
public class ActionProperty53Error {
  ...
  public ActionProperty53Error() {
  }

  public ActionProperty53Error code(String code) {
  ...
  **/
  ...
  public ActionProperty53Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty53Error instance itself
   */
  public ActionProperty53Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty53Error actionProperty53Error = (ActionProperty53Error) o;
    return Objects.equals(this.code, actionProperty53Error.code) &&
        Objects.equals(this.message, actionProperty53Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty53Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty53Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty53Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty53Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty53Error is not found in the empty JSON string", ActionProperty53Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty53Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty53Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty53Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty53Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty53Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty53Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty53Error value) throws IOException {
           ...
           @Override
           public ActionProperty53Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty53Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty53Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty53Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty53Error
  */
  public static ActionProperty53Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty53Error.class);
  }

 /**
  * Convert an instance of ActionProperty53Error to an JSON string
  *
  * @return JSON string
  */
