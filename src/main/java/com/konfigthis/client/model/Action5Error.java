...
public class Action5Error {
  ...
  public Action5Error code(String code) {
  ...
  **/
  ...
  public Action5Error message(String message) {
  ...
  **/
   ...
   * @return the Action5Error instance itself
   */
  public Action5Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action5Error action5Error = (Action5Error) o;
    return Objects.equals(this.code, action5Error.code) &&
        Objects.equals(this.message, action5Error.message)&&
        Objects.equals(this.additionalProperties, action5Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action5Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action5Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action5Error is not found in the empty JSON string", Action5Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action5Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action5Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action5Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action5Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action5Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action5Error>() {
           @Override
           public void write(JsonWriter out, Action5Error value) throws IOException {
           ...
           @Override
           public Action5Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action5Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action5Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action5Error
  * @throws IOException if the JSON string is invalid with respect to Action5Error
  */
  public static Action5Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action5Error.class);
  }

 /**
  * Convert an instance of Action5Error to an JSON string
  *
  * @return JSON string
  */
