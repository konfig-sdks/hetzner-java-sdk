...
/**
 * ActionProperty63ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty63ResourcesInner {
  ...
  public ActionProperty63ResourcesInner() {
  }

  public ActionProperty63ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty63ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty63ResourcesInner instance itself
   */
  public ActionProperty63ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty63ResourcesInner actionProperty63ResourcesInner = (ActionProperty63ResourcesInner) o;
    return Objects.equals(this.id, actionProperty63ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty63ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty63ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty63ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty63ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty63ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty63ResourcesInner is not found in the empty JSON string", ActionProperty63ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty63ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty63ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty63ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty63ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty63ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty63ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty63ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty63ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty63ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty63ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty63ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty63ResourcesInner
  */
  public static ActionProperty63ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty63ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty63ResourcesInner to an JSON string
  *
  * @return JSON string
  */
