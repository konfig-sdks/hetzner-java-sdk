...
public class PrimaryIPsUpdateIpLabelsRequest {
  ...
  public PrimaryIPsUpdateIpLabelsRequest() {
  }

  public PrimaryIPsUpdateIpLabelsRequest autoDelete(Boolean autoDelete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "Delete this Primary IP when the resource it is assigned to is deleted")
  ...
  public PrimaryIPsUpdateIpLabelsRequest labels(Object labels) {
  ...
  **/
  ...
  public PrimaryIPsUpdateIpLabelsRequest name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "my-ip", value = "New unique name to set")
   ...
   * @return the PrimaryIPsUpdateIpLabelsRequest instance itself
   */
  public PrimaryIPsUpdateIpLabelsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPsUpdateIpLabelsRequest primaryIPsUpdateIpLabelsRequest = (PrimaryIPsUpdateIpLabelsRequest) o;
    return Objects.equals(this.autoDelete, primaryIPsUpdateIpLabelsRequest.autoDelete) &&
        Objects.equals(this.labels, primaryIPsUpdateIpLabelsRequest.labels) &&
        Objects.equals(this.name, primaryIPsUpdateIpLabelsRequest.name)&&
        Objects.equals(this.additionalProperties, primaryIPsUpdateIpLabelsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoDelete, labels, name, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrimaryIPsUpdateIpLabelsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPsUpdateIpLabelsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPsUpdateIpLabelsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPsUpdateIpLabelsRequest is not found in the empty JSON string", PrimaryIPsUpdateIpLabelsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPsUpdateIpLabelsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPsUpdateIpLabelsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPsUpdateIpLabelsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPsUpdateIpLabelsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPsUpdateIpLabelsRequest>() {
           @Override
           public void write(JsonWriter out, PrimaryIPsUpdateIpLabelsRequest value) throws IOException {
           ...
           @Override
           public PrimaryIPsUpdateIpLabelsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPsUpdateIpLabelsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPsUpdateIpLabelsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPsUpdateIpLabelsRequest
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPsUpdateIpLabelsRequest
  */
  public static PrimaryIPsUpdateIpLabelsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPsUpdateIpLabelsRequest.class);
  }

 /**
  * Convert an instance of PrimaryIPsUpdateIpLabelsRequest to an JSON string
  *
  * @return JSON string
  */
