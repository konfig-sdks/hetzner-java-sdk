...
public class Action18Error {
  ...
  public Action18Error() {
  }

  public Action18Error code(String code) {
  ...
  **/
  ...
  public Action18Error message(String message) {
  ...
  **/
   ...
   * @return the Action18Error instance itself
   */
  public Action18Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action18Error action18Error = (Action18Error) o;
    return Objects.equals(this.code, action18Error.code) &&
        Objects.equals(this.message, action18Error.message)&&
        Objects.equals(this.additionalProperties, action18Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action18Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action18Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action18Error is not found in the empty JSON string", Action18Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action18Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action18Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action18Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action18Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action18Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action18Error>() {
           @Override
           public void write(JsonWriter out, Action18Error value) throws IOException {
           ...
           @Override
           public Action18Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action18Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action18Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action18Error
  * @throws IOException if the JSON string is invalid with respect to Action18Error
  */
  public static Action18Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action18Error.class);
  }

 /**
  * Convert an instance of Action18Error to an JSON string
  *
  * @return JSON string
  */
