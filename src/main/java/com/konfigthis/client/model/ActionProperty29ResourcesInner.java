...
/**
 * ActionProperty29ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty29ResourcesInner {
  ...
  public ActionProperty29ResourcesInner() {
  }

  public ActionProperty29ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty29ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty29ResourcesInner instance itself
   */
  public ActionProperty29ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty29ResourcesInner actionProperty29ResourcesInner = (ActionProperty29ResourcesInner) o;
    return Objects.equals(this.id, actionProperty29ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty29ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty29ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty29ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty29ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty29ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty29ResourcesInner is not found in the empty JSON string", ActionProperty29ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty29ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty29ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty29ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty29ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty29ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty29ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty29ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty29ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty29ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty29ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty29ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty29ResourcesInner
  */
  public static ActionProperty29ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty29ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty29ResourcesInner to an JSON string
  *
  * @return JSON string
  */
