...
public class NetworkActionsChangeProtectionRequest {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public NetworkActionsChangeProtectionRequest() {
  }

  public NetworkActionsChangeProtectionRequest delete(Boolean delete) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "If true, prevents the Network from being deleted")
   ...
   * @return the NetworkActionsChangeProtectionRequest instance itself
   */
  public NetworkActionsChangeProtectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsChangeProtectionRequest networkActionsChangeProtectionRequest = (NetworkActionsChangeProtectionRequest) o;
    return Objects.equals(this.delete, networkActionsChangeProtectionRequest.delete)&&
        Objects.equals(this.additionalProperties, networkActionsChangeProtectionRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsChangeProtectionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsChangeProtectionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsChangeProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsChangeProtectionRequest is not found in the empty JSON string", NetworkActionsChangeProtectionRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsChangeProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsChangeProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsChangeProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsChangeProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsChangeProtectionRequest>() {
           @Override
           public void write(JsonWriter out, NetworkActionsChangeProtectionRequest value) throws IOException {
           ...
           @Override
           public NetworkActionsChangeProtectionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsChangeProtectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsChangeProtectionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsChangeProtectionRequest
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsChangeProtectionRequest
  */
  public static NetworkActionsChangeProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsChangeProtectionRequest.class);
  }

 /**
  * Convert an instance of NetworkActionsChangeProtectionRequest to an JSON string
  *
  * @return JSON string
  */
