...
public class ListMetaProperty30Pagination {
  ...
  public ListMetaProperty30Pagination() {
  }

  public ListMetaProperty30Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty30Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty30Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty30Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty30Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty30Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty30Pagination instance itself
   */
  public ListMetaProperty30Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty30Pagination listMetaProperty30Pagination = (ListMetaProperty30Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty30Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty30Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty30Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty30Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty30Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty30Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty30Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty30Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty30Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty30Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty30Pagination is not found in the empty JSON string", ListMetaProperty30Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty30Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty30Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty30Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty30Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty30Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty30Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty30Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty30Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty30Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty30Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty30Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty30Pagination
  */
  public static ListMetaProperty30Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty30Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty30Pagination to an JSON string
  *
  * @return JSON string
  */
