...
public class CertificatePropertyStatusError {
  ...
  public CertificatePropertyStatusError() {
  }

  public CertificatePropertyStatusError code(String code) {
  ...
  **/
  ...
  public CertificatePropertyStatusError message(String message) {
  ...
  **/
   ...
   * @return the CertificatePropertyStatusError instance itself
   */
  public CertificatePropertyStatusError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatePropertyStatusError certificatePropertyStatusError = (CertificatePropertyStatusError) o;
    return Objects.equals(this.code, certificatePropertyStatusError.code) &&
        Objects.equals(this.message, certificatePropertyStatusError.message)&&
        Objects.equals(this.additionalProperties, certificatePropertyStatusError.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificatePropertyStatusError {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatePropertyStatusError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatePropertyStatusError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatePropertyStatusError is not found in the empty JSON string", CertificatePropertyStatusError.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatePropertyStatusError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatePropertyStatusError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatePropertyStatusError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatePropertyStatusError.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatePropertyStatusError>() {
           @Override
           public void write(JsonWriter out, CertificatePropertyStatusError value) throws IOException {
           ...
           @Override
           public CertificatePropertyStatusError read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatePropertyStatusError instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatePropertyStatusError given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatePropertyStatusError
  * @throws IOException if the JSON string is invalid with respect to CertificatePropertyStatusError
  */
  public static CertificatePropertyStatusError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatePropertyStatusError.class);
  }

 /**
  * Convert an instance of CertificatePropertyStatusError to an JSON string
  *
  * @return JSON string
  */
