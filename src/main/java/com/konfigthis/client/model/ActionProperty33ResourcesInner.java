...
/**
 * ActionProperty33ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty33ResourcesInner {
  ...
  public ActionProperty33ResourcesInner() {
  }

  public ActionProperty33ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty33ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty33ResourcesInner instance itself
   */
  public ActionProperty33ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty33ResourcesInner actionProperty33ResourcesInner = (ActionProperty33ResourcesInner) o;
    return Objects.equals(this.id, actionProperty33ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty33ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty33ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty33ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty33ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty33ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty33ResourcesInner is not found in the empty JSON string", ActionProperty33ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty33ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty33ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty33ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty33ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty33ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty33ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty33ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty33ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty33ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty33ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty33ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty33ResourcesInner
  */
  public static ActionProperty33ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty33ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty33ResourcesInner to an JSON string
  *
  * @return JSON string
  */
