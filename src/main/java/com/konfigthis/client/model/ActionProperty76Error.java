...
public class ActionProperty76Error {
  ...
  public ActionProperty76Error() {
  }

  public ActionProperty76Error code(String code) {
  ...
  **/
  ...
  public ActionProperty76Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty76Error instance itself
   */
  public ActionProperty76Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty76Error actionProperty76Error = (ActionProperty76Error) o;
    return Objects.equals(this.code, actionProperty76Error.code) &&
        Objects.equals(this.message, actionProperty76Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty76Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty76Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty76Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty76Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty76Error is not found in the empty JSON string", ActionProperty76Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty76Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty76Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty76Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty76Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty76Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty76Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty76Error value) throws IOException {
           ...
           @Override
           public ActionProperty76Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty76Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty76Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty76Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty76Error
  */
  public static ActionProperty76Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty76Error.class);
  }

 /**
  * Convert an instance of ActionProperty76Error to an JSON string
  *
  * @return JSON string
  */
