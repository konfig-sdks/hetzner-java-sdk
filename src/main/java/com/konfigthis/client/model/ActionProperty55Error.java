...
public class ActionProperty55Error {
  ...
  public ActionProperty55Error() {
  }

  public ActionProperty55Error code(String code) {
  ...
  **/
  ...
  public ActionProperty55Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty55Error instance itself
   */
  public ActionProperty55Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty55Error actionProperty55Error = (ActionProperty55Error) o;
    return Objects.equals(this.code, actionProperty55Error.code) &&
        Objects.equals(this.message, actionProperty55Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty55Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty55Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty55Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty55Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty55Error is not found in the empty JSON string", ActionProperty55Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty55Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty55Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty55Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty55Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty55Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty55Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty55Error value) throws IOException {
           ...
           @Override
           public ActionProperty55Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty55Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty55Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty55Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty55Error
  */
  public static ActionProperty55Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty55Error.class);
  }

 /**
  * Convert an instance of ActionProperty55Error to an JSON string
  *
  * @return JSON string
  */
