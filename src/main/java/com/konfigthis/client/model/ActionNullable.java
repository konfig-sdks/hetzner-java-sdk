...
import com.konfigthis.client.model.ActionNullableError;
import com.konfigthis.client.model.ActionNullableResourcesInner;
...
public class ActionNullable {
  ...
  private ActionNullableError error;
  ...
  private List<ActionNullableResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionNullable() {
  }

  public ActionNullable command(String command) {
  ...
  **/
  ...
  public ActionNullable error(ActionNullableError error) {
  ...
  **/
  ...
  public ActionNullableError getError() {
    return error;
  }


  public void setError(ActionNullableError error) {
  ...
  public ActionNullable finished(String finished) {
  ...
  **/
  ...
  public ActionNullable id(Long id) {
  ...
  **/
  ...
  public ActionNullable progress(Integer progress) {
  ...
  **/
  ...
  public ActionNullable resources(List<ActionNullableResourcesInner> resources) {
  ...
  public ActionNullable addResourcesItem(ActionNullableResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionNullableResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionNullableResourcesInner> resources) {
  ...
  public ActionNullable started(String started) {
  ...
  **/
  ...
  public ActionNullable status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionNullable instance itself
   */
  public ActionNullable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionNullable actionNullable = (ActionNullable) o;
    return Objects.equals(this.command, actionNullable.command) &&
        Objects.equals(this.error, actionNullable.error) &&
        Objects.equals(this.finished, actionNullable.finished) &&
        Objects.equals(this.id, actionNullable.id) &&
        Objects.equals(this.progress, actionNullable.progress) &&
        Objects.equals(this.resources, actionNullable.resources) &&
        Objects.equals(this.started, actionNullable.started) &&
        Objects.equals(this.status, actionNullable.status)&&
        Objects.equals(this.additionalProperties, actionNullable.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionNullable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionNullable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionNullable is not found in the empty JSON string", ActionNullable.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionNullable.openapiRequiredFields) {
      ...
      ActionNullableError.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionNullableResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionNullable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionNullable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionNullable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionNullable.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionNullable>() {
           @Override
           public void write(JsonWriter out, ActionNullable value) throws IOException {
           ...
           @Override
           public ActionNullable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionNullable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionNullable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionNullable
  * @throws IOException if the JSON string is invalid with respect to ActionNullable
  */
  public static ActionNullable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionNullable.class);
  }

 /**
  * Convert an instance of ActionNullable to an JSON string
  *
  * @return JSON string
  */
