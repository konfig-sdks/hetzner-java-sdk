...
import com.konfigthis.client.model.LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner;
...
public class LoadBalancerTypesGetByIdResponseLoadBalancerType {
  ...
  private List<LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner> prices = new ArrayList<>();

  public LoadBalancerTypesGetByIdResponseLoadBalancerType() {
  }

  public LoadBalancerTypesGetByIdResponseLoadBalancerType description(String description) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType deprecated(String deprecated) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType id(Long id) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType maxAssignedCertificates(Long maxAssignedCertificates) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType maxConnections(Long maxConnections) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType maxServices(Long maxServices) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType maxTargets(Long maxTargets) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType name(String name) {
  ...
  **/
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType prices(List<LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner> prices) {
  ...
  public LoadBalancerTypesGetByIdResponseLoadBalancerType addPricesItem(LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner> prices) {
   ...
   * @return the LoadBalancerTypesGetByIdResponseLoadBalancerType instance itself
   */
  public LoadBalancerTypesGetByIdResponseLoadBalancerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTypesGetByIdResponseLoadBalancerType loadBalancerTypesGetByIdResponseLoadBalancerType = (LoadBalancerTypesGetByIdResponseLoadBalancerType) o;
    return Objects.equals(this.description, loadBalancerTypesGetByIdResponseLoadBalancerType.description) &&
        Objects.equals(this.deprecated, loadBalancerTypesGetByIdResponseLoadBalancerType.deprecated) &&
        Objects.equals(this.id, loadBalancerTypesGetByIdResponseLoadBalancerType.id) &&
        Objects.equals(this.maxAssignedCertificates, loadBalancerTypesGetByIdResponseLoadBalancerType.maxAssignedCertificates) &&
        Objects.equals(this.maxConnections, loadBalancerTypesGetByIdResponseLoadBalancerType.maxConnections) &&
        Objects.equals(this.maxServices, loadBalancerTypesGetByIdResponseLoadBalancerType.maxServices) &&
        Objects.equals(this.maxTargets, loadBalancerTypesGetByIdResponseLoadBalancerType.maxTargets) &&
        Objects.equals(this.name, loadBalancerTypesGetByIdResponseLoadBalancerType.name) &&
        Objects.equals(this.prices, loadBalancerTypesGetByIdResponseLoadBalancerType.prices)&&
        Objects.equals(this.additionalProperties, loadBalancerTypesGetByIdResponseLoadBalancerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTypesGetByIdResponseLoadBalancerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTypesGetByIdResponseLoadBalancerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTypesGetByIdResponseLoadBalancerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTypesGetByIdResponseLoadBalancerType is not found in the empty JSON string", LoadBalancerTypesGetByIdResponseLoadBalancerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTypesGetByIdResponseLoadBalancerType.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        LoadBalancerTypesGetByIdResponseLoadBalancerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTypesGetByIdResponseLoadBalancerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTypesGetByIdResponseLoadBalancerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTypesGetByIdResponseLoadBalancerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTypesGetByIdResponseLoadBalancerType.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTypesGetByIdResponseLoadBalancerType>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTypesGetByIdResponseLoadBalancerType value) throws IOException {
           ...
           @Override
           public LoadBalancerTypesGetByIdResponseLoadBalancerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTypesGetByIdResponseLoadBalancerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTypesGetByIdResponseLoadBalancerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTypesGetByIdResponseLoadBalancerType
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTypesGetByIdResponseLoadBalancerType
  */
  public static LoadBalancerTypesGetByIdResponseLoadBalancerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTypesGetByIdResponseLoadBalancerType.class);
  }

 /**
  * Convert an instance of LoadBalancerTypesGetByIdResponseLoadBalancerType to an JSON string
  *
  * @return JSON string
  */
