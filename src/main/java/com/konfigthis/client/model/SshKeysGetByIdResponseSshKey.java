...
public class SshKeysGetByIdResponseSshKey {
  ...
  public SshKeysGetByIdResponseSshKey() {
  }

  public SshKeysGetByIdResponseSshKey created(String created) {
  ...
  **/
  ...
  public SshKeysGetByIdResponseSshKey fingerprint(String fingerprint) {
  ...
  **/
  ...
  public SshKeysGetByIdResponseSshKey id(Long id) {
  ...
  **/
  ...
  public SshKeysGetByIdResponseSshKey labels(Map<String, String> labels) {
  ...
  public SshKeysGetByIdResponseSshKey putLabelsItem(String key, String labelsItem) {
  ...
  **/
  ...
  public SshKeysGetByIdResponseSshKey name(String name) {
  ...
  **/
  ...
  public SshKeysGetByIdResponseSshKey publicKey(String publicKey) {
  ...
  **/
   ...
   * @return the SshKeysGetByIdResponseSshKey instance itself
   */
  public SshKeysGetByIdResponseSshKey putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysGetByIdResponseSshKey sshKeysGetByIdResponseSshKey = (SshKeysGetByIdResponseSshKey) o;
    return Objects.equals(this.created, sshKeysGetByIdResponseSshKey.created) &&
        Objects.equals(this.fingerprint, sshKeysGetByIdResponseSshKey.fingerprint) &&
        Objects.equals(this.id, sshKeysGetByIdResponseSshKey.id) &&
        Objects.equals(this.labels, sshKeysGetByIdResponseSshKey.labels) &&
        Objects.equals(this.name, sshKeysGetByIdResponseSshKey.name) &&
        Objects.equals(this.publicKey, sshKeysGetByIdResponseSshKey.publicKey)&&
        Objects.equals(this.additionalProperties, sshKeysGetByIdResponseSshKey.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysGetByIdResponseSshKey {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysGetByIdResponseSshKey
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysGetByIdResponseSshKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysGetByIdResponseSshKey is not found in the empty JSON string", SshKeysGetByIdResponseSshKey.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysGetByIdResponseSshKey.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysGetByIdResponseSshKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysGetByIdResponseSshKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysGetByIdResponseSshKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysGetByIdResponseSshKey.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysGetByIdResponseSshKey>() {
           @Override
           public void write(JsonWriter out, SshKeysGetByIdResponseSshKey value) throws IOException {
           ...
           @Override
           public SshKeysGetByIdResponseSshKey read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysGetByIdResponseSshKey instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysGetByIdResponseSshKey given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysGetByIdResponseSshKey
  * @throws IOException if the JSON string is invalid with respect to SshKeysGetByIdResponseSshKey
  */
  public static SshKeysGetByIdResponseSshKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysGetByIdResponseSshKey.class);
  }

 /**
  * Convert an instance of SshKeysGetByIdResponseSshKey to an JSON string
  *
  * @return JSON string
  */
