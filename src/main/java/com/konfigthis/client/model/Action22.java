...
import com.konfigthis.client.model.Action22Error;
import com.konfigthis.client.model.Action22ResourcesInner;
...
public class Action22 {
  ...
  private List<Action22ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action22 command(String command) {
  ...
  **/
  ...
  public Action22 error(Action22Error error) {
  ...
  **/
  ...
  public Action22Error getError() {
    return error;
  }


  public void setError(Action22Error error) {
  ...
  public Action22 finished(String finished) {
  ...
  **/
  ...
  public Action22 progress(Integer progress) {
  ...
  **/
  ...
  public Action22 resources(List<Action22ResourcesInner> resources) {
  ...
  public Action22 addResourcesItem(Action22ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action22ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action22ResourcesInner> resources) {
  ...
  public Action22 started(String started) {
  ...
  **/
  ...
  public Action22 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action22 instance itself
   */
  public Action22 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action22 action22 = (Action22) o;
    return Objects.equals(this.command, action22.command) &&
        Objects.equals(this.error, action22.error) &&
        Objects.equals(this.finished, action22.finished) &&
        Objects.equals(this.id, action22.id) &&
        Objects.equals(this.progress, action22.progress) &&
        Objects.equals(this.resources, action22.resources) &&
        Objects.equals(this.started, action22.started) &&
        Objects.equals(this.status, action22.status)&&
        Objects.equals(this.additionalProperties, action22.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action22
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action22.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action22 is not found in the empty JSON string", Action22.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action22.openapiRequiredFields) {
      ...
      Action22Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action22ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action22.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action22' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action22> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action22.class));

       return (TypeAdapter<T>) new TypeAdapter<Action22>() {
           @Override
           public void write(JsonWriter out, Action22 value) throws IOException {
           ...
           @Override
           public Action22 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action22 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action22 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action22
  * @throws IOException if the JSON string is invalid with respect to Action22
  */
  public static Action22 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action22.class);
  }

 /**
  * Convert an instance of Action22 to an JSON string
  *
  * @return JSON string
  */
