...
import com.konfigthis.client.model.ListMetaProperty15Pagination;
...
public class ListMetaProperty15 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty15Pagination pagination;

  public ListMetaProperty15() {
  }

  public ListMetaProperty15 pagination(ListMetaProperty15Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty15Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty15Pagination pagination) {
   ...
   * @return the ListMetaProperty15 instance itself
   */
  public ListMetaProperty15 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty15 listMetaProperty15 = (ListMetaProperty15) o;
    return Objects.equals(this.pagination, listMetaProperty15.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty15.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty15 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty15
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty15.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty15 is not found in the empty JSON string", ListMetaProperty15.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty15.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty15Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty15.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty15>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty15 value) throws IOException {
           ...
           @Override
           public ListMetaProperty15 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty15 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty15 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty15
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty15
  */
  public static ListMetaProperty15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty15.class);
  }

 /**
  * Convert an instance of ListMetaProperty15 to an JSON string
  *
  * @return JSON string
  */
