...
public class ActionProperty58Error {
  ...
  public ActionProperty58Error() {
  }

  public ActionProperty58Error code(String code) {
  ...
  **/
  ...
  public ActionProperty58Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty58Error instance itself
   */
  public ActionProperty58Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty58Error actionProperty58Error = (ActionProperty58Error) o;
    return Objects.equals(this.code, actionProperty58Error.code) &&
        Objects.equals(this.message, actionProperty58Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty58Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty58Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty58Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty58Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty58Error is not found in the empty JSON string", ActionProperty58Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty58Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty58Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty58Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty58Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty58Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty58Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty58Error value) throws IOException {
           ...
           @Override
           public ActionProperty58Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty58Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty58Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty58Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty58Error
  */
  public static ActionProperty58Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty58Error.class);
  }

 /**
  * Convert an instance of ActionProperty58Error to an JSON string
  *
  * @return JSON string
  */
