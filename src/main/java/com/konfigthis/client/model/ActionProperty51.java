...
import com.konfigthis.client.model.ActionProperty51Error;
import com.konfigthis.client.model.ActionProperty51ResourcesInner;
...
public class ActionProperty51 {
  ...
  private ActionProperty51Error error;
  ...
  private List<ActionProperty51ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty51() {
  }

  public ActionProperty51 command(String command) {
  ...
  **/
  ...
  public ActionProperty51 error(ActionProperty51Error error) {
  ...
  **/
  ...
  public ActionProperty51Error getError() {
    return error;
  }


  public void setError(ActionProperty51Error error) {
  ...
  public ActionProperty51 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty51 id(Long id) {
  ...
  **/
  ...
  public ActionProperty51 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty51 resources(List<ActionProperty51ResourcesInner> resources) {
  ...
  public ActionProperty51 addResourcesItem(ActionProperty51ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty51ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty51ResourcesInner> resources) {
  ...
  public ActionProperty51 started(String started) {
  ...
  **/
  ...
  public ActionProperty51 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty51 instance itself
   */
  public ActionProperty51 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty51 actionProperty51 = (ActionProperty51) o;
    return Objects.equals(this.command, actionProperty51.command) &&
        Objects.equals(this.error, actionProperty51.error) &&
        Objects.equals(this.finished, actionProperty51.finished) &&
        Objects.equals(this.id, actionProperty51.id) &&
        Objects.equals(this.progress, actionProperty51.progress) &&
        Objects.equals(this.resources, actionProperty51.resources) &&
        Objects.equals(this.started, actionProperty51.started) &&
        Objects.equals(this.status, actionProperty51.status)&&
        Objects.equals(this.additionalProperties, actionProperty51.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty51 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty51
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty51.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty51 is not found in the empty JSON string", ActionProperty51.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty51.openapiRequiredFields) {
      ...
      ActionProperty51Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty51ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty51.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty51' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty51> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty51.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty51>() {
           @Override
           public void write(JsonWriter out, ActionProperty51 value) throws IOException {
           ...
           @Override
           public ActionProperty51 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty51 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty51 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty51
  * @throws IOException if the JSON string is invalid with respect to ActionProperty51
  */
  public static ActionProperty51 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty51.class);
  }

 /**
  * Convert an instance of ActionProperty51 to an JSON string
  *
  * @return JSON string
  */
