...
/**
 * ActionProperty57ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty57ResourcesInner {
  ...
  public ActionProperty57ResourcesInner() {
  }

  public ActionProperty57ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty57ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty57ResourcesInner instance itself
   */
  public ActionProperty57ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty57ResourcesInner actionProperty57ResourcesInner = (ActionProperty57ResourcesInner) o;
    return Objects.equals(this.id, actionProperty57ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty57ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty57ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty57ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty57ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty57ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty57ResourcesInner is not found in the empty JSON string", ActionProperty57ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty57ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty57ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty57ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty57ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty57ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty57ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty57ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty57ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty57ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty57ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty57ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty57ResourcesInner
  */
  public static ActionProperty57ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty57ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty57ResourcesInner to an JSON string
  *
  * @return JSON string
  */
