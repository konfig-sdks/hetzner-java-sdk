...
/**
 * Action5ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action5ResourcesInner {
  ...
  public Action5ResourcesInner() {
  }

  public Action5ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action5ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action5ResourcesInner instance itself
   */
  public Action5ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action5ResourcesInner action5ResourcesInner = (Action5ResourcesInner) o;
    return Objects.equals(this.id, action5ResourcesInner.id) &&
        Objects.equals(this.type, action5ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action5ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action5ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action5ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action5ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action5ResourcesInner is not found in the empty JSON string", Action5ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action5ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action5ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action5ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action5ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action5ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action5ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action5ResourcesInner value) throws IOException {
           ...
           @Override
           public Action5ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action5ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action5ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action5ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action5ResourcesInner
  */
  public static Action5ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action5ResourcesInner.class);
  }

 /**
  * Convert an instance of Action5ResourcesInner to an JSON string
  *
  * @return JSON string
  */
