...
import com.konfigthis.client.model.ActionProperty30Error;
import com.konfigthis.client.model.ActionProperty30ResourcesInner;
...
public class ActionProperty30 {
  ...
  private ActionProperty30Error error;
  ...
  private List<ActionProperty30ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty30() {
  }

  public ActionProperty30 command(String command) {
  ...
  **/
  ...
  public ActionProperty30 error(ActionProperty30Error error) {
  ...
  **/
  ...
  public ActionProperty30Error getError() {
    return error;
  }


  public void setError(ActionProperty30Error error) {
  ...
  public ActionProperty30 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty30 id(Long id) {
  ...
  **/
  ...
  public ActionProperty30 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty30 resources(List<ActionProperty30ResourcesInner> resources) {
  ...
  public ActionProperty30 addResourcesItem(ActionProperty30ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty30ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty30ResourcesInner> resources) {
  ...
  public ActionProperty30 started(String started) {
  ...
  **/
  ...
  public ActionProperty30 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty30 instance itself
   */
  public ActionProperty30 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty30 actionProperty30 = (ActionProperty30) o;
    return Objects.equals(this.command, actionProperty30.command) &&
        Objects.equals(this.error, actionProperty30.error) &&
        Objects.equals(this.finished, actionProperty30.finished) &&
        Objects.equals(this.id, actionProperty30.id) &&
        Objects.equals(this.progress, actionProperty30.progress) &&
        Objects.equals(this.resources, actionProperty30.resources) &&
        Objects.equals(this.started, actionProperty30.started) &&
        Objects.equals(this.status, actionProperty30.status)&&
        Objects.equals(this.additionalProperties, actionProperty30.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty30 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty30
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty30.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty30 is not found in the empty JSON string", ActionProperty30.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty30.openapiRequiredFields) {
      ...
      ActionProperty30Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty30ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty30.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty30' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty30> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty30.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty30>() {
           @Override
           public void write(JsonWriter out, ActionProperty30 value) throws IOException {
           ...
           @Override
           public ActionProperty30 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty30 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty30 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty30
  * @throws IOException if the JSON string is invalid with respect to ActionProperty30
  */
  public static ActionProperty30 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty30.class);
  }

 /**
  * Convert an instance of ActionProperty30 to an JSON string
  *
  * @return JSON string
  */
