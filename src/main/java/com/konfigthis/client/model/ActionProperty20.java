...
import com.konfigthis.client.model.ActionProperty20Error;
import com.konfigthis.client.model.ActionProperty20ResourcesInner;
...
public class ActionProperty20 {
  ...
  private ActionProperty20Error error;
  ...
  private List<ActionProperty20ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty20() {
  }

  public ActionProperty20 command(String command) {
  ...
  **/
  ...
  public ActionProperty20 error(ActionProperty20Error error) {
  ...
  **/
  ...
  public ActionProperty20Error getError() {
    return error;
  }


  public void setError(ActionProperty20Error error) {
  ...
  public ActionProperty20 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty20 id(Long id) {
  ...
  **/
  ...
  public ActionProperty20 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty20 resources(List<ActionProperty20ResourcesInner> resources) {
  ...
  public ActionProperty20 addResourcesItem(ActionProperty20ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty20ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty20ResourcesInner> resources) {
  ...
  public ActionProperty20 started(String started) {
  ...
  **/
  ...
  public ActionProperty20 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty20 instance itself
   */
  public ActionProperty20 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty20 actionProperty20 = (ActionProperty20) o;
    return Objects.equals(this.command, actionProperty20.command) &&
        Objects.equals(this.error, actionProperty20.error) &&
        Objects.equals(this.finished, actionProperty20.finished) &&
        Objects.equals(this.id, actionProperty20.id) &&
        Objects.equals(this.progress, actionProperty20.progress) &&
        Objects.equals(this.resources, actionProperty20.resources) &&
        Objects.equals(this.started, actionProperty20.started) &&
        Objects.equals(this.status, actionProperty20.status)&&
        Objects.equals(this.additionalProperties, actionProperty20.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty20 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty20
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty20.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty20 is not found in the empty JSON string", ActionProperty20.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty20.openapiRequiredFields) {
      ...
      ActionProperty20Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty20ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty20.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty20' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty20> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty20.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty20>() {
           @Override
           public void write(JsonWriter out, ActionProperty20 value) throws IOException {
           ...
           @Override
           public ActionProperty20 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty20 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty20 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty20
  * @throws IOException if the JSON string is invalid with respect to ActionProperty20
  */
  public static ActionProperty20 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty20.class);
  }

 /**
  * Convert an instance of ActionProperty20 to an JSON string
  *
  * @return JSON string
  */
