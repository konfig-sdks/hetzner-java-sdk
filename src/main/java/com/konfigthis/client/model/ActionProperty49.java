...
import com.konfigthis.client.model.ActionProperty49Error;
import com.konfigthis.client.model.ActionProperty49ResourcesInner;
...
public class ActionProperty49 {
  ...
  private ActionProperty49Error error;
  ...
  private List<ActionProperty49ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty49() {
  }

  public ActionProperty49 command(String command) {
  ...
  **/
  ...
  public ActionProperty49 error(ActionProperty49Error error) {
  ...
  **/
  ...
  public ActionProperty49Error getError() {
    return error;
  }


  public void setError(ActionProperty49Error error) {
  ...
  public ActionProperty49 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty49 id(Long id) {
  ...
  **/
  ...
  public ActionProperty49 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty49 resources(List<ActionProperty49ResourcesInner> resources) {
  ...
  public ActionProperty49 addResourcesItem(ActionProperty49ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty49ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty49ResourcesInner> resources) {
  ...
  public ActionProperty49 started(String started) {
  ...
  **/
  ...
  public ActionProperty49 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty49 instance itself
   */
  public ActionProperty49 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty49 actionProperty49 = (ActionProperty49) o;
    return Objects.equals(this.command, actionProperty49.command) &&
        Objects.equals(this.error, actionProperty49.error) &&
        Objects.equals(this.finished, actionProperty49.finished) &&
        Objects.equals(this.id, actionProperty49.id) &&
        Objects.equals(this.progress, actionProperty49.progress) &&
        Objects.equals(this.resources, actionProperty49.resources) &&
        Objects.equals(this.started, actionProperty49.started) &&
        Objects.equals(this.status, actionProperty49.status)&&
        Objects.equals(this.additionalProperties, actionProperty49.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty49 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty49
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty49.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty49 is not found in the empty JSON string", ActionProperty49.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty49.openapiRequiredFields) {
      ...
      ActionProperty49Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty49ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty49.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty49' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty49> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty49.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty49>() {
           @Override
           public void write(JsonWriter out, ActionProperty49 value) throws IOException {
           ...
           @Override
           public ActionProperty49 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty49 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty49 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty49
  * @throws IOException if the JSON string is invalid with respect to ActionProperty49
  */
  public static ActionProperty49 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty49.class);
  }

 /**
  * Convert an instance of ActionProperty49 to an JSON string
  *
  * @return JSON string
  */
