...
public class PrimaryIPPropertyProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public PrimaryIPPropertyProtection() {
  }

  public PrimaryIPPropertyProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the PrimaryIPPropertyProtection instance itself
   */
  public PrimaryIPPropertyProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIPPropertyProtection primaryIPPropertyProtection = (PrimaryIPPropertyProtection) o;
    return Objects.equals(this.delete, primaryIPPropertyProtection.delete)&&
        Objects.equals(this.additionalProperties, primaryIPPropertyProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrimaryIPPropertyProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIPPropertyProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIPPropertyProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIPPropertyProtection is not found in the empty JSON string", PrimaryIPPropertyProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIPPropertyProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIPPropertyProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIPPropertyProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIPPropertyProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIPPropertyProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIPPropertyProtection>() {
           @Override
           public void write(JsonWriter out, PrimaryIPPropertyProtection value) throws IOException {
           ...
           @Override
           public PrimaryIPPropertyProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIPPropertyProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIPPropertyProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIPPropertyProtection
  * @throws IOException if the JSON string is invalid with respect to PrimaryIPPropertyProtection
  */
  public static PrimaryIPPropertyProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIPPropertyProtection.class);
  }

 /**
  * Convert an instance of PrimaryIPPropertyProtection to an JSON string
  *
  * @return JSON string
  */
