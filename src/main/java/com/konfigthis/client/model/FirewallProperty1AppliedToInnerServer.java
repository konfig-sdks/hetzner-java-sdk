...
/**
 * FirewallProperty1AppliedToInnerServer
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FirewallProperty1AppliedToInnerServer {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public FirewallProperty1AppliedToInnerServer() {
  }

  public FirewallProperty1AppliedToInnerServer id(Long id) {
  ...
  **/
   ...
   * @return the FirewallProperty1AppliedToInnerServer instance itself
   */
  public FirewallProperty1AppliedToInnerServer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallProperty1AppliedToInnerServer firewallProperty1AppliedToInnerServer = (FirewallProperty1AppliedToInnerServer) o;
    return Objects.equals(this.id, firewallProperty1AppliedToInnerServer.id)&&
        Objects.equals(this.additionalProperties, firewallProperty1AppliedToInnerServer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallProperty1AppliedToInnerServer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallProperty1AppliedToInnerServer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallProperty1AppliedToInnerServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallProperty1AppliedToInnerServer is not found in the empty JSON string", FirewallProperty1AppliedToInnerServer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallProperty1AppliedToInnerServer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallProperty1AppliedToInnerServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallProperty1AppliedToInnerServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallProperty1AppliedToInnerServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallProperty1AppliedToInnerServer.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallProperty1AppliedToInnerServer>() {
           @Override
           public void write(JsonWriter out, FirewallProperty1AppliedToInnerServer value) throws IOException {
           ...
           @Override
           public FirewallProperty1AppliedToInnerServer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallProperty1AppliedToInnerServer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallProperty1AppliedToInnerServer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallProperty1AppliedToInnerServer
  * @throws IOException if the JSON string is invalid with respect to FirewallProperty1AppliedToInnerServer
  */
  public static FirewallProperty1AppliedToInnerServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallProperty1AppliedToInnerServer.class);
  }

 /**
  * Convert an instance of FirewallProperty1AppliedToInnerServer to an JSON string
  *
  * @return JSON string
  */
