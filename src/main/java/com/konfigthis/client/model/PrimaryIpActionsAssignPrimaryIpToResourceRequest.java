...
public class PrimaryIpActionsAssignPrimaryIpToResourceRequest {
 ...
 public enum AssigneeTypeEnum {
  ...
  public PrimaryIpActionsAssignPrimaryIpToResourceRequest() {
  }

  public PrimaryIpActionsAssignPrimaryIpToResourceRequest assigneeId(Long assigneeId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4711", required = true, value = "ID of a resource of type `assignee_type`")
  ...
  public PrimaryIpActionsAssignPrimaryIpToResourceRequest assigneeType(AssigneeTypeEnum assigneeType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "SERVER", required = true, value = "Type of resource assigning the Primary IP to")
   ...
   * @return the PrimaryIpActionsAssignPrimaryIpToResourceRequest instance itself
   */
  public PrimaryIpActionsAssignPrimaryIpToResourceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrimaryIpActionsAssignPrimaryIpToResourceRequest primaryIpActionsAssignPrimaryIpToResourceRequest = (PrimaryIpActionsAssignPrimaryIpToResourceRequest) o;
    return Objects.equals(this.assigneeId, primaryIpActionsAssignPrimaryIpToResourceRequest.assigneeId) &&
        Objects.equals(this.assigneeType, primaryIpActionsAssignPrimaryIpToResourceRequest.assigneeType)&&
        Objects.equals(this.additionalProperties, primaryIpActionsAssignPrimaryIpToResourceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assigneeId, assigneeType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrimaryIpActionsAssignPrimaryIpToResourceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrimaryIpActionsAssignPrimaryIpToResourceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrimaryIpActionsAssignPrimaryIpToResourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrimaryIpActionsAssignPrimaryIpToResourceRequest is not found in the empty JSON string", PrimaryIpActionsAssignPrimaryIpToResourceRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrimaryIpActionsAssignPrimaryIpToResourceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrimaryIpActionsAssignPrimaryIpToResourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrimaryIpActionsAssignPrimaryIpToResourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrimaryIpActionsAssignPrimaryIpToResourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrimaryIpActionsAssignPrimaryIpToResourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PrimaryIpActionsAssignPrimaryIpToResourceRequest>() {
           @Override
           public void write(JsonWriter out, PrimaryIpActionsAssignPrimaryIpToResourceRequest value) throws IOException {
           ...
           @Override
           public PrimaryIpActionsAssignPrimaryIpToResourceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrimaryIpActionsAssignPrimaryIpToResourceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrimaryIpActionsAssignPrimaryIpToResourceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrimaryIpActionsAssignPrimaryIpToResourceRequest
  * @throws IOException if the JSON string is invalid with respect to PrimaryIpActionsAssignPrimaryIpToResourceRequest
  */
  public static PrimaryIpActionsAssignPrimaryIpToResourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrimaryIpActionsAssignPrimaryIpToResourceRequest.class);
  }

 /**
  * Convert an instance of PrimaryIpActionsAssignPrimaryIpToResourceRequest to an JSON string
  *
  * @return JSON string
  */
