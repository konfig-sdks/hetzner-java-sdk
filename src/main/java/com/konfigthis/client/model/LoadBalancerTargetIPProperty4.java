...
public class LoadBalancerTargetIPProperty4 {
  public static final String SERIALIZED_NAME_IP = "ip";
  @SerializedName(SERIALIZED_NAME_IP)
  private String ip;

  public LoadBalancerTargetIPProperty4() {
  }

  public LoadBalancerTargetIPProperty4 ip(String ip) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetIPProperty4 instance itself
   */
  public LoadBalancerTargetIPProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetIPProperty4 loadBalancerTargetIPProperty4 = (LoadBalancerTargetIPProperty4) o;
    return Objects.equals(this.ip, loadBalancerTargetIPProperty4.ip)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetIPProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetIPProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetIPProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetIPProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetIPProperty4 is not found in the empty JSON string", LoadBalancerTargetIPProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetIPProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetIPProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetIPProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetIPProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetIPProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetIPProperty4>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetIPProperty4 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetIPProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetIPProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetIPProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetIPProperty4
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetIPProperty4
  */
  public static LoadBalancerTargetIPProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetIPProperty4.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetIPProperty4 to an JSON string
  *
  * @return JSON string
  */
