...
public class ActionProperty47Error {
  ...
  public ActionProperty47Error() {
  }

  public ActionProperty47Error code(String code) {
  ...
  **/
  ...
  public ActionProperty47Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty47Error instance itself
   */
  public ActionProperty47Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty47Error actionProperty47Error = (ActionProperty47Error) o;
    return Objects.equals(this.code, actionProperty47Error.code) &&
        Objects.equals(this.message, actionProperty47Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty47Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty47Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty47Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty47Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty47Error is not found in the empty JSON string", ActionProperty47Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty47Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty47Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty47Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty47Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty47Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty47Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty47Error value) throws IOException {
           ...
           @Override
           public ActionProperty47Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty47Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty47Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty47Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty47Error
  */
  public static ActionProperty47Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty47Error.class);
  }

 /**
  * Convert an instance of ActionProperty47Error to an JSON string
  *
  * @return JSON string
  */
