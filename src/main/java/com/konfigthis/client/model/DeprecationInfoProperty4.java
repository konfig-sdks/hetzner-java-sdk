...
public class DeprecationInfoProperty4 {
  ...
  public DeprecationInfoProperty4() {
  }

  public DeprecationInfoProperty4 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty4 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty4 instance itself
   */
  public DeprecationInfoProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty4 deprecationInfoProperty4 = (DeprecationInfoProperty4) o;
    return Objects.equals(this.announced, deprecationInfoProperty4.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty4.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty4 is not found in the empty JSON string", DeprecationInfoProperty4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty4>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty4 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty4
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty4
  */
  public static DeprecationInfoProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty4.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty4 to an JSON string
  *
  * @return JSON string
  */
