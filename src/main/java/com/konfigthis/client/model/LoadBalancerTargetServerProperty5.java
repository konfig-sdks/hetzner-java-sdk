...
public class LoadBalancerTargetServerProperty5 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public LoadBalancerTargetServerProperty5() {
  }

  public LoadBalancerTargetServerProperty5 id(Long id) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetServerProperty5 instance itself
   */
  public LoadBalancerTargetServerProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetServerProperty5 loadBalancerTargetServerProperty5 = (LoadBalancerTargetServerProperty5) o;
    return Objects.equals(this.id, loadBalancerTargetServerProperty5.id)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetServerProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetServerProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetServerProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetServerProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetServerProperty5 is not found in the empty JSON string", LoadBalancerTargetServerProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetServerProperty5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetServerProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetServerProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetServerProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetServerProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetServerProperty5>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetServerProperty5 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetServerProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetServerProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetServerProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetServerProperty5
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetServerProperty5
  */
  public static LoadBalancerTargetServerProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetServerProperty5.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetServerProperty5 to an JSON string
  *
  * @return JSON string
  */
