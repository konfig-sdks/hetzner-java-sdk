...
import com.konfigthis.client.model.ServersUpdateServerResponseServer;
...
public class ServersUpdateServerResponse {
  public static final String SERIALIZED_NAME_SERVER = "server";
  @SerializedName(SERIALIZED_NAME_SERVER)
  private ServersUpdateServerResponseServer server;

  public ServersUpdateServerResponse() {
  }

  public ServersUpdateServerResponse server(ServersUpdateServerResponseServer server) {
  ...
  **/
  ...
  public ServersUpdateServerResponseServer getServer() {
    return server;
  }


  public void setServer(ServersUpdateServerResponseServer server) {
   ...
   * @return the ServersUpdateServerResponse instance itself
   */
  public ServersUpdateServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersUpdateServerResponse serversUpdateServerResponse = (ServersUpdateServerResponse) o;
    return Objects.equals(this.server, serversUpdateServerResponse.server)&&
        Objects.equals(this.additionalProperties, serversUpdateServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersUpdateServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersUpdateServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersUpdateServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersUpdateServerResponse is not found in the empty JSON string", ServersUpdateServerResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `server`
      if (jsonObj.get("server") != null && !jsonObj.get("server").isJsonNull()) {
        ServersUpdateServerResponseServer.validateJsonObject(jsonObj.getAsJsonObject("server"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersUpdateServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersUpdateServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersUpdateServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersUpdateServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersUpdateServerResponse>() {
           @Override
           public void write(JsonWriter out, ServersUpdateServerResponse value) throws IOException {
           ...
           @Override
           public ServersUpdateServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersUpdateServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersUpdateServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersUpdateServerResponse
  * @throws IOException if the JSON string is invalid with respect to ServersUpdateServerResponse
  */
  public static ServersUpdateServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersUpdateServerResponse.class);
  }

 /**
  * Convert an instance of ServersUpdateServerResponse to an JSON string
  *
  * @return JSON string
  */
