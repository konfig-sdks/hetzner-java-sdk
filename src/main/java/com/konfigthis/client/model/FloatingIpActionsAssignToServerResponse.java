...
import com.konfigthis.client.model.ActionProperty9;
...
public class FloatingIpActionsAssignToServerResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty9 action;

  public FloatingIpActionsAssignToServerResponse() {
  }

  public FloatingIpActionsAssignToServerResponse action(ActionProperty9 action) {
  ...
  **/
  ...
  public ActionProperty9 getAction() {
    return action;
  }


  public void setAction(ActionProperty9 action) {
   ...
   * @return the FloatingIpActionsAssignToServerResponse instance itself
   */
  public FloatingIpActionsAssignToServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIpActionsAssignToServerResponse floatingIpActionsAssignToServerResponse = (FloatingIpActionsAssignToServerResponse) o;
    return Objects.equals(this.action, floatingIpActionsAssignToServerResponse.action)&&
        Objects.equals(this.additionalProperties, floatingIpActionsAssignToServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIpActionsAssignToServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionsAssignToServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionsAssignToServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionsAssignToServerResponse is not found in the empty JSON string", FloatingIpActionsAssignToServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionsAssignToServerResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty9.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionsAssignToServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionsAssignToServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionsAssignToServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionsAssignToServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionsAssignToServerResponse>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionsAssignToServerResponse value) throws IOException {
           ...
           @Override
           public FloatingIpActionsAssignToServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionsAssignToServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionsAssignToServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionsAssignToServerResponse
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionsAssignToServerResponse
  */
  public static FloatingIpActionsAssignToServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionsAssignToServerResponse.class);
  }

 /**
  * Convert an instance of FloatingIpActionsAssignToServerResponse to an JSON string
  *
  * @return JSON string
  */
