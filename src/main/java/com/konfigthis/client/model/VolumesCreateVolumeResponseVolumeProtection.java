...
public class VolumesCreateVolumeResponseVolumeProtection {
  public static final String SERIALIZED_NAME_DELETE = "delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private Boolean delete;

  public VolumesCreateVolumeResponseVolumeProtection() {
  }

  public VolumesCreateVolumeResponseVolumeProtection delete(Boolean delete) {
  ...
  **/
   ...
   * @return the VolumesCreateVolumeResponseVolumeProtection instance itself
   */
  public VolumesCreateVolumeResponseVolumeProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesCreateVolumeResponseVolumeProtection volumesCreateVolumeResponseVolumeProtection = (VolumesCreateVolumeResponseVolumeProtection) o;
    return Objects.equals(this.delete, volumesCreateVolumeResponseVolumeProtection.delete)&&
        Objects.equals(this.additionalProperties, volumesCreateVolumeResponseVolumeProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesCreateVolumeResponseVolumeProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesCreateVolumeResponseVolumeProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesCreateVolumeResponseVolumeProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesCreateVolumeResponseVolumeProtection is not found in the empty JSON string", VolumesCreateVolumeResponseVolumeProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesCreateVolumeResponseVolumeProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesCreateVolumeResponseVolumeProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesCreateVolumeResponseVolumeProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesCreateVolumeResponseVolumeProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesCreateVolumeResponseVolumeProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesCreateVolumeResponseVolumeProtection>() {
           @Override
           public void write(JsonWriter out, VolumesCreateVolumeResponseVolumeProtection value) throws IOException {
           ...
           @Override
           public VolumesCreateVolumeResponseVolumeProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesCreateVolumeResponseVolumeProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesCreateVolumeResponseVolumeProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesCreateVolumeResponseVolumeProtection
  * @throws IOException if the JSON string is invalid with respect to VolumesCreateVolumeResponseVolumeProtection
  */
  public static VolumesCreateVolumeResponseVolumeProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesCreateVolumeResponseVolumeProtection.class);
  }

 /**
  * Convert an instance of VolumesCreateVolumeResponseVolumeProtection to an JSON string
  *
  * @return JSON string
  */
