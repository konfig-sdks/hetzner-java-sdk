...
public class FirewallAppliedToInnerLabelSelector {
  ...
  **/
   ...
   * @return the FirewallAppliedToInnerLabelSelector instance itself
   */
  public FirewallAppliedToInnerLabelSelector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.selector, firewallAppliedToInnerLabelSelector.selector)&&
        Objects.equals(this.additionalProperties, firewallAppliedToInnerLabelSelector.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallAppliedToInnerLabelSelector
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallAppliedToInnerLabelSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FirewallAppliedToInnerLabelSelector>() {
           ...
           public FirewallAppliedToInnerLabelSelector read(JsonReader in) throws IOException {
             ...
             FirewallAppliedToInnerLabelSelector instance = thisAdapter.fromJsonTree(jsonObj);
