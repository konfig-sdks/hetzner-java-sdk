...
public class CertificatePropertyUsedByInner {
  ...
  public CertificatePropertyUsedByInner() {
  }

  public CertificatePropertyUsedByInner id(Long id) {
  ...
  **/
  ...
  public CertificatePropertyUsedByInner type(String type) {
  ...
  **/
   ...
   * @return the CertificatePropertyUsedByInner instance itself
   */
  public CertificatePropertyUsedByInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatePropertyUsedByInner certificatePropertyUsedByInner = (CertificatePropertyUsedByInner) o;
    return Objects.equals(this.id, certificatePropertyUsedByInner.id) &&
        Objects.equals(this.type, certificatePropertyUsedByInner.type)&&
        Objects.equals(this.additionalProperties, certificatePropertyUsedByInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificatePropertyUsedByInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatePropertyUsedByInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatePropertyUsedByInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatePropertyUsedByInner is not found in the empty JSON string", CertificatePropertyUsedByInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificatePropertyUsedByInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatePropertyUsedByInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatePropertyUsedByInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatePropertyUsedByInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatePropertyUsedByInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatePropertyUsedByInner>() {
           @Override
           public void write(JsonWriter out, CertificatePropertyUsedByInner value) throws IOException {
           ...
           @Override
           public CertificatePropertyUsedByInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatePropertyUsedByInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatePropertyUsedByInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatePropertyUsedByInner
  * @throws IOException if the JSON string is invalid with respect to CertificatePropertyUsedByInner
  */
  public static CertificatePropertyUsedByInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatePropertyUsedByInner.class);
  }

 /**
  * Convert an instance of CertificatePropertyUsedByInner to an JSON string
  *
  * @return JSON string
  */
