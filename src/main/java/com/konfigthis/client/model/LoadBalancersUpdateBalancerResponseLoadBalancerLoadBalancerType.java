...
import com.konfigthis.client.model.LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner;
...
public class LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType {
  ...
  private List<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner> prices = new ArrayList<>();

  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType() {
  }

  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType description(String description) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType deprecated(String deprecated) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType id(Long id) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType maxAssignedCertificates(Long maxAssignedCertificates) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType maxConnections(Long maxConnections) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType maxServices(Long maxServices) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType maxTargets(Long maxTargets) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType name(String name) {
  ...
  **/
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType prices(List<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner> prices) {
  ...
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType addPricesItem(LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner pricesItem) {
  ...
  **/
  ...
  public List<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner> prices) {
   ...
   * @return the LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType instance itself
   */
  public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType = (LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType) o;
    return Objects.equals(this.description, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.description) &&
        Objects.equals(this.deprecated, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.deprecated) &&
        Objects.equals(this.id, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.id) &&
        Objects.equals(this.maxAssignedCertificates, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.maxAssignedCertificates) &&
        Objects.equals(this.maxConnections, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.maxConnections) &&
        Objects.equals(this.maxServices, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.maxServices) &&
        Objects.equals(this.maxTargets, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.maxTargets) &&
        Objects.equals(this.name, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.name) &&
        Objects.equals(this.prices, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.prices)&&
        Objects.equals(this.additionalProperties, loadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType is not found in the empty JSON string", LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerTypePricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType>() {
           @Override
           public void write(JsonWriter out, LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType value) throws IOException {
           ...
           @Override
           public LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType
  */
  public static LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType.class);
  }

 /**
  * Convert an instance of LoadBalancersUpdateBalancerResponseLoadBalancerLoadBalancerType to an JSON string
  *
  * @return JSON string
  */
