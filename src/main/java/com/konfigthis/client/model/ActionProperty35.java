...
import com.konfigthis.client.model.ActionProperty35Error;
import com.konfigthis.client.model.ActionProperty35ResourcesInner;
...
public class ActionProperty35 {
  ...
  private ActionProperty35Error error;
  ...
  private List<ActionProperty35ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty35() {
  }

  public ActionProperty35 command(String command) {
  ...
  **/
  ...
  public ActionProperty35 error(ActionProperty35Error error) {
  ...
  **/
  ...
  public ActionProperty35Error getError() {
    return error;
  }


  public void setError(ActionProperty35Error error) {
  ...
  public ActionProperty35 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty35 id(Long id) {
  ...
  **/
  ...
  public ActionProperty35 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty35 resources(List<ActionProperty35ResourcesInner> resources) {
  ...
  public ActionProperty35 addResourcesItem(ActionProperty35ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty35ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty35ResourcesInner> resources) {
  ...
  public ActionProperty35 started(String started) {
  ...
  **/
  ...
  public ActionProperty35 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty35 instance itself
   */
  public ActionProperty35 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty35 actionProperty35 = (ActionProperty35) o;
    return Objects.equals(this.command, actionProperty35.command) &&
        Objects.equals(this.error, actionProperty35.error) &&
        Objects.equals(this.finished, actionProperty35.finished) &&
        Objects.equals(this.id, actionProperty35.id) &&
        Objects.equals(this.progress, actionProperty35.progress) &&
        Objects.equals(this.resources, actionProperty35.resources) &&
        Objects.equals(this.started, actionProperty35.started) &&
        Objects.equals(this.status, actionProperty35.status)&&
        Objects.equals(this.additionalProperties, actionProperty35.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty35 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty35
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty35.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty35 is not found in the empty JSON string", ActionProperty35.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty35.openapiRequiredFields) {
      ...
      ActionProperty35Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty35ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty35.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty35' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty35> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty35.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty35>() {
           @Override
           public void write(JsonWriter out, ActionProperty35 value) throws IOException {
           ...
           @Override
           public ActionProperty35 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty35 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty35 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty35
  * @throws IOException if the JSON string is invalid with respect to ActionProperty35
  */
  public static ActionProperty35 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty35.class);
  }

 /**
  * Convert an instance of ActionProperty35 to an JSON string
  *
  * @return JSON string
  */
