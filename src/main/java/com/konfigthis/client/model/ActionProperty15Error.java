...
public class ActionProperty15Error {
  ...
  public ActionProperty15Error() {
  }

  public ActionProperty15Error code(String code) {
  ...
  **/
  ...
  public ActionProperty15Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty15Error instance itself
   */
  public ActionProperty15Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty15Error actionProperty15Error = (ActionProperty15Error) o;
    return Objects.equals(this.code, actionProperty15Error.code) &&
        Objects.equals(this.message, actionProperty15Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty15Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty15Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty15Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty15Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty15Error is not found in the empty JSON string", ActionProperty15Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty15Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty15Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty15Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty15Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty15Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty15Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty15Error value) throws IOException {
           ...
           @Override
           public ActionProperty15Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty15Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty15Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty15Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty15Error
  */
  public static ActionProperty15Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty15Error.class);
  }

 /**
  * Convert an instance of ActionProperty15Error to an JSON string
  *
  * @return JSON string
  */
