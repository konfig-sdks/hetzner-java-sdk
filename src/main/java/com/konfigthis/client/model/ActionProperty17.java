...
import com.konfigthis.client.model.ActionProperty17Error;
import com.konfigthis.client.model.ActionProperty17ResourcesInner;
...
public class ActionProperty17 {
  ...
  private ActionProperty17Error error;
  ...
  private List<ActionProperty17ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty17() {
  }

  public ActionProperty17 command(String command) {
  ...
  **/
  ...
  public ActionProperty17 error(ActionProperty17Error error) {
  ...
  **/
  ...
  public ActionProperty17Error getError() {
    return error;
  }


  public void setError(ActionProperty17Error error) {
  ...
  public ActionProperty17 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty17 id(Long id) {
  ...
  **/
  ...
  public ActionProperty17 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty17 resources(List<ActionProperty17ResourcesInner> resources) {
  ...
  public ActionProperty17 addResourcesItem(ActionProperty17ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty17ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty17ResourcesInner> resources) {
  ...
  public ActionProperty17 started(String started) {
  ...
  **/
  ...
  public ActionProperty17 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty17 instance itself
   */
  public ActionProperty17 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty17 actionProperty17 = (ActionProperty17) o;
    return Objects.equals(this.command, actionProperty17.command) &&
        Objects.equals(this.error, actionProperty17.error) &&
        Objects.equals(this.finished, actionProperty17.finished) &&
        Objects.equals(this.id, actionProperty17.id) &&
        Objects.equals(this.progress, actionProperty17.progress) &&
        Objects.equals(this.resources, actionProperty17.resources) &&
        Objects.equals(this.started, actionProperty17.started) &&
        Objects.equals(this.status, actionProperty17.status)&&
        Objects.equals(this.additionalProperties, actionProperty17.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty17 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty17
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty17.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty17 is not found in the empty JSON string", ActionProperty17.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty17.openapiRequiredFields) {
      ...
      ActionProperty17Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty17ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty17.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty17' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty17> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty17.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty17>() {
           @Override
           public void write(JsonWriter out, ActionProperty17 value) throws IOException {
           ...
           @Override
           public ActionProperty17 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty17 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty17 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty17
  * @throws IOException if the JSON string is invalid with respect to ActionProperty17
  */
  public static ActionProperty17 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty17.class);
  }

 /**
  * Convert an instance of ActionProperty17 to an JSON string
  *
  * @return JSON string
  */
