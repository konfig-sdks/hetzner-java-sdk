...
/**
 * ActionProperty56ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty56ResourcesInner {
  ...
  public ActionProperty56ResourcesInner() {
  }

  public ActionProperty56ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty56ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty56ResourcesInner instance itself
   */
  public ActionProperty56ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty56ResourcesInner actionProperty56ResourcesInner = (ActionProperty56ResourcesInner) o;
    return Objects.equals(this.id, actionProperty56ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty56ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty56ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty56ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty56ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty56ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty56ResourcesInner is not found in the empty JSON string", ActionProperty56ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty56ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty56ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty56ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty56ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty56ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty56ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty56ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty56ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty56ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty56ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty56ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty56ResourcesInner
  */
  public static ActionProperty56ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty56ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty56ResourcesInner to an JSON string
  *
  * @return JSON string
  */
