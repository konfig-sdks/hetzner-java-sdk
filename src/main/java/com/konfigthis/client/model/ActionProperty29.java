...
import com.konfigthis.client.model.ActionProperty29Error;
import com.konfigthis.client.model.ActionProperty29ResourcesInner;
...
public class ActionProperty29 {
  ...
  private ActionProperty29Error error;
  ...
  private List<ActionProperty29ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public ActionProperty29() {
  }

  public ActionProperty29 command(String command) {
  ...
  **/
  ...
  public ActionProperty29 error(ActionProperty29Error error) {
  ...
  **/
  ...
  public ActionProperty29Error getError() {
    return error;
  }


  public void setError(ActionProperty29Error error) {
  ...
  public ActionProperty29 finished(String finished) {
  ...
  **/
  ...
  public ActionProperty29 id(Long id) {
  ...
  **/
  ...
  public ActionProperty29 progress(Integer progress) {
  ...
  **/
  ...
  public ActionProperty29 resources(List<ActionProperty29ResourcesInner> resources) {
  ...
  public ActionProperty29 addResourcesItem(ActionProperty29ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<ActionProperty29ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<ActionProperty29ResourcesInner> resources) {
  ...
  public ActionProperty29 started(String started) {
  ...
  **/
  ...
  public ActionProperty29 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the ActionProperty29 instance itself
   */
  public ActionProperty29 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty29 actionProperty29 = (ActionProperty29) o;
    return Objects.equals(this.command, actionProperty29.command) &&
        Objects.equals(this.error, actionProperty29.error) &&
        Objects.equals(this.finished, actionProperty29.finished) &&
        Objects.equals(this.id, actionProperty29.id) &&
        Objects.equals(this.progress, actionProperty29.progress) &&
        Objects.equals(this.resources, actionProperty29.resources) &&
        Objects.equals(this.started, actionProperty29.started) &&
        Objects.equals(this.status, actionProperty29.status)&&
        Objects.equals(this.additionalProperties, actionProperty29.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty29 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty29
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty29.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty29 is not found in the empty JSON string", ActionProperty29.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty29.openapiRequiredFields) {
      ...
      ActionProperty29Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        ActionProperty29ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty29.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty29' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty29> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty29.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty29>() {
           @Override
           public void write(JsonWriter out, ActionProperty29 value) throws IOException {
           ...
           @Override
           public ActionProperty29 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty29 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty29 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty29
  * @throws IOException if the JSON string is invalid with respect to ActionProperty29
  */
  public static ActionProperty29 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty29.class);
  }

 /**
  * Convert an instance of ActionProperty29 to an JSON string
  *
  * @return JSON string
  */
