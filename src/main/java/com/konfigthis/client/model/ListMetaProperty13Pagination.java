...
public class ListMetaProperty13Pagination {
  ...
  public ListMetaProperty13Pagination() {
  }

  public ListMetaProperty13Pagination lastPage(Long lastPage) {
  ...
  **/
  ...
  public ListMetaProperty13Pagination nextPage(Long nextPage) {
  ...
  **/
  ...
  public ListMetaProperty13Pagination page(Long page) {
  ...
  **/
  ...
  public ListMetaProperty13Pagination perPage(Long perPage) {
  ...
  **/
  ...
  public ListMetaProperty13Pagination previousPage(Long previousPage) {
  ...
  **/
  ...
  public ListMetaProperty13Pagination totalEntries(Long totalEntries) {
  ...
  **/
   ...
   * @return the ListMetaProperty13Pagination instance itself
   */
  public ListMetaProperty13Pagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty13Pagination listMetaProperty13Pagination = (ListMetaProperty13Pagination) o;
    return Objects.equals(this.lastPage, listMetaProperty13Pagination.lastPage) &&
        Objects.equals(this.nextPage, listMetaProperty13Pagination.nextPage) &&
        Objects.equals(this.page, listMetaProperty13Pagination.page) &&
        Objects.equals(this.perPage, listMetaProperty13Pagination.perPage) &&
        Objects.equals(this.previousPage, listMetaProperty13Pagination.previousPage) &&
        Objects.equals(this.totalEntries, listMetaProperty13Pagination.totalEntries)&&
        Objects.equals(this.additionalProperties, listMetaProperty13Pagination.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty13Pagination {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty13Pagination
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty13Pagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty13Pagination is not found in the empty JSON string", ListMetaProperty13Pagination.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty13Pagination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty13Pagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty13Pagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty13Pagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty13Pagination.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty13Pagination>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty13Pagination value) throws IOException {
           ...
           @Override
           public ListMetaProperty13Pagination read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty13Pagination instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty13Pagination given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty13Pagination
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty13Pagination
  */
  public static ListMetaProperty13Pagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty13Pagination.class);
  }

 /**
  * Convert an instance of ListMetaProperty13Pagination to an JSON string
  *
  * @return JSON string
  */
