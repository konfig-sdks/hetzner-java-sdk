...
public class ActionProperty3Error {
  ...
  public ActionProperty3Error() {
  }

  public ActionProperty3Error code(String code) {
  ...
  **/
  ...
  public ActionProperty3Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty3Error instance itself
   */
  public ActionProperty3Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty3Error actionProperty3Error = (ActionProperty3Error) o;
    return Objects.equals(this.code, actionProperty3Error.code) &&
        Objects.equals(this.message, actionProperty3Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty3Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty3Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty3Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty3Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty3Error is not found in the empty JSON string", ActionProperty3Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty3Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty3Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty3Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty3Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty3Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty3Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty3Error value) throws IOException {
           ...
           @Override
           public ActionProperty3Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty3Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty3Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty3Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty3Error
  */
  public static ActionProperty3Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty3Error.class);
  }

 /**
  * Convert an instance of ActionProperty3Error to an JSON string
  *
  * @return JSON string
  */
