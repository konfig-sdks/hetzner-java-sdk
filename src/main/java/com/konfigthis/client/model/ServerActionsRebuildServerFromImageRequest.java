...
public class ServerActionsRebuildServerFromImageRequest {
  public static final String SERIALIZED_NAME_IMAGE = "image";
  @SerializedName(SERIALIZED_NAME_IMAGE)
  private String image;

  public ServerActionsRebuildServerFromImageRequest() {
  }

  public ServerActionsRebuildServerFromImageRequest image(String image) {
  ...
  **/
  ...
  @ApiModelProperty(example = "ubuntu-20.04", required = true, value = "ID or name of Image to rebuilt from.")
   ...
   * @return the ServerActionsRebuildServerFromImageRequest instance itself
   */
  public ServerActionsRebuildServerFromImageRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServerActionsRebuildServerFromImageRequest serverActionsRebuildServerFromImageRequest = (ServerActionsRebuildServerFromImageRequest) o;
    return Objects.equals(this.image, serverActionsRebuildServerFromImageRequest.image)&&
        Objects.equals(this.additionalProperties, serverActionsRebuildServerFromImageRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServerActionsRebuildServerFromImageRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServerActionsRebuildServerFromImageRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServerActionsRebuildServerFromImageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerActionsRebuildServerFromImageRequest is not found in the empty JSON string", ServerActionsRebuildServerFromImageRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServerActionsRebuildServerFromImageRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerActionsRebuildServerFromImageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerActionsRebuildServerFromImageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerActionsRebuildServerFromImageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerActionsRebuildServerFromImageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerActionsRebuildServerFromImageRequest>() {
           @Override
           public void write(JsonWriter out, ServerActionsRebuildServerFromImageRequest value) throws IOException {
           ...
           @Override
           public ServerActionsRebuildServerFromImageRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServerActionsRebuildServerFromImageRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServerActionsRebuildServerFromImageRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServerActionsRebuildServerFromImageRequest
  * @throws IOException if the JSON string is invalid with respect to ServerActionsRebuildServerFromImageRequest
  */
  public static ServerActionsRebuildServerFromImageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerActionsRebuildServerFromImageRequest.class);
  }

 /**
  * Convert an instance of ServerActionsRebuildServerFromImageRequest to an JSON string
  *
  * @return JSON string
  */
