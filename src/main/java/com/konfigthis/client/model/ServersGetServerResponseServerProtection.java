...
public class ServersGetServerResponseServerProtection {
  ...
  public ServersGetServerResponseServerProtection() {
  }

  public ServersGetServerResponseServerProtection delete(Boolean delete) {
  ...
  **/
  ...
  public ServersGetServerResponseServerProtection rebuild(Boolean rebuild) {
  ...
  **/
   ...
   * @return the ServersGetServerResponseServerProtection instance itself
   */
  public ServersGetServerResponseServerProtection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ServersGetServerResponseServerProtection serversGetServerResponseServerProtection = (ServersGetServerResponseServerProtection) o;
    return Objects.equals(this.delete, serversGetServerResponseServerProtection.delete) &&
        Objects.equals(this.rebuild, serversGetServerResponseServerProtection.rebuild)&&
        Objects.equals(this.additionalProperties, serversGetServerResponseServerProtection.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServersGetServerResponseServerProtection {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersGetServerResponseServerProtection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersGetServerResponseServerProtection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersGetServerResponseServerProtection is not found in the empty JSON string", ServersGetServerResponseServerProtection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersGetServerResponseServerProtection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersGetServerResponseServerProtection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersGetServerResponseServerProtection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersGetServerResponseServerProtection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersGetServerResponseServerProtection.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersGetServerResponseServerProtection>() {
           @Override
           public void write(JsonWriter out, ServersGetServerResponseServerProtection value) throws IOException {
           ...
           @Override
           public ServersGetServerResponseServerProtection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ServersGetServerResponseServerProtection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ServersGetServerResponseServerProtection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersGetServerResponseServerProtection
  * @throws IOException if the JSON string is invalid with respect to ServersGetServerResponseServerProtection
  */
  public static ServersGetServerResponseServerProtection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersGetServerResponseServerProtection.class);
  }

 /**
  * Convert an instance of ServersGetServerResponseServerProtection to an JSON string
  *
  * @return JSON string
  */
