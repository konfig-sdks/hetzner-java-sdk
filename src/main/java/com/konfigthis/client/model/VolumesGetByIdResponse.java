...
import com.konfigthis.client.model.VolumesGetByIdResponseVolume;
...
public class VolumesGetByIdResponse {
  public static final String SERIALIZED_NAME_VOLUME = "volume";
  @SerializedName(SERIALIZED_NAME_VOLUME)
  private VolumesGetByIdResponseVolume volume;

  public VolumesGetByIdResponse() {
  }

  public VolumesGetByIdResponse volume(VolumesGetByIdResponseVolume volume) {
  ...
  **/
  ...
  public VolumesGetByIdResponseVolume getVolume() {
    return volume;
  }


  public void setVolume(VolumesGetByIdResponseVolume volume) {
   ...
   * @return the VolumesGetByIdResponse instance itself
   */
  public VolumesGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesGetByIdResponse volumesGetByIdResponse = (VolumesGetByIdResponse) o;
    return Objects.equals(this.volume, volumesGetByIdResponse.volume)&&
        Objects.equals(this.additionalProperties, volumesGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesGetByIdResponse is not found in the empty JSON string", VolumesGetByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesGetByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `volume`
      VolumesGetByIdResponseVolume.validateJsonObject(jsonObj.getAsJsonObject("volume"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, VolumesGetByIdResponse value) throws IOException {
           ...
           @Override
           public VolumesGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to VolumesGetByIdResponse
  */
  public static VolumesGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesGetByIdResponse.class);
  }

 /**
  * Convert an instance of VolumesGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
