...
/**
 * Action1ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action1ResourcesInner {
  ...
  public Action1ResourcesInner() {
  }

  public Action1ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action1ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action1ResourcesInner instance itself
   */
  public Action1ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action1ResourcesInner action1ResourcesInner = (Action1ResourcesInner) o;
    return Objects.equals(this.id, action1ResourcesInner.id) &&
        Objects.equals(this.type, action1ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action1ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action1ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action1ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action1ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action1ResourcesInner is not found in the empty JSON string", Action1ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action1ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action1ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action1ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action1ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action1ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action1ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action1ResourcesInner value) throws IOException {
           ...
           @Override
           public Action1ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action1ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action1ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action1ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action1ResourcesInner
  */
  public static Action1ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action1ResourcesInner.class);
  }

 /**
  * Convert an instance of Action1ResourcesInner to an JSON string
  *
  * @return JSON string
  */
