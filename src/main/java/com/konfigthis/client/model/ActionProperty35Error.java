...
public class ActionProperty35Error {
  ...
  public ActionProperty35Error() {
  }

  public ActionProperty35Error code(String code) {
  ...
  **/
  ...
  public ActionProperty35Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty35Error instance itself
   */
  public ActionProperty35Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty35Error actionProperty35Error = (ActionProperty35Error) o;
    return Objects.equals(this.code, actionProperty35Error.code) &&
        Objects.equals(this.message, actionProperty35Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty35Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty35Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty35Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty35Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty35Error is not found in the empty JSON string", ActionProperty35Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty35Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty35Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty35Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty35Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty35Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty35Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty35Error value) throws IOException {
           ...
           @Override
           public ActionProperty35Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty35Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty35Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty35Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty35Error
  */
  public static ActionProperty35Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty35Error.class);
  }

 /**
  * Convert an instance of ActionProperty35Error to an JSON string
  *
  * @return JSON string
  */
