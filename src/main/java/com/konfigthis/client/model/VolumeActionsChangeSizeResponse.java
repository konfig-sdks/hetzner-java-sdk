...
import com.konfigthis.client.model.ActionProperty79;
...
public class VolumeActionsChangeSizeResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty79 action;

  public VolumeActionsChangeSizeResponse() {
  }

  public VolumeActionsChangeSizeResponse action(ActionProperty79 action) {
  ...
  **/
  ...
  public ActionProperty79 getAction() {
    return action;
  }


  public void setAction(ActionProperty79 action) {
   ...
   * @return the VolumeActionsChangeSizeResponse instance itself
   */
  public VolumeActionsChangeSizeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumeActionsChangeSizeResponse volumeActionsChangeSizeResponse = (VolumeActionsChangeSizeResponse) o;
    return Objects.equals(this.action, volumeActionsChangeSizeResponse.action)&&
        Objects.equals(this.additionalProperties, volumeActionsChangeSizeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumeActionsChangeSizeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionsChangeSizeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionsChangeSizeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionsChangeSizeResponse is not found in the empty JSON string", VolumeActionsChangeSizeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionsChangeSizeResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty79.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionsChangeSizeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionsChangeSizeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionsChangeSizeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionsChangeSizeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionsChangeSizeResponse>() {
           @Override
           public void write(JsonWriter out, VolumeActionsChangeSizeResponse value) throws IOException {
           ...
           @Override
           public VolumeActionsChangeSizeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionsChangeSizeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionsChangeSizeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionsChangeSizeResponse
  * @throws IOException if the JSON string is invalid with respect to VolumeActionsChangeSizeResponse
  */
  public static VolumeActionsChangeSizeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionsChangeSizeResponse.class);
  }

 /**
  * Convert an instance of VolumeActionsChangeSizeResponse to an JSON string
  *
  * @return JSON string
  */
