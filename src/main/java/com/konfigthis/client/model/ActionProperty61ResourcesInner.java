...
/**
 * ActionProperty61ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty61ResourcesInner {
  ...
  public ActionProperty61ResourcesInner() {
  }

  public ActionProperty61ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty61ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty61ResourcesInner instance itself
   */
  public ActionProperty61ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty61ResourcesInner actionProperty61ResourcesInner = (ActionProperty61ResourcesInner) o;
    return Objects.equals(this.id, actionProperty61ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty61ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty61ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty61ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty61ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty61ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty61ResourcesInner is not found in the empty JSON string", ActionProperty61ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty61ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty61ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty61ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty61ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty61ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty61ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty61ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty61ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty61ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty61ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty61ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty61ResourcesInner
  */
  public static ActionProperty61ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty61ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty61ResourcesInner to an JSON string
  *
  * @return JSON string
  */
