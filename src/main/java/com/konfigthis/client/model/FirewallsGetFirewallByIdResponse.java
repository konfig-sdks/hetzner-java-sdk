...
import com.konfigthis.client.model.FirewallProperty1;
...
public class FirewallsGetFirewallByIdResponse {
  public static final String SERIALIZED_NAME_FIREWALL = "firewall";
  @SerializedName(SERIALIZED_NAME_FIREWALL)
  private FirewallProperty1 firewall;

  public FirewallsGetFirewallByIdResponse() {
  }

  public FirewallsGetFirewallByIdResponse firewall(FirewallProperty1 firewall) {
  ...
  **/
  ...
  public FirewallProperty1 getFirewall() {
    return firewall;
  }


  public void setFirewall(FirewallProperty1 firewall) {
   ...
   * @return the FirewallsGetFirewallByIdResponse instance itself
   */
  public FirewallsGetFirewallByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsGetFirewallByIdResponse firewallsGetFirewallByIdResponse = (FirewallsGetFirewallByIdResponse) o;
    return Objects.equals(this.firewall, firewallsGetFirewallByIdResponse.firewall)&&
        Objects.equals(this.additionalProperties, firewallsGetFirewallByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsGetFirewallByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsGetFirewallByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsGetFirewallByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsGetFirewallByIdResponse is not found in the empty JSON string", FirewallsGetFirewallByIdResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsGetFirewallByIdResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `firewall`
      FirewallProperty1.validateJsonObject(jsonObj.getAsJsonObject("firewall"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsGetFirewallByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsGetFirewallByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsGetFirewallByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsGetFirewallByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsGetFirewallByIdResponse>() {
           @Override
           public void write(JsonWriter out, FirewallsGetFirewallByIdResponse value) throws IOException {
           ...
           @Override
           public FirewallsGetFirewallByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsGetFirewallByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsGetFirewallByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsGetFirewallByIdResponse
  * @throws IOException if the JSON string is invalid with respect to FirewallsGetFirewallByIdResponse
  */
  public static FirewallsGetFirewallByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsGetFirewallByIdResponse.class);
  }

 /**
  * Convert an instance of FirewallsGetFirewallByIdResponse to an JSON string
  *
  * @return JSON string
  */
