...
public class DeprecationInfoProperty9 {
  ...
  public DeprecationInfoProperty9() {
  }

  public DeprecationInfoProperty9 announced(String announced) {
  ...
  **/
  ...
  public DeprecationInfoProperty9 unavailableAfter(String unavailableAfter) {
  ...
  **/
   ...
   * @return the DeprecationInfoProperty9 instance itself
   */
  public DeprecationInfoProperty9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeprecationInfoProperty9 deprecationInfoProperty9 = (DeprecationInfoProperty9) o;
    return Objects.equals(this.announced, deprecationInfoProperty9.announced) &&
        Objects.equals(this.unavailableAfter, deprecationInfoProperty9.unavailableAfter)&&
        Objects.equals(this.additionalProperties, deprecationInfoProperty9.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprecationInfoProperty9 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeprecationInfoProperty9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeprecationInfoProperty9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprecationInfoProperty9 is not found in the empty JSON string", DeprecationInfoProperty9.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeprecationInfoProperty9.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprecationInfoProperty9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprecationInfoProperty9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprecationInfoProperty9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprecationInfoProperty9.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprecationInfoProperty9>() {
           @Override
           public void write(JsonWriter out, DeprecationInfoProperty9 value) throws IOException {
           ...
           @Override
           public DeprecationInfoProperty9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DeprecationInfoProperty9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeprecationInfoProperty9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeprecationInfoProperty9
  * @throws IOException if the JSON string is invalid with respect to DeprecationInfoProperty9
  */
  public static DeprecationInfoProperty9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprecationInfoProperty9.class);
  }

 /**
  * Convert an instance of DeprecationInfoProperty9 to an JSON string
  *
  * @return JSON string
  */
