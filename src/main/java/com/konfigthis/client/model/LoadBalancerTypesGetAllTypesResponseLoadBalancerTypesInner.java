...
import com.konfigthis.client.model.LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner;
...
public class LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner {
  ...
  private List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner> prices = new ArrayList<>();

  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner() {
  }

  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner description(String description) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner deprecated(String deprecated) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner id(Long id) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner maxAssignedCertificates(Long maxAssignedCertificates) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner maxConnections(Long maxConnections) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner maxServices(Long maxServices) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner maxTargets(Long maxTargets) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner name(String name) {
  ...
  **/
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner prices(List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner> prices) {
  ...
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner addPricesItem(LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner pricesItem) {
  ...
  **/
  ...
  public List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner> getPrices() {
    return prices;
  }


  public void setPrices(List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner> prices) {
   ...
   * @return the LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner instance itself
   */
  public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner = (LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner) o;
    return Objects.equals(this.description, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.description) &&
        Objects.equals(this.deprecated, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.deprecated) &&
        Objects.equals(this.id, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.id) &&
        Objects.equals(this.maxAssignedCertificates, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.maxAssignedCertificates) &&
        Objects.equals(this.maxConnections, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.maxConnections) &&
        Objects.equals(this.maxServices, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.maxServices) &&
        Objects.equals(this.maxTargets, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.maxTargets) &&
        Objects.equals(this.name, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.name) &&
        Objects.equals(this.prices, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.prices)&&
        Objects.equals(this.additionalProperties, loadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner is not found in the empty JSON string", LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayprices.size(); i++) {
        LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInnerPricesInner.validateJsonObject(jsonArrayprices.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner value) throws IOException {
           ...
           @Override
           public LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner
  */
  public static LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.class);
  }

 /**
  * Convert an instance of LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner to an JSON string
  *
  * @return JSON string
  */
