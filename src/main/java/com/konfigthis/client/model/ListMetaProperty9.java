...
import com.konfigthis.client.model.ListMetaProperty9Pagination;
...
public class ListMetaProperty9 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty9Pagination pagination;

  public ListMetaProperty9() {
  }

  public ListMetaProperty9 pagination(ListMetaProperty9Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty9Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty9Pagination pagination) {
   ...
   * @return the ListMetaProperty9 instance itself
   */
  public ListMetaProperty9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty9 listMetaProperty9 = (ListMetaProperty9) o;
    return Objects.equals(this.pagination, listMetaProperty9.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty9.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty9 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty9 is not found in the empty JSON string", ListMetaProperty9.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty9.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty9Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty9.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty9>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty9 value) throws IOException {
           ...
           @Override
           public ListMetaProperty9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty9
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty9
  */
  public static ListMetaProperty9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty9.class);
  }

 /**
  * Convert an instance of ListMetaProperty9 to an JSON string
  *
  * @return JSON string
  */
