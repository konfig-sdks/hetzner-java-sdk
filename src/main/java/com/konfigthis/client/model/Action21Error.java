...
public class Action21Error {
  ...
  public Action21Error() {
  }

  public Action21Error code(String code) {
  ...
  **/
  ...
  public Action21Error message(String message) {
  ...
  **/
   ...
   * @return the Action21Error instance itself
   */
  public Action21Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action21Error action21Error = (Action21Error) o;
    return Objects.equals(this.code, action21Error.code) &&
        Objects.equals(this.message, action21Error.message)&&
        Objects.equals(this.additionalProperties, action21Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action21Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action21Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action21Error is not found in the empty JSON string", Action21Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action21Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action21Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action21Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action21Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action21Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action21Error>() {
           @Override
           public void write(JsonWriter out, Action21Error value) throws IOException {
           ...
           @Override
           public Action21Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action21Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action21Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action21Error
  * @throws IOException if the JSON string is invalid with respect to Action21Error
  */
  public static Action21Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action21Error.class);
  }

 /**
  * Convert an instance of Action21Error to an JSON string
  *
  * @return JSON string
  */
