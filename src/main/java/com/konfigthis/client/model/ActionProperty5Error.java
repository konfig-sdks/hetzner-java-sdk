...
public class ActionProperty5Error {
  ...
  public ActionProperty5Error() {
  }

  public ActionProperty5Error code(String code) {
  ...
  **/
  ...
  public ActionProperty5Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty5Error instance itself
   */
  public ActionProperty5Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty5Error actionProperty5Error = (ActionProperty5Error) o;
    return Objects.equals(this.code, actionProperty5Error.code) &&
        Objects.equals(this.message, actionProperty5Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty5Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty5Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty5Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty5Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty5Error is not found in the empty JSON string", ActionProperty5Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty5Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty5Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty5Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty5Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty5Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty5Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty5Error value) throws IOException {
           ...
           @Override
           public ActionProperty5Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty5Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty5Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty5Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty5Error
  */
  public static ActionProperty5Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty5Error.class);
  }

 /**
  * Convert an instance of ActionProperty5Error to an JSON string
  *
  * @return JSON string
  */
