...
import com.konfigthis.client.model.ListMetaProperty5Pagination;
...
public class ListMetaProperty5 {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private ListMetaProperty5Pagination pagination;

  public ListMetaProperty5() {
  }

  public ListMetaProperty5 pagination(ListMetaProperty5Pagination pagination) {
  ...
  **/
  ...
  public ListMetaProperty5Pagination getPagination() {
    return pagination;
  }


  public void setPagination(ListMetaProperty5Pagination pagination) {
   ...
   * @return the ListMetaProperty5 instance itself
   */
  public ListMetaProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMetaProperty5 listMetaProperty5 = (ListMetaProperty5) o;
    return Objects.equals(this.pagination, listMetaProperty5.pagination)&&
        Objects.equals(this.additionalProperties, listMetaProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMetaProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMetaProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMetaProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMetaProperty5 is not found in the empty JSON string", ListMetaProperty5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMetaProperty5.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `pagination`
      ListMetaProperty5Pagination.validateJsonObject(jsonObj.getAsJsonObject("pagination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMetaProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMetaProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMetaProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMetaProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMetaProperty5>() {
           @Override
           public void write(JsonWriter out, ListMetaProperty5 value) throws IOException {
           ...
           @Override
           public ListMetaProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMetaProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMetaProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMetaProperty5
  * @throws IOException if the JSON string is invalid with respect to ListMetaProperty5
  */
  public static ListMetaProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMetaProperty5.class);
  }

 /**
  * Convert an instance of ListMetaProperty5 to an JSON string
  *
  * @return JSON string
  */
