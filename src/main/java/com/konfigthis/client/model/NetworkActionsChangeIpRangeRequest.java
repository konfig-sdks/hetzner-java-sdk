...
public class NetworkActionsChangeIpRangeRequest {
  public static final String SERIALIZED_NAME_IP_RANGE = "ip_range";
  @SerializedName(SERIALIZED_NAME_IP_RANGE)
  private String ipRange;

  public NetworkActionsChangeIpRangeRequest() {
  }

  public NetworkActionsChangeIpRangeRequest ipRange(String ipRange) {
  ...
  **/
  ...
  @ApiModelProperty(example = "10.0.0.0/12", required = true, value = "The new prefix for the whole Network")
   ...
   * @return the NetworkActionsChangeIpRangeRequest instance itself
   */
  public NetworkActionsChangeIpRangeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsChangeIpRangeRequest networkActionsChangeIpRangeRequest = (NetworkActionsChangeIpRangeRequest) o;
    return Objects.equals(this.ipRange, networkActionsChangeIpRangeRequest.ipRange)&&
        Objects.equals(this.additionalProperties, networkActionsChangeIpRangeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipRange, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NetworkActionsChangeIpRangeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsChangeIpRangeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsChangeIpRangeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsChangeIpRangeRequest is not found in the empty JSON string", NetworkActionsChangeIpRangeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsChangeIpRangeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsChangeIpRangeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsChangeIpRangeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsChangeIpRangeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsChangeIpRangeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsChangeIpRangeRequest>() {
           @Override
           public void write(JsonWriter out, NetworkActionsChangeIpRangeRequest value) throws IOException {
           ...
           @Override
           public NetworkActionsChangeIpRangeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsChangeIpRangeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsChangeIpRangeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsChangeIpRangeRequest
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsChangeIpRangeRequest
  */
  public static NetworkActionsChangeIpRangeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsChangeIpRangeRequest.class);
  }

 /**
  * Convert an instance of NetworkActionsChangeIpRangeRequest to an JSON string
  *
  * @return JSON string
  */
