...
/**
 * ActionProperty16ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionProperty16ResourcesInner {
  ...
  public ActionProperty16ResourcesInner() {
  }

  public ActionProperty16ResourcesInner id(Long id) {
  ...
  **/
  ...
  public ActionProperty16ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the ActionProperty16ResourcesInner instance itself
   */
  public ActionProperty16ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty16ResourcesInner actionProperty16ResourcesInner = (ActionProperty16ResourcesInner) o;
    return Objects.equals(this.id, actionProperty16ResourcesInner.id) &&
        Objects.equals(this.type, actionProperty16ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, actionProperty16ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty16ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty16ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty16ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty16ResourcesInner is not found in the empty JSON string", ActionProperty16ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty16ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty16ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty16ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty16ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty16ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty16ResourcesInner>() {
           @Override
           public void write(JsonWriter out, ActionProperty16ResourcesInner value) throws IOException {
           ...
           @Override
           public ActionProperty16ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty16ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty16ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty16ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to ActionProperty16ResourcesInner
  */
  public static ActionProperty16ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty16ResourcesInner.class);
  }

 /**
  * Convert an instance of ActionProperty16ResourcesInner to an JSON string
  *
  * @return JSON string
  */
