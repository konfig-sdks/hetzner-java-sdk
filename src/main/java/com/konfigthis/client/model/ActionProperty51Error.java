...
public class ActionProperty51Error {
  ...
  public ActionProperty51Error() {
  }

  public ActionProperty51Error code(String code) {
  ...
  **/
  ...
  public ActionProperty51Error message(String message) {
  ...
  **/
   ...
   * @return the ActionProperty51Error instance itself
   */
  public ActionProperty51Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActionProperty51Error actionProperty51Error = (ActionProperty51Error) o;
    return Objects.equals(this.code, actionProperty51Error.code) &&
        Objects.equals(this.message, actionProperty51Error.message)&&
        Objects.equals(this.additionalProperties, actionProperty51Error.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionProperty51Error {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionProperty51Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionProperty51Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionProperty51Error is not found in the empty JSON string", ActionProperty51Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionProperty51Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionProperty51Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionProperty51Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionProperty51Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionProperty51Error.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionProperty51Error>() {
           @Override
           public void write(JsonWriter out, ActionProperty51Error value) throws IOException {
           ...
           @Override
           public ActionProperty51Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActionProperty51Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActionProperty51Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActionProperty51Error
  * @throws IOException if the JSON string is invalid with respect to ActionProperty51Error
  */
  public static ActionProperty51Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionProperty51Error.class);
  }

 /**
  * Convert an instance of ActionProperty51Error to an JSON string
  *
  * @return JSON string
  */
