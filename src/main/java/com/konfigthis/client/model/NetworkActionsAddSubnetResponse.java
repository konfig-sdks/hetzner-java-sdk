...
import com.konfigthis.client.model.ActionProperty35;
...
public class NetworkActionsAddSubnetResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty35 action;

  public NetworkActionsAddSubnetResponse() {
  }

  public NetworkActionsAddSubnetResponse action(ActionProperty35 action) {
  ...
  **/
  ...
  public ActionProperty35 getAction() {
    return action;
  }


  public void setAction(ActionProperty35 action) {
   ...
   * @return the NetworkActionsAddSubnetResponse instance itself
   */
  public NetworkActionsAddSubnetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsAddSubnetResponse networkActionsAddSubnetResponse = (NetworkActionsAddSubnetResponse) o;
    return Objects.equals(this.action, networkActionsAddSubnetResponse.action)&&
        Objects.equals(this.additionalProperties, networkActionsAddSubnetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsAddSubnetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsAddSubnetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsAddSubnetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsAddSubnetResponse is not found in the empty JSON string", NetworkActionsAddSubnetResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsAddSubnetResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty35.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsAddSubnetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsAddSubnetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsAddSubnetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsAddSubnetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsAddSubnetResponse>() {
           @Override
           public void write(JsonWriter out, NetworkActionsAddSubnetResponse value) throws IOException {
           ...
           @Override
           public NetworkActionsAddSubnetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsAddSubnetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsAddSubnetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsAddSubnetResponse
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsAddSubnetResponse
  */
  public static NetworkActionsAddSubnetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsAddSubnetResponse.class);
  }

 /**
  * Convert an instance of NetworkActionsAddSubnetResponse to an JSON string
  *
  * @return JSON string
  */
