...
import com.konfigthis.client.model.LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner;
...
public class LoadBalancerTypesGetAllTypesResponse {
  ...
  private List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner> loadBalancerTypes = new ArrayList<>();

  public LoadBalancerTypesGetAllTypesResponse() {
  }

  public LoadBalancerTypesGetAllTypesResponse loadBalancerTypes(List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner> loadBalancerTypes) {
  ...
  public LoadBalancerTypesGetAllTypesResponse addLoadBalancerTypesItem(LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner loadBalancerTypesItem) {
  ...
  **/
  ...
  public List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner> getLoadBalancerTypes() {
    return loadBalancerTypes;
  }


  public void setLoadBalancerTypes(List<LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner> loadBalancerTypes) {
   ...
   * @return the LoadBalancerTypesGetAllTypesResponse instance itself
   */
  public LoadBalancerTypesGetAllTypesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTypesGetAllTypesResponse loadBalancerTypesGetAllTypesResponse = (LoadBalancerTypesGetAllTypesResponse) o;
    return Objects.equals(this.loadBalancerTypes, loadBalancerTypesGetAllTypesResponse.loadBalancerTypes)&&
        Objects.equals(this.additionalProperties, loadBalancerTypesGetAllTypesResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadBalancerTypes, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancerTypesGetAllTypesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTypesGetAllTypesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTypesGetAllTypesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTypesGetAllTypesResponse is not found in the empty JSON string", LoadBalancerTypesGetAllTypesResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTypesGetAllTypesResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayloadBalancerTypes.size(); i++) {
        LoadBalancerTypesGetAllTypesResponseLoadBalancerTypesInner.validateJsonObject(jsonArrayloadBalancerTypes.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTypesGetAllTypesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTypesGetAllTypesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTypesGetAllTypesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTypesGetAllTypesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTypesGetAllTypesResponse>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTypesGetAllTypesResponse value) throws IOException {
           ...
           @Override
           public LoadBalancerTypesGetAllTypesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTypesGetAllTypesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTypesGetAllTypesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTypesGetAllTypesResponse
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTypesGetAllTypesResponse
  */
  public static LoadBalancerTypesGetAllTypesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTypesGetAllTypesResponse.class);
  }

 /**
  * Convert an instance of LoadBalancerTypesGetAllTypesResponse to an JSON string
  *
  * @return JSON string
  */
