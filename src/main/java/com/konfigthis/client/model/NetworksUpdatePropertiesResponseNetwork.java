...
import com.konfigthis.client.model.NetworksUpdatePropertiesResponseNetworkProtection;
import com.konfigthis.client.model.NetworksUpdatePropertiesResponseNetworkRoutesInner;
import com.konfigthis.client.model.NetworksUpdatePropertiesResponseNetworkSubnetsInner;
...
public class NetworksUpdatePropertiesResponseNetwork {
  ...
  private NetworksUpdatePropertiesResponseNetworkProtection protection;

  public static final String SERIALIZED_NAME_ROUTES = "routes";
  @SerializedName(SERIALIZED_NAME_ROUTES)
  private List<NetworksUpdatePropertiesResponseNetworkRoutesInner> routes = new ArrayList<>();

  public static final String SERIALIZED_NAME_SUBNETS = "subnets";
  @SerializedName(SERIALIZED_NAME_SUBNETS)
  private List<NetworksUpdatePropertiesResponseNetworkSubnetsInner> subnets = new ArrayList<>();

  public NetworksUpdatePropertiesResponseNetwork() {
  }

  public NetworksUpdatePropertiesResponseNetwork servers(List<Long> servers) {
  ...
  public NetworksUpdatePropertiesResponseNetwork addServersItem(Long serversItem) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork created(String created) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork exposeRoutesToVswitch(Boolean exposeRoutesToVswitch) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork id(Long id) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork ipRange(String ipRange) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork labels(Object labels) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork loadBalancers(List<Long> loadBalancers) {
  ...
  public NetworksUpdatePropertiesResponseNetwork addLoadBalancersItem(Long loadBalancersItem) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork name(String name) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetwork protection(NetworksUpdatePropertiesResponseNetworkProtection protection) {
  ...
  **/
  ...
  public NetworksUpdatePropertiesResponseNetworkProtection getProtection() {
    return protection;
  }


  public void setProtection(NetworksUpdatePropertiesResponseNetworkProtection protection) {
  ...
  public NetworksUpdatePropertiesResponseNetwork routes(List<NetworksUpdatePropertiesResponseNetworkRoutesInner> routes) {
  ...
  public NetworksUpdatePropertiesResponseNetwork addRoutesItem(NetworksUpdatePropertiesResponseNetworkRoutesInner routesItem) {
  ...
  **/
  ...
  public List<NetworksUpdatePropertiesResponseNetworkRoutesInner> getRoutes() {
    return routes;
  }


  public void setRoutes(List<NetworksUpdatePropertiesResponseNetworkRoutesInner> routes) {
  ...
  public NetworksUpdatePropertiesResponseNetwork subnets(List<NetworksUpdatePropertiesResponseNetworkSubnetsInner> subnets) {
  ...
  public NetworksUpdatePropertiesResponseNetwork addSubnetsItem(NetworksUpdatePropertiesResponseNetworkSubnetsInner subnetsItem) {
  ...
  **/
  ...
  public List<NetworksUpdatePropertiesResponseNetworkSubnetsInner> getSubnets() {
    return subnets;
  }


  public void setSubnets(List<NetworksUpdatePropertiesResponseNetworkSubnetsInner> subnets) {
   ...
   * @return the NetworksUpdatePropertiesResponseNetwork instance itself
   */
  public NetworksUpdatePropertiesResponseNetwork putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworksUpdatePropertiesResponseNetwork networksUpdatePropertiesResponseNetwork = (NetworksUpdatePropertiesResponseNetwork) o;
    return Objects.equals(this.servers, networksUpdatePropertiesResponseNetwork.servers) &&
        Objects.equals(this.created, networksUpdatePropertiesResponseNetwork.created) &&
        Objects.equals(this.exposeRoutesToVswitch, networksUpdatePropertiesResponseNetwork.exposeRoutesToVswitch) &&
        Objects.equals(this.id, networksUpdatePropertiesResponseNetwork.id) &&
        Objects.equals(this.ipRange, networksUpdatePropertiesResponseNetwork.ipRange) &&
        Objects.equals(this.labels, networksUpdatePropertiesResponseNetwork.labels) &&
        Objects.equals(this.loadBalancers, networksUpdatePropertiesResponseNetwork.loadBalancers) &&
        Objects.equals(this.name, networksUpdatePropertiesResponseNetwork.name) &&
        Objects.equals(this.protection, networksUpdatePropertiesResponseNetwork.protection) &&
        Objects.equals(this.routes, networksUpdatePropertiesResponseNetwork.routes) &&
        Objects.equals(this.subnets, networksUpdatePropertiesResponseNetwork.subnets)&&
        Objects.equals(this.additionalProperties, networksUpdatePropertiesResponseNetwork.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworksUpdatePropertiesResponseNetwork {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworksUpdatePropertiesResponseNetwork
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworksUpdatePropertiesResponseNetwork.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworksUpdatePropertiesResponseNetwork is not found in the empty JSON string", NetworksUpdatePropertiesResponseNetwork.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworksUpdatePropertiesResponseNetwork.openapiRequiredFields) {
      ...
      NetworksUpdatePropertiesResponseNetworkProtection.validateJsonObject(jsonObj.getAsJsonObject("protection"));
      ...
      for (int i = 0; i < jsonArrayroutes.size(); i++) {
        NetworksUpdatePropertiesResponseNetworkRoutesInner.validateJsonObject(jsonArrayroutes.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArraysubnets.size(); i++) {
        NetworksUpdatePropertiesResponseNetworkSubnetsInner.validateJsonObject(jsonArraysubnets.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworksUpdatePropertiesResponseNetwork.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworksUpdatePropertiesResponseNetwork' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworksUpdatePropertiesResponseNetwork> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworksUpdatePropertiesResponseNetwork.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworksUpdatePropertiesResponseNetwork>() {
           @Override
           public void write(JsonWriter out, NetworksUpdatePropertiesResponseNetwork value) throws IOException {
           ...
           @Override
           public NetworksUpdatePropertiesResponseNetwork read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworksUpdatePropertiesResponseNetwork instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworksUpdatePropertiesResponseNetwork given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworksUpdatePropertiesResponseNetwork
  * @throws IOException if the JSON string is invalid with respect to NetworksUpdatePropertiesResponseNetwork
  */
  public static NetworksUpdatePropertiesResponseNetwork fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworksUpdatePropertiesResponseNetwork.class);
  }

 /**
  * Convert an instance of NetworksUpdatePropertiesResponseNetwork to an JSON string
  *
  * @return JSON string
  */
