...
import com.konfigthis.client.model.ActionProperty36;
...
public class NetworkActionsChangeIpRangeResponse {
  public static final String SERIALIZED_NAME_ACTION = "action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private ActionProperty36 action;

  public NetworkActionsChangeIpRangeResponse() {
  }

  public NetworkActionsChangeIpRangeResponse action(ActionProperty36 action) {
  ...
  **/
  ...
  public ActionProperty36 getAction() {
    return action;
  }


  public void setAction(ActionProperty36 action) {
   ...
   * @return the NetworkActionsChangeIpRangeResponse instance itself
   */
  public NetworkActionsChangeIpRangeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkActionsChangeIpRangeResponse networkActionsChangeIpRangeResponse = (NetworkActionsChangeIpRangeResponse) o;
    return Objects.equals(this.action, networkActionsChangeIpRangeResponse.action)&&
        Objects.equals(this.additionalProperties, networkActionsChangeIpRangeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkActionsChangeIpRangeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkActionsChangeIpRangeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkActionsChangeIpRangeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkActionsChangeIpRangeResponse is not found in the empty JSON string", NetworkActionsChangeIpRangeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkActionsChangeIpRangeResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `action`
      ActionProperty36.validateJsonObject(jsonObj.getAsJsonObject("action"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkActionsChangeIpRangeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkActionsChangeIpRangeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkActionsChangeIpRangeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkActionsChangeIpRangeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkActionsChangeIpRangeResponse>() {
           @Override
           public void write(JsonWriter out, NetworkActionsChangeIpRangeResponse value) throws IOException {
           ...
           @Override
           public NetworkActionsChangeIpRangeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkActionsChangeIpRangeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkActionsChangeIpRangeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkActionsChangeIpRangeResponse
  * @throws IOException if the JSON string is invalid with respect to NetworkActionsChangeIpRangeResponse
  */
  public static NetworkActionsChangeIpRangeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkActionsChangeIpRangeResponse.class);
  }

 /**
  * Convert an instance of NetworkActionsChangeIpRangeResponse to an JSON string
  *
  * @return JSON string
  */
