...
import com.konfigthis.client.model.Action2Error;
import com.konfigthis.client.model.Action2ResourcesInner;
...
public class Action2 {
  ...
  private List<Action2ResourcesInner> resources = new ArrayList<>();
 ...
 public enum StatusEnum {
  ...
  public Action2 command(String command) {
  ...
  **/
  ...
  public Action2 error(Action2Error error) {
  ...
  **/
  ...
  public Action2Error getError() {
    return error;
  }


  public void setError(Action2Error error) {
  ...
  public Action2 finished(String finished) {
  ...
  **/
  ...
  public Action2 progress(Integer progress) {
  ...
  **/
  ...
  public Action2 resources(List<Action2ResourcesInner> resources) {
  ...
  public Action2 addResourcesItem(Action2ResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<Action2ResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<Action2ResourcesInner> resources) {
  ...
  public Action2 started(String started) {
  ...
  **/
  ...
  public Action2 status(StatusEnum status) {
  ...
  **/
   ...
   * @return the Action2 instance itself
   */
  public Action2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.command, action2.command) &&
        Objects.equals(this.error, action2.error) &&
        Objects.equals(this.finished, action2.finished) &&
        Objects.equals(this.id, action2.id) &&
        Objects.equals(this.progress, action2.progress) &&
        Objects.equals(this.resources, action2.resources) &&
        Objects.equals(this.started, action2.started) &&
        Objects.equals(this.status, action2.status)&&
        Objects.equals(this.additionalProperties, action2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action2 is not found in the empty JSON string", Action2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action2.openapiRequiredFields) {
      ...
      Action2Error.validateJsonObject(jsonObj.getAsJsonObject("error"));
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        Action2ResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action2.class));

       return (TypeAdapter<T>) new TypeAdapter<Action2>() {
           @Override
           public void write(JsonWriter out, Action2 value) throws IOException {
           ...
           @Override
           public Action2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action2
  * @throws IOException if the JSON string is invalid with respect to Action2
  */
  public static Action2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action2.class);
  }

 /**
  * Convert an instance of Action2 to an JSON string
  *
  * @return JSON string
  */
