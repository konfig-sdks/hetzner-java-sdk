...
/**
 * Action15ResourcesInner
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Action15ResourcesInner {
  ...
  public Action15ResourcesInner() {
  }

  public Action15ResourcesInner id(Long id) {
  ...
  **/
  ...
  public Action15ResourcesInner type(String type) {
  ...
  **/
   ...
   * @return the Action15ResourcesInner instance itself
   */
  public Action15ResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action15ResourcesInner action15ResourcesInner = (Action15ResourcesInner) o;
    return Objects.equals(this.id, action15ResourcesInner.id) &&
        Objects.equals(this.type, action15ResourcesInner.type)&&
        Objects.equals(this.additionalProperties, action15ResourcesInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Action15ResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action15ResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action15ResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action15ResourcesInner is not found in the empty JSON string", Action15ResourcesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action15ResourcesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action15ResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action15ResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action15ResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action15ResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<Action15ResourcesInner>() {
           @Override
           public void write(JsonWriter out, Action15ResourcesInner value) throws IOException {
           ...
           @Override
           public Action15ResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action15ResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action15ResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action15ResourcesInner
  * @throws IOException if the JSON string is invalid with respect to Action15ResourcesInner
  */
  public static Action15ResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action15ResourcesInner.class);
  }

 /**
  * Convert an instance of Action15ResourcesInner to an JSON string
  *
  * @return JSON string
  */
