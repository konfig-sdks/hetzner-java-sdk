...
public class LoadBalancerTargetLabelSelectorProperty1 {
  public static final String SERIALIZED_NAME_SELECTOR = "selector";
  @SerializedName(SERIALIZED_NAME_SELECTOR)
  private String selector;

  public LoadBalancerTargetLabelSelectorProperty1() {
  }

  public LoadBalancerTargetLabelSelectorProperty1 selector(String selector) {
  ...
  **/
   ...
   * @return the LoadBalancerTargetLabelSelectorProperty1 instance itself
   */
  public LoadBalancerTargetLabelSelectorProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerTargetLabelSelectorProperty1 loadBalancerTargetLabelSelectorProperty1 = (LoadBalancerTargetLabelSelectorProperty1) o;
    return Objects.equals(this.selector, loadBalancerTargetLabelSelectorProperty1.selector)&&
        Objects.equals(this.additionalProperties, loadBalancerTargetLabelSelectorProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerTargetLabelSelectorProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerTargetLabelSelectorProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerTargetLabelSelectorProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerTargetLabelSelectorProperty1 is not found in the empty JSON string", LoadBalancerTargetLabelSelectorProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerTargetLabelSelectorProperty1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerTargetLabelSelectorProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerTargetLabelSelectorProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerTargetLabelSelectorProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerTargetLabelSelectorProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerTargetLabelSelectorProperty1>() {
           @Override
           public void write(JsonWriter out, LoadBalancerTargetLabelSelectorProperty1 value) throws IOException {
           ...
           @Override
           public LoadBalancerTargetLabelSelectorProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerTargetLabelSelectorProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerTargetLabelSelectorProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerTargetLabelSelectorProperty1
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerTargetLabelSelectorProperty1
  */
  public static LoadBalancerTargetLabelSelectorProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerTargetLabelSelectorProperty1.class);
  }

 /**
  * Convert an instance of LoadBalancerTargetLabelSelectorProperty1 to an JSON string
  *
  * @return JSON string
  */
