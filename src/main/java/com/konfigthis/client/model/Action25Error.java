...
public class Action25Error {
  ...
  public Action25Error() {
  }

  public Action25Error code(String code) {
  ...
  **/
  ...
  public Action25Error message(String message) {
  ...
  **/
   ...
   * @return the Action25Error instance itself
   */
  public Action25Error putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Action25Error action25Error = (Action25Error) o;
    return Objects.equals(this.code, action25Error.code) &&
        Objects.equals(this.message, action25Error.message)&&
        Objects.equals(this.additionalProperties, action25Error.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Action25Error
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Action25Error.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Action25Error is not found in the empty JSON string", Action25Error.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Action25Error.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Action25Error.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Action25Error' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Action25Error> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Action25Error.class));

       return (TypeAdapter<T>) new TypeAdapter<Action25Error>() {
           @Override
           public void write(JsonWriter out, Action25Error value) throws IOException {
           ...
           @Override
           public Action25Error read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Action25Error instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Action25Error given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Action25Error
  * @throws IOException if the JSON string is invalid with respect to Action25Error
  */
  public static Action25Error fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Action25Error.class);
  }

 /**
  * Convert an instance of Action25Error to an JSON string
  *
  * @return JSON string
  */
