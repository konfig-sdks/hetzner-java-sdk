...
/**
 * API tests for PrimaryIpActionsApi
 */
@Disabled
public class PrimaryIpActionsApiTest {

    private static PrimaryIpActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PrimaryIpActionsApi(apiClient);
    }
     ...
     */
    @Test
    public void assignPrimaryIpToResourceTest() throws ApiException {
        Long assigneeId = null;
        String assigneeType = null;
        Long id = null;
        PrimaryIpActionsAssignPrimaryIpToResourceResponse response = api.assignPrimaryIpToResource(assigneeId, assigneeType, id)
                .execute();
    ...
    public void changeDnsPtrTest() throws ApiException {
        ...
        String ip = null;
        Long id = null;
        PrimaryIpActionsChangeDnsPtrResponse response = api.changeDnsPtr(dnsPtr, ip, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void changeProtectionPrimaryIpTest() throws ApiException {
        Long id = null;
        Boolean delete = null;
        PrimaryIpActionsChangeProtectionPrimaryIpResponse response = api.changeProtectionPrimaryIp(id)
                .delete(delete)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionByIdTest() throws ApiException {
        Long id = null;
        PrimaryIpActionsGetActionByIdResponse response = api.getActionById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        PrimaryIpActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
     ...
     */
    @Test
    public void unassignPrimaryIpTest() throws ApiException {
        Long id = null;
        PrimaryIpActionsUnassignPrimaryIpResponse response = api.unassignPrimaryIp(id)
                .execute();
        // TODO: test validations
    }
