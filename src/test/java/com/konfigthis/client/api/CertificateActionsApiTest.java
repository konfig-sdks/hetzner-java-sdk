...
/**
 * API tests for CertificateActionsApi
 */
@Disabled
public class CertificateActionsApiTest {

    private static CertificateActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CertificateActionsApi(apiClient);
    }
    ...
    public void getActionTest() throws ApiException {
        Long id = null;
        CertificateActionsGetActionResponse response = api.getAction(id)
                .execute();
    ...
    public void getActionByIdTest() throws ApiException {
        Long id = null;
        Long actionId = null;
        CertificateActionsGetActionByIdResponse response = api.getActionById(id, actionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        CertificateActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
    ...
    public void getAllActions_0Test() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        CertificateActionsGetAllActions200Response response = api.getAllActions_0(id)
                .sort(sort)
                .status(status)
                .page(page)
                .perPage(perPage)
     ...
     */
    @Test
    public void retryIssuanceOrRenewalTest() throws ApiException {
        Long id = null;
        CertificateActionsRetryIssuanceOrRenewalResponse response = api.retryIssuanceOrRenewal(id)
                .execute();
        // TODO: test validations
    }
