...
public class PrimaryIpsApiTest {
    ...
    private static PrimaryIpsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PrimaryIpsApi(apiClient);
    }
    ...
    public void createOrUpdateTest() throws ApiException {
        ...
        Object labels = null;
        PrimaryIPsCreateOrUpdateResponse response = api.createOrUpdate(assigneeType, name, type)
     ...
     */
    @Test
    public void deletePrimaryIpTest() throws ApiException {
        Long id = null;
        api.deletePrimaryIp(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllTest() throws ApiException {
        ...
        Long perPage = null;
        String sort = null;
        PrimaryIPsGetAllResponse response = api.getAll()
                .name(name)
    ...
    public void getByIdTest() throws ApiException {
        Long id = null;
        PrimaryIPsGetByIdResponse response = api.getById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateIpLabelsTest() throws ApiException {
        Long id = null;
        Boolean autoDelete = null;
        Object labels = null;
        String name = null;
        PrimaryIPsUpdateIpLabelsResponse response = api.updateIpLabels(id)
                .autoDelete(autoDelete)
                .labels(labels)
                .name(name)
                .execute();
