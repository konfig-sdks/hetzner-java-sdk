...
public class FirewallActionsApiTest {
    ...
    private static FirewallActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new FirewallActionsApi(apiClient);
    }
     ...
     */
    @Test
    public void applyToResourcesTest() throws ApiException {
        List<FirewallResource> applyTo = null;
        Long id = null;
        FirewallActionsApplyToResourcesResponse response = api.applyToResources(applyTo, id)
                .execute();
    ...
    public void getActionByIdTest() throws ApiException {
        Long id = null;
        FirewallActionsGetActionByIdResponse response = api.getActionById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionById_0Test() throws ApiException {
        Long id = null;
        Long actionId = null;
        FirewallActionsGetActionById200Response response = api.getActionById_0(id, actionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        FirewallActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
    ...
    public void getAllActions_0Test() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        FirewallActionsGetAllActions200Response response = api.getAllActions_0(id)
                .sort(sort)
                .status(status)
                .page(page)
                .perPage(perPage)
     ...
     */
    @Test
    public void removeFromResourcesTest() throws ApiException {
        List<FirewallResource1> removeFrom = null;
        Long id = null;
        FirewallActionsRemoveFromResourcesResponse response = api.removeFromResources(removeFrom, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void setRulesTest() throws ApiException {
        List<Rule1> rules = null;
        Long id = null;
        FirewallActionsSetRulesResponse response = api.setRules(rules, id)
                .execute();
        // TODO: test validations
    }
