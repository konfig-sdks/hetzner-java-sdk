...
public class LoadBalancerActionsApiTest {
    ...
    private static LoadBalancerActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LoadBalancerActionsApi(apiClient);
    }
     ...
     */
    @Test
    public void addServiceTest() throws ApiException {
        Integer destinationPort = null;
        LoadBalancerServiceHealthCheckProperty1 healthCheck = null;
        Integer listenPort = null;
        String protocol = null;
        Boolean proxyprotocol = null;
        Long id = null;
        LoadBalancerServiceHTTPProperty1 http = null;
        LoadBalancerActionsAddServiceResponse response = api.addService(destinationPort, healthCheck, listenPort, protocol, proxyprotocol, id)
                .http(http)
                .execute();
     ...
     */
    @Test
    public void addTargetTest() throws ApiException {
        String type = null;
        Long id = null;
        LoadBalancerTargetIPProperty1 ip = null;
        LoadBalancerActionsAddTargetRequestLabelSelector labelSelector = null;
        LoadBalancerActionsAddTargetRequestServer server = null;
        Boolean usePrivateIp = null;
        LoadBalancerActionsAddTargetResponse response = api.addTarget(type, id)
                .ip(ip)
    ...
    public void attachToNetworkTest() throws ApiException {
        ...
        Long id = null;
        String ip = null;
        LoadBalancerActionsAttachToNetworkResponse response = api.attachToNetwork(network, id)
                .ip(ip)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void changeAlgorithmTest() throws ApiException {
        String type = null;
        Long id = null;
        LoadBalancerActionsChangeAlgorithmResponse response = api.changeAlgorithm(type, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void changeDnsPtrTest() throws ApiException {
        ...
        String ip = null;
        Long id = null;
        LoadBalancerActionsChangeDnsPtrResponse response = api.changeDnsPtr(dnsPtr, ip, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void changeProtectionTest() throws ApiException {
        Long id = null;
        Boolean delete = null;
        LoadBalancerActionsChangeProtectionResponse response = api.changeProtection(id)
                .delete(delete)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void changeTypeTest() throws ApiException {
        String loadBalancerType = null;
        Long id = null;
        LoadBalancerActionsChangeTypeResponse response = api.changeType(loadBalancerType, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void deleteServiceTest() throws ApiException {
        Integer listenPort = null;
        Long id = null;
        LoadBalancerActionsDeleteServiceResponse response = api.deleteService(listenPort, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void detachFromNetworkTest() throws ApiException {
        Long network = null;
        Long id = null;
        LoadBalancerActionsDetachFromNetworkResponse response = api.detachFromNetwork(network, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void disablePublicInterfaceTest() throws ApiException {
        Long id = null;
        LoadBalancerActionsDisablePublicInterfaceResponse response = api.disablePublicInterface(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void enablePublicInterfaceTest() throws ApiException {
        Long id = null;
        LoadBalancerActionsEnablePublicInterfaceResponse response = api.enablePublicInterface(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        LoadBalancerActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
     ...
     */
    @Test
    public void getAllActions_0Test() throws ApiException {
        Long id = null;
        String sort = null;
        String status = null;
        Long page = null;
        Long perPage = null;
        LoadBalancerActionsGetAllActions200Response response = api.getAllActions_0(id)
                .sort(sort)
                .status(status)
                .page(page)
                .perPage(perPage)
     ...
     */
    @Test
    public void getSpecificActionTest() throws ApiException {
        Long id = null;
        LoadBalancerActionsGetSpecificActionResponse response = api.getSpecificAction(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getSpecificAction_0Test() throws ApiException {
        Long id = null;
        Long actionId = null;
        LoadBalancerActionsGetSpecificAction200Response response = api.getSpecificAction_0(id, actionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void removeTargetTest() throws ApiException {
        String type = null;
        Long id = null;
        LoadBalancerTargetIPProperty2 ip = null;
        LoadBalancerActionsRemoveTargetRequestLabelSelector labelSelector = null;
        LoadBalancerActionsRemoveTargetRequestServer server = null;
        LoadBalancerActionsRemoveTargetResponse response = api.removeTarget(type, id)
                .ip(ip)
                .labelSelector(labelSelector)
                .server(server)
                .execute();
    ...
    public void updateServiceTest() throws ApiException {
        ...
        Long id = null;
        Integer destinationPort = null;
        UpdateLoadBalancerServiceHealthCheckProperty healthCheck = null;
        LoadBalancerServiceHTTPProperty2 http = null;
        String protocol = null;
        Boolean proxyprotocol = null;
        LoadBalancerActionsUpdateServiceResponse response = api.updateService(listenPort, id)
