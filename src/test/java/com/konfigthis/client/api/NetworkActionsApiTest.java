...
public class NetworkActionsApiTest {
    ...
    private static NetworkActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new NetworkActionsApi(apiClient);
    }
     ...
     */
    @Test
    public void addRouteTest() throws ApiException {
        String destination = null;
        String gateway = null;
        Long id = null;
        NetworkActionsAddRouteResponse response = api.addRoute(destination, gateway, id)
                .execute();
     ...
     */
    @Test
    public void addSubnetTest() throws ApiException {
        String networkZone = null;
        String type = null;
        Long id = null;
        String ipRange = null;
        Long vswitchId = null;
        NetworkActionsAddSubnetResponse response = api.addSubnet(networkZone, type, id)
                .ipRange(ipRange)
                .vswitchId(vswitchId)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void changeIpRangeTest() throws ApiException {
        String ipRange = null;
        Long id = null;
        NetworkActionsChangeIpRangeResponse response = api.changeIpRange(ipRange, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void changeProtectionTest() throws ApiException {
        Long id = null;
        Boolean delete = null;
        NetworkActionsChangeProtectionResponse response = api.changeProtection(id)
                .delete(delete)
                .execute();
        // TODO: test validations
    }
    ...
    public void deleteRouteTest() throws ApiException {
        ...
        String gateway = null;
        Long id = null;
        NetworkActionsDeleteRouteResponse response = api.deleteRoute(destination, gateway, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void deleteSubnetTest() throws ApiException {
        String ipRange = null;
        Long id = null;
        NetworkActionsDeleteSubnetResponse response = api.deleteSubnet(ipRange, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionTest() throws ApiException {
        Long id = null;
        NetworkActionsGetActionResponse response = api.getAction(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAction_0Test() throws ApiException {
        Long id = null;
        Long actionId = null;
        NetworkActionsGetAction200Response response = api.getAction_0(id, actionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        NetworkActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
    ...
    public void getAllActions_0Test() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        NetworkActionsGetAllActions200Response response = api.getAllActions_0(id)
                .sort(sort)
                .status(status)
                .page(page)
                .perPage(perPage)
