...
/**
 * API tests for ImageActionsApi
 */
@Disabled
public class ImageActionsApiTest {

    private static ImageActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ImageActionsApi(apiClient);
    }
    ...
    public void changeProtectionTest() throws ApiException {
        Long id = null;
        Boolean delete = null;
        ImageActionsChangeProtectionResponse response = api.changeProtection(id)
                .delete(delete)
                .execute();
    ...
    public void getActionByIdTest() throws ApiException {
        Long id = null;
        ImageActionsGetActionByIdResponse response = api.getActionById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionById_0Test() throws ApiException {
        Long id = null;
        Long actionId = null;
        ImageActionsGetActionById200Response response = api.getActionById_0(id, actionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        ImageActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
    ...
    public void getAllActions_0Test() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        ImageActionsGetAllActions200Response response = api.getAllActions_0(id)
                .sort(sort)
                .status(status)
                .page(page)
                .perPage(perPage)
