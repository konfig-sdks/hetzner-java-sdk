...
public class ServersApiTest {
    ...
    private static ServersApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ServersApi(apiClient);
    }
     ...
     */
    @Test
    public void createServerActionTest() throws ApiException {
        String image = null;
        String name = null;
        String serverType = null;
        Boolean automount = null;
        String datacenter = null;
        List<ServersCreateServerActionRequestFirewallsInner> firewalls = null;
        Object labels = null;
        String location = null;
        List<Long> networks = null;
        Long placementGroup = null;
        ServersCreateServerActionRequestPublicNet publicNet = null;
        List<String> sshKeys = null;
        Boolean startAfterCreate = null;
        String userData = null;
        List<Long> volumes = null;
        ServersCreateServerActionResponse response = api.createServerAction(image, name, serverType)
                .automount(automount)
    ...
    public void deleteServerTest() throws ApiException {
        Long id = null;
        ServersDeleteServerResponse response = api.deleteServer(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        ServersGetAllResponse response = api.getAll()
                .name(name)
     ...
     */
    @Test
    public void getMetricsForServerTest() throws ApiException {
        Long id = null;
        String type = null;
        String start = null;
        String end = null;
        String step = null;
        ServersGetMetricsForServerResponse response = api.getMetricsForServer(id, type, start, end)
                .step(step)
                .execute();
        // TODO: test validations
    }
    ...
    public void getServerTest() throws ApiException {
        Long id = null;
        ServersGetServerResponse response = api.getServer(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateServerTest() throws ApiException {
        ...
        Object labels = null;
        String name = null;
        ServersUpdateServerResponse response = api.updateServer(id)
                .labels(labels)
                .name(name)
                .execute();
        // TODO: test validations
