...
public class FirewallsApiTest {
    ...
    public void createFirewallTest() throws ApiException {
        String name = null;
        List<FirewallsCreateFirewallRequestApplyToInner> applyTo = null;
        Object labels = null;
        List<Rule> rules = null;
        FirewallsCreateFirewallResponse response = api.createFirewall(name)
                .applyTo(applyTo)
                .labels(labels)
                .rules(rules)
                .execute();
     ...
     */
    @Test
    public void deleteFirewallByIdTest() throws ApiException {
        Long id = null;
        api.deleteFirewallById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getFirewallByIdTest() throws ApiException {
        Long id = null;
        FirewallsGetFirewallByIdResponse response = api.getFirewallById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void listAllTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        FirewallsListAllResponse response = api.listAll()
                .sort(sort)
                .name(name)
     ...
     */
    @Test
    public void updateFirewallByIdTest() throws ApiException {
        Long id = null;
        Object labels = null;
        String name = null;
        FirewallsUpdateFirewallByIdResponse response = api.updateFirewallById(id)
                .labels(labels)
                .name(name)
                .execute();
        // TODO: test validations
