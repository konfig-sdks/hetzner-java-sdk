...
public class SshKeysApiTest {
    ...
    public void createKeyTest() throws ApiException {
        ...
        Object labels = null;
        SshKeysCreateKeyResponse response = api.createKey(name, publicKey)
                .labels(labels)
                .execute();
     ...
     */
    @Test
    public void getAllSshKeysTest() throws ApiException {
        String sort = null;
        String name = null;
        ...
        Long page = null;
        Long perPage = null;
        SshKeysGetAllSshKeysResponse response = api.getAllSshKeys()
                .sort(sort)
                .name(name)
    ...
    public void getByIdTest() throws ApiException {
        Long id = null;
        SshKeysGetByIdResponse response = api.getById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateKeyTest() throws ApiException {
        ...
        Object labels = null;
        String name = null;
        SshKeysUpdateKeyResponse response = api.updateKey(id)
                .labels(labels)
                .name(name)
                .execute();
        // TODO: test validations
