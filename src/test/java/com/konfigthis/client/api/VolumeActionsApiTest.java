...
public class VolumeActionsApiTest {
    ...
    private static VolumeActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new VolumeActionsApi(apiClient);
    }
     ...
     */
    @Test
    public void attachVolumeToServerTest() throws ApiException {
        Long server = null;
        Long id = null;
        Boolean automount = null;
        VolumeActionsAttachVolumeToServerResponse response = api.attachVolumeToServer(server, id)
                .automount(automount)
                .execute();
     ...
     */
    @Test
    public void changeProtectionVolumeTest() throws ApiException {
        Long id = null;
        Boolean delete = null;
        VolumeActionsChangeProtectionVolumeResponse response = api.changeProtectionVolume(id)
                .delete(delete)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void changeSizeTest() throws ApiException {
        Double size = null;
        Long id = null;
        VolumeActionsChangeSizeResponse response = api.changeSize(size, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void detachVolumeFromServerTest() throws ApiException {
        Long id = null;
        VolumeActionsDetachVolumeFromServerResponse response = api.detachVolumeFromServer(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionTest() throws ApiException {
        Long id = null;
        Long actionId = null;
        VolumeActionsGetActionResponse response = api.getAction(id, actionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionByIdTest() throws ApiException {
        Long id = null;
        VolumeActionsGetActionByIdResponse response = api.getActionById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        VolumeActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
    ...
    public void getAllActions_0Test() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        VolumeActionsGetAllActions200Response response = api.getAllActions_0(id)
                .sort(sort)
                .status(status)
                .page(page)
                .perPage(perPage)
