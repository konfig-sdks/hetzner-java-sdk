...
public class VolumesApiTest {
    ...
    private static VolumesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new VolumesApi(apiClient);
    }
    ...
    public void createVolumeTest() throws ApiException {
        ...
        Long server = null;
        VolumesCreateVolumeResponse response = api.createVolume(name, size)
                .automount(automount)
                .format(format)
                .labels(labels)
                .location(location)
    ...
    public void getAllTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        VolumesGetAllResponse response = api.getAll()
                .status(status)
                .sort(sort)
                .name(name)
    ...
    public void getByIdTest() throws ApiException {
        Long id = null;
        VolumesGetByIdResponse response = api.getById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateVolumePropertiesTest() throws ApiException {
        Long id = null;
        VolumesUpdateVolumePropertiesRequestLabels labels = null;
        String name = null;
        VolumesUpdateVolumePropertiesResponse response = api.updateVolumeProperties(id)
                .labels(labels)
                .name(name)
                .execute();
        // TODO: test validations
