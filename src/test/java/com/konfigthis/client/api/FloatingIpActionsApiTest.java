...
public class FloatingIpActionsApiTest {
    ...
    private static FloatingIpActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new FloatingIpActionsApi(apiClient);
    }
     ...
     */
    @Test
    public void assignToServerTest() throws ApiException {
        Long server = null;
        Long id = null;
        FloatingIpActionsAssignToServerResponse response = api.assignToServer(server, id)
                .execute();
    ...
    public void changeDnsPtrTest() throws ApiException {
        ...
        String ip = null;
        Long id = null;
        FloatingIpActionsChangeDnsPtrResponse response = api.changeDnsPtr(dnsPtr, ip, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void changeProtectionTest() throws ApiException {
        Long id = null;
        Boolean delete = null;
        FloatingIpActionsChangeProtectionResponse response = api.changeProtection(id)
                .delete(delete)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionByIdTest() throws ApiException {
        Long id = null;
        FloatingIpActionsGetActionByIdResponse response = api.getActionById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getActionById_0Test() throws ApiException {
        Long id = null;
        Long actionId = null;
        FloatingIpActionsGetActionById200Response response = api.getActionById_0(id, actionId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllActionsTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        FloatingIpActionsGetAllActionsResponse response = api.getAllActions()
                .id(id)
                .sort(sort)
                .status(status)
                .page(page)
    ...
    public void getAllActions_0Test() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        FloatingIpActionsGetAllActions200Response response = api.getAllActions_0(id)
                .sort(sort)
                .status(status)
                .page(page)
                .perPage(perPage)
     ...
     */
    @Test
    public void unassignIpTest() throws ApiException {
        Long id = null;
        FloatingIpActionsUnassignIpResponse response = api.unassignIp(id)
                .execute();
        // TODO: test validations
    }
