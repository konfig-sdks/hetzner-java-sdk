...
public class FloatingIpsApiTest {
    ...
    private static FloatingIpsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new FloatingIpsApi(apiClient);
    }
     ...
     */
    @Test
    public void createNewIpTest() throws ApiException {
        String type = null;
        ...
        String name = null;
        Long server = null;
        FloatingIPsCreateNewIpResponse response = api.createNewIp(type)
    ...
    public void getTest() throws ApiException {
        Long id = null;
        FloatingIPsGetResponse response = api.get(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        FloatingIPsGetAllResponse response = api.getAll()
                .name(name)
     ...
     */
    @Test
    public void updateDescriptionLabelsTest() throws ApiException {
        Long id = null;
        String description = null;
        Object labels = null;
        String name = null;
        FloatingIPsUpdateDescriptionLabelsResponse response = api.updateDescriptionLabels(id)
                .description(description)
                .labels(labels)
                .name(name)
                .execute();
