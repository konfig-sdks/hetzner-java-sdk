...
public class CertificatesApiTest {
     ...
     */
    @Test
    public void createNewCertificateTest() throws ApiException {
        String name = null;
        ...
        String type = null;
        CertificatesCreateNewCertificateResponse response = api.createNewCertificate(name)
    ...
    public void getAllTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        CertificatesGetAllResponse response = api.getAll()
                .sort(sort)
                .name(name)
    ...
    public void getByIdTest() throws ApiException {
        Long id = null;
        CertificatesGetByIdResponse response = api.getById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateByIdTest() throws ApiException {
        ...
        Object labels = null;
        String name = null;
        CertificatesUpdateByIdResponse response = api.updateById(id)
                .labels(labels)
                .name(name)
                .execute();
        // TODO: test validations
