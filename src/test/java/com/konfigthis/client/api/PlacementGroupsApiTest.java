...
public class PlacementGroupsApiTest {
    ...
    private static PlacementGroupsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PlacementGroupsApi(apiClient);
    }
    ...
    public void createNewGroupTest() throws ApiException {
        ...
        String type = null;
        Object labels = null;
        PlacementGroupsCreateNewGroupResponse response = api.createNewGroup(name, type)
                .labels(labels)
                .execute();
    ...
    public void getAllTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        PlacementGroupsGetAllResponse response = api.getAll()
                .sort(sort)
                .name(name)
    ...
    public void getByIdTest() throws ApiException {
        Long id = null;
        PlacementGroupsGetByIdResponse response = api.getById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void updatePropertiesTest() throws ApiException {
        ...
        Object labels = null;
        String name = null;
        PlacementGroupsUpdatePropertiesResponse response = api.updateProperties(id)
                .labels(labels)
                .name(name)
                .execute();
        // TODO: test validations
