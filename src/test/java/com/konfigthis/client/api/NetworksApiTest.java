...
public class NetworksApiTest {
    ...
    private static NetworksApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new NetworksApi(apiClient);
    }
    ...
    public void createNetworkTest() throws ApiException {
        String ipRange = null;
        String name = null;
        Boolean exposeRoutesToVswitch = null;
        NetworksCreateNetworkRequestLabels labels = null;
        List<NetworksCreateNetworkRequestRoutesInner> routes = null;
        List<NetworksCreateNetworkRequestSubnetsInner> subnets = null;
        NetworksCreateNetworkResponse response = api.createNetwork(ipRange, name)
    ...
    public void getAllTest() throws ApiException {
        ...
        Long page = null;
        Long perPage = null;
        NetworksGetAllResponse response = api.getAll()
                .name(name)
    ...
    public void getByIdTest() throws ApiException {
        Long id = null;
        NetworksGetByIdResponse response = api.getById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void updatePropertiesTest() throws ApiException {
        Long id = null;
        Boolean exposeRoutesToVswitch = null;
        NetworksUpdatePropertiesRequestLabels labels = null;
        String name = null;
        NetworksUpdatePropertiesResponse response = api.updateProperties(id)
                .exposeRoutesToVswitch(exposeRoutesToVswitch)
                .labels(labels)
                .name(name)
                .execute();
