...
|**prices** | [**List&lt;LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner&gt;**](LoadBalancersGetByIdResponseLoadBalancerLoadBalancerTypePricesInner.md) | Prices in different network zones |  |
